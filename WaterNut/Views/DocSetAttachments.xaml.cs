...
namespace WaterNut.Views
{
	...
	/// </summary>
	public partial class DocSetAttachmentViewModel : UserControl
	{
		public DocSetAttachmentViewModel()
		{
			InitializeComponent();
            im = (WaterNut.QuerySpace.CoreEntities.ViewModels.DocSetAttachmentViewModel)FindResource("DocSetAttachmentViewModelDataSource");
			// Insert code required on object creation below this point.
		}
        WaterNut.QuerySpace.CoreEntities.ViewModels.DocSetAttachmentViewModel im;
        
        private async void RemovePOTxt_MouseLeftButtonUp(object sender, MouseButtonEventArgs e)
        {
           // await im.RemoveEntryData((((FrameworkElement)sender).DataContext as VirtualListItem<AsycudaDocumentSetAttachments>).Data).ConfigureAwait(false);
        }
