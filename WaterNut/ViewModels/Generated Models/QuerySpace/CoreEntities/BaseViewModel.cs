...
namespace WaterNut.QuerySpace.CoreEntities.ViewModels
{
	 public partial class BaseViewModel : ViewModelBase<BaseViewModel> // ViewModelBase<BaseViewModel>
	{
           ...
           // Load Repository
                public CoreEntitiesOnCreated()
                    {
                        ...
                        RegisterToReceiveMessages<string>(MessageToken.CurrentAsycudaDocumentSetIDChanged, OnCurrentAsycudaDocumentSetIDChanged);
                        ...
                        RegisterToReceiveMessages<string>(MessageToken.CurrentConsigneesIDChanged, OnCurrentConsigneesIDChanged);
                        ...
                        RegisterToReceiveMessages<string>(MessageToken.CurrentToDo_POToXML_RecreateIDChanged, OnCurrentToDo_POToXML_RecreateIDChanged);
            ...
            catch (Exception)
            {
                throw;
                        ...
                        internal async void OnCurrentAsycudaDocumentSetIDChanged(object sender, NotificationEventArgs<string> e)
                        {
                            using (AsycudaDocumentSetRepository ctx = new AsycudaDocumentSetRepository())
                            {
                                CurrentAsycudaDocumentSet = await ctx.GetAsycudaDocumentSet(e.Data).ConfigureAwait(continueOnCapturedContext: false);
                            }
                            NotifyPropertyChanged(m => CurrentAsycudaDocumentSet);
                        }

                        private  string _currentAsycudaDocumentSetID = "";
                        public string CurrentAsycudaDocumentSetID
                        {
                            get
                            {
                                return _currentAsycudaDocumentSetID;
                            }
                            set
                            {
                                if (_currentAsycudaDocumentSetID != value)
                                {
                                    _currentAsycudaDocumentSetID = value;
                                    if (!string.IsNullOrEmpty(_currentAsycudaDocumentSetID)) BeginSendMessage(MessageToken.CurrentAsycudaDocumentSetIDChanged,
                                                     new NotificationEventArgs<string>(MessageToken.CurrentAsycudaDocumentSetIDChanged, _currentAsycudaDocumentSetID));
                                    NotifyPropertyChanged(x => this.CurrentAsycudaDocumentSetID);  
                                }
                            }
                        }
                        ...
                        internal async void OnCurrentConsigneesIDChanged(object sender, NotificationEventArgs<string> e)
                        {
                            using (ConsigneesRepository ctx = new ConsigneesRepository())
                            {
                                CurrentConsignees = await ctx.GetConsignees(e.Data).ConfigureAwait(continueOnCapturedContext: false);
                            }
                            NotifyPropertyChanged(m => CurrentConsignees);
                        }

                        private  string _currentConsigneesID = "";
                        public string CurrentConsigneesID
                        {
                            get
                            {
                                return _currentConsigneesID;
                            }
                            set
                            {
                                if (_currentConsigneesID != value)
                                {
                                    _currentConsigneesID = value;
                                    if (!string.IsNullOrEmpty(_currentConsigneesID)) BeginSendMessage(MessageToken.CurrentConsigneesIDChanged,
                                                     new NotificationEventArgs<string>(MessageToken.CurrentConsigneesIDChanged, _currentConsigneesID));
                                    NotifyPropertyChanged(x => this.CurrentConsigneesID);  
                                }
                            }
                        }
                        ...
                        internal async void OnCurrentFileTypeReplaceRegexIDChanged(object sender, NotificationEventArgs<string> e)
                        {
                            using (FileTypeReplaceRegexRepository ctx = new FileTypeReplaceRegexRepository())
                            {
                                CurrentFileTypeReplaceRegex = await ctx.GetFileTypeReplaceRegex(e.Data).ConfigureAwait(continueOnCapturedContext: false);
                            }
                            NotifyPropertyChanged(m => CurrentFileTypeReplaceRegex);
                        }

                        private  string _currentFileTypeReplaceRegexID = "";
                        public string CurrentFileTypeReplaceRegexID
                        {
                            get
                            {
                                return _currentFileTypeReplaceRegexID;
                            }
                            set
                            {
                                if (_currentFileTypeReplaceRegexID != value)
                                {
                                    _currentFileTypeReplaceRegexID = value;
                                    if (!string.IsNullOrEmpty(_currentFileTypeReplaceRegexID)) BeginSendMessage(MessageToken.CurrentFileTypeReplaceRegexIDChanged,
                                                     new NotificationEventArgs<string>(MessageToken.CurrentFileTypeReplaceRegexIDChanged, _currentFileTypeReplaceRegexID));
                                    NotifyPropertyChanged(x => this.CurrentFileTypeReplaceRegexID);  
                                }
                            }
                        }
                        ...
                        internal async void OnCurrentToDo_POToXML_RecreateIDChanged(object sender, NotificationEventArgs<string> e)
                        {
                            using (ToDo_POToXML_RecreateRepository ctx = new ToDo_POToXML_RecreateRepository())
                            {
                                CurrentToDo_POToXML_Recreate = await ctx.GetToDo_POToXML_Recreate(e.Data).ConfigureAwait(continueOnCapturedContext: false);
                            }
                            NotifyPropertyChanged(m => CurrentToDo_POToXML_Recreate);
                        }

                        private  string _currentToDo_POToXML_RecreateID = "";
                        public string CurrentToDo_POToXML_RecreateID
                        {
                            get
                            {
                                return _currentToDo_POToXML_RecreateID;
                            }
                            set
                            {
                                if (_currentToDo_POToXML_RecreateID != value)
                                {
                                    _currentToDo_POToXML_RecreateID = value;
                                    if (!string.IsNullOrEmpty(_currentToDo_POToXML_RecreateID)) BeginSendMessage(MessageToken.CurrentToDo_POToXML_RecreateIDChanged,
                                                     new NotificationEventArgs<string>(MessageToken.CurrentToDo_POToXML_RecreateIDChanged, _currentToDo_POToXML_RecreateID));
                                    NotifyPropertyChanged(x => this.CurrentToDo_POToXML_RecreateID);  
                                }
                            }
                        }
        ...
        internal void OnCurrentAsycudaDocumentSetChanged(object sender, SimpleMvvmToolkit.NotificationEventArgs<AsycudaDocumentSet> e)
        {
            //CurrentAsycudaDocumentSet = e.Data;
            NotifyPropertyChanged(m => this.CurrentAsycudaDocumentSet);
        }

        private  AsycudaDocumentSet _currentAsycudaDocumentSet;
        public AsycudaDocumentSet CurrentAsycudaDocumentSet
        {
            ...
            set
            {
                if (_currentAsycudaDocumentSet != value)
                {
                    _currentAsycudaDocumentSet = value;
                    BeginSendMessage(MessageToken.CurrentAsycudaDocumentSetChanged,
                                                     new NotificationEventArgs<AsycudaDocumentSet>(MessageToken.CurrentAsycudaDocumentSetChanged, _currentAsycudaDocumentSet)); 
		...
		VirtualListItem<AsycudaDocumentSet> _vcurrentAsycudaDocumentSet;
        public VirtualListItem<AsycudaDocumentSet> VCurrentAsycudaDocumentSet
        {
            get
            {
                return _vcurrentAsycudaDocumentSet;
            }
            set
            {
                if (_vcurrentAsycudaDocumentSet != value)
                {
                    _vcurrentAsycudaDocumentSet = value;
					if(_vcurrentAsycudaDocumentSet != null) CurrentAsycudaDocumentSet = value.Data;
                    NotifyPropertyChanged(x => this.VCurrentAsycudaDocumentSet);                    
                }
            }
        }
        ...
        internal void OnCurrentConsigneesChanged(object sender, SimpleMvvmToolkit.NotificationEventArgs<Consignees> e)
        {
            //CurrentConsignees = e.Data;
            NotifyPropertyChanged(m => this.CurrentConsignees);
        }

        private  Consignees _currentConsignees;
        public Consignees CurrentConsignees
        {
            get
            {
                return _currentConsignees;
            }
            set
            {
                if (_currentConsignees != value)
                {
                    _currentConsignees = value;
                    BeginSendMessage(MessageToken.CurrentConsigneesChanged,
                                                     new NotificationEventArgs<Consignees>(MessageToken.CurrentConsigneesChanged, _currentConsignees)); 
		...
		VirtualListItem<Consignees> _vcurrentConsignees;
        public VirtualListItem<Consignees> VCurrentConsignees
        {
            get
            {
                return _vcurrentConsignees;
            }
            set
            {
                if (_vcurrentConsignees != value)
                {
                    _vcurrentConsignees = value;
					if(_vcurrentConsignees != null) CurrentConsignees = value.Data;
                    NotifyPropertyChanged(x => this.VCurrentConsignees);                    
                }
            }
        }
        ...
        internal void OnCurrentFileTypeReplaceRegexChanged(object sender, SimpleMvvmToolkit.NotificationEventArgs<FileTypeReplaceRegex> e)
        {
            //CurrentFileTypeReplaceRegex = e.Data;
            NotifyPropertyChanged(m => this.CurrentFileTypeReplaceRegex);
        }

        private  FileTypeReplaceRegex _currentFileTypeReplaceRegex;
        public FileTypeReplaceRegex CurrentFileTypeReplaceRegex
        {
            get
            {
                return _currentFileTypeReplaceRegex;
            }
            set
            {
                if (_currentFileTypeReplaceRegex != value)
                {
                    _currentFileTypeReplaceRegex = value;
                    BeginSendMessage(MessageToken.CurrentFileTypeReplaceRegexChanged,
                                                     new NotificationEventArgs<FileTypeReplaceRegex>(MessageToken.CurrentFileTypeReplaceRegexChanged, _currentFileTypeReplaceRegex)); 
		...
		VirtualListItem<FileTypeReplaceRegex> _vcurrentFileTypeReplaceRegex;
        public VirtualListItem<FileTypeReplaceRegex> VCurrentFileTypeReplaceRegex
        {
            get
            {
                return _vcurrentFileTypeReplaceRegex;
            }
            set
            {
                if (_vcurrentFileTypeReplaceRegex != value)
                {
                    _vcurrentFileTypeReplaceRegex = value;
					if(_vcurrentFileTypeReplaceRegex != null) CurrentFileTypeReplaceRegex = value.Data;
                    NotifyPropertyChanged(x => this.VCurrentFileTypeReplaceRegex);                    
                }
            }
        }
        ...
        internal void OnCurrentToDo_POToXML_RecreateChanged(object sender, SimpleMvvmToolkit.NotificationEventArgs<ToDo_POToXML_Recreate> e)
        {
            //CurrentToDo_POToXML_Recreate = e.Data;
            NotifyPropertyChanged(m => this.CurrentToDo_POToXML_Recreate);
        }

        private  ToDo_POToXML_Recreate _currentToDo_POToXML_Recreate;
        public ToDo_POToXML_Recreate CurrentToDo_POToXML_Recreate
        {
            get
            {
                return _currentToDo_POToXML_Recreate;
            }
            set
            {
                if (_currentToDo_POToXML_Recreate != value)
                {
                    _currentToDo_POToXML_Recreate = value;
                    BeginSendMessage(MessageToken.CurrentToDo_POToXML_RecreateChanged,
                                                     new NotificationEventArgs<ToDo_POToXML_Recreate>(MessageToken.CurrentToDo_POToXML_RecreateChanged, _currentToDo_POToXML_Recreate)); 
		...
		VirtualListItem<ToDo_POToXML_Recreate> _vcurrentToDo_POToXML_Recreate;
        public VirtualListItem<ToDo_POToXML_Recreate> VCurrentToDo_POToXML_Recreate
        {
            get
            {
                return _vcurrentToDo_POToXML_Recreate;
            }
            set
            {
                if (_vcurrentToDo_POToXML_Recreate != value)
                {
                    _vcurrentToDo_POToXML_Recreate = value;
					if(_vcurrentToDo_POToXML_Recreate != null) CurrentToDo_POToXML_Recreate = value.Data;
                    NotifyPropertyChanged(x => this.VCurrentToDo_POToXML_Recreate);                    
                }
            }
        }
