...
namespace WaterNut.QuerySpace.CoreEntities.ViewModels
{
	...
	public partial class TODO_AdjustmentsToXMLViewModel_AutoGen : ViewModelBase<TODO_AdjustmentsToXMLViewModel_AutoGen>
	{

       private static readonly TODO_AdjustmentsToXMLViewModel_AutoGen instance;
       static TODO_AdjustmentsToXMLViewModel_AutoGen()
        {
            instance = new TODO_AdjustmentsToXMLViewModel_AutoGen();
        }

       public static TODO_AdjustmentsToXMLViewModel_AutoGen Instance
        {
            get { return instance; }
        }
       ...
       private readonly object lockObject = new object();
        ...
        public TODO_AdjustmentsToXMLViewModel_AutoGen()
        {
            ...
            RegisterToReceiveMessages(MessageToken.TODO_AdjustmentsToXMLChanged, OnTODO_AdjustmentsToXMLChanged);
			RegisterToReceiveMessages(MessageToken.TODO_AdjustmentsToXMLFilterExpressionChanged, OnTODO_AdjustmentsToXMLFilterExpressionChanged);


 			// Recieve messages for Core Current Entities Changed
 

			TODO_AdjustmentsToXML = new VirtualList<TODO_AdjustmentsToXML>(vloader);
			TODO_AdjustmentsToXML.LoadingStateChanged += TODO_AdjustmentsToXML_LoadingStateChanged;
            BindingOperations.EnableCollectionSynchronization(TODO_AdjustmentsToXML, lockObject);
		...
		private VirtualList<TODO_AdjustmentsToXML> _TODO_AdjustmentsToXML = null;
        public VirtualList<TODO_AdjustmentsToXML> TODO_AdjustmentsToXML
        {
            get
            {
                return _TODO_AdjustmentsToXML;
            }
            set
            {
                _TODO_AdjustmentsToXML = value;
            }
        }

		 private void OnTODO_AdjustmentsToXMLFilterExpressionChanged(object sender, NotificationEventArgs e)
        {
			TODO_AdjustmentsToXML.Refresh();
            SelectedTODO_AdjustmentsToXML.Clear();
            NotifyPropertyChanged(x => SelectedTODO_AdjustmentsToXML);
            BeginSendMessage(MessageToken.SelectedTODO_AdjustmentsToXMLChanged, new NotificationEventArgs(MessageToken.SelectedTODO_AdjustmentsToXMLChanged));
        }

		void TODO_AdjustmentsToXML_LoadingStateChanged(object sender, EventArgs e)
        {
            switch (TODO_AdjustmentsToXML.LoadingState)
            {
                ...
                case QueuedBackgroundWorkerState.Standby: 
                    ...
                    NotifyPropertyChanged(x => TODO_AdjustmentsToXML);
                    break;
                case QueuedBackgroundWorkerState.StoppedByError:
                    StatusModel.Error("TODO_AdjustmentsToXML | Error occured..." + TODO_AdjustmentsToXML.LastLoadingError.Message);
                    NotifyPropertyChanged(x => TODO_AdjustmentsToXML);
                    break;
            }
		...
		public readonly TODO_AdjustmentsToXMLVirturalListLoader vloader = new TODO_AdjustmentsToXMLVirturalListLoader();

		private ObservableCollection<TODO_AdjustmentsToXML> _selectedTODO_AdjustmentsToXML = new ObservableCollection<TODO_AdjustmentsToXML>();
        public ObservableCollection<TODO_AdjustmentsToXML> SelectedTODO_AdjustmentsToXML
        {
            get
            {
                return _selectedTODO_AdjustmentsToXML;
            }
            set
            {
                _selectedTODO_AdjustmentsToXML = value;
				BeginSendMessage(MessageToken.SelectedTODO_AdjustmentsToXMLChanged,
                                    new NotificationEventArgs(MessageToken.SelectedTODO_AdjustmentsToXMLChanged));
				 NotifyPropertyChanged(x => SelectedTODO_AdjustmentsToXML);
            }
        }
...
// Filtering Each Field except IDs
        ...
        {
            IEnumerable<TODO_AdjustmentsToXML> lst = null;
            using (var ctx = new TODO_AdjustmentsToXMLRepository())
            {
                lst = await ctx.GetTODO_AdjustmentsToXMLByExpressionNav(vloader.FilterExpression, vloader.NavigationExpression).ConfigureAwait(continueOnCapturedContext: false);
            }
            SelectedTODO_AdjustmentsToXML = new ObservableCollection<TODO_AdjustmentsToXML>(lst);
        }
...
// Send to Excel Implementation
        ...
        public async Task Send2Excel()
        {
            ...
            var s = new ExportToCSV<TODO_AdjustmentsToXMLExcelLine, List<TODO_AdjustmentsToXMLExcelLine>>
            {
                dataToPrint = lst.Select(x => new TODO_AdjustmentsToXMLExcelLine
                {
        ...
        public class TODO_AdjustmentsToXMLExcelLine
        {
