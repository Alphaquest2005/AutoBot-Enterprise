...
namespace WaterNut.QuerySpace.CoreEntities.ViewModels
{
	...
	public partial class TODO_PODocSetToAssessViewModel_AutoGen : ViewModelBase<TODO_PODocSetToAssessViewModel_AutoGen>
	{

       private static readonly TODO_PODocSetToAssessViewModel_AutoGen instance;
       static TODO_PODocSetToAssessViewModel_AutoGen()
        {
            instance = new TODO_PODocSetToAssessViewModel_AutoGen();
        }

       public static TODO_PODocSetToAssessViewModel_AutoGen Instance
        {
            get { return instance; }
        }
       ...
       private readonly object lockObject = new object();
        ...
        public TODO_PODocSetToAssessViewModel_AutoGen()
        {
            ...
            RegisterToReceiveMessages(MessageToken.TODO_PODocSetToAssessChanged, OnTODO_PODocSetToAssessChanged);
			RegisterToReceiveMessages(MessageToken.TODO_PODocSetToAssessFilterExpressionChanged, OnTODO_PODocSetToAssessFilterExpressionChanged);


 			// Recieve messages for Core Current Entities Changed
 

			TODO_PODocSetToAssess = new VirtualList<TODO_PODocSetToAssess>(vloader);
			TODO_PODocSetToAssess.LoadingStateChanged += TODO_PODocSetToAssess_LoadingStateChanged;
            BindingOperations.EnableCollectionSynchronization(TODO_PODocSetToAssess, lockObject);
		...
		private VirtualList<TODO_PODocSetToAssess> _TODO_PODocSetToAssess = null;
        public VirtualList<TODO_PODocSetToAssess> TODO_PODocSetToAssess
        {
            get
            {
                return _TODO_PODocSetToAssess;
            }
            set
            {
		...
		void TODO_PODocSetToAssess_LoadingStateChanged(object sender, EventArgs e)
        {
            switch (TODO_PODocSetToAssess.LoadingState)
            {
                ...
                case QueuedBackgroundWorkerState.Standby: 
                    ...
                    NotifyPropertyChanged(x => TODO_PODocSetToAssess);
                    break;
                case QueuedBackgroundWorkerState.StoppedByError:
                    StatusModel.Error("TODO_PODocSetToAssess | Error occured..." + TODO_PODocSetToAssess.LastLoadingError.Message);
                    NotifyPropertyChanged(x => TODO_PODocSetToAssess);
                    break;
            }
		...
		public readonly TODO_PODocSetToAssessVirturalListLoader vloader = new TODO_PODocSetToAssessVirturalListLoader();

		private ObservableCollection<TODO_PODocSetToAssess> _selectedTODO_PODocSetToAssess = new ObservableCollection<TODO_PODocSetToAssess>();
        public ObservableCollection<TODO_PODocSetToAssess> SelectedTODO_PODocSetToAssess
        {
            get
            {
                return _selectedTODO_PODocSetToAssess;
            }
            set
            {
                _selectedTODO_PODocSetToAssess = value;
				BeginSendMessage(MessageToken.SelectedTODO_PODocSetToAssessChanged,
                                    new NotificationEventArgs(MessageToken.SelectedTODO_PODocSetToAssessChanged));
				 NotifyPropertyChanged(x => SelectedTODO_PODocSetToAssess);
            }
        }

        internal virtual void OnCurrentTODO_PODocSetToAssessChanged(object sender, NotificationEventArgs<TODO_PODocSetToAssess> e)
        {
            if(BaseViewModel.Instance.CurrentTODO_PODocSetToAssess != null) BaseViewModel.Instance.CurrentTODO_PODocSetToAssess.PropertyChanged += CurrentTODO_PODocSetToAssess__propertyChanged;
           // NotifyPropertyChanged(x => this.CurrentTODO_PODocSetToAssess);
        }   

            void CurrentTODO_PODocSetToAssess__propertyChanged(object sender, System.ComponentModel.PropertyChangedEventArgs e)
                {
                 } 
        internal virtual void OnTODO_PODocSetToAssessChanged(object sender, NotificationEventArgs e)
        {
            _TODO_PODocSetToAssess.Refresh();
			NotifyPropertyChanged(x => this.TODO_PODocSetToAssess);
        }   
...
// Filtering Each Field except IDs
        ...
        {
            IEnumerable<TODO_PODocSetToAssess> lst = null;
            using (var ctx = new TODO_PODocSetToAssessRepository())
            {
                lst = await ctx.GetTODO_PODocSetToAssessByExpressionNav(vloader.FilterExpression, vloader.NavigationExpression).ConfigureAwait(continueOnCapturedContext: false);
            }
            SelectedTODO_PODocSetToAssess = new ObservableCollection<TODO_PODocSetToAssess>(lst);
        }
...
// Send to Excel Implementation
        ...
        public async Task Send2Excel()
        {
            ...
            var s = new ExportToCSV<TODO_PODocSetToAssessExcelLine, List<TODO_PODocSetToAssessExcelLine>>
            {
                dataToPrint = lst.Select(x => new TODO_PODocSetToAssessExcelLine
                {
