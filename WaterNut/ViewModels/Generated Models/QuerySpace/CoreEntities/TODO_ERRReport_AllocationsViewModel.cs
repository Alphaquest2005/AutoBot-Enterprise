...
namespace WaterNut.QuerySpace.CoreEntities.ViewModels
{
	...
	public partial class TODO_ERRReport_AllocationsViewModel_AutoGen : ViewModelBase<TODO_ERRReport_AllocationsViewModel_AutoGen>
	{

       private static readonly TODO_ERRReport_AllocationsViewModel_AutoGen instance;
       static TODO_ERRReport_AllocationsViewModel_AutoGen()
        {
            instance = new TODO_ERRReport_AllocationsViewModel_AutoGen();
        }

       public static TODO_ERRReport_AllocationsViewModel_AutoGen Instance
        {
            get { return instance; }
        }
       ...
       private readonly object lockObject = new object();
        ...
        public TODO_ERRReport_AllocationsViewModel_AutoGen()
        {
            ...
            RegisterToReceiveMessages(MessageToken.TODO_ERRReport_AllocationsChanged, OnTODO_ERRReport_AllocationsChanged);
			RegisterToReceiveMessages(MessageToken.TODO_ERRReport_AllocationsFilterExpressionChanged, OnTODO_ERRReport_AllocationsFilterExpressionChanged);


 			// Recieve messages for Core Current Entities Changed
 

			TODO_ERRReport_Allocations = new VirtualList<TODO_ERRReport_Allocations>(vloader);
			TODO_ERRReport_Allocations.LoadingStateChanged += TODO_ERRReport_Allocations_LoadingStateChanged;
            BindingOperations.EnableCollectionSynchronization(TODO_ERRReport_Allocations, lockObject);
		...
		private VirtualList<TODO_ERRReport_Allocations> _TODO_ERRReport_Allocations = null;
        public VirtualList<TODO_ERRReport_Allocations> TODO_ERRReport_Allocations
        {
            get
            {
                return _TODO_ERRReport_Allocations;
            }
            set
            {
                _TODO_ERRReport_Allocations = value;
                NotifyPropertyChanged( x => x.TODO_ERRReport_Allocations);
            }
        }

		 private void OnTODO_ERRReport_AllocationsFilterExpressionChanged(object sender, NotificationEventArgs e)
        {
			Task.Run(() => TODO_ERRReport_Allocations.Refresh()).ConfigureAwait(false);
            SelectedTODO_ERRReport_Allocations.Clear();
            NotifyPropertyChanged(x => SelectedTODO_ERRReport_Allocations);
            BeginSendMessage(MessageToken.SelectedTODO_ERRReport_AllocationsChanged, new NotificationEventArgs(MessageToken.SelectedTODO_ERRReport_AllocationsChanged));
        }

		void TODO_ERRReport_Allocations_LoadingStateChanged(object sender, EventArgs e)
        {
            switch (TODO_ERRReport_Allocations.LoadingState)
            {
                ...
                case QueuedBackgroundWorkerState.Standby: 
                    ...
                    NotifyPropertyChanged(x => TODO_ERRReport_Allocations);
                    break;
                case QueuedBackgroundWorkerState.StoppedByError:
                    StatusModel.Error("TODO_ERRReport_Allocations | Error occured..." + TODO_ERRReport_Allocations.LastLoadingError.Message);
                    NotifyPropertyChanged(x => TODO_ERRReport_Allocations);
                    break;
            }
		...
		public readonly TODO_ERRReport_AllocationsVirturalListLoader vloader = new TODO_ERRReport_AllocationsVirturalListLoader();

		private ObservableCollection<TODO_ERRReport_Allocations> _selectedTODO_ERRReport_Allocations = new ObservableCollection<TODO_ERRReport_Allocations>();
        public ObservableCollection<TODO_ERRReport_Allocations> SelectedTODO_ERRReport_Allocations
        {
            get
            {
                return _selectedTODO_ERRReport_Allocations;
            }
            set
            {
                _selectedTODO_ERRReport_Allocations = value;
				BeginSendMessage(MessageToken.SelectedTODO_ERRReport_AllocationsChanged,
                                    new NotificationEventArgs(MessageToken.SelectedTODO_ERRReport_AllocationsChanged));
				 NotifyPropertyChanged(x => SelectedTODO_ERRReport_Allocations);
            }
        }
...
// Filtering Each Field except IDs
        ...
        {
            IEnumerable<TODO_ERRReport_Allocations> lst = null;
            using (var ctx = new TODO_ERRReport_AllocationsRepository())
            {
                lst = await ctx.GetTODO_ERRReport_AllocationsByExpressionNav(vloader.FilterExpression, vloader.NavigationExpression).ConfigureAwait(continueOnCapturedContext: false);
            }
            SelectedTODO_ERRReport_Allocations = new ObservableCollection<TODO_ERRReport_Allocations>(lst);
        }
		...
		public void FilterData(StringBuilder res = null)
		{
			...
			TODO_ERRReport_Allocations.Refresh();
			NotifyPropertyChanged(x => this.TODO_ERRReport_Allocations);
		}		  
...
// Send to Excel Implementation
        ...
        public async Task Send2Excel()
        {
            ...
            var s = new ExportToCSV<TODO_ERRReport_AllocationsExcelLine, List<TODO_ERRReport_AllocationsExcelLine>>
            {
                dataToPrint = lst.Select(x => new TODO_ERRReport_AllocationsExcelLine
                {
