...
namespace WaterNut.QuerySpace.AllocationQS.ViewModels
{
	...
	public partial class AsycudaSalesAndAdjustmentAllocationsExViewModel_AutoGen : ViewModelBase<AsycudaSalesAndAdjustmentAllocationsExViewModel_AutoGen>
	{

       private static readonly AsycudaSalesAndAdjustmentAllocationsExViewModel_AutoGen instance;
       static AsycudaSalesAndAdjustmentAllocationsExViewModel_AutoGen()
        {
            instance = new AsycudaSalesAndAdjustmentAllocationsExViewModel_AutoGen();
        }

       public static AsycudaSalesAndAdjustmentAllocationsExViewModel_AutoGen Instance
        {
            get { return instance; }
        }
       ...
       private readonly object lockObject = new object();
        ...
        public AsycudaSalesAndAdjustmentAllocationsExViewModel_AutoGen()
        {
            ...
            RegisterToReceiveMessages(MessageToken.AsycudaSalesAndAdjustmentAllocationsExesChanged, OnAsycudaSalesAndAdjustmentAllocationsExesChanged);
			RegisterToReceiveMessages(MessageToken.AsycudaSalesAndAdjustmentAllocationsExesFilterExpressionChanged, OnAsycudaSalesAndAdjustmentAllocationsExesFilterExpressionChanged);
			...
			AsycudaSalesAndAdjustmentAllocationsExes.LoadingStateChanged += AsycudaSalesAndAdjustmentAllocationsExes_LoadingStateChanged;
            BindingOperations.EnableCollectionSynchronization(AsycudaSalesAndAdjustmentAllocationsExes, lockObject);
		...
		private VirtualList<AsycudaSalesAndAdjustmentAllocationsEx> _AsycudaSalesAndAdjustmentAllocationsExes = null;
        public VirtualList<AsycudaSalesAndAdjustmentAllocationsEx> AsycudaSalesAndAdjustmentAllocationsExes
        {
            get
            {
                return _AsycudaSalesAndAdjustmentAllocationsExes;
            }
            set
            {
		...
		void AsycudaSalesAndAdjustmentAllocationsExes_LoadingStateChanged(object sender, EventArgs e)
        {
            switch (AsycudaSalesAndAdjustmentAllocationsExes.LoadingState)
            {
                ...
                case QueuedBackgroundWorkerState.Standby: 
                    ...
                    NotifyPropertyChanged(x => AsycudaSalesAndAdjustmentAllocationsExes);
                    break;
                case QueuedBackgroundWorkerState.StoppedByError:
                    StatusModel.Error("AsycudaSalesAndAdjustmentAllocationsExes | Error occured..." + AsycudaSalesAndAdjustmentAllocationsExes.LastLoadingError.Message);
                    NotifyPropertyChanged(x => AsycudaSalesAndAdjustmentAllocationsExes);
                    break;
            }
		...
		public readonly AsycudaSalesAndAdjustmentAllocationsExVirturalListLoader vloader = new AsycudaSalesAndAdjustmentAllocationsExVirturalListLoader();

		private ObservableCollection<AsycudaSalesAndAdjustmentAllocationsEx> _selectedAsycudaSalesAndAdjustmentAllocationsExes = new ObservableCollection<AsycudaSalesAndAdjustmentAllocationsEx>();
        public ObservableCollection<AsycudaSalesAndAdjustmentAllocationsEx> SelectedAsycudaSalesAndAdjustmentAllocationsExes
        {
            get
            {
                return _selectedAsycudaSalesAndAdjustmentAllocationsExes;
            }
            set
            {
                _selectedAsycudaSalesAndAdjustmentAllocationsExes = value;
				BeginSendMessage(MessageToken.SelectedAsycudaSalesAndAdjustmentAllocationsExesChanged,
                                    new NotificationEventArgs(MessageToken.SelectedAsycudaSalesAndAdjustmentAllocationsExesChanged));
				 NotifyPropertyChanged(x => SelectedAsycudaSalesAndAdjustmentAllocationsExes);
            }
        }
...
// Filtering Each Field except IDs
		...
		public async Task SelectAll()
        {
            ...
            SelectedAsycudaSalesAndAdjustmentAllocationsExes = new ObservableCollection<AsycudaSalesAndAdjustmentAllocationsEx>(lst);
        }
...
// Send to Excel Implementation
        ...
        public async Task Send2Excel()
        {
            ...
            {
                dataToPrint = lst.Select(x => new AsycudaSalesAndAdjustmentAllocationsExExcelLine
                {
