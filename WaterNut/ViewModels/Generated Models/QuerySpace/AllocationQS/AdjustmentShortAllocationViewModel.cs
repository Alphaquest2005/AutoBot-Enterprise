...
namespace WaterNut.QuerySpace.AllocationQS.ViewModels
{
	...
	public partial class AdjustmentShortAllocationViewModel_AutoGen : ViewModelBase<AdjustmentShortAllocationViewModel_AutoGen>
	{

       private static readonly AdjustmentShortAllocationViewModel_AutoGen instance;
       static AdjustmentShortAllocationViewModel_AutoGen()
        {
            instance = new AdjustmentShortAllocationViewModel_AutoGen();
        }

       public static AdjustmentShortAllocationViewModel_AutoGen Instance
        {
            get { return instance; }
        }
       ...
       private readonly object lockObject = new object();
        ...
        public AdjustmentShortAllocationViewModel_AutoGen()
        {
            ...
            RegisterToReceiveMessages(MessageToken.AdjustmentShortAllocationsChanged, OnAdjustmentShortAllocationsChanged);
			RegisterToReceiveMessages(MessageToken.AdjustmentShortAllocationsFilterExpressionChanged, OnAdjustmentShortAllocationsFilterExpressionChanged);
			...
			AdjustmentShortAllocations = new VirtualList<AdjustmentShortAllocation>(vloader);
			AdjustmentShortAllocations.LoadingStateChanged += AdjustmentShortAllocations_LoadingStateChanged;
            BindingOperations.EnableCollectionSynchronization(AdjustmentShortAllocations, lockObject);
		...
		private VirtualList<AdjustmentShortAllocation> _AdjustmentShortAllocations = null;
        public VirtualList<AdjustmentShortAllocation> AdjustmentShortAllocations
        {
            get
            {
                return _AdjustmentShortAllocations;
            }
            set
            {
                _AdjustmentShortAllocations = value;
                NotifyPropertyChanged( x => x.AdjustmentShortAllocations);
            }
        }

		 private void OnAdjustmentShortAllocationsFilterExpressionChanged(object sender, NotificationEventArgs e)
        {
			Task.Run(() => AdjustmentShortAllocations.Refresh()).ConfigureAwait(false);
            SelectedAdjustmentShortAllocations.Clear();
            NotifyPropertyChanged(x => SelectedAdjustmentShortAllocations);
            BeginSendMessage(MessageToken.SelectedAdjustmentShortAllocationsChanged, new NotificationEventArgs(MessageToken.SelectedAdjustmentShortAllocationsChanged));
        }

		void AdjustmentShortAllocations_LoadingStateChanged(object sender, EventArgs e)
        {
            switch (AdjustmentShortAllocations.LoadingState)
            {
                ...
                case QueuedBackgroundWorkerState.Standby: 
                    ...
                    NotifyPropertyChanged(x => AdjustmentShortAllocations);
                    break;
                case QueuedBackgroundWorkerState.StoppedByError:
                    StatusModel.Error("AdjustmentShortAllocations | Error occured..." + AdjustmentShortAllocations.LastLoadingError.Message);
                    NotifyPropertyChanged(x => AdjustmentShortAllocations);
                    break;
            }
		...
		public readonly AdjustmentShortAllocationVirturalListLoader vloader = new AdjustmentShortAllocationVirturalListLoader();

		private ObservableCollection<AdjustmentShortAllocation> _selectedAdjustmentShortAllocations = new ObservableCollection<AdjustmentShortAllocation>();
        public ObservableCollection<AdjustmentShortAllocation> SelectedAdjustmentShortAllocations
        {
            get
            {
                return _selectedAdjustmentShortAllocations;
            }
            set
            {
                _selectedAdjustmentShortAllocations = value;
				BeginSendMessage(MessageToken.SelectedAdjustmentShortAllocationsChanged,
                                    new NotificationEventArgs(MessageToken.SelectedAdjustmentShortAllocationsChanged));
				 NotifyPropertyChanged(x => SelectedAdjustmentShortAllocations);
            }
        }
        ...
        internal virtual void OnCurrentAdjustmentShortAllocationChanged(object sender, NotificationEventArgs<AdjustmentShortAllocation> e)
        {
           ...
           // NotifyPropertyChanged(x => this.CurrentAdjustmentShortAllocation);
            ...
            void CurrentAdjustmentShortAllocation__propertyChanged(object sender, System.ComponentModel.PropertyChangedEventArgs e)
                {
        ...
        internal virtual void OnAdjustmentShortAllocationsChanged(object sender, NotificationEventArgs e)
        {
			...
			// theorticall don't need this cuz i am inheriting from core entities baseview model so changes should flow up to here
                ...
                else
                {
                    ...
                    AdjustmentShortAllocations.Refresh();
					NotifyPropertyChanged(x => this.AdjustmentShortAllocations);
				}
...
// Filtering Each Field except IDs
        ...
        {
            IEnumerable<AdjustmentShortAllocation> lst = null;
            using (var ctx = new AdjustmentShortAllocationRepository())
            {
                lst = await ctx.GetAdjustmentShortAllocationsByExpressionNav(vloader.FilterExpression, vloader.NavigationExpression).ConfigureAwait(continueOnCapturedContext: false);
            }
            SelectedAdjustmentShortAllocations = new ObservableCollection<AdjustmentShortAllocation>(lst);
        }
...
// Send to Excel Implementation
        ...
        public async Task Send2Excel()
        {
            ...
            var s = new ExportToCSV<AdjustmentShortAllocationExcelLine, List<AdjustmentShortAllocationExcelLine>>
            {
                dataToPrint = lst.Select(x => new AdjustmentShortAllocationExcelLine
                {
