...
namespace WaterNut.QuerySpace.OCR.ViewModels
{
	...
	public partial class OCR_InvoiceRegExViewModel_AutoGen : ViewModelBase<OCR_InvoiceRegExViewModel_AutoGen>
	{

       private static readonly OCR_InvoiceRegExViewModel_AutoGen instance;
       static OCR_InvoiceRegExViewModel_AutoGen()
        {
            instance = new OCR_InvoiceRegExViewModel_AutoGen();
        }

       public static OCR_InvoiceRegExViewModel_AutoGen Instance
        {
            get { return instance; }
        }
       ...
       private readonly object lockObject = new object();
        ...
        public OCR_InvoiceRegExViewModel_AutoGen()
        {
			...
			OCR_InvoiceRegEx = new VirtualList<OCR_InvoiceRegEx>(vloader);
		...
		private VirtualList<OCR_InvoiceRegEx> _OCR_InvoiceRegEx = null;
        public VirtualList<OCR_InvoiceRegEx> OCR_InvoiceRegEx
        {
            get
            {
		...
		public readonly OCR_InvoiceRegExVirturalListLoader vloader = new OCR_InvoiceRegExVirturalListLoader();

		private ObservableCollection<OCR_InvoiceRegEx> _selectedOCR_InvoiceRegEx = new ObservableCollection<OCR_InvoiceRegEx>();
        public ObservableCollection<OCR_InvoiceRegEx> SelectedOCR_InvoiceRegEx
        {
            get
            {
        ...
        internal virtual void OnCurrentOCR_InvoiceRegExChanged(object sender, NotificationEventArgs<OCR_InvoiceRegEx> e)
        {
            if(BaseViewModel.Instance.CurrentOCR_InvoiceRegEx != null) BaseViewModel.Instance.CurrentOCR_InvoiceRegEx.PropertyChanged += CurrentOCR_InvoiceRegEx__propertyChanged;
           // NotifyPropertyChanged(x => this.CurrentOCR_InvoiceRegEx);
        }   

            void CurrentOCR_InvoiceRegEx__propertyChanged(object sender, System.ComponentModel.PropertyChangedEventArgs e)
                {
                    //if (e.PropertyName == "AddOCR_Invoices")
                   // {
                   //    if(Invoices.Contains(CurrentOCR_InvoiceRegEx.OCR_Invoices) == false) Invoices.Add(CurrentOCR_InvoiceRegEx.OCR_Invoices);
                    //}
                    //if (e.PropertyName == "AddRegEx")
                   // {
                   //    if(RegularExpressions.Contains(CurrentOCR_InvoiceRegEx.RegEx) == false) RegularExpressions.Add(CurrentOCR_InvoiceRegEx.RegEx);
                    //}
                    //if (e.PropertyName == "AddReplacementRegEx")
                   // {
                   //    if(RegularExpressions.Contains(CurrentOCR_InvoiceRegEx.ReplacementRegEx) == false) RegularExpressions.Add(CurrentOCR_InvoiceRegEx.ReplacementRegEx);
                    //}
                 } 
...
// Filtering Each Field except IDs
        ...
        {
            IEnumerable<OCR_InvoiceRegEx> lst = null;
            using (var ctx = new OCR_InvoiceRegExRepository())
            {
            ...
            SelectedOCR_InvoiceRegEx = new ObservableCollection<OCR_InvoiceRegEx>(lst);
        }
...
// Send to Excel Implementation
        ...
        public async Task Send2Excel()
        {
            ...
            var s = new ExportToCSV<OCR_InvoiceRegExExcelLine, List<OCR_InvoiceRegExExcelLine>>
            {
                dataToPrint = lst.Select(x => new OCR_InvoiceRegExExcelLine
                {
                }).ToList()
            };
        ...
        public class OCR_InvoiceRegExExcelLine
        {
		        }
