...
{
    public partial class OCR_FieldMappingsVirturalListLoader : IVirtualListLoader<OCR_FieldMappings>
	{
        ...
        public string FilterExpression
        {
            ...
            set
            {
                ...
                MessageBus.Default.BeginNotify(MessageToken.OCR_FieldMappingsFilterExpressionChanged, null,
                                            new NotificationEventArgs<string>(MessageToken.OCR_FieldMappingsFilterExpressionChanged, _filterExpression));
            }
        }
        ...
        public IList<OCR_FieldMappings> LoadRange(int startIndex, int count, SortDescriptionCollection sortDescriptions, out int overallCount)
        {
            try
            {
            ...
            catch (Exception ex)
            {
                ...
                overallCount = 0;
                return new List<OCR_FieldMappings>() ;
            }
