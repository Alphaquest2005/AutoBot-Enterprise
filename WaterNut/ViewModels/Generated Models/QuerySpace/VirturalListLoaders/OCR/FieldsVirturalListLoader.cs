...
{
    public partial class FieldsVirturalListLoader : IVirtualListLoader<Fields>
	{
        ...
        public string FilterExpression
        {
            ...
            set
            {
                ...
                MessageBus.Default.BeginNotify(MessageToken.FieldsFilterExpressionChanged, null,
                                            new NotificationEventArgs<string>(MessageToken.FieldsFilterExpressionChanged, _filterExpression));
            }
        }
        ...
        public IList<Fields> LoadRange(int startIndex, int count, SortDescriptionCollection sortDescriptions, out int overallCount)
        {
            try
            {
