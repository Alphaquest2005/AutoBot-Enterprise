...
{
    public partial class LinesVirturalListLoader : IVirtualListLoader<Lines>
	{
        ...
        public string FilterExpression
        {
            ...
            set
            {
                ...
                MessageBus.Default.BeginNotify(MessageToken.LinesFilterExpressionChanged, null,
                                            new NotificationEventArgs<string>(MessageToken.LinesFilterExpressionChanged, _filterExpression));
            }
        }
        ...
        public IList<Lines> LoadRange(int startIndex, int count, SortDescriptionCollection sortDescriptions, out int overallCount)
        {
            try
            {
