...
{
    public partial class PartsVirturalListLoader : IVirtualListLoader<Parts>
	{
        ...
        public string FilterExpression
        {
            ...
            set
            {
                ...
                MessageBus.Default.BeginNotify(MessageToken.PartsFilterExpressionChanged, null,
                                            new NotificationEventArgs<string>(MessageToken.PartsFilterExpressionChanged, _filterExpression));
            }
        }
        ...
        public IList<Parts> LoadRange(int startIndex, int count, SortDescriptionCollection sortDescriptions, out int overallCount)
        {
            try
            {
