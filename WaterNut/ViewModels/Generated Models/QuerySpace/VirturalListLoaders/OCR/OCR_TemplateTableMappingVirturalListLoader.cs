...
{
    public partial class OCR_TemplateTableMappingVirturalListLoader : IVirtualListLoader<OCR_TemplateTableMapping>
	{
        ...
        public string FilterExpression
        {
            ...
            set
            {
                ...
                MessageBus.Default.BeginNotify(MessageToken.OCR_TemplateTableMappingFilterExpressionChanged, null,
                                            new NotificationEventArgs<string>(MessageToken.OCR_TemplateTableMappingFilterExpressionChanged, _filterExpression));
            }
        }
        ...
        public IList<OCR_TemplateTableMapping> LoadRange(int startIndex, int count, SortDescriptionCollection sortDescriptions, out int overallCount)
        {
            try
            {
            ...
            catch (Exception ex)
            {
                ...
                overallCount = 0;
                return new List<OCR_TemplateTableMapping>() ;
            }
