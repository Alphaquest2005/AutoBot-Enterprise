...
{
    public partial class OCR_InvoiceRegExVirturalListLoader : IVirtualListLoader<OCR_InvoiceRegEx>
	{
        ...
        public IList<OCR_InvoiceRegEx> LoadRange(int startIndex, int count, SortDescriptionCollection sortDescriptions, out int overallCount)
        {
            try
            {
            ...
            catch (Exception ex)
            {
                ...
                overallCount = 0;
                return new List<OCR_InvoiceRegEx>() ;
            }
