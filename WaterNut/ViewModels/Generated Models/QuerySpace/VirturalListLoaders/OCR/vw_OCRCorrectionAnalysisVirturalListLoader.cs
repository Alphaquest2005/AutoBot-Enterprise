...
{
    public partial class vw_OCRCorrectionAnalysisVirturalListLoader : IVirtualListLoader<vw_OCRCorrectionAnalysis>
	{
        ...
        public string FilterExpression
        {
            ...
            set
            {
                ...
                MessageBus.Default.BeginNotify(MessageToken.vw_OCRCorrectionAnalysisFilterExpressionChanged, null,
                                            new NotificationEventArgs<string>(MessageToken.vw_OCRCorrectionAnalysisFilterExpressionChanged, _filterExpression));
            }
        }
        ...
        public IList<vw_OCRCorrectionAnalysis> LoadRange(int startIndex, int count, SortDescriptionCollection sortDescriptions, out int overallCount)
        {
            try
            {
            ...
            catch (Exception ex)
            {
                ...
                overallCount = 0;
                return new List<vw_OCRCorrectionAnalysis>() ;
            }
