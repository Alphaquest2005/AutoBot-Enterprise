...
{
    public partial class ImportErrorsVirturalListLoader : IVirtualListLoader<ImportErrors>
	{
        ...
        public string FilterExpression
        {
            ...
            set
            {
                ...
                MessageBus.Default.BeginNotify(MessageToken.ImportErrorsFilterExpressionChanged, null,
                                            new NotificationEventArgs<string>(MessageToken.ImportErrorsFilterExpressionChanged, _filterExpression));
            }
        }
        ...
        public IList<ImportErrors> LoadRange(int startIndex, int count, SortDescriptionCollection sortDescriptions, out int overallCount)
        {
            try
            {
