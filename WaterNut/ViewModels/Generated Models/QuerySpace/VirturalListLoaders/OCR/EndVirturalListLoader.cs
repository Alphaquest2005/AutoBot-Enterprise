...
{
    public partial class EndVirturalListLoader : IVirtualListLoader<End>
	{
        ...
        public string FilterExpression
        {
            ...
            set
            {
                ...
                MessageBus.Default.BeginNotify(MessageToken.EndFilterExpressionChanged, null,
                                            new NotificationEventArgs<string>(MessageToken.EndFilterExpressionChanged, _filterExpression));
            }
        }
        ...
        public IList<End> LoadRange(int startIndex, int count, SortDescriptionCollection sortDescriptions, out int overallCount)
        {
            try
            {
