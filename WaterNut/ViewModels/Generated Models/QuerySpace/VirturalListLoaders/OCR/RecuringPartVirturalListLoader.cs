...
{
    public partial class RecuringPartVirturalListLoader : IVirtualListLoader<RecuringPart>
	{
        ...
        public string FilterExpression
        {
            ...
            set
            {
                ...
                MessageBus.Default.BeginNotify(MessageToken.RecuringPartFilterExpressionChanged, null,
                                            new NotificationEventArgs<string>(MessageToken.RecuringPartFilterExpressionChanged, _filterExpression));
            }
        }
        ...
        public IList<RecuringPart> LoadRange(int startIndex, int count, SortDescriptionCollection sortDescriptions, out int overallCount)
        {
            try
            {
