...
{
    public partial class TemplateRegExVirturalListLoader : IVirtualListLoader<TemplateRegEx>
	{
        ...
        public string FilterExpression
        {
            ...
            set
            {
                ...
                MessageBus.Default.BeginNotify(MessageToken.OCR_InvoiceRegExFilterExpressionChanged, null,
                                            new NotificationEventArgs<string>(MessageToken.OCR_InvoiceRegExFilterExpressionChanged, _filterExpression));
            }
        }
        ...
        public IList<TemplateRegEx> LoadRange(int startIndex, int count, SortDescriptionCollection sortDescriptions, out int overallCount)
        {
            try
            {
