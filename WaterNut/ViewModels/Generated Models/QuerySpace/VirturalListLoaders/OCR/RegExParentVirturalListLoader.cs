...
{
    public partial class RegExParentVirturalListLoader : IVirtualListLoader<RegExParent>
	{
        ...
        public string FilterExpression
        {
            ...
            set
            {
                ...
                MessageBus.Default.BeginNotify(MessageToken.RegExParentFilterExpressionChanged, null,
                                            new NotificationEventArgs<string>(MessageToken.RegExParentFilterExpressionChanged, _filterExpression));
            }
        }
        ...
        public IList<RegExParent> LoadRange(int startIndex, int count, SortDescriptionCollection sortDescriptions, out int overallCount)
        {
            try
            {
