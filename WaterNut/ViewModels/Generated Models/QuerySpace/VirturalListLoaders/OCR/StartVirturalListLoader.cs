...
{
    public partial class StartVirturalListLoader : IVirtualListLoader<Start>
	{
        ...
        public string FilterExpression
        {
            ...
            set
            {
                ...
                MessageBus.Default.BeginNotify(MessageToken.StartFilterExpressionChanged, null,
                                            new NotificationEventArgs<string>(MessageToken.StartFilterExpressionChanged, _filterExpression));
            }
        }
        ...
        public IList<Start> LoadRange(int startIndex, int count, SortDescriptionCollection sortDescriptions, out int overallCount)
        {
            try
            {
