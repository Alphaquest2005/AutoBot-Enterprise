...
{
    public partial class PartTypesVirturalListLoader : IVirtualListLoader<PartTypes>
	{
        ...
        public string FilterExpression
        {
            ...
            set
            {
                ...
                MessageBus.Default.BeginNotify(MessageToken.PartTypesFilterExpressionChanged, null,
                                            new NotificationEventArgs<string>(MessageToken.PartTypesFilterExpressionChanged, _filterExpression));
            }
        }
        ...
        public IList<PartTypes> LoadRange(int startIndex, int count, SortDescriptionCollection sortDescriptions, out int overallCount)
        {
            try
            {
