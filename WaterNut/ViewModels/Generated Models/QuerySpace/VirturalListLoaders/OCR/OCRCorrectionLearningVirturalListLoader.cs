...
{
    public partial class OCRCorrectionLearningVirturalListLoader : IVirtualListLoader<OCRCorrectionLearning>
	{
        ...
        public string FilterExpression
        {
            ...
            set
            {
                ...
                MessageBus.Default.BeginNotify(MessageToken.OCRCorrectionLearningFilterExpressionChanged, null,
                                            new NotificationEventArgs<string>(MessageToken.OCRCorrectionLearningFilterExpressionChanged, _filterExpression));
            }
        }
        ...
        public IList<OCRCorrectionLearning> LoadRange(int startIndex, int count, SortDescriptionCollection sortDescriptions, out int overallCount)
        {
            try
            {
            ...
            catch (Exception ex)
            {
                ...
                overallCount = 0;
                return new List<OCRCorrectionLearning>() ;
            }
