...
{
    public partial class InvoicesVirturalListLoader : IVirtualListLoader<Invoices>
	{
        ...
        public string FilterExpression
        {
            ...
            set
            {
                ...
                MessageBus.Default.BeginNotify(MessageToken.InvoicesFilterExpressionChanged, null,
                                            new NotificationEventArgs<string>(MessageToken.InvoicesFilterExpressionChanged, _filterExpression));
            }
        }
        ...
        public IList<Invoices> LoadRange(int startIndex, int count, SortDescriptionCollection sortDescriptions, out int overallCount)
        {
            try
            {
