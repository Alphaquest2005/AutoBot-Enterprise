...
{
    public partial class OCR_FieldValueVirturalListLoader : IVirtualListLoader<OCR_FieldValue>
	{
        ...
        public string FilterExpression
        {
            ...
            set
            {
                ...
                MessageBus.Default.BeginNotify(MessageToken.OCR_FieldValueFilterExpressionChanged, null,
                                            new NotificationEventArgs<string>(MessageToken.OCR_FieldValueFilterExpressionChanged, _filterExpression));
            }
        }
        ...
        public IList<OCR_FieldValue> LoadRange(int startIndex, int count, SortDescriptionCollection sortDescriptions, out int overallCount)
        {
            try
            {
            ...
            catch (Exception ex)
            {
                ...
                overallCount = 0;
                return new List<OCR_FieldValue>() ;
            }
