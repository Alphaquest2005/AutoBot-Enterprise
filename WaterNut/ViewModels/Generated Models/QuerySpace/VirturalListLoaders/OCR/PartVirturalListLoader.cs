...
{
    public partial class PartVirturalListLoader : IVirtualListLoader<Part>
	{
        ...
        public string FilterExpression
        {
            ...
            set
            {
                ...
                MessageBus.Default.BeginNotify(MessageToken.PartExsFilterExpressionChanged, null,
                                            new NotificationEventArgs<string>(MessageToken.PartExsFilterExpressionChanged, _filterExpression));
            }
        }
        ...
        public IList<Part> LoadRange(int startIndex, int count, SortDescriptionCollection sortDescriptions, out int overallCount)
        {
            try
            {
