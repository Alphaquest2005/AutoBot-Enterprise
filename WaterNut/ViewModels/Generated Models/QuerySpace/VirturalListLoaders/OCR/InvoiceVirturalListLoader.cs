...
{
    public partial class InvoiceVirturalListLoader : IVirtualListLoader<Invoice>
	{
        ...
        public string FilterExpression
        {
            ...
            set
            {
                ...
                MessageBus.Default.BeginNotify(MessageToken.InvoiceExsFilterExpressionChanged, null,
                                            new NotificationEventArgs<string>(MessageToken.InvoiceExsFilterExpressionChanged, _filterExpression));
            }
        }
        ...
        public IList<Invoice> LoadRange(int startIndex, int count, SortDescriptionCollection sortDescriptions, out int overallCount)
        {
            try
            {
