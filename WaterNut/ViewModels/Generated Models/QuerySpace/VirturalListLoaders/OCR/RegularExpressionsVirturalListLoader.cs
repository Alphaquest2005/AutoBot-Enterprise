...
{
    public partial class RegularExpressionsVirturalListLoader : IVirtualListLoader<RegularExpressions>
	{
        ...
        public string FilterExpression
        {
            ...
            set
            {
                ...
                MessageBus.Default.BeginNotify(MessageToken.RegularExpressionsFilterExpressionChanged, null,
                                            new NotificationEventArgs<string>(MessageToken.RegularExpressionsFilterExpressionChanged, _filterExpression));
            }
        }
        ...
        public IList<RegularExpressions> LoadRange(int startIndex, int count, SortDescriptionCollection sortDescriptions, out int overallCount)
        {
            try
            {
            ...
            catch (Exception ex)
            {
                ...
                overallCount = 0;
                return new List<RegularExpressions>() ;
            }
