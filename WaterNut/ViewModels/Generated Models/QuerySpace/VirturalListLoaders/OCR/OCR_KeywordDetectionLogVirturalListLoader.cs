...
{
    public partial class OCR_KeywordDetectionLogVirturalListLoader : IVirtualListLoader<OCR_KeywordDetectionLog>
	{
        ...
        public string FilterExpression
        {
            ...
            set
            {
                ...
                MessageBus.Default.BeginNotify(MessageToken.OCR_KeywordDetectionLogFilterExpressionChanged, null,
                                            new NotificationEventArgs<string>(MessageToken.OCR_KeywordDetectionLogFilterExpressionChanged, _filterExpression));
            }
        }
        ...
        public IList<OCR_KeywordDetectionLog> LoadRange(int startIndex, int count, SortDescriptionCollection sortDescriptions, out int overallCount)
        {
            try
            {
            ...
            catch (Exception ex)
            {
                ...
                overallCount = 0;
                return new List<OCR_KeywordDetectionLog>() ;
            }
