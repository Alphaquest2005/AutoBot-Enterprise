...
{
    public partial class OCR_FailedLinesVirturalListLoader : IVirtualListLoader<OCR_FailedLines>
	{
        ...
        public string FilterExpression
        {
            ...
            set
            {
                ...
                MessageBus.Default.BeginNotify(MessageToken.OCR_FailedLinesFilterExpressionChanged, null,
                                            new NotificationEventArgs<string>(MessageToken.OCR_FailedLinesFilterExpressionChanged, _filterExpression));
            }
        }
        ...
        public IList<OCR_FailedLines> LoadRange(int startIndex, int count, SortDescriptionCollection sortDescriptions, out int overallCount)
        {
            try
            {
            ...
            catch (Exception ex)
            {
                ...
                overallCount = 0;
                return new List<OCR_FailedLines>() ;
            }
