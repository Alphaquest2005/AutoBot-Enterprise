...
{
    public partial class ChildPartsVirturalListLoader : IVirtualListLoader<ChildParts>
	{
        ...
        public string FilterExpression
        {
            ...
            set
            {
                ...
                MessageBus.Default.BeginNotify(MessageToken.ChildPartsFilterExpressionChanged, null,
                                            new NotificationEventArgs<string>(MessageToken.ChildPartsFilterExpressionChanged, _filterExpression));
            }
        }
        ...
        public IList<ChildParts> LoadRange(int startIndex, int count, SortDescriptionCollection sortDescriptions, out int overallCount)
        {
            try
            {
