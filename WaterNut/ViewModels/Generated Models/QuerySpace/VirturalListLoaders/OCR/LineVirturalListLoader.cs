...
{
    public partial class LineVirturalListLoader : IVirtualListLoader<Line>
	{
        ...
        public string FilterExpression
        {
            ...
            set
            {
                ...
                MessageBus.Default.BeginNotify(MessageToken.LineSetFilterExpressionChanged, null,
                                            new NotificationEventArgs<string>(MessageToken.LineSetFilterExpressionChanged, _filterExpression));
            }
        }
        ...
        public IList<Line> LoadRange(int startIndex, int count, SortDescriptionCollection sortDescriptions, out int overallCount)
        {
            try
            {
