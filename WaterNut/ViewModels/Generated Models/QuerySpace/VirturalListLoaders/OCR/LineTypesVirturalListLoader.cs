...
{
    public partial class LineTypesVirturalListLoader : IVirtualListLoader<LineTypes>
	{
        ...
        public string FilterExpression
        {
            ...
            set
            {
                ...
                MessageBus.Default.BeginNotify(MessageToken.LineTypesFilterExpressionChanged, null,
                                            new NotificationEventArgs<string>(MessageToken.LineTypesFilterExpressionChanged, _filterExpression));
            }
        }
        ...
        public IList<LineTypes> LoadRange(int startIndex, int count, SortDescriptionCollection sortDescriptions, out int overallCount)
        {
            try
            {
