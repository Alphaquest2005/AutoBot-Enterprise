...
{
    public partial class InvoiceIdentificatonRegExVirturalListLoader : IVirtualListLoader<InvoiceIdentificatonRegEx>
	{
        ...
        public string FilterExpression
        {
            ...
            set
            {
                ...
                MessageBus.Default.BeginNotify(MessageToken.InvoiceIdentificatonRegExFilterExpressionChanged, null,
                                            new NotificationEventArgs<string>(MessageToken.InvoiceIdentificatonRegExFilterExpressionChanged, _filterExpression));
            }
        }
        ...
        public IList<InvoiceIdentificatonRegEx> LoadRange(int startIndex, int count, SortDescriptionCollection sortDescriptions, out int overallCount)
        {
            try
            {
            ...
            catch (Exception ex)
            {
                ...
                overallCount = 0;
                return new List<InvoiceIdentificatonRegEx>() ;
            }
