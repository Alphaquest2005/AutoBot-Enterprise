...
{
    public partial class FieldFormatRegExVirturalListLoader : IVirtualListLoader<FieldFormatRegEx>
	{
        ...
        public string FilterExpression
        {
            ...
            set
            {
                ...
                MessageBus.Default.BeginNotify(MessageToken.OCR_FieldFormatRegExFilterExpressionChanged, null,
                                            new NotificationEventArgs<string>(MessageToken.OCR_FieldFormatRegExFilterExpressionChanged, _filterExpression));
            }
        }
        ...
        public IList<FieldFormatRegEx> LoadRange(int startIndex, int count, SortDescriptionCollection sortDescriptions, out int overallCount)
        {
            try
            {
            ...
            catch (Exception ex)
            {
                ...
                overallCount = 0;
                return new List<FieldFormatRegEx>() ;
            }
