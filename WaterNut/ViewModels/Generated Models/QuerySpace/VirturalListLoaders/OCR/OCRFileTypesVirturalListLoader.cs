...
{
    public partial class OCRFileTypesVirturalListLoader : IVirtualListLoader<OCRFileTypes>
	{
        ...
        public string FilterExpression
        {
            ...
            set
            {
                ...
                MessageBus.Default.BeginNotify(MessageToken.OCRInvoicesFileTypesFilterExpressionChanged, null,
                                            new NotificationEventArgs<string>(MessageToken.OCRInvoicesFileTypesFilterExpressionChanged, _filterExpression));
            }
        }
        ...
        public IList<OCRFileTypes> LoadRange(int startIndex, int count, SortDescriptionCollection sortDescriptions, out int overallCount)
        {
            try
            {
