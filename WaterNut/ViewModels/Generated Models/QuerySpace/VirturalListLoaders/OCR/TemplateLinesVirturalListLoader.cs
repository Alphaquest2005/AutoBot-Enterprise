...
{
    public partial class TemplateLinesVirturalListLoader : IVirtualListLoader<TemplateLines>
	{
        ...
        public string FilterExpression
        {
            ...
            set
            {
                ...
                MessageBus.Default.BeginNotify(MessageToken.TemplateLinesFilterExpressionChanged, null,
                                            new NotificationEventArgs<string>(MessageToken.TemplateLinesFilterExpressionChanged, _filterExpression));
            }
        }
        ...
        public IList<TemplateLines> LoadRange(int startIndex, int count, SortDescriptionCollection sortDescriptions, out int overallCount)
        {
            try
            {
