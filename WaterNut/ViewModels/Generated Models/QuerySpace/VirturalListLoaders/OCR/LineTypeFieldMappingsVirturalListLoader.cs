...
{
    public partial class LineTypeFieldMappingsVirturalListLoader : IVirtualListLoader<LineTypeFieldMappings>
	{
        ...
        public string FilterExpression
        {
            ...
            set
            {
                ...
                MessageBus.Default.BeginNotify(MessageToken.LineTypeFieldMappingsFilterExpressionChanged, null,
                                            new NotificationEventArgs<string>(MessageToken.LineTypeFieldMappingsFilterExpressionChanged, _filterExpression));
            }
        }
        ...
        public IList<LineTypeFieldMappings> LoadRange(int startIndex, int count, SortDescriptionCollection sortDescriptions, out int overallCount)
        {
            try
            {
            ...
            catch (Exception ex)
            {
                ...
                overallCount = 0;
                return new List<LineTypeFieldMappings>() ;
            }
