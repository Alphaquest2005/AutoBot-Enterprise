...
{
    public partial class TemplateIdentificatonRegExVirturalListLoader : IVirtualListLoader<TemplateIdentificatonRegEx>
	{
        ...
        public string FilterExpression
        {
            ...
            set
            {
                ...
                MessageBus.Default.BeginNotify(MessageToken.TemplatesIdentificatonRegExFilterExpressionChanged, null,
                                            new NotificationEventArgs<string>(MessageToken.TemplatesIdentificatonRegExFilterExpressionChanged, _filterExpression));
            }
        }
        ...
        public IList<TemplateIdentificatonRegEx> LoadRange(int startIndex, int count, SortDescriptionCollection sortDescriptions, out int overallCount)
        {
            try
            {
            ...
            catch (Exception ex)
            {
                ...
                overallCount = 0;
                return new List<TemplateIdentificatonRegEx>() ;
            }
