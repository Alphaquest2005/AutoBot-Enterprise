...
{
    public partial class TemplateLinesRegularExpressionsVirturalListLoader : IVirtualListLoader<TemplateLinesRegularExpressions>
	{
        ...
        public string FilterExpression
        {
            ...
            set
            {
                ...
                MessageBus.Default.BeginNotify(MessageToken.TemplateLinesRegularExpressionsFilterExpressionChanged, null,
                                            new NotificationEventArgs<string>(MessageToken.TemplateLinesRegularExpressionsFilterExpressionChanged, _filterExpression));
            }
        }
        ...
        public IList<TemplateLinesRegularExpressions> LoadRange(int startIndex, int count, SortDescriptionCollection sortDescriptions, out int overallCount)
        {
            try
            {
            ...
            catch (Exception ex)
            {
                ...
                overallCount = 0;
                return new List<TemplateLinesRegularExpressions>() ;
            }
