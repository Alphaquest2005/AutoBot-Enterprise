...
{
    public partial class TemplateRegularExpressionsVirturalListLoader : IVirtualListLoader<TemplateRegularExpressions>
	{
        ...
        public string FilterExpression
        {
            ...
            set
            {
                ...
                MessageBus.Default.BeginNotify(MessageToken.TemplateRegularExpressionsFilterExpressionChanged, null,
                                            new NotificationEventArgs<string>(MessageToken.TemplateRegularExpressionsFilterExpressionChanged, _filterExpression));
            }
        }
        ...
        public IList<TemplateRegularExpressions> LoadRange(int startIndex, int count, SortDescriptionCollection sortDescriptions, out int overallCount)
        {
            try
            {
            ...
            catch (Exception ex)
            {
                ...
                overallCount = 0;
                return new List<TemplateRegularExpressions>() ;
            }
