...
{
    public partial class TemplatesVirturalListLoader : IVirtualListLoader<Templates>
	{
        ...
        public string FilterExpression
        {
            ...
            set
            {
                ...
                MessageBus.Default.BeginNotify(MessageToken.TemplatesFilterExpressionChanged, null,
                                            new NotificationEventArgs<string>(MessageToken.TemplatesFilterExpressionChanged, _filterExpression));
            }
        }
        ...
        public IList<Templates> LoadRange(int startIndex, int count, SortDescriptionCollection sortDescriptions, out int overallCount)
        {
            try
            {
