...
{
    public partial class OCR_FailedFieldsVirturalListLoader : IVirtualListLoader<OCR_FailedFields>
	{
        ...
        public string FilterExpression
        {
            ...
            set
            {
                ...
                MessageBus.Default.BeginNotify(MessageToken.OCR_FailedFieldsFilterExpressionChanged, null,
                                            new NotificationEventArgs<string>(MessageToken.OCR_FailedFieldsFilterExpressionChanged, _filterExpression));
            }
        }
        ...
        public IList<OCR_FailedFields> LoadRange(int startIndex, int count, SortDescriptionCollection sortDescriptions, out int overallCount)
        {
            try
            {
            ...
            catch (Exception ex)
            {
                ...
                overallCount = 0;
                return new List<OCR_FailedFields>() ;
            }
