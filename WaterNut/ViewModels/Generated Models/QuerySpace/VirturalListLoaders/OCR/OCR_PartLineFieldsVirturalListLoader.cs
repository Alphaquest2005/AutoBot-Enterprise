...
{
    public partial class OCR_PartLineFieldsVirturalListLoader : IVirtualListLoader<OCR_PartLineFields>
	{
        ...
        public string FilterExpression
        {
            ...
            set
            {
                ...
                MessageBus.Default.BeginNotify(MessageToken.OCR_PartLineFieldsFilterExpressionChanged, null,
                                            new NotificationEventArgs<string>(MessageToken.OCR_PartLineFieldsFilterExpressionChanged, _filterExpression));
            }
        }
        ...
        public IList<OCR_PartLineFields> LoadRange(int startIndex, int count, SortDescriptionCollection sortDescriptions, out int overallCount)
        {
            try
            {
            ...
            catch (Exception ex)
            {
                ...
                overallCount = 0;
                return new List<OCR_PartLineFields>() ;
            }
