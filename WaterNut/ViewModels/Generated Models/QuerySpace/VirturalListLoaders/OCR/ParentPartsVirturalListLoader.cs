...
{
    public partial class ParentPartsVirturalListLoader : IVirtualListLoader<ParentParts>
	{
        ...
        public string FilterExpression
        {
            ...
            set
            {
                ...
                MessageBus.Default.BeginNotify(MessageToken.ParentPartsFilterExpressionChanged, null,
                                            new NotificationEventArgs<string>(MessageToken.ParentPartsFilterExpressionChanged, _filterExpression));
            }
        }
        ...
        public IList<ParentParts> LoadRange(int startIndex, int count, SortDescriptionCollection sortDescriptions, out int overallCount)
        {
            try
            {
