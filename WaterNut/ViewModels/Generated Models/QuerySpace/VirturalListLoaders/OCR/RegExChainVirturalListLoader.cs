...
{
    public partial class RegExChainVirturalListLoader : IVirtualListLoader<RegExChain>
	{
        ...
        public string FilterExpression
        {
            ...
            set
            {
                ...
                MessageBus.Default.BeginNotify(MessageToken.RegExChainFilterExpressionChanged, null,
                                            new NotificationEventArgs<string>(MessageToken.RegExChainFilterExpressionChanged, _filterExpression));
            }
        }
        ...
        public IList<RegExChain> LoadRange(int startIndex, int count, SortDescriptionCollection sortDescriptions, out int overallCount)
        {
            try
            {
