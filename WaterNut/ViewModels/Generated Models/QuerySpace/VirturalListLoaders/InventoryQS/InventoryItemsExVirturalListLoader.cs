    ...
    public partial class InventoryItemsExVirturalListLoader : IVirtualListLoader<InventoryItemsEx>
	{
        ...
        public string FilterExpression
        {
            ...
            set
            {
                ...
                MessageBus.Default.BeginNotify(MessageToken.InventoryItemsExFilterExpressionChanged, null,
                                            new NotificationEventArgs<string>(MessageToken.InventoryItemsExFilterExpressionChanged, _filterExpression));
            }
        }
        ...
        public IList<InventoryItemsEx> LoadRange(int startIndex, int count, SortDescriptionCollection sortDescriptions, out int overallCount)
        {
            ...
            catch (Exception ex)
            {
                ...
                overallCount = 0;
                return new List<InventoryItemsEx>() ;
            }
