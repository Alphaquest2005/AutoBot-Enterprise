...
{
    public partial class EntryDataDetailsExVirturalListLoader : IVirtualListLoader<EntryDataDetailsEx>
	{
        ...
        public string FilterExpression
        {
            ...
            set
            {
                ...
                MessageBus.Default.BeginNotify(MessageToken.EntryDataDetailsExFilterExpressionChanged, null,
                                            new NotificationEventArgs<string>(MessageToken.EntryDataDetailsExFilterExpressionChanged, _filterExpression));
            }
        }
        ...
        public IList<EntryDataDetailsEx> LoadRange(int startIndex, int count, SortDescriptionCollection sortDescriptions, out int overallCount)
        {
            try
            {
            ...
            catch (Exception ex)
            {
                ...
                overallCount = 0;
                return new List<EntryDataDetailsEx>() ;
            }
