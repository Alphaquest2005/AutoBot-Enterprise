...
{
    public partial class TODO_PreDiscrepancyErrorsVirturalListLoader : IVirtualListLoader<TODO_PreDiscrepancyErrors>
	{
        ...
        public string FilterExpression
        {
            ...
            set
            {
                ...
                MessageBus.Default.BeginNotify(MessageToken.TODO_PreDiscrepancyErrorsFilterExpressionChanged, null,
                                            new NotificationEventArgs<string>(MessageToken.TODO_PreDiscrepancyErrorsFilterExpressionChanged, _filterExpression));
            }
        }
        ...
        public IList<TODO_PreDiscrepancyErrors> LoadRange(int startIndex, int count, SortDescriptionCollection sortDescriptions, out int overallCount)
        {
            try
            {
            ...
            catch (Exception ex)
            {
                ...
                overallCount = 0;
                return new List<TODO_PreDiscrepancyErrors>() ;
            }
