...
{
    public partial class AdjustmentOversAllocationVirturalListLoader : IVirtualListLoader<AdjustmentOversAllocation>
	{
        ...
        public string FilterExpression
        {
            ...
            set
            {
                ...
                MessageBus.Default.BeginNotify(MessageToken.AdjustmentOversAllocationsFilterExpressionChanged, null,
                                            new NotificationEventArgs<string>(MessageToken.AdjustmentOversAllocationsFilterExpressionChanged, _filterExpression));
            }
        }
        ...
        public IList<AdjustmentOversAllocation> LoadRange(int startIndex, int count, SortDescriptionCollection sortDescriptions, out int overallCount)
        {
            try
            {
            ...
            catch (Exception ex)
            {
                ...
                overallCount = 0;
                return new List<AdjustmentOversAllocation>() ;
            }
