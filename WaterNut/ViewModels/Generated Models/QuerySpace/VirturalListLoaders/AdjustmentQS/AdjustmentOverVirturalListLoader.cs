...
{
    public partial class AdjustmentOverVirturalListLoader : IVirtualListLoader<AdjustmentOver>
	{
        ...
        public string FilterExpression
        {
            ...
            set
            {
                ...
                MessageBus.Default.BeginNotify(MessageToken.AdjustmentOversFilterExpressionChanged, null,
                                            new NotificationEventArgs<string>(MessageToken.AdjustmentOversFilterExpressionChanged, _filterExpression));
            }
        }
        ...
        public IList<AdjustmentOver> LoadRange(int startIndex, int count, SortDescriptionCollection sortDescriptions, out int overallCount)
        {
            try
            {
            ...
            catch (Exception ex)
            {
                ...
                overallCount = 0;
                return new List<AdjustmentOver>() ;
            }
