...
{
    public partial class InventoryItemAliaVirturalListLoader : IVirtualListLoader<InventoryItemAlia>
	{
        ...
        public IList<InventoryItemAlia> LoadRange(int startIndex, int count, SortDescriptionCollection sortDescriptions, out int overallCount)
        {
            try
            {
            ...
            catch (Exception ex)
            {
                ...
                overallCount = 0;
                return new List<InventoryItemAlia>() ;
            }
