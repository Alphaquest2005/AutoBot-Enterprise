...
{
    public partial class xcuda_ItemVirturalListLoader : IVirtualListLoader<xcuda_Item>
	{
        ...
        public string FilterExpression
        {
            ...
            set
            {
                ...
                MessageBus.Default.BeginNotify(MessageToken.xcuda_ItemFilterExpressionChanged, null,
                                            new NotificationEventArgs<string>(MessageToken.xcuda_ItemFilterExpressionChanged, _filterExpression));
            }
        }
        ...
        public IList<xcuda_Item> LoadRange(int startIndex, int count, SortDescriptionCollection sortDescriptions, out int overallCount)
        {
            try
            {
