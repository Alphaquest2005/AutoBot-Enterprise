...
{
    public partial class AdjustmentShortVirturalListLoader : IVirtualListLoader<AdjustmentShort>
	{
        ...
        public string FilterExpression
        {
            ...
            set
            {
                ...
                MessageBus.Default.BeginNotify(MessageToken.AdjustmentShortsFilterExpressionChanged, null,
                                            new NotificationEventArgs<string>(MessageToken.AdjustmentShortsFilterExpressionChanged, _filterExpression));
            }
        }
        ...
        public IList<AdjustmentShort> LoadRange(int startIndex, int count, SortDescriptionCollection sortDescriptions, out int overallCount)
        {
            try
            {
            ...
            catch (Exception ex)
            {
                ...
                overallCount = 0;
                return new List<AdjustmentShort>() ;
            }
