...
{
    public partial class AsycudaSalesAllocationVirturalListLoader : IVirtualListLoader<AsycudaSalesAllocation>
	{
        ...
        public string FilterExpression
        {
            ...
            set
            {
                ...
                MessageBus.Default.BeginNotify(MessageToken.AsycudaSalesAllocationsFilterExpressionChanged, null,
                                            new NotificationEventArgs<string>(MessageToken.AsycudaSalesAllocationsFilterExpressionChanged, _filterExpression));
            }
        }
        ...
        public IList<AsycudaSalesAllocation> LoadRange(int startIndex, int count, SortDescriptionCollection sortDescriptions, out int overallCount)
        {
            try
            {
            ...
            catch (Exception ex)
            {
                ...
                overallCount = 0;
                return new List<AsycudaSalesAllocation>() ;
            }
