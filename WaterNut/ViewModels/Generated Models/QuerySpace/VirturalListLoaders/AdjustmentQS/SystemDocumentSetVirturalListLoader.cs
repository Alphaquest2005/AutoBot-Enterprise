...
{
    public partial class SystemDocumentSetVirturalListLoader : IVirtualListLoader<SystemDocumentSet>
	{
        ...
        public string FilterExpression
        {
            ...
            set
            {
                ...
                MessageBus.Default.BeginNotify(MessageToken.SystemDocumentSetsFilterExpressionChanged, null,
                                            new NotificationEventArgs<string>(MessageToken.SystemDocumentSetsFilterExpressionChanged, _filterExpression));
            }
        }
        ...
        public IList<SystemDocumentSet> LoadRange(int startIndex, int count, SortDescriptionCollection sortDescriptions, out int overallCount)
        {
            try
            {
            ...
            catch (Exception ex)
            {
                ...
                overallCount = 0;
                return new List<SystemDocumentSet>() ;
            }
