...
{
    public partial class EntryDataDetailVirturalListLoader : IVirtualListLoader<EntryDataDetail>
	{
        ...
        public string FilterExpression
        {
            ...
            set
            {
                ...
                MessageBus.Default.BeginNotify(MessageToken.EntryDataDetailsFilterExpressionChanged, null,
                                            new NotificationEventArgs<string>(MessageToken.EntryDataDetailsFilterExpressionChanged, _filterExpression));
            }
        }
        ...
        public IList<EntryDataDetail> LoadRange(int startIndex, int count, SortDescriptionCollection sortDescriptions, out int overallCount)
        {
            try
            {
            ...
            catch (Exception ex)
            {
                ...
                overallCount = 0;
                return new List<EntryDataDetail>() ;
            }
