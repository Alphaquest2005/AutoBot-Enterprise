...
{
    public partial class TODO_AdjustmentOversToXMLVirturalListLoader : IVirtualListLoader<TODO_AdjustmentOversToXML>
	{
        ...
        public string FilterExpression
        {
            ...
            set
            {
                ...
                MessageBus.Default.BeginNotify(MessageToken.TODO_AdjustmentOversToXMLFilterExpressionChanged, null,
                                            new NotificationEventArgs<string>(MessageToken.TODO_AdjustmentOversToXMLFilterExpressionChanged, _filterExpression));
            }
        }
        ...
        public IList<TODO_AdjustmentOversToXML> LoadRange(int startIndex, int count, SortDescriptionCollection sortDescriptions, out int overallCount)
        {
            try
            {
            ...
            catch (Exception ex)
            {
                ...
                overallCount = 0;
                return new List<TODO_AdjustmentOversToXML>() ;
            }
