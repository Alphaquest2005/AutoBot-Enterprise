...
{
    public partial class AsycudaDocumentItemEntryDataDetailVirturalListLoader : IVirtualListLoader<AsycudaDocumentItemEntryDataDetail>
	{
        ...
        public IList<AsycudaDocumentItemEntryDataDetail> LoadRange(int startIndex, int count, SortDescriptionCollection sortDescriptions, out int overallCount)
        {
            try
            {
            ...
            catch (Exception ex)
            {
                ...
                overallCount = 0;
                return new List<AsycudaDocumentItemEntryDataDetail>() ;
            }
