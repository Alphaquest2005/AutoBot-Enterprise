...
{
    public partial class AsycudaDocumentSetEntryDataDetailVirturalListLoader : IVirtualListLoader<AsycudaDocumentSetEntryDataDetail>
	{
        ...
        public IList<AsycudaDocumentSetEntryDataDetail> LoadRange(int startIndex, int count, SortDescriptionCollection sortDescriptions, out int overallCount)
        {
            try
            {
            ...
            catch (Exception ex)
            {
                ...
                overallCount = 0;
                return new List<AsycudaDocumentSetEntryDataDetail>() ;
            }
