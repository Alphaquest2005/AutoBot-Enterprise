...
{
    public partial class AsycudaSalesAndAdjustmentAllocationsExVirturalListLoader : IVirtualListLoader<AsycudaSalesAndAdjustmentAllocationsEx>
	{
        ...
        public string FilterExpression
        {
            ...
            set
            {
                ...
                MessageBus.Default.BeginNotify(MessageToken.AsycudaSalesAndAdjustmentAllocationsExesFilterExpressionChanged, null,
                                            new NotificationEventArgs<string>(MessageToken.AsycudaSalesAndAdjustmentAllocationsExesFilterExpressionChanged, _filterExpression));
            }
        }
        ...
        public IList<AsycudaSalesAndAdjustmentAllocationsEx> LoadRange(int startIndex, int count, SortDescriptionCollection sortDescriptions, out int overallCount)
        {
            try
            {
            ...
            catch (Exception ex)
            {
                ...
                overallCount = 0;
                return new List<AsycudaSalesAndAdjustmentAllocationsEx>() ;
            }
