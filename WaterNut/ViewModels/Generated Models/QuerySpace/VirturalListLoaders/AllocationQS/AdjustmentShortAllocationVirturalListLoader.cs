...
{
    public partial class AdjustmentShortAllocationVirturalListLoader : IVirtualListLoader<AdjustmentShortAllocation>
	{
        ...
        public string FilterExpression
        {
            ...
            set
            {
                ...
                MessageBus.Default.BeginNotify(MessageToken.AdjustmentShortAllocationsFilterExpressionChanged, null,
                                            new NotificationEventArgs<string>(MessageToken.AdjustmentShortAllocationsFilterExpressionChanged, _filterExpression));
            }
        }
        ...
        public IList<AdjustmentShortAllocation> LoadRange(int startIndex, int count, SortDescriptionCollection sortDescriptions, out int overallCount)
        {
            try
            {
            ...
            catch (Exception ex)
            {
                ...
                overallCount = 0;
                return new List<AdjustmentShortAllocation>() ;
            }
