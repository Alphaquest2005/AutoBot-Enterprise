...
{
    public partial class AllocationsTestCasVirturalListLoader : IVirtualListLoader<AllocationsTestCas>
	{
        ...
        public string FilterExpression
        {
            ...
            set
            {
                ...
                MessageBus.Default.BeginNotify(MessageToken.AllocationsTestCasesFilterExpressionChanged, null,
                                            new NotificationEventArgs<string>(MessageToken.AllocationsTestCasesFilterExpressionChanged, _filterExpression));
            }
        }
        ...
        public IList<AllocationsTestCas> LoadRange(int startIndex, int count, SortDescriptionCollection sortDescriptions, out int overallCount)
        {
            try
            {
            ...
            catch (Exception ex)
            {
                ...
                overallCount = 0;
                return new List<AllocationsTestCas>() ;
            }
