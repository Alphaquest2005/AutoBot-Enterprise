...
{
    public partial class TODO_DiscrepanciesExecutionReportVirturalListLoader : IVirtualListLoader<TODO_DiscrepanciesExecutionReport>
	{
        ...
        public string FilterExpression
        {
            ...
            set
            {
                ...
                MessageBus.Default.BeginNotify(MessageToken.TODO_DiscrepanciesExecutionReportFilterExpressionChanged, null,
                                            new NotificationEventArgs<string>(MessageToken.TODO_DiscrepanciesExecutionReportFilterExpressionChanged, _filterExpression));
            }
        }
        ...
        public IList<TODO_DiscrepanciesExecutionReport> LoadRange(int startIndex, int count, SortDescriptionCollection sortDescriptions, out int overallCount)
        {
            try
            {
            ...
            catch (Exception ex)
            {
                ...
                overallCount = 0;
                return new List<TODO_DiscrepanciesExecutionReport>() ;
            }
