...
{
    public partial class TODO_TotalAdjustmentsToProcessVirturalListLoader : IVirtualListLoader<TODO_TotalAdjustmentsToProcess>
	{
        ...
        public string FilterExpression
        {
            ...
            set
            {
                ...
                MessageBus.Default.BeginNotify(MessageToken.TODO_TotalAdjustmentsToProcessFilterExpressionChanged, null,
                                            new NotificationEventArgs<string>(MessageToken.TODO_TotalAdjustmentsToProcessFilterExpressionChanged, _filterExpression));
            }
        }
        ...
        public IList<TODO_TotalAdjustmentsToProcess> LoadRange(int startIndex, int count, SortDescriptionCollection sortDescriptions, out int overallCount)
        {
            try
            {
            ...
            catch (Exception ex)
            {
                ...
                overallCount = 0;
                return new List<TODO_TotalAdjustmentsToProcess>() ;
            }
