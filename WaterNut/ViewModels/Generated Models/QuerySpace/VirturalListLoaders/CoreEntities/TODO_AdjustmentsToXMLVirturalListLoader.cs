...
{
    public partial class TODO_AdjustmentsToXMLVirturalListLoader : IVirtualListLoader<TODO_AdjustmentsToXML>
	{
        ...
        public string FilterExpression
        {
            ...
            set
            {
                ...
                MessageBus.Default.BeginNotify(MessageToken.TODO_AdjustmentsToXMLFilterExpressionChanged, null,
                                            new NotificationEventArgs<string>(MessageToken.TODO_AdjustmentsToXMLFilterExpressionChanged, _filterExpression));
            }
        }
        ...
        public IList<TODO_AdjustmentsToXML> LoadRange(int startIndex, int count, SortDescriptionCollection sortDescriptions, out int overallCount)
        {
            try
            {
            ...
            catch (Exception ex)
            {
                ...
                overallCount = 0;
                return new List<TODO_AdjustmentsToXML>() ;
            }
