...
{
    public partial class ExpiredEntriesLstVirturalListLoader : IVirtualListLoader<ExpiredEntriesLst>
	{
        ...
        public string FilterExpression
        {
            ...
            set
            {
                ...
                MessageBus.Default.BeginNotify(MessageToken.ExpiredEntriesLstFilterExpressionChanged, null,
                                            new NotificationEventArgs<string>(MessageToken.ExpiredEntriesLstFilterExpressionChanged, _filterExpression));
            }
        }
        ...
        public IList<ExpiredEntriesLst> LoadRange(int startIndex, int count, SortDescriptionCollection sortDescriptions, out int overallCount)
        {
            try
            {
            ...
            catch (Exception ex)
            {
                ...
                overallCount = 0;
                return new List<ExpiredEntriesLst>() ;
            }
