...
{
    public partial class TODO_ERRReport_AsycudaEntriesVirturalListLoader : IVirtualListLoader<TODO_ERRReport_AsycudaEntries>
	{
        ...
        public string FilterExpression
        {
            ...
            set
            {
                ...
                MessageBus.Default.BeginNotify(MessageToken.TODO_ERRReport_AsycudaEntriesFilterExpressionChanged, null,
                                            new NotificationEventArgs<string>(MessageToken.TODO_ERRReport_AsycudaEntriesFilterExpressionChanged, _filterExpression));
            }
        }
        ...
        public IList<TODO_ERRReport_AsycudaEntries> LoadRange(int startIndex, int count, SortDescriptionCollection sortDescriptions, out int overallCount)
        {
            try
            {
            ...
            catch (Exception ex)
            {
                ...
                overallCount = 0;
                return new List<TODO_ERRReport_AsycudaEntries>() ;
            }
