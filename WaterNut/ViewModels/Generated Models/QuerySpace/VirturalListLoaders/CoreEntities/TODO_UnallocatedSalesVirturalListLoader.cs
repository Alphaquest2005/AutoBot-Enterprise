...
{
    public partial class TODO_UnallocatedSalesVirturalListLoader : IVirtualListLoader<TODO_UnallocatedSales>
	{
        ...
        public string FilterExpression
        {
            ...
            set
            {
                ...
                MessageBus.Default.BeginNotify(MessageToken.TODO_UnallocatedSalesFilterExpressionChanged, null,
                                            new NotificationEventArgs<string>(MessageToken.TODO_UnallocatedSalesFilterExpressionChanged, _filterExpression));
            }
        }
        ...
        public IList<TODO_UnallocatedSales> LoadRange(int startIndex, int count, SortDescriptionCollection sortDescriptions, out int overallCount)
        {
            try
            {
            ...
            catch (Exception ex)
            {
                ...
                overallCount = 0;
                return new List<TODO_UnallocatedSales>() ;
            }
