...
{
    public partial class SessionsVirturalListLoader : IVirtualListLoader<Sessions>
	{
        ...
        public string FilterExpression
        {
            ...
            set
            {
                ...
                MessageBus.Default.BeginNotify(MessageToken.SessionsFilterExpressionChanged, null,
                                            new NotificationEventArgs<string>(MessageToken.SessionsFilterExpressionChanged, _filterExpression));
            }
        }
        ...
        public IList<Sessions> LoadRange(int startIndex, int count, SortDescriptionCollection sortDescriptions, out int overallCount)
        {
            try
            {
