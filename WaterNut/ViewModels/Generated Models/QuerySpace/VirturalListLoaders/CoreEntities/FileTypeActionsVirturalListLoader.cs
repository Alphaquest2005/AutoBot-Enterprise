...
{
    public partial class FileTypeActionsVirturalListLoader : IVirtualListLoader<FileTypeActions>
	{
        ...
        public string FilterExpression
        {
            ...
            set
            {
                ...
                MessageBus.Default.BeginNotify(MessageToken.FileTypeActionsFilterExpressionChanged, null,
                                            new NotificationEventArgs<string>(MessageToken.FileTypeActionsFilterExpressionChanged, _filterExpression));
            }
        }
        ...
        public IList<FileTypeActions> LoadRange(int startIndex, int count, SortDescriptionCollection sortDescriptions, out int overallCount)
        {
            try
            {
            ...
            catch (Exception ex)
            {
                ...
                overallCount = 0;
                return new List<FileTypeActions>() ;
            }
