...
{
    public partial class FileTypeMappingsValuesVirturalListLoader : IVirtualListLoader<FileTypeMappingsValues>
	{
        ...
        public string FilterExpression
        {
            ...
            set
            {
                ...
                MessageBus.Default.BeginNotify(MessageToken.FileTypeMappingsValuesFilterExpressionChanged, null,
                                            new NotificationEventArgs<string>(MessageToken.FileTypeMappingsValuesFilterExpressionChanged, _filterExpression));
            }
        }
        ...
        public IList<FileTypeMappingsValues> LoadRange(int startIndex, int count, SortDescriptionCollection sortDescriptions, out int overallCount)
        {
            try
            {
            ...
            catch (Exception ex)
            {
                ...
                overallCount = 0;
                return new List<FileTypeMappingsValues>() ;
            }
