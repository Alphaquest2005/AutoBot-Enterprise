...
{
    public partial class TODO_ERRReport_ByItemNumberVirturalListLoader : IVirtualListLoader<TODO_ERRReport_ByItemNumber>
	{
        ...
        public string FilterExpression
        {
            ...
            set
            {
                ...
                MessageBus.Default.BeginNotify(MessageToken.TODO_ERRReport_ByItemNumberFilterExpressionChanged, null,
                                            new NotificationEventArgs<string>(MessageToken.TODO_ERRReport_ByItemNumberFilterExpressionChanged, _filterExpression));
            }
        }
        ...
        public IList<TODO_ERRReport_ByItemNumber> LoadRange(int startIndex, int count, SortDescriptionCollection sortDescriptions, out int overallCount)
        {
            try
            {
            ...
            catch (Exception ex)
            {
                ...
                overallCount = 0;
                return new List<TODO_ERRReport_ByItemNumber>() ;
            }
