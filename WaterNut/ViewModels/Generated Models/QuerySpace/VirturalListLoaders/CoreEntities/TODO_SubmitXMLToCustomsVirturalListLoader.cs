...
{
    public partial class TODO_SubmitXMLToCustomsVirturalListLoader : IVirtualListLoader<TODO_SubmitXMLToCustoms>
	{
        ...
        public string FilterExpression
        {
            ...
            set
            {
                ...
                MessageBus.Default.BeginNotify(MessageToken.TODO_SubmitXMLToCustomsFilterExpressionChanged, null,
                                            new NotificationEventArgs<string>(MessageToken.TODO_SubmitXMLToCustomsFilterExpressionChanged, _filterExpression));
            }
        }
        ...
        public IList<TODO_SubmitXMLToCustoms> LoadRange(int startIndex, int count, SortDescriptionCollection sortDescriptions, out int overallCount)
        {
            try
            {
            ...
            catch (Exception ex)
            {
                ...
                overallCount = 0;
                return new List<TODO_SubmitXMLToCustoms>() ;
            }
