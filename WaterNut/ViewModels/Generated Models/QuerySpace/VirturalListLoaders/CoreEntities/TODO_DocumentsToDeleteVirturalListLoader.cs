...
{
    public partial class TODO_DocumentsToDeleteVirturalListLoader : IVirtualListLoader<TODO_DocumentsToDelete>
	{
        ...
        public string FilterExpression
        {
            ...
            set
            {
                ...
                MessageBus.Default.BeginNotify(MessageToken.TODO_DocumentsToDeleteFilterExpressionChanged, null,
                                            new NotificationEventArgs<string>(MessageToken.TODO_DocumentsToDeleteFilterExpressionChanged, _filterExpression));
            }
        }
        ...
        public IList<TODO_DocumentsToDelete> LoadRange(int startIndex, int count, SortDescriptionCollection sortDescriptions, out int overallCount)
        {
            try
            {
            ...
            catch (Exception ex)
            {
                ...
                overallCount = 0;
                return new List<TODO_DocumentsToDelete>() ;
            }
