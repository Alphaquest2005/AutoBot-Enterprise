...
{
    public partial class TODO_CreateEx9VirturalListLoader : IVirtualListLoader<TODO_CreateEx9>
	{
        ...
        public string FilterExpression
        {
            ...
            set
            {
                ...
                MessageBus.Default.BeginNotify(MessageToken.TODO_CreateEx9FilterExpressionChanged, null,
                                            new NotificationEventArgs<string>(MessageToken.TODO_CreateEx9FilterExpressionChanged, _filterExpression));
            }
        }
        ...
        public IList<TODO_CreateEx9> LoadRange(int startIndex, int count, SortDescriptionCollection sortDescriptions, out int overallCount)
        {
            try
            {
            ...
            catch (Exception ex)
            {
                ...
                overallCount = 0;
                return new List<TODO_CreateEx9>() ;
            }
