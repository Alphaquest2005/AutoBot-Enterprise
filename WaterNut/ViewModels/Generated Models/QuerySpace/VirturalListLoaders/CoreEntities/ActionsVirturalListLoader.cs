...
{
    public partial class ActionsVirturalListLoader : IVirtualListLoader<Actions>
	{
        ...
        public string FilterExpression
        {
            ...
            set
            {
                ...
                MessageBus.Default.BeginNotify(MessageToken.ActionsFilterExpressionChanged, null,
                                            new NotificationEventArgs<string>(MessageToken.ActionsFilterExpressionChanged, _filterExpression));
            }
        }
        ...
        public IList<Actions> LoadRange(int startIndex, int count, SortDescriptionCollection sortDescriptions, out int overallCount)
        {
            try
            {
