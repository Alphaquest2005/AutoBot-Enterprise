...
{
    public partial class FileTypeMappingsVirturalListLoader : IVirtualListLoader<FileTypeMappings>
	{
        ...
        public string FilterExpression
        {
            ...
            set
            {
                ...
                MessageBus.Default.BeginNotify(MessageToken.FileTypeMappingsFilterExpressionChanged, null,
                                            new NotificationEventArgs<string>(MessageToken.FileTypeMappingsFilterExpressionChanged, _filterExpression));
            }
        }
        ...
        public IList<FileTypeMappings> LoadRange(int startIndex, int count, SortDescriptionCollection sortDescriptions, out int overallCount)
        {
            try
            {
            ...
            catch (Exception ex)
            {
                ...
                overallCount = 0;
                return new List<FileTypeMappings>() ;
            }
