...
{
    public partial class ContactsVirturalListLoader : IVirtualListLoader<Contacts>
	{
        ...
        public string FilterExpression
        {
            ...
            set
            {
                ...
                MessageBus.Default.BeginNotify(MessageToken.ContactsFilterExpressionChanged, null,
                                            new NotificationEventArgs<string>(MessageToken.ContactsFilterExpressionChanged, _filterExpression));
            }
        }
        ...
        public IList<Contacts> LoadRange(int startIndex, int count, SortDescriptionCollection sortDescriptions, out int overallCount)
        {
            try
            {
