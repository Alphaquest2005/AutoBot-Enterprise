...
{
    public partial class FileImporterInfoVirturalListLoader : IVirtualListLoader<FileImporterInfo>
	{
        ...
        public string FilterExpression
        {
            ...
            set
            {
                ...
                MessageBus.Default.BeginNotify(MessageToken.FileImporterInfosFilterExpressionChanged, null,
                                            new NotificationEventArgs<string>(MessageToken.FileImporterInfosFilterExpressionChanged, _filterExpression));
            }
        }
        ...
        public IList<FileImporterInfo> LoadRange(int startIndex, int count, SortDescriptionCollection sortDescriptions, out int overallCount)
        {
            try
            {
            ...
            catch (Exception ex)
            {
                ...
                overallCount = 0;
                return new List<FileImporterInfo>() ;
            }
