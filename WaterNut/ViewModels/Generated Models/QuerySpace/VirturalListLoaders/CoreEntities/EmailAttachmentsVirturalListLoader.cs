...
{
    public partial class EmailAttachmentsVirturalListLoader : IVirtualListLoader<EmailAttachments>
	{
        ...
        public string FilterExpression
        {
            ...
            set
            {
                ...
                MessageBus.Default.BeginNotify(MessageToken.EmailAttachmentsFilterExpressionChanged, null,
                                            new NotificationEventArgs<string>(MessageToken.EmailAttachmentsFilterExpressionChanged, _filterExpression));
            }
        }
        ...
        public IList<EmailAttachments> LoadRange(int startIndex, int count, SortDescriptionCollection sortDescriptions, out int overallCount)
        {
            try
            {
            ...
            catch (Exception ex)
            {
                ...
                overallCount = 0;
                return new List<EmailAttachments>() ;
            }
