...
{
    public partial class TODO_DeleteDocumentSetVirturalListLoader : IVirtualListLoader<TODO_DeleteDocumentSet>
	{
        ...
        public string FilterExpression
        {
            ...
            set
            {
                ...
                MessageBus.Default.BeginNotify(MessageToken.TODO_DeleteDocumentSetFilterExpressionChanged, null,
                                            new NotificationEventArgs<string>(MessageToken.TODO_DeleteDocumentSetFilterExpressionChanged, _filterExpression));
            }
        }
        ...
        public IList<TODO_DeleteDocumentSet> LoadRange(int startIndex, int count, SortDescriptionCollection sortDescriptions, out int overallCount)
        {
            try
            {
            ...
            catch (Exception ex)
            {
                ...
                overallCount = 0;
                return new List<TODO_DeleteDocumentSet>() ;
            }
