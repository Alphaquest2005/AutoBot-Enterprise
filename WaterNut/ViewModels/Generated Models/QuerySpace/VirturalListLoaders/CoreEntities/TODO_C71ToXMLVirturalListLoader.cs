...
{
    public partial class TODO_C71ToXMLVirturalListLoader : IVirtualListLoader<TODO_C71ToXML>
	{
        ...
        public string FilterExpression
        {
            ...
            set
            {
                ...
                MessageBus.Default.BeginNotify(MessageToken.TODO_C71ToXMLFilterExpressionChanged, null,
                                            new NotificationEventArgs<string>(MessageToken.TODO_C71ToXMLFilterExpressionChanged, _filterExpression));
            }
        }
        ...
        public IList<TODO_C71ToXML> LoadRange(int startIndex, int count, SortDescriptionCollection sortDescriptions, out int overallCount)
        {
            try
            {
