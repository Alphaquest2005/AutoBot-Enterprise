...
{
    public partial class TODO_SubmitMissingInvoicePDFsVirturalListLoader : IVirtualListLoader<TODO_SubmitMissingInvoicePDFs>
	{
        ...
        public string FilterExpression
        {
            ...
            set
            {
                ...
                MessageBus.Default.BeginNotify(MessageToken.TODO_SubmitMissingInvoicePDFsFilterExpressionChanged, null,
                                            new NotificationEventArgs<string>(MessageToken.TODO_SubmitMissingInvoicePDFsFilterExpressionChanged, _filterExpression));
            }
        }
        ...
        public IList<TODO_SubmitMissingInvoicePDFs> LoadRange(int startIndex, int count, SortDescriptionCollection sortDescriptions, out int overallCount)
        {
            try
            {
            ...
            catch (Exception ex)
            {
                ...
                overallCount = 0;
                return new List<TODO_SubmitMissingInvoicePDFs>() ;
            }
