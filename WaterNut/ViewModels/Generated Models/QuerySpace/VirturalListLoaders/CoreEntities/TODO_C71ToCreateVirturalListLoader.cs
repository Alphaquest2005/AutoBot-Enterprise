...
{
    public partial class TODO_C71ToCreateVirturalListLoader : IVirtualListLoader<TODO_C71ToCreate>
	{
        ...
        public string FilterExpression
        {
            ...
            set
            {
                ...
                MessageBus.Default.BeginNotify(MessageToken.TODO_C71ToCreateFilterExpressionChanged, null,
                                            new NotificationEventArgs<string>(MessageToken.TODO_C71ToCreateFilterExpressionChanged, _filterExpression));
            }
        }
        ...
        public IList<TODO_C71ToCreate> LoadRange(int startIndex, int count, SortDescriptionCollection sortDescriptions, out int overallCount)
        {
            try
            {
            ...
            catch (Exception ex)
            {
                ...
                overallCount = 0;
                return new List<TODO_C71ToCreate>() ;
            }
