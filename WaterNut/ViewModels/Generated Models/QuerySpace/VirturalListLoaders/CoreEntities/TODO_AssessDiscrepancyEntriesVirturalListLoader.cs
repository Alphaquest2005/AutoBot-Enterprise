...
{
    public partial class TODO_AssessDiscrepancyEntriesVirturalListLoader : IVirtualListLoader<TODO_AssessDiscrepancyEntries>
	{
        ...
        public string FilterExpression
        {
            ...
            set
            {
                ...
                MessageBus.Default.BeginNotify(MessageToken.TODO_AssessDiscrepancyEntriesFilterExpressionChanged, null,
                                            new NotificationEventArgs<string>(MessageToken.TODO_AssessDiscrepancyEntriesFilterExpressionChanged, _filterExpression));
            }
        }
        ...
        public IList<TODO_AssessDiscrepancyEntries> LoadRange(int startIndex, int count, SortDescriptionCollection sortDescriptions, out int overallCount)
        {
            try
            {
            ...
            catch (Exception ex)
            {
                ...
                overallCount = 0;
                return new List<TODO_AssessDiscrepancyEntries>() ;
            }
