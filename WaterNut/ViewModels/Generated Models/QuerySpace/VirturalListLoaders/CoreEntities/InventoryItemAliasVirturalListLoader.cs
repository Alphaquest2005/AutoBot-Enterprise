...
{
    public partial class InventoryItemAliasVirturalListLoader : IVirtualListLoader<InventoryItemAlias>
	{
        ...
        public string FilterExpression
        {
            ...
            set
            {
                ...
                MessageBus.Default.BeginNotify(MessageToken.InventoryItemAliasFilterExpressionChanged, null,
                                            new NotificationEventArgs<string>(MessageToken.InventoryItemAliasFilterExpressionChanged, _filterExpression));
            }
        }
        ...
        public IList<InventoryItemAlias> LoadRange(int startIndex, int count, SortDescriptionCollection sortDescriptions, out int overallCount)
        {
            try
            {
            ...
            catch (Exception ex)
            {
                ...
                overallCount = 0;
                return new List<InventoryItemAlias>() ;
            }
