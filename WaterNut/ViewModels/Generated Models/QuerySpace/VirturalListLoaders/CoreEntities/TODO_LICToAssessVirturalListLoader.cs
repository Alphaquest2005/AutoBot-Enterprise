...
{
    public partial class TODO_LICToAssessVirturalListLoader : IVirtualListLoader<TODO_LICToAssess>
	{
        ...
        public string FilterExpression
        {
            ...
            set
            {
                ...
                MessageBus.Default.BeginNotify(MessageToken.TODO_LICToAssessFilterExpressionChanged, null,
                                            new NotificationEventArgs<string>(MessageToken.TODO_LICToAssessFilterExpressionChanged, _filterExpression));
            }
        }
        ...
        public IList<TODO_LICToAssess> LoadRange(int startIndex, int count, SortDescriptionCollection sortDescriptions, out int overallCount)
        {
            try
            {
            ...
            catch (Exception ex)
            {
                ...
                overallCount = 0;
                return new List<TODO_LICToAssess>() ;
            }
