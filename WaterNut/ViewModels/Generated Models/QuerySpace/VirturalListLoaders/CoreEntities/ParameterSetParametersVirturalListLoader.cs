...
{
    public partial class ParameterSetParametersVirturalListLoader : IVirtualListLoader<ParameterSetParameters>
	{
        ...
        public string FilterExpression
        {
            ...
            set
            {
                ...
                MessageBus.Default.BeginNotify(MessageToken.ParameterSetParametersFilterExpressionChanged, null,
                                            new NotificationEventArgs<string>(MessageToken.ParameterSetParametersFilterExpressionChanged, _filterExpression));
            }
        }
        ...
        public IList<ParameterSetParameters> LoadRange(int startIndex, int count, SortDescriptionCollection sortDescriptions, out int overallCount)
        {
            try
            {
            ...
            catch (Exception ex)
            {
                ...
                overallCount = 0;
                return new List<ParameterSetParameters>() ;
            }
