...
{
    public partial class Customs_ProcedureInOutVirturalListLoader : IVirtualListLoader<Customs_ProcedureInOut>
	{
        ...
        public string FilterExpression
        {
            ...
            set
            {
                ...
                MessageBus.Default.BeginNotify(MessageToken.Customs_ProcedureInOutFilterExpressionChanged, null,
                                            new NotificationEventArgs<string>(MessageToken.Customs_ProcedureInOutFilterExpressionChanged, _filterExpression));
            }
        }
        ...
        public IList<Customs_ProcedureInOut> LoadRange(int startIndex, int count, SortDescriptionCollection sortDescriptions, out int overallCount)
        {
            try
            {
            ...
            catch (Exception ex)
            {
                ...
                overallCount = 0;
                return new List<Customs_ProcedureInOut>() ;
            }
