...
{
    public partial class InventoryItemXVirturalListLoader : IVirtualListLoader<InventoryItemX>
	{
        ...
        public string FilterExpression
        {
            ...
            set
            {
                ...
                MessageBus.Default.BeginNotify(MessageToken.InventoryItemXFilterExpressionChanged, null,
                                            new NotificationEventArgs<string>(MessageToken.InventoryItemXFilterExpressionChanged, _filterExpression));
            }
        }
        ...
        public IList<InventoryItemX> LoadRange(int startIndex, int count, SortDescriptionCollection sortDescriptions, out int overallCount)
        {
            try
            {
            ...
            catch (Exception ex)
            {
                ...
                overallCount = 0;
                return new List<InventoryItemX>() ;
            }
