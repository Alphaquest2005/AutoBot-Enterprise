...
{
    public partial class TODO_ERRReport_UnmappedItemsVirturalListLoader : IVirtualListLoader<TODO_ERRReport_UnmappedItems>
	{
        ...
        public string FilterExpression
        {
            ...
            set
            {
                ...
                MessageBus.Default.BeginNotify(MessageToken.TODO_ERRReport_UnmappedItemsFilterExpressionChanged, null,
                                            new NotificationEventArgs<string>(MessageToken.TODO_ERRReport_UnmappedItemsFilterExpressionChanged, _filterExpression));
            }
        }
        ...
        public IList<TODO_ERRReport_UnmappedItems> LoadRange(int startIndex, int count, SortDescriptionCollection sortDescriptions, out int overallCount)
        {
            try
            {
            ...
            catch (Exception ex)
            {
                ...
                overallCount = 0;
                return new List<TODO_ERRReport_UnmappedItems>() ;
            }
