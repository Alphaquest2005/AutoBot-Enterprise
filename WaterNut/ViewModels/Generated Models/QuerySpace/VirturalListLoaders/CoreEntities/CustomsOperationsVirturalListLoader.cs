...
{
    public partial class CustomsOperationsVirturalListLoader : IVirtualListLoader<CustomsOperations>
	{
        ...
        public string FilterExpression
        {
            ...
            set
            {
                ...
                MessageBus.Default.BeginNotify(MessageToken.CustomsOperationsFilterExpressionChanged, null,
                                            new NotificationEventArgs<string>(MessageToken.CustomsOperationsFilterExpressionChanged, _filterExpression));
            }
        }
        ...
        public IList<CustomsOperations> LoadRange(int startIndex, int count, SortDescriptionCollection sortDescriptions, out int overallCount)
        {
            try
            {
            ...
            catch (Exception ex)
            {
                ...
                overallCount = 0;
                return new List<CustomsOperations>() ;
            }
