...
{
    public partial class TODO_SubmitEntryCIFVirturalListLoader : IVirtualListLoader<TODO_SubmitEntryCIF>
	{
        ...
        public string FilterExpression
        {
            ...
            set
            {
                ...
                MessageBus.Default.BeginNotify(MessageToken.TODO_SubmitEntryCIFFilterExpressionChanged, null,
                                            new NotificationEventArgs<string>(MessageToken.TODO_SubmitEntryCIFFilterExpressionChanged, _filterExpression));
            }
        }
        ...
        public IList<TODO_SubmitEntryCIF> LoadRange(int startIndex, int count, SortDescriptionCollection sortDescriptions, out int overallCount)
        {
            try
            {
            ...
            catch (Exception ex)
            {
                ...
                overallCount = 0;
                return new List<TODO_SubmitEntryCIF>() ;
            }
