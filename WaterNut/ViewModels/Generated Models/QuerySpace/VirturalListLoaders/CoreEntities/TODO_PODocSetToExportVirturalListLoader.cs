...
{
    public partial class TODO_PODocSetToExportVirturalListLoader : IVirtualListLoader<TODO_PODocSetToExport>
	{
        ...
        public string FilterExpression
        {
            ...
            set
            {
                ...
                MessageBus.Default.BeginNotify(MessageToken.TODO_PODocSetToExportFilterExpressionChanged, null,
                                            new NotificationEventArgs<string>(MessageToken.TODO_PODocSetToExportFilterExpressionChanged, _filterExpression));
            }
        }
        ...
        public IList<TODO_PODocSetToExport> LoadRange(int startIndex, int count, SortDescriptionCollection sortDescriptions, out int overallCount)
        {
            try
            {
            ...
            catch (Exception ex)
            {
                ...
                overallCount = 0;
                return new List<TODO_PODocSetToExport>() ;
            }
