...
{
    public partial class AsycudaItemBasicInfoVirturalListLoader : IVirtualListLoader<AsycudaItemBasicInfo>
	{
        ...
        public string FilterExpression
        {
            ...
            set
            {
                ...
                MessageBus.Default.BeginNotify(MessageToken.AsycudaItemBasicInfoFilterExpressionChanged, null,
                                            new NotificationEventArgs<string>(MessageToken.AsycudaItemBasicInfoFilterExpressionChanged, _filterExpression));
            }
        }
        ...
        public IList<AsycudaItemBasicInfo> LoadRange(int startIndex, int count, SortDescriptionCollection sortDescriptions, out int overallCount)
        {
            try
            {
            ...
            catch (Exception ex)
            {
                ...
                overallCount = 0;
                return new List<AsycudaItemBasicInfo>() ;
            }
