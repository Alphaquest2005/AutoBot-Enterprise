...
{
    public partial class TODO_DiscrepanciesToSubmitVirturalListLoader : IVirtualListLoader<TODO_DiscrepanciesToSubmit>
	{
        ...
        public string FilterExpression
        {
            ...
            set
            {
                ...
                MessageBus.Default.BeginNotify(MessageToken.TODO_DiscrepanciesToSubmitFilterExpressionChanged, null,
                                            new NotificationEventArgs<string>(MessageToken.TODO_DiscrepanciesToSubmitFilterExpressionChanged, _filterExpression));
            }
        }
        ...
        public IList<TODO_DiscrepanciesToSubmit> LoadRange(int startIndex, int count, SortDescriptionCollection sortDescriptions, out int overallCount)
        {
            try
            {
            ...
            catch (Exception ex)
            {
                ...
                overallCount = 0;
                return new List<TODO_DiscrepanciesToSubmit>() ;
            }
