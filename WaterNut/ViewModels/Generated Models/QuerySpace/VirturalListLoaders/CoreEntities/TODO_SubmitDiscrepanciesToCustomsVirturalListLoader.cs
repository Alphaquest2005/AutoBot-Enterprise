...
{
    public partial class TODO_SubmitDiscrepanciesToCustomsVirturalListLoader : IVirtualListLoader<TODO_SubmitDiscrepanciesToCustoms>
	{
        ...
        public string FilterExpression
        {
            ...
            set
            {
                ...
                MessageBus.Default.BeginNotify(MessageToken.TODO_SubmitDiscrepanciesToCustomsFilterExpressionChanged, null,
                                            new NotificationEventArgs<string>(MessageToken.TODO_SubmitDiscrepanciesToCustomsFilterExpressionChanged, _filterExpression));
            }
        }
        ...
        public IList<TODO_SubmitDiscrepanciesToCustoms> LoadRange(int startIndex, int count, SortDescriptionCollection sortDescriptions, out int overallCount)
        {
            try
            {
            ...
            catch (Exception ex)
            {
                ...
                overallCount = 0;
                return new List<TODO_SubmitDiscrepanciesToCustoms>() ;
            }
