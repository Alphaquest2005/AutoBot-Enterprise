...
{
    public partial class ParametersVirturalListLoader : IVirtualListLoader<Parameters>
	{
        ...
        public string FilterExpression
        {
            ...
            set
            {
                ...
                MessageBus.Default.BeginNotify(MessageToken.ParametersFilterExpressionChanged, null,
                                            new NotificationEventArgs<string>(MessageToken.ParametersFilterExpressionChanged, _filterExpression));
            }
        }
        ...
        public IList<Parameters> LoadRange(int startIndex, int count, SortDescriptionCollection sortDescriptions, out int overallCount)
        {
            try
            {
