...
{
    public partial class TODO_PODocSetToAssessVirturalListLoader : IVirtualListLoader<TODO_PODocSetToAssess>
	{
        ...
        public string FilterExpression
        {
            ...
            set
            {
                ...
                MessageBus.Default.BeginNotify(MessageToken.TODO_PODocSetToAssessFilterExpressionChanged, null,
                                            new NotificationEventArgs<string>(MessageToken.TODO_PODocSetToAssessFilterExpressionChanged, _filterExpression));
            }
        }
        ...
        public IList<TODO_PODocSetToAssess> LoadRange(int startIndex, int count, SortDescriptionCollection sortDescriptions, out int overallCount)
        {
            try
            {
            ...
            catch (Exception ex)
            {
                ...
                overallCount = 0;
                return new List<TODO_PODocSetToAssess>() ;
            }
