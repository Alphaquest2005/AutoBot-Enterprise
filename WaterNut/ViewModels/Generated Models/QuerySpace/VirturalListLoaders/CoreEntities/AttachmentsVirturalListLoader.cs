...
{
    public partial class AttachmentsVirturalListLoader : IVirtualListLoader<Attachments>
	{
        ...
        public string FilterExpression
        {
            ...
            set
            {
                ...
                MessageBus.Default.BeginNotify(MessageToken.AttachmentsFilterExpressionChanged, null,
                                            new NotificationEventArgs<string>(MessageToken.AttachmentsFilterExpressionChanged, _filterExpression));
            }
        }
        ...
        public IList<Attachments> LoadRange(int startIndex, int count, SortDescriptionCollection sortDescriptions, out int overallCount)
        {
            try
            {
