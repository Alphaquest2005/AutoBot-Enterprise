...
{
    public partial class TODO_SubmitPOInfoVirturalListLoader : IVirtualListLoader<TODO_SubmitPOInfo>
	{
        ...
        public string FilterExpression
        {
            ...
            set
            {
                ...
                MessageBus.Default.BeginNotify(MessageToken.TODO_SubmitPOInfoFilterExpressionChanged, null,
                                            new NotificationEventArgs<string>(MessageToken.TODO_SubmitPOInfoFilterExpressionChanged, _filterExpression));
            }
        }
        ...
        public IList<TODO_SubmitPOInfo> LoadRange(int startIndex, int count, SortDescriptionCollection sortDescriptions, out int overallCount)
        {
            try
            {
            ...
            catch (Exception ex)
            {
                ...
                overallCount = 0;
                return new List<TODO_SubmitPOInfo>() ;
            }
