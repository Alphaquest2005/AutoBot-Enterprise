...
{
    public partial class TODO_DiscrepanciesAlreadyXMLedVirturalListLoader : IVirtualListLoader<TODO_DiscrepanciesAlreadyXMLed>
	{
        ...
        public string FilterExpression
        {
            ...
            set
            {
                ...
                MessageBus.Default.BeginNotify(MessageToken.TODO_DiscrepanciesAlreadyXMLedFilterExpressionChanged, null,
                                            new NotificationEventArgs<string>(MessageToken.TODO_DiscrepanciesAlreadyXMLedFilterExpressionChanged, _filterExpression));
            }
        }
        ...
        public IList<TODO_DiscrepanciesAlreadyXMLed> LoadRange(int startIndex, int count, SortDescriptionCollection sortDescriptions, out int overallCount)
        {
            try
            {
            ...
            catch (Exception ex)
            {
                ...
                overallCount = 0;
                return new List<TODO_DiscrepanciesAlreadyXMLed>() ;
            }
