...
{
    public partial class SessionScheduleVirturalListLoader : IVirtualListLoader<SessionSchedule>
	{
        ...
        public string FilterExpression
        {
            ...
            set
            {
                ...
                MessageBus.Default.BeginNotify(MessageToken.SessionScheduleFilterExpressionChanged, null,
                                            new NotificationEventArgs<string>(MessageToken.SessionScheduleFilterExpressionChanged, _filterExpression));
            }
        }
        ...
        public IList<SessionSchedule> LoadRange(int startIndex, int count, SortDescriptionCollection sortDescriptions, out int overallCount)
        {
            try
            {
            ...
            catch (Exception ex)
            {
                ...
                overallCount = 0;
                return new List<SessionSchedule>() ;
            }
