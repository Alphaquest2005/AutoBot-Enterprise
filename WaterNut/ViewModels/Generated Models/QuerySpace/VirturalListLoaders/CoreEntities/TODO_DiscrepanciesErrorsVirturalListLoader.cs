...
{
    public partial class TODO_DiscrepanciesErrorsVirturalListLoader : IVirtualListLoader<TODO_DiscrepanciesErrors>
	{
        ...
        public string FilterExpression
        {
            ...
            set
            {
                ...
                MessageBus.Default.BeginNotify(MessageToken.TODO_DiscrepanciesErrorsFilterExpressionChanged, null,
                                            new NotificationEventArgs<string>(MessageToken.TODO_DiscrepanciesErrorsFilterExpressionChanged, _filterExpression));
            }
        }
        ...
        public IList<TODO_DiscrepanciesErrors> LoadRange(int startIndex, int count, SortDescriptionCollection sortDescriptions, out int overallCount)
        {
            try
            {
            ...
            catch (Exception ex)
            {
                ...
                overallCount = 0;
                return new List<TODO_DiscrepanciesErrors>() ;
            }
