...
{
    public partial class ToDo_POToXML_RecreateVirturalListLoader : IVirtualListLoader<ToDo_POToXML_Recreate>
	{
        ...
        public string FilterExpression
        {
            ...
            set
            {
                ...
                MessageBus.Default.BeginNotify(MessageToken.ToDo_POToXML_RecreateFilterExpressionChanged, null,
                                            new NotificationEventArgs<string>(MessageToken.ToDo_POToXML_RecreateFilterExpressionChanged, _filterExpression));
            }
        }
        ...
        public IList<ToDo_POToXML_Recreate> LoadRange(int startIndex, int count, SortDescriptionCollection sortDescriptions, out int overallCount)
        {
            try
            {
            ...
            catch (Exception ex)
            {
                ...
                overallCount = 0;
                return new List<ToDo_POToXML_Recreate>() ;
            }
