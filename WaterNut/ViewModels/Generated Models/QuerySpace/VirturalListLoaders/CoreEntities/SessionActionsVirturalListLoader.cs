...
{
    public partial class SessionActionsVirturalListLoader : IVirtualListLoader<SessionActions>
	{
        ...
        public string FilterExpression
        {
            ...
            set
            {
                ...
                MessageBus.Default.BeginNotify(MessageToken.SessionActionsFilterExpressionChanged, null,
                                            new NotificationEventArgs<string>(MessageToken.SessionActionsFilterExpressionChanged, _filterExpression));
            }
        }
        ...
        public IList<SessionActions> LoadRange(int startIndex, int count, SortDescriptionCollection sortDescriptions, out int overallCount)
        {
            try
            {
            ...
            catch (Exception ex)
            {
                ...
                overallCount = 0;
                return new List<SessionActions>() ;
            }
