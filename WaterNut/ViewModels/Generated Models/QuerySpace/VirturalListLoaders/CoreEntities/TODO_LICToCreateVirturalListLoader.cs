...
{
    public partial class TODO_LICToCreateVirturalListLoader : IVirtualListLoader<TODO_LICToCreate>
	{
        ...
        public string FilterExpression
        {
            ...
            set
            {
                ...
                MessageBus.Default.BeginNotify(MessageToken.TODO_LICToCreateFilterExpressionChanged, null,
                                            new NotificationEventArgs<string>(MessageToken.TODO_LICToCreateFilterExpressionChanged, _filterExpression));
            }
        }
        ...
        public IList<TODO_LICToCreate> LoadRange(int startIndex, int count, SortDescriptionCollection sortDescriptions, out int overallCount)
        {
            try
            {
            ...
            catch (Exception ex)
            {
                ...
                overallCount = 0;
                return new List<TODO_LICToCreate>() ;
            }
