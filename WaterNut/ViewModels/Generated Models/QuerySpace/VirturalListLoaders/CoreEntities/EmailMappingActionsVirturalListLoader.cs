...
{
    public partial class EmailMappingActionsVirturalListLoader : IVirtualListLoader<EmailMappingActions>
	{
        ...
        public string FilterExpression
        {
            ...
            set
            {
                ...
                MessageBus.Default.BeginNotify(MessageToken.EmailMappingActionsFilterExpressionChanged, null,
                                            new NotificationEventArgs<string>(MessageToken.EmailMappingActionsFilterExpressionChanged, _filterExpression));
            }
        }
        ...
        public IList<EmailMappingActions> LoadRange(int startIndex, int count, SortDescriptionCollection sortDescriptions, out int overallCount)
        {
            try
            {
            ...
            catch (Exception ex)
            {
                ...
                overallCount = 0;
                return new List<EmailMappingActions>() ;
            }
