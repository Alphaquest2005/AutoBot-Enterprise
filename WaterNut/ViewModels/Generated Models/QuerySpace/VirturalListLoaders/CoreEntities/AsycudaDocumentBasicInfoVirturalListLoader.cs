...
{
    public partial class AsycudaDocumentBasicInfoVirturalListLoader : IVirtualListLoader<AsycudaDocumentBasicInfo>
	{
        ...
        public string FilterExpression
        {
            ...
            set
            {
                ...
                MessageBus.Default.BeginNotify(MessageToken.AsycudaDocumentBasicInfoFilterExpressionChanged, null,
                                            new NotificationEventArgs<string>(MessageToken.AsycudaDocumentBasicInfoFilterExpressionChanged, _filterExpression));
            }
        }
        ...
        public IList<AsycudaDocumentBasicInfo> LoadRange(int startIndex, int count, SortDescriptionCollection sortDescriptions, out int overallCount)
        {
            try
            {
            ...
            catch (Exception ex)
            {
                ...
                overallCount = 0;
                return new List<AsycudaDocumentBasicInfo>() ;
            }
