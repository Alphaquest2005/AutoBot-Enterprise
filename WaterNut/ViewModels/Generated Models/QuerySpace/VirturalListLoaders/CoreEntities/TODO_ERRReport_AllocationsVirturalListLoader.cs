...
{
    public partial class TODO_ERRReport_AllocationsVirturalListLoader : IVirtualListLoader<TODO_ERRReport_Allocations>
	{
        ...
        public string FilterExpression
        {
            ...
            set
            {
                ...
                MessageBus.Default.BeginNotify(MessageToken.TODO_ERRReport_AllocationsFilterExpressionChanged, null,
                                            new NotificationEventArgs<string>(MessageToken.TODO_ERRReport_AllocationsFilterExpressionChanged, _filterExpression));
            }
        }
        ...
        public IList<TODO_ERRReport_Allocations> LoadRange(int startIndex, int count, SortDescriptionCollection sortDescriptions, out int overallCount)
        {
            try
            {
                if (FilterExpression == null) FilterExpression = "All";
			    using (var ctx = new TODO_ERRReport_AllocationsRepository())
				{
            ...
            catch (Exception ex)
            {
                ...
                overallCount = 0;
                return new List<TODO_ERRReport_Allocations>() ;
            }
