...
{
    public partial class TODO_LicenceAvailableQtyVirturalListLoader : IVirtualListLoader<TODO_LicenceAvailableQty>
	{
        ...
        public string FilterExpression
        {
            ...
            set
            {
                ...
                MessageBus.Default.BeginNotify(MessageToken.TODO_LicenceAvailableQtyFilterExpressionChanged, null,
                                            new NotificationEventArgs<string>(MessageToken.TODO_LicenceAvailableQtyFilterExpressionChanged, _filterExpression));
            }
        }
        ...
        public IList<TODO_LicenceAvailableQty> LoadRange(int startIndex, int count, SortDescriptionCollection sortDescriptions, out int overallCount)
        {
            try
            {
            ...
            catch (Exception ex)
            {
                ...
                overallCount = 0;
                return new List<TODO_LicenceAvailableQty>() ;
            }
