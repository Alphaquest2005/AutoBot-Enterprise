...
{
    public partial class InventoryItemsVirturalListLoader : IVirtualListLoader<InventoryItems>
	{
        ...
        public string FilterExpression
        {
            ...
            set
            {
                ...
                MessageBus.Default.BeginNotify(MessageToken.InventoryItemsFilterExpressionChanged, null,
                                            new NotificationEventArgs<string>(MessageToken.InventoryItemsFilterExpressionChanged, _filterExpression));
            }
        }
        ...
        public IList<InventoryItems> LoadRange(int startIndex, int count, SortDescriptionCollection sortDescriptions, out int overallCount)
        {
            try
            {
