...
{
    public partial class TODO_SubmitAllXMLToCustomsVirturalListLoader : IVirtualListLoader<TODO_SubmitAllXMLToCustoms>
	{
        ...
        public string FilterExpression
        {
            ...
            set
            {
                ...
                MessageBus.Default.BeginNotify(MessageToken.TODO_SubmitAllXMLToCustomsFilterExpressionChanged, null,
                                            new NotificationEventArgs<string>(MessageToken.TODO_SubmitAllXMLToCustomsFilterExpressionChanged, _filterExpression));
            }
        }
        ...
        public IList<TODO_SubmitAllXMLToCustoms> LoadRange(int startIndex, int count, SortDescriptionCollection sortDescriptions, out int overallCount)
        {
            try
            {
            ...
            catch (Exception ex)
            {
                ...
                overallCount = 0;
                return new List<TODO_SubmitAllXMLToCustoms>() ;
            }
