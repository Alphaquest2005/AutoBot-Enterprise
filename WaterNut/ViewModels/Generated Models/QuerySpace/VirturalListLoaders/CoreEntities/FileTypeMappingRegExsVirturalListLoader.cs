...
{
    public partial class FileTypeMappingRegExsVirturalListLoader : IVirtualListLoader<FileTypeMappingRegExs>
	{
        ...
        public string FilterExpression
        {
            ...
            set
            {
                ...
                MessageBus.Default.BeginNotify(MessageToken.FileTypeMappingRegExsFilterExpressionChanged, null,
                                            new NotificationEventArgs<string>(MessageToken.FileTypeMappingRegExsFilterExpressionChanged, _filterExpression));
            }
        }
        ...
        public IList<FileTypeMappingRegExs> LoadRange(int startIndex, int count, SortDescriptionCollection sortDescriptions, out int overallCount)
        {
            try
            {
            ...
            catch (Exception ex)
            {
                ...
                overallCount = 0;
                return new List<FileTypeMappingRegExs>() ;
            }
