...
{
    public partial class TODO_ImportCompleteEntriesVirturalListLoader : IVirtualListLoader<TODO_ImportCompleteEntries>
	{
        ...
        public string FilterExpression
        {
            ...
            set
            {
                ...
                MessageBus.Default.BeginNotify(MessageToken.TODO_ImportCompleteEntriesFilterExpressionChanged, null,
                                            new NotificationEventArgs<string>(MessageToken.TODO_ImportCompleteEntriesFilterExpressionChanged, _filterExpression));
            }
        }
        ...
        public IList<TODO_ImportCompleteEntries> LoadRange(int startIndex, int count, SortDescriptionCollection sortDescriptions, out int overallCount)
        {
            try
            {
            ...
            catch (Exception ex)
            {
                ...
                overallCount = 0;
                return new List<TODO_ImportCompleteEntries>() ;
            }
