...
{
    public partial class FileTypeContactsVirturalListLoader : IVirtualListLoader<FileTypeContacts>
	{
        ...
        public string FilterExpression
        {
            ...
            set
            {
                ...
                MessageBus.Default.BeginNotify(MessageToken.FileTypeContactsFilterExpressionChanged, null,
                                            new NotificationEventArgs<string>(MessageToken.FileTypeContactsFilterExpressionChanged, _filterExpression));
            }
        }
        ...
        public IList<FileTypeContacts> LoadRange(int startIndex, int count, SortDescriptionCollection sortDescriptions, out int overallCount)
        {
            try
            {
            ...
            catch (Exception ex)
            {
                ...
                overallCount = 0;
                return new List<FileTypeContacts>() ;
            }
