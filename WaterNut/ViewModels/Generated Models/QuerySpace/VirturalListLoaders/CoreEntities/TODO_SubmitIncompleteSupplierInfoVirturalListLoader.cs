...
{
    public partial class TODO_SubmitIncompleteSupplierInfoVirturalListLoader : IVirtualListLoader<TODO_SubmitIncompleteSupplierInfo>
	{
        ...
        public string FilterExpression
        {
            ...
            set
            {
                ...
                MessageBus.Default.BeginNotify(MessageToken.TODO_SubmitIncompleteSupplierInfoFilterExpressionChanged, null,
                                            new NotificationEventArgs<string>(MessageToken.TODO_SubmitIncompleteSupplierInfoFilterExpressionChanged, _filterExpression));
            }
        }
        ...
        public IList<TODO_SubmitIncompleteSupplierInfo> LoadRange(int startIndex, int count, SortDescriptionCollection sortDescriptions, out int overallCount)
        {
            try
            {
            ...
            catch (Exception ex)
            {
                ...
                overallCount = 0;
                return new List<TODO_SubmitIncompleteSupplierInfo>() ;
            }
