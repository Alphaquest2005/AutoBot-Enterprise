...
{
    public partial class ImportActionsVirturalListLoader : IVirtualListLoader<ImportActions>
	{
        ...
        public string FilterExpression
        {
            ...
            set
            {
                ...
                MessageBus.Default.BeginNotify(MessageToken.ImportActionsFilterExpressionChanged, null,
                                            new NotificationEventArgs<string>(MessageToken.ImportActionsFilterExpressionChanged, _filterExpression));
            }
        }
        ...
        public IList<ImportActions> LoadRange(int startIndex, int count, SortDescriptionCollection sortDescriptions, out int overallCount)
        {
            try
            {
