...
{
    public partial class TODO_EntriesExpiringNextMonthVirturalListLoader : IVirtualListLoader<TODO_EntriesExpiringNextMonth>
	{
        ...
        public string FilterExpression
        {
            ...
            set
            {
                ...
                MessageBus.Default.BeginNotify(MessageToken.TODO_EntriesExpiringNextMonthFilterExpressionChanged, null,
                                            new NotificationEventArgs<string>(MessageToken.TODO_EntriesExpiringNextMonthFilterExpressionChanged, _filterExpression));
            }
        }
        ...
        public IList<TODO_EntriesExpiringNextMonth> LoadRange(int startIndex, int count, SortDescriptionCollection sortDescriptions, out int overallCount)
        {
            try
            {
            ...
            catch (Exception ex)
            {
                ...
                overallCount = 0;
                return new List<TODO_EntriesExpiringNextMonth>() ;
            }
