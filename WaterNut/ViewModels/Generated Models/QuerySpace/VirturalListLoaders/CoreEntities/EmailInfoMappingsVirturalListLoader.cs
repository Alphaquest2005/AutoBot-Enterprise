...
{
    public partial class EmailInfoMappingsVirturalListLoader : IVirtualListLoader<EmailInfoMappings>
	{
        ...
        public string FilterExpression
        {
            ...
            set
            {
                ...
                MessageBus.Default.BeginNotify(MessageToken.EmailInfoMappingsFilterExpressionChanged, null,
                                            new NotificationEventArgs<string>(MessageToken.EmailInfoMappingsFilterExpressionChanged, _filterExpression));
            }
        }
        ...
        public IList<EmailInfoMappings> LoadRange(int startIndex, int count, SortDescriptionCollection sortDescriptions, out int overallCount)
        {
            try
            {
            ...
            catch (Exception ex)
            {
                ...
                overallCount = 0;
                return new List<EmailInfoMappings>() ;
            }
