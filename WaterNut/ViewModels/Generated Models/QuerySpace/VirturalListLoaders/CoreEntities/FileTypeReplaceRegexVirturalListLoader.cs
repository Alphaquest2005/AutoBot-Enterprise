...
{
    public partial class FileTypeReplaceRegexVirturalListLoader : IVirtualListLoader<FileTypeReplaceRegex>
	{
        ...
        public string FilterExpression
        {
            ...
            set
            {
                ...
                MessageBus.Default.BeginNotify(MessageToken.FileTypeReplaceRegexFilterExpressionChanged, null,
                                            new NotificationEventArgs<string>(MessageToken.FileTypeReplaceRegexFilterExpressionChanged, _filterExpression));
            }
        }
        ...
        public IList<FileTypeReplaceRegex> LoadRange(int startIndex, int count, SortDescriptionCollection sortDescriptions, out int overallCount)
        {
            try
            {
            ...
            catch (Exception ex)
            {
                ...
                overallCount = 0;
                return new List<FileTypeReplaceRegex>() ;
            }
