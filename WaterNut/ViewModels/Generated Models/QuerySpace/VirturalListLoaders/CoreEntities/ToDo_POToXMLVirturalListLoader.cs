...
{
    public partial class ToDo_POToXMLVirturalListLoader : IVirtualListLoader<ToDo_POToXML>
	{
        ...
        public string FilterExpression
        {
            ...
            set
            {
                ...
                MessageBus.Default.BeginNotify(MessageToken.ToDo_POToXMLFilterExpressionChanged, null,
                                            new NotificationEventArgs<string>(MessageToken.ToDo_POToXMLFilterExpressionChanged, _filterExpression));
            }
        }
        ...
        public IList<ToDo_POToXML> LoadRange(int startIndex, int count, SortDescriptionCollection sortDescriptions, out int overallCount)
        {
            try
            {
