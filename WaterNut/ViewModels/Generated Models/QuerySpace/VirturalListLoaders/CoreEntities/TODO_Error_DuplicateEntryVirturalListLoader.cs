...
{
    public partial class TODO_Error_DuplicateEntryVirturalListLoader : IVirtualListLoader<TODO_Error_DuplicateEntry>
	{
        ...
        public string FilterExpression
        {
            ...
            set
            {
                ...
                MessageBus.Default.BeginNotify(MessageToken.TODO_Error_DuplicateEntryFilterExpressionChanged, null,
                                            new NotificationEventArgs<string>(MessageToken.TODO_Error_DuplicateEntryFilterExpressionChanged, _filterExpression));
            }
        }
        ...
        public IList<TODO_Error_DuplicateEntry> LoadRange(int startIndex, int count, SortDescriptionCollection sortDescriptions, out int overallCount)
        {
            try
            {
            ...
            catch (Exception ex)
            {
                ...
                overallCount = 0;
                return new List<TODO_Error_DuplicateEntry>() ;
            }
