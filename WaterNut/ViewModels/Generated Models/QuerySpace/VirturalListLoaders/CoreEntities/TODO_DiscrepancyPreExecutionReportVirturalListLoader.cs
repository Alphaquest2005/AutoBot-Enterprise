...
{
    public partial class TODO_DiscrepancyPreExecutionReportVirturalListLoader : IVirtualListLoader<TODO_DiscrepancyPreExecutionReport>
	{
        ...
        public string FilterExpression
        {
            ...
            set
            {
                ...
                MessageBus.Default.BeginNotify(MessageToken.TODO_DiscrepancyPreExecutionReportFilterExpressionChanged, null,
                                            new NotificationEventArgs<string>(MessageToken.TODO_DiscrepancyPreExecutionReportFilterExpressionChanged, _filterExpression));
            }
        }
        ...
        public IList<TODO_DiscrepancyPreExecutionReport> LoadRange(int startIndex, int count, SortDescriptionCollection sortDescriptions, out int overallCount)
        {
            try
            {
                if (FilterExpression == null) FilterExpression = "All";
			    using (var ctx = new TODO_DiscrepancyPreExecutionReportRepository())
				{
            ...
            catch (Exception ex)
            {
                ...
                overallCount = 0;
                return new List<TODO_DiscrepancyPreExecutionReport>() ;
            }
