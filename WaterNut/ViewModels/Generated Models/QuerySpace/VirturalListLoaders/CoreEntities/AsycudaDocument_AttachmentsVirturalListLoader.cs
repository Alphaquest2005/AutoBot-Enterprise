...
{
    public partial class AsycudaDocument_AttachmentsVirturalListLoader : IVirtualListLoader<AsycudaDocument_Attachments>
	{
        ...
        public string FilterExpression
        {
            ...
            set
            {
                ...
                MessageBus.Default.BeginNotify(MessageToken.AsycudaDocument_AttachmentsFilterExpressionChanged, null,
                                            new NotificationEventArgs<string>(MessageToken.AsycudaDocument_AttachmentsFilterExpressionChanged, _filterExpression));
            }
        }
        ...
        public IList<AsycudaDocument_Attachments> LoadRange(int startIndex, int count, SortDescriptionCollection sortDescriptions, out int overallCount)
        {
            try
            {
            ...
            catch (Exception ex)
            {
                ...
                overallCount = 0;
                return new List<AsycudaDocument_Attachments>() ;
            }
