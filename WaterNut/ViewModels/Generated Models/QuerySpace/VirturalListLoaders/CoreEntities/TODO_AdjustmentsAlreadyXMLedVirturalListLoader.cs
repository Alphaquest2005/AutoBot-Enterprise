...
{
    public partial class TODO_AdjustmentsAlreadyXMLedVirturalListLoader : IVirtualListLoader<TODO_AdjustmentsAlreadyXMLed>
	{
        ...
        public string FilterExpression
        {
            ...
            set
            {
                ...
                MessageBus.Default.BeginNotify(MessageToken.TODO_AdjustmentsAlreadyXMLedFilterExpressionChanged, null,
                                            new NotificationEventArgs<string>(MessageToken.TODO_AdjustmentsAlreadyXMLedFilterExpressionChanged, _filterExpression));
            }
        }
        ...
        public IList<TODO_AdjustmentsAlreadyXMLed> LoadRange(int startIndex, int count, SortDescriptionCollection sortDescriptions, out int overallCount)
        {
            try
            {
            ...
            catch (Exception ex)
            {
                ...
                overallCount = 0;
                return new List<TODO_AdjustmentsAlreadyXMLed>() ;
            }
