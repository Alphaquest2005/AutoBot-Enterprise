...
{
    public partial class ParameterSetVirturalListLoader : IVirtualListLoader<ParameterSet>
	{
        ...
        public string FilterExpression
        {
            ...
            set
            {
                ...
                MessageBus.Default.BeginNotify(MessageToken.ParameterSetFilterExpressionChanged, null,
                                            new NotificationEventArgs<string>(MessageToken.ParameterSetFilterExpressionChanged, _filterExpression));
            }
        }
        ...
        public IList<ParameterSet> LoadRange(int startIndex, int count, SortDescriptionCollection sortDescriptions, out int overallCount)
        {
            try
            {
