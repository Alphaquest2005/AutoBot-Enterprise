...
{
    public partial class FileTypesVirturalListLoader : IVirtualListLoader<FileTypes>
	{
        ...
        public string FilterExpression
        {
            ...
            set
            {
                ...
                MessageBus.Default.BeginNotify(MessageToken.FileTypesFilterExpressionChanged, null,
                                            new NotificationEventArgs<string>(MessageToken.FileTypesFilterExpressionChanged, _filterExpression));
            }
        }
        ...
        public IList<FileTypes> LoadRange(int startIndex, int count, SortDescriptionCollection sortDescriptions, out int overallCount)
        {
            try
            {
