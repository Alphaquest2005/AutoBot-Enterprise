...
{
    public partial class CancelledEntriesLstVirturalListLoader : IVirtualListLoader<CancelledEntriesLst>
	{
        ...
        public string FilterExpression
        {
            ...
            set
            {
                ...
                MessageBus.Default.BeginNotify(MessageToken.CancelledEntriesLstFilterExpressionChanged, null,
                                            new NotificationEventArgs<string>(MessageToken.CancelledEntriesLstFilterExpressionChanged, _filterExpression));
            }
        }
        ...
        public IList<CancelledEntriesLst> LoadRange(int startIndex, int count, SortDescriptionCollection sortDescriptions, out int overallCount)
        {
            try
            {
            ...
            catch (Exception ex)
            {
                ...
                overallCount = 0;
                return new List<CancelledEntriesLst>() ;
            }
