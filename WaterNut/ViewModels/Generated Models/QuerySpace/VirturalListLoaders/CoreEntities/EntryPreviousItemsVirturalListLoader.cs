...
{
    public partial class EntryPreviousItemsVirturalListLoader : IVirtualListLoader<EntryPreviousItems>
	{
        ...
        public string FilterExpression
        {
            ...
            set
            {
                ...
                MessageBus.Default.BeginNotify(MessageToken.EntryPreviousItemsFilterExpressionChanged, null,
                                            new NotificationEventArgs<string>(MessageToken.EntryPreviousItemsFilterExpressionChanged, _filterExpression));
            }
        }
        ...
        public IList<EntryPreviousItems> LoadRange(int startIndex, int count, SortDescriptionCollection sortDescriptions, out int overallCount)
        {
            try
            {
            ...
            catch (Exception ex)
            {
                ...
                overallCount = 0;
                return new List<EntryPreviousItems>() ;
            }
