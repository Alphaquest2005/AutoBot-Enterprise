...
{
    public partial class TODO_ERRReport_SubmitWarehouseErrorsVirturalListLoader : IVirtualListLoader<TODO_ERRReport_SubmitWarehouseErrors>
	{
        ...
        public string FilterExpression
        {
            ...
            set
            {
                ...
                MessageBus.Default.BeginNotify(MessageToken.TODO_ERRReport_SubmitWarehouseErrorsFilterExpressionChanged, null,
                                            new NotificationEventArgs<string>(MessageToken.TODO_ERRReport_SubmitWarehouseErrorsFilterExpressionChanged, _filterExpression));
            }
        }
        ...
        public IList<TODO_ERRReport_SubmitWarehouseErrors> LoadRange(int startIndex, int count, SortDescriptionCollection sortDescriptions, out int overallCount)
        {
            try
            {
            ...
            catch (Exception ex)
            {
                ...
                overallCount = 0;
                return new List<TODO_ERRReport_SubmitWarehouseErrors>() ;
            }
