...
{
    public partial class TODO_SubmitInadequatePackagesVirturalListLoader : IVirtualListLoader<TODO_SubmitInadequatePackages>
	{
        ...
        public string FilterExpression
        {
            ...
            set
            {
                ...
                MessageBus.Default.BeginNotify(MessageToken.TODO_SubmitInadequatePackagesFilterExpressionChanged, null,
                                            new NotificationEventArgs<string>(MessageToken.TODO_SubmitInadequatePackagesFilterExpressionChanged, _filterExpression));
            }
        }
        ...
        public IList<TODO_SubmitInadequatePackages> LoadRange(int startIndex, int count, SortDescriptionCollection sortDescriptions, out int overallCount)
        {
            try
            {
            ...
            catch (Exception ex)
            {
                ...
                overallCount = 0;
                return new List<TODO_SubmitInadequatePackages>() ;
            }
