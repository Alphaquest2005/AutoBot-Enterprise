...
{
    public partial class TODO_LicenseToXMLVirturalListLoader : IVirtualListLoader<TODO_LicenseToXML>
	{
        ...
        public string FilterExpression
        {
            ...
            set
            {
                ...
                MessageBus.Default.BeginNotify(MessageToken.TODO_LicenseToXMLFilterExpressionChanged, null,
                                            new NotificationEventArgs<string>(MessageToken.TODO_LicenseToXMLFilterExpressionChanged, _filterExpression));
            }
        }
        ...
        public IList<TODO_LicenseToXML> LoadRange(int startIndex, int count, SortDescriptionCollection sortDescriptions, out int overallCount)
        {
            try
            {
            ...
            catch (Exception ex)
            {
                ...
                overallCount = 0;
                return new List<TODO_LicenseToXML>() ;
            }
