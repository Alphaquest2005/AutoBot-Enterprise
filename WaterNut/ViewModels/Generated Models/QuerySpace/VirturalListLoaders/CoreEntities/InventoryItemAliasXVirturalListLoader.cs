...
{
    public partial class InventoryItemAliasXVirturalListLoader : IVirtualListLoader<InventoryItemAliasX>
	{
        ...
        public string FilterExpression
        {
            ...
            set
            {
                ...
                MessageBus.Default.BeginNotify(MessageToken.InventoryItemAliasXFilterExpressionChanged, null,
                                            new NotificationEventArgs<string>(MessageToken.InventoryItemAliasXFilterExpressionChanged, _filterExpression));
            }
        }
        ...
        public IList<InventoryItemAliasX> LoadRange(int startIndex, int count, SortDescriptionCollection sortDescriptions, out int overallCount)
        {
            try
            {
            ...
            catch (Exception ex)
            {
                ...
                overallCount = 0;
                return new List<InventoryItemAliasX>() ;
            }
