...
{
    public partial class EmailsVirturalListLoader : IVirtualListLoader<Emails>
	{
        ...
        public string FilterExpression
        {
            ...
            set
            {
                ...
                MessageBus.Default.BeginNotify(MessageToken.EmailsFilterExpressionChanged, null,
                                            new NotificationEventArgs<string>(MessageToken.EmailsFilterExpressionChanged, _filterExpression));
            }
        }
        ...
        public IList<Emails> LoadRange(int startIndex, int count, SortDescriptionCollection sortDescriptions, out int overallCount)
        {
            try
            {
