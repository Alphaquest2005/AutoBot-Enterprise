...
{
    public partial class EmailMappingVirturalListLoader : IVirtualListLoader<EmailMapping>
	{
        ...
        public string FilterExpression
        {
            ...
            set
            {
                ...
                MessageBus.Default.BeginNotify(MessageToken.EmailMappingFilterExpressionChanged, null,
                                            new NotificationEventArgs<string>(MessageToken.EmailMappingFilterExpressionChanged, _filterExpression));
            }
        }
        ...
        public IList<EmailMapping> LoadRange(int startIndex, int count, SortDescriptionCollection sortDescriptions, out int overallCount)
        {
            try
            {
