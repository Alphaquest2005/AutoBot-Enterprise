...
{
    public partial class FileGroupsVirturalListLoader : IVirtualListLoader<FileGroups>
	{
        ...
        public string FilterExpression
        {
            ...
            set
            {
                ...
                MessageBus.Default.BeginNotify(MessageToken.FileGroupsFilterExpressionChanged, null,
                                            new NotificationEventArgs<string>(MessageToken.FileGroupsFilterExpressionChanged, _filterExpression));
            }
        }
        ...
        public IList<FileGroups> LoadRange(int startIndex, int count, SortDescriptionCollection sortDescriptions, out int overallCount)
        {
            try
            {
