...
{
    public partial class AttachmentLogVirturalListLoader : IVirtualListLoader<AttachmentLog>
	{
        ...
        public string FilterExpression
        {
            ...
            set
            {
                ...
                MessageBus.Default.BeginNotify(MessageToken.AttachmentLogFilterExpressionChanged, null,
                                            new NotificationEventArgs<string>(MessageToken.AttachmentLogFilterExpressionChanged, _filterExpression));
            }
        }
        ...
        public IList<AttachmentLog> LoadRange(int startIndex, int count, SortDescriptionCollection sortDescriptions, out int overallCount)
        {
            try
            {
