...
{
    public partial class TODO_SubmitUnclassifiedItemsVirturalListLoader : IVirtualListLoader<TODO_SubmitUnclassifiedItems>
	{
        ...
        public string FilterExpression
        {
            ...
            set
            {
                ...
                MessageBus.Default.BeginNotify(MessageToken.TODO_SubmitUnclassifiedItemsFilterExpressionChanged, null,
                                            new NotificationEventArgs<string>(MessageToken.TODO_SubmitUnclassifiedItemsFilterExpressionChanged, _filterExpression));
            }
        }
        ...
        public IList<TODO_SubmitUnclassifiedItems> LoadRange(int startIndex, int count, SortDescriptionCollection sortDescriptions, out int overallCount)
        {
            try
            {
            ...
            catch (Exception ex)
            {
                ...
                overallCount = 0;
                return new List<TODO_SubmitUnclassifiedItems>() ;
            }
