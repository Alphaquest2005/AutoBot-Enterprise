...
{
    public partial class InfoMappingRegExVirturalListLoader : IVirtualListLoader<InfoMappingRegEx>
	{
        ...
        public string FilterExpression
        {
            ...
            set
            {
                ...
                MessageBus.Default.BeginNotify(MessageToken.InfoMappingRegExFilterExpressionChanged, null,
                                            new NotificationEventArgs<string>(MessageToken.InfoMappingRegExFilterExpressionChanged, _filterExpression));
            }
        }
        ...
        public IList<InfoMappingRegEx> LoadRange(int startIndex, int count, SortDescriptionCollection sortDescriptions, out int overallCount)
        {
            try
            {
            ...
            catch (Exception ex)
            {
                ...
                overallCount = 0;
                return new List<InfoMappingRegEx>() ;
            }
