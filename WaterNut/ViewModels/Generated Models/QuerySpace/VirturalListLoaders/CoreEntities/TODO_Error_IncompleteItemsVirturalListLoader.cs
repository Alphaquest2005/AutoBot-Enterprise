...
{
    public partial class TODO_Error_IncompleteItemsVirturalListLoader : IVirtualListLoader<TODO_Error_IncompleteItems>
	{
        ...
        public string FilterExpression
        {
            ...
            set
            {
                ...
                MessageBus.Default.BeginNotify(MessageToken.TODO_Error_IncompleteItemsFilterExpressionChanged, null,
                                            new NotificationEventArgs<string>(MessageToken.TODO_Error_IncompleteItemsFilterExpressionChanged, _filterExpression));
            }
        }
        ...
        public IList<TODO_Error_IncompleteItems> LoadRange(int startIndex, int count, SortDescriptionCollection sortDescriptions, out int overallCount)
        {
            try
            {
            ...
            catch (Exception ex)
            {
                ...
                overallCount = 0;
                return new List<TODO_Error_IncompleteItems>() ;
            }
