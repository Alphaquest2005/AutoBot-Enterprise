...
{
    public partial class TODO_CreateDiscrepancyEntriesVirturalListLoader : IVirtualListLoader<TODO_CreateDiscrepancyEntries>
	{
        ...
        public string FilterExpression
        {
            ...
            set
            {
                ...
                MessageBus.Default.BeginNotify(MessageToken.TODO_CreateDiscrepancyEntriesFilterExpressionChanged, null,
                                            new NotificationEventArgs<string>(MessageToken.TODO_CreateDiscrepancyEntriesFilterExpressionChanged, _filterExpression));
            }
        }
        ...
        public IList<TODO_CreateDiscrepancyEntries> LoadRange(int startIndex, int count, SortDescriptionCollection sortDescriptions, out int overallCount)
        {
            try
            {
            ...
            catch (Exception ex)
            {
                ...
                overallCount = 0;
                return new List<TODO_CreateDiscrepancyEntries>() ;
            }
