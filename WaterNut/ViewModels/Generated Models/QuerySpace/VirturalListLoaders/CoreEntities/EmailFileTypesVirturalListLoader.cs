...
{
    public partial class EmailFileTypesVirturalListLoader : IVirtualListLoader<EmailFileTypes>
	{
        ...
        public string FilterExpression
        {
            ...
            set
            {
                ...
                MessageBus.Default.BeginNotify(MessageToken.EmailFileTypesFilterExpressionChanged, null,
                                            new NotificationEventArgs<string>(MessageToken.EmailFileTypesFilterExpressionChanged, _filterExpression));
            }
        }
        ...
        public IList<EmailFileTypes> LoadRange(int startIndex, int count, SortDescriptionCollection sortDescriptions, out int overallCount)
        {
            try
            {
            ...
            catch (Exception ex)
            {
                ...
                overallCount = 0;
                return new List<EmailFileTypes>() ;
            }
