...
{
    public partial class InventoryItemAliasExVirturalListLoader : IVirtualListLoader<InventoryItemAliasEx>
	{
        ...
        public string FilterExpression
        {
            ...
            set
            {
                ...
                MessageBus.Default.BeginNotify(MessageToken.InventoryItemAliasExFilterExpressionChanged, null,
                                            new NotificationEventArgs<string>(MessageToken.InventoryItemAliasExFilterExpressionChanged, _filterExpression));
            }
        }
        ...
        public IList<InventoryItemAliasEx> LoadRange(int startIndex, int count, SortDescriptionCollection sortDescriptions, out int overallCount)
        {
            try
            {
            ...
            catch (Exception ex)
            {
                ...
                overallCount = 0;
                return new List<InventoryItemAliasEx>() ;
            }
