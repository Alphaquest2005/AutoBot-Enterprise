...
{
    public partial class DeclarantVirturalListLoader : IVirtualListLoader<Declarant>
	{
        ...
        public string FilterExpression
        {
            ...
            set
            {
                ...
                MessageBus.Default.BeginNotify(MessageToken.DeclarantsFilterExpressionChanged, null,
                                            new NotificationEventArgs<string>(MessageToken.DeclarantsFilterExpressionChanged, _filterExpression));
            }
        }
        ...
        public IList<Declarant> LoadRange(int startIndex, int count, SortDescriptionCollection sortDescriptions, out int overallCount)
        {
            try
            {
