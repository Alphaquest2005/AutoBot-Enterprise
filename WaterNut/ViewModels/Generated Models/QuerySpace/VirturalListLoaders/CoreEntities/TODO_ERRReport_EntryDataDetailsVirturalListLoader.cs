...
{
    public partial class TODO_ERRReport_EntryDataDetailsVirturalListLoader : IVirtualListLoader<TODO_ERRReport_EntryDataDetails>
	{
        ...
        public string FilterExpression
        {
            ...
            set
            {
                ...
                MessageBus.Default.BeginNotify(MessageToken.TODO_ERRReport_EntryDataDetailsFilterExpressionChanged, null,
                                            new NotificationEventArgs<string>(MessageToken.TODO_ERRReport_EntryDataDetailsFilterExpressionChanged, _filterExpression));
            }
        }
        ...
        public IList<TODO_ERRReport_EntryDataDetails> LoadRange(int startIndex, int count, SortDescriptionCollection sortDescriptions, out int overallCount)
        {
            try
            {
            ...
            catch (Exception ex)
            {
                ...
                overallCount = 0;
                return new List<TODO_ERRReport_EntryDataDetails>() ;
            }
