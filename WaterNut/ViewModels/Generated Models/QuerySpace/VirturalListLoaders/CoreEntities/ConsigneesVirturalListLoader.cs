...
{
    public partial class ConsigneesVirturalListLoader : IVirtualListLoader<Consignees>
	{
        ...
        public string FilterExpression
        {
            ...
            set
            {
                ...
                MessageBus.Default.BeginNotify(MessageToken.ConsigneesFilterExpressionChanged, null,
                                            new NotificationEventArgs<string>(MessageToken.ConsigneesFilterExpressionChanged, _filterExpression));
            }
        }
        ...
        public IList<Consignees> LoadRange(int startIndex, int count, SortDescriptionCollection sortDescriptions, out int overallCount)
        {
            try
            {
