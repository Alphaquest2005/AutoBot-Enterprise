...
{
    public partial class TODO_SubmitDocSetWithIncompleteInvoicesVirturalListLoader : IVirtualListLoader<TODO_SubmitDocSetWithIncompleteInvoices>
	{
        ...
        public string FilterExpression
        {
            ...
            set
            {
                ...
                MessageBus.Default.BeginNotify(MessageToken.TODO_SubmitDocSetWithIncompleteInvoicesFilterExpressionChanged, null,
                                            new NotificationEventArgs<string>(MessageToken.TODO_SubmitDocSetWithIncompleteInvoicesFilterExpressionChanged, _filterExpression));
            }
        }
        ...
        public IList<TODO_SubmitDocSetWithIncompleteInvoices> LoadRange(int startIndex, int count, SortDescriptionCollection sortDescriptions, out int overallCount)
        {
            try
            {
            ...
            catch (Exception ex)
            {
                ...
                overallCount = 0;
                return new List<TODO_SubmitDocSetWithIncompleteInvoices>() ;
            }
