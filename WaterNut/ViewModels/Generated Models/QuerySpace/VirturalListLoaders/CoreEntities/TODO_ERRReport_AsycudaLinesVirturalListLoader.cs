...
{
    public partial class TODO_ERRReport_AsycudaLinesVirturalListLoader : IVirtualListLoader<TODO_ERRReport_AsycudaLines>
	{
        ...
        public string FilterExpression
        {
            ...
            set
            {
                ...
                MessageBus.Default.BeginNotify(MessageToken.TODO_ERRReport_AsycudaLinesFilterExpressionChanged, null,
                                            new NotificationEventArgs<string>(MessageToken.TODO_ERRReport_AsycudaLinesFilterExpressionChanged, _filterExpression));
            }
        }
        ...
        public IList<TODO_ERRReport_AsycudaLines> LoadRange(int startIndex, int count, SortDescriptionCollection sortDescriptions, out int overallCount)
        {
            try
            {
            ...
            catch (Exception ex)
            {
                ...
                overallCount = 0;
                return new List<TODO_ERRReport_AsycudaLines>() ;
            }
