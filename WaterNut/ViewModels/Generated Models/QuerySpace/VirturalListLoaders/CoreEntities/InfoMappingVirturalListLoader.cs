...
{
    public partial class InfoMappingVirturalListLoader : IVirtualListLoader<InfoMapping>
	{
        ...
        public string FilterExpression
        {
            ...
            set
            {
                ...
                MessageBus.Default.BeginNotify(MessageToken.InfoMappingFilterExpressionChanged, null,
                                            new NotificationEventArgs<string>(MessageToken.InfoMappingFilterExpressionChanged, _filterExpression));
            }
        }
        ...
        public IList<InfoMapping> LoadRange(int startIndex, int count, SortDescriptionCollection sortDescriptions, out int overallCount)
        {
            try
            {
