...
{
    public partial class EmailMappingRexExsVirturalListLoader : IVirtualListLoader<EmailMappingRexExs>
	{
        ...
        public string FilterExpression
        {
            ...
            set
            {
                ...
                MessageBus.Default.BeginNotify(MessageToken.EmailMappingRexExsFilterExpressionChanged, null,
                                            new NotificationEventArgs<string>(MessageToken.EmailMappingRexExsFilterExpressionChanged, _filterExpression));
            }
        }
        ...
        public IList<EmailMappingRexExs> LoadRange(int startIndex, int count, SortDescriptionCollection sortDescriptions, out int overallCount)
        {
            try
            {
            ...
            catch (Exception ex)
            {
                ...
                overallCount = 0;
                return new List<EmailMappingRexExs>() ;
            }
