...
{
    public partial class CounterPointPOsVirturalListLoader : IVirtualListLoader<CounterPointPOs>
	{
        ...
        public string FilterExpression
        {
            ...
            set
            {
                ...
                MessageBus.Default.BeginNotify(MessageToken.CounterPointPOsFilterExpressionChanged, null,
                                            new NotificationEventArgs<string>(MessageToken.CounterPointPOsFilterExpressionChanged, _filterExpression));
            }
        }
        ...
        public IList<CounterPointPOs> LoadRange(int startIndex, int count, SortDescriptionCollection sortDescriptions, out int overallCount)
        {
            try
            {
