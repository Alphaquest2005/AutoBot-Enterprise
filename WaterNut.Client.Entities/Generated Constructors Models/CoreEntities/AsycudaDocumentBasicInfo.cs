...
namespace CoreEntities.Client.Entities
{
    ...
    {
       public AsycudaDocumentBasicInfo()
        {
            this.DTO = new DTO.AsycudaDocumentBasicInfo();//{TrackingState = TrackableEntities.TrackingState.Added}
            _changeTracker = new ChangeTrackingCollection<DTO.AsycudaDocumentBasicInfo>(this.DTO);
