...
namespace CoreEntities.Client.Entities
{
    ...
    public partial class SessionActions 
    {
       public SessionActions()
        {
            this.DTO = new DTO.SessionActions();//{TrackingState = TrackableEntities.TrackingState.Added}
            _changeTracker = new ChangeTrackingCollection<DTO.SessionActions>(this.DTO);
