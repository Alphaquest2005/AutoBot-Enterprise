...
namespace CoreEntities.Client.Entities
{
    ...
    public partial class EmailFileTypes 
    {
       public EmailFileTypes()
        {
            this.DTO = new DTO.EmailFileTypes();//{TrackingState = TrackableEntities.TrackingState.Added}
            _changeTracker = new ChangeTrackingCollection<DTO.EmailFileTypes>(this.DTO);
