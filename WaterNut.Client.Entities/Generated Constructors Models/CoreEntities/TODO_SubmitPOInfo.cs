...
namespace CoreEntities.Client.Entities
{
    ...
    public partial class TODO_SubmitPOInfo 
    {
       public TODO_SubmitPOInfo()
        {
            this.DTO = new DTO.TODO_SubmitPOInfo();//{TrackingState = TrackableEntities.TrackingState.Added}
            _changeTracker = new ChangeTrackingCollection<DTO.TODO_SubmitPOInfo>(this.DTO);
