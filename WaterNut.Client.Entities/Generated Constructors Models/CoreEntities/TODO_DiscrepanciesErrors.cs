...
namespace CoreEntities.Client.Entities
{
    ...
    {
       public TODO_DiscrepanciesErrors()
        {
            this.DTO = new DTO.TODO_DiscrepanciesErrors();//{TrackingState = TrackableEntities.TrackingState.Added}
            _changeTracker = new ChangeTrackingCollection<DTO.TODO_DiscrepanciesErrors>(this.DTO);
