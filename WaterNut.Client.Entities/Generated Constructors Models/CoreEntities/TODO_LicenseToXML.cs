...
namespace CoreEntities.Client.Entities
{
    ...
    public partial class TODO_LicenseToXML 
    {
       public TODO_LicenseToXML()
        {
            this.DTO = new DTO.TODO_LicenseToXML();//{TrackingState = TrackableEntities.TrackingState.Added}
            _changeTracker = new ChangeTrackingCollection<DTO.TODO_LicenseToXML>(this.DTO);
