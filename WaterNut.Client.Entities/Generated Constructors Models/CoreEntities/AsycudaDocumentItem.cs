...
namespace CoreEntities.Client.Entities
{
    ...
    public partial class AsycudaDocumentItem 
    {
       public AsycudaDocumentItem()
        {
            this.DTO = new DTO.AsycudaDocumentItem();//{TrackingState = TrackableEntities.TrackingState.Added}
            _changeTracker = new ChangeTrackingCollection<DTO.AsycudaDocumentItem>(this.DTO);
