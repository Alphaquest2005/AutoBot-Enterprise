...
namespace CoreEntities.Client.Entities
{
    ...
    {
       public AsycudaItemBasicInfo()
        {
            this.DTO = new DTO.AsycudaItemBasicInfo();//{TrackingState = TrackableEntities.TrackingState.Added}
            _changeTracker = new ChangeTrackingCollection<DTO.AsycudaItemBasicInfo>(this.DTO);
