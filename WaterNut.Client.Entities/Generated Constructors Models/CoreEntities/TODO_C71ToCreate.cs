...
namespace CoreEntities.Client.Entities
{
    ...
    public partial class TODO_C71ToCreate 
    {
       public TODO_C71ToCreate()
        {
            this.DTO = new DTO.TODO_C71ToCreate();//{TrackingState = TrackableEntities.TrackingState.Added}
            _changeTracker = new ChangeTrackingCollection<DTO.TODO_C71ToCreate>(this.DTO);
