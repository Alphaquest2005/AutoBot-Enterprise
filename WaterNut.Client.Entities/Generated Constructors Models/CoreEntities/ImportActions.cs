...
namespace CoreEntities.Client.Entities
{
    ...
    public partial class ImportActions 
    {
       public ImportActions()
        {
            this.DTO = new DTO.ImportActions();//{TrackingState = TrackableEntities.TrackingState.Added}
            _changeTracker = new ChangeTrackingCollection<DTO.ImportActions>(this.DTO);
