...
namespace CoreEntities.Client.Entities
{
    ...
    public partial class AsycudaDocument 
    {
       public AsycudaDocument()
        {
            this.DTO = new DTO.AsycudaDocument();//{TrackingState = TrackableEntities.TrackingState.Added}
            _changeTracker = new ChangeTrackingCollection<DTO.AsycudaDocument>(this.DTO);
