...
namespace CoreEntities.Client.Entities
{
    ...
    public partial class EmailMapping 
    {
       public EmailMapping()
        {
            this.DTO = new DTO.EmailMapping();//{TrackingState = TrackableEntities.TrackingState.Added}
            _changeTracker = new ChangeTrackingCollection<DTO.EmailMapping>(this.DTO);
