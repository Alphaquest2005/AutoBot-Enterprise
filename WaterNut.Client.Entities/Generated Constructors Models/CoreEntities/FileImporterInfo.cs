...
namespace CoreEntities.Client.Entities
{
    ...
    public partial class FileImporterInfo 
    {
       public FileImporterInfo()
        {
            this.DTO = new DTO.FileImporterInfo();//{TrackingState = TrackableEntities.TrackingState.Added}
            _changeTracker = new ChangeTrackingCollection<DTO.FileImporterInfo>(this.DTO);
