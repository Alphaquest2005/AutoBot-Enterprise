...
namespace CoreEntities.Client.Entities
{
    ...
    public partial class AsycudaDocumentSet_Attachments 
    {
       public AsycudaDocumentSet_Attachments()
        {
            this.DTO = new DTO.AsycudaDocumentSet_Attachments();//{TrackingState = TrackableEntities.TrackingState.Added}
            _changeTracker = new ChangeTrackingCollection<DTO.AsycudaDocumentSet_Attachments>(this.DTO);
