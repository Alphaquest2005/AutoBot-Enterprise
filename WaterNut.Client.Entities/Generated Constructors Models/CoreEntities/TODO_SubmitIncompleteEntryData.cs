...
namespace CoreEntities.Client.Entities
{
    ...
    public partial class TODO_SubmitIncompleteEntryData 
    {
       public TODO_SubmitIncompleteEntryData()
        {
            this.DTO = new DTO.TODO_SubmitIncompleteEntryData();//{TrackingState = TrackableEntities.TrackingState.Added}
            _changeTracker = new ChangeTrackingCollection<DTO.TODO_SubmitIncompleteEntryData>(this.DTO);
