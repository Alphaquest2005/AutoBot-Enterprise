...
namespace CoreEntities.Client.Entities
{
    ...
    {
       public TODO_PODocSet()
        {
            this.DTO = new DTO.TODO_PODocSet();//{TrackingState = TrackableEntities.TrackingState.Added}
            _changeTracker = new ChangeTrackingCollection<DTO.TODO_PODocSet>(this.DTO);
