...
namespace CoreEntities.Client.Entities
{
    ...
    {
       public TODO_CreateEx9()
        {
            this.DTO = new DTO.TODO_CreateEx9();//{TrackingState = TrackableEntities.TrackingState.Added}
            _changeTracker = new ChangeTrackingCollection<DTO.TODO_CreateEx9>(this.DTO);
