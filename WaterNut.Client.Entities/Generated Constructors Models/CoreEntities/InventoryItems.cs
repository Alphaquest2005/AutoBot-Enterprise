...
namespace CoreEntities.Client.Entities
{
    ...
    public partial class InventoryItems 
    {
       public InventoryItems()
        {
            this.DTO = new DTO.InventoryItems();//{TrackingState = TrackableEntities.TrackingState.Added}
            _changeTracker = new ChangeTrackingCollection<DTO.InventoryItems>(this.DTO);
