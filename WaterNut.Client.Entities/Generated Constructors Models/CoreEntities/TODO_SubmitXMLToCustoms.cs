...
namespace CoreEntities.Client.Entities
{
    ...
    public partial class TODO_SubmitXMLToCustoms 
    {
       public TODO_SubmitXMLToCustoms()
        {
            this.DTO = new DTO.TODO_SubmitXMLToCustoms();//{TrackingState = TrackableEntities.TrackingState.Added}
            _changeTracker = new ChangeTrackingCollection<DTO.TODO_SubmitXMLToCustoms>(this.DTO);
