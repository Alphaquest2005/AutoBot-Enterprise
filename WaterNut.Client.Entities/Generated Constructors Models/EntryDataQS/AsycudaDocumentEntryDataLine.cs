...
namespace EntryDataQS.Client.Entities
{
    ...
    {
       public AsycudaDocumentEntryDataLine()
        {
            this.DTO = new DTO.AsycudaDocumentEntryDataLine();//{TrackingState = TrackableEntities.TrackingState.Added}
            _changeTracker = new ChangeTrackingCollection<DTO.AsycudaDocumentEntryDataLine>(this.DTO);
