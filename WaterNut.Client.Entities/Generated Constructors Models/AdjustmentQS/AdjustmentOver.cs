...
namespace AdjustmentQS.Client.Entities
{
    ...
    public partial class AdjustmentOver 
    {
       public AdjustmentOver()
        {
            this.DTO = new DTO.AdjustmentOver();//{TrackingState = TrackableEntities.TrackingState.Added}
            _changeTracker = new ChangeTrackingCollection<DTO.AdjustmentOver>(this.DTO);
