...
namespace AdjustmentQS.Client.Entities
{
    ...
    public partial class EntryDataDetail 
    {
       public EntryDataDetail()
        {
            this.DTO = new DTO.EntryDataDetail();//{TrackingState = TrackableEntities.TrackingState.Added}
            _changeTracker = new ChangeTrackingCollection<DTO.EntryDataDetail>(this.DTO);
