...
namespace AdjustmentQS.Client.Entities
{
    ...
    public partial class AsycudaDocumentItemLastItemCost 
    {
       public AsycudaDocumentItemLastItemCost()
        {
            this.DTO = new DTO.AsycudaDocumentItemLastItemCost();//{TrackingState = TrackableEntities.TrackingState.Added}
            _changeTracker = new ChangeTrackingCollection<DTO.AsycudaDocumentItemLastItemCost>(this.DTO);
