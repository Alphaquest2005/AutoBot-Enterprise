...
namespace AdjustmentQS.Client.Entities
{
    ...
    public partial class InventoryItem 
    {
       public InventoryItem()
        {
            this.DTO = new DTO.InventoryItem();//{TrackingState = TrackableEntities.TrackingState.Added}
            _changeTracker = new ChangeTrackingCollection<DTO.InventoryItem>(this.DTO);
