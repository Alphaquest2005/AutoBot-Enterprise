...
namespace AdjustmentQS.Client.Entities
{
    ...
    public partial class InventoryItemAlia 
    {
       public InventoryItemAlia()
        {
            this.DTO = new DTO.InventoryItemAlia();//{TrackingState = TrackableEntities.TrackingState.Added}
            _changeTracker = new ChangeTrackingCollection<DTO.InventoryItemAlia>(this.DTO);
