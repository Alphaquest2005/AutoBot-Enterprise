...
namespace AdjustmentQS.Client.Entities
{
    ...
    {
       public AdjustmentOversAllocation()
        {
            this.DTO = new DTO.AdjustmentOversAllocation();//{TrackingState = TrackableEntities.TrackingState.Added}
            _changeTracker = new ChangeTrackingCollection<DTO.AdjustmentOversAllocation>(this.DTO);
