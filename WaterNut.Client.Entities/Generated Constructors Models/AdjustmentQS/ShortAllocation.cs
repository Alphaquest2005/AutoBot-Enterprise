...
namespace AdjustmentQS.Client.Entities
{
    ...
    public partial class ShortAllocation 
    {
       public ShortAllocation()
        {
            this.DTO = new DTO.ShortAllocation();//{TrackingState = TrackableEntities.TrackingState.Added}
            _changeTracker = new ChangeTrackingCollection<DTO.ShortAllocation>(this.DTO);
