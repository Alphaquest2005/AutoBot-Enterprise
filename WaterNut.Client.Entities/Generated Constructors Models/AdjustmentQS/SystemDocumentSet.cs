...
namespace AdjustmentQS.Client.Entities
{
    ...
    public partial class SystemDocumentSet 
    {
       public SystemDocumentSet()
        {
            this.DTO = new DTO.SystemDocumentSet();//{TrackingState = TrackableEntities.TrackingState.Added}
            _changeTracker = new ChangeTrackingCollection<DTO.SystemDocumentSet>(this.DTO);
