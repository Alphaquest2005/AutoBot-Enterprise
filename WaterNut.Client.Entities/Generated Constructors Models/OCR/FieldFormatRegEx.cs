...
namespace OCR.Client.Entities
{
    ...
    public partial class FieldFormatRegEx 
    {
       public FieldFormatRegEx()
        {
            this.DTO = new DTO.FieldFormatRegEx();//{TrackingState = TrackableEntities.TrackingState.Added}
            _changeTracker = new ChangeTrackingCollection<DTO.FieldFormatRegEx>(this.DTO);
