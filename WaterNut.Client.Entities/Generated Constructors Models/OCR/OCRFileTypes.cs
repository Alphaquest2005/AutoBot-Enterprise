...
namespace OCR.Client.Entities
{
    ...
    public partial class OCRFileTypes 
    {
       public OCRFileTypes()
        {
            this.DTO = new DTO.OCRFileTypes();//{TrackingState = TrackableEntities.TrackingState.Added}
            _changeTracker = new ChangeTrackingCollection<DTO.OCRFileTypes>(this.DTO);
