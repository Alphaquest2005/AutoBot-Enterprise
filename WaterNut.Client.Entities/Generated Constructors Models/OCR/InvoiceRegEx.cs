...
namespace OCR.Client.Entities
{
    ...
    public partial class InvoiceRegEx 
    {
       public InvoiceRegEx()
        {
            this.DTO = new DTO.InvoiceRegEx();//{TrackingState = TrackableEntities.TrackingState.Added}
            _changeTracker = new ChangeTrackingCollection<DTO.InvoiceRegEx>(this.DTO);
