...
namespace OCR.Client.Entities
{
    ...
    public partial class OCRCorrectionLearning 
    {
       public OCRCorrectionLearning()
        {
            this.DTO = new DTO.OCRCorrectionLearning();//{TrackingState = TrackableEntities.TrackingState.Added}
            _changeTracker = new ChangeTrackingCollection<DTO.OCRCorrectionLearning>(this.DTO);
