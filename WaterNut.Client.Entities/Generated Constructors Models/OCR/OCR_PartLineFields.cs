...
namespace OCR.Client.Entities
{
    ...
    public partial class OCR_PartLineFields 
    {
       public OCR_PartLineFields()
        {
            this.DTO = new DTO.OCR_PartLineFields();//{TrackingState = TrackableEntities.TrackingState.Added}
            _changeTracker = new ChangeTrackingCollection<DTO.OCR_PartLineFields>(this.DTO);
