...
namespace OCR.Client.Entities
{
    ...
    {
       public OCR_InvoiceRegEx()
        {
            this.DTO = new DTO.OCR_InvoiceRegEx();//{TrackingState = TrackableEntities.TrackingState.Added}
            _changeTracker = new ChangeTrackingCollection<DTO.OCR_InvoiceRegEx>(this.DTO);
