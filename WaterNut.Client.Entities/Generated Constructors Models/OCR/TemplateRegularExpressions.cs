...
namespace OCR.Client.Entities
{
    ...
    public partial class TemplateRegularExpressions 
    {
       public TemplateRegularExpressions()
        {
            this.DTO = new DTO.TemplateRegularExpressions();//{TrackingState = TrackableEntities.TrackingState.Added}
            _changeTracker = new ChangeTrackingCollection<DTO.TemplateRegularExpressions>(this.DTO);
