...
namespace OCR.Client.Entities
{
    ...
    {
       public vw_OCRCorrectionAnalysis()
        {
            this.DTO = new DTO.vw_OCRCorrectionAnalysis();//{TrackingState = TrackableEntities.TrackingState.Added}
            _changeTracker = new ChangeTrackingCollection<DTO.vw_OCRCorrectionAnalysis>(this.DTO);
