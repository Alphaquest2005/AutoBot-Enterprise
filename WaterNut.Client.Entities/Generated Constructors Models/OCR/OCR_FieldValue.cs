...
namespace OCR.Client.Entities
{
    ...
    public partial class OCR_FieldValue 
    {
       public OCR_FieldValue()
        {
            this.DTO = new DTO.OCR_FieldValue();//{TrackingState = TrackableEntities.TrackingState.Added}
            _changeTracker = new ChangeTrackingCollection<DTO.OCR_FieldValue>(this.DTO);
