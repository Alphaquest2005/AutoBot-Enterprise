...
namespace OCR.Client.Entities
{
    ...
    {
       public InvoiceIdentificatonRegEx()
        {
            this.DTO = new DTO.InvoiceIdentificatonRegEx();//{TrackingState = TrackableEntities.TrackingState.Added}
            _changeTracker = new ChangeTrackingCollection<DTO.InvoiceIdentificatonRegEx>(this.DTO);
