...
namespace OCR.Client.Entities
{
    ...
    public partial class RecuringPart 
    {
       public RecuringPart()
        {
            this.DTO = new DTO.RecuringPart();//{TrackingState = TrackableEntities.TrackingState.Added}
            _changeTracker = new ChangeTrackingCollection<DTO.RecuringPart>(this.DTO);
