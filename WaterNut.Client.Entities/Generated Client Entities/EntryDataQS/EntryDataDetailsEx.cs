...
public int InventoryItemId
       ...
       private EntryDataEx _EntryDataEx;
        public  EntryDataEx EntryDataEx
		{
                  ...
                  if (this.entrydatadetailsex != null)
                   {
                       ...
                       {
                           if (this.entrydatadetailsex.EntryDataEx !=
                               _EntryDataEx.DTO)
                           {
                                if (this.entrydatadetailsex.EntryDataEx  != null)
                               _EntryDataEx = new EntryDataEx(this.entrydatadetailsex.EntryDataEx);
                           }
                       }
                       else
                       {
			...
			//		//if (this.entrydatadetailsex.EntryDataEx == null) Debugger.Break();
			//		if (this.entrydatadetailsex.EntryDataEx != null)
            //        {
            //           i. = this.entrydatadetailsex.EntryDataEx;
            //        }
            //        else
            //        {
            //            this.entrydatadetailsex.EntryDataEx = i.;
             //       }
			...
			set
			{
                ...
                _EntryDataEx = value;
                if(value != null)
                     this.entrydatadetailsex.EntryDataEx = value.DTO;
				if(this.TrackingState == TrackableEntities.TrackingState.Unchanged)this.TrackingState = TrackableEntities.TrackingState.Modified;
        ...
        ObservableCollection<AsycudaDocumentSetEntryDataDetail> _AsycudaDocumentSets = null;
        public  ObservableCollection<AsycudaDocumentSetEntryDataDetail> AsycudaDocumentSets
		{
            
		    get 
				{ 
					if(_AsycudaDocumentSets != null) return _AsycudaDocumentSets;
					//if (this.entrydatadetailsex.AsycudaDocumentSets == null) Debugger.Break();
					if(this.entrydatadetailsex.AsycudaDocumentSets != null)
					{
						_AsycudaDocumentSets = new ObservableCollection<AsycudaDocumentSetEntryDataDetail>(this.entrydatadetailsex.AsycudaDocumentSets.Select(x => new AsycudaDocumentSetEntryDataDetail(x)));
					}
			...
			set
			{
				...
				if (value != null)
					this.entrydatadetailsex.AsycudaDocumentSets = new ChangeTrackingCollection<DTO.AsycudaDocumentSetEntryDataDetail>(value.Select(x => x.DTO).ToList());
        ...
        void AsycudaDocumentSets_CollectionChanged(object sender, System.Collections.Specialized.NotifyCollectionChangedEventArgs e)
        {
            switch (e.Action)
            {
                case NotifyCollectionChangedAction.Add:
                    foreach (AsycudaDocumentSetEntryDataDetail itm in e.NewItems)
                    {
                        if (itm != null)
                        entrydatadetailsex.AsycudaDocumentSets.Add(itm.DTO);
                    }
                    if(this.TrackingState == TrackableEntities.TrackingState.Unchanged)this.TrackingState = TrackableEntities.TrackingState.Modified;
                    break;
                case NotifyCollectionChangedAction.Remove:
                    foreach (AsycudaDocumentSetEntryDataDetail itm in e.OldItems)
                    {
                        if (itm != null)
                        entrydatadetailsex.AsycudaDocumentSets.Remove(itm.DTO);
                    }
					if(this.TrackingState == TrackableEntities.TrackingState.Unchanged)this.TrackingState = TrackableEntities.TrackingState.Modified;
                    break;
