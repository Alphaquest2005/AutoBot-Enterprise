...
**Location**: `/mnt/c/Insight Software/AutoBot-Enterprise-alpha/AutoBotUtilities.Tests/PDFImportTests.cs`  
...
### Repository Root
**Correct base path**: `/mnt/c/Insight Software/AutoBot-Enterprise-alpha/`

### Key Test Files
```bash
# Amazon invoice test data
/mnt/c/Insight Software/AutoBot-Enterprise-alpha/AutoBotUtilities.Tests/Test Data/Amazon.com - Order 112-9126443-1163432.pdf
/mnt/c/Insight Software/AutoBot-Enterprise-alpha/AutoBotUtilities.Tests/Test Data/Amazon.com - Order 112-9126443-1163432.pdf.txt

# Test configuration
/mnt/c/Insight Software/AutoBot-Enterprise-alpha/AutoBotUtilities.Tests/appsettings.json
```

### Key Paths
```bash
# Repository root
/mnt/c/Insight Software/AutoBot-Enterprise-alpha/

# 🎯 CRITICAL ANALYSIS FILES
/mnt/c/Insight Software/AutoBot-Enterprise-alpha/COMPLETE-DEEPSEEK-INTEGRATION-ANALYSIS.md         # Complete pipeline analysis (REQUIRED READING)
/mnt/c/Insight Software/AutoBot-Enterprise-alpha/Claude OCR Correction Knowledge.md                # Extended knowledge base
/mnt/c/Insight Software/AutoBot-Enterprise-alpha/DEEPSEEK_OCR_TEMPLATE_CREATION_KNOWLEDGEBASE.md   # Knowledge base file: Template creation system implementation
/mnt/c/Insight Software/AutoBot-Enterprise-alpha/AutoBot1/WebSource-AutoBot Scripts/               # Foundational OCR database schema

# Main Application Entry Points
/mnt/c/Insight Software/AutoBot-Enterprise-alpha/AutoBot1/Program.cs               # Console App (✅ Logging Implemented)
/mnt/c/Insight Software/AutoBot-Enterprise-alpha/WaterNut/App.xaml.cs              # WPF App (❌ No Logging)
/mnt/c/Insight Software/AutoBot-Enterprise-alpha/WCFConsoleHost/Program.cs         # WCF Service (⚠️ Basic Serilog)

# Project Files
/mnt/c/Insight Software/AutoBot-Enterprise-alpha/AutoBot1/AutoBot1.csproj
/mnt/c/Insight Software/AutoBot-Enterprise-alpha/WaterNut/AutoWaterNut.csproj
/mnt/c/Insight Software/AutoBot-Enterprise-alpha/WCFConsoleHost/AutoWaterNutServer.csproj
```

### OCR Correction Service Files
```bash
# Main service files
/mnt/c/Insight Software/AutoBot-Enterprise-alpha/InvoiceReader/OCRCorrectionService/OCRCorrectionService.cs
/mnt/c/Insight Software/AutoBot-Enterprise-alpha/InvoiceReader/OCRCorrectionService/OCRErrorDetection.cs
/mnt/c/Insight Software/AutoBot-Enterprise-alpha/InvoiceReader/OCRCorrectionService/OCRPromptCreation.cs
/mnt/c/Insight Software/AutoBot-Enterprise-alpha/InvoiceReader/OCRCorrectionService/OCRDeepSeekIntegration.cs
/mnt/c/Insight Software/AutoBot-Enterprise-alpha/InvoiceReader/OCRCorrectionService/OCRCaribbeanCustomsProcessor.cs

# Pipeline infrastructure
/mnt/c/Insight Software/AutoBot-Enterprise-alpha/InvoiceReader/InvoiceReader/PipelineInfrastructure/ReadFormattedTextStep.cs

# DeepSeek API
/mnt/c/Insight Software/AutoBot-Enterprise-alpha/WaterNut.Business.Services/Utils/DeepSeek/DeepSeekInvoiceApi.cs
```

### Common Search Patterns
```bash
# Search for OCR-related files
Grep pattern="OCR|DeepSeek" include="*.cs" path="/mnt/c/Insight Software/AutoBot-Enterprise-alpha/InvoiceReader"

# Search for test files
Glob pattern="*Test*.cs" path="/mnt/c/Insight Software/AutoBot-Enterprise-alpha/AutoBotUtilities.Tests"
...
- Include spaces in quoted paths: `/mnt/c/Insight Software/AutoBot-Enterprise-alpha/`
...
- **Main Service**: `/mnt/c/Insight Software/AutoBot-Enterprise-alpha/InvoiceReader/OCRCorrectionService/OCRCorrectionService.cs`
- **Pipeline Methods**: `/mnt/c/Insight Software/AutoBot-Enterprise-alpha/InvoiceReader/OCRCorrectionService/OCRDatabaseUpdates.cs`
...
- **Error Detection**: `/mnt/c/Insight Software/AutoBot-Enterprise-alpha/InvoiceReader/OCRCorrectionService/OCRErrorDetection.cs`
...
- **Pipeline Extension Methods**: `/mnt/c/Insight Software/AutoBot-Enterprise-alpha/InvoiceReader/OCRCorrectionService/OCRCorrectionPipeline.cs`
...
- **Database Strategies**: `/mnt/c/Insight Software/AutoBot-Enterprise-alpha/InvoiceReader/OCRCorrectionService/OCRDatabaseStrategies.cs`
...
- **Field Mapping & Validation**: `/mnt/c/Insight Software/AutoBot-Enterprise-alpha/InvoiceReader/OCRCorrectionService/OCRFieldMapping.cs`
...
- **DeepSeek Integration**: `/mnt/c/Insight Software/AutoBot-Enterprise-alpha/InvoiceReader/OCRCorrectionService/OCRDeepSeekIntegration.cs`
...
- **ReadFormattedTextStep Integration**: `/mnt/c/Insight Software/AutoBot-Enterprise-alpha/InvoiceReader/InvoiceReader/PipelineInfrastructure/ReadFormattedTextStep.cs`
...
**Note**: For comprehensive documentation, architecture details, debugging methodology, and implementation status, see `/mnt/c/Insight Software/AutoBot-Enterprise-alpha/Claude OCR Correction Knowledge.md` and `/mnt/c/Insight Software/AutoBot-Enterprise-alpha/Logging-Unification-Implementation-Plan.md`.
...
**Repository Root**: `/mnt/c/Insight Software/AutoBot-Enterprise-alpha/`
