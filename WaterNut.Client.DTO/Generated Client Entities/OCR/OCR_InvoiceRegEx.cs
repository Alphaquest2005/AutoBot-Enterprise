...
namespace OCR.Client.DTO
{
   ...
   // [JsonObject(IsReference = true)]
    ...
    public partial class OCR_InvoiceRegEx : BaseEntity<OCR_InvoiceRegEx>, ITrackable, IEquatable<OCR_InvoiceRegEx>
    {
        [DataMember]
        public int Id
		{ 
   ...
   //     public ICollection<string> ModifiedProperties { get; set; }
    ...
    //	private Guid _entityIdentity = default(Guid);
    	...
    	bool IEquatable<OCR_InvoiceRegEx>.Equals(OCR_InvoiceRegEx other)
    	{
