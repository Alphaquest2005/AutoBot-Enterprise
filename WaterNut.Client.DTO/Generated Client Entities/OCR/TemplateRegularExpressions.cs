...
namespace OCR.Client.DTO
{
   ...
   // [JsonObject(IsReference = true)]
    ...
    public partial class TemplateRegularExpressions : BaseEntity<TemplateRegularExpressions>, ITrackable, IEquatable<TemplateRegularExpressions>
    {
        [DataMember]
        public int Id
		{ 
   ...
   //     public ICollection<string> ModifiedProperties { get; set; }
    ...
    //	private Guid _entityIdentity = default(Guid);
    	...
    	bool IEquatable<TemplateRegularExpressions>.Equals(TemplateRegularExpressions other)
    	{
