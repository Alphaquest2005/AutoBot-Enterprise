...
namespace OCR.Client.DTO
{
   ...
   // [JsonObject(IsReference = true)]
    ...
    public partial class FieldFormatRegEx : BaseEntity<FieldFormatRegEx>, ITrackable, IEquatable<FieldFormatRegEx>
    {
        [DataMember]
        public int Id
		{ 
   ...
   //     public ICollection<string> ModifiedProperties { get; set; }
    ...
    //	private Guid _entityIdentity = default(Guid);
    	...
    	bool IEquatable<FieldFormatRegEx>.Equals(FieldFormatRegEx other)
    	{
