...
namespace CoreEntities.Client.DTO
{
   ...
   // [JsonObject(IsReference = true)]
    ...
    public partial class TODO_SubmitSalesToCustoms : BaseEntity<TODO_SubmitSalesToCustoms>, ITrackable, IEquatable<TODO_SubmitSalesToCustoms>
    {
        [DataMember]
        public int Id
		{ 
   ...
   //     public ICollection<string> ModifiedProperties { get; set; }
    ...
    //	private Guid _entityIdentity = default(Guid);
    	...
    	bool IEquatable<TODO_SubmitSalesToCustoms>.Equals(TODO_SubmitSalesToCustoms other)
    	{
