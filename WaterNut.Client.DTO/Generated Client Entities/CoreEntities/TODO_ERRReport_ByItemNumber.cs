...
namespace CoreEntities.Client.DTO
{
   ...
   // [JsonObject(IsReference = true)]
    ...
    public partial class TODO_ERRReport_ByItemNumber : BaseEntity<TODO_ERRReport_ByItemNumber>, ITrackable, IEquatable<TODO_ERRReport_ByItemNumber>
    {
        [DataMember]
   ...
   //     public ICollection<string> ModifiedProperties { get; set; }
    ...
    //	private Guid _entityIdentity = default(Guid);
    	...
    	bool IEquatable<TODO_ERRReport_ByItemNumber>.Equals(TODO_ERRReport_ByItemNumber other)
    	{
