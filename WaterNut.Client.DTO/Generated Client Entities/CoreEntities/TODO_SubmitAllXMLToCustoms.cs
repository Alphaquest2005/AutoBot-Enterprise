...
namespace CoreEntities.Client.DTO
{
   ...
   // [JsonObject(IsReference = true)]
    ...
    public partial class TODO_SubmitAllXMLToCustoms : BaseEntity<TODO_SubmitAllXMLToCustoms>, ITrackable, IEquatable<TODO_SubmitAllXMLToCustoms>
    {
        [DataMember]
        public int Id
		{ 
		...
		{ 
		    get { return _SystemDocumentSetId; }
			set
			{
			    if (value == _SystemDocumentSetId) return;
				_SystemDocumentSetId = value;
				NotifyPropertyChanged();//m => this.SystemDocumentSetId
			}
		}
   ...
   //     public ICollection<string> ModifiedProperties { get; set; }
    ...
    //	private Guid _entityIdentity = default(Guid);
    	...
    	bool IEquatable<TODO_SubmitAllXMLToCustoms>.Equals(TODO_SubmitAllXMLToCustoms other)
    	{
