...
namespace CoreEntities.Client.DTO
{
   ...
   // [JsonObject(IsReference = true)]
    ...
    public partial class TODO_AdjustmentsAlreadyXMLed : BaseEntity<TODO_AdjustmentsAlreadyXMLed>, ITrackable, IEquatable<TODO_AdjustmentsAlreadyXMLed>
    {
        [DataMember]
   ...
   //     public ICollection<string> ModifiedProperties { get; set; }
    ...
    //	private Guid _entityIdentity = default(Guid);
    	...
    	bool IEquatable<TODO_AdjustmentsAlreadyXMLed>.Equals(TODO_AdjustmentsAlreadyXMLed other)
    	{
