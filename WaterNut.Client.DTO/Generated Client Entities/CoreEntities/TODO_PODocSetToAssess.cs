...
namespace CoreEntities.Client.DTO
{
   ...
   // [JsonObject(IsReference = true)]
    ...
    public partial class TODO_PODocSetToAssess : BaseEntity<TODO_PODocSetToAssess>, ITrackable, IEquatable<TODO_PODocSetToAssess>
    {
        [DataMember]
   ...
   //     public ICollection<string> ModifiedProperties { get; set; }
    ...
    //	private Guid _entityIdentity = default(Guid);
    	...
    	bool IEquatable<TODO_PODocSetToAssess>.Equals(TODO_PODocSetToAssess other)
    	{
