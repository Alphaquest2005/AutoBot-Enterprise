...
namespace CoreEntities.Client.DTO
{
   ...
   // [JsonObject(IsReference = true)]
    ...
    public partial class TODO_ERRReport_UnmappedItems : BaseEntity<TODO_ERRReport_UnmappedItems>, ITrackable, IEquatable<TODO_ERRReport_UnmappedItems>
    {
        [DataMember]
   ...
   //     public ICollection<string> ModifiedProperties { get; set; }
    ...
    //	private Guid _entityIdentity = default(Guid);
    	...
    	bool IEquatable<TODO_ERRReport_UnmappedItems>.Equals(TODO_ERRReport_UnmappedItems other)
    	{
