...
namespace CoreEntities.Client.DTO
{
   ...
   // [JsonObject(IsReference = true)]
    ...
    public partial class TODO_LICToCreate : BaseEntity<TODO_LICToCreate>, ITrackable, IEquatable<TODO_LICToCreate>
    {
        [DataMember]
   ...
   //     public ICollection<string> ModifiedProperties { get; set; }
    ...
    //	private Guid _entityIdentity = default(Guid);
    	...
    	bool IEquatable<TODO_LICToCreate>.Equals(TODO_LICToCreate other)
    	{
