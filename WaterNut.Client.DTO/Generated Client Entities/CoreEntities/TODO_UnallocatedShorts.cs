...
namespace CoreEntities.Client.DTO
{
   ...
   // [JsonObject(IsReference = true)]
    ...
    public partial class TODO_UnallocatedShorts : BaseEntity<TODO_UnallocatedShorts>, ITrackable, IEquatable<TODO_UnallocatedShorts>
    {
        [DataMember]
   ...
   //     public ICollection<string> ModifiedProperties { get; set; }
    ...
    //	private Guid _entityIdentity = default(Guid);
    	...
    	bool IEquatable<TODO_UnallocatedShorts>.Equals(TODO_UnallocatedShorts other)
    	{
