...
namespace CoreEntities.Client.DTO
{
   ...
   // [JsonObject(IsReference = true)]
    ...
    public partial class TODO_PODocSetToAssessErrors : BaseEntity<TODO_PODocSetToAssessErrors>, ITrackable, IEquatable<TODO_PODocSetToAssessErrors>
    {
        [DataMember]
		...
		{ 
			...
			set
			{
			    if (value == _ExpectedAttachments) return;
				_ExpectedAttachments = value;
				NotifyPropertyChanged();//m => this.ExpectedAttachments
			}
		}
        private Nullable<int> _ExpectedAttachments;
		...
		{ 
		    get { return _GeneratedPackages; }
			set
			{
			    if (value == _GeneratedPackages) return;
				_GeneratedPackages = value;
				NotifyPropertyChanged();//m => this.GeneratedPackages
			}
		}
        private Nullable<double> _GeneratedPackages;

        [DataMember]
        public Nullable<double> SpecifiedCIF
		{ 
		    get { return _SpecifiedCIF; }
			set
			{
			    if (value == _SpecifiedCIF) return;
				_SpecifiedCIF = value;
				NotifyPropertyChanged();//m => this.SpecifiedCIF
			}
		}
        private Nullable<double> _SpecifiedCIF;

        [DataMember]
        public Nullable<double> GeneratedCIF
		{ 
		    get { return _GeneratedCIF; }
			set
			{
			    if (value == _GeneratedCIF) return;
				_GeneratedCIF = value;
				NotifyPropertyChanged();//m => this.GeneratedCIF
			}
		}
   ...
   //     public ICollection<string> ModifiedProperties { get; set; }
    ...
    //	private Guid _entityIdentity = default(Guid);
    	...
    	bool IEquatable<TODO_PODocSetToAssessErrors>.Equals(TODO_PODocSetToAssessErrors other)
    	{
