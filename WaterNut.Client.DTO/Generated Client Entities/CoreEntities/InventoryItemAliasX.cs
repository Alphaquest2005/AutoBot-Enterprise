...
namespace CoreEntities.Client.DTO
{
   ...
   // [JsonObject(IsReference = true)]
    ...
    public partial class InventoryItemAliasX : BaseEntity<InventoryItemAliasX>, ITrackable, IEquatable<InventoryItemAliasX>
    {
        [DataMember]
        public int AliasId
		{ 
   ...
   //     public ICollection<string> ModifiedProperties { get; set; }
    ...
    //	private Guid _entityIdentity = default(Guid);
    	...
    	bool IEquatable<InventoryItemAliasX>.Equals(InventoryItemAliasX other)
    	{
