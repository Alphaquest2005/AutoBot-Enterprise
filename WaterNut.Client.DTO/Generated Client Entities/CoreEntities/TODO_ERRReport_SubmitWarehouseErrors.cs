...
namespace CoreEntities.Client.DTO
{
   ...
   // [JsonObject(IsReference = true)]
    ...
    public partial class TODO_ERRReport_SubmitWarehouseErrors : BaseEntity<TODO_ERRReport_SubmitWarehouseErrors>, ITrackable, IEquatable<TODO_ERRReport_SubmitWarehouseErrors>
    {
        [DataMember]
   ...
   //     public ICollection<string> ModifiedProperties { get; set; }
    ...
    //	private Guid _entityIdentity = default(Guid);
    	...
    	bool IEquatable<TODO_ERRReport_SubmitWarehouseErrors>.Equals(TODO_ERRReport_SubmitWarehouseErrors other)
    	{
