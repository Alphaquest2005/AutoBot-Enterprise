...
namespace CoreEntities.Client.DTO
{
   ...
   // [JsonObject(IsReference = true)]
    ...
    public partial class TODO_SubmitIncompleteEntryData : BaseEntity<TODO_SubmitIncompleteEntryData>, ITrackable, IEquatable<TODO_SubmitIncompleteEntryData>
    {
        [DataMember]
   ...
   //     public ICollection<string> ModifiedProperties { get; set; }
    ...
    //	private Guid _entityIdentity = default(Guid);
    	...
    	bool IEquatable<TODO_SubmitIncompleteEntryData>.Equals(TODO_SubmitIncompleteEntryData other)
    	{
