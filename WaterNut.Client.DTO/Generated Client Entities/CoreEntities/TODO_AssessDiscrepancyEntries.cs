...
namespace CoreEntities.Client.DTO
{
   ...
   // [JsonObject(IsReference = true)]
    ...
    public partial class TODO_AssessDiscrepancyEntries : BaseEntity<TODO_AssessDiscrepancyEntries>, ITrackable, IEquatable<TODO_AssessDiscrepancyEntries>
    {
        [DataMember]
   ...
   //     public ICollection<string> ModifiedProperties { get; set; }
    ...
    //	private Guid _entityIdentity = default(Guid);
    	...
    	bool IEquatable<TODO_AssessDiscrepancyEntries>.Equals(TODO_AssessDiscrepancyEntries other)
    	{
