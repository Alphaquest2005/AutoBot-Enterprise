...
namespace CoreEntities.Client.DTO
{
   ...
   // [JsonObject(IsReference = true)]
    ...
    public partial class TODO_DiscrepanciesToSubmit : BaseEntity<TODO_DiscrepanciesToSubmit>, ITrackable, IEquatable<TODO_DiscrepanciesToSubmit>
    {
        [DataMember]
   ...
   //     public ICollection<string> ModifiedProperties { get; set; }
    ...
    //	private Guid _entityIdentity = default(Guid);
    	...
    	bool IEquatable<TODO_DiscrepanciesToSubmit>.Equals(TODO_DiscrepanciesToSubmit other)
    	{
