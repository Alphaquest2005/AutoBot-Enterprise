...
namespace AdjustmentQS.Client.DTO
{
   ...
   // [JsonObject(IsReference = true)]
    ...
    public partial class ShortAllocation : BaseEntity<ShortAllocation>, ITrackable, IEquatable<ShortAllocation>
    {
        [DataMember]
   ...
   //     public ICollection<string> ModifiedProperties { get; set; }
    ...
    //	private Guid _entityIdentity = default(Guid);
    	...
    	bool IEquatable<ShortAllocation>.Equals(ShortAllocation other)
    	{
