...
namespace AdjustmentQS.Client.DTO
{
   ...
   // [JsonObject(IsReference = true)]
    ...
    public partial class AdjustmentOver : BaseEntity<AdjustmentOver>, ITrackable, IEquatable<AdjustmentOver>
    {
        [DataMember]
   ...
   //     public ICollection<string> ModifiedProperties { get; set; }
    ...
    //	private Guid _entityIdentity = default(Guid);
    	...
    	bool IEquatable<AdjustmentOver>.Equals(AdjustmentOver other)
    	{
