...
namespace AdjustmentQS.Client.DTO
{
   ...
   // [JsonObject(IsReference = true)]
    ...
    public partial class InventoryItemAlia : BaseEntity<InventoryItemAlia>, ITrackable, IEquatable<InventoryItemAlia>
    {
        [DataMember]
        public int AliasId
		{ 
   ...
   //     public ICollection<string> ModifiedProperties { get; set; }
    ...
    //	private Guid _entityIdentity = default(Guid);
    	...
    	bool IEquatable<InventoryItemAlia>.Equals(InventoryItemAlia other)
    	{
