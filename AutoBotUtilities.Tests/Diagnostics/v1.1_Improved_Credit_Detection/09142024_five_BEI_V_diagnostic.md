# Invoice Diagnostic Report - 09142024_five_BEI_V

## 📋 **File Identification**
- **Invoice File**: 09142024_five_BEI_V.txt
- **Test Version**: v1.1
- **Test Date**: 2025-06-26 22:46:40
...
```json
{
  "extractedFields": {
    "InvoiceTotal": 0.0,
    "SubTotal": 0.0,
    "TotalInternalFreight": 15.0,
    "TotalOtherCost": 0.0,
    "TotalInsurance": 0.0,
    "TotalDeduction": 0.0
  },
  "validation": {
    "CalculatedTotal": 15.0,
    "BalanceCheck": 15.0,
...
- **Problem**: JSON extraction produces balance error of 15.0000
- **Evidence**: Balance check: 15.0000 (should be 0.00)
- **Expected Behavior**: JSON reference should produce perfect balance (0.00)
- **Actual Behavior**: JSON reference has 15.0000 balance error
- **Proposed Fix**:
```
