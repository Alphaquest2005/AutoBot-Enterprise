# Invoice Diagnostic Report - 2000129-50710193

## 📋 **File Identification**
- **Invoice File**: 2000129-50710193.txt
- **Test Version**: v1.1
- **Test Date**: 2025-06-26 22:55:28
...
{
  "extractedFields": {
    "InvoiceTotal": 3293.56,
    "SubTotal": 3299.28,
    "TotalInternalFreight": 0.0,
    "TotalOtherCost": 0.0,
    "TotalInsurance": 0.0,
    "TotalDeduction": 29.52
  },
  "validation": {
    "CalculatedTotal": 3269.76,
    "BalanceCheck": 23.8,
...
- **Problem**: JSON extraction produces balance error of 23.8000
- **Evidence**: Balance check: 23.8000 (should be 0.00)
- **Expected Behavior**: JSON reference should produce perfect balance (0.00)
- **Actual Behavior**: JSON reference has 23.8000 balance error
- **Proposed Fix**:
```
