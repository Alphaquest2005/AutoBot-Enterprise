# Invoice Diagnostic Report - 07252024_TEMU

## 📋 **File Identification**
- **Invoice File**: 07252024_TEMU.txt
- **Test Version**: v1.1
- **Test Date**: 2025-06-26 22:36:03
- **Vendor Category**: TEMU
...
```json
{
  "extractedFields": {
    ...
    "TotalOtherCost": 2.03,
    "TotalInsurance": 0.0,
    "TotalDeduction": 111.02
  },
  "validation": {
    "CalculatedTotal": 33.99,
    "BalanceCheck": 0.0,
