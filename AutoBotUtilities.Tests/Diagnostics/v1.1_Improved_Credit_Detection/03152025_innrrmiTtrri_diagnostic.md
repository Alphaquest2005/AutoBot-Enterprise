# Invoice Diagnostic Report - 03152025_innrrmiTtrri

## 📋 **File Identification**
- **Invoice File**: 03152025_innrrmiTtrri.txt
- **Test Version**: v1.1
- **Test Date**: 2025-06-26 21:34:23
...
- **Financial Patterns**: Gift Card, Credit, Tax
...
```json
{
  "extractedFields": {
    "InvoiceTotal": 44.57,
    "SubTotal": 34.66,
    "TotalInternalFreight": 7.49,
    "TotalOtherCost": 0.0,
    "TotalInsurance": 0.0,
    "TotalDeduction": 10.8
  },
  "validation": {
    "CalculatedTotal": 44.57,
    "BalanceCheck": 0.0,
