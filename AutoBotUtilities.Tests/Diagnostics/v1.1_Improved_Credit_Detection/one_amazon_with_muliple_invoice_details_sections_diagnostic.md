# Invoice Diagnostic Report - one_amazon_with_muliple_invoice_details_sections

## 📋 **File Identification**
- **Invoice File**: one_amazon_with_muliple_invoice_details_sections.txt
- **Test Version**: v1.1
- **Test Date**: 2025-06-27 06:10:00
...
- **Financial Patterns**: Credit, Free Shipping, Tax
...
```json
{
  "extractedFields": {
    "InvoiceTotal": 288.94,
    "SubTotal": 269.02,
    "TotalInternalFreight": 2.35,
    "TotalOtherCost": 0.0,
    "TotalInsurance": 0.0,
    "TotalDeduction": 3.92
  },
  "validation": {
    "CalculatedTotal": 288.94,
    "BalanceCheck": 0.0,
...
**For Future LLM Reference**: If this one_amazon_with_muliple_invoice_details_sections file shows ANY issues in future versions (v1.2+), it indicates a REGRESSION. The v1.1 logic should be restored as this file achieved perfect processing status.
