# Invoice Diagnostic Report - 07292024_Order

## 📋 **File Identification**
- **Invoice File**: 07292024_Order.txt
- **Test Version**: v1.1
- **Test Date**: 2025-06-26 22:40:18
...
```json
{
  "extractedFields": {
    "InvoiceTotal": 96.29,
    "SubTotal": 89.99,
    "TotalInternalFreight": 27.0,
    "TotalOtherCost": 6.3,
    "TotalInsurance": 0.0,
    "TotalDeduction": 0.0
  },
  "validation": {
    "CalculatedTotal": 96.29,
    "BalanceCheck": 0.0,
...
**For Future LLM Reference**: If this 07292024_Order file shows ANY issues in future versions (v1.2+), it indicates a REGRESSION. The v1.1 logic should be restored as this file achieved perfect processing status.
