# Invoice Diagnostic Report - 03152025_Free_returns_within_90_days

## 📋 **File Identification**
- **Invoice File**: 03152025_Free_returns_within_90_days.txt
- **Test Version**: v1.1
- **Test Date**: 2025-06-26 21:33:11
...
```json
{
  "extractedFields": {
    ...
    "TotalOtherCost": 0.0,
    "TotalInsurance": -200.14,
    "TotalDeduction": 0.0
  },
  "validation": {
    "CalculatedTotal": 44.07,
    "BalanceCheck": 0.0,
