# Invoice Diagnostic Report - MACKESS_COX_BOL

## 📋 **File Identification**
- **Invoice File**: MACKESS_COX_BOL.txt
- **Test Version**: v1.1
- **Test Date**: 2025-06-27 02:57:44
...
```json
{
  "extractedFields": {
    "InvoiceTotal": 128.08,
    "SubTotal": 128.08,
    "TotalInternalFreight": 52.75,
    "TotalOtherCost": 75.33,
    "TotalInsurance": 0.0,
    "TotalDeduction": 0.0
  },
  "validation": {
    "CalculatedTotal": 128.08,
    "BalanceCheck": 0.0,
...
**For Future LLM Reference**: If this MACKESS_COX_BOL file shows ANY issues in future versions (v1.2+), it indicates a REGRESSION. The v1.1 logic should be restored as this file achieved perfect processing status.
