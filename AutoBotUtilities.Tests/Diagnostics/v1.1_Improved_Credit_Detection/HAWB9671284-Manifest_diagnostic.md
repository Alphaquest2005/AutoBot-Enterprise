# Invoice Diagnostic Report - HAWB9671284-Manifest

## 📋 **File Identification**
- **Invoice File**: HAWB9671284-Manifest.txt
- **Test Version**: v1.1
- **Test Date**: 2025-06-27 02:24:27
...
```json
{
  "extractedFields": {
    "InvoiceTotal": 74.7,
    "SubTotal": 63.95,
    "TotalInternalFreight": 10.75,
    "TotalOtherCost": 0.0,
    "TotalInsurance": 0.0,
    "TotalDeduction": 0.0
  },
  "validation": {
    "CalculatedTotal": 74.7,
    "BalanceCheck": 0.0,
...
**For Future LLM Reference**: If this HAWB9671284-Manifest file shows ANY issues in future versions (v1.2+), it indicates a REGRESSION. The v1.1 logic should be restored as this file achieved perfect processing status.
