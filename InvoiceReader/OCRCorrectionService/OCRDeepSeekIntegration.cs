    ...
    public partial class OCRCorrectionService
    {
            ...
            LineContext lineContext)
        {
            ...
            try
            {
                ...
                string documentType = "Shipment Invoice"; // Default document type for AI regex creation
            ...
            string failureReason)
        {
            ...
            if (correction == null || lineContext == null || failedResponse == null)
            {
                ...
                string documentType = "Shipment Invoice"; // Default document type for AI regex creation with fallback
                _logger.Error($"📋 **DOCUMENT_TYPE_DETECTED**: {documentType} - Using DatabaseTemplateHelper document-specific validation rules");
