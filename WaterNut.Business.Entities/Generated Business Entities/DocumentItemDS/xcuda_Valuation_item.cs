...
namespace DocumentItemDS.Business.Entities
{
    ...
    public partial class xcuda_Valuation_item : BaseEntity<xcuda_Valuation_item>, ITrackable 
    {
        ...
        [DataMember]
        public xcuda_item_deduction xcuda_item_deduction { get; set; }
        [DataMember]
        public xcuda_item_external_freight xcuda_item_external_freight { get; set; }
        [DataMember]
        public xcuda_item_insurance xcuda_item_insurance { get; set; }
        [DataMember]
        public xcuda_item_internal_freight xcuda_item_internal_freight { get; set; }
        [DataMember]
        public xcuda_Item_Invoice xcuda_Item_Invoice { get; set; }
        [DataMember]
        public xcuda_item_other_cost xcuda_item_other_cost { get; set; }
        [DataMember]
