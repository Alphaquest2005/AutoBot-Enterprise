...
namespace PreviousDocumentDS.Business.Entities
{
    ...
    public partial class xcuda_Valuation_item : BaseEntity<xcuda_Valuation_item>, ITrackable 
    {
        ...
        float _total_cost_itm;
        [DataMember]
        public float Total_CIF_itm 
        {
            get
            {
        ...
        float _total_cif_itm;
        [DataMember]
        public Nullable<float> Rate_of_adjustement 
        {
            get
            {
        ...
        Nullable<float> _rate_of_adjustement;
        [DataMember]
        public float Statistical_value 
        {
            get
            {
