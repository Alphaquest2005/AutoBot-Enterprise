namespace EntryDataQS.Business.Entities.Mapping
{
    ...
    public partial class AsycudaDocumentEntryDataMap : EntityTypeConfiguration<AsycudaDocumentEntryData>
    {
        ...
        {                        
              ...
              this.HasRequired(t => t.EntryDataEx).WithMany(t =>(ICollection<AsycudaDocumentEntryData>) t.AsycudaDocuments).HasForeignKey(d => d.EntryDataId);
              this.HasRequired(t => t.EntryData).WithMany(t =>(ICollection<AsycudaDocumentEntryData>) t.AsycudaDocumentEntryDatas).HasForeignKey(d => d.EntryDataId);
             // Tracking Properties
