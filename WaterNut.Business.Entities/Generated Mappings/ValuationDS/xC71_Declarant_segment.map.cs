namespace ValuationDS.Business.Entities.Mapping
{
    ...
    public partial class xC71_Declarant_segmentMap : EntityTypeConfiguration<xC71_Declarant_segment>
    {
        public xC71_Declarant_segmentMap()
        {                        
              this.HasKey(t => t.Identification_segment_Id);        
              this.ToTable("xC71_Declarant_segment");
              ...
              this.HasRequired(t => t.xC71_Identification_segment).WithOptional(t => (xC71_Declarant_segment)t.xC71_Declarant_segment);
             // Tracking Properties
