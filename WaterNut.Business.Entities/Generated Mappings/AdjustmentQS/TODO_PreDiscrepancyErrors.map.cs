namespace AdjustmentQS.Business.Entities.Mapping
{
    ...
    public partial class TODO_PreDiscrepancyErrorsMap : EntityTypeConfiguration<TODO_PreDiscrepancyErrors>
    {
        public TODO_PreDiscrepancyErrorsMap()
        {                        
              this.HasKey(t => new {t.EntryDataDetailsId, t.ApplicationSettingsId});        
              this.ToTable("TODO-PreDiscrepancyErrors");
