namespace AdjustmentQS.Business.Entities.Mapping
{
    ...
    public partial class TODO_AdjustmentOversToXMLMap : EntityTypeConfiguration<TODO_AdjustmentOversToXML>
    {
        public TODO_AdjustmentOversToXMLMap()
        {                        
              this.HasKey(t => new {t.EntryDataDetailsId, t.EntryData_Id});        
              this.ToTable("TODO-AdjustmentOversToXML");
