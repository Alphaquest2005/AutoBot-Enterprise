namespace CoreEntities.Business.Entities.Mapping
{
    ...
    public partial class InventoryItemAliasXMap : EntityTypeConfiguration<InventoryItemAliasX>
    {
        public InventoryItemAliasXMap()
        {                        
              ...
              this.HasRequired(t => t.InventoryItemsEx).WithMany(t =>(ICollection<InventoryItemAliasX>) t.InventoryItemAliasEx).HasForeignKey(d => new {d.ItemNumber, d.ApplicationSettingsId});
             // Tracking Properties
