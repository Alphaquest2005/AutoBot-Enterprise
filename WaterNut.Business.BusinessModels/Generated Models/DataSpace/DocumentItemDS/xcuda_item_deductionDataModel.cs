...
{
	public partial class xcuda_item_deductionDataModel_AutoGen 
	{
        private static readonly xcuda_item_deductionDataModel_AutoGen instance;
        static xcuda_item_deductionDataModel_AutoGen()
        {
            instance = new xcuda_item_deductionDataModel_AutoGen();
        }

        public static  xcuda_item_deductionDataModel_AutoGen Instance
        {
            get { return instance; }
        }
