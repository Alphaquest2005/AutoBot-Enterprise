...
{
	public partial class OversShortDataModel_AutoGen 
	{
        private static readonly OversShortDataModel_AutoGen instance;
        static OversShortDataModel_AutoGen()
        {
            instance = new OversShortDataModel_AutoGen();
        }

        public static  OversShortDataModel_AutoGen Instance
        {
            get { return instance; }
        }
