...
{
	public partial class xcuda_RegistrationDataModel_AutoGen 
	{
        private static readonly xcuda_RegistrationDataModel_AutoGen instance;
        static xcuda_RegistrationDataModel_AutoGen()
        {
            instance = new xcuda_RegistrationDataModel_AutoGen();
        }

        public static  xcuda_RegistrationDataModel_AutoGen Instance
        {
            get { return instance; }
        }
