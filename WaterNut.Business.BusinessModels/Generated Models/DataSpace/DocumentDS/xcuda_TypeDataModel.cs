...
{
	public partial class xcuda_TypeDataModel_AutoGen 
	{
        private static readonly xcuda_TypeDataModel_AutoGen instance;
        static xcuda_TypeDataModel_AutoGen()
        {
            instance = new xcuda_TypeDataModel_AutoGen();
        }

        public static  xcuda_TypeDataModel_AutoGen Instance
        {
            get { return instance; }
        }
