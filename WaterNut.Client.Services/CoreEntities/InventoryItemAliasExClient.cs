...
namespace CoreEntities.Client.Services
{
    ...
    public partial class InventoryItemAliasExClient :  ClientService<IInventoryItemAliasExService>, IInventoryItemAliasExService, IDisposable
    {
        ...
        public async Task<IEnumerable<InventoryItemAliasEx>> GetInventoryItemAliasEx(List<string> includesLst = null)
        {
            return await Channel.GetInventoryItemAliasEx(includesLst).ConfigureAwait(false);
        }
        ...
        {
            return await Channel.GetInventoryItemAliasExByExpression(exp, includesLst).ConfigureAwait(false);
        }
        ...
        {
            return await Channel.GetInventoryItemAliasExByExpressionLst(expLst, includesLst).ConfigureAwait(false);
        }

		public async Task<IEnumerable<InventoryItemAliasEx>> GetInventoryItemAliasExByExpressionNav(string exp,
															 Dictionary<string, string> navExp, List<string> includesLst = null)
		{
			return await Channel.GetInventoryItemAliasExByExpressionNav(exp, navExp, includesLst).ConfigureAwait(false);
		}

        public async Task<IEnumerable<InventoryItemAliasEx>> GetInventoryItemAliasExByBatch(string exp,
                                                                        int totalrow, List<string> includesLst = null)
        {
            return await Channel.GetInventoryItemAliasExByBatch(exp, totalrow, includesLst).ConfigureAwait(false);
        }

        public async Task<IEnumerable<InventoryItemAliasEx>> GetInventoryItemAliasExByBatchExpressionLst(List<string> expLst,
                                                                        int totalrow, List<string> includesLst = null)
        {
            return await Channel.GetInventoryItemAliasExByBatchExpressionLst(expLst, totalrow, includesLst).ConfigureAwait(false);
        }
