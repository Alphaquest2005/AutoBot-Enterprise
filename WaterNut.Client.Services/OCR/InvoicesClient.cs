...
{
    [Export (typeof(InvoicesClient))]
    [Export (typeof(IInvoicesService))]
    [Export(typeof(IClientService))]
    [PartCreationPolicy(CreationPolicy.NonShared)]
    public partial class InvoicesClient :  ClientService<IInvoicesService>, IInvoicesService, IDisposable
    {
        
        public async Task<IEnumerable<Invoices>> GetInvoices(List<string> includesLst = null)
        {
            return await Channel.GetInvoices(includesLst).ConfigureAwait(false);
        }

        public async Task<Invoices> GetInvoicesByKey(string id, List<string> includesLst = null)
        {
            return await Channel.GetInvoicesByKey(id, includesLst).ConfigureAwait(false);
        }

		public async Task<IEnumerable<Invoices>> GetInvoicesByExpression(string exp, List<string> includesLst = null)
        {
            return await Channel.GetInvoicesByExpression(exp, includesLst).ConfigureAwait(false);
        }

		public async Task<IEnumerable<Invoices>> GetInvoicesByExpressionLst(List<string> expLst, List<string> includesLst = null)
        {
            return await Channel.GetInvoicesByExpressionLst(expLst, includesLst).ConfigureAwait(false);
        }

		public async Task<IEnumerable<Invoices>> GetInvoicesByExpressionNav(string exp,
															 Dictionary<string, string> navExp, List<string> includesLst = null)
		{
			return await Channel.GetInvoicesByExpressionNav(exp, navExp, includesLst).ConfigureAwait(false);
		}

        public async Task<IEnumerable<Invoices>> GetInvoicesByBatch(string exp,
                                                                        int totalrow, List<string> includesLst = null)
        {
            return await Channel.GetInvoicesByBatch(exp, totalrow, includesLst).ConfigureAwait(false);
        }

        public async Task<IEnumerable<Invoices>> GetInvoicesByBatchExpressionLst(List<string> expLst,
                                                                        int totalrow, List<string> includesLst = null)
        {
            return await Channel.GetInvoicesByBatchExpressionLst(expLst, totalrow, includesLst).ConfigureAwait(false);
        }

        public async Task<Invoices> UpdateInvoices(Invoices entity)
        {
           return await Channel.UpdateInvoices(entity).ConfigureAwait(false);
        }

        public async Task<Invoices> CreateInvoices(Invoices entity)
        {
           return await Channel.CreateInvoices(entity).ConfigureAwait(false);
        }

        public async Task<bool> DeleteInvoices(string id)
        {
            return await Channel.DeleteInvoices(id).ConfigureAwait(false);
        }

        public async Task<bool> RemoveSelectedInvoices(IEnumerable<string> selectedInvoices)
        {
           return await Channel.RemoveSelectedInvoices(selectedInvoices).ConfigureAwait(false);
        }
