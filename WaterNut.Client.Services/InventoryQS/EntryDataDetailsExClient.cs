...
namespace InventoryQS.Client.Services
{
    ...
    public partial class EntryDataDetailsExClient :  ClientService<IEntryDataDetailsExService>, IEntryDataDetailsExService, IDisposable
    {
        ...
        public async Task<IEnumerable<EntryDataDetailsEx>> GetEntryDataDetailsEx(List<string> includesLst = null)
        {
            return await Channel.GetEntryDataDetailsEx(includesLst).ConfigureAwait(false);
        }
        ...
        {
            return await Channel.GetEntryDataDetailsExByExpression(exp, includesLst).ConfigureAwait(false);
        }
        ...
        {
            return await Channel.GetEntryDataDetailsExByExpressionLst(expLst, includesLst).ConfigureAwait(false);
        }

		public async Task<IEnumerable<EntryDataDetailsEx>> GetEntryDataDetailsExByExpressionNav(string exp,
															 Dictionary<string, string> navExp, List<string> includesLst = null)
		{
			return await Channel.GetEntryDataDetailsExByExpressionNav(exp, navExp, includesLst).ConfigureAwait(false);
		}

        public async Task<IEnumerable<EntryDataDetailsEx>> GetEntryDataDetailsExByBatch(string exp,
                                                                        int totalrow, List<string> includesLst = null)
        {
            return await Channel.GetEntryDataDetailsExByBatch(exp, totalrow, includesLst).ConfigureAwait(false);
        }

        public async Task<IEnumerable<EntryDataDetailsEx>> GetEntryDataDetailsExByBatchExpressionLst(List<string> expLst,
                                                                        int totalrow, List<string> includesLst = null)
        {
            return await Channel.GetEntryDataDetailsExByBatchExpressionLst(expLst, totalrow, includesLst).ConfigureAwait(false);
        }
