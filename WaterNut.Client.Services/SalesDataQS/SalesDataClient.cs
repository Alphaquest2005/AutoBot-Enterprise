...
namespace SalesDataQS.Client.Services
{
    ...
    public partial class SalesDataClient :  ClientService<ISalesDataService>, ISalesDataService, IDisposable
    {
        ...
        {
           return await Channel.RemoveSelectedSalesData(selectedSalesData).ConfigureAwait(false);
        }
       ...
       // Virtural List implementation
        ...
        {
            return  await Channel.GetSalesDataByApplicationSettingsId(ApplicationSettingsId, includesLst).ConfigureAwait(false);
        }
