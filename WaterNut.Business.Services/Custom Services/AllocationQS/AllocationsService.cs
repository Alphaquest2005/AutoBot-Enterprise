...
namespace AllocationQS.Business.Services
{
    ...
    public partial class AllocationsService : IAllocationsService, IDisposable
   {
        ...
        public async Task CreateEx9(string filterExpression, bool perIM7, bool process7100, bool applyCurrentChecks,
            int AsycudaDocumentSetId, string documentType, string ex9BucketType, bool isGrouped, bool checkQtyAllocatedGreaterThanPiQuantity, bool checkForMultipleMonths, bool applyEx9Bucket, bool applyHistoricChecks, bool perInvoice, bool autoAssess, bool overPIcheck, bool universalPIcheck)
        {
            var docset =
           ...
           await WaterNut.DataSpace.CreateEx9Class.Instance.CreateEx9(filterExpression, perIM7, process7100, applyCurrentChecks, docset, documentType, ex9BucketType, isGrouped, checkQtyAllocatedGreaterThanPiQuantity, checkForMultipleMonths,
                    applyEx9Bucket, applyHistoricChecks, perInvoice, autoAssess, overPIcheck, universalPIcheck).ConfigureAwait(false);
        }
