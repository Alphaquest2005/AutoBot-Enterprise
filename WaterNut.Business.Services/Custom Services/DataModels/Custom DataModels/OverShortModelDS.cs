...
//            using (var ctx = new Adjustmentservice())
//            {
...
//                                // InventoryItem = g.Key.InventoryItem.ItemNumber,
...
//            DocumentCT cdoc = await BaseDataModel.Instance.CreateDocumentCt(docSet).ConfigureAwait(false);
//            CreateEx9Class.Instance.Ex9InitializeCdoc(dt, dfp, cdoc, docSet, "7400");
...
//                    //   if (await CreateEx9Class.Instance.CreateEx9EntryAsync(pod, cdoc, itmcount, dfp, "7400", new List<CreateEx9Class.ItemSalesPiSummary>()).ConfigureAwait(false))
//                    {
