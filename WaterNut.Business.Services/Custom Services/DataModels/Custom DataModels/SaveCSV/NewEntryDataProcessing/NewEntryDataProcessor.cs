...
{
    public class NewEntryDataProcessor : INewEntryDataProcessor
    {
        ...
        {
            int applicationSettingsId = rawEntryData.EntryData.ApplicationSettingsId;
            string entryDataId = rawEntryData.EntryData.EntryDataId;
            EntryData entryData = null;

            entryData = await entryDataCreators[fileType.FileImporterInfos.EntryType]
                .CreateAndSave(docSet, rawEntryData, applicationSettingsId, entryDataId).ConfigureAwait(false);
