...
namespace CounterPointQS.Business.Services
{
   ...
   [ServiceBehavior(InstanceContextMode = InstanceContextMode.PerCall,
    ...
    public partial class CounterPointSalesDetailsService : ICounterPointSalesDetailsService, IDisposable
    {
        //private readonly CounterPointQSContext dbContext;

        public bool StartTracking { get; set; }

        public CounterPointSalesDetailsService()
        {
            try
            {
            ...
            //using (var scope = new TransactionScope(TransactionScopeOption.Required,
               ...
               // {
                  using ( var dbContext = new CounterPointQSContext(){StartTracking = StartTracking})
                  {
                    ...
                    IEnumerable<CounterPointSalesDetails> entities = await set.AsNoTracking().ToListAsync()
        ...
        public async Task<CounterPointSalesDetails> GetCounterPointSalesDetailsByKey(string INVNO, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
              ...
              using ( var dbContext = new CounterPointQSContext(){StartTracking = StartTracking})
              {
                var i = INVNO;
				var set = AddIncludes(includesLst, dbContext);
                CounterPointSalesDetails entity = await set.AsNoTracking().SingleOrDefaultAsync(x => x.INVNO == i).ConfigureAwait(continueOnCapturedContext: false);
            ...
            int totalrow, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
                ...
                var res = new ConcurrentQueue<List<CounterPointSalesDetails>>();
                    ...
                    //  for (int bat = 0; bat < batches; bat++)
                    {
                        try
                        {
                            using (var dbContext = new CounterPointQSContext(){StartTracking = StartTracking})
                            {
                                ...
                                var set = AddIncludes(includesLst, dbContext);
                                IQueryable<CounterPointSalesDetails> dset;
                                if (exp == "All")
                                {
                                    dset = set.OrderBy(x => x.INVNO);
                                }
                                else
                                {
                                    dset = set.OrderBy(x => x.INVNO).Where(exp);
                                }
            ...
            using ( var dbContext = new CounterPointQSContext(){StartTracking = StartTracking})
              {
                try
                {   
                     var res = (CounterPointSalesDetails) entity;
        ...
        public async Task<bool> DeleteCounterPointSalesDetails(string INVNO)
        {
            try
            {
              ...
              {
                var i = INVNO;
                CounterPointSalesDetails entity = await dbContext.CounterPointSalesDetails
													.SingleOrDefaultAsync(x => x.INVNO == i)
													.ConfigureAwait(continueOnCapturedContext: false);
                if (entity == null)
                    return false;
        ...
        public async Task<bool> RemoveSelectedCounterPointSalesDetails(IEnumerable<string> lst)
        {
            try
            {
                StatusModel.StartStatusUpdate("Removing CounterPointSalesDetails", lst.Count());
                var t = Task.Run(() =>
                {
                    using (var ctx = new CounterPointSalesDetailsService())
                    {
                        foreach (var item in lst.ToList())
                        {

                            ctx.DeleteCounterPointSalesDetails(item).Wait();
		...
		public async Task<int> Count(string exp)
        {
            try
            {
                using (CounterPointQSContext dbContext = new CounterPointQSContext(){StartTracking = StartTracking})
                {
                    ...
                    if (exp == "All")
                    {
                        return await dbContext.CounterPointSalesDetails
                                    .AsNoTracking()
									.CountAsync()
									.ConfigureAwait(continueOnCapturedContext: false);
                    }
		...
		public async Task<int> CountNav(string exp, Dictionary<string, string> navExp)
        {
            try
            {
                ...
                using (var dbContext = new CounterPointQSContext(){StartTracking = StartTracking})
                {
                    ...
                    return await dbContext.CounterPointSalesDetails.Where(exp == "All" || exp == null ? "INVNO != null" : exp)
											.AsNoTracking()
                                            .CountAsync()
											.ConfigureAwait(continueOnCapturedContext: false);
                }
                                                                                 ...
                                                                                 Dictionary<string, string> navExp, IEnumerable<string> includeLst = null)
        {
            try
            {
                using (var dbContext = new CounterPointQSContext(){StartTracking = StartTracking})
                {
                    ...
                    return await set//dbContext.CounterPointSalesDetails
								.AsNoTracking()
                                .Where(exp == "All" || exp == null ? "INVNO != null" : exp)
								.OrderBy(y => y.INVNO)
		...
		private static async Task<IEnumerable<CounterPointSalesDetails>> LoadRangeWhere<T>(int startIndex, int count,
        ...
        private static async Task<IEnumerable<CounterPointSalesDetails>> GetWhere<T>(CounterPointQSContext dbContext,
             ...
             try
             {
                 using (var dbContext = new CounterPointQSContext(){StartTracking = StartTracking})
                 {
					...
					decimal res = 0;
                     ...
                     if (whereExp == "All")
                     {
                          res = Convert.ToDecimal(dbContext.CounterPointSalesDetails.AsNoTracking().Sum(field));
                     }
                     else
                     {
                         res = Convert.ToDecimal(dbContext.CounterPointSalesDetails.AsNoTracking().Where(whereExp).Sum(field));
                     }
             ...
             try
             {
                 using (var dbContext = new CounterPointQSContext(){StartTracking = StartTracking})
                 {
					...
					string res = "";
                     ...
                     if (whereExp == "All")
                     {
                          res = Convert.ToString(dbContext.CounterPointSalesDetails.AsNoTracking().Min(field));
                     }
                     else
                     {
                         res = Convert.ToString(dbContext.CounterPointSalesDetails.AsNoTracking().Where(whereExp).Min(field));
                     }
		...
		private static IQueryable<CounterPointSalesDetails> AddIncludes(IEnumerable<string> includesLst, CounterPointQSContext dbContext)
       {
		 try
			{
			   if (includesLst == null) includesLst = new List<string>();
			   var set =(DbQuery<CounterPointSalesDetails>) dbContext.CounterPointSalesDetails; 
	   ...
	   private IQueryable<CounterPointSalesDetails> AddWheres(List<string> expLst, IQueryable<CounterPointSalesDetails> set)
        {
            try
            {
