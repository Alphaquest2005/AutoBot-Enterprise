...
namespace AllocationDS.Business.Services
{
   ...
   [ServiceBehavior(InstanceContextMode = InstanceContextMode.PerCall,
    ...
    public partial class EntryDataService : IEntryDataService, IDisposable
    {
		...
		private static Task<IEnumerable<EntryData>> GetWhereSelectMany<T>(AllocationDSContext dbContext,
		...
		private static Task<IEnumerable<EntryData>> GetWhereSelect<T>(AllocationDSContext dbContext,
                                                                      string exp, string navExp, string navProp, List<string> includesLst = null) where T : class
        {
			try
			{
