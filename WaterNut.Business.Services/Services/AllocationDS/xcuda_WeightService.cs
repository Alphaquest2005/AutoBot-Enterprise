...
namespace AllocationDS.Business.Services
{
   ...
   [ServiceBehavior(InstanceContextMode = InstanceContextMode.PerCall,
    ...
    public partial class xcuda_WeightService : Ixcuda_WeightService, IDisposable
    {
        ...
        public Task<IEnumerable<xcuda_Weight>> Getxcuda_Weight(List<string> includesLst = null, bool tracking = true)
        {
            try
            {
        ...
        public Task<xcuda_Weight> Getxcuda_WeightByKey(string Valuation_Id, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
			   if(string.IsNullOrEmpty(Valuation_Id))return Task.FromResult<xcuda_Weight>(null); 
              using ( var dbContext = new AllocationDSContext(){StartTracking = StartTracking})
              {
                var i = Convert.ToInt32(Valuation_Id);
				var set = AddIncludes(includesLst, dbContext);
                xcuda_Weight entity = set.AsNoTracking().SingleOrDefault(x => x.Valuation_Id == i);
		 ...
		 public Task<IEnumerable<xcuda_Weight>> Getxcuda_WeightByExpression(string exp, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
                using (var dbContext = new AllocationDSContext(){StartTracking = StartTracking})
                {
					...
					if (string.IsNullOrEmpty(exp) || exp == "None") return Task.FromResult<IEnumerable<xcuda_Weight>>(new List<xcuda_Weight>());
					var set = AddIncludes(includesLst, dbContext);
                    if (exp == "All")
                    {
                        ...
                        if(tracking) entities.AsParallel(new ParallelLinqOptions() { MaxDegreeOfParallelism = Environment.ProcessorCount }).ForAll(x => x.StartTracking());
                        return Task.FromResult<IEnumerable<xcuda_Weight>>(entities); 
                    }
					else
					{
		 ...
		 public Task<IEnumerable<xcuda_Weight>> Getxcuda_WeightByExpressionLst(List<string> expLst, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
                using (var dbContext = new AllocationDSContext(){StartTracking = StartTracking})
                {
                    dbContext.Database.CommandTimeout = 0;
					if (expLst.Count == 0 || expLst.FirstOrDefault() == "None") return Task.FromResult<IEnumerable<xcuda_Weight>>(new List<xcuda_Weight>());
					var set = AddIncludes(includesLst, dbContext);
		...
		public Task<IEnumerable<xcuda_Weight>> Getxcuda_WeightByExpressionNav(string exp,
            ...
            try
            {
                using (var dbContext = new AllocationDSContext(){StartTracking = StartTracking})
                {
                    ...
                    if (exp == "All" && navExp.Count == 0)
                    {
                        ...
                        return Task.FromResult<IEnumerable<xcuda_Weight>>(aentities); 
                    }
					var set = AddIncludes(includesLst, dbContext);
                    var entities = set.AsNoTracking().Where(exp)
									.ToList();
        ...
        public Task<IEnumerable<xcuda_Weight>> Getxcuda_WeightByBatch(string exp,
        ...
        public Task<IEnumerable<xcuda_Weight>> Getxcuda_WeightByBatchExpressionLst(List<string> expLst,
                                                                                   int totalrow, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
        ...
        public Task<xcuda_Weight> Updatexcuda_Weight(xcuda_Weight entity)
        { 
            using ( var dbContext = new AllocationDSContext(){StartTracking = StartTracking})
              {
                try
        ...
        public Task<xcuda_Weight> Createxcuda_Weight(xcuda_Weight entity)
        {
            try
            {
                var res = (xcuda_Weight) entity;
        ...
        public Task<bool> Deletexcuda_Weight(string Valuation_Id)
        {
            try
            {
              using ( var dbContext = new AllocationDSContext(){StartTracking = StartTracking})
              {
                var i = Convert.ToInt32(Valuation_Id);
                xcuda_Weight entity = dbContext.xcuda_Weight
        ...
        public async Task<bool> RemoveSelectedxcuda_Weight(IEnumerable<string> lst)
        {
            try
            {
                StatusModel.StartStatusUpdate("Removing xcuda_Weight", lst.Count());
                var t = Task.Run(() =>
                {
                    using (var ctx = new xcuda_WeightService())
                    {
                        foreach (var item in lst.ToList())
                        {
                            ...
                            ctx.Deletexcuda_Weight(item).Wait();
		...
		public Task<int> Count(string exp)
        {
            try
            {
                using (AllocationDSContext dbContext = new AllocationDSContext(){StartTracking = StartTracking})
                {
                    ...
                    if (exp == "All")
                    {
                        return Task.FromResult(dbContext.xcuda_Weight
                            .AsNoTracking()
                            .Count());
                    }
                    else
        ...
        public Task<IEnumerable<xcuda_Weight>> LoadRange(int startIndex, int count, string exp)
        {
            try
            {
                using (var dbContext = new AllocationDSContext(){StartTracking = StartTracking})
                {
                    ...
                    if (exp == "All")
                    {
                        return Task.FromResult<IEnumerable<xcuda_Weight>>(dbContext.xcuda_Weight
                            .AsNoTracking()
		...
		public Task<int> CountNav(string exp, Dictionary<string, string> navExp)
        {
            try
            {
                ...
                using (var dbContext = new AllocationDSContext(){StartTracking = StartTracking})
                {
                    ...
                    return Task.FromResult(dbContext.xcuda_Weight.Where(exp == "All" || exp == null ? "Valuation_Id != null" : exp)
                        .AsNoTracking()
                        .Count());
                }
		...
		private static Task<int> CountWhereSelect<T>(AllocationDSContext dbContext, string exp, string navExp, string navProp) where T : class
        {
		  ...
		  public Task<IEnumerable<xcuda_Weight>> LoadRangeNav(int startIndex, int count, string exp,
                                                              Dictionary<string, string> navExp, IEnumerable<string> includeLst = null)
        {
            try
            {
                ...
                {
                    dbContext.Database.CommandTimeout = 0;
                    if ((string.IsNullOrEmpty(exp) && navExp.Count == 0) || exp == "None") return Task.FromResult<IEnumerable<xcuda_Weight>>(new List<xcuda_Weight>());
                    var set = AddIncludes(includeLst, dbContext);

                    if (exp == "All" && navExp.Count == 0)
                    {
                       
                        return Task.FromResult<IEnumerable<xcuda_Weight>>(set
                            .AsNoTracking()
                            .OrderBy(y => y.Valuation_Id)
                    ...
                    return Task.FromResult<IEnumerable<xcuda_Weight>>(set//dbContext.xcuda_Weight
                        .AsNoTracking()
                        .Where(exp == "All" || exp == null ? "Valuation_Id != null" : exp)
                        .OrderBy(y => y.Valuation_Id)
		...
		private static Task<IEnumerable<xcuda_Weight>> LoadRangeSelectMany<T>(int startIndex, int count,
		...
		private static Task<IEnumerable<xcuda_Weight>> LoadRangeSelect<T>(int startIndex, int count,
                                                                          AllocationDSContext dbContext, string exp, string navExp, string navProp, IEnumerable<string> includeLst = null) where T : class
        {
			try
			{
		...
		private static Task<IEnumerable<xcuda_Weight>> GetWhereSelectMany<T>(AllocationDSContext dbContext,
                                                                             string exp, string navExp, string navProp, List<string> includesLst = null) where T : class
        {
			...
			if (includesLst == null)
			{
				return Task.FromResult<IEnumerable<xcuda_Weight>>(dbContext.Set<T>()
                    .AsNoTracking()
                    .Where(navExp)
                    .SelectMany(navProp).OfType<xcuda_Weight>()
                    .Where(exp == "All" || exp == null?"Valuation_Id != null":exp)
            ...
            return Task.FromResult<IEnumerable<xcuda_Weight>>(set.ToList());
			}
			catch (Exception)
			{
				Debugger.Break();
		...
		private static Task<IEnumerable<xcuda_Weight>> GetWhereSelect<T>(AllocationDSContext dbContext,
                                                                         string exp, string navExp, string navProp, List<string> includesLst = null) where T : class
        {
			try
			{
        ...
        public Task<decimal> SumNav( string exp, Dictionary<string, string> navExp, string field)
        {
            try
            {
                ...
                {
                    dbContext.Database.CommandTimeout = 0;
                    if (!dbContext.xcuda_Weight.Any()) return Task.FromResult<decimal>(0);
                    if (exp == "All" && navExp.Count == 0)
                    {
                        return Task.FromResult(Convert.ToDecimal(dbContext.xcuda_Weight
                                                                     .AsNoTracking()
                                                                     .Sum(field)??0));
                    }
                    return Task.FromResult(Convert.ToDecimal(dbContext.xcuda_Weight.Where(exp == "All" || exp == null ? "Valuation_Id != null" : exp)
                                                                 .AsNoTracking()
                                                                 .Sum(field)??0));
                }
