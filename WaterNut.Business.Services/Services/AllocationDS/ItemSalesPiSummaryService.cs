...
{
   [Export (typeof(IItemSalesPiSummaryService))]
   [Export(typeof(IBusinessService))]
   [PartCreationPolicy(CreationPolicy.NonShared)]
   [ServiceBehavior(InstanceContextMode = InstanceContextMode.PerCall,
                    ConcurrencyMode = ConcurrencyMode.Multiple)]
   
    public partial class ItemSalesPiSummaryService : IItemSalesPiSummaryService, IDisposable
    {
        //private readonly AllocationDSContext dbContext;

        public bool StartTracking { get; set; }

        public ItemSalesPiSummaryService()
        {
            try
            {
        ...
        public Task<IEnumerable<ItemSalesPiSummary>> GetItemSalesPiSummary(List<string> includesLst = null, bool tracking = true)
        {
            try
            {
            //using (var scope = new TransactionScope(TransactionScopeOption.Required,
               ...
               // {
                  using ( var dbContext = new AllocationDSContext(){StartTracking = StartTracking})
                  {
                    ...
                    IEnumerable<ItemSalesPiSummary> entities = set.AsNoTracking().ToList();
                           //scope.Complete();
        ...
        public Task<ItemSalesPiSummary> GetItemSalesPiSummaryByKey(string PreviousItem_Id, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
			   if(string.IsNullOrEmpty(PreviousItem_Id))return Task.FromResult<ItemSalesPiSummary>(null); 
              using ( var dbContext = new AllocationDSContext(){StartTracking = StartTracking})
              {
                var i = Convert.ToInt32(PreviousItem_Id);
				var set = AddIncludes(includesLst, dbContext);
                ItemSalesPiSummary entity = set.AsNoTracking().SingleOrDefault(x => x.PreviousItem_Id == i);
		 ...
		 public Task<IEnumerable<ItemSalesPiSummary>> GetItemSalesPiSummaryByExpression(string exp, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
                using (var dbContext = new AllocationDSContext(){StartTracking = StartTracking})
                {
					...
					if (string.IsNullOrEmpty(exp) || exp == "None") return Task.FromResult<IEnumerable<ItemSalesPiSummary>>(new List<ItemSalesPiSummary>());
					var set = AddIncludes(includesLst, dbContext);
                    if (exp == "All")
                    {
                        ...
                        if(tracking) entities.AsParallel(new ParallelLinqOptions() { MaxDegreeOfParallelism = Environment.ProcessorCount }).ForAll(x => x.StartTracking());
                        return Task.FromResult<IEnumerable<ItemSalesPiSummary>>(entities); 
                    }
					else
					{
		 ...
		 public Task<IEnumerable<ItemSalesPiSummary>> GetItemSalesPiSummaryByExpressionLst(List<string> expLst, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
                using (var dbContext = new AllocationDSContext(){StartTracking = StartTracking})
                {
                    dbContext.Database.CommandTimeout = 0;
					if (expLst.Count == 0 || expLst.FirstOrDefault() == "None") return Task.FromResult<IEnumerable<ItemSalesPiSummary>>(new List<ItemSalesPiSummary>());
					var set = AddIncludes(includesLst, dbContext);
		...
		public Task<IEnumerable<ItemSalesPiSummary>> GetItemSalesPiSummaryByExpressionNav(string exp,
            ...
            try
            {
                using (var dbContext = new AllocationDSContext(){StartTracking = StartTracking})
                {
                    ...
                    if (exp == "All" && navExp.Count == 0)
                    {
                        ...
                        return Task.FromResult<IEnumerable<ItemSalesPiSummary>>(aentities); 
                    }
					var set = AddIncludes(includesLst, dbContext);
                    var entities = set.AsNoTracking().Where(exp)
									.ToList();
        ...
        public Task<IEnumerable<ItemSalesPiSummary>> GetItemSalesPiSummaryByBatch(string exp,
                                                                                  int totalrow, List<string> includesLst = null, bool tracking = true)
        {
            try
            {

                var res = new ConcurrentQueue<List<ItemSalesPiSummary>>();
        ...
        public Task<IEnumerable<ItemSalesPiSummary>> GetItemSalesPiSummaryByBatchExpressionLst(List<string> expLst,
                                                                                               int totalrow, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
        ...
        public Task<ItemSalesPiSummary> UpdateItemSalesPiSummary(ItemSalesPiSummary entity)
        { 
            using ( var dbContext = new AllocationDSContext(){StartTracking = StartTracking})
              {
                try
                {   
                     var res = (ItemSalesPiSummary) entity;
        ...
        public Task<ItemSalesPiSummary> CreateItemSalesPiSummary(ItemSalesPiSummary entity)
        {
            try
            {
                var res = (ItemSalesPiSummary) entity;
              using ( var dbContext = new AllocationDSContext(){StartTracking = StartTracking})
              {
                dbContext.ItemSalesPiSummary.Add(res);
                dbContext.SaveChanges();
                res.AcceptChanges();
                return Task.FromResult(res);
              }
        ...
        public Task<bool> DeleteItemSalesPiSummary(string PreviousItem_Id)
        {
            try
            {
              using ( var dbContext = new AllocationDSContext(){StartTracking = StartTracking})
              {
                var i = Convert.ToInt32(PreviousItem_Id);
                ItemSalesPiSummary entity = dbContext.ItemSalesPiSummary
													.SingleOrDefault(x => x.PreviousItem_Id == i);
                if (entity == null)
                    return Task.FromResult(false);

                    dbContext.ItemSalesPiSummary.Attach(entity);
                    dbContext.ItemSalesPiSummary.Remove(entity);
                    dbContext.SaveChanges();
        ...
        public async Task<bool> RemoveSelectedItemSalesPiSummary(IEnumerable<string> lst)
        {
            try
            {
         ...
         public Task<int> CountByExpressionLst(List<string> expLst)
        {
            try
            {
                using (var dbContext = new AllocationDSContext(){StartTracking = StartTracking})
                {
                    ...
                    var set = (IQueryable<ItemSalesPiSummary>)dbContext.ItemSalesPiSummary; 
                    if (expLst.FirstOrDefault() == "All")
                    {
		...
		public Task<int> Count(string exp)
        {
            try
            {
                using (AllocationDSContext dbContext = new AllocationDSContext(){StartTracking = StartTracking})
                {
                    ...
                    if (exp == "All")
                    {
                        return Task.FromResult(dbContext.ItemSalesPiSummary
                            .AsNoTracking()
                            .Count());
                    }
                    else
        ...
        public Task<IEnumerable<ItemSalesPiSummary>> LoadRange(int startIndex, int count, string exp)
        {
            try
            {
                using (var dbContext = new AllocationDSContext(){StartTracking = StartTracking})
                {
                    ...
                    if (exp == "All")
                    {
                        return Task.FromResult<IEnumerable<ItemSalesPiSummary>>(dbContext.ItemSalesPiSummary
                            .AsNoTracking()
		...
		public Task<int> CountNav(string exp, Dictionary<string, string> navExp)
        {
            try
            {
                ...
                using (var dbContext = new AllocationDSContext(){StartTracking = StartTracking})
                {
                    ...
                    return Task.FromResult(dbContext.ItemSalesPiSummary.Where(exp == "All" || exp == null ? "PreviousItem_Id != null" : exp)
                        .AsNoTracking()
                        .Count());
                }
		...
		private static Task<int> CountWhereSelect<T>(AllocationDSContext dbContext, string exp, string navExp, string navProp) where T : class
        {
		  ...
		  public Task<IEnumerable<ItemSalesPiSummary>> LoadRangeNav(int startIndex, int count, string exp,
                                                                    Dictionary<string, string> navExp, IEnumerable<string> includeLst = null)
        {
            try
            {
                ...
                {
                    dbContext.Database.CommandTimeout = 0;
                    if ((string.IsNullOrEmpty(exp) && navExp.Count == 0) || exp == "None") return Task.FromResult<IEnumerable<ItemSalesPiSummary>>(new List<ItemSalesPiSummary>());
                    var set = AddIncludes(includeLst, dbContext);

                    if (exp == "All" && navExp.Count == 0)
                    {
                       
                        return Task.FromResult<IEnumerable<ItemSalesPiSummary>>(set
                            .AsNoTracking()
                            .OrderBy(y => y.PreviousItem_Id)
                    ...
                    return Task.FromResult<IEnumerable<ItemSalesPiSummary>>(set//dbContext.ItemSalesPiSummary
                        .AsNoTracking()
                        .Where(exp == "All" || exp == null ? "PreviousItem_Id != null" : exp)
                        .OrderBy(y => y.PreviousItem_Id)
		...
		private static async Task<IEnumerable<ItemSalesPiSummary>> LoadRangeWhere<T>(int startIndex, int count,
		...
		private static Task<IEnumerable<ItemSalesPiSummary>> LoadRangeSelectMany<T>(int startIndex, int count,
		...
		private static Task<IEnumerable<ItemSalesPiSummary>> LoadRangeSelect<T>(int startIndex, int count,
                                                                                AllocationDSContext dbContext, string exp, string navExp, string navProp, IEnumerable<string> includeLst = null) where T : class
        {
			try
			{
        ...
        private static async Task<IEnumerable<ItemSalesPiSummary>> GetWhere<T>(AllocationDSContext dbContext,
		...
		private static Task<IEnumerable<ItemSalesPiSummary>> GetWhereSelectMany<T>(AllocationDSContext dbContext,
                                                                                   string exp, string navExp, string navProp, List<string> includesLst = null) where T : class
        {
			...
			if (includesLst == null)
			{
				return Task.FromResult<IEnumerable<ItemSalesPiSummary>>(dbContext.Set<T>()
                    .AsNoTracking()
                    .Where(navExp)
                    .SelectMany(navProp).OfType<ItemSalesPiSummary>()
                    .Where(exp == "All" || exp == null?"PreviousItem_Id != null":exp)
			...
			var set = (DbQuery<ItemSalesPiSummary>)dbContext.Set<T>()
				.AsNoTracking()
                .Where(navExp)
                .SelectMany(navProp).OfType<ItemSalesPiSummary>()
                .Where(exp == "All" || exp == null?"PreviousItem_Id != null":exp)
            ...
            return Task.FromResult<IEnumerable<ItemSalesPiSummary>>(set.ToList());
			}
			catch (Exception)
			{
				Debugger.Break();
		...
		private static Task<IEnumerable<ItemSalesPiSummary>> GetWhereSelect<T>(AllocationDSContext dbContext,
                                                                               string exp, string navExp, string navProp, List<string> includesLst = null) where T : class
        {
			try
			{
			...
			catch (Exception)
			{
				...
				throw;
			        ...
			        public Task<IEnumerable<ItemSalesPiSummary>> GetItemSalesPiSummaryByApplicationSettingsId(string ApplicationSettingsId, List<string> includesLst = null)
        {
            try
            {
                using ( var dbContext = new AllocationDSContext(){StartTracking = StartTracking})
            ...
            catch (Exception updateEx)
            {
 	        ...
 	        public Task<IEnumerable<ItemSalesPiSummary>> GetItemSalesPiSummaryByxEntryItem_Id(string xEntryItem_Id, List<string> includesLst = null)
        {
            try
            {
                using ( var dbContext = new AllocationDSContext(){StartTracking = StartTracking})
             ...
             try
             {
                 using (var dbContext = new AllocationDSContext(){StartTracking = StartTracking})
                 {
					...
					decimal res = 0;
                     ...
                     if (whereExp == "All")
                     {
                          res = Convert.ToDecimal(dbContext.ItemSalesPiSummary.AsNoTracking().Sum(field));
                     }
                     else
                     {
                         res = Convert.ToDecimal(dbContext.ItemSalesPiSummary.AsNoTracking().Where(whereExp).Sum(field));
                     }
        ...
        public Task<decimal> SumNav( string exp, Dictionary<string, string> navExp, string field)
        {
            try
            {
                ...
                {
                    dbContext.Database.CommandTimeout = 0;
                    if (!dbContext.ItemSalesPiSummary.Any()) return Task.FromResult<decimal>(0);
                    if (exp == "All" && navExp.Count == 0)
                    {
                        return Task.FromResult(Convert.ToDecimal(dbContext.ItemSalesPiSummary
                                                                     .AsNoTracking()
                                                                     .Sum(field)??0));
                    }
                    return Task.FromResult(Convert.ToDecimal(dbContext.ItemSalesPiSummary.Where(exp == "All" || exp == null ? "PreviousItem_Id != null" : exp)
                                                                 .AsNoTracking()
                                                                 .Sum(field)??0));
                }
             ...
             try
             {
                 using (var dbContext = new AllocationDSContext(){StartTracking = StartTracking})
                 {
					...
					string res = "";
                     ...
                     if (whereExp == "All")
                     {
                          res = Convert.ToString(dbContext.ItemSalesPiSummary.AsNoTracking().Min(field));
                     }
                     else
                     {
                         res = Convert.ToString(dbContext.ItemSalesPiSummary.AsNoTracking().Where(whereExp).Min(field));
                     }
		...
		private static IQueryable<ItemSalesPiSummary> AddIncludes(IEnumerable<string> includesLst, AllocationDSContext dbContext)
       {
		 try
			{
			   if (includesLst == null) includesLst = new List<string>();
			   var set =(DbQuery<ItemSalesPiSummary>) dbContext.ItemSalesPiSummary; 
	   ...
	   private IQueryable<ItemSalesPiSummary> AddWheres(List<string> expLst, IQueryable<ItemSalesPiSummary> set)
        {
            try
            {
