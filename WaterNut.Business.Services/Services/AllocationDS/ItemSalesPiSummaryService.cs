...
namespace AllocationDS.Business.Services
{
   ...
   [ServiceBehavior(InstanceContextMode = InstanceContextMode.PerCall,
    ...
    public partial class ItemSalesPiSummaryService : IItemSalesPiSummaryService, IDisposable
    {
        ...
        public async Task<IEnumerable<ItemSalesPiSummary>> GetItemSalesPiSummary(List<string> includesLst = null, bool tracking = true)
        {
            try
            {
        ...
        public async Task<ItemSalesPiSummary> GetItemSalesPiSummaryByKey(string PreviousItem_Id, List<string> includesLst = null, bool tracking = true)
        {
		 ...
		 public async Task<IEnumerable<ItemSalesPiSummary>> GetItemSalesPiSummaryByExpression(string exp, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
                using (var dbContext = new AllocationDSContext(){StartTracking = StartTracking})
                {
					...
					if (string.IsNullOrEmpty(exp) || exp == "None") return new List<ItemSalesPiSummary>();
					var set = AddIncludes(includesLst, dbContext);
                    if (exp == "All")
                    {
		 ...
		 public async Task<IEnumerable<ItemSalesPiSummary>> GetItemSalesPiSummaryByExpressionLst(List<string> expLst, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
                using (var dbContext = new AllocationDSContext(){StartTracking = StartTracking})
                {
                    dbContext.Database.CommandTimeout = 0;
					if (expLst.Count == 0 || expLst.FirstOrDefault() == "None") return new List<ItemSalesPiSummary>();
					var set = AddIncludes(includesLst, dbContext);
		...
		public async Task<IEnumerable<ItemSalesPiSummary>> GetItemSalesPiSummaryByExpressionNav(string exp,
        ...
        public async Task<IEnumerable<ItemSalesPiSummary>> GetItemSalesPiSummaryByBatch(string exp,
        ...
        public async Task<IEnumerable<ItemSalesPiSummary>> GetItemSalesPiSummaryByBatchExpressionLst(List<string> expLst,
            int totalrow, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
        ...
        public async Task<ItemSalesPiSummary> UpdateItemSalesPiSummary(ItemSalesPiSummary entity)
        { 
            using ( var dbContext = new AllocationDSContext(){StartTracking = StartTracking})
              {
                try
        ...
        public async Task<ItemSalesPiSummary> CreateItemSalesPiSummary(ItemSalesPiSummary entity)
        {
            try
            {
                var res = (ItemSalesPiSummary) entity;
		...
		public async Task<int> Count(string exp)
        {
            try
            {
                using (AllocationDSContext dbContext = new AllocationDSContext(){StartTracking = StartTracking})
                {
                    ...
                    if (exp == "All")
                    {
                        return dbContext.ItemSalesPiSummary
                                    .AsNoTracking()
									.Count();
                    }
                    else
        ...
        public async Task<IEnumerable<ItemSalesPiSummary>> LoadRange(int startIndex, int count, string exp)
        {
            try
            {
                using (var dbContext = new AllocationDSContext(){StartTracking = StartTracking})
		...
		public async Task<int> CountNav(string exp, Dictionary<string, string> navExp)
        {
            try
            {
                ...
                using (var dbContext = new AllocationDSContext(){StartTracking = StartTracking})
                {
                    ...
                    return dbContext.ItemSalesPiSummary.Where(exp == "All" || exp == null ? "PreviousItem_Id != null" : exp)
											.AsNoTracking()
                                            .Count();
                }
		...
		private static async Task<int> CountWhereSelect<T>(AllocationDSContext dbContext, string exp, string navExp, string navProp) where T : class
        {
		  ...
		  public async Task<IEnumerable<ItemSalesPiSummary>> LoadRangeNav(int startIndex, int count, string exp,
                                                                                 Dictionary<string, string> navExp, IEnumerable<string> includeLst = null)
        {
            try
            {
                ...
                {
                    dbContext.Database.CommandTimeout = 0;
                    if ((string.IsNullOrEmpty(exp) && navExp.Count == 0) || exp == "None") return new List<ItemSalesPiSummary>();
                    ...
                    return set//dbContext.ItemSalesPiSummary
								.AsNoTracking()
                                .Where(exp == "All" || exp == null ? "PreviousItem_Id != null" : exp)
								.OrderBy(y => y.PreviousItem_Id)
		...
		private static async Task<IEnumerable<ItemSalesPiSummary>> LoadRangeSelectMany<T>(int startIndex, int count,
		...
		private static async Task<IEnumerable<ItemSalesPiSummary>> LoadRangeSelect<T>(int startIndex, int count,
            AllocationDSContext dbContext, string exp, string navExp, string navProp, IEnumerable<string> includeLst = null) where T : class
        {
			try
			{
		...
		private static async Task<IEnumerable<ItemSalesPiSummary>> GetWhereSelectMany<T>(AllocationDSContext dbContext,
		...
		private static async Task<IEnumerable<ItemSalesPiSummary>> GetWhereSelect<T>(AllocationDSContext dbContext,
            string exp, string navExp, string navProp, List<string> includesLst = null) where T : class
        {
			try
			{
        ...
        public async Task<decimal> SumNav( string exp, Dictionary<string, string> navExp, string field)
        {
            try
            {
                ...
                {
                    dbContext.Database.CommandTimeout = 0;
                    if (!dbContext.ItemSalesPiSummary.Any()) return 0;
                    if (exp == "All" && navExp.Count == 0)
                    {
                        return Convert.ToDecimal(dbContext.ItemSalesPiSummary
										.AsNoTracking()
                                        .Sum(field)??0);
                    }
