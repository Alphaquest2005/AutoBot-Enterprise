...
namespace AllocationDS.Business.Services
{
   ...
   [ServiceBehavior(InstanceContextMode = InstanceContextMode.PerCall,
    ...
    public partial class EX9AsycudaSalesAllocationsService : IEX9AsycudaSalesAllocationsService, IDisposable
    {
        ...
        public Task<IEnumerable<EX9AsycudaSalesAllocations>> GetEX9AsycudaSalesAllocations(List<string> includesLst = null, bool tracking = true)
        {
            try
            {
            //using (var scope = new TransactionScope(TransactionScopeOption.Required,
               ...
               // {
                  using ( var dbContext = new AllocationDSContext(){StartTracking = StartTracking})
                  {
                    ...
                    IEnumerable<EX9AsycudaSalesAllocations> entities = set.AsNoTracking().ToList();
                           //scope.Complete();
        ...
        public Task<EX9AsycudaSalesAllocations> GetEX9AsycudaSalesAllocationsByKey(string AllocationId, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
			   if(string.IsNullOrEmpty(AllocationId))return Task.FromResult<EX9AsycudaSalesAllocations>(null); 
              using ( var dbContext = new AllocationDSContext(){StartTracking = StartTracking})
              {
                var i = Convert.ToInt32(AllocationId);
				var set = AddIncludes(includesLst, dbContext);
                EX9AsycudaSalesAllocations entity = set.AsNoTracking().SingleOrDefault(x => x.AllocationId == i);
		 ...
		 public Task<IEnumerable<EX9AsycudaSalesAllocations>> GetEX9AsycudaSalesAllocationsByExpression(string exp, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
                using (var dbContext = new AllocationDSContext(){StartTracking = StartTracking})
                {
					...
					if (string.IsNullOrEmpty(exp) || exp == "None") return Task.FromResult<IEnumerable<EX9AsycudaSalesAllocations>>(new List<EX9AsycudaSalesAllocations>());
					var set = AddIncludes(includesLst, dbContext);
                    if (exp == "All")
                    {
                        ...
                        if(tracking) entities.AsParallel(new ParallelLinqOptions() { MaxDegreeOfParallelism = Environment.ProcessorCount }).ForAll(x => x.StartTracking());
                        return Task.FromResult<IEnumerable<EX9AsycudaSalesAllocations>>(entities); 
                    }
					else
					{
		 ...
		 public Task<IEnumerable<EX9AsycudaSalesAllocations>> GetEX9AsycudaSalesAllocationsByExpressionLst(List<string> expLst, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
                using (var dbContext = new AllocationDSContext(){StartTracking = StartTracking})
                {
                    dbContext.Database.CommandTimeout = 0;
					if (expLst.Count == 0 || expLst.FirstOrDefault() == "None") return Task.FromResult<IEnumerable<EX9AsycudaSalesAllocations>>(new List<EX9AsycudaSalesAllocations>());
					var set = AddIncludes(includesLst, dbContext);
        ...
        public Task<IEnumerable<EX9AsycudaSalesAllocations>> GetEX9AsycudaSalesAllocationsByBatch(string exp,
        ...
        public Task<IEnumerable<EX9AsycudaSalesAllocations>> GetEX9AsycudaSalesAllocationsByBatchExpressionLst(List<string> expLst,
                                                                                                               int totalrow, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
        ...
        public Task<EX9AsycudaSalesAllocations> UpdateEX9AsycudaSalesAllocations(EX9AsycudaSalesAllocations entity)
        { 
            using ( var dbContext = new AllocationDSContext(){StartTracking = StartTracking})
              {
                try
        ...
        public Task<EX9AsycudaSalesAllocations> CreateEX9AsycudaSalesAllocations(EX9AsycudaSalesAllocations entity)
        {
            try
            {
                var res = (EX9AsycudaSalesAllocations) entity;
        ...
        public Task<bool> DeleteEX9AsycudaSalesAllocations(string AllocationId)
        {
            try
            {
              using ( var dbContext = new AllocationDSContext(){StartTracking = StartTracking})
              {
                var i = Convert.ToInt32(AllocationId);
                EX9AsycudaSalesAllocations entity = dbContext.EX9AsycudaSalesAllocations
		...
		public Task<int> Count(string exp)
        {
            try
            {
                using (AllocationDSContext dbContext = new AllocationDSContext(){StartTracking = StartTracking})
                {
                    ...
                    if (exp == "All")
                    {
                        return Task.FromResult(dbContext.EX9AsycudaSalesAllocations
                            .AsNoTracking()
                            .Count());
                    }
                    else
        ...
        public Task<IEnumerable<EX9AsycudaSalesAllocations>> LoadRange(int startIndex, int count, string exp)
        {
            try
            {
                using (var dbContext = new AllocationDSContext(){StartTracking = StartTracking})
                {
                    ...
                    if (exp == "All")
                    {
                        return Task.FromResult<IEnumerable<EX9AsycudaSalesAllocations>>(dbContext.EX9AsycudaSalesAllocations
                            .AsNoTracking()
		...
		public async Task<int> CountNav(string exp, Dictionary<string, string> navExp)
        {
            try
            {
                ...
                using (var dbContext = new AllocationDSContext(){StartTracking = StartTracking})
                {
                    ...
                    if (exp == "All" && navExp.Count == 0)
                    {
                        return dbContext.EX9AsycudaSalesAllocations
										.AsNoTracking()
                                        .Count();
                    }
                    foreach (var itm in navExp)
                    ...
                    return dbContext.EX9AsycudaSalesAllocations.Where(exp == "All" || exp == null ? "AllocationId != null" : exp)
											.AsNoTracking()
                                            .Count();
                }
                                                                                 ...
                                                                                 Dictionary<string, string> navExp, IEnumerable<string> includeLst = null)
        {
            try
            {
                using (var dbContext = new AllocationDSContext(){StartTracking = StartTracking})
                {
                    ...
                    return set//dbContext.EX9AsycudaSalesAllocations
								.AsNoTracking()
                                .Where(exp == "All" || exp == null ? "AllocationId != null" : exp)
								.OrderBy(y => y.AllocationId)
		...
		private static Task<IEnumerable<EX9AsycudaSalesAllocations>> LoadRangeSelectMany<T>(int startIndex, int count,
                                                                                            AllocationDSContext dbContext, string exp, string navExp, string navProp, IEnumerable<string> includeLst = null) where T : class
        {
            ...
            return Task.FromResult<IEnumerable<EX9AsycudaSalesAllocations>>(set
                .Where(exp == "All" || exp == null ? "AllocationId != null" : exp)
                .Distinct()
                .OrderBy(y => y.AllocationId)
		...
		private static Task<IEnumerable<EX9AsycudaSalesAllocations>> LoadRangeSelect<T>(int startIndex, int count,
                                                                                        AllocationDSContext dbContext, string exp, string navExp, string navProp, IEnumerable<string> includeLst = null) where T : class
        {
			try
			{
		...
		private static Task<IEnumerable<EX9AsycudaSalesAllocations>> GetWhereSelectMany<T>(AllocationDSContext dbContext,
                                                                                           string exp, string navExp, string navProp, List<string> includesLst = null) where T : class
        {
			...
			if (includesLst == null)
			{
				return Task.FromResult<IEnumerable<EX9AsycudaSalesAllocations>>(dbContext.Set<T>()
                    .AsNoTracking()
                    .Where(navExp)
                    .SelectMany(navProp).OfType<EX9AsycudaSalesAllocations>()
                    .Where(exp == "All" || exp == null?"AllocationId != null":exp)
            ...
            return Task.FromResult<IEnumerable<EX9AsycudaSalesAllocations>>(set.ToList());
			}
			catch (Exception)
			{
				Debugger.Break();
		...
		private static Task<IEnumerable<EX9AsycudaSalesAllocations>> GetWhereSelect<T>(AllocationDSContext dbContext,
                                                                                       string exp, string navExp, string navProp, List<string> includesLst = null) where T : class
        {
			try
			{
			...
			catch (Exception)
			{
				...
				throw;
			        ...
			        public Task<IEnumerable<EX9AsycudaSalesAllocations>> GetEX9AsycudaSalesAllocationsByPreviousItem_Id(string PreviousItem_Id, List<string> includesLst = null)
        {
            try
            {
                using ( var dbContext = new AllocationDSContext(){StartTracking = StartTracking})
              {
                ...
                var set = AddIncludes(includesLst, dbContext);
                IEnumerable<EX9AsycudaSalesAllocations> entities = set//dbContext.EX9AsycudaSalesAllocations
            ...
            catch (Exception updateEx)
            {
 	        ...
 	        public Task<IEnumerable<EX9AsycudaSalesAllocations>> GetEX9AsycudaSalesAllocationsByEntryDataDetailsId(string EntryDataDetailsId, List<string> includesLst = null)
        {
            try
            {
                using ( var dbContext = new AllocationDSContext(){StartTracking = StartTracking})
            ...
            catch (Exception updateEx)
            {
 	        ...
 	        public Task<IEnumerable<EX9AsycudaSalesAllocations>> GetEX9AsycudaSalesAllocationsBypASYCUDA_Id(string pASYCUDA_Id, List<string> includesLst = null)
        {
            try
            {
                using ( var dbContext = new AllocationDSContext(){StartTracking = StartTracking})
            ...
            catch (Exception updateEx)
            {
 	        ...
 	        public Task<IEnumerable<EX9AsycudaSalesAllocations>> GetEX9AsycudaSalesAllocationsByxBond_Item_Id(string xBond_Item_Id, List<string> includesLst = null)
        {
            try
            {
                using ( var dbContext = new AllocationDSContext(){StartTracking = StartTracking})
            ...
            catch (Exception updateEx)
            {
 	        ...
 	        public Task<IEnumerable<EX9AsycudaSalesAllocations>> GetEX9AsycudaSalesAllocationsByApplicationSettingsId(string ApplicationSettingsId, List<string> includesLst = null)
        {
            try
            {
                using ( var dbContext = new AllocationDSContext(){StartTracking = StartTracking})
            ...
            catch (Exception updateEx)
            {
 	        ...
 	        public Task<IEnumerable<EX9AsycudaSalesAllocations>> GetEX9AsycudaSalesAllocationsByEmailId(string EmailId, List<string> includesLst = null)
        {
            try
            {
                using ( var dbContext = new AllocationDSContext(){StartTracking = StartTracking})
            ...
            catch (Exception updateEx)
            {
 	        ...
 	        public Task<IEnumerable<EX9AsycudaSalesAllocations>> GetEX9AsycudaSalesAllocationsByFileTypeId(string FileTypeId, List<string> includesLst = null)
        {
            try
            {
                using ( var dbContext = new AllocationDSContext(){StartTracking = StartTracking})
            ...
            catch (Exception updateEx)
            {
 	        ...
 	        public Task<IEnumerable<EX9AsycudaSalesAllocations>> GetEX9AsycudaSalesAllocationsByEntryData_Id(string EntryData_Id, List<string> includesLst = null)
        {
            try
            {
                using ( var dbContext = new AllocationDSContext(){StartTracking = StartTracking})
            ...
            catch (Exception updateEx)
            {
 	        ...
 	        public Task<IEnumerable<EX9AsycudaSalesAllocations>> GetEX9AsycudaSalesAllocationsByCustomsOperationId(string CustomsOperationId, List<string> includesLst = null)
        {
            try
            {
                using ( var dbContext = new AllocationDSContext(){StartTracking = StartTracking})
            ...
            catch (Exception updateEx)
            {
 	        ...
 	        public Task<IEnumerable<EX9AsycudaSalesAllocations>> GetEX9AsycudaSalesAllocationsByCustoms_ProcedureId(string Customs_ProcedureId, List<string> includesLst = null)
        {
            try
            {
                using ( var dbContext = new AllocationDSContext(){StartTracking = StartTracking})
            ...
            catch (Exception updateEx)
            {
 	        ...
 	        public Task<IEnumerable<EX9AsycudaSalesAllocations>> GetEX9AsycudaSalesAllocationsByInventoryItemId(string InventoryItemId, List<string> includesLst = null)
        {
            try
            {
                using ( var dbContext = new AllocationDSContext(){StartTracking = StartTracking})
