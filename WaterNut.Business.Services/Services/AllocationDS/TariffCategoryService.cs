...
namespace AllocationDS.Business.Services
{
   ...
   [ServiceBehavior(InstanceContextMode = InstanceContextMode.PerCall,
    ...
    public partial class TariffCategoryService : ITariffCategoryService, IDisposable
    {
        ...
        public async Task<IEnumerable<TariffCategory>> GetTariffCategory(List<string> includesLst = null, bool tracking = true)
        {
            try
            {
        ...
        public async Task<TariffCategory> GetTariffCategoryByKey(string TariffCategoryCode, List<string> includesLst = null, bool tracking = true)
        {
		 ...
		 public async Task<IEnumerable<TariffCategory>> GetTariffCategoryByExpression(string exp, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
                using (var dbContext = new AllocationDSContext(){StartTracking = StartTracking})
		 ...
		 public async Task<IEnumerable<TariffCategory>> GetTariffCategoryByExpressionLst(List<string> expLst, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
                using (var dbContext = new AllocationDSContext(){StartTracking = StartTracking})
        ...
        public async Task<bool> DeleteTariffCategory(string TariffCategoryCode)
        {
            try
            {
              ...
              {
                var i = TariffCategoryCode;
                TariffCategory entity = await dbContext.TariffCategory
		...
		public async Task<int> CountNav(string exp, Dictionary<string, string> navExp)
        {
            try
            {
                ...
                using (var dbContext = new AllocationDSContext(){StartTracking = StartTracking})
                {
                    ...
                    return await dbContext.TariffCategory.Where(exp == "All" || exp == null ? "TariffCategoryCode != null" : exp)
											.AsNoTracking()
                                            .CountAsync()
											.ConfigureAwait(continueOnCapturedContext: false);
                }
                                                                                 ...
                                                                                 Dictionary<string, string> navExp, IEnumerable<string> includeLst = null)
        {
            try
            {
                using (var dbContext = new AllocationDSContext(){StartTracking = StartTracking})
                {
                    ...
                    return await set//dbContext.TariffCategory
								.AsNoTracking()
                                .Where(exp == "All" || exp == null ? "TariffCategoryCode != null" : exp)
								.OrderBy(y => y.TariffCategoryCode)
		...
		private static async Task<IEnumerable<TariffCategory>> GetWhereSelectMany<T>(AllocationDSContext dbContext,
		...
		private static async Task<IEnumerable<TariffCategory>> GetWhereSelect<T>(AllocationDSContext dbContext,
            string exp, string navExp, string navProp, List<string> includesLst = null) where T : class
        {
			try
			{
