...
namespace AllocationDS.Business.Services
{
   ...
   [ServiceBehavior(InstanceContextMode = InstanceContextMode.PerCall,
    ...
    public partial class SubItemsService : ISubItemsService, IDisposable
    {
                ...
                var t = Task.Run(async () =>
                {
                    using (var ctx = new SubItemsService())
                    {
                        foreach (var item in lst.ToList())
                        {
                            ...
                            await ctx.DeleteSubItems(item).ConfigureAwait(false);
        ...
        private static async Task<IEnumerable<SubItems>> GetWhere<T>(AllocationDSContext dbContext,
		...
		private static Task<IEnumerable<SubItems>> GetWhereSelectMany<T>(AllocationDSContext dbContext,
		...
		private static Task<IEnumerable<SubItems>> GetWhereSelect<T>(AllocationDSContext dbContext,
                                                                     string exp, string navExp, string navProp, List<string> includesLst = null) where T : class
        {
			try
			{
		...
		private static IQueryable<SubItems> AddIncludes(IEnumerable<string> includesLst, AllocationDSContext dbContext)
       {
		 try
			{
