...
namespace AllocationDS.Business.Services
{
   ...
   [ServiceBehavior(InstanceContextMode = InstanceContextMode.PerCall,
    ...
    public partial class AllocationsTestCasesService : IAllocationsTestCasesService, IDisposable
    {
        ...
        public async Task<IEnumerable<AllocationsTestCases>> GetAllocationsTestCases(List<string> includesLst = null, bool tracking = true)
        {
            try
            {
            //using (var scope = new TransactionScope(TransactionScopeOption.Required,
               ...
               // {
                  using ( var dbContext = new AllocationDSContext(){StartTracking = StartTracking})
                  {
                    ...
                    IEnumerable<AllocationsTestCases> entities = await set.AsNoTracking().ToListAsync()
        ...
        public async Task<AllocationsTestCases> GetAllocationsTestCasesByKey(string Id, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
              ...
              using ( var dbContext = new AllocationDSContext(){StartTracking = StartTracking})
              {
				...
				var set = AddIncludes(includesLst, dbContext);
                AllocationsTestCases entity = await set.AsNoTracking().SingleOrDefaultAsync(x => x.Id == i).ConfigureAwait(continueOnCapturedContext: false);
		 ...
		 public async Task<IEnumerable<AllocationsTestCases>> GetAllocationsTestCasesByExpression(string exp, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
                using (var dbContext = new AllocationDSContext(){StartTracking = StartTracking})
                {
					...
					if (string.IsNullOrEmpty(exp) || exp == "None") return new List<AllocationsTestCases>();
					var set = AddIncludes(includesLst, dbContext);
                    if (exp == "All")
                    {
		 ...
		 public async Task<IEnumerable<AllocationsTestCases>> GetAllocationsTestCasesByExpressionLst(List<string> expLst, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
                using (var dbContext = new AllocationDSContext(){StartTracking = StartTracking})
                {
                    dbContext.Database.CommandTimeout = 0;
					if (expLst.Count == 0 || expLst.FirstOrDefault() == "None") return new List<AllocationsTestCases>();
					var set = AddIncludes(includesLst, dbContext);
		...
		public async Task<IEnumerable<AllocationsTestCases>> GetAllocationsTestCasesByExpressionNav(string exp,
        ...
        public async Task<IEnumerable<AllocationsTestCases>> GetAllocationsTestCasesByBatch(string exp,
        ...
        public async Task<IEnumerable<AllocationsTestCases>> GetAllocationsTestCasesByBatchExpressionLst(List<string> expLst,
            int totalrow, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
        ...
        public async Task<AllocationsTestCases> UpdateAllocationsTestCases(AllocationsTestCases entity)
        { 
            using ( var dbContext = new AllocationDSContext(){StartTracking = StartTracking})
              {
                try
        ...
        public async Task<AllocationsTestCases> CreateAllocationsTestCases(AllocationsTestCases entity)
        {
            try
            {
                var res = (AllocationsTestCases) entity;
        ...
        public async Task<bool> DeleteAllocationsTestCases(string Id)
        {
            try
            {
              using ( var dbContext = new AllocationDSContext(){StartTracking = StartTracking})
              {
                var i = Convert.ToInt32(Id);
                AllocationsTestCases entity = await dbContext.AllocationsTestCases
		...
		public async Task<int> Count(string exp)
        {
            try
            {
                using (AllocationDSContext dbContext = new AllocationDSContext(){StartTracking = StartTracking})
                {
                    ...
                    if (exp == "All")
                    {
                        return await dbContext.AllocationsTestCases
                                    .AsNoTracking()
									.CountAsync()
									.ConfigureAwait(continueOnCapturedContext: false);
                    }
        ...
        public async Task<IEnumerable<AllocationsTestCases>> LoadRange(int startIndex, int count, string exp)
        {
            try
            {
                using (var dbContext = new AllocationDSContext(){StartTracking = StartTracking})
		...
		public async Task<int> CountNav(string exp, Dictionary<string, string> navExp)
        {
            try
            {
                ...
                using (var dbContext = new AllocationDSContext(){StartTracking = StartTracking})
                {
                    ...
                    return await dbContext.AllocationsTestCases.Where(exp == "All" || exp == null ? "Id != null" : exp)
											.AsNoTracking()
                                            .CountAsync()
											.ConfigureAwait(continueOnCapturedContext: false);
                }
		...
		private static async Task<int> CountWhereSelect<T>(AllocationDSContext dbContext, string exp, string navExp, string navProp) where T : class
        {
		  ...
		  public async Task<IEnumerable<AllocationsTestCases>> LoadRangeNav(int startIndex, int count, string exp,
                                                                                 Dictionary<string, string> navExp, IEnumerable<string> includeLst = null)
        {
            try
            {
                ...
                {
                    dbContext.Database.CommandTimeout = 0;
                    if ((string.IsNullOrEmpty(exp) && navExp.Count == 0) || exp == "None") return new List<AllocationsTestCases>();
                    ...
                    return await set//dbContext.AllocationsTestCases
								.AsNoTracking()
                                .Where(exp == "All" || exp == null ? "Id != null" : exp)
								.OrderBy(y => y.Id)
		...
		private static async Task<IEnumerable<AllocationsTestCases>> LoadRangeSelectMany<T>(int startIndex, int count,
		...
		private static async Task<IEnumerable<AllocationsTestCases>> LoadRangeSelect<T>(int startIndex, int count,
            AllocationDSContext dbContext, string exp, string navExp, string navProp, IEnumerable<string> includeLst = null) where T : class
        {
			try
			{
		...
		private static async Task<IEnumerable<AllocationsTestCases>> GetWhereSelectMany<T>(AllocationDSContext dbContext,
		...
		private static async Task<IEnumerable<AllocationsTestCases>> GetWhereSelect<T>(AllocationDSContext dbContext,
            string exp, string navExp, string navProp, List<string> includesLst = null) where T : class
        {
			try
			{
			...
			catch (Exception)
			{
				...
				throw;
			        ...
			        public async Task<IEnumerable<AllocationsTestCases>> GetAllocationsTestCasesByEntryDataDetailsId(string EntryDataDetailsId, List<string> includesLst = null)
        {
            try
            {
                using ( var dbContext = new AllocationDSContext(){StartTracking = StartTracking})
              {
                ...
                var set = AddIncludes(includesLst, dbContext);
                IEnumerable<AllocationsTestCases> entities = await set//dbContext.AllocationsTestCases
                                      .AsNoTracking()
            ...
            catch (Exception updateEx)
            {
 	        ...
 	        public async Task<IEnumerable<AllocationsTestCases>> GetAllocationsTestCasesByApplicationSettingsId(string ApplicationSettingsId, List<string> includesLst = null)
        {
            try
            {
                using ( var dbContext = new AllocationDSContext(){StartTracking = StartTracking})
        ...
        public async Task<decimal> SumNav( string exp, Dictionary<string, string> navExp, string field)
        {
            try
            {
                ...
                {
                    dbContext.Database.CommandTimeout = 0;
                    if (!dbContext.AllocationsTestCases.Any()) return 0;
                    if (exp == "All" && navExp.Count == 0)
                    {
                        return Convert.ToDecimal(dbContext.AllocationsTestCases
										.AsNoTracking()
                                        .Sum(field)??0);
                    }
                    return Convert.ToDecimal(dbContext.AllocationsTestCases.Where(exp == "All" || exp == null ? "Id != null" : exp)
											.AsNoTracking()
                                            .Sum(field)??0);
                }
