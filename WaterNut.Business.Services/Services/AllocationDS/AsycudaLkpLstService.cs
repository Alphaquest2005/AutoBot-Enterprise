...
namespace AllocationDS.Business.Services
{
   ...
   [ServiceBehavior(InstanceContextMode = InstanceContextMode.PerCall,
    ...
    public partial class AsycudaLkpLstService : IAsycudaLkpLstService, IDisposable
    {
        ...
        public Task<IEnumerable<AsycudaLkpLst>> GetAsycudaLkpLst(List<string> includesLst = null, bool tracking = true)
        {
            try
            {
            //using (var scope = new TransactionScope(TransactionScopeOption.Required,
               ...
               // {
                  using ( var dbContext = new AllocationDSContext(){StartTracking = StartTracking})
                  {
                    ...
                    IEnumerable<AsycudaLkpLst> entities = set.AsNoTracking().ToList();
                           //scope.Complete();
        ...
        public Task<AsycudaLkpLst> GetAsycudaLkpLstByKey(string ASYCUDA_Id, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
			   if(string.IsNullOrEmpty(ASYCUDA_Id))return Task.FromResult<AsycudaLkpLst>(null); 
              using ( var dbContext = new AllocationDSContext(){StartTracking = StartTracking})
              {
                var i = Convert.ToInt32(ASYCUDA_Id);
				var set = AddIncludes(includesLst, dbContext);
                AsycudaLkpLst entity = set.AsNoTracking().SingleOrDefault(x => x.ASYCUDA_Id == i);
		 ...
		 public Task<IEnumerable<AsycudaLkpLst>> GetAsycudaLkpLstByExpression(string exp, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
                using (var dbContext = new AllocationDSContext(){StartTracking = StartTracking})
                {
					...
					if (string.IsNullOrEmpty(exp) || exp == "None") return Task.FromResult<IEnumerable<AsycudaLkpLst>>(new List<AsycudaLkpLst>());
					var set = AddIncludes(includesLst, dbContext);
                    if (exp == "All")
                    {
                        ...
                        if(tracking) entities.AsParallel(new ParallelLinqOptions() { MaxDegreeOfParallelism = Environment.ProcessorCount }).ForAll(x => x.StartTracking());
                        return Task.FromResult<IEnumerable<AsycudaLkpLst>>(entities); 
                    }
					else
					{
		 ...
		 public Task<IEnumerable<AsycudaLkpLst>> GetAsycudaLkpLstByExpressionLst(List<string> expLst, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
                using (var dbContext = new AllocationDSContext(){StartTracking = StartTracking})
                {
                    dbContext.Database.CommandTimeout = 0;
					if (expLst.Count == 0 || expLst.FirstOrDefault() == "None") return Task.FromResult<IEnumerable<AsycudaLkpLst>>(new List<AsycudaLkpLst>());
					var set = AddIncludes(includesLst, dbContext);
		...
		public Task<IEnumerable<AsycudaLkpLst>> GetAsycudaLkpLstByExpressionNav(string exp,
            ...
            try
            {
                using (var dbContext = new AllocationDSContext(){StartTracking = StartTracking})
                {
                    ...
                    if (exp == "All" && navExp.Count == 0)
                    {
                        ...
                        return Task.FromResult<IEnumerable<AsycudaLkpLst>>(aentities); 
                    }
					var set = AddIncludes(includesLst, dbContext);
                    var entities = set.AsNoTracking().Where(exp)
									.ToList();
        ...
        public Task<IEnumerable<AsycudaLkpLst>> GetAsycudaLkpLstByBatch(string exp,
        ...
        public Task<IEnumerable<AsycudaLkpLst>> GetAsycudaLkpLstByBatchExpressionLst(List<string> expLst,
                                                                                     int totalrow, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
        ...
        public Task<AsycudaLkpLst> UpdateAsycudaLkpLst(AsycudaLkpLst entity)
        { 
            using ( var dbContext = new AllocationDSContext(){StartTracking = StartTracking})
              {
                try
        ...
        public Task<AsycudaLkpLst> CreateAsycudaLkpLst(AsycudaLkpLst entity)
        {
            try
            {
                var res = (AsycudaLkpLst) entity;
        ...
        public Task<bool> DeleteAsycudaLkpLst(string ASYCUDA_Id)
        {
            try
            {
              using ( var dbContext = new AllocationDSContext(){StartTracking = StartTracking})
              {
                var i = Convert.ToInt32(ASYCUDA_Id);
                AsycudaLkpLst entity = dbContext.AsycudaLkpLst
        ...
        public async Task<bool> RemoveSelectedAsycudaLkpLst(IEnumerable<string> lst)
        {
            try
            {
                StatusModel.StartStatusUpdate("Removing AsycudaLkpLst", lst.Count());
                var t = Task.Run(() =>
                {
                    using (var ctx = new AsycudaLkpLstService())
                    {
                        foreach (var item in lst.ToList())
                        {
                            ...
                            ctx.DeleteAsycudaLkpLst(item).Wait();
		...
		public Task<int> Count(string exp)
        {
            try
            {
                using (AllocationDSContext dbContext = new AllocationDSContext(){StartTracking = StartTracking})
                {
                    ...
                    if (exp == "All")
                    {
                        return Task.FromResult(dbContext.AsycudaLkpLst
                            .AsNoTracking()
                            .Count());
                    }
                    else
        ...
        public Task<IEnumerable<AsycudaLkpLst>> LoadRange(int startIndex, int count, string exp)
        {
            try
            {
                using (var dbContext = new AllocationDSContext(){StartTracking = StartTracking})
                {
                    ...
                    if (exp == "All")
                    {
                        return Task.FromResult<IEnumerable<AsycudaLkpLst>>(dbContext.AsycudaLkpLst
                            .AsNoTracking()
		...
		public Task<int> CountNav(string exp, Dictionary<string, string> navExp)
        {
            try
            {
                ...
                using (var dbContext = new AllocationDSContext(){StartTracking = StartTracking})
                {
                    ...
                    return Task.FromResult(dbContext.AsycudaLkpLst.Where(exp == "All" || exp == null ? "ASYCUDA_Id != null" : exp)
                        .AsNoTracking()
                        .Count());
                }
		...
		private static Task<int> CountWhereSelect<T>(AllocationDSContext dbContext, string exp, string navExp, string navProp) where T : class
        {
		  ...
		  public Task<IEnumerable<AsycudaLkpLst>> LoadRangeNav(int startIndex, int count, string exp,
                                                               Dictionary<string, string> navExp, IEnumerable<string> includeLst = null)
        {
            try
            {
                ...
                {
                    dbContext.Database.CommandTimeout = 0;
                    if ((string.IsNullOrEmpty(exp) && navExp.Count == 0) || exp == "None") return Task.FromResult<IEnumerable<AsycudaLkpLst>>(new List<AsycudaLkpLst>());
                    var set = AddIncludes(includeLst, dbContext);

                    if (exp == "All" && navExp.Count == 0)
                    {
                       
                        return Task.FromResult<IEnumerable<AsycudaLkpLst>>(set
                            .AsNoTracking()
                            .OrderBy(y => y.ASYCUDA_Id)
                    ...
                    return Task.FromResult<IEnumerable<AsycudaLkpLst>>(set//dbContext.AsycudaLkpLst
                        .AsNoTracking()
                        .Where(exp == "All" || exp == null ? "ASYCUDA_Id != null" : exp)
                        .OrderBy(y => y.ASYCUDA_Id)
		...
		private static Task<IEnumerable<AsycudaLkpLst>> LoadRangeSelectMany<T>(int startIndex, int count,
		...
		private static Task<IEnumerable<AsycudaLkpLst>> LoadRangeSelect<T>(int startIndex, int count,
                                                                           AllocationDSContext dbContext, string exp, string navExp, string navProp, IEnumerable<string> includeLst = null) where T : class
        {
			try
			{
		...
		private static Task<IEnumerable<AsycudaLkpLst>> GetWhereSelectMany<T>(AllocationDSContext dbContext,
                                                                              string exp, string navExp, string navProp, List<string> includesLst = null) where T : class
        {
			...
			if (includesLst == null)
			{
				return Task.FromResult<IEnumerable<AsycudaLkpLst>>(dbContext.Set<T>()
                    .AsNoTracking()
                    .Where(navExp)
                    .SelectMany(navProp).OfType<AsycudaLkpLst>()
                    .Where(exp == "All" || exp == null?"ASYCUDA_Id != null":exp)
            ...
            return Task.FromResult<IEnumerable<AsycudaLkpLst>>(set.ToList());
			}
			catch (Exception)
			{
				Debugger.Break();
		...
		private static Task<IEnumerable<AsycudaLkpLst>> GetWhereSelect<T>(AllocationDSContext dbContext,
                                                                          string exp, string navExp, string navProp, List<string> includesLst = null) where T : class
        {
			try
			{
        ...
        public Task<decimal> SumNav( string exp, Dictionary<string, string> navExp, string field)
        {
            try
            {
                ...
                {
                    dbContext.Database.CommandTimeout = 0;
                    if (!dbContext.AsycudaLkpLst.Any()) return Task.FromResult<decimal>(0);
                    if (exp == "All" && navExp.Count == 0)
                    {
                        return Task.FromResult(Convert.ToDecimal(dbContext.AsycudaLkpLst
                                                                     .AsNoTracking()
                                                                     .Sum(field)??0));
                    }
                    return Task.FromResult(Convert.ToDecimal(dbContext.AsycudaLkpLst.Where(exp == "All" || exp == null ? "ASYCUDA_Id != null" : exp)
                                                                 .AsNoTracking()
                                                                 .Sum(field)??0));
                }
