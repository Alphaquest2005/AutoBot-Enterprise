...
namespace AllocationDS.Business.Services
{
   ...
   [ServiceBehavior(InstanceContextMode = InstanceContextMode.PerCall,
    ...
    public partial class TariffSupUnitLkpsService : ITariffSupUnitLkpsService, IDisposable
    {
		...
		private static Task<IEnumerable<TariffSupUnitLkps>> GetWhereSelectMany<T>(AllocationDSContext dbContext,
		...
		private static Task<IEnumerable<TariffSupUnitLkps>> GetWhereSelect<T>(AllocationDSContext dbContext,
                                                                              string exp, string navExp, string navProp, List<string> includesLst = null) where T : class
        {
			try
			{
