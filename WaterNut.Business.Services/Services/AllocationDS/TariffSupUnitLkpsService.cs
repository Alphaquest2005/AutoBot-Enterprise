...
{
   [Export (typeof(ITariffSupUnitLkpsService))]
   [Export(typeof(IBusinessService))]
   [PartCreationPolicy(CreationPolicy.NonShared)]
   [ServiceBehavior(InstanceContextMode = InstanceContextMode.PerCall,
                    ConcurrencyMode = ConcurrencyMode.Multiple)]
   
    public partial class TariffSupUnitLkpsService : ITariffSupUnitLkpsService, IDisposable
    {
        //private readonly AllocationDSContext dbContext;

        public bool StartTracking { get; set; }

        public TariffSupUnitLkpsService()
        {
            try
            {
            ...
            //using (var scope = new TransactionScope(TransactionScopeOption.Required,
               ...
               // {
                  using ( var dbContext = new AllocationDSContext(){StartTracking = StartTracking})
                  {
                    ...
                    IEnumerable<TariffSupUnitLkps> entities = await set.AsNoTracking().ToListAsync()
        ...
        public async Task<TariffSupUnitLkps> GetTariffSupUnitLkpsByKey(string Id, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
              ...
              using ( var dbContext = new AllocationDSContext(){StartTracking = StartTracking})
              {
				...
				var set = AddIncludes(includesLst, dbContext);
                TariffSupUnitLkps entity = await set.AsNoTracking().SingleOrDefaultAsync(x => x.Id == i).ConfigureAwait(continueOnCapturedContext: false);
                    ...
                    foreach (var itm in navExp)
                    {
                        switch (itm.Key)
                        {
                            case "TariffCategoryCodeSuppUnit":
                                return
                                    await
                                        GetWhere<TariffCategoryCodeSuppUnit>(dbContext, exp, itm.Value, "TariffSupUnitLkps", "Select", includesLst)
										.ConfigureAwait(continueOnCapturedContext: false);
            ...
            int totalrow, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
                ...
                var res = new ConcurrentQueue<List<TariffSupUnitLkps>>();
                    ...
                    //  for (int bat = 0; bat < batches; bat++)
                    {
                        try
                        {
                            using (var dbContext = new AllocationDSContext(){StartTracking = StartTracking})
                            {
                                ...
                                var set = AddIncludes(includesLst, dbContext);
                                IQueryable<TariffSupUnitLkps> dset;
                                if (exp == "All")
                                {
            ...
            using ( var dbContext = new AllocationDSContext(){StartTracking = StartTracking})
              {
                try
                {   
                     var res = (TariffSupUnitLkps) entity;
        ...
        public async Task<bool> DeleteTariffSupUnitLkps(string Id)
        {
            try
            {
              ...
              {
                var i = Convert.ToInt32(Id);
                TariffSupUnitLkps entity = await dbContext.TariffSupUnitLkps
        ...
        public async Task<bool> RemoveSelectedTariffSupUnitLkps(IEnumerable<string> lst)
        {
            try
            {
                StatusModel.StartStatusUpdate("Removing TariffSupUnitLkps", lst.Count());
                var t = Task.Run(() =>
                {
                    using (var ctx = new TariffSupUnitLkpsService())
                    {
                        foreach (var item in lst.ToList())
                        {
                            ...
                            ctx.DeleteTariffSupUnitLkps(item).Wait();
		...
		public async Task<int> Count(string exp)
        {
            try
            {
                using (AllocationDSContext dbContext = new AllocationDSContext(){StartTracking = StartTracking})
                {
                    ...
                    if (exp == "All")
                    {
                        return await dbContext.TariffSupUnitLkps
                                    .AsNoTracking()
									.CountAsync()
									.ConfigureAwait(continueOnCapturedContext: false);
                    }
            ...
            try
            {
                ...
                using (var dbContext = new AllocationDSContext(){StartTracking = StartTracking})
                {
                    ...
                    foreach (var itm in navExp)
                    {
                        ...
                        {
                            case "TariffCategoryCodeSuppUnit":
                                return await CountWhere<TariffCategoryCodeSuppUnit>(dbContext, exp, itm.Value, "TariffSupUnitLkps", "Select")
											.ConfigureAwait(continueOnCapturedContext: false);
						}
                    }
                    return await dbContext.TariffSupUnitLkps.Where(exp == "All" || exp == null ? "Id != null" : exp)
											.AsNoTracking()
                                            .CountAsync()
											.ConfigureAwait(continueOnCapturedContext: false);
                }
                                                                                 ...
                                                                                 Dictionary<string, string> navExp, IEnumerable<string> includeLst = null)
        {
            try
            {
                ...
                {
                    dbContext.Database.CommandTimeout = 0;
                    if ((string.IsNullOrEmpty(exp) && navExp.Count == 0) || exp == "None") return new List<TariffSupUnitLkps>();
                    ...
                    foreach (var itm in navExp)
                    {
                        switch (itm.Key)
                        {
                            case "TariffCategoryCodeSuppUnit":
                                return
                                    await
                                        LoadRangeWhere<TariffCategoryCodeSuppUnit>(startIndex, count, dbContext, exp, itm.Value, "TariffSupUnitLkps", "Select")
													.ConfigureAwait(continueOnCapturedContext: false);
                    ...
                    return await set//dbContext.TariffSupUnitLkps
								.AsNoTracking()
                                .Where(exp == "All" || exp == null ? "Id != null" : exp)
								.OrderBy(y => y.Id)
		...
		private static async Task<IEnumerable<TariffSupUnitLkps>> LoadRangeWhere<T>(int startIndex, int count,
        ...
        private static async Task<IEnumerable<TariffSupUnitLkps>> GetWhere<T>(AllocationDSContext dbContext,
		...
		private static async Task<IEnumerable<TariffSupUnitLkps>> GetWhereSelectMany<T>(AllocationDSContext dbContext,
		...
		private static async Task<IEnumerable<TariffSupUnitLkps>> GetWhereSelect<T>(AllocationDSContext dbContext,
            string exp, string navExp, string navProp, List<string> includesLst = null) where T : class
        {
			try
			{
            ...
            try
            {
                ...
                using (var dbContext = new AllocationDSContext(){StartTracking = StartTracking})
                {
                    ...
                    foreach (var itm in navExp)
                    {
                        ...
                        {
                            case "TariffCategoryCodeSuppUnit":
                                return await SumWhere<TariffCategoryCodeSuppUnit>(dbContext, exp, itm.Value, "TariffSupUnitLkps", field, "Select")
											.ConfigureAwait(continueOnCapturedContext: false);
						}
                    }
		...
		private static IQueryable<TariffSupUnitLkps> AddIncludes(IEnumerable<string> includesLst, AllocationDSContext dbContext)
       {
		 try
			{
			   if (includesLst == null) includesLst = new List<string>();
			   var set =(DbQuery<TariffSupUnitLkps>) dbContext.TariffSupUnitLkps; 
	   ...
	   private IQueryable<TariffSupUnitLkps> AddWheres(List<string> expLst, IQueryable<TariffSupUnitLkps> set)
        {
            try
            {
