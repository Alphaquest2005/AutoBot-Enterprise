    ...
    public partial class AllocationErrorsService : IAllocationErrorsService, IDisposable
    {
            ...
            //using (var scope = new TransactionScope(TransactionScopeOption.Required,
               ...
               // {
                  using ( var dbContext = new AllocationDSContext(){StartTracking = StartTracking})
                  {
                    ...
                    IEnumerable<AllocationErrors> entities = await set.AsNoTracking().ToListAsync()
        ...
        public async Task<AllocationErrors> GetAllocationErrorsByKey(string ItemNumber, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
              ...
              using ( var dbContext = new AllocationDSContext(){StartTracking = StartTracking})
              {
                var i = ItemNumber;
				var set = AddIncludes(includesLst, dbContext);
                AllocationErrors entity = await set.AsNoTracking().SingleOrDefaultAsync(x => x.ItemNumber == i).ConfigureAwait(continueOnCapturedContext: false);
        ...
        public async Task<bool> DeleteAllocationErrors(string ItemNumber)
        {
            try
            {
              ...
              {
                var i = ItemNumber;
                AllocationErrors entity = await dbContext.AllocationErrors
		...
		public async Task<int> Count(string exp)
        {
            try
            {
                using (AllocationDSContext dbContext = new AllocationDSContext(){StartTracking = StartTracking})
                {
                    ...
                    if (exp == "All")
                    {
                        return await dbContext.AllocationErrors
                                    .AsNoTracking()
									.CountAsync()
									.ConfigureAwait(continueOnCapturedContext: false);
                    }
