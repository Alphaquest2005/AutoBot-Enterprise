...
namespace AllocationDS.Business.Services
{
   ...
   [ServiceBehavior(InstanceContextMode = InstanceContextMode.PerCall,
    ...
    public partial class AsycudaSalesAllocationsPIDataService : IAsycudaSalesAllocationsPIDataService, IDisposable
    {
        ...
        public Task<IEnumerable<AsycudaSalesAllocationsPIData>> GetAsycudaSalesAllocationsPIData(List<string> includesLst = null, bool tracking = true)
        {
            try
            {
            //using (var scope = new TransactionScope(TransactionScopeOption.Required,
               ...
               // {
                  using ( var dbContext = new AllocationDSContext(){StartTracking = StartTracking})
                  {
                    ...
                    IEnumerable<AsycudaSalesAllocationsPIData> entities = set.AsNoTracking().ToList();
                           //scope.Complete();
        ...
        public Task<AsycudaSalesAllocationsPIData> GetAsycudaSalesAllocationsPIDataByKey(string Id, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
			   if(string.IsNullOrEmpty(Id))return Task.FromResult<AsycudaSalesAllocationsPIData>(null); 
              using ( var dbContext = new AllocationDSContext(){StartTracking = StartTracking})
              {
                var i = Convert.ToInt32(Id);
				var set = AddIncludes(includesLst, dbContext);
                AsycudaSalesAllocationsPIData entity = set.AsNoTracking().SingleOrDefault(x => x.Id == i);
		 ...
		 public Task<IEnumerable<AsycudaSalesAllocationsPIData>> GetAsycudaSalesAllocationsPIDataByExpression(string exp, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
                using (var dbContext = new AllocationDSContext(){StartTracking = StartTracking})
                {
					...
					if (string.IsNullOrEmpty(exp) || exp == "None") return Task.FromResult<IEnumerable<AsycudaSalesAllocationsPIData>>(new List<AsycudaSalesAllocationsPIData>());
					var set = AddIncludes(includesLst, dbContext);
                    if (exp == "All")
                    {
                        ...
                        if(tracking) entities.AsParallel(new ParallelLinqOptions() { MaxDegreeOfParallelism = Environment.ProcessorCount }).ForAll(x => x.StartTracking());
                        return Task.FromResult<IEnumerable<AsycudaSalesAllocationsPIData>>(entities); 
                    }
					else
					{
		 ...
		 public Task<IEnumerable<AsycudaSalesAllocationsPIData>> GetAsycudaSalesAllocationsPIDataByExpressionLst(List<string> expLst, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
                using (var dbContext = new AllocationDSContext(){StartTracking = StartTracking})
                {
                    dbContext.Database.CommandTimeout = 0;
					if (expLst.Count == 0 || expLst.FirstOrDefault() == "None") return Task.FromResult<IEnumerable<AsycudaSalesAllocationsPIData>>(new List<AsycudaSalesAllocationsPIData>());
					var set = AddIncludes(includesLst, dbContext);
        ...
        public Task<IEnumerable<AsycudaSalesAllocationsPIData>> GetAsycudaSalesAllocationsPIDataByBatch(string exp,
        ...
        public Task<IEnumerable<AsycudaSalesAllocationsPIData>> GetAsycudaSalesAllocationsPIDataByBatchExpressionLst(List<string> expLst,
                                                                                                                     int totalrow, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
        ...
        public Task<AsycudaSalesAllocationsPIData> UpdateAsycudaSalesAllocationsPIData(AsycudaSalesAllocationsPIData entity)
        { 
            using ( var dbContext = new AllocationDSContext(){StartTracking = StartTracking})
              {
                try
        ...
        public Task<AsycudaSalesAllocationsPIData> CreateAsycudaSalesAllocationsPIData(AsycudaSalesAllocationsPIData entity)
        {
            try
            {
                var res = (AsycudaSalesAllocationsPIData) entity;
        ...
        public Task<bool> DeleteAsycudaSalesAllocationsPIData(string Id)
        {
            try
            {
              using ( var dbContext = new AllocationDSContext(){StartTracking = StartTracking})
              {
                var i = Convert.ToInt32(Id);
                AsycudaSalesAllocationsPIData entity = dbContext.AsycudaSalesAllocationsPIData
		...
		public Task<int> Count(string exp)
        {
            try
            {
                using (AllocationDSContext dbContext = new AllocationDSContext(){StartTracking = StartTracking})
                {
                    ...
                    if (exp == "All")
                    {
                        return Task.FromResult(dbContext.AsycudaSalesAllocationsPIData
                            .AsNoTracking()
                            .Count());
                    }
                    else
        ...
        public Task<IEnumerable<AsycudaSalesAllocationsPIData>> LoadRange(int startIndex, int count, string exp)
        {
            try
            {
                using (var dbContext = new AllocationDSContext(){StartTracking = StartTracking})
                {
                    ...
                    if (exp == "All")
                    {
                        return Task.FromResult<IEnumerable<AsycudaSalesAllocationsPIData>>(dbContext.AsycudaSalesAllocationsPIData
                            .AsNoTracking()
                            .OrderBy(y => y.Id)
                            .Skip(startIndex)
                            .Take(count)
		...
		public async Task<int> CountNav(string exp, Dictionary<string, string> navExp)
        {
            try
            {
                ...
                using (var dbContext = new AllocationDSContext(){StartTracking = StartTracking})
                {
                    ...
                    if (exp == "All" && navExp.Count == 0)
                    {
                        return dbContext.AsycudaSalesAllocationsPIData
										.AsNoTracking()
                                        .Count();
                    }
                    foreach (var itm in navExp)
                                                                                 ...
                                                                                 Dictionary<string, string> navExp, IEnumerable<string> includeLst = null)
        {
            try
            {
                using (var dbContext = new AllocationDSContext(){StartTracking = StartTracking})
                {
                    ...
                    return set//dbContext.AsycudaSalesAllocationsPIData
								.AsNoTracking()
                                .Where(exp == "All" || exp == null ? "Id != null" : exp)
								.OrderBy(y => y.Id)
		...
		private static Task<IEnumerable<AsycudaSalesAllocationsPIData>> LoadRangeSelectMany<T>(int startIndex, int count,
                                                                                               AllocationDSContext dbContext, string exp, string navExp, string navProp, IEnumerable<string> includeLst = null) where T : class
        {
            ...
            return Task.FromResult<IEnumerable<AsycudaSalesAllocationsPIData>>(set
                .Where(exp == "All" || exp == null ? "Id != null" : exp)
                .Distinct()
                .OrderBy(y => y.Id)
		...
		private static Task<IEnumerable<AsycudaSalesAllocationsPIData>> LoadRangeSelect<T>(int startIndex, int count,
                                                                                           AllocationDSContext dbContext, string exp, string navExp, string navProp, IEnumerable<string> includeLst = null) where T : class
        {
			try
			{
		...
		private static Task<IEnumerable<AsycudaSalesAllocationsPIData>> GetWhereSelectMany<T>(AllocationDSContext dbContext,
                                                                                              string exp, string navExp, string navProp, List<string> includesLst = null) where T : class
        {
			...
			if (includesLst == null)
			{
				return Task.FromResult<IEnumerable<AsycudaSalesAllocationsPIData>>(dbContext.Set<T>()
                    .AsNoTracking()
                    .Where(navExp)
                    .SelectMany(navProp).OfType<AsycudaSalesAllocationsPIData>()
                    .Where(exp == "All" || exp == null?"Id != null":exp)
            ...
            return Task.FromResult<IEnumerable<AsycudaSalesAllocationsPIData>>(set.ToList());
			}
			catch (Exception)
			{
				Debugger.Break();
		...
		private static Task<IEnumerable<AsycudaSalesAllocationsPIData>> GetWhereSelect<T>(AllocationDSContext dbContext,
                                                                                          string exp, string navExp, string navProp, List<string> includesLst = null) where T : class
        {
			try
			{
			...
			catch (Exception)
			{
				...
				throw;
			        ...
			        public Task<IEnumerable<AsycudaSalesAllocationsPIData>> GetAsycudaSalesAllocationsPIDataByAllocationId(string AllocationId, List<string> includesLst = null)
        {
            try
            {
                using ( var dbContext = new AllocationDSContext(){StartTracking = StartTracking})
              {
                ...
                var set = AddIncludes(includesLst, dbContext);
                IEnumerable<AsycudaSalesAllocationsPIData> entities = set//dbContext.AsycudaSalesAllocationsPIData
                                      .AsNoTracking()
            ...
            catch (Exception updateEx)
            {
 	        ...
 	        public Task<IEnumerable<AsycudaSalesAllocationsPIData>> GetAsycudaSalesAllocationsPIDataByxBond_Item_Id(string xBond_Item_Id, List<string> includesLst = null)
        {
            try
            {
                using ( var dbContext = new AllocationDSContext(){StartTracking = StartTracking})
            ...
            catch (Exception updateEx)
            {
 	        ...
 	        public Task<IEnumerable<AsycudaSalesAllocationsPIData>> GetAsycudaSalesAllocationsPIDataByxASYCUDA_Id(string xASYCUDA_Id, List<string> includesLst = null)
        {
            try
            {
                using ( var dbContext = new AllocationDSContext(){StartTracking = StartTracking})
