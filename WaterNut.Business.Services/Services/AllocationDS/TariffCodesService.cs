...
namespace AllocationDS.Business.Services
{
   ...
   [ServiceBehavior(InstanceContextMode = InstanceContextMode.PerCall,
    ...
    public partial class TariffCodesService : ITariffCodesService, IDisposable
    {
        ...
        public async Task<IEnumerable<TariffCodes>> GetTariffCodes(List<string> includesLst = null, bool tracking = true)
        {
            try
            {
            //using (var scope = new TransactionScope(TransactionScopeOption.Required,
               ...
               // {
                  using ( var dbContext = new AllocationDSContext(){StartTracking = StartTracking})
                  {
                    ...
                    IEnumerable<TariffCodes> entities = await set.AsNoTracking().ToListAsync()
        ...
        public async Task<TariffCodes> GetTariffCodesByKey(string TariffCode, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
			   if(string.IsNullOrEmpty(TariffCode))return null; 
              using ( var dbContext = new AllocationDSContext(){StartTracking = StartTracking})
              {
                var i = TariffCode;
				var set = AddIncludes(includesLst, dbContext);
                TariffCodes entity = await set.AsNoTracking().SingleOrDefaultAsync(x => x.TariffCode == i).ConfigureAwait(continueOnCapturedContext: false);
		 ...
		 public async Task<IEnumerable<TariffCodes>> GetTariffCodesByExpression(string exp, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
                using (var dbContext = new AllocationDSContext(){StartTracking = StartTracking})
		 ...
		 public async Task<IEnumerable<TariffCodes>> GetTariffCodesByExpressionLst(List<string> expLst, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
                using (var dbContext = new AllocationDSContext(){StartTracking = StartTracking})
                {
					if (expLst.Count == 0 || expLst.FirstOrDefault() == "None") return new List<TariffCodes>();
					var set = AddIncludes(includesLst, dbContext);
        ...
        public async Task<bool> DeleteTariffCodes(string TariffCode)
        {
            try
            {
              using ( var dbContext = new AllocationDSContext(){StartTracking = StartTracking})
              {
                var i = TariffCode;
                TariffCodes entity = await dbContext.TariffCodes
													.SingleOrDefaultAsync(x => x.TariffCode == i)
													.ConfigureAwait(continueOnCapturedContext: false);
                if (entity == null)
                    return false;
		...
		public async Task<int> Count(string exp)
        {
            try
            {
                using (AllocationDSContext dbContext = new AllocationDSContext(){StartTracking = StartTracking})
                {
                    ...
                    if (exp == "All")
                    {
                        return await dbContext.TariffCodes
                                    .AsNoTracking()
									.CountAsync()
									.ConfigureAwait(continueOnCapturedContext: false);
                    }
                                                                                 ...
                                                                                 Dictionary<string, string> navExp, IEnumerable<string> includeLst = null)
        {
            try
            {
                using (var dbContext = new AllocationDSContext(){StartTracking = StartTracking})
                {
                    ...
                    return await set//dbContext.TariffCodes
								.AsNoTracking()
                                .Where(exp == "All" || exp == null ? "TariffCode != null" : exp)
								.OrderBy(y => y.TariffCode)
		...
		private static async Task<IEnumerable<TariffCodes>> LoadRangeSelectMany<T>(int startIndex, int count,
		...
		private static async Task<IEnumerable<TariffCodes>> LoadRangeSelect<T>(int startIndex, int count,
            AllocationDSContext dbContext, string exp, string navExp, string navProp, IEnumerable<string> includeLst = null) where T : class
        {
			try
			{
		...
		private static async Task<IEnumerable<TariffCodes>> GetWhereSelectMany<T>(AllocationDSContext dbContext,
		...
		private static async Task<IEnumerable<TariffCodes>> GetWhereSelect<T>(AllocationDSContext dbContext,
            string exp, string navExp, string navProp, List<string> includesLst = null) where T : class
        {
			try
			{
