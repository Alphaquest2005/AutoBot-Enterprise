...
namespace AllocationDS.Business.Services
{
   ...
   [ServiceBehavior(InstanceContextMode = InstanceContextMode.PerCall,
    ...
    public partial class xcuda_Inventory_ItemService : Ixcuda_Inventory_ItemService, IDisposable
    {
        ...
        public Task<IEnumerable<xcuda_Inventory_Item>> Getxcuda_Inventory_Item(List<string> includesLst = null, bool tracking = true)
        {
            try
            {
        ...
        public Task<xcuda_Inventory_Item> Getxcuda_Inventory_ItemByKey(string Item_Id, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
			   if(string.IsNullOrEmpty(Item_Id))return Task.FromResult<xcuda_Inventory_Item>(null); 
              using ( var dbContext = new AllocationDSContext(){StartTracking = StartTracking})
              {
		 ...
		 public Task<IEnumerable<xcuda_Inventory_Item>> Getxcuda_Inventory_ItemByExpression(string exp, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
                using (var dbContext = new AllocationDSContext(){StartTracking = StartTracking})
                {
					...
					if (string.IsNullOrEmpty(exp) || exp == "None") return Task.FromResult<IEnumerable<xcuda_Inventory_Item>>(new List<xcuda_Inventory_Item>());
					var set = AddIncludes(includesLst, dbContext);
                    if (exp == "All")
                    {
                        ...
                        if(tracking) entities.AsParallel(new ParallelLinqOptions() { MaxDegreeOfParallelism = Environment.ProcessorCount }).ForAll(x => x.StartTracking());
                        return Task.FromResult<IEnumerable<xcuda_Inventory_Item>>(entities); 
                    }
					else
					{
		 ...
		 public Task<IEnumerable<xcuda_Inventory_Item>> Getxcuda_Inventory_ItemByExpressionLst(List<string> expLst, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
                using (var dbContext = new AllocationDSContext(){StartTracking = StartTracking})
                {
                    dbContext.Database.CommandTimeout = 0;
					if (expLst.Count == 0 || expLst.FirstOrDefault() == "None") return Task.FromResult<IEnumerable<xcuda_Inventory_Item>>(new List<xcuda_Inventory_Item>());
					var set = AddIncludes(includesLst, dbContext);
        ...
        public Task<IEnumerable<xcuda_Inventory_Item>> Getxcuda_Inventory_ItemByBatch(string exp,
        ...
        public Task<IEnumerable<xcuda_Inventory_Item>> Getxcuda_Inventory_ItemByBatchExpressionLst(List<string> expLst,
                                                                                                   int totalrow, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
        ...
        public Task<xcuda_Inventory_Item> Updatexcuda_Inventory_Item(xcuda_Inventory_Item entity)
        { 
            using ( var dbContext = new AllocationDSContext(){StartTracking = StartTracking})
              {
                try
        ...
        public Task<xcuda_Inventory_Item> Createxcuda_Inventory_Item(xcuda_Inventory_Item entity)
        {
            try
            {
                var res = (xcuda_Inventory_Item) entity;
        ...
        public Task<bool> Deletexcuda_Inventory_Item(string Item_Id)
        {
            try
            {
              using ( var dbContext = new AllocationDSContext(){StartTracking = StartTracking})
		...
		public Task<int> Count(string exp)
        {
            try
            {
                using (AllocationDSContext dbContext = new AllocationDSContext(){StartTracking = StartTracking})
                {
                    ...
                    if (exp == "All")
                    {
                        return Task.FromResult(dbContext.xcuda_Inventory_Item
                            .AsNoTracking()
                            .Count());
                    }
                    else
        ...
        public Task<IEnumerable<xcuda_Inventory_Item>> LoadRange(int startIndex, int count, string exp)
        {
            try
            {
                using (var dbContext = new AllocationDSContext(){StartTracking = StartTracking})
                {
                    ...
                    if (exp == "All")
                    {
                        return Task.FromResult<IEnumerable<xcuda_Inventory_Item>>(dbContext.xcuda_Inventory_Item
                            .AsNoTracking()
                            .OrderBy(y => y.Item_Id)
                            .Skip(startIndex)
                            .Take(count)
		...
		private static Task<IEnumerable<xcuda_Inventory_Item>> LoadRangeSelectMany<T>(int startIndex, int count,
                                                                                      AllocationDSContext dbContext, string exp, string navExp, string navProp, IEnumerable<string> includeLst = null) where T : class
        {
            ...
            return Task.FromResult<IEnumerable<xcuda_Inventory_Item>>(set
                .Where(exp == "All" || exp == null ? "Item_Id != null" : exp)
                .Distinct()
                .OrderBy(y => y.Item_Id)
		...
		private static Task<IEnumerable<xcuda_Inventory_Item>> LoadRangeSelect<T>(int startIndex, int count,
                                                                                  AllocationDSContext dbContext, string exp, string navExp, string navProp, IEnumerable<string> includeLst = null) where T : class
        {
			try
			{
		...
		private static Task<IEnumerable<xcuda_Inventory_Item>> GetWhereSelectMany<T>(AllocationDSContext dbContext,
                                                                                     string exp, string navExp, string navProp, List<string> includesLst = null) where T : class
        {
			...
			if (includesLst == null)
			{
				return Task.FromResult<IEnumerable<xcuda_Inventory_Item>>(dbContext.Set<T>()
                    .AsNoTracking()
                    .Where(navExp)
                    .SelectMany(navProp).OfType<xcuda_Inventory_Item>()
                    .Where(exp == "All" || exp == null?"Item_Id != null":exp)
            ...
            return Task.FromResult<IEnumerable<xcuda_Inventory_Item>>(set.ToList());
			}
			catch (Exception)
			{
				Debugger.Break();
		...
		private static Task<IEnumerable<xcuda_Inventory_Item>> GetWhereSelect<T>(AllocationDSContext dbContext,
                                                                                 string exp, string navExp, string navProp, List<string> includesLst = null) where T : class
        {
			try
			{
			...
			catch (Exception)
			{
				...
				throw;
			        ...
			        public Task<IEnumerable<xcuda_Inventory_Item>> Getxcuda_Inventory_ItemByInventoryItemId(string InventoryItemId, List<string> includesLst = null)
        {
            try
            {
                using ( var dbContext = new AllocationDSContext(){StartTracking = StartTracking})
