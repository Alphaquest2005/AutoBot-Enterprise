...
namespace AllocationDS.Business.Services
{
   ...
   [ServiceBehavior(InstanceContextMode = InstanceContextMode.PerCall,
    ...
    public partial class AsycudaDocumentItemEntryDataDetailsService : IAsycudaDocumentItemEntryDataDetailsService, IDisposable
    {
        ...
        public Task<IEnumerable<AsycudaDocumentItemEntryDataDetails>> GetAsycudaDocumentItemEntryDataDetails(List<string> includesLst = null, bool tracking = true)
        {
            try
            {
        ...
        public Task<AsycudaDocumentItemEntryDataDetails> GetAsycudaDocumentItemEntryDataDetailsByKey(string Id, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
			   if(string.IsNullOrEmpty(Id))return Task.FromResult<AsycudaDocumentItemEntryDataDetails>(null); 
              using ( var dbContext = new AllocationDSContext(){StartTracking = StartTracking})
              {
		 ...
		 public Task<IEnumerable<AsycudaDocumentItemEntryDataDetails>> GetAsycudaDocumentItemEntryDataDetailsByExpression(string exp, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
                using (var dbContext = new AllocationDSContext(){StartTracking = StartTracking})
                {
					...
					if (string.IsNullOrEmpty(exp) || exp == "None") return Task.FromResult<IEnumerable<AsycudaDocumentItemEntryDataDetails>>(new List<AsycudaDocumentItemEntryDataDetails>());
					var set = AddIncludes(includesLst, dbContext);
                    if (exp == "All")
                    {
                        ...
                        if(tracking) entities.AsParallel(new ParallelLinqOptions() { MaxDegreeOfParallelism = Environment.ProcessorCount }).ForAll(x => x.StartTracking());
                        return Task.FromResult<IEnumerable<AsycudaDocumentItemEntryDataDetails>>(entities); 
                    }
					else
					{
		 ...
		 public Task<IEnumerable<AsycudaDocumentItemEntryDataDetails>> GetAsycudaDocumentItemEntryDataDetailsByExpressionLst(List<string> expLst, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
                using (var dbContext = new AllocationDSContext(){StartTracking = StartTracking})
                {
                    dbContext.Database.CommandTimeout = 0;
					if (expLst.Count == 0 || expLst.FirstOrDefault() == "None") return Task.FromResult<IEnumerable<AsycudaDocumentItemEntryDataDetails>>(new List<AsycudaDocumentItemEntryDataDetails>());
					var set = AddIncludes(includesLst, dbContext);
        ...
        public Task<IEnumerable<AsycudaDocumentItemEntryDataDetails>> GetAsycudaDocumentItemEntryDataDetailsByBatch(string exp,
        ...
        public Task<IEnumerable<AsycudaDocumentItemEntryDataDetails>> GetAsycudaDocumentItemEntryDataDetailsByBatchExpressionLst(List<string> expLst,
                                                                                                                                 int totalrow, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
        ...
        public Task<AsycudaDocumentItemEntryDataDetails> UpdateAsycudaDocumentItemEntryDataDetails(AsycudaDocumentItemEntryDataDetails entity)
        { 
            using ( var dbContext = new AllocationDSContext(){StartTracking = StartTracking})
              {
                try
        ...
        public Task<AsycudaDocumentItemEntryDataDetails> CreateAsycudaDocumentItemEntryDataDetails(AsycudaDocumentItemEntryDataDetails entity)
        {
            try
            {
                var res = (AsycudaDocumentItemEntryDataDetails) entity;
        ...
        public Task<bool> DeleteAsycudaDocumentItemEntryDataDetails(string Id)
        {
            try
            {
              using ( var dbContext = new AllocationDSContext(){StartTracking = StartTracking})
        ...
        public Task<IEnumerable<AsycudaDocumentItemEntryDataDetails>> LoadRange(int startIndex, int count, string exp)
        {
            try
            {
                using (var dbContext = new AllocationDSContext(){StartTracking = StartTracking})
                {
                    ...
                    if (exp == "All")
                    {
                        return Task.FromResult<IEnumerable<AsycudaDocumentItemEntryDataDetails>>(dbContext.AsycudaDocumentItemEntryDataDetails
                            .AsNoTracking()
                            .OrderBy(y => y.Id)
                            .Skip(startIndex)
                            .Take(count)
		...
		private static Task<IEnumerable<AsycudaDocumentItemEntryDataDetails>> LoadRangeSelectMany<T>(int startIndex, int count,
                                                                                                     AllocationDSContext dbContext, string exp, string navExp, string navProp, IEnumerable<string> includeLst = null) where T : class
        {
            ...
            return Task.FromResult<IEnumerable<AsycudaDocumentItemEntryDataDetails>>(set
                .Where(exp == "All" || exp == null ? "Id != null" : exp)
                .Distinct()
                .OrderBy(y => y.Id)
		...
		private static Task<IEnumerable<AsycudaDocumentItemEntryDataDetails>> LoadRangeSelect<T>(int startIndex, int count,
                                                                                                 AllocationDSContext dbContext, string exp, string navExp, string navProp, IEnumerable<string> includeLst = null) where T : class
        {
			try
			{
		...
		private static Task<IEnumerable<AsycudaDocumentItemEntryDataDetails>> GetWhereSelectMany<T>(AllocationDSContext dbContext,
                                                                                                    string exp, string navExp, string navProp, List<string> includesLst = null) where T : class
        {
			...
			if (includesLst == null)
			{
				return Task.FromResult<IEnumerable<AsycudaDocumentItemEntryDataDetails>>(dbContext.Set<T>()
                    .AsNoTracking()
                    .Where(navExp)
                    .SelectMany(navProp).OfType<AsycudaDocumentItemEntryDataDetails>()
                    .Where(exp == "All" || exp == null?"Id != null":exp)
            ...
            return Task.FromResult<IEnumerable<AsycudaDocumentItemEntryDataDetails>>(set.ToList());
			}
			catch (Exception)
			{
				Debugger.Break();
		...
		private static Task<IEnumerable<AsycudaDocumentItemEntryDataDetails>> GetWhereSelect<T>(AllocationDSContext dbContext,
                                                                                                string exp, string navExp, string navProp, List<string> includesLst = null) where T : class
        {
			try
			{
			...
			catch (Exception)
			{
				...
				throw;
			        ...
			        public Task<IEnumerable<AsycudaDocumentItemEntryDataDetails>> GetAsycudaDocumentItemEntryDataDetailsByEntryDataDetailsId(string EntryDataDetailsId, List<string> includesLst = null)
        {
            try
            {
                using ( var dbContext = new AllocationDSContext(){StartTracking = StartTracking})
            ...
            catch (Exception updateEx)
            {
 	        ...
 	        public Task<IEnumerable<AsycudaDocumentItemEntryDataDetails>> GetAsycudaDocumentItemEntryDataDetailsByItem_Id(string Item_Id, List<string> includesLst = null)
        {
            try
            {
                using ( var dbContext = new AllocationDSContext(){StartTracking = StartTracking})
            ...
            catch (Exception updateEx)
            {
 	        ...
 	        public Task<IEnumerable<AsycudaDocumentItemEntryDataDetails>> GetAsycudaDocumentItemEntryDataDetailsByEntryData_Id(string EntryData_Id, List<string> includesLst = null)
        {
            try
            {
                using ( var dbContext = new AllocationDSContext(){StartTracking = StartTracking})
            ...
            catch (Exception updateEx)
            {
 	        ...
 	        public Task<IEnumerable<AsycudaDocumentItemEntryDataDetails>> GetAsycudaDocumentItemEntryDataDetailsByApplicationSettingsId(string ApplicationSettingsId, List<string> includesLst = null)
        {
            try
            {
                using ( var dbContext = new AllocationDSContext(){StartTracking = StartTracking})
            ...
            catch (Exception updateEx)
            {
 	        ...
 	        public Task<IEnumerable<AsycudaDocumentItemEntryDataDetails>> GetAsycudaDocumentItemEntryDataDetailsByAsycudaDocumentSetId(string AsycudaDocumentSetId, List<string> includesLst = null)
        {
            try
            {
                using ( var dbContext = new AllocationDSContext(){StartTracking = StartTracking})
