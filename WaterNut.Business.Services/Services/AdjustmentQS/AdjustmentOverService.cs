    ...
    public partial class AdjustmentOverService : IAdjustmentOverService, IDisposable
    {
            ...
            //using (var scope = new TransactionScope(TransactionScopeOption.Required,
               ...
               // {
                  using ( var dbContext = new AdjustmentQSContext(){StartTracking = StartTracking})
                  {
                    ...
                    IEnumerable<AdjustmentOver> entities = await set.AsNoTracking().ToListAsync()
        ...
        public async Task<AdjustmentOver> GetAdjustmentOverByKey(string EntryDataDetailsId, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
              ...
              using ( var dbContext = new AdjustmentQSContext(){StartTracking = StartTracking})
              {
				...
				var set = AddIncludes(includesLst, dbContext);
                AdjustmentOver entity = await set.AsNoTracking().SingleOrDefaultAsync(x => x.EntryDataDetailsId == i).ConfigureAwait(continueOnCapturedContext: false);
                    ...
                    foreach (var itm in navExp)
                    {
                        switch (itm.Key)
                        {
                            ...
                            case "InventoryItem":
                                return
                                    await
                                        GetWhere<InventoryItem>(dbContext, exp, itm.Value, "AdjustmentOvers", "SelectMany", includesLst)
										.ConfigureAwait(continueOnCapturedContext: false);
        ...
        public async Task<bool> DeleteAdjustmentOver(string EntryDataDetailsId)
        {
            try
            {
              ...
              {
                var i = Convert.ToInt32(EntryDataDetailsId);
                AdjustmentOver entity = await dbContext.AdjustmentOvers
		...
		public async Task<int> CountNav(string exp, Dictionary<string, string> navExp)
        {
            try
            {
                ...
                using (var dbContext = new AdjustmentQSContext(){StartTracking = StartTracking})
                {
                        ...
                        switch (itm.Key)
                        {
                            case "AdjustmentEx":
                                return await CountWhere<AdjustmentEx>(dbContext, exp, itm.Value, "AdjustmentOvers", "SelectMany")
											.ConfigureAwait(continueOnCapturedContext: false);
                            case "InventoryItem":
                                return await CountWhere<InventoryItem>(dbContext, exp, itm.Value, "AdjustmentOvers", "SelectMany")
											.ConfigureAwait(continueOnCapturedContext: false);
                            case "AsycudaDocumentItemEntryDataDetails":
                    ...
                    return await dbContext.AdjustmentOvers.Where(exp == "All" || exp == null ? "EntryDataDetailsId != null" : exp)
											.AsNoTracking()
                                            .CountAsync()
											.ConfigureAwait(continueOnCapturedContext: false);
                }
                                                                                 ...
                                                                                 Dictionary<string, string> navExp, IEnumerable<string> includeLst = null)
        {
            try
            {
                using (var dbContext = new AdjustmentQSContext(){StartTracking = StartTracking})
                {
                    ...
                    foreach (var itm in navExp)
                    {
                        switch (itm.Key)
                        {
                            ...
                            case "InventoryItem":
                                return
                                    await
                                        LoadRangeWhere<InventoryItem>(startIndex, count, dbContext, exp, itm.Value, "AdjustmentOvers", "SelectMany")
													.ConfigureAwait(continueOnCapturedContext: false);
                    ...
                    return await set//dbContext.AdjustmentOvers
								.AsNoTracking()
                                .Where(exp == "All" || exp == null ? "EntryDataDetailsId != null" : exp)
								.OrderBy(y => y.EntryDataDetailsId)
			        ...
			        public async Task<IEnumerable<AdjustmentOver>> GetAdjustmentOverByEntryDataId(string EntryDataId, List<string> includesLst = null)
        {
            try
            {
                using ( var dbContext = new AdjustmentQSContext(){StartTracking = StartTracking})
              {
                var i = EntryDataId;
                var set = AddIncludes(includesLst, dbContext);
                IEnumerable<AdjustmentOver> entities = await set//dbContext.AdjustmentOvers
                        ...
                        switch (itm.Key)
                        {
                            case "AdjustmentEx":
                                return await SumWhere<AdjustmentEx>(dbContext, exp, itm.Value, "AdjustmentOvers", field, "SelectMany")
											.ConfigureAwait(continueOnCapturedContext: false);
                            case "InventoryItem":
                                return await SumWhere<InventoryItem>(dbContext, exp, itm.Value, "AdjustmentOvers", field, "SelectMany")
											.ConfigureAwait(continueOnCapturedContext: false);
                            case "AsycudaDocumentItemEntryDataDetails":
