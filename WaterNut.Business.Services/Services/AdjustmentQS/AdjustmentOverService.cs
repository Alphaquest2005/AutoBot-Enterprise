...
namespace AdjustmentQS.Business.Services
{
   ...
   [ServiceBehavior(InstanceContextMode = InstanceContextMode.PerCall,
    ...
    public partial class AdjustmentOverService : IAdjustmentOverService, IDisposable
    {
        ...
        public Task<IEnumerable<AdjustmentOver>> GetAdjustmentOvers(List<string> includesLst = null, bool tracking = true)
        {
            try
            {
        ...
        public Task<AdjustmentOver> GetAdjustmentOverByKey(string EntryDataDetailsId, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
			   if(string.IsNullOrEmpty(EntryDataDetailsId))return Task.FromResult<AdjustmentOver>(null); 
              using ( var dbContext = new AdjustmentQSContext(){StartTracking = StartTracking})
              {
		 ...
		 public Task<IEnumerable<AdjustmentOver>> GetAdjustmentOversByExpression(string exp, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
                using (var dbContext = new AdjustmentQSContext(){StartTracking = StartTracking})
                {
					...
					if (string.IsNullOrEmpty(exp) || exp == "None") return Task.FromResult<IEnumerable<AdjustmentOver>>(new List<AdjustmentOver>());
					var set = AddIncludes(includesLst, dbContext);
                    if (exp == "All")
                    {
                        ...
                        if(tracking) entities.AsParallel(new ParallelLinqOptions() { MaxDegreeOfParallelism = Environment.ProcessorCount }).ForAll(x => x.StartTracking());
                        return Task.FromResult<IEnumerable<AdjustmentOver>>(entities); 
                    }
					else
					{
		 ...
		 public Task<IEnumerable<AdjustmentOver>> GetAdjustmentOversByExpressionLst(List<string> expLst, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
                using (var dbContext = new AdjustmentQSContext(){StartTracking = StartTracking})
                {
                    dbContext.Database.CommandTimeout = 0;
					if (expLst.Count == 0 || expLst.FirstOrDefault() == "None") return Task.FromResult<IEnumerable<AdjustmentOver>>(new List<AdjustmentOver>());
					var set = AddIncludes(includesLst, dbContext);
        ...
        public Task<IEnumerable<AdjustmentOver>> GetAdjustmentOversByBatch(string exp,
        ...
        public Task<IEnumerable<AdjustmentOver>> GetAdjustmentOversByBatchExpressionLst(List<string> expLst,
                                                                                        int totalrow, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
        ...
        public Task<AdjustmentOver> UpdateAdjustmentOver(AdjustmentOver entity)
        { 
            using ( var dbContext = new AdjustmentQSContext(){StartTracking = StartTracking})
              {
                try
        ...
        public Task<AdjustmentOver> CreateAdjustmentOver(AdjustmentOver entity)
        {
            try
            {
                var res = (AdjustmentOver) entity;
        ...
        public Task<bool> DeleteAdjustmentOver(string EntryDataDetailsId)
        {
            try
            {
              using ( var dbContext = new AdjustmentQSContext(){StartTracking = StartTracking})
		...
		public Task<int> Count(string exp)
        {
            try
            {
                using (AdjustmentQSContext dbContext = new AdjustmentQSContext(){StartTracking = StartTracking})
                {
                    ...
                    if (exp == "All")
                    {
                        return Task.FromResult(dbContext.AdjustmentOvers
                            .AsNoTracking()
                            .Count());
                    }
                    else
        ...
        public Task<IEnumerable<AdjustmentOver>> LoadRange(int startIndex, int count, string exp)
        {
            try
            {
                using (var dbContext = new AdjustmentQSContext(){StartTracking = StartTracking})
                {
                    ...
                    if (exp == "All")
                    {
                        return Task.FromResult<IEnumerable<AdjustmentOver>>(dbContext.AdjustmentOvers
                            .AsNoTracking()
		...
		private static Task<IEnumerable<AdjustmentOver>> LoadRangeSelectMany<T>(int startIndex, int count,
                                                                                AdjustmentQSContext dbContext, string exp, string navExp, string navProp, IEnumerable<string> includeLst = null) where T : class
        {
            ...
            return Task.FromResult<IEnumerable<AdjustmentOver>>(set
                .Where(exp == "All" || exp == null ? "EntryDataDetailsId != null" : exp)
                .Distinct()
                .OrderBy(y => y.EntryDataDetailsId)
		...
		private static Task<IEnumerable<AdjustmentOver>> LoadRangeSelect<T>(int startIndex, int count,
                                                                            AdjustmentQSContext dbContext, string exp, string navExp, string navProp, IEnumerable<string> includeLst = null) where T : class
        {
			try
			{
		...
		private static Task<IEnumerable<AdjustmentOver>> GetWhereSelectMany<T>(AdjustmentQSContext dbContext,
                                                                               string exp, string navExp, string navProp, List<string> includesLst = null) where T : class
        {
			...
			if (includesLst == null)
			{
				return Task.FromResult<IEnumerable<AdjustmentOver>>(dbContext.Set<T>()
                    .AsNoTracking()
                    .Where(navExp)
                    .SelectMany(navProp).OfType<AdjustmentOver>()
                    .Where(exp == "All" || exp == null?"EntryDataDetailsId != null":exp)
            ...
            return Task.FromResult<IEnumerable<AdjustmentOver>>(set.ToList());
			}
			catch (Exception)
			{
				Debugger.Break();
		...
		private static Task<IEnumerable<AdjustmentOver>> GetWhereSelect<T>(AdjustmentQSContext dbContext,
                                                                           string exp, string navExp, string navProp, List<string> includesLst = null) where T : class
        {
			try
			{
			...
			catch (Exception)
			{
				...
				throw;
			        ...
			        public Task<IEnumerable<AdjustmentOver>> GetAdjustmentOverByEntryDataId(string EntryDataId, List<string> includesLst = null)
        {
            try
            {
                using ( var dbContext = new AdjustmentQSContext(){StartTracking = StartTracking})
            ...
            catch (Exception updateEx)
            {
 	        ...
 	        public Task<IEnumerable<AdjustmentOver>> GetAdjustmentOverByAsycudaDocumentSetId(string AsycudaDocumentSetId, List<string> includesLst = null)
        {
            try
            {
                using ( var dbContext = new AdjustmentQSContext(){StartTracking = StartTracking})
            ...
            catch (Exception updateEx)
            {
 	        ...
 	        public Task<IEnumerable<AdjustmentOver>> GetAdjustmentOverByApplicationSettingsId(string ApplicationSettingsId, List<string> includesLst = null)
        {
            try
            {
                using ( var dbContext = new AdjustmentQSContext(){StartTracking = StartTracking})
            ...
            catch (Exception updateEx)
            {
 	        ...
 	        public Task<IEnumerable<AdjustmentOver>> GetAdjustmentOverByEmailId(string EmailId, List<string> includesLst = null)
        {
            try
            {
                using ( var dbContext = new AdjustmentQSContext(){StartTracking = StartTracking})
            ...
            catch (Exception updateEx)
            {
 	        ...
 	        public Task<IEnumerable<AdjustmentOver>> GetAdjustmentOverByFileTypeId(string FileTypeId, List<string> includesLst = null)
        {
            try
            {
                using ( var dbContext = new AdjustmentQSContext(){StartTracking = StartTracking})
            ...
            catch (Exception updateEx)
            {
 	        ...
 	        public Task<IEnumerable<AdjustmentOver>> GetAdjustmentOverByEntryData_Id(string EntryData_Id, List<string> includesLst = null)
        {
            try
            {
                using ( var dbContext = new AdjustmentQSContext(){StartTracking = StartTracking})
            ...
            catch (Exception updateEx)
            {
 	        ...
 	        public Task<IEnumerable<AdjustmentOver>> GetAdjustmentOverByInventoryItemId(string InventoryItemId, List<string> includesLst = null)
        {
            try
            {
                using ( var dbContext = new AdjustmentQSContext(){StartTracking = StartTracking})
