...
namespace AdjustmentQS.Business.Services
{
   ...
   [ServiceBehavior(InstanceContextMode = InstanceContextMode.PerCall,
    ...
    public partial class SystemDocumentSetService : ISystemDocumentSetService, IDisposable
    {
		...
		private static async Task<IEnumerable<SystemDocumentSet>> GetWhereSelectMany<T>(AdjustmentQSContext dbContext,
		...
		private static async Task<IEnumerable<SystemDocumentSet>> GetWhereSelect<T>(AdjustmentQSContext dbContext,
            string exp, string navExp, string navProp, List<string> includesLst = null) where T : class
        {
			try
			{
