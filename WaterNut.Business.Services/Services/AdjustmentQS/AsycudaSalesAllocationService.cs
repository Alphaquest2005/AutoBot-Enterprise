    ...
    public partial class AsycudaSalesAllocationService : IAsycudaSalesAllocationService, IDisposable
    {
            ...
            //using (var scope = new TransactionScope(TransactionScopeOption.Required,
               ...
               // {
                  using ( var dbContext = new AdjustmentQSContext(){StartTracking = StartTracking})
                  {
                    ...
                    IEnumerable<AsycudaSalesAllocation> entities = await set.AsNoTracking().ToListAsync()
        ...
        public async Task<AsycudaSalesAllocation> GetAsycudaSalesAllocationByKey(string AllocationId, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
              ...
              using ( var dbContext = new AdjustmentQSContext(){StartTracking = StartTracking})
              {
				...
				var set = AddIncludes(includesLst, dbContext);
                AsycudaSalesAllocation entity = await set.AsNoTracking().SingleOrDefaultAsync(x => x.AllocationId == i).ConfigureAwait(continueOnCapturedContext: false);
        ...
        public async Task<bool> DeleteAsycudaSalesAllocation(string AllocationId)
        {
            try
            {
              ...
              {
                var i = Convert.ToInt32(AllocationId);
                AsycudaSalesAllocation entity = await dbContext.AsycudaSalesAllocations
			        ...
			        public async Task<IEnumerable<AsycudaSalesAllocation>> GetAsycudaSalesAllocationByEntryDataDetailsId(string EntryDataDetailsId, List<string> includesLst = null)
        {
            try
            {
                using ( var dbContext = new AdjustmentQSContext(){StartTracking = StartTracking})
              {
                ...
                var set = AddIncludes(includesLst, dbContext);
                IEnumerable<AsycudaSalesAllocation> entities = await set//dbContext.AsycudaSalesAllocations
                                      .AsNoTracking()
