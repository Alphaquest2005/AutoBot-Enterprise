...
namespace AdjustmentQS.Business.Services
{
   ...
   [ServiceBehavior(InstanceContextMode = InstanceContextMode.PerCall,
    ...
    public partial class xcuda_ItemService : Ixcuda_ItemService, IDisposable
    {
        ...
        private static async Task<IEnumerable<xcuda_Item>> GetWhere<T>(AdjustmentQSContext dbContext,
		...
		private static async Task<IEnumerable<xcuda_Item>> GetWhereSelectMany<T>(AdjustmentQSContext dbContext,
		...
		private static async Task<IEnumerable<xcuda_Item>> GetWhereSelect<T>(AdjustmentQSContext dbContext,
            string exp, string navExp, string navProp, List<string> includesLst = null) where T : class
        {
			try
			{
		...
		private static IQueryable<xcuda_Item> AddIncludes(IEnumerable<string> includesLst, AdjustmentQSContext dbContext)
       {
		 try
			{
