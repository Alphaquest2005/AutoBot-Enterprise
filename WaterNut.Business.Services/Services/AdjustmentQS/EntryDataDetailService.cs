...
namespace AdjustmentQS.Business.Services
{
   ...
   [ServiceBehavior(InstanceContextMode = InstanceContextMode.PerCall,
    ...
    public partial class EntryDataDetailService : IEntryDataDetailService, IDisposable
    {
        ...
        public Task<IEnumerable<EntryDataDetail>> GetEntryDataDetails(List<string> includesLst = null, bool tracking = true)
        {
            try
            {
            //using (var scope = new TransactionScope(TransactionScopeOption.Required,
               ...
               // {
                  using ( var dbContext = new AdjustmentQSContext(){StartTracking = StartTracking})
                  {
                    ...
                    IEnumerable<EntryDataDetail> entities = set.AsNoTracking().ToList();
                           //scope.Complete();
        ...
        public Task<EntryDataDetail> GetEntryDataDetailByKey(string EntryDataDetailsId, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
			   if(string.IsNullOrEmpty(EntryDataDetailsId))return Task.FromResult<EntryDataDetail>(null); 
              using ( var dbContext = new AdjustmentQSContext(){StartTracking = StartTracking})
              {
                var i = Convert.ToInt32(EntryDataDetailsId);
				var set = AddIncludes(includesLst, dbContext);
                EntryDataDetail entity = set.AsNoTracking().SingleOrDefault(x => x.EntryDataDetailsId == i);
		 ...
		 public Task<IEnumerable<EntryDataDetail>> GetEntryDataDetailsByExpression(string exp, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
                using (var dbContext = new AdjustmentQSContext(){StartTracking = StartTracking})
                {
					...
					if (string.IsNullOrEmpty(exp) || exp == "None") return Task.FromResult<IEnumerable<EntryDataDetail>>(new List<EntryDataDetail>());
					var set = AddIncludes(includesLst, dbContext);
                    if (exp == "All")
                    {
                        ...
                        if(tracking) entities.AsParallel(new ParallelLinqOptions() { MaxDegreeOfParallelism = Environment.ProcessorCount }).ForAll(x => x.StartTracking());
                        return Task.FromResult<IEnumerable<EntryDataDetail>>(entities); 
                    }
					else
					{
		 ...
		 public Task<IEnumerable<EntryDataDetail>> GetEntryDataDetailsByExpressionLst(List<string> expLst, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
                using (var dbContext = new AdjustmentQSContext(){StartTracking = StartTracking})
                {
                    dbContext.Database.CommandTimeout = 0;
					if (expLst.Count == 0 || expLst.FirstOrDefault() == "None") return Task.FromResult<IEnumerable<EntryDataDetail>>(new List<EntryDataDetail>());
					var set = AddIncludes(includesLst, dbContext);
        ...
        public Task<IEnumerable<EntryDataDetail>> GetEntryDataDetailsByBatch(string exp,
        ...
        public Task<IEnumerable<EntryDataDetail>> GetEntryDataDetailsByBatchExpressionLst(List<string> expLst,
                                                                                          int totalrow, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
        ...
        public Task<EntryDataDetail> UpdateEntryDataDetail(EntryDataDetail entity)
        { 
            using ( var dbContext = new AdjustmentQSContext(){StartTracking = StartTracking})
              {
                try
        ...
        public Task<EntryDataDetail> CreateEntryDataDetail(EntryDataDetail entity)
        {
            try
            {
                var res = (EntryDataDetail) entity;
        ...
        public Task<bool> DeleteEntryDataDetail(string EntryDataDetailsId)
        {
            try
            {
              using ( var dbContext = new AdjustmentQSContext(){StartTracking = StartTracking})
              {
                var i = Convert.ToInt32(EntryDataDetailsId);
                EntryDataDetail entity = dbContext.EntryDataDetails
        ...
        public Task<IEnumerable<EntryDataDetail>> LoadRange(int startIndex, int count, string exp)
        {
            try
            {
                using (var dbContext = new AdjustmentQSContext(){StartTracking = StartTracking})
                {
                    ...
                    if (exp == "All")
                    {
                        return Task.FromResult<IEnumerable<EntryDataDetail>>(dbContext.EntryDataDetails
                            .AsNoTracking()
		...
		private static Task<IEnumerable<EntryDataDetail>> LoadRangeSelectMany<T>(int startIndex, int count,
                                                                                 AdjustmentQSContext dbContext, string exp, string navExp, string navProp, IEnumerable<string> includeLst = null) where T : class
        {
            ...
            return Task.FromResult<IEnumerable<EntryDataDetail>>(set
                .Where(exp == "All" || exp == null ? "EntryDataDetailsId != null" : exp)
                .Distinct()
                .OrderBy(y => y.EntryDataDetailsId)
		...
		private static Task<IEnumerable<EntryDataDetail>> LoadRangeSelect<T>(int startIndex, int count,
                                                                             AdjustmentQSContext dbContext, string exp, string navExp, string navProp, IEnumerable<string> includeLst = null) where T : class
        {
			try
			{
		...
		private static Task<IEnumerable<EntryDataDetail>> GetWhereSelectMany<T>(AdjustmentQSContext dbContext,
                                                                                string exp, string navExp, string navProp, List<string> includesLst = null) where T : class
        {
			...
			if (includesLst == null)
			{
				return Task.FromResult<IEnumerable<EntryDataDetail>>(dbContext.Set<T>()
                    .AsNoTracking()
                    .Where(navExp)
                    .SelectMany(navProp).OfType<EntryDataDetail>()
                    .Where(exp == "All" || exp == null?"EntryDataDetailsId != null":exp)
            ...
            return Task.FromResult<IEnumerable<EntryDataDetail>>(set.ToList());
			}
			catch (Exception)
			{
				Debugger.Break();
		...
		private static Task<IEnumerable<EntryDataDetail>> GetWhereSelect<T>(AdjustmentQSContext dbContext,
                                                                            string exp, string navExp, string navProp, List<string> includesLst = null) where T : class
        {
			try
			{
			...
			catch (Exception)
			{
				...
				throw;
			        ...
			        public Task<IEnumerable<EntryDataDetail>> GetEntryDataDetailByEntryDataId(string EntryDataId, List<string> includesLst = null)
        {
            try
            {
                using ( var dbContext = new AdjustmentQSContext(){StartTracking = StartTracking})
              {
                var i = EntryDataId;
                var set = AddIncludes(includesLst, dbContext);
                IEnumerable<EntryDataDetail> entities = set//dbContext.EntryDataDetails
            ...
            catch (Exception updateEx)
            {
 	        ...
 	        public Task<IEnumerable<EntryDataDetail>> GetEntryDataDetailByInventoryItemId(string InventoryItemId, List<string> includesLst = null)
        {
            try
            {
                using ( var dbContext = new AdjustmentQSContext(){StartTracking = StartTracking})
            ...
            catch (Exception updateEx)
            {
 	        ...
 	        public Task<IEnumerable<EntryDataDetail>> GetEntryDataDetailByEntryData_Id(string EntryData_Id, List<string> includesLst = null)
        {
            try
            {
                using ( var dbContext = new AdjustmentQSContext(){StartTracking = StartTracking})
