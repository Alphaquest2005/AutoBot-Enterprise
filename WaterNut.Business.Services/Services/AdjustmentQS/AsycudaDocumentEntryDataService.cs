...
namespace AdjustmentQS.Business.Services
{
   ...
   [ServiceBehavior(InstanceContextMode = InstanceContextMode.PerCall,
    ...
    public partial class AsycudaDocumentEntryDataService : IAsycudaDocumentEntryDataService, IDisposable
    {
		...
		private static async Task<IEnumerable<AsycudaDocumentEntryData>> GetWhereSelectMany<T>(AdjustmentQSContext dbContext,
		...
		private static async Task<IEnumerable<AsycudaDocumentEntryData>> GetWhereSelect<T>(AdjustmentQSContext dbContext,
            string exp, string navExp, string navProp, List<string> includesLst = null) where T : class
        {
			try
			{
