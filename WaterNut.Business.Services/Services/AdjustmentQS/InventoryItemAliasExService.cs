...
namespace AdjustmentQS.Business.Services
{
   ...
   [ServiceBehavior(InstanceContextMode = InstanceContextMode.PerCall,
    ...
    public partial class InventoryItemAliasExService : IInventoryItemAliasExService, IDisposable
    {
        ...
        public async Task<IEnumerable<InventoryItemAliasEx>> GetInventoryItemAliasExes(List<string> includesLst = null, bool tracking = true)
        {
            try
            {
            //using (var scope = new TransactionScope(TransactionScopeOption.Required,
               ...
               // {
                  using ( var dbContext = new AdjustmentQSContext(){StartTracking = StartTracking})
                  {
                    ...
                    IEnumerable<InventoryItemAliasEx> entities = await set.AsNoTracking().ToListAsync()
        ...
        public async Task<InventoryItemAliasEx> GetInventoryItemAliasExByKey(string AliasId, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
              ...
              using ( var dbContext = new AdjustmentQSContext(){StartTracking = StartTracking})
              {
				...
				var set = AddIncludes(includesLst, dbContext);
                InventoryItemAliasEx entity = await set.AsNoTracking().SingleOrDefaultAsync(x => x.AliasId == i).ConfigureAwait(continueOnCapturedContext: false);
		 ...
		 public async Task<IEnumerable<InventoryItemAliasEx>> GetInventoryItemAliasExesByExpression(string exp, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
                using (var dbContext = new AdjustmentQSContext(){StartTracking = StartTracking})
		 ...
		 public async Task<IEnumerable<InventoryItemAliasEx>> GetInventoryItemAliasExesByExpressionLst(List<string> expLst, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
                using (var dbContext = new AdjustmentQSContext(){StartTracking = StartTracking})
                {
					if (expLst.Count == 0 || expLst.FirstOrDefault() == "None") return new List<InventoryItemAliasEx>();
					var set = AddIncludes(includesLst, dbContext);
        ...
        public async Task<bool> DeleteInventoryItemAliasEx(string AliasId)
        {
            try
            {
              using ( var dbContext = new AdjustmentQSContext(){StartTracking = StartTracking})
              {
                var i = Convert.ToInt32(AliasId);
                InventoryItemAliasEx entity = await dbContext.InventoryItemAliasExes
		...
		public async Task<int> Count(string exp)
        {
            try
            {
                using (AdjustmentQSContext dbContext = new AdjustmentQSContext(){StartTracking = StartTracking})
                {
                    ...
                    if (exp == "All")
                    {
                        return await dbContext.InventoryItemAliasExes
                                    .AsNoTracking()
									.CountAsync()
									.ConfigureAwait(continueOnCapturedContext: false);
                    }
		...
		public async Task<int> CountNav(string exp, Dictionary<string, string> navExp)
        {
            try
            {
                ...
                using (var dbContext = new AdjustmentQSContext(){StartTracking = StartTracking})
                {
                    ...
                    return await dbContext.InventoryItemAliasExes.Where(exp == "All" || exp == null ? "AliasId != null" : exp)
											.AsNoTracking()
                                            .CountAsync()
											.ConfigureAwait(continueOnCapturedContext: false);
                }
                                                                                 ...
                                                                                 Dictionary<string, string> navExp, IEnumerable<string> includeLst = null)
        {
            try
            {
                using (var dbContext = new AdjustmentQSContext(){StartTracking = StartTracking})
                {
                    ...
                    return await set//dbContext.InventoryItemAliasExes
								.AsNoTracking()
                                .Where(exp == "All" || exp == null ? "AliasId != null" : exp)
								.OrderBy(y => y.AliasId)
		...
		private static async Task<IEnumerable<InventoryItemAliasEx>> LoadRangeSelectMany<T>(int startIndex, int count,
		...
		private static async Task<IEnumerable<InventoryItemAliasEx>> LoadRangeSelect<T>(int startIndex, int count,
            AdjustmentQSContext dbContext, string exp, string navExp, string navProp, IEnumerable<string> includeLst = null) where T : class
        {
			try
			{
		...
		private static async Task<IEnumerable<InventoryItemAliasEx>> GetWhereSelectMany<T>(AdjustmentQSContext dbContext,
		...
		private static async Task<IEnumerable<InventoryItemAliasEx>> GetWhereSelect<T>(AdjustmentQSContext dbContext,
            string exp, string navExp, string navProp, List<string> includesLst = null) where T : class
        {
			try
			{
			        ...
			        public async Task<IEnumerable<InventoryItemAliasEx>> GetInventoryItemAliasExByApplicationSettingsId(string ApplicationSettingsId, List<string> includesLst = null)
        {
            try
            {
                using ( var dbContext = new AdjustmentQSContext(){StartTracking = StartTracking})
              {
                ...
                var set = AddIncludes(includesLst, dbContext);
                IEnumerable<InventoryItemAliasEx> entities = await set//dbContext.InventoryItemAliasExes
                                      .AsNoTracking()
