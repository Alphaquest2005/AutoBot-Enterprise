...
namespace AdjustmentQS.Business.Services
{
   ...
   [ServiceBehavior(InstanceContextMode = InstanceContextMode.PerCall,
    ...
    public partial class InventoryItemService : IInventoryItemService, IDisposable
    {
        ...
        public async Task<InventoryItem> GetInventoryItemByKey(string ItemNumber, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
              ...
              using ( var dbContext = new AdjustmentQSContext(){StartTracking = StartTracking})
              {
                var i = ItemNumber;
				var set = AddIncludes(includesLst, dbContext);
                InventoryItem entity = await set.AsNoTracking().SingleOrDefaultAsync(x => x.ItemNumber == i).ConfigureAwait(continueOnCapturedContext: false);
                    ...
                    foreach (var itm in navExp)
                    {
                        switch (itm.Key)
                        {
                            case "AdjustmentOvers":
                                return
                                    await
                                        GetWhere<AdjustmentOver>(dbContext, exp, itm.Value, "InventoryItem", "Select", includesLst)
										.ConfigureAwait(continueOnCapturedContext: false);

                            case "EntryDataDetails":
                                return
                                    await
                                        GetWhere<EntryDataDetail>(dbContext, exp, itm.Value, "InventoryItem", "Select", includesLst)
										.ConfigureAwait(continueOnCapturedContext: false);
        ...
        public async Task<bool> DeleteInventoryItem(string ItemNumber)
        {
            try
            {
              using ( var dbContext = new AdjustmentQSContext(){StartTracking = StartTracking})
            ...
            try
            {
                ...
                using (var dbContext = new AdjustmentQSContext(){StartTracking = StartTracking})
                {
                    ...
                    foreach (var itm in navExp)
                    {
                        ...
                        {
                            case "AdjustmentOvers":
                                return await CountWhere<AdjustmentOver>(dbContext, exp, itm.Value, "InventoryItem", "Select")
											.ConfigureAwait(continueOnCapturedContext: false);
                            case "EntryDataDetails":
                                return await CountWhere<EntryDataDetail>(dbContext, exp, itm.Value, "InventoryItem", "Select")
											.ConfigureAwait(continueOnCapturedContext: false);
                            case "InventoryItemAlias":
                    ...
                    foreach (var itm in navExp)
                    {
                        switch (itm.Key)
                        {
                            case "AdjustmentOvers":
                                return
                                    await
                                        LoadRangeWhere<AdjustmentOver>(startIndex, count, dbContext, exp, itm.Value, "InventoryItem", "Select")
													.ConfigureAwait(continueOnCapturedContext: false);

                            case "EntryDataDetails":
                                return
                                    await
                                        LoadRangeWhere<EntryDataDetail>(startIndex, count, dbContext, exp, itm.Value, "InventoryItem", "Select")
													.ConfigureAwait(continueOnCapturedContext: false);
        ...
        private static async Task<IEnumerable<InventoryItem>> GetWhere<T>(AdjustmentQSContext dbContext,
		...
		private static async Task<IEnumerable<InventoryItem>> GetWhereSelectMany<T>(AdjustmentQSContext dbContext,
		...
		private static async Task<IEnumerable<InventoryItem>> GetWhereSelect<T>(AdjustmentQSContext dbContext,
            string exp, string navExp, string navProp, List<string> includesLst = null) where T : class
        {
			try
			{
            ...
            try
            {
                ...
                using (var dbContext = new AdjustmentQSContext(){StartTracking = StartTracking})
                {
                    ...
                    foreach (var itm in navExp)
                    {
                        ...
                        {
                            case "AdjustmentOvers":
                                return await SumWhere<AdjustmentOver>(dbContext, exp, itm.Value, "InventoryItem", field, "Select")
											.ConfigureAwait(continueOnCapturedContext: false);
                            case "EntryDataDetails":
                                return await SumWhere<EntryDataDetail>(dbContext, exp, itm.Value, "InventoryItem", field, "Select")
											.ConfigureAwait(continueOnCapturedContext: false);
                            case "InventoryItemAlias":
		...
		private static IQueryable<InventoryItem> AddIncludes(IEnumerable<string> includesLst, AdjustmentQSContext dbContext)
       {
		 try
			{
