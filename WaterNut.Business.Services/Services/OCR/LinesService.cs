...
namespace OCR.Business.Services
{
   ...
   [ServiceBehavior(InstanceContextMode = InstanceContextMode.PerCall,
    ...
    public partial class LinesService : ILinesService, IDisposable
    {
        ...
        public Task<IEnumerable<Lines>> GetLines(List<string> includesLst = null, bool tracking = true)
        {
            try
            {
            //using (var scope = new TransactionScope(TransactionScopeOption.Required,
               ...
               // {
                  using ( var dbContext = new OCRContext(){StartTracking = StartTracking})
                  {
                    ...
                    IEnumerable<Lines> entities = set.AsNoTracking().ToList();
                           //scope.Complete();
        ...
        public Task<Lines> GetLinesByKey(string Id, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
			   if(string.IsNullOrEmpty(Id))return Task.FromResult<Lines>(null); 
              using ( var dbContext = new OCRContext(){StartTracking = StartTracking})
              {
                var i = Convert.ToInt32(Id);
				var set = AddIncludes(includesLst, dbContext);
                Lines entity = set.AsNoTracking().SingleOrDefault(x => x.Id == i);
		 ...
		 public Task<IEnumerable<Lines>> GetLinesByExpression(string exp, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
                using (var dbContext = new OCRContext(){StartTracking = StartTracking})
                {
					...
					if (string.IsNullOrEmpty(exp) || exp == "None") return Task.FromResult<IEnumerable<Lines>>(new List<Lines>());
					var set = AddIncludes(includesLst, dbContext);
                    if (exp == "All")
                    {
                        ...
                        if(tracking) entities.AsParallel(new ParallelLinqOptions() { MaxDegreeOfParallelism = Environment.ProcessorCount }).ForAll(x => x.StartTracking());
                        return Task.FromResult<IEnumerable<Lines>>(entities); 
                    }
					else
					{
		 ...
		 public Task<IEnumerable<Lines>> GetLinesByExpressionLst(List<string> expLst, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
                using (var dbContext = new OCRContext(){StartTracking = StartTracking})
                {
                    dbContext.Database.CommandTimeout = 0;
					if (expLst.Count == 0 || expLst.FirstOrDefault() == "None") return Task.FromResult<IEnumerable<Lines>>(new List<Lines>());
					var set = AddIncludes(includesLst, dbContext);
																							  ...
																							  List<string> includesLst = null, bool tracking = true)
        {
            try
            {
                ...
                {
                    dbContext.Database.CommandTimeout = 0;
                    if (string.IsNullOrEmpty(exp) || exp == "None") return new List<Lines>();
                    ...
                    foreach (var itm in navExp)
                    {
                        switch (itm.Key)
                        {
                            ...
                            case "ChildLines":
                                return
                                    await
                                        GetWhere<Lines>(dbContext, exp, itm.Value, "ChildLines", "Select", includesLst)
										.ConfigureAwait(continueOnCapturedContext: false);
                            ...
                            case "Fields":
                                return
                                    await
                                        GetWhere<Fields>(dbContext, exp, itm.Value, "Lines", "Select", includesLst)
										.ConfigureAwait(continueOnCapturedContext: false);
        ...
        public Task<IEnumerable<Lines>> GetLinesByBatch(string exp,
                                                        int totalrow, List<string> includesLst = null, bool tracking = true)
        {
            try
            {

                var res = new ConcurrentQueue<List<Lines>>();
        ...
        public Task<IEnumerable<Lines>> GetLinesByBatchExpressionLst(List<string> expLst,
                                                                     int totalrow, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
        ...
        public Task<Lines> UpdateLines(Lines entity)
        { 
            using ( var dbContext = new OCRContext(){StartTracking = StartTracking})
              {
                try
                {   
                     var res = (Lines) entity;
        ...
        public Task<Lines> CreateLines(Lines entity)
        {
            try
            {
                var res = (Lines) entity;
        ...
        public Task<bool> DeleteLines(string Id)
        {
            try
            {
              using ( var dbContext = new OCRContext(){StartTracking = StartTracking})
              {
                var i = Convert.ToInt32(Id);
                Lines entity = dbContext.Lines
													.SingleOrDefault(x => x.Id == i);
                if (entity == null)
                    return Task.FromResult(false);

                    dbContext.Lines.Attach(entity);
        ...
        public async Task<bool> RemoveSelectedLines(IEnumerable<string> lst)
        {
            try
            {
                StatusModel.StartStatusUpdate("Removing Lines", lst.Count());
                var t = Task.Run(() =>
                {
                    using (var ctx = new LinesService())
                    {
                        foreach (var item in lst.ToList())
                        {

                            ctx.DeleteLines(item).Wait();
         ...
         public Task<int> CountByExpressionLst(List<string> expLst)
        {
            try
            {
                using (var dbContext = new OCRContext(){StartTracking = StartTracking})
                {
                    ...
                    var set = (IQueryable<Lines>)dbContext.Lines; 
                    if (expLst.FirstOrDefault() == "All")
                    {
		...
		public Task<int> Count(string exp)
        {
            try
            {
                using (OCRContext dbContext = new OCRContext(){StartTracking = StartTracking})
                {
                    ...
                    if (exp == "All")
                    {
                        return Task.FromResult(dbContext.Lines
                            .AsNoTracking()
                            .Count());
                    }
                    else
        ...
        public Task<IEnumerable<Lines>> LoadRange(int startIndex, int count, string exp)
        {
            try
            {
                using (var dbContext = new OCRContext(){StartTracking = StartTracking})
                {
                    ...
                    if (exp == "All")
                    {
                        return Task.FromResult<IEnumerable<Lines>>(dbContext.Lines
                            .AsNoTracking()
                            .OrderBy(y => y.Id)
                            .Skip(startIndex)
                            .Take(count)
                        ...
                        switch (itm.Key)
                        {
                            ...
                            case "RegularExpressions":
                                return await CountWhere<RegularExpressions>(dbContext, exp, itm.Value, "Lines", "SelectMany")
											.ConfigureAwait(continueOnCapturedContext: false);
                            case "ChildLines":
                                return await CountWhere<Lines>(dbContext, exp, itm.Value, "ChildLines", "Select")
											.ConfigureAwait(continueOnCapturedContext: false);
                            case "ParentLine":
                            ...
                            case "FailedLines":
                                return await CountWhere<OCR_FailedLines>(dbContext, exp, itm.Value, "OCR_Lines", "Select")
											.ConfigureAwait(continueOnCapturedContext: false);
                            case "Fields":
                                return await CountWhere<Fields>(dbContext, exp, itm.Value, "Lines", "Select")
											.ConfigureAwait(continueOnCapturedContext: false);
						}
                    }
                    return dbContext.Lines.Where(exp == "All" || exp == null ? "Id != null" : exp)
											.AsNoTracking()
                                            .Count();
                }
		...
		private static Task<int> CountWhereSelectMany<T>(OCRContext dbContext, string exp, string navExp, string navProp) where T : class
        {
            ...
            return Task.FromResult(dbContext.Set<T>()
                .AsNoTracking()
                .Where(navExp)
                .SelectMany(navProp).OfType<Lines>()
                                                                                 ...
                                                                                 Dictionary<string, string> navExp, IEnumerable<string> includeLst = null)
        {
            try
            {
                ...
                {
                    dbContext.Database.CommandTimeout = 0;
                    if ((string.IsNullOrEmpty(exp) && navExp.Count == 0) || exp == "None") return new List<Lines>();
                    ...
                    foreach (var itm in navExp)
                    {
                        switch (itm.Key)
                        {
                            ...
                            case "ChildLines":
                                return
                                    await
                                        LoadRangeWhere<Lines>(startIndex, count, dbContext, exp, itm.Value, "ChildLines", "Select")
													.ConfigureAwait(continueOnCapturedContext: false);
                            ...
                            case "Fields":
                                return
                                    await
                                        LoadRangeWhere<Fields>(startIndex, count, dbContext, exp, itm.Value, "Lines", "Select")
													.ConfigureAwait(continueOnCapturedContext: false);
		...
		private static async Task<IEnumerable<Lines>> LoadRangeWhere<T>(int startIndex, int count,
		...
		private static Task<IEnumerable<Lines>> LoadRangeSelectMany<T>(int startIndex, int count,
                                                                       OCRContext dbContext, string exp, string navExp, string navProp, IEnumerable<string> includeLst = null) where T : class
        {
            ...
            return Task.FromResult<IEnumerable<Lines>>(set
                .Where(exp == "All" || exp == null ? "Id != null" : exp)
                .Distinct()
                .OrderBy(y => y.Id)
		...
		private static Task<IEnumerable<Lines>> LoadRangeSelect<T>(int startIndex, int count,
                                                                   OCRContext dbContext, string exp, string navExp, string navProp, IEnumerable<string> includeLst = null) where T : class
        {
			try
			{
        ...
        private static async Task<IEnumerable<Lines>> GetWhere<T>(OCRContext dbContext,
		...
		private static Task<IEnumerable<Lines>> GetWhereSelectMany<T>(OCRContext dbContext,
                                                                      string exp, string navExp, string navProp, List<string> includesLst = null) where T : class
        {
			...
			if (includesLst == null)
			{
				return Task.FromResult<IEnumerable<Lines>>(dbContext.Set<T>()
                    .AsNoTracking()
                    .Where(navExp)
                    .SelectMany(navProp).OfType<Lines>()
                    .Where(exp == "All" || exp == null?"Id != null":exp)
			...
			var set = (DbQuery<Lines>)dbContext.Set<T>()
				.AsNoTracking()
                .Where(navExp)
                .SelectMany(navProp).OfType<Lines>()
                .Where(exp == "All" || exp == null?"Id != null":exp)
            ...
            return Task.FromResult<IEnumerable<Lines>>(set.ToList());
			}
			catch (Exception)
			{
				Debugger.Break();
		...
		private static Task<IEnumerable<Lines>> GetWhereSelect<T>(OCRContext dbContext,
                                                                  string exp, string navExp, string navProp, List<string> includesLst = null) where T : class
        {
			try
			{
			...
			catch (Exception)
			{
				...
				throw;
			        ...
			        public Task<IEnumerable<Lines>> GetLinesByPartId(string PartId, List<string> includesLst = null)
        {
            try
            {
                using ( var dbContext = new OCRContext(){StartTracking = StartTracking})
              {
                ...
                var set = AddIncludes(includesLst, dbContext);
                IEnumerable<Lines> entities = set//dbContext.Lines
                                                    // .Include(x => x.ChildLines)									  
                                                    // .Include(x => x.FailedLines)									  
                                                    // .Include(x => x.Fields)									  
                                      .AsNoTracking()
            ...
            catch (Exception updateEx)
            {
 	        ...
 	        public Task<IEnumerable<Lines>> GetLinesByRegExId(string RegExId, List<string> includesLst = null)
        {
            try
            {
                using ( var dbContext = new OCRContext(){StartTracking = StartTracking})
            ...
            catch (Exception updateEx)
            {
 	        ...
 	        public Task<IEnumerable<Lines>> GetLinesByParentId(string ParentId, List<string> includesLst = null)
        {
            try
            {
                using ( var dbContext = new OCRContext(){StartTracking = StartTracking})
             ...
             try
             {
                 using (var dbContext = new OCRContext(){StartTracking = StartTracking})
                 {
					...
					decimal res = 0;
                     ...
                     if (whereExp == "All")
                     {
                          res = Convert.ToDecimal(dbContext.Lines.AsNoTracking().Sum(field));
                     }
                     else
                     {
                         res = Convert.ToDecimal(dbContext.Lines.AsNoTracking().Where(whereExp).Sum(field));
                     }
        ...
        public async Task<decimal> SumNav( string exp, Dictionary<string, string> navExp, string field)
        {
            try
            {
                ...
                {
                    dbContext.Database.CommandTimeout = 0;
                    if (!dbContext.Lines.Any()) return 0;
                    if (exp == "All" && navExp.Count == 0)
                    {
                        return Convert.ToDecimal(dbContext.Lines
										.AsNoTracking()
                                        .Sum(field)??0);
                    }
                    foreach (var itm in navExp)
                        ...
                        switch (itm.Key)
                        {
                            ...
                            case "RegularExpressions":
                                return await SumWhere<RegularExpressions>(dbContext, exp, itm.Value, "Lines", field, "SelectMany")
											.ConfigureAwait(continueOnCapturedContext: false);
                            case "ChildLines":
                                return await SumWhere<Lines>(dbContext, exp, itm.Value, "ChildLines", field, "Select")
											.ConfigureAwait(continueOnCapturedContext: false);
                            case "ParentLine":
                            ...
                            case "FailedLines":
                                return await SumWhere<OCR_FailedLines>(dbContext, exp, itm.Value, "OCR_Lines", field, "Select")
											.ConfigureAwait(continueOnCapturedContext: false);
                            case "Fields":
                                return await SumWhere<Fields>(dbContext, exp, itm.Value, "Lines", field, "Select")
											.ConfigureAwait(continueOnCapturedContext: false);
						}
                    }
                    return Convert.ToDecimal(dbContext.Lines.Where(exp == "All" || exp == null ? "Id != null" : exp)
											.AsNoTracking()
                                            .Sum(field)??0);
                }
             ...
             try
             {
                 using (var dbContext = new OCRContext(){StartTracking = StartTracking})
                 {
					...
					string res = "";
                     ...
                     if (whereExp == "All")
                     {
                          res = Convert.ToString(dbContext.Lines.AsNoTracking().Min(field));
                     }
                     else
                     {
                         res = Convert.ToString(dbContext.Lines.AsNoTracking().Where(whereExp).Min(field));
                     }
		...
		private static IQueryable<Lines> AddIncludes(IEnumerable<string> includesLst, OCRContext dbContext)
       {
		 try
			{
			   if (includesLst == null) includesLst = new List<string>();
			   var set =(DbQuery<Lines>) dbContext.Lines; 
	   ...
	   private IQueryable<Lines> AddWheres(List<string> expLst, IQueryable<Lines> set)
        {
            try
            {
