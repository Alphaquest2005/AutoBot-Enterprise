...
{
   [Export (typeof(IOCRCorrectionLearningService))]
   [Export(typeof(IBusinessService))]
   [PartCreationPolicy(CreationPolicy.NonShared)]
   [ServiceBehavior(InstanceContextMode = InstanceContextMode.PerCall,
                    ConcurrencyMode = ConcurrencyMode.Multiple)]
   
    public partial class OCRCorrectionLearningService : IOCRCorrectionLearningService, IDisposable
    {
        //private readonly OCRContext dbContext;

        public bool StartTracking { get; set; }

        public OCRCorrectionLearningService()
        {
            try
            {
        ...
        public async Task<IEnumerable<OCRCorrectionLearning>> GetOCRCorrectionLearning(List<string> includesLst = null, bool tracking = true)
        {
            try
            {
            //using (var scope = new TransactionScope(TransactionScopeOption.Required,
               ...
               // {
                  using ( var dbContext = new OCRContext(){StartTracking = StartTracking})
                  {
                    ...
                    IEnumerable<OCRCorrectionLearning> entities = set.AsNoTracking().ToList();
                           //scope.Complete();
        ...
        public async Task<OCRCorrectionLearning> GetOCRCorrectionLearningByKey(string Id, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
              ...
              using ( var dbContext = new OCRContext(){StartTracking = StartTracking})
              {
				...
				var set = AddIncludes(includesLst, dbContext);
                OCRCorrectionLearning entity = set.AsNoTracking().SingleOrDefault(x => x.Id == i);
		 ...
		 public async Task<IEnumerable<OCRCorrectionLearning>> GetOCRCorrectionLearningByExpression(string exp, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
                using (var dbContext = new OCRContext(){StartTracking = StartTracking})
                {
					...
					if (string.IsNullOrEmpty(exp) || exp == "None") return new List<OCRCorrectionLearning>();
					var set = AddIncludes(includesLst, dbContext);
                    if (exp == "All")
                    {
		 ...
		 public async Task<IEnumerable<OCRCorrectionLearning>> GetOCRCorrectionLearningByExpressionLst(List<string> expLst, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
                using (var dbContext = new OCRContext(){StartTracking = StartTracking})
                {
                    dbContext.Database.CommandTimeout = 0;
					if (expLst.Count == 0 || expLst.FirstOrDefault() == "None") return new List<OCRCorrectionLearning>();
					var set = AddIncludes(includesLst, dbContext);
		...
		public async Task<IEnumerable<OCRCorrectionLearning>> GetOCRCorrectionLearningByExpressionNav(string exp,
        ...
        public async Task<IEnumerable<OCRCorrectionLearning>> GetOCRCorrectionLearningByBatch(string exp,
            int totalrow, List<string> includesLst = null, bool tracking = true)
        {
            try
            {

                var res = new ConcurrentQueue<List<OCRCorrectionLearning>>();
                    ...
                    //  for (int bat = 0; bat < batches; bat++)
                    {
                        try
                        {
                            using (var dbContext = new OCRContext(){StartTracking = StartTracking})
                            {
                                ...
                                var set = AddIncludes(includesLst, dbContext);
                                IQueryable<OCRCorrectionLearning> dset;
                                if (exp == "All")
                                {
        ...
        public async Task<IEnumerable<OCRCorrectionLearning>> GetOCRCorrectionLearningByBatchExpressionLst(List<string> expLst,
            int totalrow, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
            ...
            using ( var dbContext = new OCRContext(){StartTracking = StartTracking})
              {
                try
                {   
                     var res = (OCRCorrectionLearning) entity;
        ...
        public async Task<OCRCorrectionLearning> CreateOCRCorrectionLearning(OCRCorrectionLearning entity)
        {
            try
            {
              ...
              using ( var dbContext = new OCRContext(){StartTracking = StartTracking})
              {
                dbContext.OCRCorrectionLearning.Add(res);
                dbContext.SaveChanges();
                res.AcceptChanges();
                return res;
              }
        ...
        public async Task<bool> DeleteOCRCorrectionLearning(string Id)
        {
            try
            {
              ...
              {
                var i = Convert.ToInt32(Id);
                OCRCorrectionLearning entity = dbContext.OCRCorrectionLearning
													.SingleOrDefault(x => x.Id == i);
                if (entity == null)
                    return false;

                    dbContext.OCRCorrectionLearning.Attach(entity);
                    dbContext.OCRCorrectionLearning.Remove(entity);
                    dbContext.SaveChanges();
                    return true;
              }
            }
        ...
        public async Task<bool> RemoveSelectedOCRCorrectionLearning(IEnumerable<string> lst)
        {
            try
            {
                StatusModel.StartStatusUpdate("Removing OCRCorrectionLearning", lst.Count());
                var t = Task.Run(() =>
                {
                    using (var ctx = new OCRCorrectionLearningService())
                    {
                        foreach (var item in lst.ToList())
                        {

                            ctx.DeleteOCRCorrectionLearning(item).Wait();
         ...
         public async Task<int> CountByExpressionLst(List<string> expLst)
        {
            try
            {
                using (var dbContext = new OCRContext(){StartTracking = StartTracking})
                {
                    ...
                    var set = (IQueryable<OCRCorrectionLearning>)dbContext.OCRCorrectionLearning; 
                    if (expLst.FirstOrDefault() == "All")
                    {
		...
		public async Task<int> Count(string exp)
        {
            try
            {
                using (OCRContext dbContext = new OCRContext(){StartTracking = StartTracking})
                {
                    ...
                    if (exp == "All")
                    {
                        return dbContext.OCRCorrectionLearning
                                    .AsNoTracking()
									.Count();
                    }
                    else
        ...
        public async Task<IEnumerable<OCRCorrectionLearning>> LoadRange(int startIndex, int count, string exp)
        {
            try
            {
                using (var dbContext = new OCRContext(){StartTracking = StartTracking})
		...
		public async Task<int> CountNav(string exp, Dictionary<string, string> navExp)
        {
            try
            {
                ...
                using (var dbContext = new OCRContext(){StartTracking = StartTracking})
                {
                    ...
                    return dbContext.OCRCorrectionLearning.Where(exp == "All" || exp == null ? "Id != null" : exp)
											.AsNoTracking()
                                            .Count();
                }
		...
		private static async Task<int> CountWhereSelectMany<T>(OCRContext dbContext, string exp, string navExp, string navProp) where T : class
        {
            ...
            return dbContext.Set<T>()
				.AsNoTracking()
                .Where(navExp)
                .SelectMany(navProp).OfType<OCRCorrectionLearning>()
		...
		private static async Task<int> CountWhereSelect<T>(OCRContext dbContext, string exp, string navExp, string navProp) where T : class
        {
            ...
            return dbContext.Set<T>()
				.AsNoTracking()
                .Where(navExp)
                .Select(navProp).OfType<OCRCorrectionLearning>()
                .Where(exp == "All" || exp == null ? "Id != null" : exp)
                .Distinct()
                .OrderBy("Id")
                .Count();
		  ...
		  public async Task<IEnumerable<OCRCorrectionLearning>> LoadRangeNav(int startIndex, int count, string exp,
                                                                                 Dictionary<string, string> navExp, IEnumerable<string> includeLst = null)
        {
            try
            {
                ...
                {
                    dbContext.Database.CommandTimeout = 0;
                    if ((string.IsNullOrEmpty(exp) && navExp.Count == 0) || exp == "None") return new List<OCRCorrectionLearning>();
                    ...
                    return set//dbContext.OCRCorrectionLearning
								.AsNoTracking()
                                .Where(exp == "All" || exp == null ? "Id != null" : exp)
								.OrderBy(y => y.Id)
		...
		private static async Task<IEnumerable<OCRCorrectionLearning>> LoadRangeWhere<T>(int startIndex, int count,
		...
		private static async Task<IEnumerable<OCRCorrectionLearning>> LoadRangeSelectMany<T>(int startIndex, int count,
		...
		private static async Task<IEnumerable<OCRCorrectionLearning>> LoadRangeSelect<T>(int startIndex, int count,
            OCRContext dbContext, string exp, string navExp, string navProp, IEnumerable<string> includeLst = null) where T : class
        {
			try
			{
        ...
        private static async Task<IEnumerable<OCRCorrectionLearning>> GetWhere<T>(OCRContext dbContext,
		...
		private static async Task<IEnumerable<OCRCorrectionLearning>> GetWhereSelectMany<T>(OCRContext dbContext,
            string exp, string navExp, string navProp, List<string> includesLst = null) where T : class
        {
			...
			var set = (DbQuery<OCRCorrectionLearning>)dbContext.Set<T>()
				.AsNoTracking()
                .Where(navExp)
                .SelectMany(navProp).OfType<OCRCorrectionLearning>()
                .Where(exp == "All" || exp == null?"Id != null":exp)
		...
		private static async Task<IEnumerable<OCRCorrectionLearning>> GetWhereSelect<T>(OCRContext dbContext,
            string exp, string navExp, string navProp, List<string> includesLst = null) where T : class
        {
			try
			{
             ...
             try
             {
                 using (var dbContext = new OCRContext(){StartTracking = StartTracking})
                 {
					...
					decimal res = 0;
                     ...
                     if (whereExp == "All")
                     {
                          res = Convert.ToDecimal(dbContext.OCRCorrectionLearning.AsNoTracking().Sum(field));
                     }
                     else
                     {
                         res = Convert.ToDecimal(dbContext.OCRCorrectionLearning.AsNoTracking().Where(whereExp).Sum(field));
                     }
        ...
        public async Task<decimal> SumNav( string exp, Dictionary<string, string> navExp, string field)
        {
            try
            {
                ...
                {
                    dbContext.Database.CommandTimeout = 0;
                    if (!dbContext.OCRCorrectionLearning.Any()) return 0;
                    if (exp == "All" && navExp.Count == 0)
                    {
                        return Convert.ToDecimal(dbContext.OCRCorrectionLearning
										.AsNoTracking()
                                        .Sum(field)??0);
                    }
                    return Convert.ToDecimal(dbContext.OCRCorrectionLearning.Where(exp == "All" || exp == null ? "Id != null" : exp)
											.AsNoTracking()
                                            .Sum(field)??0);
                }
             ...
             try
             {
                 using (var dbContext = new OCRContext(){StartTracking = StartTracking})
                 {
					...
					string res = "";
                     ...
                     if (whereExp == "All")
                     {
                          res = Convert.ToString(dbContext.OCRCorrectionLearning.AsNoTracking().Min(field));
                     }
                     else
                     {
                         res = Convert.ToString(dbContext.OCRCorrectionLearning.AsNoTracking().Where(whereExp).Min(field));
                     }
		...
		private static IQueryable<OCRCorrectionLearning> AddIncludes(IEnumerable<string> includesLst, OCRContext dbContext)
       {
		 try
			{
			   if (includesLst == null) includesLst = new List<string>();
			   var set =(DbQuery<OCRCorrectionLearning>) dbContext.OCRCorrectionLearning; 
	   ...
	   private IQueryable<OCRCorrectionLearning> AddWheres(List<string> expLst, IQueryable<OCRCorrectionLearning> set)
        {
            try
            {
