...
namespace OCR.Business.Services
{
   ...
   [ServiceBehavior(InstanceContextMode = InstanceContextMode.PerCall,
    ...
    public partial class InvoiceService : IInvoiceService, IDisposable
    {
        ...
        public async Task<IEnumerable<Invoice>> GetInvoiceExs(List<string> includesLst = null, bool tracking = true)
        {
            try
            {
            //using (var scope = new TransactionScope(TransactionScopeOption.Required,
               ...
               // {
                  using ( var dbContext = new OCRContext(){StartTracking = StartTracking})
                  {
                    ...
                    IEnumerable<Invoice> entities = await set.AsNoTracking().ToListAsync()
        ...
        public async Task<Invoice> GetInvoiceByKey(string Id, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
              ...
              using ( var dbContext = new OCRContext(){StartTracking = StartTracking})
              {
				...
				var set = AddIncludes(includesLst, dbContext);
                Invoice entity = await set.AsNoTracking().SingleOrDefaultAsync(x => x.Id == i).ConfigureAwait(continueOnCapturedContext: false);
		 ...
		 public async Task<IEnumerable<Invoice>> GetInvoiceExsByExpression(string exp, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
                using (var dbContext = new OCRContext(){StartTracking = StartTracking})
                {
					...
					if (string.IsNullOrEmpty(exp) || exp == "None") return new List<Invoice>();
					var set = AddIncludes(includesLst, dbContext);
                    if (exp == "All")
                    {
		 ...
		 public async Task<IEnumerable<Invoice>> GetInvoiceExsByExpressionLst(List<string> expLst, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
                using (var dbContext = new OCRContext(){StartTracking = StartTracking})
                {
                    dbContext.Database.CommandTimeout = 0;
					if (expLst.Count == 0 || expLst.FirstOrDefault() == "None") return new List<Invoice>();
					var set = AddIncludes(includesLst, dbContext);
		...
		public async Task<IEnumerable<Invoice>> GetInvoiceExsByExpressionNav(string exp,
                    ...
                    foreach (var itm in navExp)
                    {
                        switch (itm.Key)
                        {
                            case "Parts":
                                return
                                    await
                                        GetWhere<Part>(dbContext, exp, itm.Value, "Invoice", "Select", includesLst)
										.ConfigureAwait(continueOnCapturedContext: false);
        ...
        public async Task<IEnumerable<Invoice>> GetInvoiceExsByBatch(string exp,
            int totalrow, List<string> includesLst = null, bool tracking = true)
        {
            try
            {

                var res = new ConcurrentQueue<List<Invoice>>();
        ...
        public async Task<IEnumerable<Invoice>> GetInvoiceExsByBatchExpressionLst(List<string> expLst,
            int totalrow, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
        ...
        public async Task<bool> DeleteInvoice(string Id)
        {
            try
            {
              ...
              {
                var i = Convert.ToInt32(Id);
                Invoice entity = await dbContext.InvoiceExs
													.SingleOrDefaultAsync(x => x.Id == i)
													.ConfigureAwait(continueOnCapturedContext: false);
                if (entity == null)
                    return false;

                    dbContext.InvoiceExs.Attach(entity);
                    dbContext.InvoiceExs.Remove(entity);
                    await dbContext.SaveChangesAsync().ConfigureAwait(continueOnCapturedContext: false);
                    return true;
              }
            }
        ...
        public async Task<bool> RemoveSelectedInvoice(IEnumerable<string> lst)
        {
            try
            {
                StatusModel.StartStatusUpdate("Removing Invoice", lst.Count());
                var t = Task.Run(() =>
                {
                    using (var ctx = new InvoiceService())
                    {
                        foreach (var item in lst.ToList())
                        {

                            ctx.DeleteInvoice(item).Wait();
         ...
         public async Task<int> CountByExpressionLst(List<string> expLst)
        {
            try
            {
                using (var dbContext = new OCRContext(){StartTracking = StartTracking})
                {
                    ...
                    var set = (IQueryable<Invoice>)dbContext.InvoiceExs; 
                    if (expLst.FirstOrDefault() == "All")
                    {
		...
		public async Task<int> Count(string exp)
        {
            try
            {
                using (OCRContext dbContext = new OCRContext(){StartTracking = StartTracking})
                {
                    ...
                    if (exp == "All")
                    {
                        return await dbContext.InvoiceExs
                                    .AsNoTracking()
									.CountAsync()
									.ConfigureAwait(continueOnCapturedContext: false);
                    }
        ...
        public async Task<IEnumerable<Invoice>> LoadRange(int startIndex, int count, string exp)
        {
            try
            {
                using (var dbContext = new OCRContext(){StartTracking = StartTracking})
            ...
            try
            {
                ...
                using (var dbContext = new OCRContext(){StartTracking = StartTracking})
                {
                    ...
                    foreach (var itm in navExp)
                    {
                        ...
                        {
                            case "Parts":
                                return await CountWhere<Part>(dbContext, exp, itm.Value, "Invoice", "Select")
											.ConfigureAwait(continueOnCapturedContext: false);
						}
                    }
                    return await dbContext.InvoiceExs.Where(exp == "All" || exp == null ? "Id != null" : exp)
											.AsNoTracking()
                                            .CountAsync()
											.ConfigureAwait(continueOnCapturedContext: false);
                }
		...
		private static async Task<int> CountWhereSelectMany<T>(OCRContext dbContext, string exp, string navExp, string navProp) where T : class
        {
            ...
            return await dbContext.Set<T>()
				.AsNoTracking()
                .Where(navExp)
                .SelectMany(navProp).OfType<Invoice>()
		...
		private static async Task<int> CountWhereSelect<T>(OCRContext dbContext, string exp, string navExp, string navProp) where T : class
        {
		  ...
		  public async Task<IEnumerable<Invoice>> LoadRangeNav(int startIndex, int count, string exp,
                                                                                 Dictionary<string, string> navExp, IEnumerable<string> includeLst = null)
        {
            try
            {
                ...
                {
                    dbContext.Database.CommandTimeout = 0;
                    if ((string.IsNullOrEmpty(exp) && navExp.Count == 0) || exp == "None") return new List<Invoice>();
                    ...
                    foreach (var itm in navExp)
                    {
                        switch (itm.Key)
                        {
                            case "Parts":
                                return
                                    await
                                        LoadRangeWhere<Part>(startIndex, count, dbContext, exp, itm.Value, "Invoice", "Select")
													.ConfigureAwait(continueOnCapturedContext: false);
                    ...
                    return await set//dbContext.InvoiceExs
								.AsNoTracking()
                                .Where(exp == "All" || exp == null ? "Id != null" : exp)
								.OrderBy(y => y.Id)
		...
		private static async Task<IEnumerable<Invoice>> LoadRangeWhere<T>(int startIndex, int count,
		...
		private static async Task<IEnumerable<Invoice>> LoadRangeSelectMany<T>(int startIndex, int count,
		...
		private static async Task<IEnumerable<Invoice>> LoadRangeSelect<T>(int startIndex, int count,
            OCRContext dbContext, string exp, string navExp, string navProp, IEnumerable<string> includeLst = null) where T : class
        {
			try
			{
        ...
        private static async Task<IEnumerable<Invoice>> GetWhere<T>(OCRContext dbContext,
		...
		private static async Task<IEnumerable<Invoice>> GetWhereSelectMany<T>(OCRContext dbContext,
            string exp, string navExp, string navProp, List<string> includesLst = null) where T : class
        {
			...
			var set = (DbQuery<Invoice>)dbContext.Set<T>()
				.AsNoTracking()
                .Where(navExp)
                .SelectMany(navProp).OfType<Invoice>()
                .Where(exp == "All" || exp == null?"Id != null":exp)
		...
		private static async Task<IEnumerable<Invoice>> GetWhereSelect<T>(OCRContext dbContext,
            string exp, string navExp, string navProp, List<string> includesLst = null) where T : class
        {
			try
			{
			        ...
			        public async Task<IEnumerable<Invoice>> GetInvoiceByFileTypeId(string FileTypeId, List<string> includesLst = null)
        {
            try
            {
                using ( var dbContext = new OCRContext(){StartTracking = StartTracking})
              {
                ...
                var set = AddIncludes(includesLst, dbContext);
                IEnumerable<Invoice> entities = await set//dbContext.InvoiceExs
                                                    // .Include(x => x.Parts)									  
                                      .AsNoTracking()
             ...
             try
             {
                 using (var dbContext = new OCRContext(){StartTracking = StartTracking})
                 {
					...
					decimal res = 0;
                     ...
                     if (whereExp == "All")
                     {
                          res = Convert.ToDecimal(dbContext.InvoiceExs.AsNoTracking().Sum(field));
                     }
                     else
                     {
                         res = Convert.ToDecimal(dbContext.InvoiceExs.AsNoTracking().Where(whereExp).Sum(field));
                     }
        ...
        public async Task<decimal> SumNav( string exp, Dictionary<string, string> navExp, string field)
        {
            try
            {
                ...
                {
                    dbContext.Database.CommandTimeout = 0;
                    if (!dbContext.InvoiceExs.Any()) return 0;
                    if (exp == "All" && navExp.Count == 0)
                    {
                        return Convert.ToDecimal(dbContext.InvoiceExs
										.AsNoTracking()
                                        .Sum(field)??0);
                    }
                    foreach (var itm in navExp)
                    {
                        ...
                        {
                            case "Parts":
                                return await SumWhere<Part>(dbContext, exp, itm.Value, "Invoice", field, "Select")
											.ConfigureAwait(continueOnCapturedContext: false);
						}
                    }
                    return Convert.ToDecimal(dbContext.InvoiceExs.Where(exp == "All" || exp == null ? "Id != null" : exp)
											.AsNoTracking()
                                            .Sum(field)??0);
                }
             ...
             try
             {
                 using (var dbContext = new OCRContext(){StartTracking = StartTracking})
                 {
					...
					string res = "";
                     ...
                     if (whereExp == "All")
                     {
                          res = Convert.ToString(dbContext.InvoiceExs.AsNoTracking().Min(field));
                     }
                     else
                     {
                         res = Convert.ToString(dbContext.InvoiceExs.AsNoTracking().Where(whereExp).Min(field));
                     }
		...
		private static IQueryable<Invoice> AddIncludes(IEnumerable<string> includesLst, OCRContext dbContext)
       {
		 try
			{
			   if (includesLst == null) includesLst = new List<string>();
			   var set =(DbQuery<Invoice>) dbContext.InvoiceExs; 
	   ...
	   private IQueryable<Invoice> AddWheres(List<string> expLst, IQueryable<Invoice> set)
        {
            try
            {
