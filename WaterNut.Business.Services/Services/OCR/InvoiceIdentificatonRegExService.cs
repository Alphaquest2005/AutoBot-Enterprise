...
namespace OCR.Business.Services
{
   ...
   [ServiceBehavior(InstanceContextMode = InstanceContextMode.PerCall,
    ...
    public partial class InvoiceIdentificatonRegExService : IInvoiceIdentificatonRegExService, IDisposable
    {
        ...
        public Task<IEnumerable<InvoiceIdentificatonRegEx>> GetInvoiceIdentificatonRegEx(List<string> includesLst = null, bool tracking = true)
        {
            try
            {
            //using (var scope = new TransactionScope(TransactionScopeOption.Required,
               ...
               // {
                  using ( var dbContext = new OCRContext(){StartTracking = StartTracking})
                  {
                    ...
                    IEnumerable<InvoiceIdentificatonRegEx> entities = set.AsNoTracking().ToList();
                           //scope.Complete();
        ...
        public Task<InvoiceIdentificatonRegEx> GetInvoiceIdentificatonRegExByKey(string Id, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
			   if(string.IsNullOrEmpty(Id))return Task.FromResult<InvoiceIdentificatonRegEx>(null); 
              using ( var dbContext = new OCRContext(){StartTracking = StartTracking})
              {
                var i = Convert.ToInt32(Id);
				var set = AddIncludes(includesLst, dbContext);
                InvoiceIdentificatonRegEx entity = set.AsNoTracking().SingleOrDefault(x => x.Id == i);
		 ...
		 public Task<IEnumerable<InvoiceIdentificatonRegEx>> GetInvoiceIdentificatonRegExByExpression(string exp, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
                using (var dbContext = new OCRContext(){StartTracking = StartTracking})
                {
					...
					if (string.IsNullOrEmpty(exp) || exp == "None") return Task.FromResult<IEnumerable<InvoiceIdentificatonRegEx>>(new List<InvoiceIdentificatonRegEx>());
					var set = AddIncludes(includesLst, dbContext);
                    if (exp == "All")
                    {
                        ...
                        if(tracking) entities.AsParallel(new ParallelLinqOptions() { MaxDegreeOfParallelism = Environment.ProcessorCount }).ForAll(x => x.StartTracking());
                        return Task.FromResult<IEnumerable<InvoiceIdentificatonRegEx>>(entities); 
                    }
					else
					{
		 ...
		 public Task<IEnumerable<InvoiceIdentificatonRegEx>> GetInvoiceIdentificatonRegExByExpressionLst(List<string> expLst, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
                using (var dbContext = new OCRContext(){StartTracking = StartTracking})
                {
                    dbContext.Database.CommandTimeout = 0;
					if (expLst.Count == 0 || expLst.FirstOrDefault() == "None") return Task.FromResult<IEnumerable<InvoiceIdentificatonRegEx>>(new List<InvoiceIdentificatonRegEx>());
					var set = AddIncludes(includesLst, dbContext);
        ...
        public Task<IEnumerable<InvoiceIdentificatonRegEx>> GetInvoiceIdentificatonRegExByBatch(string exp,
        ...
        public Task<IEnumerable<InvoiceIdentificatonRegEx>> GetInvoiceIdentificatonRegExByBatchExpressionLst(List<string> expLst,
                                                                                                             int totalrow, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
        ...
        public Task<InvoiceIdentificatonRegEx> UpdateInvoiceIdentificatonRegEx(InvoiceIdentificatonRegEx entity)
        { 
            using ( var dbContext = new OCRContext(){StartTracking = StartTracking})
              {
                try
        ...
        public Task<InvoiceIdentificatonRegEx> CreateInvoiceIdentificatonRegEx(InvoiceIdentificatonRegEx entity)
        {
            try
            {
                var res = (InvoiceIdentificatonRegEx) entity;
        ...
        public Task<bool> DeleteInvoiceIdentificatonRegEx(string Id)
        {
            try
            {
              using ( var dbContext = new OCRContext(){StartTracking = StartTracking})
              {
                var i = Convert.ToInt32(Id);
                InvoiceIdentificatonRegEx entity = dbContext.InvoiceIdentificatonRegEx
		...
		public Task<int> Count(string exp)
        {
            try
            {
                using (OCRContext dbContext = new OCRContext(){StartTracking = StartTracking})
                {
                    ...
                    if (exp == "All")
                    {
                        return Task.FromResult(dbContext.InvoiceIdentificatonRegEx
                            .AsNoTracking()
                            .Count());
                    }
                    else
        ...
        public Task<IEnumerable<InvoiceIdentificatonRegEx>> LoadRange(int startIndex, int count, string exp)
        {
            try
            {
                using (var dbContext = new OCRContext(){StartTracking = StartTracking})
                {
                    ...
                    if (exp == "All")
                    {
                        return Task.FromResult<IEnumerable<InvoiceIdentificatonRegEx>>(dbContext.InvoiceIdentificatonRegEx
                            .AsNoTracking()
                            .OrderBy(y => y.Id)
                            .Skip(startIndex)
                            .Take(count)
		...
		public async Task<int> CountNav(string exp, Dictionary<string, string> navExp)
        {
            try
            {
                ...
                using (var dbContext = new OCRContext(){StartTracking = StartTracking})
                {
                    ...
                    if (exp == "All" && navExp.Count == 0)
                    {
                        return dbContext.InvoiceIdentificatonRegEx
										.AsNoTracking()
                                        .Count();
                    }
                    foreach (var itm in navExp)
                    ...
                    return dbContext.InvoiceIdentificatonRegEx.Where(exp == "All" || exp == null ? "Id != null" : exp)
											.AsNoTracking()
                                            .Count();
                }
                                                                                 ...
                                                                                 Dictionary<string, string> navExp, IEnumerable<string> includeLst = null)
        {
            try
            {
                using (var dbContext = new OCRContext(){StartTracking = StartTracking})
                {
                    ...
                    return set//dbContext.InvoiceIdentificatonRegEx
								.AsNoTracking()
                                .Where(exp == "All" || exp == null ? "Id != null" : exp)
								.OrderBy(y => y.Id)
		...
		private static Task<IEnumerable<InvoiceIdentificatonRegEx>> LoadRangeSelectMany<T>(int startIndex, int count,
                                                                                           OCRContext dbContext, string exp, string navExp, string navProp, IEnumerable<string> includeLst = null) where T : class
        {
            ...
            return Task.FromResult<IEnumerable<InvoiceIdentificatonRegEx>>(set
                .Where(exp == "All" || exp == null ? "Id != null" : exp)
                .Distinct()
                .OrderBy(y => y.Id)
		...
		private static Task<IEnumerable<InvoiceIdentificatonRegEx>> LoadRangeSelect<T>(int startIndex, int count,
                                                                                       OCRContext dbContext, string exp, string navExp, string navProp, IEnumerable<string> includeLst = null) where T : class
        {
			try
			{
		...
		private static Task<IEnumerable<InvoiceIdentificatonRegEx>> GetWhereSelectMany<T>(OCRContext dbContext,
                                                                                          string exp, string navExp, string navProp, List<string> includesLst = null) where T : class
        {
			...
			if (includesLst == null)
			{
				return Task.FromResult<IEnumerable<InvoiceIdentificatonRegEx>>(dbContext.Set<T>()
                    .AsNoTracking()
                    .Where(navExp)
                    .SelectMany(navProp).OfType<InvoiceIdentificatonRegEx>()
                    .Where(exp == "All" || exp == null?"Id != null":exp)
            ...
            return Task.FromResult<IEnumerable<InvoiceIdentificatonRegEx>>(set.ToList());
			}
			catch (Exception)
			{
				Debugger.Break();
		...
		private static Task<IEnumerable<InvoiceIdentificatonRegEx>> GetWhereSelect<T>(OCRContext dbContext,
                                                                                      string exp, string navExp, string navProp, List<string> includesLst = null) where T : class
        {
			try
			{
			...
			catch (Exception)
			{
				...
				throw;
			        ...
			        public Task<IEnumerable<InvoiceIdentificatonRegEx>> GetInvoiceIdentificatonRegExByInvoiceId(string InvoiceId, List<string> includesLst = null)
        {
            try
            {
                using ( var dbContext = new OCRContext(){StartTracking = StartTracking})
              {
                ...
                var set = AddIncludes(includesLst, dbContext);
                IEnumerable<InvoiceIdentificatonRegEx> entities = set//dbContext.InvoiceIdentificatonRegEx
                                      .AsNoTracking()
            ...
            catch (Exception updateEx)
            {
 	        ...
 	        public Task<IEnumerable<InvoiceIdentificatonRegEx>> GetInvoiceIdentificatonRegExByRegExId(string RegExId, List<string> includesLst = null)
        {
            try
            {
                using ( var dbContext = new OCRContext(){StartTracking = StartTracking})
