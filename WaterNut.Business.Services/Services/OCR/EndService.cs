...
namespace OCR.Business.Services
{
   ...
   [ServiceBehavior(InstanceContextMode = InstanceContextMode.PerCall,
    ...
    public partial class EndService : IEndService, IDisposable
    {
        ...
        public Task<IEnumerable<End>> GetEnd(List<string> includesLst = null, bool tracking = true)
        {
            try
            {
        ...
        public Task<End> GetEndByKey(string Id, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
			   if(string.IsNullOrEmpty(Id))return Task.FromResult<End>(null); 
              using ( var dbContext = new OCRContext(){StartTracking = StartTracking})
              {
		 ...
		 public Task<IEnumerable<End>> GetEndByExpression(string exp, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
                using (var dbContext = new OCRContext(){StartTracking = StartTracking})
                {
					...
					if (string.IsNullOrEmpty(exp) || exp == "None") return Task.FromResult<IEnumerable<End>>(new List<End>());
					var set = AddIncludes(includesLst, dbContext);
                    if (exp == "All")
                    {
                        ...
                        if(tracking) entities.AsParallel(new ParallelLinqOptions() { MaxDegreeOfParallelism = Environment.ProcessorCount }).ForAll(x => x.StartTracking());
                        return Task.FromResult<IEnumerable<End>>(entities); 
                    }
					else
					{
		 ...
		 public Task<IEnumerable<End>> GetEndByExpressionLst(List<string> expLst, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
                using (var dbContext = new OCRContext(){StartTracking = StartTracking})
                {
                    dbContext.Database.CommandTimeout = 0;
					if (expLst.Count == 0 || expLst.FirstOrDefault() == "None") return Task.FromResult<IEnumerable<End>>(new List<End>());
					var set = AddIncludes(includesLst, dbContext);
        ...
        public Task<IEnumerable<End>> GetEndByBatch(string exp,
        ...
        public Task<IEnumerable<End>> GetEndByBatchExpressionLst(List<string> expLst,
                                                                 int totalrow, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
        ...
        public Task<End> UpdateEnd(End entity)
        { 
            using ( var dbContext = new OCRContext(){StartTracking = StartTracking})
              {
                try
        ...
        public Task<End> CreateEnd(End entity)
        {
            try
            {
                var res = (End) entity;
        ...
        public Task<bool> DeleteEnd(string Id)
        {
            try
            {
              using ( var dbContext = new OCRContext(){StartTracking = StartTracking})
		...
		public Task<int> Count(string exp)
        {
            try
            {
                using (OCRContext dbContext = new OCRContext(){StartTracking = StartTracking})
                {
                    ...
                    if (exp == "All")
                    {
                        return Task.FromResult(dbContext.End
                            .AsNoTracking()
                            .Count());
                    }
                    else
        ...
        public Task<IEnumerable<End>> LoadRange(int startIndex, int count, string exp)
        {
            try
            {
                using (var dbContext = new OCRContext(){StartTracking = StartTracking})
                {
                    ...
                    if (exp == "All")
                    {
                        return Task.FromResult<IEnumerable<End>>(dbContext.End
                            .AsNoTracking()
                            .OrderBy(y => y.Id)
                            .Skip(startIndex)
                            .Take(count)
		...
		private static Task<IEnumerable<End>> LoadRangeSelectMany<T>(int startIndex, int count,
                                                                     OCRContext dbContext, string exp, string navExp, string navProp, IEnumerable<string> includeLst = null) where T : class
        {
            ...
            return Task.FromResult<IEnumerable<End>>(set
                .Where(exp == "All" || exp == null ? "Id != null" : exp)
                .Distinct()
                .OrderBy(y => y.Id)
		...
		private static Task<IEnumerable<End>> LoadRangeSelect<T>(int startIndex, int count,
                                                                 OCRContext dbContext, string exp, string navExp, string navProp, IEnumerable<string> includeLst = null) where T : class
        {
			try
			{
		...
		private static Task<IEnumerable<End>> GetWhereSelectMany<T>(OCRContext dbContext,
                                                                    string exp, string navExp, string navProp, List<string> includesLst = null) where T : class
        {
			...
			if (includesLst == null)
			{
				return Task.FromResult<IEnumerable<End>>(dbContext.Set<T>()
                    .AsNoTracking()
                    .Where(navExp)
                    .SelectMany(navProp).OfType<End>()
                    .Where(exp == "All" || exp == null?"Id != null":exp)
            ...
            return Task.FromResult<IEnumerable<End>>(set.ToList());
			}
			catch (Exception)
			{
				Debugger.Break();
		...
		private static Task<IEnumerable<End>> GetWhereSelect<T>(OCRContext dbContext,
                                                                string exp, string navExp, string navProp, List<string> includesLst = null) where T : class
        {
			try
			{
			...
			catch (Exception)
			{
				...
				throw;
			        ...
			        public Task<IEnumerable<End>> GetEndByPartId(string PartId, List<string> includesLst = null)
        {
            try
            {
                using ( var dbContext = new OCRContext(){StartTracking = StartTracking})
            ...
            catch (Exception updateEx)
            {
 	        ...
 	        public Task<IEnumerable<End>> GetEndByRegExId(string RegExId, List<string> includesLst = null)
        {
            try
            {
                using ( var dbContext = new OCRContext(){StartTracking = StartTracking})
