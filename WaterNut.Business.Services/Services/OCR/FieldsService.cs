    ...
    public partial class FieldsService : IFieldsService, IDisposable
    {
            ...
            //using (var scope = new TransactionScope(TransactionScopeOption.Required,
               ...
               // {
                  using ( var dbContext = new OCRContext(){StartTracking = StartTracking})
                  {
                    ...
                    IEnumerable<Fields> entities = await set.AsNoTracking().ToListAsync()
        ...
        public async Task<Fields> GetFieldsByKey(string Id, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
              ...
              using ( var dbContext = new OCRContext(){StartTracking = StartTracking})
              {
				...
				var set = AddIncludes(includesLst, dbContext);
                Fields entity = await set.AsNoTracking().SingleOrDefaultAsync(x => x.Id == i).ConfigureAwait(continueOnCapturedContext: false);
        ...
        public async Task<bool> DeleteFields(string Id)
        {
            try
            {
              ...
              {
                var i = Convert.ToInt32(Id);
                Fields entity = await dbContext.Fields
                                                                                 ...
                                                                                 Dictionary<string, string> navExp, IEnumerable<string> includeLst = null)
        {
            try
            {
                using (var dbContext = new OCRContext(){StartTracking = StartTracking})
                {
                    ...
                    return await set//dbContext.Fields
								.AsNoTracking()
                                .Where(exp == "All" || exp == null ? "Id != null" : exp)
								.OrderBy(y => y.Id)
