...
namespace OCR.Business.Services
{
   ...
   [ServiceBehavior(InstanceContextMode = InstanceContextMode.PerCall,
    ...
    public partial class InvoicesService : IInvoicesService, IDisposable
    {
        ...
        public Task<IEnumerable<Invoices>> GetInvoices(List<string> includesLst = null, bool tracking = true)
        {
            try
            {
        ...
        public Task<Invoices> GetInvoicesByKey(string Id, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
			   if(string.IsNullOrEmpty(Id))return Task.FromResult<Invoices>(null); 
              using ( var dbContext = new OCRContext(){StartTracking = StartTracking})
              {
                var i = Convert.ToInt32(Id);
				var set = AddIncludes(includesLst, dbContext);
                Invoices entity = set.AsNoTracking().SingleOrDefault(x => x.Id == i);
		 ...
		 public Task<IEnumerable<Invoices>> GetInvoicesByExpression(string exp, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
                using (var dbContext = new OCRContext(){StartTracking = StartTracking})
		 ...
		 public Task<IEnumerable<Invoices>> GetInvoicesByExpressionLst(List<string> expLst, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
                using (var dbContext = new OCRContext(){StartTracking = StartTracking})
        ...
        public Task<IEnumerable<Invoices>> GetInvoicesByBatch(string exp,
        ...
        public Task<IEnumerable<Invoices>> GetInvoicesByBatchExpressionLst(List<string> expLst,
                                                                           int totalrow, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
        ...
        public Task<bool> DeleteInvoices(string Id)
        {
            try
            {
              using ( var dbContext = new OCRContext(){StartTracking = StartTracking})
              {
                var i = Convert.ToInt32(Id);
                Invoices entity = dbContext.Invoices
		...
		public Task<int> Count(string exp)
        {
            try
            {
                using (OCRContext dbContext = new OCRContext(){StartTracking = StartTracking})
                {
                    ...
                    if (exp == "All")
                    {
                        return Task.FromResult(dbContext.Invoices
                            .AsNoTracking()
                            .Count());
                    }
                    else
        ...
        public Task<IEnumerable<Invoices>> LoadRange(int startIndex, int count, string exp)
        {
            try
            {
                using (var dbContext = new OCRContext(){StartTracking = StartTracking})
                {
                    ...
                    if (exp == "All")
                    {
                        return Task.FromResult<IEnumerable<Invoices>>(dbContext.Invoices
                            .AsNoTracking()
                            .OrderBy(y => y.Id)
                            .Skip(startIndex)
                            .Take(count)
		...
		public async Task<int> CountNav(string exp, Dictionary<string, string> navExp)
        {
            try
            {
                ...
                using (var dbContext = new OCRContext(){StartTracking = StartTracking})
                {
                    ...
                    return dbContext.Invoices.Where(exp == "All" || exp == null ? "Id != null" : exp)
											.AsNoTracking()
                                            .Count();
                }
		...
		private static Task<IEnumerable<Invoices>> GetWhereSelectMany<T>(OCRContext dbContext,
		...
		private static Task<IEnumerable<Invoices>> GetWhereSelect<T>(OCRContext dbContext,
                                                                     string exp, string navExp, string navProp, List<string> includesLst = null) where T : class
        {
			try
			{
			        ...
			        public Task<IEnumerable<Invoices>> GetInvoicesByFileTypeId(string FileTypeId, List<string> includesLst = null)
        {
            try
            {
                using ( var dbContext = new OCRContext(){StartTracking = StartTracking})
              {
                ...
                var set = AddIncludes(includesLst, dbContext);
                IEnumerable<Invoices> entities = set//dbContext.Invoices
                                                    // .Include(x => x.Parts)									  
                                                    // .Include(x => x.RegEx)									  
