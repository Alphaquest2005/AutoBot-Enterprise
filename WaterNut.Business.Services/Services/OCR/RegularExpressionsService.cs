    ...
    public partial class RegularExpressionsService : IRegularExpressionsService, IDisposable
    {
            ...
            //using (var scope = new TransactionScope(TransactionScopeOption.Required,
               ...
               // {
                  using ( var dbContext = new OCRContext(){StartTracking = StartTracking})
                  {
                    ...
                    IEnumerable<RegularExpressions> entities = await set.AsNoTracking().ToListAsync()
        ...
        public async Task<RegularExpressions> GetRegularExpressionsByKey(string Id, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
              ...
              using ( var dbContext = new OCRContext(){StartTracking = StartTracking})
              {
				...
				var set = AddIncludes(includesLst, dbContext);
                RegularExpressions entity = await set.AsNoTracking().SingleOrDefaultAsync(x => x.Id == i).ConfigureAwait(continueOnCapturedContext: false);
                    ...
                    foreach (var itm in navExp)
                    {
                        switch (itm.Key)
                        {
                            ...
                            case "InvoiceIdentificatonRegEx":
                                return
                                    await
                                        GetWhere<InvoiceIdentificatonRegEx>(dbContext, exp, itm.Value, "OCR_RegularExpressions", "Select", includesLst)
										.ConfigureAwait(continueOnCapturedContext: false);
        ...
        public async Task<bool> DeleteRegularExpressions(string Id)
        {
            try
            {
              ...
              {
                var i = Convert.ToInt32(Id);
                RegularExpressions entity = await dbContext.RegularExpressions
		...
		public async Task<int> Count(string exp)
        {
            try
            {
                using (OCRContext dbContext = new OCRContext(){StartTracking = StartTracking})
                {
                    ...
                    if (exp == "All")
                    {
                        return await dbContext.RegularExpressions
                                    .AsNoTracking()
									.CountAsync()
									.ConfigureAwait(continueOnCapturedContext: false);
                    }
                        ...
                        switch (itm.Key)
                        {
                            ...
                            case "FieldFormatRepRegEx":
                                return await CountWhere<FieldFormatRegEx>(dbContext, exp, itm.Value, "RegEx", "Select")
											.ConfigureAwait(continueOnCapturedContext: false);
                            case "InvoiceIdentificatonRegEx":
                                return await CountWhere<InvoiceIdentificatonRegEx>(dbContext, exp, itm.Value, "OCR_RegularExpressions", "Select")
											.ConfigureAwait(continueOnCapturedContext: false);
						}
                    }
                                                                                 ...
                                                                                 Dictionary<string, string> navExp, IEnumerable<string> includeLst = null)
        {
            try
            {
                using (var dbContext = new OCRContext(){StartTracking = StartTracking})
                {
                    ...
                    foreach (var itm in navExp)
                    {
                        switch (itm.Key)
                        {
                            ...
                            case "InvoiceIdentificatonRegEx":
                                return
                                    await
                                        LoadRangeWhere<InvoiceIdentificatonRegEx>(startIndex, count, dbContext, exp, itm.Value, "OCR_RegularExpressions", "Select")
													.ConfigureAwait(continueOnCapturedContext: false);
                    ...
                    return await set//dbContext.RegularExpressions
								.AsNoTracking()
                                .Where(exp == "All" || exp == null ? "Id != null" : exp)
								.OrderBy(y => y.Id)
                        ...
                        switch (itm.Key)
                        {
                            ...
                            case "FieldFormatRepRegEx":
                                return await SumWhere<FieldFormatRegEx>(dbContext, exp, itm.Value, "RegEx", field, "Select")
											.ConfigureAwait(continueOnCapturedContext: false);
                            case "InvoiceIdentificatonRegEx":
                                return await SumWhere<InvoiceIdentificatonRegEx>(dbContext, exp, itm.Value, "OCR_RegularExpressions", field, "Select")
											.ConfigureAwait(continueOnCapturedContext: false);
						}
                    }
