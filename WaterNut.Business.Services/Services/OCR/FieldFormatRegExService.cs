...
namespace OCR.Business.Services
{
   ...
   [ServiceBehavior(InstanceContextMode = InstanceContextMode.PerCall,
    ...
    public partial class FieldFormatRegExService : IFieldFormatRegExService, IDisposable
    {
        ...
        public async Task<IEnumerable<FieldFormatRegEx>> GetOCR_FieldFormatRegEx(List<string> includesLst = null, bool tracking = true)
        {
            try
            {
            //using (var scope = new TransactionScope(TransactionScopeOption.Required,
               ...
               // {
                  using ( var dbContext = new OCRContext(){StartTracking = StartTracking})
                  {
                    ...
                    IEnumerable<FieldFormatRegEx> entities = await set.AsNoTracking().ToListAsync()
        ...
        public async Task<FieldFormatRegEx> GetFieldFormatRegExByKey(string Id, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
              ...
              using ( var dbContext = new OCRContext(){StartTracking = StartTracking})
              {
				...
				var set = AddIncludes(includesLst, dbContext);
                FieldFormatRegEx entity = await set.AsNoTracking().SingleOrDefaultAsync(x => x.Id == i).ConfigureAwait(continueOnCapturedContext: false);
		 ...
		 public async Task<IEnumerable<FieldFormatRegEx>> GetOCR_FieldFormatRegExByExpression(string exp, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
                using (var dbContext = new OCRContext(){StartTracking = StartTracking})
		 ...
		 public async Task<IEnumerable<FieldFormatRegEx>> GetOCR_FieldFormatRegExByExpressionLst(List<string> expLst, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
                using (var dbContext = new OCRContext(){StartTracking = StartTracking})
                {
                    dbContext.Database.CommandTimeout = 0;
					if (expLst.Count == 0 || expLst.FirstOrDefault() == "None") return new List<FieldFormatRegEx>();
					var set = AddIncludes(includesLst, dbContext);
        ...
        public async Task<IEnumerable<FieldFormatRegEx>> GetOCR_FieldFormatRegExByBatch(string exp,
        ...
        public async Task<IEnumerable<FieldFormatRegEx>> GetOCR_FieldFormatRegExByBatchExpressionLst(List<string> expLst,
            int totalrow, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
        ...
        public async Task<bool> DeleteFieldFormatRegEx(string Id)
        {
            try
            {
              ...
              {
                var i = Convert.ToInt32(Id);
                FieldFormatRegEx entity = await dbContext.OCR_FieldFormatRegEx
		...
		public async Task<int> Count(string exp)
        {
            try
            {
                using (OCRContext dbContext = new OCRContext(){StartTracking = StartTracking})
                {
                    ...
                    if (exp == "All")
                    {
                        return await dbContext.OCR_FieldFormatRegEx
                                    .AsNoTracking()
									.CountAsync()
									.ConfigureAwait(continueOnCapturedContext: false);
                    }
        ...
        public async Task<IEnumerable<FieldFormatRegEx>> LoadRange(int startIndex, int count, string exp)
        {
            try
            {
                using (var dbContext = new OCRContext(){StartTracking = StartTracking})
		...
		public async Task<int> CountNav(string exp, Dictionary<string, string> navExp)
        {
            try
            {
                ...
                using (var dbContext = new OCRContext(){StartTracking = StartTracking})
                {
                    ...
                    return await dbContext.OCR_FieldFormatRegEx.Where(exp == "All" || exp == null ? "Id != null" : exp)
											.AsNoTracking()
                                            .CountAsync()
											.ConfigureAwait(continueOnCapturedContext: false);
                }
                                                                                 ...
                                                                                 Dictionary<string, string> navExp, IEnumerable<string> includeLst = null)
        {
            try
            {
                using (var dbContext = new OCRContext(){StartTracking = StartTracking})
                {
                    ...
                    return await set//dbContext.OCR_FieldFormatRegEx
								.AsNoTracking()
                                .Where(exp == "All" || exp == null ? "Id != null" : exp)
								.OrderBy(y => y.Id)
		...
		private static async Task<IEnumerable<FieldFormatRegEx>> LoadRangeSelectMany<T>(int startIndex, int count,
		...
		private static async Task<IEnumerable<FieldFormatRegEx>> LoadRangeSelect<T>(int startIndex, int count,
            OCRContext dbContext, string exp, string navExp, string navProp, IEnumerable<string> includeLst = null) where T : class
        {
			try
			{
		...
		private static async Task<IEnumerable<FieldFormatRegEx>> GetWhereSelectMany<T>(OCRContext dbContext,
		...
		private static async Task<IEnumerable<FieldFormatRegEx>> GetWhereSelect<T>(OCRContext dbContext,
            string exp, string navExp, string navProp, List<string> includesLst = null) where T : class
        {
			try
			{
			        ...
			        public async Task<IEnumerable<FieldFormatRegEx>> GetFieldFormatRegExByFieldId(string FieldId, List<string> includesLst = null)
        {
            try
            {
                using ( var dbContext = new OCRContext(){StartTracking = StartTracking})
              {
                ...
                var set = AddIncludes(includesLst, dbContext);
                IEnumerable<FieldFormatRegEx> entities = await set//dbContext.OCR_FieldFormatRegEx
                                      .AsNoTracking()
