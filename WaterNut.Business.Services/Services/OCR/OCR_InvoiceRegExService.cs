...
namespace OCR.Business.Services
{
   ...
   [ServiceBehavior(InstanceContextMode = InstanceContextMode.PerCall,
    ...
    public partial class OCR_InvoiceRegExService : IOCR_InvoiceRegExService, IDisposable
    {
        //private readonly OCRContext dbContext;

        public bool StartTracking { get; set; }

        public OCR_InvoiceRegExService()
        {
            try
            {
        ...
        public async Task<IEnumerable<OCR_InvoiceRegEx>> GetOCR_InvoiceRegEx(List<string> includesLst = null, bool tracking = true)
        {
            try
            {
            //using (var scope = new TransactionScope(TransactionScopeOption.Required,
               ...
               // {
                  using ( var dbContext = new OCRContext(){StartTracking = StartTracking})
                  {
                    ...
                    IEnumerable<OCR_InvoiceRegEx> entities = await set.AsNoTracking().ToListAsync()
        ...
        public async Task<OCR_InvoiceRegEx> GetOCR_InvoiceRegExByKey(string Id, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
              ...
              using ( var dbContext = new OCRContext(){StartTracking = StartTracking})
              {
				...
				var set = AddIncludes(includesLst, dbContext);
                OCR_InvoiceRegEx entity = await set.AsNoTracking().SingleOrDefaultAsync(x => x.Id == i).ConfigureAwait(continueOnCapturedContext: false);
		 ...
		 public async Task<IEnumerable<OCR_InvoiceRegEx>> GetOCR_InvoiceRegExByExpression(string exp, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
                using (var dbContext = new OCRContext(){StartTracking = StartTracking})
                {
					...
					if (string.IsNullOrEmpty(exp) || exp == "None") return new List<OCR_InvoiceRegEx>();
					var set = AddIncludes(includesLst, dbContext);
                    if (exp == "All")
                    {
		 ...
		 public async Task<IEnumerable<OCR_InvoiceRegEx>> GetOCR_InvoiceRegExByExpressionLst(List<string> expLst, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
                using (var dbContext = new OCRContext(){StartTracking = StartTracking})
                {
                    dbContext.Database.CommandTimeout = 0;
					if (expLst.Count == 0 || expLst.FirstOrDefault() == "None") return new List<OCR_InvoiceRegEx>();
					var set = AddIncludes(includesLst, dbContext);
                    ...
                    foreach (var itm in navExp)
                    {
                        switch (itm.Key)
                        {
                            case "OCR_Invoices":
                                return
                                    await
                                        GetWhere<Invoices>(dbContext, exp, itm.Value, "OCR_InvoiceRegEx", "SelectMany", includesLst)
										.ConfigureAwait(continueOnCapturedContext: false);

                            case "RegEx":
                                return
                                    await
                                        GetWhere<RegularExpressions>(dbContext, exp, itm.Value, "OCR_InvoiceRegEx", "SelectMany", includesLst)
										.ConfigureAwait(continueOnCapturedContext: false);
            ...
            int totalrow, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
                ...
                var res = new ConcurrentQueue<List<OCR_InvoiceRegEx>>();
                    ...
                    //  for (int bat = 0; bat < batches; bat++)
                    {
                        try
                        {
                            using (var dbContext = new OCRContext(){StartTracking = StartTracking})
                            {
                                ...
                                var set = AddIncludes(includesLst, dbContext);
                                IQueryable<OCR_InvoiceRegEx> dset;
                                if (exp == "All")
                                {
            ...
            using ( var dbContext = new OCRContext(){StartTracking = StartTracking})
              {
                try
                {   
                     var res = (OCR_InvoiceRegEx) entity;
        ...
        public async Task<bool> DeleteOCR_InvoiceRegEx(string Id)
        {
            try
            {
              ...
              {
                var i = Convert.ToInt32(Id);
                OCR_InvoiceRegEx entity = await dbContext.OCR_InvoiceRegEx
        ...
        public async Task<bool> RemoveSelectedOCR_InvoiceRegEx(IEnumerable<string> lst)
        {
            try
            {
                StatusModel.StartStatusUpdate("Removing OCR_InvoiceRegEx", lst.Count());
                var t = Task.Run(() =>
                {
                    using (var ctx = new OCR_InvoiceRegExService())
                    {
                        foreach (var item in lst.ToList())
                        {

                            ctx.DeleteOCR_InvoiceRegEx(item).Wait();
         ...
         public async Task<int> CountByExpressionLst(List<string> expLst)
        {
            try
            {
                using (var dbContext = new OCRContext(){StartTracking = StartTracking})
                {
                    ...
                    var set = (IQueryable<OCR_InvoiceRegEx>)dbContext.OCR_InvoiceRegEx; 
                    if (expLst.FirstOrDefault() == "All")
                    {
            ...
            try
            {
                ...
                using (var dbContext = new OCRContext(){StartTracking = StartTracking})
                {
                    ...
                    foreach (var itm in navExp)
                    {
                        ...
                        {
                            case "OCR_Invoices":
                                return await CountWhere<Invoices>(dbContext, exp, itm.Value, "OCR_InvoiceRegEx", "SelectMany")
											.ConfigureAwait(continueOnCapturedContext: false);
                            case "RegEx":
                                return await CountWhere<RegularExpressions>(dbContext, exp, itm.Value, "OCR_InvoiceRegEx", "SelectMany")
											.ConfigureAwait(continueOnCapturedContext: false);
                            case "ReplacementRegEx":
                                return await CountWhere<RegularExpressions>(dbContext, exp, itm.Value, "OCR_InvoiceRegEx", "SelectMany")
											.ConfigureAwait(continueOnCapturedContext: false);
		...
		private static async Task<int> CountWhereSelectMany<T>(OCRContext dbContext, string exp, string navExp, string navProp) where T : class
        {
            ...
            return await dbContext.Set<T>()
				.AsNoTracking()
                .Where(navExp)
                .SelectMany(navProp).OfType<OCR_InvoiceRegEx>()
		...
		private static async Task<int> CountWhereSelect<T>(OCRContext dbContext, string exp, string navExp, string navProp) where T : class
        {
            ...
            return await dbContext.Set<T>()
				.AsNoTracking()
                .Where(navExp)
                .Select(navProp).OfType<OCR_InvoiceRegEx>()
                .Where(exp == "All" || exp == null ? "Id != null" : exp)
                .Distinct()
                .OrderBy("Id")
                .CountAsync()
                                                                                 ...
                                                                                 Dictionary<string, string> navExp, IEnumerable<string> includeLst = null)
        {
            try
            {
                ...
                {
                    dbContext.Database.CommandTimeout = 0;
                    if ((string.IsNullOrEmpty(exp) && navExp.Count == 0) || exp == "None") return new List<OCR_InvoiceRegEx>();
                    ...
                    foreach (var itm in navExp)
                    {
                        switch (itm.Key)
                        {
                            case "OCR_Invoices":
                                return
                                    await
                                        LoadRangeWhere<Invoices>(startIndex, count, dbContext, exp, itm.Value, "OCR_InvoiceRegEx", "SelectMany")
													.ConfigureAwait(continueOnCapturedContext: false);

                            case "RegEx":
                                return
                                    await
                                        LoadRangeWhere<RegularExpressions>(startIndex, count, dbContext, exp, itm.Value, "OCR_InvoiceRegEx", "SelectMany")
													.ConfigureAwait(continueOnCapturedContext: false);
		...
		private static async Task<IEnumerable<OCR_InvoiceRegEx>> LoadRangeWhere<T>(int startIndex, int count,
		...
		private static async Task<IEnumerable<OCR_InvoiceRegEx>> LoadRangeSelectMany<T>(int startIndex, int count,
		...
		private static async Task<IEnumerable<OCR_InvoiceRegEx>> LoadRangeSelect<T>(int startIndex, int count,
            OCRContext dbContext, string exp, string navExp, string navProp, IEnumerable<string> includeLst = null) where T : class
        {
			try
			{
        ...
        private static async Task<IEnumerable<OCR_InvoiceRegEx>> GetWhere<T>(OCRContext dbContext,
		...
		private static async Task<IEnumerable<OCR_InvoiceRegEx>> GetWhereSelectMany<T>(OCRContext dbContext,
            string exp, string navExp, string navProp, List<string> includesLst = null) where T : class
        {
			...
			var set = (DbQuery<OCR_InvoiceRegEx>)dbContext.Set<T>()
				.AsNoTracking()
                .Where(navExp)
                .SelectMany(navProp).OfType<OCR_InvoiceRegEx>()
                .Where(exp == "All" || exp == null?"Id != null":exp)
		...
		private static async Task<IEnumerable<OCR_InvoiceRegEx>> GetWhereSelect<T>(OCRContext dbContext,
            string exp, string navExp, string navProp, List<string> includesLst = null) where T : class
        {
			try
			{
			        ...
			        public async Task<IEnumerable<OCR_InvoiceRegEx>> GetOCR_InvoiceRegExByInvoiceId(string InvoiceId, List<string> includesLst = null)
        {
            try
            {
                using ( var dbContext = new OCRContext(){StartTracking = StartTracking})
              {
                ...
                var set = AddIncludes(includesLst, dbContext);
                IEnumerable<OCR_InvoiceRegEx> entities = await set//dbContext.OCR_InvoiceRegEx
                                      .AsNoTracking()
            ...
            try
            {
                ...
                using (var dbContext = new OCRContext(){StartTracking = StartTracking})
                {
                    ...
                    foreach (var itm in navExp)
                    {
                        ...
                        {
                            case "OCR_Invoices":
                                return await SumWhere<Invoices>(dbContext, exp, itm.Value, "OCR_InvoiceRegEx", field, "SelectMany")
											.ConfigureAwait(continueOnCapturedContext: false);
                            case "RegEx":
                                return await SumWhere<RegularExpressions>(dbContext, exp, itm.Value, "OCR_InvoiceRegEx", field, "SelectMany")
											.ConfigureAwait(continueOnCapturedContext: false);
                            case "ReplacementRegEx":
                                return await SumWhere<RegularExpressions>(dbContext, exp, itm.Value, "OCR_InvoiceRegEx", field, "SelectMany")
											.ConfigureAwait(continueOnCapturedContext: false);
		...
		private static IQueryable<OCR_InvoiceRegEx> AddIncludes(IEnumerable<string> includesLst, OCRContext dbContext)
       {
		 try
			{
			   if (includesLst == null) includesLst = new List<string>();
			   var set =(DbQuery<OCR_InvoiceRegEx>) dbContext.OCR_InvoiceRegEx; 
	   ...
	   private IQueryable<OCR_InvoiceRegEx> AddWheres(List<string> expLst, IQueryable<OCR_InvoiceRegEx> set)
        {
            try
            {
