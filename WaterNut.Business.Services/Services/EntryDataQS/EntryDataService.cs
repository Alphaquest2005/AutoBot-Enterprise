...
namespace EntryDataQS.Business.Services
{
   ...
   [ServiceBehavior(InstanceContextMode = InstanceContextMode.PerCall,
    ...
    public partial class EntryDataService : IEntryDataService, IDisposable
    {
        ...
        public Task<IEnumerable<EntryData>> GetEntryDatas(List<string> includesLst = null, bool tracking = true)
        {
            try
            {
        ...
        public Task<EntryData> GetEntryDataByKey(string EntryData_Id, List<string> includesLst = null, bool tracking = true)
        {
		 ...
		 public Task<IEnumerable<EntryData>> GetEntryDatasByExpression(string exp, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
                using (var dbContext = new EntryDataQSContext(){StartTracking = StartTracking})
		 ...
		 public Task<IEnumerable<EntryData>> GetEntryDatasByExpressionLst(List<string> expLst, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
                using (var dbContext = new EntryDataQSContext(){StartTracking = StartTracking})
        ...
        public Task<IEnumerable<EntryData>> GetEntryDatasByBatch(string exp,
        ...
        public Task<IEnumerable<EntryData>> GetEntryDatasByBatchExpressionLst(List<string> expLst,
                                                                              int totalrow, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
        ...
        public Task<bool> DeleteEntryData(string EntryData_Id)
        {
            try
            {
              ...
              {
                var i = Convert.ToInt32(EntryData_Id);
                EntryData entity = dbContext.EntryDatas
													.SingleOrDefault(x => x.EntryData_Id == i);
                if (entity == null)
                    return Task.FromResult(false);

                    dbContext.EntryDatas.Attach(entity);
                    dbContext.EntryDatas.Remove(entity);
                    dbContext.SaveChanges();
         ...
         public Task<int> CountByExpressionLst(List<string> expLst)
        {
            try
            {
                using (var dbContext = new EntryDataQSContext(){StartTracking = StartTracking})
                {
                    ...
                    var set = (IQueryable<EntryData>)dbContext.EntryDatas; 
                    if (expLst.FirstOrDefault() == "All")
                    {
		...
		public Task<int> Count(string exp)
        {
            try
            {
                using (EntryDataQSContext dbContext = new EntryDataQSContext(){StartTracking = StartTracking})
                {
                    ...
                    if (exp == "All")
                    {
                        return Task.FromResult(dbContext.EntryDatas
                            .AsNoTracking()
                            .Count());
                    }
                    else
        ...
        public Task<IEnumerable<EntryData>> LoadRange(int startIndex, int count, string exp)
        {
            try
            {
                using (var dbContext = new EntryDataQSContext(){StartTracking = StartTracking})
                {
                    ...
                    if (exp == "All")
                    {
                        return Task.FromResult<IEnumerable<EntryData>>(dbContext.EntryDatas
                            .AsNoTracking()
		...
		public async Task<int> CountNav(string exp, Dictionary<string, string> navExp)
        {
            try
            {
                ...
                using (var dbContext = new EntryDataQSContext(){StartTracking = StartTracking})
                {
                    ...
                    return dbContext.EntryDatas.Where(exp == "All" || exp == null ? "EntryData_Id != null" : exp)
											.AsNoTracking()
                                            .Count();
                }
                                                                                 ...
                                                                                 Dictionary<string, string> navExp, IEnumerable<string> includeLst = null)
        {
            try
            {
                using (var dbContext = new EntryDataQSContext(){StartTracking = StartTracking})
                {
                    ...
                    return set//dbContext.EntryDatas
								.AsNoTracking()
                                .Where(exp == "All" || exp == null ? "EntryData_Id != null" : exp)
								.OrderBy(y => y.EntryData_Id)
        ...
        private static async Task<IEnumerable<EntryData>> GetWhere<T>(EntryDataQSContext dbContext,
		...
		private static Task<IEnumerable<EntryData>> GetWhereSelectMany<T>(EntryDataQSContext dbContext,
		...
		private static Task<IEnumerable<EntryData>> GetWhereSelect<T>(EntryDataQSContext dbContext,
                                                                      string exp, string navExp, string navProp, List<string> includesLst = null) where T : class
        {
			try
			{
			        ...
			        public Task<IEnumerable<EntryData>> GetEntryDataByEntryDataId(string EntryDataId, List<string> includesLst = null)
        {
            try
            {
                using ( var dbContext = new EntryDataQSContext(){StartTracking = StartTracking})
              {
                var i = EntryDataId;
                var set = AddIncludes(includesLst, dbContext);
                IEnumerable<EntryData> entities = set//dbContext.EntryDatas
             ...
             try
             {
                 using (var dbContext = new EntryDataQSContext(){StartTracking = StartTracking})
                 {
					...
					decimal res = 0;
                     ...
                     if (whereExp == "All")
                     {
                          res = Convert.ToDecimal(dbContext.EntryDatas.AsNoTracking().Sum(field));
                     }
                     else
                     {
                         res = Convert.ToDecimal(dbContext.EntryDatas.AsNoTracking().Where(whereExp).Sum(field));
                     }
        ...
        public async Task<decimal> SumNav( string exp, Dictionary<string, string> navExp, string field)
        {
            try
            {
                ...
                {
                    dbContext.Database.CommandTimeout = 0;
                    if (!dbContext.EntryDatas.Any()) return 0;
                    if (exp == "All" && navExp.Count == 0)
                    {
                        return Convert.ToDecimal(dbContext.EntryDatas
										.AsNoTracking()
                                        .Sum(field)??0);
                    }
                    foreach (var itm in navExp)
                    ...
                    return Convert.ToDecimal(dbContext.EntryDatas.Where(exp == "All" || exp == null ? "EntryData_Id != null" : exp)
											.AsNoTracking()
                                            .Sum(field)??0);
                }
             ...
             try
             {
                 using (var dbContext = new EntryDataQSContext(){StartTracking = StartTracking})
                 {
					...
					string res = "";
                     ...
                     if (whereExp == "All")
                     {
                          res = Convert.ToString(dbContext.EntryDatas.AsNoTracking().Min(field));
                     }
                     else
                     {
                         res = Convert.ToString(dbContext.EntryDatas.AsNoTracking().Where(whereExp).Min(field));
                     }
		...
		private static IQueryable<EntryData> AddIncludes(IEnumerable<string> includesLst, EntryDataQSContext dbContext)
       {
		 try
			{
			   if (includesLst == null) includesLst = new List<string>();
			   var set =(DbQuery<EntryData>) dbContext.EntryDatas; 
