...
namespace EntryDataQS.Business.Services
{
   ...
   [ServiceBehavior(InstanceContextMode = InstanceContextMode.PerCall,
    ...
    public partial class EntryDataService : IEntryDataService, IDisposable
    {
        ...
        public async Task<IEnumerable<EntryData>> GetEntryDatas(List<string> includesLst = null, bool tracking = true)
        {
            try
            {
        ...
        public async Task<EntryData> GetEntryDataByKey(string EntryData_Id, List<string> includesLst = null, bool tracking = true)
        {
		 ...
		 public async Task<IEnumerable<EntryData>> GetEntryDatasByExpression(string exp, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
                using (var dbContext = new EntryDataQSContext(){StartTracking = StartTracking})
		 ...
		 public async Task<IEnumerable<EntryData>> GetEntryDatasByExpressionLst(List<string> expLst, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
                using (var dbContext = new EntryDataQSContext(){StartTracking = StartTracking})
        ...
        public async Task<bool> DeleteEntryData(string EntryData_Id)
        {
            try
            {
              ...
              {
                var i = Convert.ToInt32(EntryData_Id);
                EntryData entity = await dbContext.EntryDatas
		...
		public async Task<int> Count(string exp)
        {
            try
            {
                using (EntryDataQSContext dbContext = new EntryDataQSContext(){StartTracking = StartTracking})
                {
                    ...
                    if (exp == "All")
                    {
                        return await dbContext.EntryDatas
                                    .AsNoTracking()
									.CountAsync()
									.ConfigureAwait(continueOnCapturedContext: false);
                    }
		...
		public async Task<int> CountNav(string exp, Dictionary<string, string> navExp)
        {
            try
            {
                ...
                using (var dbContext = new EntryDataQSContext(){StartTracking = StartTracking})
                {
                    ...
                    return await dbContext.EntryDatas.Where(exp == "All" || exp == null ? "EntryData_Id != null" : exp)
											.AsNoTracking()
                                            .CountAsync()
											.ConfigureAwait(continueOnCapturedContext: false);
                }
                                                                                 ...
                                                                                 Dictionary<string, string> navExp, IEnumerable<string> includeLst = null)
        {
            try
            {
                using (var dbContext = new EntryDataQSContext(){StartTracking = StartTracking})
                {
                    ...
                    return await set//dbContext.EntryDatas
								.AsNoTracking()
                                .Where(exp == "All" || exp == null ? "EntryData_Id != null" : exp)
								.OrderBy(y => y.EntryData_Id)
		...
		private static async Task<IEnumerable<EntryData>> GetWhereSelectMany<T>(EntryDataQSContext dbContext,
		...
		private static async Task<IEnumerable<EntryData>> GetWhereSelect<T>(EntryDataQSContext dbContext,
            string exp, string navExp, string navProp, List<string> includesLst = null) where T : class
        {
			try
			{
