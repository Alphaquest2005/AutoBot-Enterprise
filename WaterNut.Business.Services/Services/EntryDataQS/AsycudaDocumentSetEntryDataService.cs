...
namespace EntryDataQS.Business.Services
{
   ...
   [ServiceBehavior(InstanceContextMode = InstanceContextMode.PerCall,
    ...
    public partial class AsycudaDocumentSetEntryDataService : IAsycudaDocumentSetEntryDataService, IDisposable
    {
                    ...
                    foreach (var itm in navExp)
                    {
                        switch (itm.Key)
                        {
                            ...
                            case "EntryData":
                                return
                                    await
                                        GetWhere<EntryData>(dbContext, exp, itm.Value, "AsycudaDocumentSetEntryDatas", "SelectMany", includesLst)
										.ConfigureAwait(continueOnCapturedContext: false);
                        ...
                        switch (itm.Key)
                        {
                            case "EntryDataEx":
                                return await CountWhere<EntryDataEx>(dbContext, exp, itm.Value, "AsycudaDocumentSets", "SelectMany")
											.ConfigureAwait(continueOnCapturedContext: false);
                            case "EntryData":
                                return await CountWhere<EntryData>(dbContext, exp, itm.Value, "AsycudaDocumentSetEntryDatas", "SelectMany")
											.ConfigureAwait(continueOnCapturedContext: false);
						}
                    }
                    ...
                    foreach (var itm in navExp)
                    {
                        switch (itm.Key)
                        {
                            ...
                            case "EntryData":
                                return
                                    await
                                        LoadRangeWhere<EntryData>(startIndex, count, dbContext, exp, itm.Value, "AsycudaDocumentSetEntryDatas", "SelectMany")
													.ConfigureAwait(continueOnCapturedContext: false);
		...
		private static Task<IEnumerable<AsycudaDocumentSetEntryData>> GetWhereSelectMany<T>(EntryDataQSContext dbContext,
		...
		private static Task<IEnumerable<AsycudaDocumentSetEntryData>> GetWhereSelect<T>(EntryDataQSContext dbContext,
                                                                                        string exp, string navExp, string navProp, List<string> includesLst = null) where T : class
        {
			try
			{
                        ...
                        switch (itm.Key)
                        {
                            case "EntryDataEx":
                                return await SumWhere<EntryDataEx>(dbContext, exp, itm.Value, "AsycudaDocumentSets", field, "SelectMany")
											.ConfigureAwait(continueOnCapturedContext: false);
                            case "EntryData":
                                return await SumWhere<EntryData>(dbContext, exp, itm.Value, "AsycudaDocumentSetEntryDatas", field, "SelectMany")
											.ConfigureAwait(continueOnCapturedContext: false);
						}
                    }
