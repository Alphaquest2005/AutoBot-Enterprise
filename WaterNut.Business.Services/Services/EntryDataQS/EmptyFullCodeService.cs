...
namespace EntryDataQS.Business.Services
{
   ...
   [ServiceBehavior(InstanceContextMode = InstanceContextMode.PerCall,
    ...
    public partial class EmptyFullCodeService : IEmptyFullCodeService, IDisposable
    {
        //private readonly EntryDataQSContext dbContext;

        public bool StartTracking { get; set; }

        public EmptyFullCodeService()
        {
            try
            {
            ...
            //using (var scope = new TransactionScope(TransactionScopeOption.Required,
               ...
               // {
                  using ( var dbContext = new EntryDataQSContext(){StartTracking = StartTracking})
                  {
                    ...
                    IEnumerable<EmptyFullCode> entities = await set.AsNoTracking().ToListAsync()
        ...
        public async Task<EmptyFullCode> GetEmptyFullCodeByKey(string EmptyFullCodeId, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
              ...
              using ( var dbContext = new EntryDataQSContext(){StartTracking = StartTracking})
              {
				...
				var set = AddIncludes(includesLst, dbContext);
                EmptyFullCode entity = await set.AsNoTracking().SingleOrDefaultAsync(x => x.EmptyFullCodeId == i).ConfigureAwait(continueOnCapturedContext: false);
            ...
            int totalrow, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
                ...
                var res = new ConcurrentQueue<List<EmptyFullCode>>();
                    ...
                    //  for (int bat = 0; bat < batches; bat++)
                    {
                        try
                        {
                            using (var dbContext = new EntryDataQSContext(){StartTracking = StartTracking})
                            {
                                ...
                                var set = AddIncludes(includesLst, dbContext);
                                IQueryable<EmptyFullCode> dset;
                                if (exp == "All")
                                {
                                    dset = set.OrderBy(x => x.EmptyFullCodeId);
                                }
                                else
                                {
                                    dset = set.OrderBy(x => x.EmptyFullCodeId).Where(exp);
                                }
        ...
        public async Task<bool> DeleteEmptyFullCode(string EmptyFullCodeId)
        {
            try
            {
              ...
              {
                var i = Convert.ToInt32(EmptyFullCodeId);
                EmptyFullCode entity = await dbContext.EmptyFullCodes
													.SingleOrDefaultAsync(x => x.EmptyFullCodeId == i)
													.ConfigureAwait(continueOnCapturedContext: false);
                if (entity == null)
                    return false;
        ...
        public async Task<bool> RemoveSelectedEmptyFullCode(IEnumerable<string> lst)
        {
            try
            {
                StatusModel.StartStatusUpdate("Removing EmptyFullCode", lst.Count());
                var t = Task.Run(() =>
                {
                    using (var ctx = new EmptyFullCodeService())
                    {
                        foreach (var item in lst.ToList())
                        {

                            ctx.DeleteEmptyFullCode(item).Wait();
		...
		public async Task<int> Count(string exp)
        {
            try
            {
                using (EntryDataQSContext dbContext = new EntryDataQSContext(){StartTracking = StartTracking})
                {
                    ...
                    if (exp == "All")
                    {
                        return await dbContext.EmptyFullCodes
                                    .AsNoTracking()
									.CountAsync()
									.ConfigureAwait(continueOnCapturedContext: false);
                    }
		...
		public async Task<int> CountNav(string exp, Dictionary<string, string> navExp)
        {
            try
            {
                ...
                using (var dbContext = new EntryDataQSContext(){StartTracking = StartTracking})
                {
                    ...
                    return await dbContext.EmptyFullCodes.Where(exp == "All" || exp == null ? "EmptyFullCodeId != null" : exp)
											.AsNoTracking()
                                            .CountAsync()
											.ConfigureAwait(continueOnCapturedContext: false);
                }
                                                                                 ...
                                                                                 Dictionary<string, string> navExp, IEnumerable<string> includeLst = null)
        {
            try
            {
                using (var dbContext = new EntryDataQSContext(){StartTracking = StartTracking})
                {
                    ...
                    return await set//dbContext.EmptyFullCodes
								.AsNoTracking()
                                .Where(exp == "All" || exp == null ? "EmptyFullCodeId != null" : exp)
								.OrderBy(y => y.EmptyFullCodeId)
		...
		private static async Task<IEnumerable<EmptyFullCode>> LoadRangeWhere<T>(int startIndex, int count,
        ...
        private static async Task<IEnumerable<EmptyFullCode>> GetWhere<T>(EntryDataQSContext dbContext,
             ...
             try
             {
                 using (var dbContext = new EntryDataQSContext(){StartTracking = StartTracking})
                 {
					decimal res = 0;
                     ...
                     if (whereExp == "All")
                     {
                          res = Convert.ToDecimal(dbContext.EmptyFullCodes.AsNoTracking().Sum(field));
                     }
                     else
                     {
                         res = Convert.ToDecimal(dbContext.EmptyFullCodes.AsNoTracking().Where(whereExp).Sum(field));
                     }
             ...
             try
             {
                 using (var dbContext = new EntryDataQSContext(){StartTracking = StartTracking})
                 {
					string res = "";
                     ...
                     if (whereExp == "All")
                     {
                          res = Convert.ToString(dbContext.EmptyFullCodes.AsNoTracking().Min(field));
                     }
                     else
                     {
                         res = Convert.ToString(dbContext.EmptyFullCodes.AsNoTracking().Where(whereExp).Min(field));
                     }
		...
		private static IQueryable<EmptyFullCode> AddIncludes(IEnumerable<string> includesLst, EntryDataQSContext dbContext)
       {
		 try
			{
			   if (includesLst == null) includesLst = new List<string>();
			   var set =(DbQuery<EmptyFullCode>) dbContext.EmptyFullCodes; 
	   ...
	   private IQueryable<EmptyFullCode> AddWheres(List<string> expLst, IQueryable<EmptyFullCode> set)
        {
            try
            {
