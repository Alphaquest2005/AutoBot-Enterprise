    ...
    public partial class EntryDataDetailsExService : IEntryDataDetailsExService, IDisposable
    {
        ...
        public async Task<bool> DeleteEntryDataDetailsEx(string EntryDataDetailsId)
        {
            try
            {
              ...
              {
                var i = Convert.ToInt32(EntryDataDetailsId);
                EntryDataDetailsEx entity = await dbContext.EntryDataDetailsExes
		...
		public async Task<int> Count(string exp)
        {
            try
            {
                using (EntryDataQSContext dbContext = new EntryDataQSContext(){StartTracking = StartTracking})
                {
                    ...
                    if (exp == "All")
                    {
                        return await dbContext.EntryDataDetailsExes
                                    .AsNoTracking()
									.CountAsync()
									.ConfigureAwait(continueOnCapturedContext: false);
                    }
		...
		public async Task<int> CountNav(string exp, Dictionary<string, string> navExp)
        {
            try
            {
                ...
                using (var dbContext = new EntryDataQSContext(){StartTracking = StartTracking})
                {
                    ...
                    return await dbContext.EntryDataDetailsExes.Where(exp == "All" || exp == null ? "EntryDataDetailsId != null" : exp)
											.AsNoTracking()
                                            .CountAsync()
											.ConfigureAwait(continueOnCapturedContext: false);
                }
                                                                                 ...
                                                                                 Dictionary<string, string> navExp, IEnumerable<string> includeLst = null)
        {
            try
            {
                using (var dbContext = new EntryDataQSContext(){StartTracking = StartTracking})
                {
                    ...
                    return await set//dbContext.EntryDataDetailsExes
								.AsNoTracking()
                                .Where(exp == "All" || exp == null ? "EntryDataDetailsId != null" : exp)
								.OrderBy(y => y.EntryDataDetailsId)
