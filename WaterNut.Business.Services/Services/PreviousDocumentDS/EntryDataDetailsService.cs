...
namespace PreviousDocumentDS.Business.Services
{
   ...
   [ServiceBehavior(InstanceContextMode = InstanceContextMode.PerCall,
    ...
    public partial class EntryDataDetailsService : IEntryDataDetailsService, IDisposable
    {
		...
		public Task<IEnumerable<EntryDataDetails>> GetEntryDataDetailsByExpressionNav(string exp,
            ...
            try
            {
                using (var dbContext = new PreviousDocumentDSContext(){StartTracking = StartTracking})
                {
                    ...
                    if (exp == "All" && navExp.Count == 0)
                    {
                        ...
                        return Task.FromResult<IEnumerable<EntryDataDetails>>(aentities); 
                    }
					var set = AddIncludes(includesLst, dbContext);
                    var entities = set.AsNoTracking().Where(exp)
									.ToList();
		...
		public Task<int> CountNav(string exp, Dictionary<string, string> navExp)
        {
            try
            {
                ...
                using (var dbContext = new PreviousDocumentDSContext(){StartTracking = StartTracking})
                {
                    ...
                    return Task.FromResult(dbContext.EntryDataDetails.Where(exp == "All" || exp == null ? "EntryDataDetailsId != null" : exp)
                        .AsNoTracking()
                        .Count());
                }
		...
		private static Task<int> CountWhereSelect<T>(PreviousDocumentDSContext dbContext, string exp, string navExp, string navProp) where T : class
        {
		  ...
		  public Task<IEnumerable<EntryDataDetails>> LoadRangeNav(int startIndex, int count, string exp,
                                                                  Dictionary<string, string> navExp, IEnumerable<string> includeLst = null)
        {
            try
            {
                ...
                {
                    dbContext.Database.CommandTimeout = 0;
                    if ((string.IsNullOrEmpty(exp) && navExp.Count == 0) || exp == "None") return Task.FromResult<IEnumerable<EntryDataDetails>>(new List<EntryDataDetails>());
                    ...
                    return Task.FromResult<IEnumerable<EntryDataDetails>>(set//dbContext.EntryDataDetails
                        .AsNoTracking()
                        .Where(exp == "All" || exp == null ? "EntryDataDetailsId != null" : exp)
                        .OrderBy(y => y.EntryDataDetailsId)
		...
		private static Task<IEnumerable<EntryDataDetails>> GetWhereSelectMany<T>(PreviousDocumentDSContext dbContext,
		...
		private static Task<IEnumerable<EntryDataDetails>> GetWhereSelect<T>(PreviousDocumentDSContext dbContext,
                                                                             string exp, string navExp, string navProp, List<string> includesLst = null) where T : class
        {
			try
			{
        ...
        public Task<decimal> SumNav( string exp, Dictionary<string, string> navExp, string field)
        {
            try
            {
                ...
                {
                    dbContext.Database.CommandTimeout = 0;
                    if (!dbContext.EntryDataDetails.Any()) return Task.FromResult<decimal>(0);
                    if (exp == "All" && navExp.Count == 0)
                    {
                        return Task.FromResult(Convert.ToDecimal(dbContext.EntryDataDetails
                                                                     .AsNoTracking()
                                                                     .Sum(field)??0));
                    }
                    return Task.FromResult(Convert.ToDecimal(dbContext.EntryDataDetails.Where(exp == "All" || exp == null ? "EntryDataDetailsId != null" : exp)
                                                                 .AsNoTracking()
                                                                 .Sum(field)??0));
                }
