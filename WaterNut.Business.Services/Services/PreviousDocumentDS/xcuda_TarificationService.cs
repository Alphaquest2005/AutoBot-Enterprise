...
namespace PreviousDocumentDS.Business.Services
{
   ...
   [ServiceBehavior(InstanceContextMode = InstanceContextMode.PerCall,
    ...
    public partial class xcuda_TarificationService : Ixcuda_TarificationService, IDisposable
    {
                    ...
                    foreach (var itm in navExp)
                    {
                        switch (itm.Key)
                        {
                            ...
                            case "xcuda_Item":
                                return
                                    await
                                        GetWhere<PreviousEntry>(dbContext, exp, itm.Value, "xcuda_Tarification", "SelectMany", includesLst)
										.ConfigureAwait(continueOnCapturedContext: false);
                        ...
                        switch (itm.Key)
                        {
                            case "xcuda_HScode":
                                return await CountWhere<xcuda_HScode>(dbContext, exp, itm.Value, "xcuda_Tarification", "SelectMany")
											.ConfigureAwait(continueOnCapturedContext: false);
                            case "xcuda_Item":
                                return await CountWhere<PreviousEntry>(dbContext, exp, itm.Value, "xcuda_Tarification", "SelectMany")
											.ConfigureAwait(continueOnCapturedContext: false);
						}
                    }
                    ...
                    foreach (var itm in navExp)
                    {
                        switch (itm.Key)
                        {
                            ...
                            case "xcuda_Item":
                                return
                                    await
                                        LoadRangeWhere<PreviousEntry>(startIndex, count, dbContext, exp, itm.Value, "xcuda_Tarification", "SelectMany")
													.ConfigureAwait(continueOnCapturedContext: false);
        ...
        private static async Task<IEnumerable<xcuda_Tarification>> GetWhere<T>(PreviousDocumentDSContext dbContext,
                        ...
                        switch (itm.Key)
                        {
                            case "xcuda_HScode":
                                return await SumWhere<xcuda_HScode>(dbContext, exp, itm.Value, "xcuda_Tarification", field, "SelectMany")
											.ConfigureAwait(continueOnCapturedContext: false);
                            case "xcuda_Item":
                                return await SumWhere<PreviousEntry>(dbContext, exp, itm.Value, "xcuda_Tarification", field, "SelectMany")
											.ConfigureAwait(continueOnCapturedContext: false);
						}
                    }
		...
		private static IQueryable<xcuda_Tarification> AddIncludes(IEnumerable<string> includesLst, PreviousDocumentDSContext dbContext)
       {
		 try
			{
