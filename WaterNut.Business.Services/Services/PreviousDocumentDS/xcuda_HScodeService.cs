...
namespace PreviousDocumentDS.Business.Services
{
   ...
   [ServiceBehavior(InstanceContextMode = InstanceContextMode.PerCall,
    ...
    public partial class xcuda_HScodeService : Ixcuda_HScodeService, IDisposable
    {
		...
		private static Task<IEnumerable<xcuda_HScode>> GetWhereSelectMany<T>(PreviousDocumentDSContext dbContext,
		...
		private static Task<IEnumerable<xcuda_HScode>> GetWhereSelect<T>(PreviousDocumentDSContext dbContext,
                                                                         string exp, string navExp, string navProp, List<string> includesLst = null) where T : class
        {
			try
			{
