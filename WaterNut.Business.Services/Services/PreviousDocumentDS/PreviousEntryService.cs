...
namespace PreviousDocumentDS.Business.Services
{
   ...
   [ServiceBehavior(InstanceContextMode = InstanceContextMode.PerCall,
    ...
    public partial class PreviousEntryService : IPreviousEntryService, IDisposable
    {
            ...
            //using (var scope = new TransactionScope(TransactionScopeOption.Required,
               ...
               // {
                  using ( var dbContext = new PreviousDocumentDSContext(){StartTracking = StartTracking})
                  {
                    ...
                    IEnumerable<PreviousEntry> entities = await set.AsNoTracking().ToListAsync()
        ...
        public async Task<PreviousEntry> GetPreviousEntryByKey(string Item_Id, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
              ...
              using ( var dbContext = new PreviousDocumentDSContext(){StartTracking = StartTracking})
              {
				...
				var set = AddIncludes(includesLst, dbContext);
                PreviousEntry entity = await set.AsNoTracking().SingleOrDefaultAsync(x => x.Item_Id == i).ConfigureAwait(continueOnCapturedContext: false);
		...
		public async Task<IEnumerable<PreviousEntry>> GetPreviousEntriesByExpressionNav(string exp,
                    ...
                    foreach (var itm in navExp)
                    {
                        switch (itm.Key)
                        {
                            ...
                            case "xcuda_PreviousItem":
                                return
                                    await
                                        GetWhere<xcuda_PreviousItem>(dbContext, exp, itm.Value, "PreviousEntry", "SelectMany", includesLst)
										.ConfigureAwait(continueOnCapturedContext: false);
            ...
            int totalrow, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
                ...
                var res = new ConcurrentQueue<List<PreviousEntry>>();
        ...
        public async Task<bool> DeletePreviousEntry(string Item_Id)
        {
            try
            {
              ...
              {
                var i = Convert.ToInt32(Item_Id);
                PreviousEntry entity = await dbContext.PreviousEntries
        ...
        public async Task<bool> RemoveSelectedPreviousEntry(IEnumerable<string> lst)
        {
            try
            {
                StatusModel.StartStatusUpdate("Removing PreviousEntry", lst.Count());
                var t = Task.Run(() =>
                {
                    using (var ctx = new PreviousEntryService())
                    {
                        foreach (var item in lst.ToList())
                        {
                            ...
                            ctx.DeletePreviousEntry(item).Wait();
		...
		public async Task<int> Count(string exp)
        {
            try
            {
                using (PreviousDocumentDSContext dbContext = new PreviousDocumentDSContext(){StartTracking = StartTracking})
                {
                    ...
                    if (exp == "All")
                    {
                        return await dbContext.PreviousEntries
                                    .AsNoTracking()
									.CountAsync()
									.ConfigureAwait(continueOnCapturedContext: false);
                    }
		...
		public async Task<int> CountNav(string exp, Dictionary<string, string> navExp)
        {
            try
            {
                ...
                using (var dbContext = new PreviousDocumentDSContext(){StartTracking = StartTracking})
                {
                        ...
                        switch (itm.Key)
                        {
                            ...
                            case "xcuda_Valuation_item":
                                return await CountWhere<xcuda_Valuation_item>(dbContext, exp, itm.Value, "xcuda_Item", "SelectMany")
											.ConfigureAwait(continueOnCapturedContext: false);
                            case "xcuda_PreviousItem":
                                return await CountWhere<xcuda_PreviousItem>(dbContext, exp, itm.Value, "PreviousEntry", "SelectMany")
											.ConfigureAwait(continueOnCapturedContext: false);
                            case "EntryPreviousItems":
                    ...
                    return await dbContext.PreviousEntries.Where(exp == "All" || exp == null ? "Item_Id != null" : exp)
											.AsNoTracking()
                                            .CountAsync()
											.ConfigureAwait(continueOnCapturedContext: false);
                }
		...
		private static async Task<int> CountWhereSelect<T>(PreviousDocumentDSContext dbContext, string exp, string navExp, string navProp) where T : class
        {
		  ...
		  public async Task<IEnumerable<PreviousEntry>> LoadRangeNav(int startIndex, int count, string exp,
                                                                                 Dictionary<string, string> navExp, IEnumerable<string> includeLst = null)
        {
            try
            {
                ...
                {
                    dbContext.Database.CommandTimeout = 0;
                    if ((string.IsNullOrEmpty(exp) && navExp.Count == 0) || exp == "None") return new List<PreviousEntry>();
                    ...
                    foreach (var itm in navExp)
                    {
                        switch (itm.Key)
                        {
                            ...
                            case "xcuda_PreviousItem":
                                return
                                    await
                                        LoadRangeWhere<xcuda_PreviousItem>(startIndex, count, dbContext, exp, itm.Value, "PreviousEntry", "SelectMany")
													.ConfigureAwait(continueOnCapturedContext: false);
                    ...
                    return await set//dbContext.PreviousEntries
								.AsNoTracking()
                                .Where(exp == "All" || exp == null ? "Item_Id != null" : exp)
								.OrderBy(y => y.Item_Id)
		...
		private static async Task<IEnumerable<PreviousEntry>> LoadRangeWhere<T>(int startIndex, int count,
        ...
        private static async Task<IEnumerable<PreviousEntry>> GetWhere<T>(PreviousDocumentDSContext dbContext,
			        ...
			        public async Task<IEnumerable<PreviousEntry>> GetPreviousEntryByASYCUDA_Id(string ASYCUDA_Id, List<string> includesLst = null)
        {
            try
            {
                using ( var dbContext = new PreviousDocumentDSContext(){StartTracking = StartTracking})
              {
                ...
                var set = AddIncludes(includesLst, dbContext);
                IEnumerable<PreviousEntry> entities = await set//dbContext.PreviousEntries
             ...
             try
             {
                 using (var dbContext = new PreviousDocumentDSContext(){StartTracking = StartTracking})
                 {
					...
					decimal res = 0;
                     ...
                     if (whereExp == "All")
                     {
                          res = Convert.ToDecimal(dbContext.PreviousEntries.AsNoTracking().Sum(field));
                     }
                     else
                     {
                         res = Convert.ToDecimal(dbContext.PreviousEntries.AsNoTracking().Where(whereExp).Sum(field));
                     }
        ...
        public async Task<decimal> SumNav( string exp, Dictionary<string, string> navExp, string field)
        {
            try
            {
                ...
                {
                    dbContext.Database.CommandTimeout = 0;
                    if (!dbContext.PreviousEntries.Any()) return 0;
                    if (exp == "All" && navExp.Count == 0)
                    {
                        return Convert.ToDecimal(dbContext.PreviousEntries
										.AsNoTracking()
                                        .Sum(field)??0);
                    }
                    foreach (var itm in navExp)
                        ...
                        switch (itm.Key)
                        {
                            ...
                            case "xcuda_Valuation_item":
                                return await SumWhere<xcuda_Valuation_item>(dbContext, exp, itm.Value, "xcuda_Item", field, "SelectMany")
											.ConfigureAwait(continueOnCapturedContext: false);
                            case "xcuda_PreviousItem":
                                return await SumWhere<xcuda_PreviousItem>(dbContext, exp, itm.Value, "PreviousEntry", field, "SelectMany")
											.ConfigureAwait(continueOnCapturedContext: false);
                            case "EntryPreviousItems":
                    ...
                    return Convert.ToDecimal(dbContext.PreviousEntries.Where(exp == "All" || exp == null ? "Item_Id != null" : exp)
											.AsNoTracking()
                                            .Sum(field)??0);
                }
             ...
             try
             {
                 using (var dbContext = new PreviousDocumentDSContext(){StartTracking = StartTracking})
                 {
					...
					string res = "";
                     ...
                     if (whereExp == "All")
                     {
                          res = Convert.ToString(dbContext.PreviousEntries.AsNoTracking().Min(field));
                     }
                     else
                     {
                         res = Convert.ToString(dbContext.PreviousEntries.AsNoTracking().Where(whereExp).Min(field));
                     }
		...
		private static IQueryable<PreviousEntry> AddIncludes(IEnumerable<string> includesLst, PreviousDocumentDSContext dbContext)
       {
		 try
			{
			   if (includesLst == null) includesLst = new List<string>();
			   var set =(DbQuery<PreviousEntry>) dbContext.PreviousEntries; 
	   ...
	   private IQueryable<PreviousEntry> AddWheres(List<string> expLst, IQueryable<PreviousEntry> set)
        {
            try
            {
