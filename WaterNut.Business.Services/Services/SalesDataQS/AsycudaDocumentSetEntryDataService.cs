...
namespace SalesDataQS.Business.Services
{
   ...
   [ServiceBehavior(InstanceContextMode = InstanceContextMode.PerCall,
    ...
    public partial class AsycudaDocumentSetEntryDataService : IAsycudaDocumentSetEntryDataService, IDisposable
    {
        ...
        public Task<IEnumerable<AsycudaDocumentSetEntryData>> GetAsycudaDocumentSetEntryData(List<string> includesLst = null, bool tracking = true)
        {
            try
            {
        ...
        public Task<AsycudaDocumentSetEntryData> GetAsycudaDocumentSetEntryDataByKey(string Id, List<string> includesLst = null, bool tracking = true)
        {
		 ...
		 public Task<IEnumerable<AsycudaDocumentSetEntryData>> GetAsycudaDocumentSetEntryDataByExpression(string exp, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
                using (var dbContext = new SalesDataQSContext(){StartTracking = StartTracking})
		 ...
		 public Task<IEnumerable<AsycudaDocumentSetEntryData>> GetAsycudaDocumentSetEntryDataByExpressionLst(List<string> expLst, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
                using (var dbContext = new SalesDataQSContext(){StartTracking = StartTracking})
        ...
        public Task<IEnumerable<AsycudaDocumentSetEntryData>> GetAsycudaDocumentSetEntryDataByBatch(string exp,
        ...
        public Task<IEnumerable<AsycudaDocumentSetEntryData>> GetAsycudaDocumentSetEntryDataByBatchExpressionLst(List<string> expLst,
                                                                                                                 int totalrow, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
		...
		public Task<int> Count(string exp)
        {
            try
            {
                using (SalesDataQSContext dbContext = new SalesDataQSContext(){StartTracking = StartTracking})
                {
                    ...
                    if (exp == "All")
                    {
                        return Task.FromResult(dbContext.AsycudaDocumentSetEntryData
                            .AsNoTracking()
                            .Count());
                    }
                    else
        ...
        public Task<IEnumerable<AsycudaDocumentSetEntryData>> LoadRange(int startIndex, int count, string exp)
        {
            try
            {
                using (var dbContext = new SalesDataQSContext(){StartTracking = StartTracking})
                {
                    ...
                    if (exp == "All")
                    {
                        return Task.FromResult<IEnumerable<AsycudaDocumentSetEntryData>>(dbContext.AsycudaDocumentSetEntryData
                            .AsNoTracking()
                            .OrderBy(y => y.Id)
                            .Skip(startIndex)
                            .Take(count)
		...
		private static Task<IEnumerable<AsycudaDocumentSetEntryData>> GetWhereSelectMany<T>(SalesDataQSContext dbContext,
		...
		private static Task<IEnumerable<AsycudaDocumentSetEntryData>> GetWhereSelect<T>(SalesDataQSContext dbContext,
                                                                                        string exp, string navExp, string navProp, List<string> includesLst = null) where T : class
        {
			try
			{
