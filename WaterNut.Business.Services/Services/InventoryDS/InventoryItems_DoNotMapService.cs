...
namespace InventoryDS.Business.Services
{
   ...
   [ServiceBehavior(InstanceContextMode = InstanceContextMode.PerCall,
    ...
    public partial class InventoryItems_DoNotMapService : IInventoryItems_DoNotMapService, IDisposable
    {
        ...
        public Task<IEnumerable<InventoryItems_DoNotMap>> GetInventoryItems_DoNotMap(List<string> includesLst = null, bool tracking = true)
        {
            try
            {
        ...
        public Task<InventoryItems_DoNotMap> GetInventoryItems_DoNotMapByKey(string InventoryItemId, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
			   if(string.IsNullOrEmpty(InventoryItemId))return Task.FromResult<InventoryItems_DoNotMap>(null); 
              using ( var dbContext = new InventoryDSContext(){StartTracking = StartTracking})
              {
		 ...
		 public Task<IEnumerable<InventoryItems_DoNotMap>> GetInventoryItems_DoNotMapByExpression(string exp, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
                using (var dbContext = new InventoryDSContext(){StartTracking = StartTracking})
                {
					...
					if (string.IsNullOrEmpty(exp) || exp == "None") return Task.FromResult<IEnumerable<InventoryItems_DoNotMap>>(new List<InventoryItems_DoNotMap>());
					var set = AddIncludes(includesLst, dbContext);
                    if (exp == "All")
                    {
                        ...
                        if(tracking) entities.AsParallel(new ParallelLinqOptions() { MaxDegreeOfParallelism = Environment.ProcessorCount }).ForAll(x => x.StartTracking());
                        return Task.FromResult<IEnumerable<InventoryItems_DoNotMap>>(entities); 
                    }
					else
					{
		 ...
		 public Task<IEnumerable<InventoryItems_DoNotMap>> GetInventoryItems_DoNotMapByExpressionLst(List<string> expLst, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
                using (var dbContext = new InventoryDSContext(){StartTracking = StartTracking})
                {
                    dbContext.Database.CommandTimeout = 0;
					if (expLst.Count == 0 || expLst.FirstOrDefault() == "None") return Task.FromResult<IEnumerable<InventoryItems_DoNotMap>>(new List<InventoryItems_DoNotMap>());
					var set = AddIncludes(includesLst, dbContext);
        ...
        public Task<IEnumerable<InventoryItems_DoNotMap>> GetInventoryItems_DoNotMapByBatch(string exp,
        ...
        public Task<IEnumerable<InventoryItems_DoNotMap>> GetInventoryItems_DoNotMapByBatchExpressionLst(List<string> expLst,
                                                                                                         int totalrow, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
        ...
        public Task<InventoryItems_DoNotMap> UpdateInventoryItems_DoNotMap(InventoryItems_DoNotMap entity)
        { 
            using ( var dbContext = new InventoryDSContext(){StartTracking = StartTracking})
              {
                try
        ...
        public Task<InventoryItems_DoNotMap> CreateInventoryItems_DoNotMap(InventoryItems_DoNotMap entity)
        {
            try
            {
                var res = (InventoryItems_DoNotMap) entity;
        ...
        public Task<bool> DeleteInventoryItems_DoNotMap(string InventoryItemId)
        {
            try
            {
              using ( var dbContext = new InventoryDSContext(){StartTracking = StartTracking})
		...
		public Task<int> Count(string exp)
        {
            try
            {
                using (InventoryDSContext dbContext = new InventoryDSContext(){StartTracking = StartTracking})
                {
                    ...
                    if (exp == "All")
                    {
                        return Task.FromResult(dbContext.InventoryItems_DoNotMap
                            .AsNoTracking()
                            .Count());
                    }
                    else
        ...
        public Task<IEnumerable<InventoryItems_DoNotMap>> LoadRange(int startIndex, int count, string exp)
        {
            try
            {
                using (var dbContext = new InventoryDSContext(){StartTracking = StartTracking})
                {
                    ...
                    if (exp == "All")
                    {
                        return Task.FromResult<IEnumerable<InventoryItems_DoNotMap>>(dbContext.InventoryItems_DoNotMap
                            .AsNoTracking()
		...
		private static Task<IEnumerable<InventoryItems_DoNotMap>> LoadRangeSelectMany<T>(int startIndex, int count,
                                                                                         InventoryDSContext dbContext, string exp, string navExp, string navProp, IEnumerable<string> includeLst = null) where T : class
        {
            ...
            return Task.FromResult<IEnumerable<InventoryItems_DoNotMap>>(set
                .Where(exp == "All" || exp == null ? "InventoryItemId != null" : exp)
                .Distinct()
                .OrderBy(y => y.InventoryItemId)
		...
		private static Task<IEnumerable<InventoryItems_DoNotMap>> LoadRangeSelect<T>(int startIndex, int count,
                                                                                     InventoryDSContext dbContext, string exp, string navExp, string navProp, IEnumerable<string> includeLst = null) where T : class
        {
			try
			{
		...
		private static Task<IEnumerable<InventoryItems_DoNotMap>> GetWhereSelectMany<T>(InventoryDSContext dbContext,
                                                                                        string exp, string navExp, string navProp, List<string> includesLst = null) where T : class
        {
			...
			if (includesLst == null)
			{
				return Task.FromResult<IEnumerable<InventoryItems_DoNotMap>>(dbContext.Set<T>()
                    .AsNoTracking()
                    .Where(navExp)
                    .SelectMany(navProp).OfType<InventoryItems_DoNotMap>()
                    .Where(exp == "All" || exp == null?"InventoryItemId != null":exp)
            ...
            return Task.FromResult<IEnumerable<InventoryItems_DoNotMap>>(set.ToList());
			}
			catch (Exception)
			{
				Debugger.Break();
		...
		private static Task<IEnumerable<InventoryItems_DoNotMap>> GetWhereSelect<T>(InventoryDSContext dbContext,
                                                                                    string exp, string navExp, string navProp, List<string> includesLst = null) where T : class
        {
			try
			{
