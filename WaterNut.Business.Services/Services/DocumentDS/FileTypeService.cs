...
namespace DocumentDS.Business.Services
{
   ...
   [ServiceBehavior(InstanceContextMode = InstanceContextMode.PerCall,
    ...
    public partial class FileTypeService : IFileTypeService, IDisposable
    {
        ...
        public Task<IEnumerable<FileType>> GetFileTypes(List<string> includesLst = null, bool tracking = true)
        {
            try
            {
        ...
        public Task<FileType> GetFileTypeByKey(string Id, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
			   if(string.IsNullOrEmpty(Id))return Task.FromResult<FileType>(null); 
              using ( var dbContext = new DocumentDSContext(){StartTracking = StartTracking})
              {
		 ...
		 public Task<IEnumerable<FileType>> GetFileTypesByExpression(string exp, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
                using (var dbContext = new DocumentDSContext(){StartTracking = StartTracking})
                {
					...
					if (string.IsNullOrEmpty(exp) || exp == "None") return Task.FromResult<IEnumerable<FileType>>(new List<FileType>());
					var set = AddIncludes(includesLst, dbContext);
                    if (exp == "All")
                    {
                        ...
                        if(tracking) entities.AsParallel(new ParallelLinqOptions() { MaxDegreeOfParallelism = Environment.ProcessorCount }).ForAll(x => x.StartTracking());
                        return Task.FromResult<IEnumerable<FileType>>(entities); 
                    }
					else
					{
		 ...
		 public Task<IEnumerable<FileType>> GetFileTypesByExpressionLst(List<string> expLst, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
                using (var dbContext = new DocumentDSContext(){StartTracking = StartTracking})
                {
                    dbContext.Database.CommandTimeout = 0;
					if (expLst.Count == 0 || expLst.FirstOrDefault() == "None") return Task.FromResult<IEnumerable<FileType>>(new List<FileType>());
					var set = AddIncludes(includesLst, dbContext);
        ...
        public Task<IEnumerable<FileType>> GetFileTypesByBatch(string exp,
        ...
        public Task<IEnumerable<FileType>> GetFileTypesByBatchExpressionLst(List<string> expLst,
                                                                            int totalrow, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
        ...
        public Task<FileType> UpdateFileType(FileType entity)
        { 
            using ( var dbContext = new DocumentDSContext(){StartTracking = StartTracking})
              {
                try
        ...
        public Task<FileType> CreateFileType(FileType entity)
        {
            try
            {
                var res = (FileType) entity;
        ...
        public Task<bool> DeleteFileType(string Id)
        {
            try
            {
              using ( var dbContext = new DocumentDSContext(){StartTracking = StartTracking})
        ...
        public Task<IEnumerable<FileType>> LoadRange(int startIndex, int count, string exp)
        {
            try
            {
                using (var dbContext = new DocumentDSContext(){StartTracking = StartTracking})
                {
                    ...
                    if (exp == "All")
                    {
                        return Task.FromResult<IEnumerable<FileType>>(dbContext.FileTypes
                            .AsNoTracking()
                            .OrderBy(y => y.Id)
                            .Skip(startIndex)
                            .Take(count)
		...
		private static Task<IEnumerable<FileType>> LoadRangeSelectMany<T>(int startIndex, int count,
                                                                          DocumentDSContext dbContext, string exp, string navExp, string navProp, IEnumerable<string> includeLst = null) where T : class
        {
            ...
            return Task.FromResult<IEnumerable<FileType>>(set
                .Where(exp == "All" || exp == null ? "Id != null" : exp)
                .Distinct()
                .OrderBy(y => y.Id)
		...
		private static Task<IEnumerable<FileType>> LoadRangeSelect<T>(int startIndex, int count,
                                                                      DocumentDSContext dbContext, string exp, string navExp, string navProp, IEnumerable<string> includeLst = null) where T : class
        {
			try
			{
		...
		private static Task<IEnumerable<FileType>> GetWhereSelectMany<T>(DocumentDSContext dbContext,
                                                                         string exp, string navExp, string navProp, List<string> includesLst = null) where T : class
        {
			...
			if (includesLst == null)
			{
				return Task.FromResult<IEnumerable<FileType>>(dbContext.Set<T>()
                    .AsNoTracking()
                    .Where(navExp)
                    .SelectMany(navProp).OfType<FileType>()
                    .Where(exp == "All" || exp == null?"Id != null":exp)
            ...
            return Task.FromResult<IEnumerable<FileType>>(set.ToList());
			}
			catch (Exception)
			{
				Debugger.Break();
		...
		private static Task<IEnumerable<FileType>> GetWhereSelect<T>(DocumentDSContext dbContext,
                                                                     string exp, string navExp, string navProp, List<string> includesLst = null) where T : class
        {
			try
			{
			...
			catch (Exception)
			{
				...
				throw;
			        ...
			        public Task<IEnumerable<FileType>> GetFileTypeByApplicationSettingsId(string ApplicationSettingsId, List<string> includesLst = null)
        {
            try
            {
                using ( var dbContext = new DocumentDSContext(){StartTracking = StartTracking})
            ...
            catch (Exception updateEx)
            {
 	        ...
 	        public Task<IEnumerable<FileType>> GetFileTypeByFileGroupId(string FileGroupId, List<string> includesLst = null)
        {
            try
            {
                using ( var dbContext = new DocumentDSContext(){StartTracking = StartTracking})
            ...
            catch (Exception updateEx)
            {
 	        ...
 	        public Task<IEnumerable<FileType>> GetFileTypeByParentFileTypeId(string ParentFileTypeId, List<string> includesLst = null)
        {
            try
            {
                using ( var dbContext = new DocumentDSContext(){StartTracking = StartTracking})
            ...
            catch (Exception updateEx)
            {
 	        ...
 	        public Task<IEnumerable<FileType>> GetFileTypeByOldFileTypeId(string OldFileTypeId, List<string> includesLst = null)
        {
            try
            {
                using ( var dbContext = new DocumentDSContext(){StartTracking = StartTracking})
            ...
            catch (Exception updateEx)
            {
 	        ...
 	        public Task<IEnumerable<FileType>> GetFileTypeByFileInfoId(string FileInfoId, List<string> includesLst = null)
        {
            try
            {
                using ( var dbContext = new DocumentDSContext(){StartTracking = StartTracking})
