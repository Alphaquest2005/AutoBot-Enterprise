    ...
    public partial class AttachmentService : IAttachmentService, IDisposable
    {
            ...
            //using (var scope = new TransactionScope(TransactionScopeOption.Required,
               ...
               // {
                  using ( var dbContext = new DocumentDSContext(){StartTracking = StartTracking})
                  {
                    ...
                    IEnumerable<Attachment> entities = await set.AsNoTracking().ToListAsync()
        ...
        public async Task<Attachment> GetAttachmentByKey(string Id, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
              ...
              using ( var dbContext = new DocumentDSContext(){StartTracking = StartTracking})
              {
				...
				var set = AddIncludes(includesLst, dbContext);
                Attachment entity = await set.AsNoTracking().SingleOrDefaultAsync(x => x.Id == i).ConfigureAwait(continueOnCapturedContext: false);
        ...
        public async Task<bool> DeleteAttachment(string Id)
        {
            try
            {
              ...
              {
                var i = Convert.ToInt32(Id);
                Attachment entity = await dbContext.Attachments
			        ...
			        public async Task<IEnumerable<Attachment>> GetAttachmentByEmailId(string EmailId, List<string> includesLst = null)
        {
            try
            {
                using ( var dbContext = new DocumentDSContext(){StartTracking = StartTracking})
              {
                var i = EmailId;
                var set = AddIncludes(includesLst, dbContext);
                IEnumerable<Attachment> entities = await set//dbContext.Attachments
