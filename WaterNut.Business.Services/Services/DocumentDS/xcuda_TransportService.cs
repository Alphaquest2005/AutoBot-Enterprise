...
{
   [Export (typeof(Ixcuda_TransportService))]
   [Export(typeof(IBusinessService))]
   [PartCreationPolicy(CreationPolicy.NonShared)]
   [ServiceBehavior(InstanceContextMode = InstanceContextMode.PerCall,
                    ConcurrencyMode = ConcurrencyMode.Multiple)]
   
    public partial class xcuda_TransportService : Ixcuda_TransportService, IDisposable
    {
        //private readonly DocumentDSContext dbContext;

        public bool StartTracking { get; set; }

        public xcuda_TransportService()
        {
            try
            {
            ...
            //using (var scope = new TransactionScope(TransactionScopeOption.Required,
               ...
               // {
                  using ( var dbContext = new DocumentDSContext(){StartTracking = StartTracking})
                  {
                    ...
                    IEnumerable<xcuda_Transport> entities = await set.AsNoTracking().ToListAsync()
        ...
        public async Task<xcuda_Transport> Getxcuda_TransportByKey(string Transport_Id, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
              ...
              using ( var dbContext = new DocumentDSContext(){StartTracking = StartTracking})
              {
				...
				var set = AddIncludes(includesLst, dbContext);
                xcuda_Transport entity = await set.AsNoTracking().SingleOrDefaultAsync(x => x.Transport_Id == i).ConfigureAwait(continueOnCapturedContext: false);
		...
		public async Task<IEnumerable<xcuda_Transport>> Getxcuda_TransportByExpressionNav(string exp,
                    ...
                    foreach (var itm in navExp)
                    {
                        switch (itm.Key)
                        {
                            case "xcuda_ASYCUDA":
                                return
                                    await
                                        GetWhere<xcuda_ASYCUDA>(dbContext, exp, itm.Value, "xcuda_Transport", "SelectMany", includesLst)
										.ConfigureAwait(continueOnCapturedContext: false);

                            case "xcuda_Border_office":
                                return
                                    await
                                        GetWhere<xcuda_Border_office>(dbContext, exp, itm.Value, "xcuda_Transport", "Select", includesLst)
										.ConfigureAwait(continueOnCapturedContext: false);

                            case "xcuda_Delivery_terms":
                                return
                                    await
                                        GetWhere<xcuda_Delivery_terms>(dbContext, exp, itm.Value, "xcuda_Transport", "Select", includesLst)
										.ConfigureAwait(continueOnCapturedContext: false);

                            case "xcuda_Means_of_transport":
                                return
                                    await
                                        GetWhere<xcuda_Means_of_transport>(dbContext, exp, itm.Value, "xcuda_Transport", "Select", includesLst)
										.ConfigureAwait(continueOnCapturedContext: false);

                            case "xcuda_Place_of_loading":
                                return
                                    await
                                        GetWhere<xcuda_Place_of_loading>(dbContext, exp, itm.Value, "xcuda_Transport", "Select", includesLst)
										.ConfigureAwait(continueOnCapturedContext: false);
            ...
            int totalrow, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
                ...
                var res = new ConcurrentQueue<List<xcuda_Transport>>();
                    ...
                    //  for (int bat = 0; bat < batches; bat++)
                    {
                        try
                        {
                            using (var dbContext = new DocumentDSContext(){StartTracking = StartTracking})
                            {
                                ...
                                var set = AddIncludes(includesLst, dbContext);
                                IQueryable<xcuda_Transport> dset;
                                if (exp == "All")
                                {
                                    dset = set.OrderBy(x => x.Transport_Id);
                                }
                                else
                                {
                                    dset = set.OrderBy(x => x.Transport_Id).Where(exp);
                                }
            ...
            using ( var dbContext = new DocumentDSContext(){StartTracking = StartTracking})
              {
                try
                {   
                     var res = (xcuda_Transport) entity;
        ...
        public async Task<bool> Deletexcuda_Transport(string Transport_Id)
        {
            try
            {
              ...
              {
                var i = Convert.ToInt32(Transport_Id);
                xcuda_Transport entity = await dbContext.xcuda_Transport
													.SingleOrDefaultAsync(x => x.Transport_Id == i)
													.ConfigureAwait(continueOnCapturedContext: false);
                if (entity == null)
                    return false;
        ...
        public async Task<bool> RemoveSelectedxcuda_Transport(IEnumerable<string> lst)
        {
            try
            {
                StatusModel.StartStatusUpdate("Removing xcuda_Transport", lst.Count());
                var t = Task.Run(() =>
                {
                    using (var ctx = new xcuda_TransportService())
                    {
                        foreach (var item in lst.ToList())
                        {
                            ...
                            ctx.Deletexcuda_Transport(item).Wait();
		...
		public async Task<int> Count(string exp)
        {
            try
            {
                using (DocumentDSContext dbContext = new DocumentDSContext(){StartTracking = StartTracking})
                {
                    ...
                    if (exp == "All")
                    {
                        return await dbContext.xcuda_Transport
                                    .AsNoTracking()
									.CountAsync()
									.ConfigureAwait(continueOnCapturedContext: false);
                    }
            ...
            try
            {
                ...
                using (var dbContext = new DocumentDSContext(){StartTracking = StartTracking})
                {
                    ...
                    foreach (var itm in navExp)
                    {
                        ...
                        {
                            case "xcuda_ASYCUDA":
                                return await CountWhere<xcuda_ASYCUDA>(dbContext, exp, itm.Value, "xcuda_Transport", "SelectMany")
											.ConfigureAwait(continueOnCapturedContext: false);
                            case "xcuda_Border_office":
                                return await CountWhere<xcuda_Border_office>(dbContext, exp, itm.Value, "xcuda_Transport", "Select")
											.ConfigureAwait(continueOnCapturedContext: false);
                            case "xcuda_Delivery_terms":
                                return await CountWhere<xcuda_Delivery_terms>(dbContext, exp, itm.Value, "xcuda_Transport", "Select")
											.ConfigureAwait(continueOnCapturedContext: false);
                            case "xcuda_Means_of_transport":
                                return await CountWhere<xcuda_Means_of_transport>(dbContext, exp, itm.Value, "xcuda_Transport", "Select")
											.ConfigureAwait(continueOnCapturedContext: false);
                            case "xcuda_Place_of_loading":
                                return await CountWhere<xcuda_Place_of_loading>(dbContext, exp, itm.Value, "xcuda_Transport", "Select")
											.ConfigureAwait(continueOnCapturedContext: false);
						}
                    }
                    return await dbContext.xcuda_Transport.Where(exp == "All" || exp == null ? "Transport_Id != null" : exp)
											.AsNoTracking()
                                            .CountAsync()
											.ConfigureAwait(continueOnCapturedContext: false);
                }
		...
		private static async Task<int> CountWhereSelect<T>(DocumentDSContext dbContext, string exp, string navExp, string navProp) where T : class
        {
		  ...
		  public async Task<IEnumerable<xcuda_Transport>> LoadRangeNav(int startIndex, int count, string exp,
                                                                                 Dictionary<string, string> navExp, IEnumerable<string> includeLst = null)
        {
            try
            {
                using (var dbContext = new DocumentDSContext(){StartTracking = StartTracking})
                {
                    if ((string.IsNullOrEmpty(exp) && navExp.Count == 0) || exp == "None") return new List<xcuda_Transport>();
                    ...
                    foreach (var itm in navExp)
                    {
                        switch (itm.Key)
                        {
                            case "xcuda_ASYCUDA":
                                return
                                    await
                                        LoadRangeWhere<xcuda_ASYCUDA>(startIndex, count, dbContext, exp, itm.Value, "xcuda_Transport", "SelectMany")
													.ConfigureAwait(continueOnCapturedContext: false);

                            case "xcuda_Border_office":
                                return
                                    await
                                        LoadRangeWhere<xcuda_Border_office>(startIndex, count, dbContext, exp, itm.Value, "xcuda_Transport", "Select")
													.ConfigureAwait(continueOnCapturedContext: false);

                            case "xcuda_Delivery_terms":
                                return
                                    await
                                        LoadRangeWhere<xcuda_Delivery_terms>(startIndex, count, dbContext, exp, itm.Value, "xcuda_Transport", "Select")
													.ConfigureAwait(continueOnCapturedContext: false);

                            case "xcuda_Means_of_transport":
                                return
                                    await
                                        LoadRangeWhere<xcuda_Means_of_transport>(startIndex, count, dbContext, exp, itm.Value, "xcuda_Transport", "Select")
													.ConfigureAwait(continueOnCapturedContext: false);

                            case "xcuda_Place_of_loading":
                                return
                                    await
                                        LoadRangeWhere<xcuda_Place_of_loading>(startIndex, count, dbContext, exp, itm.Value, "xcuda_Transport", "Select")
													.ConfigureAwait(continueOnCapturedContext: false);
                    ...
                    return await set//dbContext.xcuda_Transport
								.AsNoTracking()
                                .Where(exp == "All" || exp == null ? "Transport_Id != null" : exp)
								.OrderBy(y => y.Transport_Id)
		...
		private static async Task<IEnumerable<xcuda_Transport>> LoadRangeWhere<T>(int startIndex, int count,
        ...
        private static async Task<IEnumerable<xcuda_Transport>> GetWhere<T>(DocumentDSContext dbContext,
			        ...
			        public async Task<IEnumerable<xcuda_Transport>> Getxcuda_TransportByASYCUDA_Id(string ASYCUDA_Id, List<string> includesLst = null)
        {
            try
            {
                using ( var dbContext = new DocumentDSContext(){StartTracking = StartTracking})
              {
                ...
                var set = AddIncludes(includesLst, dbContext);
                IEnumerable<xcuda_Transport> entities = await set//dbContext.xcuda_Transport
                                                    // .Include(x => x.xcuda_Border_office)									  
                                                    // .Include(x => x.xcuda_Delivery_terms)									  
                                                    // .Include(x => x.xcuda_Means_of_transport)									  
                                                    // .Include(x => x.xcuda_Place_of_loading)									  
                                      .AsNoTracking()
             ...
             try
             {
                 using (var dbContext = new DocumentDSContext(){StartTracking = StartTracking})
                 {
					decimal res = 0;
                     ...
                     if (whereExp == "All")
                     {
                          res = Convert.ToDecimal(dbContext.xcuda_Transport.AsNoTracking().Sum(field));
                     }
                     else
                     {
                         res = Convert.ToDecimal(dbContext.xcuda_Transport.AsNoTracking().Where(whereExp).Sum(field));
                     }
        ...
        public async Task<decimal> SumNav( string exp, Dictionary<string, string> navExp, string field)
        {
            try
            {
                ...
                using (var dbContext = new DocumentDSContext(){StartTracking = StartTracking})
                {
                    if (!dbContext.xcuda_Transport.Any()) return 0;
                    if (exp == "All" && navExp.Count == 0)
                    {
                        return Convert.ToDecimal(dbContext.xcuda_Transport
										.AsNoTracking()
                                        .Sum(field)??0);
                    }
                    foreach (var itm in navExp)
                    {
                        ...
                        {
                            case "xcuda_ASYCUDA":
                                return await SumWhere<xcuda_ASYCUDA>(dbContext, exp, itm.Value, "xcuda_Transport", field, "SelectMany")
											.ConfigureAwait(continueOnCapturedContext: false);
                            case "xcuda_Border_office":
                                return await SumWhere<xcuda_Border_office>(dbContext, exp, itm.Value, "xcuda_Transport", field, "Select")
											.ConfigureAwait(continueOnCapturedContext: false);
                            case "xcuda_Delivery_terms":
                                return await SumWhere<xcuda_Delivery_terms>(dbContext, exp, itm.Value, "xcuda_Transport", field, "Select")
											.ConfigureAwait(continueOnCapturedContext: false);
                            case "xcuda_Means_of_transport":
                                return await SumWhere<xcuda_Means_of_transport>(dbContext, exp, itm.Value, "xcuda_Transport", field, "Select")
											.ConfigureAwait(continueOnCapturedContext: false);
                            case "xcuda_Place_of_loading":
                                return await SumWhere<xcuda_Place_of_loading>(dbContext, exp, itm.Value, "xcuda_Transport", field, "Select")
											.ConfigureAwait(continueOnCapturedContext: false);
						}
                    }
                    return Convert.ToDecimal(dbContext.xcuda_Transport.Where(exp == "All" || exp == null ? "Transport_Id != null" : exp)
											.AsNoTracking()
                                            .Sum(field)??0);
                }
             ...
             try
             {
                 using (var dbContext = new DocumentDSContext(){StartTracking = StartTracking})
                 {
					string res = "";
                     ...
                     if (whereExp == "All")
                     {
                          res = Convert.ToString(dbContext.xcuda_Transport.AsNoTracking().Min(field));
                     }
                     else
                     {
                         res = Convert.ToString(dbContext.xcuda_Transport.AsNoTracking().Where(whereExp).Min(field));
                     }
		...
		private static IQueryable<xcuda_Transport> AddIncludes(IEnumerable<string> includesLst, DocumentDSContext dbContext)
       {
		 try
			{
			   if (includesLst == null) includesLst = new List<string>();
			   var set =(DbQuery<xcuda_Transport>) dbContext.xcuda_Transport; 
	   ...
	   private IQueryable<xcuda_Transport> AddWheres(List<string> expLst, IQueryable<xcuda_Transport> set)
        {
            try
            {
