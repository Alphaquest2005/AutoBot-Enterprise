...
namespace DocumentDS.Business.Services
{
   ...
   [ServiceBehavior(InstanceContextMode = InstanceContextMode.PerCall,
    ...
    public partial class AsycudaDocumentSet_AttachmentsService : IAsycudaDocumentSet_AttachmentsService, IDisposable
    {
		...
		private static Task<IEnumerable<AsycudaDocumentSet_Attachments>> GetWhereSelectMany<T>(DocumentDSContext dbContext,
		...
		private static Task<IEnumerable<AsycudaDocumentSet_Attachments>> GetWhereSelect<T>(DocumentDSContext dbContext,
                                                                                           string exp, string navExp, string navProp, List<string> includesLst = null) where T : class
        {
			try
			{
