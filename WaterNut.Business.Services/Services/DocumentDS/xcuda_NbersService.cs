...
namespace DocumentDS.Business.Services
{
   ...
   [ServiceBehavior(InstanceContextMode = InstanceContextMode.PerCall,
    ...
    public partial class xcuda_NbersService : Ixcuda_NbersService, IDisposable
    {
        ...
        public async Task<IEnumerable<xcuda_Nbers>> Getxcuda_Nbers(List<string> includesLst = null, bool tracking = true)
        {
            try
            {
            //using (var scope = new TransactionScope(TransactionScopeOption.Required,
               ...
               // {
                  using ( var dbContext = new DocumentDSContext(){StartTracking = StartTracking})
                  {
                    ...
                    IEnumerable<xcuda_Nbers> entities = await set.AsNoTracking().ToListAsync()
        ...
        public async Task<xcuda_Nbers> Getxcuda_NbersByKey(string ASYCUDA_Id, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
              ...
              using ( var dbContext = new DocumentDSContext(){StartTracking = StartTracking})
              {
				...
				var set = AddIncludes(includesLst, dbContext);
                xcuda_Nbers entity = await set.AsNoTracking().SingleOrDefaultAsync(x => x.ASYCUDA_Id == i).ConfigureAwait(continueOnCapturedContext: false);
		 ...
		 public async Task<IEnumerable<xcuda_Nbers>> Getxcuda_NbersByExpression(string exp, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
                using (var dbContext = new DocumentDSContext(){StartTracking = StartTracking})
		 ...
		 public async Task<IEnumerable<xcuda_Nbers>> Getxcuda_NbersByExpressionLst(List<string> expLst, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
                using (var dbContext = new DocumentDSContext(){StartTracking = StartTracking})
                {
                    dbContext.Database.CommandTimeout = 0;
					if (expLst.Count == 0 || expLst.FirstOrDefault() == "None") return new List<xcuda_Nbers>();
					var set = AddIncludes(includesLst, dbContext);
        ...
        public async Task<IEnumerable<xcuda_Nbers>> Getxcuda_NbersByBatch(string exp,
        ...
        public async Task<IEnumerable<xcuda_Nbers>> Getxcuda_NbersByBatchExpressionLst(List<string> expLst,
            int totalrow, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
        ...
        public async Task<xcuda_Nbers> Updatexcuda_Nbers(xcuda_Nbers entity)
        { 
            using ( var dbContext = new DocumentDSContext(){StartTracking = StartTracking})
              {
                try
        ...
        public async Task<xcuda_Nbers> Createxcuda_Nbers(xcuda_Nbers entity)
        {
            try
            {
                var res = (xcuda_Nbers) entity;
        ...
        public async Task<bool> Deletexcuda_Nbers(string ASYCUDA_Id)
        {
            try
            {
              using ( var dbContext = new DocumentDSContext(){StartTracking = StartTracking})
              {
                var i = Convert.ToInt32(ASYCUDA_Id);
                xcuda_Nbers entity = await dbContext.xcuda_Nbers
		...
		public async Task<int> Count(string exp)
        {
            try
            {
                using (DocumentDSContext dbContext = new DocumentDSContext(){StartTracking = StartTracking})
                {
                    ...
                    if (exp == "All")
                    {
                        return await dbContext.xcuda_Nbers
                                    .AsNoTracking()
									.CountAsync()
									.ConfigureAwait(continueOnCapturedContext: false);
                    }
        ...
        public async Task<IEnumerable<xcuda_Nbers>> LoadRange(int startIndex, int count, string exp)
        {
            try
            {
                using (var dbContext = new DocumentDSContext(){StartTracking = StartTracking})
		...
		public async Task<int> CountNav(string exp, Dictionary<string, string> navExp)
        {
            try
            {
                ...
                using (var dbContext = new DocumentDSContext(){StartTracking = StartTracking})
                {
                    ...
                    return await dbContext.xcuda_Nbers.Where(exp == "All" || exp == null ? "ASYCUDA_Id != null" : exp)
											.AsNoTracking()
                                            .CountAsync()
											.ConfigureAwait(continueOnCapturedContext: false);
                }
                                                                                 ...
                                                                                 Dictionary<string, string> navExp, IEnumerable<string> includeLst = null)
        {
            try
            {
                using (var dbContext = new DocumentDSContext(){StartTracking = StartTracking})
                {
                    ...
                    return await set//dbContext.xcuda_Nbers
								.AsNoTracking()
                                .Where(exp == "All" || exp == null ? "ASYCUDA_Id != null" : exp)
								.OrderBy(y => y.ASYCUDA_Id)
		...
		private static async Task<IEnumerable<xcuda_Nbers>> LoadRangeSelectMany<T>(int startIndex, int count,
		...
		private static async Task<IEnumerable<xcuda_Nbers>> LoadRangeSelect<T>(int startIndex, int count,
            DocumentDSContext dbContext, string exp, string navExp, string navProp, IEnumerable<string> includeLst = null) where T : class
        {
			try
			{
		...
		private static async Task<IEnumerable<xcuda_Nbers>> GetWhereSelectMany<T>(DocumentDSContext dbContext,
		...
		private static async Task<IEnumerable<xcuda_Nbers>> GetWhereSelect<T>(DocumentDSContext dbContext,
            string exp, string navExp, string navProp, List<string> includesLst = null) where T : class
        {
			try
			{
