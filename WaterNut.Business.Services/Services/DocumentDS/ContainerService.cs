...
namespace DocumentDS.Business.Services
{
   ...
   [ServiceBehavior(InstanceContextMode = InstanceContextMode.PerCall,
    ...
    public partial class ContainerService : IContainerService, IDisposable
    {
        ...
        public async Task<Container> GetContainerByKey(string AsycudaDocumentSetId, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
        ...
        public async Task<bool> DeleteContainer(string AsycudaDocumentSetId)
        {
            try
            {
              using ( var dbContext = new DocumentDSContext(){StartTracking = StartTracking})
		...
		private static async Task<IEnumerable<Container>> GetWhereSelectMany<T>(DocumentDSContext dbContext,
		...
		private static async Task<IEnumerable<Container>> GetWhereSelect<T>(DocumentDSContext dbContext,
            string exp, string navExp, string navProp, List<string> includesLst = null) where T : class
        {
			try
			{
