    ...
    public partial class Customs_ProcedureService : ICustoms_ProcedureService, IDisposable
    {
            ...
            //using (var scope = new TransactionScope(TransactionScopeOption.Required,
               ...
               // {
                  using ( var dbContext = new DocumentDSContext(){StartTracking = StartTracking})
                  {
                    ...
                    IEnumerable<Customs_Procedure> entities = await set.AsNoTracking().ToListAsync()
        ...
        public async Task<Customs_Procedure> GetCustoms_ProcedureByKey(string Customs_ProcedureId, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
              ...
              using ( var dbContext = new DocumentDSContext(){StartTracking = StartTracking})
              {
				...
				var set = AddIncludes(includesLst, dbContext);
                Customs_Procedure entity = await set.AsNoTracking().SingleOrDefaultAsync(x => x.Customs_ProcedureId == i).ConfigureAwait(continueOnCapturedContext: false);
        ...
        public async Task<bool> DeleteCustoms_Procedure(string Customs_ProcedureId)
        {
            try
            {
              ...
              {
                var i = Convert.ToInt32(Customs_ProcedureId);
                Customs_Procedure entity = await dbContext.Customs_Procedure
													.SingleOrDefaultAsync(x => x.Customs_ProcedureId == i)
													.ConfigureAwait(continueOnCapturedContext: false);
                if (entity == null)
                    return false;
		...
		public async Task<int> Count(string exp)
        {
            try
            {
                using (DocumentDSContext dbContext = new DocumentDSContext(){StartTracking = StartTracking})
                {
                    ...
                    if (exp == "All")
                    {
                        return await dbContext.Customs_Procedure
                                    .AsNoTracking()
									.CountAsync()
									.ConfigureAwait(continueOnCapturedContext: false);
                    }
                                                                                 ...
                                                                                 Dictionary<string, string> navExp, IEnumerable<string> includeLst = null)
        {
            try
            {
                using (var dbContext = new DocumentDSContext(){StartTracking = StartTracking})
                {
                    ...
                    return await set//dbContext.Customs_Procedure
								.AsNoTracking()
                                .Where(exp == "All" || exp == null ? "Customs_ProcedureId != null" : exp)
								.OrderBy(y => y.Customs_ProcedureId)
