    ...
    public partial class xcuda_TarificationService : Ixcuda_TarificationService, IDisposable
    {
            ...
            //using (var scope = new TransactionScope(TransactionScopeOption.Required,
               ...
               // {
                  using ( var dbContext = new DocumentItemDSContext(){StartTracking = StartTracking})
                  {
                    ...
                    IEnumerable<xcuda_Tarification> entities = await set.AsNoTracking().ToListAsync()
        ...
        public async Task<xcuda_Tarification> Getxcuda_TarificationByKey(string Item_Id, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
              ...
              using ( var dbContext = new DocumentItemDSContext(){StartTracking = StartTracking})
              {
				...
				var set = AddIncludes(includesLst, dbContext);
                xcuda_Tarification entity = await set.AsNoTracking().SingleOrDefaultAsync(x => x.Item_Id == i).ConfigureAwait(continueOnCapturedContext: false);
        ...
        public async Task<bool> Deletexcuda_Tarification(string Item_Id)
        {
            try
            {
              ...
              {
                var i = Convert.ToInt32(Item_Id);
                xcuda_Tarification entity = await dbContext.xcuda_Tarification
		...
		public async Task<int> Count(string exp)
        {
            try
            {
                using (DocumentItemDSContext dbContext = new DocumentItemDSContext(){StartTracking = StartTracking})
                {
                    ...
                    if (exp == "All")
                    {
                        return await dbContext.xcuda_Tarification
                                    .AsNoTracking()
									.CountAsync()
									.ConfigureAwait(continueOnCapturedContext: false);
                    }
		...
		public async Task<int> CountNav(string exp, Dictionary<string, string> navExp)
        {
            try
            {
                ...
                using (var dbContext = new DocumentItemDSContext(){StartTracking = StartTracking})
                {
                    ...
                    return await dbContext.xcuda_Tarification.Where(exp == "All" || exp == null ? "Item_Id != null" : exp)
											.AsNoTracking()
                                            .CountAsync()
											.ConfigureAwait(continueOnCapturedContext: false);
                }
                                                                                 ...
                                                                                 Dictionary<string, string> navExp, IEnumerable<string> includeLst = null)
        {
            try
            {
                using (var dbContext = new DocumentItemDSContext(){StartTracking = StartTracking})
                {
                    ...
                    return await set//dbContext.xcuda_Tarification
								.AsNoTracking()
                                .Where(exp == "All" || exp == null ? "Item_Id != null" : exp)
								.OrderBy(y => y.Item_Id)
		...
		private static async Task<IEnumerable<xcuda_Tarification>> GetWhereSelectMany<T>(DocumentItemDSContext dbContext,
		...
		private static async Task<IEnumerable<xcuda_Tarification>> GetWhereSelect<T>(DocumentItemDSContext dbContext,
            string exp, string navExp, string navProp, List<string> includesLst = null) where T : class
        {
			try
			{
