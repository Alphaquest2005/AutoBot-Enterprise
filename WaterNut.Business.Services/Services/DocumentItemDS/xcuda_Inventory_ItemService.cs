...
namespace DocumentItemDS.Business.Services
{
   ...
   [ServiceBehavior(InstanceContextMode = InstanceContextMode.PerCall,
    ...
    public partial class xcuda_Inventory_ItemService : Ixcuda_Inventory_ItemService, IDisposable
    {
		...
		private static Task<IEnumerable<xcuda_Inventory_Item>> GetWhereSelectMany<T>(DocumentItemDSContext dbContext,
		...
		private static Task<IEnumerable<xcuda_Inventory_Item>> GetWhereSelect<T>(DocumentItemDSContext dbContext,
                                                                                 string exp, string navExp, string navProp, List<string> includesLst = null) where T : class
        {
			try
			{
