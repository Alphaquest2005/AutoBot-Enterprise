...
namespace DocumentItemDS.Business.Services
{
   ...
   [ServiceBehavior(InstanceContextMode = InstanceContextMode.PerCall,
    ...
    public partial class AttachmentsService : IAttachmentsService, IDisposable
    {
        ...
        public Task<IEnumerable<Attachments>> GetAttachments(List<string> includesLst = null, bool tracking = true)
        {
            try
            {
            //using (var scope = new TransactionScope(TransactionScopeOption.Required,
               ...
               // {
                  using ( var dbContext = new DocumentItemDSContext(){StartTracking = StartTracking})
                  {
                    ...
                    IEnumerable<Attachments> entities = set.AsNoTracking().ToList();
                           //scope.Complete();
        ...
        public Task<Attachments> GetAttachmentsByKey(string Id, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
			   if(string.IsNullOrEmpty(Id))return Task.FromResult<Attachments>(null); 
              using ( var dbContext = new DocumentItemDSContext(){StartTracking = StartTracking})
              {
                var i = Convert.ToInt32(Id);
				var set = AddIncludes(includesLst, dbContext);
                Attachments entity = set.AsNoTracking().SingleOrDefault(x => x.Id == i);
		 ...
		 public Task<IEnumerable<Attachments>> GetAttachmentsByExpression(string exp, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
                using (var dbContext = new DocumentItemDSContext(){StartTracking = StartTracking})
                {
					...
					if (string.IsNullOrEmpty(exp) || exp == "None") return Task.FromResult<IEnumerable<Attachments>>(new List<Attachments>());
					var set = AddIncludes(includesLst, dbContext);
                    if (exp == "All")
                    {
                        ...
                        if(tracking) entities.AsParallel(new ParallelLinqOptions() { MaxDegreeOfParallelism = Environment.ProcessorCount }).ForAll(x => x.StartTracking());
                        return Task.FromResult<IEnumerable<Attachments>>(entities); 
                    }
					else
					{
		 ...
		 public Task<IEnumerable<Attachments>> GetAttachmentsByExpressionLst(List<string> expLst, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
                using (var dbContext = new DocumentItemDSContext(){StartTracking = StartTracking})
                {
                    dbContext.Database.CommandTimeout = 0;
					if (expLst.Count == 0 || expLst.FirstOrDefault() == "None") return Task.FromResult<IEnumerable<Attachments>>(new List<Attachments>());
					var set = AddIncludes(includesLst, dbContext);
                    ...
                    foreach (var itm in navExp)
                    {
                        switch (itm.Key)
                        {
                            case "xcuda_Attachments":
                                return
                                    await
                                        GetWhere<xcuda_Attachments>(dbContext, exp, itm.Value, "Attachments", "Select", includesLst)
        ...
        public Task<IEnumerable<Attachments>> GetAttachmentsByBatch(string exp,
        ...
        public Task<IEnumerable<Attachments>> GetAttachmentsByBatchExpressionLst(List<string> expLst,
                                                                                 int totalrow, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
        ...
        public Task<Attachments> UpdateAttachments(Attachments entity)
        { 
            using ( var dbContext = new DocumentItemDSContext(){StartTracking = StartTracking})
              {
                try
        ...
        public Task<Attachments> CreateAttachments(Attachments entity)
        {
            try
            {
                var res = (Attachments) entity;
        ...
        public Task<bool> DeleteAttachments(string Id)
        {
            try
            {
              using ( var dbContext = new DocumentItemDSContext(){StartTracking = StartTracking})
              {
                var i = Convert.ToInt32(Id);
                Attachments entity = dbContext.Attachments
        ...
        public Task<IEnumerable<Attachments>> LoadRange(int startIndex, int count, string exp)
        {
            try
            {
                using (var dbContext = new DocumentItemDSContext(){StartTracking = StartTracking})
                {
                    ...
                    if (exp == "All")
                    {
                        return Task.FromResult<IEnumerable<Attachments>>(dbContext.Attachments
                            .AsNoTracking()
                            .OrderBy(y => y.Id)
                            .Skip(startIndex)
                            .Take(count)
            ...
            try
            {
                ...
                using (var dbContext = new DocumentItemDSContext(){StartTracking = StartTracking})
                {
                    ...
                    foreach (var itm in navExp)
                    {
                        ...
                        {
                            case "xcuda_Attachments":
                                return await CountWhere<xcuda_Attachments>(dbContext, exp, itm.Value, "Attachments", "Select")
											.ConfigureAwait(continueOnCapturedContext: false);
						}
                    }
                    ...
                    foreach (var itm in navExp)
                    {
                        switch (itm.Key)
                        {
                            case "xcuda_Attachments":
                                return
                                    await
                                        LoadRangeWhere<xcuda_Attachments>(startIndex, count, dbContext, exp, itm.Value, "Attachments", "Select")
													.ConfigureAwait(continueOnCapturedContext: false);
		...
		private static Task<IEnumerable<Attachments>> LoadRangeSelectMany<T>(int startIndex, int count,
                                                                             DocumentItemDSContext dbContext, string exp, string navExp, string navProp, IEnumerable<string> includeLst = null) where T : class
        {
            ...
            return Task.FromResult<IEnumerable<Attachments>>(set
                .Where(exp == "All" || exp == null ? "Id != null" : exp)
                .Distinct()
                .OrderBy(y => y.Id)
		...
		private static Task<IEnumerable<Attachments>> LoadRangeSelect<T>(int startIndex, int count,
                                                                         DocumentItemDSContext dbContext, string exp, string navExp, string navProp, IEnumerable<string> includeLst = null) where T : class
        {
			try
			{
        ...
        private static async Task<IEnumerable<Attachments>> GetWhere<T>(DocumentItemDSContext dbContext,
		...
		private static Task<IEnumerable<Attachments>> GetWhereSelectMany<T>(DocumentItemDSContext dbContext,
                                                                            string exp, string navExp, string navProp, List<string> includesLst = null) where T : class
        {
			...
			if (includesLst == null)
			{
				return Task.FromResult<IEnumerable<Attachments>>(dbContext.Set<T>()
                    .AsNoTracking()
                    .Where(navExp)
                    .SelectMany(navProp).OfType<Attachments>()
                    .Where(exp == "All" || exp == null?"Id != null":exp)
            ...
            return Task.FromResult<IEnumerable<Attachments>>(set.ToList());
			}
			catch (Exception)
			{
				Debugger.Break();
		...
		private static Task<IEnumerable<Attachments>> GetWhereSelect<T>(DocumentItemDSContext dbContext,
                                                                        string exp, string navExp, string navProp, List<string> includesLst = null) where T : class
        {
			try
			{
			...
			catch (Exception)
			{
				...
				throw;
			        ...
			        public Task<IEnumerable<Attachments>> GetAttachmentsByEmailId(string EmailId, List<string> includesLst = null)
        {
            try
            {
                using ( var dbContext = new DocumentItemDSContext(){StartTracking = StartTracking})
              {
                var i = EmailId;
                var set = AddIncludes(includesLst, dbContext);
                IEnumerable<Attachments> entities = set//dbContext.Attachments
            ...
            try
            {
                ...
                using (var dbContext = new DocumentItemDSContext(){StartTracking = StartTracking})
                {
                    ...
                    foreach (var itm in navExp)
                    {
                        ...
                        {
                            case "xcuda_Attachments":
                                return await SumWhere<xcuda_Attachments>(dbContext, exp, itm.Value, "Attachments", field, "Select")
											.ConfigureAwait(continueOnCapturedContext: false);
						}
                    }
		...
		private static IQueryable<Attachments> AddIncludes(IEnumerable<string> includesLst, DocumentItemDSContext dbContext)
       {
		 try
			{
