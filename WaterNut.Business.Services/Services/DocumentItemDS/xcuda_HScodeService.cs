...
namespace DocumentItemDS.Business.Services
{
   ...
   [ServiceBehavior(InstanceContextMode = InstanceContextMode.PerCall,
    ...
    public partial class xcuda_HScodeService : Ixcuda_HScodeService, IDisposable
    {
		...
		private static async Task<IEnumerable<xcuda_HScode>> GetWhereSelectMany<T>(DocumentItemDSContext dbContext,
		...
		private static async Task<IEnumerable<xcuda_HScode>> GetWhereSelect<T>(DocumentItemDSContext dbContext,
            string exp, string navExp, string navProp, List<string> includesLst = null) where T : class
        {
			try
			{
