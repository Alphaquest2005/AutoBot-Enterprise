...
namespace DocumentItemDS.Business.Services
{
   ...
   [ServiceBehavior(InstanceContextMode = InstanceContextMode.PerCall,
    ...
    public partial class xcuda_HScodeService : Ixcuda_HScodeService, IDisposable
    {
        ...
        public Task<IEnumerable<xcuda_HScode>> Getxcuda_HScode(List<string> includesLst = null, bool tracking = true)
        {
            try
            {
        ...
        public Task<xcuda_HScode> Getxcuda_HScodeByKey(string Item_Id, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
			   if(string.IsNullOrEmpty(Item_Id))return Task.FromResult<xcuda_HScode>(null); 
              using ( var dbContext = new DocumentItemDSContext(){StartTracking = StartTracking})
              {
		 ...
		 public Task<IEnumerable<xcuda_HScode>> Getxcuda_HScodeByExpression(string exp, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
                using (var dbContext = new DocumentItemDSContext(){StartTracking = StartTracking})
                {
					...
					if (string.IsNullOrEmpty(exp) || exp == "None") return Task.FromResult<IEnumerable<xcuda_HScode>>(new List<xcuda_HScode>());
					var set = AddIncludes(includesLst, dbContext);
                    if (exp == "All")
                    {
                        ...
                        if(tracking) entities.AsParallel(new ParallelLinqOptions() { MaxDegreeOfParallelism = Environment.ProcessorCount }).ForAll(x => x.StartTracking());
                        return Task.FromResult<IEnumerable<xcuda_HScode>>(entities); 
                    }
					else
					{
		 ...
		 public Task<IEnumerable<xcuda_HScode>> Getxcuda_HScodeByExpressionLst(List<string> expLst, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
                using (var dbContext = new DocumentItemDSContext(){StartTracking = StartTracking})
                {
                    dbContext.Database.CommandTimeout = 0;
					if (expLst.Count == 0 || expLst.FirstOrDefault() == "None") return Task.FromResult<IEnumerable<xcuda_HScode>>(new List<xcuda_HScode>());
					var set = AddIncludes(includesLst, dbContext);
        ...
        public Task<IEnumerable<xcuda_HScode>> Getxcuda_HScodeByBatch(string exp,
        ...
        public Task<IEnumerable<xcuda_HScode>> Getxcuda_HScodeByBatchExpressionLst(List<string> expLst,
                                                                                   int totalrow, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
        ...
        public Task<xcuda_HScode> Updatexcuda_HScode(xcuda_HScode entity)
        { 
            using ( var dbContext = new DocumentItemDSContext(){StartTracking = StartTracking})
              {
                try
        ...
        public Task<xcuda_HScode> Createxcuda_HScode(xcuda_HScode entity)
        {
            try
            {
                var res = (xcuda_HScode) entity;
        ...
        public Task<bool> Deletexcuda_HScode(string Item_Id)
        {
            try
            {
              using ( var dbContext = new DocumentItemDSContext(){StartTracking = StartTracking})
		...
		public Task<int> Count(string exp)
        {
            try
            {
                using (DocumentItemDSContext dbContext = new DocumentItemDSContext(){StartTracking = StartTracking})
                {
                    ...
                    if (exp == "All")
                    {
                        return Task.FromResult(dbContext.xcuda_HScode
                            .AsNoTracking()
                            .Count());
                    }
                    else
        ...
        public Task<IEnumerable<xcuda_HScode>> LoadRange(int startIndex, int count, string exp)
        {
            try
            {
                using (var dbContext = new DocumentItemDSContext(){StartTracking = StartTracking})
                {
                    ...
                    if (exp == "All")
                    {
                        return Task.FromResult<IEnumerable<xcuda_HScode>>(dbContext.xcuda_HScode
                            .AsNoTracking()
                            .OrderBy(y => y.Item_Id)
                            .Skip(startIndex)
                            .Take(count)
		...
		private static Task<IEnumerable<xcuda_HScode>> LoadRangeSelectMany<T>(int startIndex, int count,
                                                                              DocumentItemDSContext dbContext, string exp, string navExp, string navProp, IEnumerable<string> includeLst = null) where T : class
        {
            ...
            return Task.FromResult<IEnumerable<xcuda_HScode>>(set
                .Where(exp == "All" || exp == null ? "Item_Id != null" : exp)
                .Distinct()
                .OrderBy(y => y.Item_Id)
		...
		private static Task<IEnumerable<xcuda_HScode>> LoadRangeSelect<T>(int startIndex, int count,
                                                                          DocumentItemDSContext dbContext, string exp, string navExp, string navProp, IEnumerable<string> includeLst = null) where T : class
        {
			try
			{
        ...
        private static async Task<IEnumerable<xcuda_HScode>> GetWhere<T>(DocumentItemDSContext dbContext,
		...
		private static Task<IEnumerable<xcuda_HScode>> GetWhereSelectMany<T>(DocumentItemDSContext dbContext,
                                                                             string exp, string navExp, string navProp, List<string> includesLst = null) where T : class
        {
			...
			if (includesLst == null)
			{
				return Task.FromResult<IEnumerable<xcuda_HScode>>(dbContext.Set<T>()
                    .AsNoTracking()
                    .Where(navExp)
                    .SelectMany(navProp).OfType<xcuda_HScode>()
                    .Where(exp == "All" || exp == null?"Item_Id != null":exp)
            ...
            return Task.FromResult<IEnumerable<xcuda_HScode>>(set.ToList());
			}
			catch (Exception)
			{
				Debugger.Break();
		...
		private static Task<IEnumerable<xcuda_HScode>> GetWhereSelect<T>(DocumentItemDSContext dbContext,
                                                                         string exp, string navExp, string navProp, List<string> includesLst = null) where T : class
        {
			try
			{
		...
		private static IQueryable<xcuda_HScode> AddIncludes(IEnumerable<string> includesLst, DocumentItemDSContext dbContext)
       {
		 try
			{
