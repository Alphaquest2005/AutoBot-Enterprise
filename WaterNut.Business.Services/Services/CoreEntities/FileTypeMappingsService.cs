...
namespace CoreEntities.Business.Services
{
   ...
   [ServiceBehavior(InstanceContextMode = InstanceContextMode.PerCall,
    ...
    public partial class FileTypeMappingsService : IFileTypeMappingsService, IDisposable
    {
        //private readonly CoreEntitiesContext dbContext;

        public bool StartTracking { get; set; }

        public FileTypeMappingsService()
        {
            try
            {
        ...
        public Task<IEnumerable<FileTypeMappings>> GetFileTypeMappings(List<string> includesLst = null, bool tracking = true)
        {
            try
            {
            //using (var scope = new TransactionScope(TransactionScopeOption.Required,
               ...
               // {
                  using ( var dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
                  {
                    ...
                    IEnumerable<FileTypeMappings> entities = set.AsNoTracking().ToList();
                           //scope.Complete();
        ...
        public Task<FileTypeMappings> GetFileTypeMappingsByKey(string Id, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
			   if(string.IsNullOrEmpty(Id))return Task.FromResult<FileTypeMappings>(null); 
              using ( var dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
              {
                var i = Convert.ToInt32(Id);
				var set = AddIncludes(includesLst, dbContext);
                FileTypeMappings entity = set.AsNoTracking().SingleOrDefault(x => x.Id == i);
		 ...
		 public Task<IEnumerable<FileTypeMappings>> GetFileTypeMappingsByExpression(string exp, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
                using (var dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
                {
					...
					if (string.IsNullOrEmpty(exp) || exp == "None") return Task.FromResult<IEnumerable<FileTypeMappings>>(new List<FileTypeMappings>());
					var set = AddIncludes(includesLst, dbContext);
                    if (exp == "All")
                    {
                        ...
                        if(tracking) entities.AsParallel(new ParallelLinqOptions() { MaxDegreeOfParallelism = Environment.ProcessorCount }).ForAll(x => x.StartTracking());
                        return Task.FromResult<IEnumerable<FileTypeMappings>>(entities); 
                    }
					else
					{
		 ...
		 public Task<IEnumerable<FileTypeMappings>> GetFileTypeMappingsByExpressionLst(List<string> expLst, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
                using (var dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
                {
                    dbContext.Database.CommandTimeout = 0;
					if (expLst.Count == 0 || expLst.FirstOrDefault() == "None") return Task.FromResult<IEnumerable<FileTypeMappings>>(new List<FileTypeMappings>());
					var set = AddIncludes(includesLst, dbContext);
																							  ...
																							  List<string> includesLst = null, bool tracking = true)
        {
            try
            {
                ...
                {
                    dbContext.Database.CommandTimeout = 0;
                    if (string.IsNullOrEmpty(exp) || exp == "None") return new List<FileTypeMappings>();
                    ...
                    foreach (var itm in navExp)
                    {
                        switch (itm.Key)
                        {
                            case "FileTypes":
                                return
                                    await
                                        GetWhere<FileTypes>(dbContext, exp, itm.Value, "FileTypeMappings", "SelectMany", includesLst)
        ...
        public Task<IEnumerable<FileTypeMappings>> GetFileTypeMappingsByBatch(string exp,
                                                                              int totalrow, List<string> includesLst = null, bool tracking = true)
        {
            try
            {

                var res = new ConcurrentQueue<List<FileTypeMappings>>();
                    ...
                    //  for (int bat = 0; bat < batches; bat++)
                    {
                        try
                        {
                            using (var dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
                            {
                                ...
                                var set = AddIncludes(includesLst, dbContext);
                                IQueryable<FileTypeMappings> dset;
                                if (exp == "All")
                                {
        ...
        public Task<IEnumerable<FileTypeMappings>> GetFileTypeMappingsByBatchExpressionLst(List<string> expLst,
                                                                                           int totalrow, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
        ...
        public Task<FileTypeMappings> UpdateFileTypeMappings(FileTypeMappings entity)
        { 
            using ( var dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
              {
                try
                {   
                     var res = (FileTypeMappings) entity;
        ...
        public Task<FileTypeMappings> CreateFileTypeMappings(FileTypeMappings entity)
        {
            try
            {
                var res = (FileTypeMappings) entity;
              using ( var dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
              {
                dbContext.FileTypeMappings.Add(res);
                dbContext.SaveChanges();
                res.AcceptChanges();
                return Task.FromResult(res);
              }
        ...
        public Task<bool> DeleteFileTypeMappings(string Id)
        {
            try
            {
              using ( var dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
              {
                var i = Convert.ToInt32(Id);
                FileTypeMappings entity = dbContext.FileTypeMappings
													.SingleOrDefault(x => x.Id == i);
                if (entity == null)
                    return Task.FromResult(false);

                    dbContext.FileTypeMappings.Attach(entity);
                    dbContext.FileTypeMappings.Remove(entity);
                    dbContext.SaveChanges();
        ...
        public async Task<bool> RemoveSelectedFileTypeMappings(IEnumerable<string> lst)
        {
            try
            {
                StatusModel.StartStatusUpdate("Removing FileTypeMappings", lst.Count());
                var t = Task.Run(() =>
                {
                    using (var ctx = new FileTypeMappingsService())
                    {
                        foreach (var item in lst.ToList())
                        {

                            ctx.DeleteFileTypeMappings(item).Wait();
         ...
         public Task<int> CountByExpressionLst(List<string> expLst)
        {
            try
            {
                using (var dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
                {
                    ...
                    var set = (IQueryable<FileTypeMappings>)dbContext.FileTypeMappings; 
                    if (expLst.FirstOrDefault() == "All")
                    {
		...
		public Task<int> Count(string exp)
        {
            try
            {
                using (CoreEntitiesContext dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
                {
                    ...
                    if (exp == "All")
                    {
                        return Task.FromResult(dbContext.FileTypeMappings
                            .AsNoTracking()
                            .Count());
                    }
                    else
        ...
        public Task<IEnumerable<FileTypeMappings>> LoadRange(int startIndex, int count, string exp)
        {
            try
            {
                using (var dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
                {
                    ...
                    if (exp == "All")
                    {
                        return Task.FromResult<IEnumerable<FileTypeMappings>>(dbContext.FileTypeMappings
                            .AsNoTracking()
                            .OrderBy(y => y.Id)
                            .Skip(startIndex)
                            .Take(count)
		...
		public async Task<int> CountNav(string exp, Dictionary<string, string> navExp)
        {
            try
            {
                ...
                using (var dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
                {
                    ...
                    if (exp == "All" && navExp.Count == 0)
                    {
                        return dbContext.FileTypeMappings
										.AsNoTracking()
                                        .Count();
                    }
                    foreach (var itm in navExp)
                    {
                        ...
                        {
                            case "FileTypes":
                                return await CountWhere<FileTypes>(dbContext, exp, itm.Value, "FileTypeMappings", "SelectMany")
											.ConfigureAwait(continueOnCapturedContext: false);
                            case "FileTypeMappingRegExs":
		...
		private static Task<int> CountWhereSelectMany<T>(CoreEntitiesContext dbContext, string exp, string navExp, string navProp) where T : class
        {
            ...
            return Task.FromResult(dbContext.Set<T>()
                .AsNoTracking()
                .Where(navExp)
                .SelectMany(navProp).OfType<FileTypeMappings>()
		...
		private static Task<int> CountWhereSelect<T>(CoreEntitiesContext dbContext, string exp, string navExp, string navProp) where T : class
        {
            ...
            return Task.FromResult(dbContext.Set<T>()
                .AsNoTracking()
                .Where(navExp)
                .Select(navProp).OfType<FileTypeMappings>()
                .Where(exp == "All" || exp == null ? "Id != null" : exp)
                .Distinct()
                .OrderBy("Id")
                .Count());
                                                                                 ...
                                                                                 Dictionary<string, string> navExp, IEnumerable<string> includeLst = null)
        {
            try
            {
                ...
                {
                    dbContext.Database.CommandTimeout = 0;
                    if ((string.IsNullOrEmpty(exp) && navExp.Count == 0) || exp == "None") return new List<FileTypeMappings>();
                    ...
                    foreach (var itm in navExp)
                    {
                        switch (itm.Key)
                        {
                            case "FileTypes":
                                return
                                    await
                                        LoadRangeWhere<FileTypes>(startIndex, count, dbContext, exp, itm.Value, "FileTypeMappings", "SelectMany")
													.ConfigureAwait(continueOnCapturedContext: false);
                    ...
                    return set//dbContext.FileTypeMappings
								.AsNoTracking()
                                .Where(exp == "All" || exp == null ? "Id != null" : exp)
								.OrderBy(y => y.Id)
		...
		private static async Task<IEnumerable<FileTypeMappings>> LoadRangeWhere<T>(int startIndex, int count,
		...
		private static Task<IEnumerable<FileTypeMappings>> LoadRangeSelectMany<T>(int startIndex, int count,
                                                                                  CoreEntitiesContext dbContext, string exp, string navExp, string navProp, IEnumerable<string> includeLst = null) where T : class
        {
            ...
            return Task.FromResult<IEnumerable<FileTypeMappings>>(set
                .Where(exp == "All" || exp == null ? "Id != null" : exp)
                .Distinct()
                .OrderBy(y => y.Id)
		...
		private static Task<IEnumerable<FileTypeMappings>> LoadRangeSelect<T>(int startIndex, int count,
                                                                              CoreEntitiesContext dbContext, string exp, string navExp, string navProp, IEnumerable<string> includeLst = null) where T : class
        {
			try
			{
        ...
        private static async Task<IEnumerable<FileTypeMappings>> GetWhere<T>(CoreEntitiesContext dbContext,
		...
		private static Task<IEnumerable<FileTypeMappings>> GetWhereSelectMany<T>(CoreEntitiesContext dbContext,
                                                                                 string exp, string navExp, string navProp, List<string> includesLst = null) where T : class
        {
			...
			if (includesLst == null)
			{
				return Task.FromResult<IEnumerable<FileTypeMappings>>(dbContext.Set<T>()
                    .AsNoTracking()
                    .Where(navExp)
                    .SelectMany(navProp).OfType<FileTypeMappings>()
                    .Where(exp == "All" || exp == null?"Id != null":exp)
			...
			var set = (DbQuery<FileTypeMappings>)dbContext.Set<T>()
				.AsNoTracking()
                .Where(navExp)
                .SelectMany(navProp).OfType<FileTypeMappings>()
                .Where(exp == "All" || exp == null?"Id != null":exp)
            ...
            return Task.FromResult<IEnumerable<FileTypeMappings>>(set.ToList());
			}
			catch (Exception)
			{
				Debugger.Break();
		...
		private static Task<IEnumerable<FileTypeMappings>> GetWhereSelect<T>(CoreEntitiesContext dbContext,
                                                                             string exp, string navExp, string navProp, List<string> includesLst = null) where T : class
        {
			try
			{
			...
			catch (Exception)
			{
				...
				throw;
			        ...
			        public Task<IEnumerable<FileTypeMappings>> GetFileTypeMappingsByFileTypeId(string FileTypeId, List<string> includesLst = null)
        {
            try
            {
                using ( var dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
             ...
             try
             {
                 using (var dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
                 {
					...
					decimal res = 0;
                     ...
                     if (whereExp == "All")
                     {
                          res = Convert.ToDecimal(dbContext.FileTypeMappings.AsNoTracking().Sum(field));
                     }
                     else
                     {
                         res = Convert.ToDecimal(dbContext.FileTypeMappings.AsNoTracking().Where(whereExp).Sum(field));
                     }
        ...
        public async Task<decimal> SumNav( string exp, Dictionary<string, string> navExp, string field)
        {
            try
            {
                ...
                {
                    dbContext.Database.CommandTimeout = 0;
                    if (!dbContext.FileTypeMappings.Any()) return 0;
                    if (exp == "All" && navExp.Count == 0)
                    {
                        return Convert.ToDecimal(dbContext.FileTypeMappings
										.AsNoTracking()
                                        .Sum(field)??0);
                    }
                    foreach (var itm in navExp)
                    {
                        ...
                        {
                            case "FileTypes":
                                return await SumWhere<FileTypes>(dbContext, exp, itm.Value, "FileTypeMappings", field, "SelectMany")
											.ConfigureAwait(continueOnCapturedContext: false);
                            case "FileTypeMappingRegExs":
                    ...
                    return Convert.ToDecimal(dbContext.FileTypeMappings.Where(exp == "All" || exp == null ? "Id != null" : exp)
											.AsNoTracking()
                                            .Sum(field)??0);
                }
             ...
             try
             {
                 using (var dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
                 {
					...
					string res = "";
                     ...
                     if (whereExp == "All")
                     {
                          res = Convert.ToString(dbContext.FileTypeMappings.AsNoTracking().Min(field));
                     }
                     else
                     {
                         res = Convert.ToString(dbContext.FileTypeMappings.AsNoTracking().Where(whereExp).Min(field));
                     }
		...
		private static IQueryable<FileTypeMappings> AddIncludes(IEnumerable<string> includesLst, CoreEntitiesContext dbContext)
       {
		 try
			{
			   if (includesLst == null) includesLst = new List<string>();
			   var set =(DbQuery<FileTypeMappings>) dbContext.FileTypeMappings; 
	   ...
	   private IQueryable<FileTypeMappings> AddWheres(List<string> expLst, IQueryable<FileTypeMappings> set)
        {
            try
            {
