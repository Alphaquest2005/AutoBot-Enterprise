...
namespace CoreEntities.Business.Services
{
   ...
   [ServiceBehavior(InstanceContextMode = InstanceContextMode.PerCall,
    ...
    public partial class TODO_SubmitIncompleteSupplierInfoService : ITODO_SubmitIncompleteSupplierInfoService, IDisposable
    {
        ...
        public async Task<IEnumerable<TODO_SubmitIncompleteSupplierInfo>> GetTODO_SubmitIncompleteSupplierInfo(List<string> includesLst = null, bool tracking = true)
        {
            try
            {
        ...
        public async Task<TODO_SubmitIncompleteSupplierInfo> GetTODO_SubmitIncompleteSupplierInfoByKey(string SupplierCode, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
		 ...
		 public async Task<IEnumerable<TODO_SubmitIncompleteSupplierInfo>> GetTODO_SubmitIncompleteSupplierInfoByExpression(string exp, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
                using (var dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
		 ...
		 public async Task<IEnumerable<TODO_SubmitIncompleteSupplierInfo>> GetTODO_SubmitIncompleteSupplierInfoByExpressionLst(List<string> expLst, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
                using (var dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
                {
                    dbContext.Database.CommandTimeout = 0;
					if (expLst.Count == 0 || expLst.FirstOrDefault() == "None") return new List<TODO_SubmitIncompleteSupplierInfo>();
					var set = AddIncludes(includesLst, dbContext);
        ...
        public async Task<bool> DeleteTODO_SubmitIncompleteSupplierInfo(string SupplierCode)
        {
            try
            {
              using ( var dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
                                                                                 ...
                                                                                 Dictionary<string, string> navExp, IEnumerable<string> includeLst = null)
        {
            try
            {
                ...
                {
                    dbContext.Database.CommandTimeout = 0;
                    if ((string.IsNullOrEmpty(exp) && navExp.Count == 0) || exp == "None") return new List<TODO_SubmitIncompleteSupplierInfo>();
		...
		private static async Task<IEnumerable<TODO_SubmitIncompleteSupplierInfo>> LoadRangeSelectMany<T>(int startIndex, int count,
		...
		private static async Task<IEnumerable<TODO_SubmitIncompleteSupplierInfo>> LoadRangeSelect<T>(int startIndex, int count,
            CoreEntitiesContext dbContext, string exp, string navExp, string navProp, IEnumerable<string> includeLst = null) where T : class
        {
			try
			{
		...
		private static async Task<IEnumerable<TODO_SubmitIncompleteSupplierInfo>> GetWhereSelectMany<T>(CoreEntitiesContext dbContext,
		...
		private static async Task<IEnumerable<TODO_SubmitIncompleteSupplierInfo>> GetWhereSelect<T>(CoreEntitiesContext dbContext,
            string exp, string navExp, string navProp, List<string> includesLst = null) where T : class
        {
			try
			{
        ...
        public async Task<decimal> SumNav( string exp, Dictionary<string, string> navExp, string field)
        {
            try
            {
                ...
                {
                    dbContext.Database.CommandTimeout = 0;
                    if (!dbContext.TODO_SubmitIncompleteSupplierInfo.Any()) return 0;
                    if (exp == "All" && navExp.Count == 0)
                    {
                        return Convert.ToDecimal(dbContext.TODO_SubmitIncompleteSupplierInfo
										.AsNoTracking()
                                        .Sum(field)??0);
                    }
                    return Convert.ToDecimal(dbContext.TODO_SubmitIncompleteSupplierInfo.Where(exp == "All" || exp == null ? "SupplierCode != null" : exp)
											.AsNoTracking()
                                            .Sum(field)??0);
                }
