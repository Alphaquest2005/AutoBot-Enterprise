...
namespace CoreEntities.Business.Services
{
   ...
   [ServiceBehavior(InstanceContextMode = InstanceContextMode.PerCall,
    ...
    public partial class AsycudaDocumentItemEntryDataDetailsService : IAsycudaDocumentItemEntryDataDetailsService, IDisposable
    {
		...
		private static async Task<IEnumerable<AsycudaDocumentItemEntryDataDetails>> GetWhereSelectMany<T>(CoreEntitiesContext dbContext,
		...
		private static async Task<IEnumerable<AsycudaDocumentItemEntryDataDetails>> GetWhereSelect<T>(CoreEntitiesContext dbContext,
            string exp, string navExp, string navProp, List<string> includesLst = null) where T : class
        {
			try
			{
