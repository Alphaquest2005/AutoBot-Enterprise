...
namespace CoreEntities.Business.Services
{
   ...
   [ServiceBehavior(InstanceContextMode = InstanceContextMode.PerCall,
    ...
    public partial class AsycudaDocumentItemEntryDataDetailsService : IAsycudaDocumentItemEntryDataDetailsService, IDisposable
    {
        ...
        public Task<AsycudaDocumentItemEntryDataDetails> GetAsycudaDocumentItemEntryDataDetailsByKey(string EntryDataDetailsId, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
			   if(string.IsNullOrEmpty(EntryDataDetailsId))return Task.FromResult<AsycudaDocumentItemEntryDataDetails>(null); 
              using ( var dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
              {
                    ...
                    foreach (var itm in navExp)
                    {
                        switch (itm.Key)
                        {
                            case "AsycudaDocumentItem":
                                return
                                    await
                                        GetWhere<AsycudaDocumentItem>(dbContext, exp, itm.Value, "AsycudaDocumentItemEntryDataDetails", "SelectMany", includesLst)
        ...
        public Task<bool> DeleteAsycudaDocumentItemEntryDataDetails(string EntryDataDetailsId)
        {
            try
            {
              using ( var dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
            ...
            try
            {
                ...
                using (var dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
                {
                    ...
                    foreach (var itm in navExp)
                    {
                        ...
                        {
                            case "AsycudaDocumentItem":
                                return await CountWhere<AsycudaDocumentItem>(dbContext, exp, itm.Value, "AsycudaDocumentItemEntryDataDetails", "SelectMany")
											.ConfigureAwait(continueOnCapturedContext: false);
						}
                    }
                    ...
                    foreach (var itm in navExp)
                    {
                        switch (itm.Key)
                        {
                            case "AsycudaDocumentItem":
                                return
                                    await
                                        LoadRangeWhere<AsycudaDocumentItem>(startIndex, count, dbContext, exp, itm.Value, "AsycudaDocumentItemEntryDataDetails", "SelectMany")
													.ConfigureAwait(continueOnCapturedContext: false);
        ...
        private static async Task<IEnumerable<AsycudaDocumentItemEntryDataDetails>> GetWhere<T>(CoreEntitiesContext dbContext,
		...
		private static Task<IEnumerable<AsycudaDocumentItemEntryDataDetails>> GetWhereSelectMany<T>(CoreEntitiesContext dbContext,
		...
		private static Task<IEnumerable<AsycudaDocumentItemEntryDataDetails>> GetWhereSelect<T>(CoreEntitiesContext dbContext,
                                                                                                string exp, string navExp, string navProp, List<string> includesLst = null) where T : class
        {
			try
			{
			...
			catch (Exception)
			{
				...
				throw;
			        ...
			        public Task<IEnumerable<AsycudaDocumentItemEntryDataDetails>> GetAsycudaDocumentItemEntryDataDetailsById(string Id, List<string> includesLst = null)
        {
            try
            {
                using ( var dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
            ...
            try
            {
                ...
                using (var dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
                {
                    ...
                    foreach (var itm in navExp)
                    {
                        ...
                        {
                            case "AsycudaDocumentItem":
                                return await SumWhere<AsycudaDocumentItem>(dbContext, exp, itm.Value, "AsycudaDocumentItemEntryDataDetails", field, "SelectMany")
											.ConfigureAwait(continueOnCapturedContext: false);
						}
                    }
		...
		private static IQueryable<AsycudaDocumentItemEntryDataDetails> AddIncludes(IEnumerable<string> includesLst, CoreEntitiesContext dbContext)
       {
		 try
			{
