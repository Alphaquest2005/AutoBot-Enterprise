...
namespace CoreEntities.Business.Services
{
   ...
   [ServiceBehavior(InstanceContextMode = InstanceContextMode.PerCall,
    ...
    public partial class TODO_UnallocatedSalesService : ITODO_UnallocatedSalesService, IDisposable
    {
        ...
        public async Task<IEnumerable<TODO_UnallocatedSales>> GetTODO_UnallocatedSales(List<string> includesLst = null, bool tracking = true)
        {
            try
            {
            //using (var scope = new TransactionScope(TransactionScopeOption.Required,
               ...
               // {
                  using ( var dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
                  {
                    ...
                    IEnumerable<TODO_UnallocatedSales> entities = await set.AsNoTracking().ToListAsync()
        ...
        public async Task<TODO_UnallocatedSales> GetTODO_UnallocatedSalesByKey(string EntryDataId, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
              ...
              using ( var dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
              {
                var i = EntryDataId;
				var set = AddIncludes(includesLst, dbContext);
                TODO_UnallocatedSales entity = await set.AsNoTracking().SingleOrDefaultAsync(x => x.EntryDataId == i).ConfigureAwait(continueOnCapturedContext: false);
		 ...
		 public async Task<IEnumerable<TODO_UnallocatedSales>> GetTODO_UnallocatedSalesByExpression(string exp, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
                using (var dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
                {
					...
					if (string.IsNullOrEmpty(exp) || exp == "None") return new List<TODO_UnallocatedSales>();
					var set = AddIncludes(includesLst, dbContext);
                    if (exp == "All")
                    {
		 ...
		 public async Task<IEnumerable<TODO_UnallocatedSales>> GetTODO_UnallocatedSalesByExpressionLst(List<string> expLst, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
                using (var dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
                {
                    dbContext.Database.CommandTimeout = 0;
					if (expLst.Count == 0 || expLst.FirstOrDefault() == "None") return new List<TODO_UnallocatedSales>();
					var set = AddIncludes(includesLst, dbContext);
		...
		public async Task<IEnumerable<TODO_UnallocatedSales>> GetTODO_UnallocatedSalesByExpressionNav(string exp,
        ...
        public async Task<IEnumerable<TODO_UnallocatedSales>> GetTODO_UnallocatedSalesByBatch(string exp,
        ...
        public async Task<IEnumerable<TODO_UnallocatedSales>> GetTODO_UnallocatedSalesByBatchExpressionLst(List<string> expLst,
            int totalrow, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
        ...
        public async Task<bool> DeleteTODO_UnallocatedSales(string EntryDataId)
        {
            try
            {
              using ( var dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
              {
                var i = EntryDataId;
                TODO_UnallocatedSales entity = await dbContext.TODO_UnallocatedSales
		...
		public async Task<int> Count(string exp)
        {
            try
            {
                using (CoreEntitiesContext dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
                {
                    ...
                    if (exp == "All")
                    {
                        return await dbContext.TODO_UnallocatedSales
                                    .AsNoTracking()
									.CountAsync()
									.ConfigureAwait(continueOnCapturedContext: false);
                    }
        ...
        public async Task<IEnumerable<TODO_UnallocatedSales>> LoadRange(int startIndex, int count, string exp)
        {
            try
            {
                using (var dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
		...
		public async Task<int> CountNav(string exp, Dictionary<string, string> navExp)
        {
            try
            {
                ...
                using (var dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
                {
                    ...
                    return await dbContext.TODO_UnallocatedSales.Where(exp == "All" || exp == null ? "EntryDataId != null" : exp)
											.AsNoTracking()
                                            .CountAsync()
											.ConfigureAwait(continueOnCapturedContext: false);
                }
		...
		private static async Task<int> CountWhereSelect<T>(CoreEntitiesContext dbContext, string exp, string navExp, string navProp) where T : class
        {
		  ...
		  public async Task<IEnumerable<TODO_UnallocatedSales>> LoadRangeNav(int startIndex, int count, string exp,
                                                                                 Dictionary<string, string> navExp, IEnumerable<string> includeLst = null)
        {
            try
            {
                ...
                {
                    dbContext.Database.CommandTimeout = 0;
                    if ((string.IsNullOrEmpty(exp) && navExp.Count == 0) || exp == "None") return new List<TODO_UnallocatedSales>();
                    ...
                    return await set//dbContext.TODO_UnallocatedSales
								.AsNoTracking()
                                .Where(exp == "All" || exp == null ? "EntryDataId != null" : exp)
								.OrderBy(y => y.EntryDataId)
		...
		private static async Task<IEnumerable<TODO_UnallocatedSales>> LoadRangeSelectMany<T>(int startIndex, int count,
		...
		private static async Task<IEnumerable<TODO_UnallocatedSales>> LoadRangeSelect<T>(int startIndex, int count,
            CoreEntitiesContext dbContext, string exp, string navExp, string navProp, IEnumerable<string> includeLst = null) where T : class
        {
			try
			{
		...
		private static async Task<IEnumerable<TODO_UnallocatedSales>> GetWhereSelectMany<T>(CoreEntitiesContext dbContext,
		...
		private static async Task<IEnumerable<TODO_UnallocatedSales>> GetWhereSelect<T>(CoreEntitiesContext dbContext,
            string exp, string navExp, string navProp, List<string> includesLst = null) where T : class
        {
			try
			{
        ...
        public async Task<decimal> SumNav( string exp, Dictionary<string, string> navExp, string field)
        {
            try
            {
                ...
                {
                    dbContext.Database.CommandTimeout = 0;
                    if (!dbContext.TODO_UnallocatedSales.Any()) return 0;
                    if (exp == "All" && navExp.Count == 0)
                    {
                        return Convert.ToDecimal(dbContext.TODO_UnallocatedSales
										.AsNoTracking()
                                        .Sum(field)??0);
                    }
                    return Convert.ToDecimal(dbContext.TODO_UnallocatedSales.Where(exp == "All" || exp == null ? "EntryDataId != null" : exp)
											.AsNoTracking()
                                            .Sum(field)??0);
                }
