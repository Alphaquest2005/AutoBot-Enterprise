    ...
    public partial class TODO_SubmitEntryCIFService : ITODO_SubmitEntryCIFService, IDisposable
    {
            ...
            //using (var scope = new TransactionScope(TransactionScopeOption.Required,
               ...
               // {
                  using ( var dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
                  {
                    ...
                    IEnumerable<TODO_SubmitEntryCIF> entities = await set.AsNoTracking().ToListAsync()
        ...
        public async Task<TODO_SubmitEntryCIF> GetTODO_SubmitEntryCIFByKey(string InvoiceNo, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
              ...
              using ( var dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
              {
                var i = InvoiceNo;
				var set = AddIncludes(includesLst, dbContext);
                TODO_SubmitEntryCIF entity = await set.AsNoTracking().SingleOrDefaultAsync(x => x.InvoiceNo == i).ConfigureAwait(continueOnCapturedContext: false);
        ...
        public async Task<bool> DeleteTODO_SubmitEntryCIF(string InvoiceNo)
        {
            try
            {
              ...
              {
                var i = InvoiceNo;
                TODO_SubmitEntryCIF entity = await dbContext.TODO_SubmitEntryCIF
		...
		public async Task<int> Count(string exp)
        {
            try
            {
                using (CoreEntitiesContext dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
                {
                    ...
                    if (exp == "All")
                    {
                        return await dbContext.TODO_SubmitEntryCIF
                                    .AsNoTracking()
									.CountAsync()
									.ConfigureAwait(continueOnCapturedContext: false);
                    }
		...
		public async Task<int> CountNav(string exp, Dictionary<string, string> navExp)
        {
            try
            {
                ...
                using (var dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
                {
                    ...
                    return await dbContext.TODO_SubmitEntryCIF.Where(exp == "All" || exp == null ? "InvoiceNo != null" : exp)
											.AsNoTracking()
                                            .CountAsync()
											.ConfigureAwait(continueOnCapturedContext: false);
                }
                                                                                 ...
                                                                                 Dictionary<string, string> navExp, IEnumerable<string> includeLst = null)
        {
            try
            {
                using (var dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
                {
                    ...
                    return await set//dbContext.TODO_SubmitEntryCIF
								.AsNoTracking()
                                .Where(exp == "All" || exp == null ? "InvoiceNo != null" : exp)
								.OrderBy(y => y.InvoiceNo)
