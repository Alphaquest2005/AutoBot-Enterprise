...
namespace CoreEntities.Business.Services
{
   ...
   [ServiceBehavior(InstanceContextMode = InstanceContextMode.PerCall,
    ...
    public partial class TODO_DiscrepanciesErrorsService : ITODO_DiscrepanciesErrorsService, IDisposable
    {
        //private readonly CoreEntitiesContext dbContext;

        public bool StartTracking { get; set; }

        public TODO_DiscrepanciesErrorsService()
        {
            try
            {
            ...
            //using (var scope = new TransactionScope(TransactionScopeOption.Required,
               ...
               // {
                  using ( var dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
                  {
                    ...
                    IEnumerable<TODO_DiscrepanciesErrors> entities = await set.AsNoTracking().ToListAsync()
        ...
        public async Task<TODO_DiscrepanciesErrors> GetTODO_DiscrepanciesErrorsByKey(string Entrydatadetailsid, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
              ...
              using ( var dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
              {
				...
				var set = AddIncludes(includesLst, dbContext);
                TODO_DiscrepanciesErrors entity = await set.AsNoTracking().SingleOrDefaultAsync(x => x.Entrydatadetailsid == i).ConfigureAwait(continueOnCapturedContext: false);
            ...
            int totalrow, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
                ...
                var res = new ConcurrentQueue<List<TODO_DiscrepanciesErrors>>();
                    ...
                    //  for (int bat = 0; bat < batches; bat++)
                    {
                        try
                        {
                            using (var dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
                            {
                                ...
                                var set = AddIncludes(includesLst, dbContext);
                                IQueryable<TODO_DiscrepanciesErrors> dset;
                                if (exp == "All")
                                {
            ...
            using ( var dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
              {
                try
                {   
                     var res = (TODO_DiscrepanciesErrors) entity;
        ...
        public async Task<bool> DeleteTODO_DiscrepanciesErrors(string Entrydatadetailsid)
        {
            try
            {
              ...
              {
                var i = Convert.ToInt32(Entrydatadetailsid);
                TODO_DiscrepanciesErrors entity = await dbContext.TODO_DiscrepanciesErrors
        ...
        public async Task<bool> RemoveSelectedTODO_DiscrepanciesErrors(IEnumerable<string> lst)
        {
            try
            {
                StatusModel.StartStatusUpdate("Removing TODO_DiscrepanciesErrors", lst.Count());
                var t = Task.Run(() =>
                {
                    using (var ctx = new TODO_DiscrepanciesErrorsService())
                    {
                        foreach (var item in lst.ToList())
                        {

                            ctx.DeleteTODO_DiscrepanciesErrors(item).Wait();
		...
		public async Task<int> Count(string exp)
        {
            try
            {
                using (CoreEntitiesContext dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
                {
                    ...
                    if (exp == "All")
                    {
                        return await dbContext.TODO_DiscrepanciesErrors
                                    .AsNoTracking()
									.CountAsync()
									.ConfigureAwait(continueOnCapturedContext: false);
                    }
		...
		public async Task<int> CountNav(string exp, Dictionary<string, string> navExp)
        {
            try
            {
                ...
                using (var dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
                {
                    ...
                    return await dbContext.TODO_DiscrepanciesErrors.Where(exp == "All" || exp == null ? "Entrydatadetailsid != null" : exp)
											.AsNoTracking()
                                            .CountAsync()
											.ConfigureAwait(continueOnCapturedContext: false);
                }
                                                                                 ...
                                                                                 Dictionary<string, string> navExp, IEnumerable<string> includeLst = null)
        {
            try
            {
                using (var dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
                {
                    ...
                    return await set//dbContext.TODO_DiscrepanciesErrors
								.AsNoTracking()
                                .Where(exp == "All" || exp == null ? "Entrydatadetailsid != null" : exp)
								.OrderBy(y => y.Entrydatadetailsid)
		...
		private static async Task<IEnumerable<TODO_DiscrepanciesErrors>> LoadRangeWhere<T>(int startIndex, int count,
        ...
        private static async Task<IEnumerable<TODO_DiscrepanciesErrors>> GetWhere<T>(CoreEntitiesContext dbContext,
			        ...
			        public async Task<IEnumerable<TODO_DiscrepanciesErrors>> GetTODO_DiscrepanciesErrorsByAsycudaDocumentSetId(string AsycudaDocumentSetId, List<string> includesLst = null)
        {
            try
            {
                using ( var dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
              {
                ...
                var set = AddIncludes(includesLst, dbContext);
                IEnumerable<TODO_DiscrepanciesErrors> entities = await set//dbContext.TODO_DiscrepanciesErrors
                                      .AsNoTracking()
             ...
             try
             {
                 using (var dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
                 {
					...
					decimal res = 0;
                     ...
                     if (whereExp == "All")
                     {
                          res = Convert.ToDecimal(dbContext.TODO_DiscrepanciesErrors.AsNoTracking().Sum(field));
                     }
                     else
                     {
                         res = Convert.ToDecimal(dbContext.TODO_DiscrepanciesErrors.AsNoTracking().Where(whereExp).Sum(field));
                     }
             ...
             try
             {
                 using (var dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
                 {
					...
					string res = "";
                     ...
                     if (whereExp == "All")
                     {
                          res = Convert.ToString(dbContext.TODO_DiscrepanciesErrors.AsNoTracking().Min(field));
                     }
                     else
                     {
                         res = Convert.ToString(dbContext.TODO_DiscrepanciesErrors.AsNoTracking().Where(whereExp).Min(field));
                     }
		...
		private static IQueryable<TODO_DiscrepanciesErrors> AddIncludes(IEnumerable<string> includesLst, CoreEntitiesContext dbContext)
       {
		 try
			{
			   if (includesLst == null) includesLst = new List<string>();
			   var set =(DbQuery<TODO_DiscrepanciesErrors>) dbContext.TODO_DiscrepanciesErrors; 
	   ...
	   private IQueryable<TODO_DiscrepanciesErrors> AddWheres(List<string> expLst, IQueryable<TODO_DiscrepanciesErrors> set)
        {
            try
            {
