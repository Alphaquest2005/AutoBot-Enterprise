    ...
    public partial class InventoryItemXService : IInventoryItemXService, IDisposable
    {
            ...
            //using (var scope = new TransactionScope(TransactionScopeOption.Required,
               ...
               // {
                  using ( var dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
                  {
                    ...
                    IEnumerable<InventoryItemX> entities = await set.AsNoTracking().ToListAsync()
        ...
        public async Task<InventoryItemX> GetInventoryItemXByKey(string InventoryItemId, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
              ...
              using ( var dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
              {
				...
				var set = AddIncludes(includesLst, dbContext);
                InventoryItemX entity = await set.AsNoTracking().SingleOrDefaultAsync(x => x.InventoryItemId == i).ConfigureAwait(continueOnCapturedContext: false);
        ...
        public async Task<bool> DeleteInventoryItemX(string InventoryItemId)
        {
            try
            {
              ...
              {
                var i = Convert.ToInt32(InventoryItemId);
                InventoryItemX entity = await dbContext.InventoryItemX
		...
		public async Task<int> Count(string exp)
        {
            try
            {
                using (CoreEntitiesContext dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
                {
                    ...
                    if (exp == "All")
                    {
                        return await dbContext.InventoryItemX
                                    .AsNoTracking()
									.CountAsync()
									.ConfigureAwait(continueOnCapturedContext: false);
                    }
		...
		public async Task<int> CountNav(string exp, Dictionary<string, string> navExp)
        {
            try
            {
                ...
                using (var dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
                {
                    ...
                    return await dbContext.InventoryItemX.Where(exp == "All" || exp == null ? "InventoryItemId != null" : exp)
											.AsNoTracking()
                                            .CountAsync()
											.ConfigureAwait(continueOnCapturedContext: false);
                }
                                                                                 ...
                                                                                 Dictionary<string, string> navExp, IEnumerable<string> includeLst = null)
        {
            try
            {
                using (var dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
                {
                    ...
                    return await set//dbContext.InventoryItemX
								.AsNoTracking()
                                .Where(exp == "All" || exp == null ? "InventoryItemId != null" : exp)
								.OrderBy(y => y.InventoryItemId)
			        ...
			        public async Task<IEnumerable<InventoryItemX>> GetInventoryItemXByApplicationSettingsId(string ApplicationSettingsId, List<string> includesLst = null)
        {
            try
            {
                using ( var dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
              {
                ...
                var set = AddIncludes(includesLst, dbContext);
                IEnumerable<InventoryItemX> entities = await set//dbContext.InventoryItemX
