...
namespace CoreEntities.Business.Services
{
   ...
   [ServiceBehavior(InstanceContextMode = InstanceContextMode.PerCall,
    ...
    public partial class InventoryItemXService : IInventoryItemXService, IDisposable
    {
        ...
        public async Task<InventoryItemX> GetInventoryItemXByKey(string ItemNumber, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
              ...
              using ( var dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
              {
                var i = ItemNumber;
				var set = AddIncludes(includesLst, dbContext);
                InventoryItemX entity = await set.AsNoTracking().SingleOrDefaultAsync(x => x.ItemNumber == i).ConfigureAwait(continueOnCapturedContext: false);
        ...
        public async Task<bool> DeleteInventoryItemX(string ItemNumber)
        {
            try
            {
              using ( var dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
		...
		public async Task<int> CountNav(string exp, Dictionary<string, string> navExp)
        {
            try
            {
                ...
                using (var dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
                {
                    ...
                    return await dbContext.InventoryItemX.Where(exp == "All" || exp == null ? "ItemNumber != null" : exp)
											.AsNoTracking()
                                            .CountAsync()
											.ConfigureAwait(continueOnCapturedContext: false);
                }
        ...
        public async Task<decimal> SumNav( string exp, Dictionary<string, string> navExp, string field)
        {
            try
            {
                ...
                using (var dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
                {
                    ...
                    return Convert.ToDecimal(dbContext.InventoryItemX.Where(exp == "All" || exp == null ? "ItemNumber != null" : exp)
											.AsNoTracking()
                                            .Sum(field)??0);
                }
