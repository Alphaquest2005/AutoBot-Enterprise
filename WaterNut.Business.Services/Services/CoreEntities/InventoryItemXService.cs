...
namespace CoreEntities.Business.Services
{
   ...
   [ServiceBehavior(InstanceContextMode = InstanceContextMode.PerCall,
    ...
    public partial class InventoryItemXService : IInventoryItemXService, IDisposable
    {
        ...
        public Task<IEnumerable<InventoryItemX>> GetInventoryItemX(List<string> includesLst = null, bool tracking = true)
        {
            try
            {
        ...
        public Task<InventoryItemX> GetInventoryItemXByKey(string InventoryItemId, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
			   if(string.IsNullOrEmpty(InventoryItemId))return Task.FromResult<InventoryItemX>(null); 
              using ( var dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
              {
		 ...
		 public Task<IEnumerable<InventoryItemX>> GetInventoryItemXByExpression(string exp, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
                using (var dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
                {
					...
					if (string.IsNullOrEmpty(exp) || exp == "None") return Task.FromResult<IEnumerable<InventoryItemX>>(new List<InventoryItemX>());
					var set = AddIncludes(includesLst, dbContext);
                    if (exp == "All")
                    {
                        ...
                        if(tracking) entities.AsParallel(new ParallelLinqOptions() { MaxDegreeOfParallelism = Environment.ProcessorCount }).ForAll(x => x.StartTracking());
                        return Task.FromResult<IEnumerable<InventoryItemX>>(entities); 
                    }
					else
					{
		 ...
		 public Task<IEnumerable<InventoryItemX>> GetInventoryItemXByExpressionLst(List<string> expLst, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
                using (var dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
                {
                    dbContext.Database.CommandTimeout = 0;
					if (expLst.Count == 0 || expLst.FirstOrDefault() == "None") return Task.FromResult<IEnumerable<InventoryItemX>>(new List<InventoryItemX>());
					var set = AddIncludes(includesLst, dbContext);
        ...
        public Task<IEnumerable<InventoryItemX>> GetInventoryItemXByBatch(string exp,
        ...
        public Task<IEnumerable<InventoryItemX>> GetInventoryItemXByBatchExpressionLst(List<string> expLst,
                                                                                       int totalrow, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
        ...
        public Task<InventoryItemX> UpdateInventoryItemX(InventoryItemX entity)
        { 
            using ( var dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
              {
                try
        ...
        public Task<InventoryItemX> CreateInventoryItemX(InventoryItemX entity)
        {
            try
            {
                var res = (InventoryItemX) entity;
        ...
        public Task<bool> DeleteInventoryItemX(string InventoryItemId)
        {
            try
            {
              using ( var dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
		...
		public Task<int> Count(string exp)
        {
            try
            {
                using (CoreEntitiesContext dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
                {
                    ...
                    if (exp == "All")
                    {
                        return Task.FromResult(dbContext.InventoryItemX
                            .AsNoTracking()
                            .Count());
                    }
                    else
        ...
        public Task<IEnumerable<InventoryItemX>> LoadRange(int startIndex, int count, string exp)
        {
            try
            {
                using (var dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
                {
                    ...
                    if (exp == "All")
                    {
                        return Task.FromResult<IEnumerable<InventoryItemX>>(dbContext.InventoryItemX
                            .AsNoTracking()
		...
		private static Task<IEnumerable<InventoryItemX>> LoadRangeSelectMany<T>(int startIndex, int count,
                                                                                CoreEntitiesContext dbContext, string exp, string navExp, string navProp, IEnumerable<string> includeLst = null) where T : class
        {
            ...
            return Task.FromResult<IEnumerable<InventoryItemX>>(set
                .Where(exp == "All" || exp == null ? "InventoryItemId != null" : exp)
                .Distinct()
                .OrderBy(y => y.InventoryItemId)
		...
		private static Task<IEnumerable<InventoryItemX>> LoadRangeSelect<T>(int startIndex, int count,
                                                                            CoreEntitiesContext dbContext, string exp, string navExp, string navProp, IEnumerable<string> includeLst = null) where T : class
        {
			try
			{
		...
		private static Task<IEnumerable<InventoryItemX>> GetWhereSelectMany<T>(CoreEntitiesContext dbContext,
                                                                               string exp, string navExp, string navProp, List<string> includesLst = null) where T : class
        {
			...
			if (includesLst == null)
			{
				return Task.FromResult<IEnumerable<InventoryItemX>>(dbContext.Set<T>()
                    .AsNoTracking()
                    .Where(navExp)
                    .SelectMany(navProp).OfType<InventoryItemX>()
                    .Where(exp == "All" || exp == null?"InventoryItemId != null":exp)
            ...
            return Task.FromResult<IEnumerable<InventoryItemX>>(set.ToList());
			}
			catch (Exception)
			{
				Debugger.Break();
		...
		private static Task<IEnumerable<InventoryItemX>> GetWhereSelect<T>(CoreEntitiesContext dbContext,
                                                                           string exp, string navExp, string navProp, List<string> includesLst = null) where T : class
        {
			try
			{
			...
			catch (Exception)
			{
				...
				throw;
			        ...
			        public Task<IEnumerable<InventoryItemX>> GetInventoryItemXByApplicationSettingsId(string ApplicationSettingsId, List<string> includesLst = null)
        {
            try
            {
                using ( var dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
