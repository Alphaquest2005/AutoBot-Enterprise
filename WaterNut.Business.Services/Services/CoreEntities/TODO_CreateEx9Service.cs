...
{
   [Export (typeof(ITODO_CreateEx9Service))]
   [Export(typeof(IBusinessService))]
   [PartCreationPolicy(CreationPolicy.NonShared)]
   [ServiceBehavior(InstanceContextMode = InstanceContextMode.PerCall,
                    ConcurrencyMode = ConcurrencyMode.Multiple)]
   
    public partial class TODO_CreateEx9Service : ITODO_CreateEx9Service, IDisposable
    {
        //private readonly CoreEntitiesContext dbContext;

        public bool StartTracking { get; set; }

        public TODO_CreateEx9Service()
        {
            try
            {
        ...
        public Task<IEnumerable<TODO_CreateEx9>> GetTODO_CreateEx9(List<string> includesLst = null, bool tracking = true)
        {
            try
            {
            //using (var scope = new TransactionScope(TransactionScopeOption.Required,
               ...
               // {
                  using ( var dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
                  {
                    ...
                    IEnumerable<TODO_CreateEx9> entities = set.AsNoTracking().ToList();
                           //scope.Complete();
        ...
        public Task<TODO_CreateEx9> GetTODO_CreateEx9ByKey(string ApplicationSettingsId, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
			   if(string.IsNullOrEmpty(ApplicationSettingsId))return Task.FromResult<TODO_CreateEx9>(null); 
              using ( var dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
              {
                var i = Convert.ToInt32(ApplicationSettingsId);
				var set = AddIncludes(includesLst, dbContext);
                TODO_CreateEx9 entity = set.AsNoTracking().SingleOrDefault(x => x.ApplicationSettingsId == i);
		 ...
		 public Task<IEnumerable<TODO_CreateEx9>> GetTODO_CreateEx9ByExpression(string exp, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
                using (var dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
                {
					...
					if (string.IsNullOrEmpty(exp) || exp == "None") return Task.FromResult<IEnumerable<TODO_CreateEx9>>(new List<TODO_CreateEx9>());
					var set = AddIncludes(includesLst, dbContext);
                    if (exp == "All")
                    {
                        ...
                        if(tracking) entities.AsParallel(new ParallelLinqOptions() { MaxDegreeOfParallelism = Environment.ProcessorCount }).ForAll(x => x.StartTracking());
                        return Task.FromResult<IEnumerable<TODO_CreateEx9>>(entities); 
                    }
					else
					{
		 ...
		 public Task<IEnumerable<TODO_CreateEx9>> GetTODO_CreateEx9ByExpressionLst(List<string> expLst, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
                using (var dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
                {
                    dbContext.Database.CommandTimeout = 0;
					if (expLst.Count == 0 || expLst.FirstOrDefault() == "None") return Task.FromResult<IEnumerable<TODO_CreateEx9>>(new List<TODO_CreateEx9>());
					var set = AddIncludes(includesLst, dbContext);
		...
		public Task<IEnumerable<TODO_CreateEx9>> GetTODO_CreateEx9ByExpressionNav(string exp,
            ...
            try
            {
                using (var dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
                {
                    ...
                    if (exp == "All" && navExp.Count == 0)
                    {
                        ...
                        return Task.FromResult<IEnumerable<TODO_CreateEx9>>(aentities); 
                    }
					var set = AddIncludes(includesLst, dbContext);
                    var entities = set.AsNoTracking().Where(exp)
									.ToList();
        ...
        public Task<IEnumerable<TODO_CreateEx9>> GetTODO_CreateEx9ByBatch(string exp,
                                                                          int totalrow, List<string> includesLst = null, bool tracking = true)
        {
            try
            {

                var res = new ConcurrentQueue<List<TODO_CreateEx9>>();
                    ...
                    //  for (int bat = 0; bat < batches; bat++)
                    {
                        try
                        {
                            using (var dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
                            {
                                ...
                                var set = AddIncludes(includesLst, dbContext);
                                IQueryable<TODO_CreateEx9> dset;
                                if (exp == "All")
                                {
        ...
        public Task<IEnumerable<TODO_CreateEx9>> GetTODO_CreateEx9ByBatchExpressionLst(List<string> expLst,
                                                                                       int totalrow, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
        ...
        public Task<TODO_CreateEx9> UpdateTODO_CreateEx9(TODO_CreateEx9 entity)
        { 
            using ( var dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
              {
                try
                {   
                     var res = (TODO_CreateEx9) entity;
        ...
        public Task<TODO_CreateEx9> CreateTODO_CreateEx9(TODO_CreateEx9 entity)
        {
            try
            {
                var res = (TODO_CreateEx9) entity;
              using ( var dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
              {
                dbContext.TODO_CreateEx9.Add(res);
                dbContext.SaveChanges();
                res.AcceptChanges();
                return Task.FromResult(res);
              }
        ...
        public Task<bool> DeleteTODO_CreateEx9(string ApplicationSettingsId)
        {
            try
            {
              using ( var dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
              {
                var i = Convert.ToInt32(ApplicationSettingsId);
                TODO_CreateEx9 entity = dbContext.TODO_CreateEx9
													.SingleOrDefault(x => x.ApplicationSettingsId == i);
                if (entity == null)
                    return Task.FromResult(false);

                    dbContext.TODO_CreateEx9.Attach(entity);
                    dbContext.TODO_CreateEx9.Remove(entity);
                    dbContext.SaveChanges();
        ...
        public async Task<bool> RemoveSelectedTODO_CreateEx9(IEnumerable<string> lst)
        {
            try
            {
                StatusModel.StartStatusUpdate("Removing TODO_CreateEx9", lst.Count());
                var t = Task.Run(() =>
                {
                    using (var ctx = new TODO_CreateEx9Service())
                    {
                        foreach (var item in lst.ToList())
                        {

                            ctx.DeleteTODO_CreateEx9(item).Wait();
         ...
         public Task<int> CountByExpressionLst(List<string> expLst)
        {
            try
            {
                using (var dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
                {
                    ...
                    var set = (IQueryable<TODO_CreateEx9>)dbContext.TODO_CreateEx9; 
                    if (expLst.FirstOrDefault() == "All")
                    {
		...
		public Task<int> Count(string exp)
        {
            try
            {
                using (CoreEntitiesContext dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
                {
                    ...
                    if (exp == "All")
                    {
                        return Task.FromResult(dbContext.TODO_CreateEx9
                            .AsNoTracking()
                            .Count());
                    }
                    else
        ...
        public Task<IEnumerable<TODO_CreateEx9>> LoadRange(int startIndex, int count, string exp)
        {
            try
            {
                using (var dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
                {
                    ...
                    if (exp == "All")
                    {
                        return Task.FromResult<IEnumerable<TODO_CreateEx9>>(dbContext.TODO_CreateEx9
                            .AsNoTracking()
		...
		public Task<int> CountNav(string exp, Dictionary<string, string> navExp)
        {
            try
            {
                ...
                using (var dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
                {
                    ...
                    return Task.FromResult(dbContext.TODO_CreateEx9.Where(exp == "All" || exp == null ? "ApplicationSettingsId != null" : exp)
                        .AsNoTracking()
                        .Count());
                }
		...
		private static Task<int> CountWhereSelectMany<T>(CoreEntitiesContext dbContext, string exp, string navExp, string navProp) where T : class
        {
            ...
            return Task.FromResult(dbContext.Set<T>()
                .AsNoTracking()
                .Where(navExp)
                .SelectMany(navProp).OfType<TODO_CreateEx9>()
		...
		private static Task<int> CountWhereSelect<T>(CoreEntitiesContext dbContext, string exp, string navExp, string navProp) where T : class
        {
            ...
            return Task.FromResult(dbContext.Set<T>()
                .AsNoTracking()
                .Where(navExp)
                .Select(navProp).OfType<TODO_CreateEx9>()
                .Where(exp == "All" || exp == null ? "ApplicationSettingsId != null" : exp)
                .Distinct()
                .OrderBy("ApplicationSettingsId")
                .Count());
		  ...
		  public Task<IEnumerable<TODO_CreateEx9>> LoadRangeNav(int startIndex, int count, string exp,
                                                                Dictionary<string, string> navExp, IEnumerable<string> includeLst = null)
        {
            try
            {
                ...
                {
                    dbContext.Database.CommandTimeout = 0;
                    if ((string.IsNullOrEmpty(exp) && navExp.Count == 0) || exp == "None") return Task.FromResult<IEnumerable<TODO_CreateEx9>>(new List<TODO_CreateEx9>());
                    var set = AddIncludes(includeLst, dbContext);

                    if (exp == "All" && navExp.Count == 0)
                    {
                       
                        return Task.FromResult<IEnumerable<TODO_CreateEx9>>(set
                            .AsNoTracking()
                            .OrderBy(y => y.ApplicationSettingsId)
                    ...
                    return Task.FromResult<IEnumerable<TODO_CreateEx9>>(set//dbContext.TODO_CreateEx9
                        .AsNoTracking()
                        .Where(exp == "All" || exp == null ? "ApplicationSettingsId != null" : exp)
                        .OrderBy(y => y.ApplicationSettingsId)
		...
		private static async Task<IEnumerable<TODO_CreateEx9>> LoadRangeWhere<T>(int startIndex, int count,
		...
		private static Task<IEnumerable<TODO_CreateEx9>> LoadRangeSelectMany<T>(int startIndex, int count,
		...
		private static Task<IEnumerable<TODO_CreateEx9>> LoadRangeSelect<T>(int startIndex, int count,
                                                                            CoreEntitiesContext dbContext, string exp, string navExp, string navProp, IEnumerable<string> includeLst = null) where T : class
        {
			try
			{
        ...
        private static async Task<IEnumerable<TODO_CreateEx9>> GetWhere<T>(CoreEntitiesContext dbContext,
		...
		private static Task<IEnumerable<TODO_CreateEx9>> GetWhereSelectMany<T>(CoreEntitiesContext dbContext,
                                                                               string exp, string navExp, string navProp, List<string> includesLst = null) where T : class
        {
			...
			if (includesLst == null)
			{
				return Task.FromResult<IEnumerable<TODO_CreateEx9>>(dbContext.Set<T>()
                    .AsNoTracking()
                    .Where(navExp)
                    .SelectMany(navProp).OfType<TODO_CreateEx9>()
                    .Where(exp == "All" || exp == null?"ApplicationSettingsId != null":exp)
			...
			var set = (DbQuery<TODO_CreateEx9>)dbContext.Set<T>()
				.AsNoTracking()
                .Where(navExp)
                .SelectMany(navProp).OfType<TODO_CreateEx9>()
                .Where(exp == "All" || exp == null?"ApplicationSettingsId != null":exp)
            ...
            return Task.FromResult<IEnumerable<TODO_CreateEx9>>(set.ToList());
			}
			catch (Exception)
			{
				Debugger.Break();
		...
		private static Task<IEnumerable<TODO_CreateEx9>> GetWhereSelect<T>(CoreEntitiesContext dbContext,
                                                                           string exp, string navExp, string navProp, List<string> includesLst = null) where T : class
        {
			try
			{
             ...
             try
             {
                 using (var dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
                 {
					...
					decimal res = 0;
                     ...
                     if (whereExp == "All")
                     {
                          res = Convert.ToDecimal(dbContext.TODO_CreateEx9.AsNoTracking().Sum(field));
                     }
                     else
                     {
                         res = Convert.ToDecimal(dbContext.TODO_CreateEx9.AsNoTracking().Where(whereExp).Sum(field));
                     }
        ...
        public Task<decimal> SumNav( string exp, Dictionary<string, string> navExp, string field)
        {
            try
            {
                ...
                {
                    dbContext.Database.CommandTimeout = 0;
                    if (!dbContext.TODO_CreateEx9.Any()) return Task.FromResult<decimal>(0);
                    if (exp == "All" && navExp.Count == 0)
                    {
                        return Task.FromResult(Convert.ToDecimal(dbContext.TODO_CreateEx9
                                                                     .AsNoTracking()
                                                                     .Sum(field)??0));
                    }
                    return Task.FromResult(Convert.ToDecimal(dbContext.TODO_CreateEx9.Where(exp == "All" || exp == null ? "ApplicationSettingsId != null" : exp)
                                                                 .AsNoTracking()
                                                                 .Sum(field)??0));
                }
             ...
             try
             {
                 using (var dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
                 {
					...
					string res = "";
                     ...
                     if (whereExp == "All")
                     {
                          res = Convert.ToString(dbContext.TODO_CreateEx9.AsNoTracking().Min(field));
                     }
                     else
                     {
                         res = Convert.ToString(dbContext.TODO_CreateEx9.AsNoTracking().Where(whereExp).Min(field));
                     }
		...
		private static IQueryable<TODO_CreateEx9> AddIncludes(IEnumerable<string> includesLst, CoreEntitiesContext dbContext)
       {
		 try
			{
			   if (includesLst == null) includesLst = new List<string>();
			   var set =(DbQuery<TODO_CreateEx9>) dbContext.TODO_CreateEx9; 
	   ...
	   private IQueryable<TODO_CreateEx9> AddWheres(List<string> expLst, IQueryable<TODO_CreateEx9> set)
        {
            try
            {
