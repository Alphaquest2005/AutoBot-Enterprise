...
namespace CoreEntities.Business.Services
{
   ...
   [ServiceBehavior(InstanceContextMode = InstanceContextMode.PerCall,
    ...
    public partial class xcuda_Supplementary_unitService : Ixcuda_Supplementary_unitService, IDisposable
    {
		...
		private static Task<IEnumerable<xcuda_Supplementary_unit>> GetWhereSelectMany<T>(CoreEntitiesContext dbContext,
		...
		private static Task<IEnumerable<xcuda_Supplementary_unit>> GetWhereSelect<T>(CoreEntitiesContext dbContext,
                                                                                     string exp, string navExp, string navProp, List<string> includesLst = null) where T : class
        {
			try
			{
