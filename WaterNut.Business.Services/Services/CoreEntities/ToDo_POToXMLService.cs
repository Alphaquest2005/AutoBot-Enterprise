...
namespace CoreEntities.Business.Services
{
   ...
   [ServiceBehavior(InstanceContextMode = InstanceContextMode.PerCall,
    ...
    public partial class ToDo_POToXMLService : IToDo_POToXMLService, IDisposable
    {
        ...
        public Task<IEnumerable<ToDo_POToXML>> GetToDo_POToXML(List<string> includesLst = null, bool tracking = true)
        {
            try
            {
            //using (var scope = new TransactionScope(TransactionScopeOption.Required,
               ...
               // {
                  using ( var dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
                  {
                    ...
                    IEnumerable<ToDo_POToXML> entities = set.AsNoTracking().ToList();
                           //scope.Complete();
        ...
        public Task<ToDo_POToXML> GetToDo_POToXMLByKey(string EntryDataDetailsId, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
			   if(string.IsNullOrEmpty(EntryDataDetailsId))return Task.FromResult<ToDo_POToXML>(null); 
              using ( var dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
              {
                var i = Convert.ToInt32(EntryDataDetailsId);
				var set = AddIncludes(includesLst, dbContext);
                ToDo_POToXML entity = set.AsNoTracking().SingleOrDefault(x => x.EntryDataDetailsId == i);
		 ...
		 public Task<IEnumerable<ToDo_POToXML>> GetToDo_POToXMLByExpression(string exp, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
                using (var dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
                {
					...
					if (string.IsNullOrEmpty(exp) || exp == "None") return Task.FromResult<IEnumerable<ToDo_POToXML>>(new List<ToDo_POToXML>());
					var set = AddIncludes(includesLst, dbContext);
                    if (exp == "All")
                    {
                        ...
                        if(tracking) entities.AsParallel(new ParallelLinqOptions() { MaxDegreeOfParallelism = Environment.ProcessorCount }).ForAll(x => x.StartTracking());
                        return Task.FromResult<IEnumerable<ToDo_POToXML>>(entities); 
                    }
					else
					{
		 ...
		 public Task<IEnumerable<ToDo_POToXML>> GetToDo_POToXMLByExpressionLst(List<string> expLst, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
                using (var dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
                {
                    dbContext.Database.CommandTimeout = 0;
					if (expLst.Count == 0 || expLst.FirstOrDefault() == "None") return Task.FromResult<IEnumerable<ToDo_POToXML>>(new List<ToDo_POToXML>());
					var set = AddIncludes(includesLst, dbContext);
		...
		public Task<IEnumerable<ToDo_POToXML>> GetToDo_POToXMLByExpressionNav(string exp,
            ...
            try
            {
                using (var dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
                {
                    ...
                    if (exp == "All" && navExp.Count == 0)
                    {
                        ...
                        return Task.FromResult<IEnumerable<ToDo_POToXML>>(aentities); 
                    }
					var set = AddIncludes(includesLst, dbContext);
                    var entities = set.AsNoTracking().Where(exp)
									.ToList();
        ...
        public Task<IEnumerable<ToDo_POToXML>> GetToDo_POToXMLByBatch(string exp,
        ...
        public Task<IEnumerable<ToDo_POToXML>> GetToDo_POToXMLByBatchExpressionLst(List<string> expLst,
                                                                                   int totalrow, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
        ...
        public Task<ToDo_POToXML> UpdateToDo_POToXML(ToDo_POToXML entity)
        { 
            using ( var dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
              {
                try
        ...
        public Task<ToDo_POToXML> CreateToDo_POToXML(ToDo_POToXML entity)
        {
            try
            {
                var res = (ToDo_POToXML) entity;
        ...
        public Task<bool> DeleteToDo_POToXML(string EntryDataDetailsId)
        {
            try
            {
              using ( var dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
              {
                var i = Convert.ToInt32(EntryDataDetailsId);
                ToDo_POToXML entity = dbContext.ToDo_POToXML
		...
		public Task<int> Count(string exp)
        {
            try
            {
                using (CoreEntitiesContext dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
                {
                    ...
                    if (exp == "All")
                    {
                        return Task.FromResult(dbContext.ToDo_POToXML
                            .AsNoTracking()
                            .Count());
                    }
                    else
        ...
        public Task<IEnumerable<ToDo_POToXML>> LoadRange(int startIndex, int count, string exp)
        {
            try
            {
                using (var dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
                {
                    ...
                    if (exp == "All")
                    {
                        return Task.FromResult<IEnumerable<ToDo_POToXML>>(dbContext.ToDo_POToXML
                            .AsNoTracking()
		...
		public Task<int> CountNav(string exp, Dictionary<string, string> navExp)
        {
            try
            {
                ...
                using (var dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
                {
                    ...
                    return Task.FromResult(dbContext.ToDo_POToXML.Where(exp == "All" || exp == null ? "EntryDataDetailsId != null" : exp)
                        .AsNoTracking()
                        .Count());
                }
		...
		private static Task<int> CountWhereSelect<T>(CoreEntitiesContext dbContext, string exp, string navExp, string navProp) where T : class
        {
		  ...
		  public Task<IEnumerable<ToDo_POToXML>> LoadRangeNav(int startIndex, int count, string exp,
                                                              Dictionary<string, string> navExp, IEnumerable<string> includeLst = null)
        {
            try
            {
                ...
                {
                    dbContext.Database.CommandTimeout = 0;
                    if ((string.IsNullOrEmpty(exp) && navExp.Count == 0) || exp == "None") return Task.FromResult<IEnumerable<ToDo_POToXML>>(new List<ToDo_POToXML>());
                    var set = AddIncludes(includeLst, dbContext);

                    if (exp == "All" && navExp.Count == 0)
                    {
                       
                        return Task.FromResult<IEnumerable<ToDo_POToXML>>(set
                            .AsNoTracking()
                            .OrderBy(y => y.EntryDataDetailsId)
                    ...
                    return Task.FromResult<IEnumerable<ToDo_POToXML>>(set//dbContext.ToDo_POToXML
                        .AsNoTracking()
                        .Where(exp == "All" || exp == null ? "EntryDataDetailsId != null" : exp)
                        .OrderBy(y => y.EntryDataDetailsId)
		...
		private static Task<IEnumerable<ToDo_POToXML>> LoadRangeSelectMany<T>(int startIndex, int count,
		...
		private static Task<IEnumerable<ToDo_POToXML>> LoadRangeSelect<T>(int startIndex, int count,
                                                                          CoreEntitiesContext dbContext, string exp, string navExp, string navProp, IEnumerable<string> includeLst = null) where T : class
        {
			try
			{
        ...
        private static async Task<IEnumerable<ToDo_POToXML>> GetWhere<T>(CoreEntitiesContext dbContext,
		...
		private static Task<IEnumerable<ToDo_POToXML>> GetWhereSelectMany<T>(CoreEntitiesContext dbContext,
                                                                             string exp, string navExp, string navProp, List<string> includesLst = null) where T : class
        {
			...
			if (includesLst == null)
			{
				return Task.FromResult<IEnumerable<ToDo_POToXML>>(dbContext.Set<T>()
                    .AsNoTracking()
                    .Where(navExp)
                    .SelectMany(navProp).OfType<ToDo_POToXML>()
                    .Where(exp == "All" || exp == null?"EntryDataDetailsId != null":exp)
            ...
            return Task.FromResult<IEnumerable<ToDo_POToXML>>(set.ToList());
			}
			catch (Exception)
			{
				Debugger.Break();
		...
		private static Task<IEnumerable<ToDo_POToXML>> GetWhereSelect<T>(CoreEntitiesContext dbContext,
                                                                         string exp, string navExp, string navProp, List<string> includesLst = null) where T : class
        {
			try
			{
        ...
        public Task<decimal> SumNav( string exp, Dictionary<string, string> navExp, string field)
        {
            try
            {
                ...
                {
                    dbContext.Database.CommandTimeout = 0;
                    if (!dbContext.ToDo_POToXML.Any()) return Task.FromResult<decimal>(0);
                    if (exp == "All" && navExp.Count == 0)
                    {
                        return Task.FromResult(Convert.ToDecimal(dbContext.ToDo_POToXML
                                                                     .AsNoTracking()
                                                                     .Sum(field)??0));
                    }
                    return Task.FromResult(Convert.ToDecimal(dbContext.ToDo_POToXML.Where(exp == "All" || exp == null ? "EntryDataDetailsId != null" : exp)
                                                                 .AsNoTracking()
                                                                 .Sum(field)??0));
                }
		...
		private static IQueryable<ToDo_POToXML> AddIncludes(IEnumerable<string> includesLst, CoreEntitiesContext dbContext)
       {
		 try
			{
