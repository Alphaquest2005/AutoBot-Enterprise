...
namespace CoreEntities.Business.Services
{
   ...
   [ServiceBehavior(InstanceContextMode = InstanceContextMode.PerCall,
    ...
    public partial class ExpiredEntriesLstService : IExpiredEntriesLstService, IDisposable
    {
        //private readonly CoreEntitiesContext dbContext;

        public bool StartTracking { get; set; }

        public ExpiredEntriesLstService()
        {
            try
            {
        ...
        public Task<IEnumerable<ExpiredEntriesLst>> GetExpiredEntriesLst(List<string> includesLst = null, bool tracking = true)
        {
            try
            {
            //using (var scope = new TransactionScope(TransactionScopeOption.Required,
               ...
               // {
                  using ( var dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
                  {
                    ...
                    IEnumerable<ExpiredEntriesLst> entities = set.AsNoTracking().ToList();
                           //scope.Complete();
        ...
        public Task<ExpiredEntriesLst> GetExpiredEntriesLstByKey(string Office, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
			   if(string.IsNullOrEmpty(Office))return Task.FromResult<ExpiredEntriesLst>(null); 
              using ( var dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
              {
                var i = Office;
				var set = AddIncludes(includesLst, dbContext);
		 ...
		 public Task<IEnumerable<ExpiredEntriesLst>> GetExpiredEntriesLstByExpression(string exp, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
                using (var dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
                {
					...
					if (string.IsNullOrEmpty(exp) || exp == "None") return Task.FromResult<IEnumerable<ExpiredEntriesLst>>(new List<ExpiredEntriesLst>());
					var set = AddIncludes(includesLst, dbContext);
                    if (exp == "All")
                    {
                        ...
                        if(tracking) entities.AsParallel(new ParallelLinqOptions() { MaxDegreeOfParallelism = Environment.ProcessorCount }).ForAll(x => x.StartTracking());
                        return Task.FromResult<IEnumerable<ExpiredEntriesLst>>(entities); 
                    }
					else
					{
		 ...
		 public Task<IEnumerable<ExpiredEntriesLst>> GetExpiredEntriesLstByExpressionLst(List<string> expLst, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
                using (var dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
                {
                    dbContext.Database.CommandTimeout = 0;
					if (expLst.Count == 0 || expLst.FirstOrDefault() == "None") return Task.FromResult<IEnumerable<ExpiredEntriesLst>>(new List<ExpiredEntriesLst>());
					var set = AddIncludes(includesLst, dbContext);
		...
		public Task<IEnumerable<ExpiredEntriesLst>> GetExpiredEntriesLstByExpressionNav(string exp,
            ...
            try
            {
                using (var dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
                {
                    ...
                    if (exp == "All" && navExp.Count == 0)
                    {
                        ...
                        return Task.FromResult<IEnumerable<ExpiredEntriesLst>>(aentities); 
                    }
					var set = AddIncludes(includesLst, dbContext);
                    var entities = set.AsNoTracking().Where(exp)
									.ToList();
        ...
        public Task<IEnumerable<ExpiredEntriesLst>> GetExpiredEntriesLstByBatch(string exp,
                                                                                int totalrow, List<string> includesLst = null, bool tracking = true)
        {
            try
            {

                var res = new ConcurrentQueue<List<ExpiredEntriesLst>>();
        ...
        public Task<IEnumerable<ExpiredEntriesLst>> GetExpiredEntriesLstByBatchExpressionLst(List<string> expLst,
                                                                                             int totalrow, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
        ...
        public Task<ExpiredEntriesLst> UpdateExpiredEntriesLst(ExpiredEntriesLst entity)
        { 
            using ( var dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
              {
                try
                {   
                     var res = (ExpiredEntriesLst) entity;
        ...
        public Task<ExpiredEntriesLst> CreateExpiredEntriesLst(ExpiredEntriesLst entity)
        {
            try
            {
                var res = (ExpiredEntriesLst) entity;
              using ( var dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
              {
                dbContext.ExpiredEntriesLst.Add(res);
                dbContext.SaveChanges();
                res.AcceptChanges();
                return Task.FromResult(res);
              }
        ...
        public Task<bool> DeleteExpiredEntriesLst(string Office)
        {
            try
            {
              using ( var dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
              {
                ...
                if (entity == null)
                    ...
                    dbContext.ExpiredEntriesLst.Attach(entity);
                    dbContext.ExpiredEntriesLst.Remove(entity);
                    dbContext.SaveChanges();
        ...
        public async Task<bool> RemoveSelectedExpiredEntriesLst(IEnumerable<string> lst)
        {
            try
            {
                StatusModel.StartStatusUpdate("Removing ExpiredEntriesLst", lst.Count());
                var t = Task.Run(() =>
                {
                    using (var ctx = new ExpiredEntriesLstService())
                    {
                        foreach (var item in lst.ToList())
                        {

                            ctx.DeleteExpiredEntriesLst(item).Wait();
         ...
         public Task<int> CountByExpressionLst(List<string> expLst)
        {
            try
            {
                using (var dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
                {
                    ...
                    var set = (IQueryable<ExpiredEntriesLst>)dbContext.ExpiredEntriesLst; 
                    if (expLst.FirstOrDefault() == "All")
                    {
		...
		public Task<int> Count(string exp)
        {
            try
            {
                using (CoreEntitiesContext dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
                {
                    ...
                    if (exp == "All")
                    {
                        return Task.FromResult(dbContext.ExpiredEntriesLst
                            .AsNoTracking()
                            .Count());
                    }
                    else
        ...
        public Task<IEnumerable<ExpiredEntriesLst>> LoadRange(int startIndex, int count, string exp)
        {
            try
            {
                using (var dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
                {
                    ...
                    if (exp == "All")
                    {
                        return Task.FromResult<IEnumerable<ExpiredEntriesLst>>(dbContext.ExpiredEntriesLst
                            .AsNoTracking()
                            .OrderBy(y => y.Office)
                            .Skip(startIndex)
                            .Take(count)
		...
		public Task<int> CountNav(string exp, Dictionary<string, string> navExp)
        {
            try
            {
                ...
                using (var dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
                {
                    ...
                    return Task.FromResult(dbContext.ExpiredEntriesLst.Where(exp == "All" || exp == null ? "Office != null" : exp)
                        .AsNoTracking()
                        .Count());
                }
		...
		private static Task<int> CountWhereSelect<T>(CoreEntitiesContext dbContext, string exp, string navExp, string navProp) where T : class
        {
		  ...
		  public Task<IEnumerable<ExpiredEntriesLst>> LoadRangeNav(int startIndex, int count, string exp,
                                                                   Dictionary<string, string> navExp, IEnumerable<string> includeLst = null)
        {
            try
            {
                ...
                {
                    dbContext.Database.CommandTimeout = 0;
                    if ((string.IsNullOrEmpty(exp) && navExp.Count == 0) || exp == "None") return Task.FromResult<IEnumerable<ExpiredEntriesLst>>(new List<ExpiredEntriesLst>());
                    var set = AddIncludes(includeLst, dbContext);

                    if (exp == "All" && navExp.Count == 0)
                    {
                       
                        return Task.FromResult<IEnumerable<ExpiredEntriesLst>>(set
                            .AsNoTracking()
                            .OrderBy(y => y.Office)
                    ...
                    return Task.FromResult<IEnumerable<ExpiredEntriesLst>>(set//dbContext.ExpiredEntriesLst
                        .AsNoTracking()
                        .Where(exp == "All" || exp == null ? "Office != null" : exp)
                        .OrderBy(y => y.Office)
		...
		private static async Task<IEnumerable<ExpiredEntriesLst>> LoadRangeWhere<T>(int startIndex, int count,
		...
		private static Task<IEnumerable<ExpiredEntriesLst>> LoadRangeSelectMany<T>(int startIndex, int count,
		...
		private static Task<IEnumerable<ExpiredEntriesLst>> LoadRangeSelect<T>(int startIndex, int count,
                                                                               CoreEntitiesContext dbContext, string exp, string navExp, string navProp, IEnumerable<string> includeLst = null) where T : class
        {
			try
			{
        ...
        private static async Task<IEnumerable<ExpiredEntriesLst>> GetWhere<T>(CoreEntitiesContext dbContext,
		...
		private static Task<IEnumerable<ExpiredEntriesLst>> GetWhereSelectMany<T>(CoreEntitiesContext dbContext,
                                                                                  string exp, string navExp, string navProp, List<string> includesLst = null) where T : class
        {
			...
			if (includesLst == null)
			{
				return Task.FromResult<IEnumerable<ExpiredEntriesLst>>(dbContext.Set<T>()
                    .AsNoTracking()
                    .Where(navExp)
                    .SelectMany(navProp).OfType<ExpiredEntriesLst>()
                    .Where(exp == "All" || exp == null?"Office != null":exp)
			...
			var set = (DbQuery<ExpiredEntriesLst>)dbContext.Set<T>()
				.AsNoTracking()
                .Where(navExp)
                .SelectMany(navProp).OfType<ExpiredEntriesLst>()
                .Where(exp == "All" || exp == null?"Office != null":exp)
            ...
            return Task.FromResult<IEnumerable<ExpiredEntriesLst>>(set.ToList());
			}
			catch (Exception)
			{
				Debugger.Break();
		...
		private static Task<IEnumerable<ExpiredEntriesLst>> GetWhereSelect<T>(CoreEntitiesContext dbContext,
                                                                              string exp, string navExp, string navProp, List<string> includesLst = null) where T : class
        {
			try
			{
			...
			catch (Exception)
			{
				...
				throw;
			        ...
			        public Task<IEnumerable<ExpiredEntriesLst>> GetExpiredEntriesLstByApplicationSettingsId(string ApplicationSettingsId, List<string> includesLst = null)
        {
            try
            {
                using ( var dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
              {
                ...
                var set = AddIncludes(includesLst, dbContext);
                IEnumerable<ExpiredEntriesLst> entities = set//dbContext.ExpiredEntriesLst
                                      .AsNoTracking()
             ...
             try
             {
                 using (var dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
                 {
					...
					decimal res = 0;
                     ...
                     if (whereExp == "All")
                     {
                          res = Convert.ToDecimal(dbContext.ExpiredEntriesLst.AsNoTracking().Sum(field));
                     }
                     else
                     {
                         res = Convert.ToDecimal(dbContext.ExpiredEntriesLst.AsNoTracking().Where(whereExp).Sum(field));
                     }
        ...
        public Task<decimal> SumNav( string exp, Dictionary<string, string> navExp, string field)
        {
            try
            {
                ...
                {
                    dbContext.Database.CommandTimeout = 0;
                    if (!dbContext.ExpiredEntriesLst.Any()) return Task.FromResult<decimal>(0);
                    if (exp == "All" && navExp.Count == 0)
                    {
                        return Task.FromResult(Convert.ToDecimal(dbContext.ExpiredEntriesLst
                                                                     .AsNoTracking()
                                                                     .Sum(field)??0));
                    }
                    return Task.FromResult(Convert.ToDecimal(dbContext.ExpiredEntriesLst.Where(exp == "All" || exp == null ? "Office != null" : exp)
                                                                 .AsNoTracking()
                                                                 .Sum(field)??0));
                }
             ...
             try
             {
                 using (var dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
                 {
					...
					string res = "";
                     ...
                     if (whereExp == "All")
                     {
                          res = Convert.ToString(dbContext.ExpiredEntriesLst.AsNoTracking().Min(field));
                     }
                     else
                     {
                         res = Convert.ToString(dbContext.ExpiredEntriesLst.AsNoTracking().Where(whereExp).Min(field));
                     }
		...
		private static IQueryable<ExpiredEntriesLst> AddIncludes(IEnumerable<string> includesLst, CoreEntitiesContext dbContext)
       {
		 try
			{
			   if (includesLst == null) includesLst = new List<string>();
			   var set =(DbQuery<ExpiredEntriesLst>) dbContext.ExpiredEntriesLst; 
	   ...
	   private IQueryable<ExpiredEntriesLst> AddWheres(List<string> expLst, IQueryable<ExpiredEntriesLst> set)
        {
            try
            {
