...
namespace CoreEntities.Business.Services
{
   ...
   [ServiceBehavior(InstanceContextMode = InstanceContextMode.PerCall,
    ...
    public partial class TODO_ERRReport_ByItemNumberService : ITODO_ERRReport_ByItemNumberService, IDisposable
    {
        ...
        public async Task<IEnumerable<TODO_ERRReport_ByItemNumber>> GetTODO_ERRReport_ByItemNumber(List<string> includesLst = null, bool tracking = true)
        {
            try
            {
            //using (var scope = new TransactionScope(TransactionScopeOption.Required,
               ...
               // {
                  using ( var dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
                  {
                    ...
                    IEnumerable<TODO_ERRReport_ByItemNumber> entities = await set.AsNoTracking().ToListAsync()
        ...
        public async Task<TODO_ERRReport_ByItemNumber> GetTODO_ERRReport_ByItemNumberByKey(string Error, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
              ...
              using ( var dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
              {
                var i = Error;
				var set = AddIncludes(includesLst, dbContext);
                TODO_ERRReport_ByItemNumber entity = await set.AsNoTracking().SingleOrDefaultAsync(x => x.Error == i).ConfigureAwait(continueOnCapturedContext: false);
		 ...
		 public async Task<IEnumerable<TODO_ERRReport_ByItemNumber>> GetTODO_ERRReport_ByItemNumberByExpression(string exp, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
                using (var dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
                {
					...
					if (string.IsNullOrEmpty(exp) || exp == "None") return new List<TODO_ERRReport_ByItemNumber>();
					var set = AddIncludes(includesLst, dbContext);
                    if (exp == "All")
                    {
		 ...
		 public async Task<IEnumerable<TODO_ERRReport_ByItemNumber>> GetTODO_ERRReport_ByItemNumberByExpressionLst(List<string> expLst, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
                using (var dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
                {
                    dbContext.Database.CommandTimeout = 0;
					if (expLst.Count == 0 || expLst.FirstOrDefault() == "None") return new List<TODO_ERRReport_ByItemNumber>();
					var set = AddIncludes(includesLst, dbContext);
        ...
        public async Task<bool> DeleteTODO_ERRReport_ByItemNumber(string Error)
        {
            try
            {
              using ( var dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
              {
                var i = Error;
                TODO_ERRReport_ByItemNumber entity = await dbContext.TODO_ERRReport_ByItemNumber
		...
		public async Task<int> Count(string exp)
        {
            try
            {
                using (CoreEntitiesContext dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
                {
                    ...
                    if (exp == "All")
                    {
                        return await dbContext.TODO_ERRReport_ByItemNumber
                                    .AsNoTracking()
									.CountAsync()
									.ConfigureAwait(continueOnCapturedContext: false);
                    }
		...
		public async Task<int> CountNav(string exp, Dictionary<string, string> navExp)
        {
            try
            {
                ...
                using (var dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
                {
                    ...
                    return await dbContext.TODO_ERRReport_ByItemNumber.Where(exp == "All" || exp == null ? "Error != null" : exp)
											.AsNoTracking()
                                            .CountAsync()
											.ConfigureAwait(continueOnCapturedContext: false);
                }
                                                                                 ...
                                                                                 Dictionary<string, string> navExp, IEnumerable<string> includeLst = null)
        {
            try
            {
                ...
                {
                    dbContext.Database.CommandTimeout = 0;
                    if ((string.IsNullOrEmpty(exp) && navExp.Count == 0) || exp == "None") return new List<TODO_ERRReport_ByItemNumber>();
                    ...
                    return await set//dbContext.TODO_ERRReport_ByItemNumber
								.AsNoTracking()
                                .Where(exp == "All" || exp == null ? "Error != null" : exp)
								.OrderBy(y => y.Error)
		...
		private static async Task<IEnumerable<TODO_ERRReport_ByItemNumber>> LoadRangeSelectMany<T>(int startIndex, int count,
		...
		private static async Task<IEnumerable<TODO_ERRReport_ByItemNumber>> LoadRangeSelect<T>(int startIndex, int count,
            CoreEntitiesContext dbContext, string exp, string navExp, string navProp, IEnumerable<string> includeLst = null) where T : class
        {
			try
			{
		...
		private static async Task<IEnumerable<TODO_ERRReport_ByItemNumber>> GetWhereSelectMany<T>(CoreEntitiesContext dbContext,
		...
		private static async Task<IEnumerable<TODO_ERRReport_ByItemNumber>> GetWhereSelect<T>(CoreEntitiesContext dbContext,
            string exp, string navExp, string navProp, List<string> includesLst = null) where T : class
        {
			try
			{
			        ...
			        public async Task<IEnumerable<TODO_ERRReport_ByItemNumber>> GetTODO_ERRReport_ByItemNumberByApplicationSettingsId(string ApplicationSettingsId, List<string> includesLst = null)
        {
            try
            {
                using ( var dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
              {
                ...
                var set = AddIncludes(includesLst, dbContext);
                IEnumerable<TODO_ERRReport_ByItemNumber> entities = await set//dbContext.TODO_ERRReport_ByItemNumber
                                      .AsNoTracking()
        ...
        public async Task<decimal> SumNav( string exp, Dictionary<string, string> navExp, string field)
        {
            try
            {
                ...
                {
                    dbContext.Database.CommandTimeout = 0;
                    if (!dbContext.TODO_ERRReport_ByItemNumber.Any()) return 0;
                    if (exp == "All" && navExp.Count == 0)
                    {
                        return Convert.ToDecimal(dbContext.TODO_ERRReport_ByItemNumber
										.AsNoTracking()
                                        .Sum(field)??0);
                    }
                    return Convert.ToDecimal(dbContext.TODO_ERRReport_ByItemNumber.Where(exp == "All" || exp == null ? "Error != null" : exp)
											.AsNoTracking()
                                            .Sum(field)??0);
                }
