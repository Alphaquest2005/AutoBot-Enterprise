...
namespace CoreEntities.Business.Services
{
   ...
   [ServiceBehavior(InstanceContextMode = InstanceContextMode.PerCall,
    ...
    public partial class InventoryItemAliasService : IInventoryItemAliasService, IDisposable
    {
        ...
        private static async Task<IEnumerable<InventoryItemAlias>> GetWhere<T>(CoreEntitiesContext dbContext,
		...
		private static async Task<IEnumerable<InventoryItemAlias>> GetWhereSelectMany<T>(CoreEntitiesContext dbContext,
		...
		private static async Task<IEnumerable<InventoryItemAlias>> GetWhereSelect<T>(CoreEntitiesContext dbContext,
            string exp, string navExp, string navProp, List<string> includesLst = null) where T : class
        {
			try
			{
		...
		private static IQueryable<InventoryItemAlias> AddIncludes(IEnumerable<string> includesLst, CoreEntitiesContext dbContext)
       {
		 try
			{
