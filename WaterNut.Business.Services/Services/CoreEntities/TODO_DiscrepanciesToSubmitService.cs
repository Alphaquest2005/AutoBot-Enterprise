...
namespace CoreEntities.Business.Services
{
   ...
   [ServiceBehavior(InstanceContextMode = InstanceContextMode.PerCall,
    ...
    public partial class TODO_DiscrepanciesToSubmitService : ITODO_DiscrepanciesToSubmitService, IDisposable
    {
        //private readonly CoreEntitiesContext dbContext;

        public bool StartTracking { get; set; }

        public TODO_DiscrepanciesToSubmitService()
        {
            try
            {
        ...
        public async Task<IEnumerable<TODO_DiscrepanciesToSubmit>> GetTODO_DiscrepanciesToSubmit(List<string> includesLst = null, bool tracking = true)
        {
            try
            {
            //using (var scope = new TransactionScope(TransactionScopeOption.Required,
               ...
               // {
                  using ( var dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
                  {
                    ...
                    IEnumerable<TODO_DiscrepanciesToSubmit> entities = await set.AsNoTracking().ToListAsync()
        ...
        public async Task<TODO_DiscrepanciesToSubmit> GetTODO_DiscrepanciesToSubmitByKey(string EntryDataDetailsId, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
              ...
              using ( var dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
              {
				...
				var set = AddIncludes(includesLst, dbContext);
                TODO_DiscrepanciesToSubmit entity = await set.AsNoTracking().SingleOrDefaultAsync(x => x.EntryDataDetailsId == i).ConfigureAwait(continueOnCapturedContext: false);
		 ...
		 public async Task<IEnumerable<TODO_DiscrepanciesToSubmit>> GetTODO_DiscrepanciesToSubmitByExpression(string exp, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
                using (var dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
                {
					...
					if (string.IsNullOrEmpty(exp) || exp == "None") return new List<TODO_DiscrepanciesToSubmit>();
					var set = AddIncludes(includesLst, dbContext);
                    if (exp == "All")
                    {
		 ...
		 public async Task<IEnumerable<TODO_DiscrepanciesToSubmit>> GetTODO_DiscrepanciesToSubmitByExpressionLst(List<string> expLst, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
                using (var dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
                {
                    dbContext.Database.CommandTimeout = 0;
					if (expLst.Count == 0 || expLst.FirstOrDefault() == "None") return new List<TODO_DiscrepanciesToSubmit>();
					var set = AddIncludes(includesLst, dbContext);
            ...
            int totalrow, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
                ...
                var res = new ConcurrentQueue<List<TODO_DiscrepanciesToSubmit>>();
                    ...
                    //  for (int bat = 0; bat < batches; bat++)
                    {
                        try
                        {
                            using (var dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
                            {
                                ...
                                var set = AddIncludes(includesLst, dbContext);
                                IQueryable<TODO_DiscrepanciesToSubmit> dset;
                                if (exp == "All")
                                {
            ...
            using ( var dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
              {
                try
                {   
                     var res = (TODO_DiscrepanciesToSubmit) entity;
        ...
        public async Task<TODO_DiscrepanciesToSubmit> CreateTODO_DiscrepanciesToSubmit(TODO_DiscrepanciesToSubmit entity)
        {
            try
            {
              ...
              using ( var dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
              {
                dbContext.TODO_DiscrepanciesToSubmit.Add(res);
                await dbContext.SaveChangesAsync().ConfigureAwait(continueOnCapturedContext: false);
                res.AcceptChanges();
                return res;
              }
        ...
        public async Task<bool> DeleteTODO_DiscrepanciesToSubmit(string EntryDataDetailsId)
        {
            try
            {
              using ( var dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
              {
                var i = Convert.ToInt32(EntryDataDetailsId);
                TODO_DiscrepanciesToSubmit entity = await dbContext.TODO_DiscrepanciesToSubmit
													.SingleOrDefaultAsync(x => x.EntryDataDetailsId == i)
													.ConfigureAwait(continueOnCapturedContext: false);
                if (entity == null)
                    return false;

                    dbContext.TODO_DiscrepanciesToSubmit.Attach(entity);
                    dbContext.TODO_DiscrepanciesToSubmit.Remove(entity);
                    await dbContext.SaveChangesAsync().ConfigureAwait(continueOnCapturedContext: false);
                    return true;
              }
            }
        ...
        public async Task<bool> RemoveSelectedTODO_DiscrepanciesToSubmit(IEnumerable<string> lst)
        {
            try
            {
                StatusModel.StartStatusUpdate("Removing TODO_DiscrepanciesToSubmit", lst.Count());
                var t = Task.Run(() =>
                {
                    using (var ctx = new TODO_DiscrepanciesToSubmitService())
                    {
                        foreach (var item in lst.ToList())
                        {

                            ctx.DeleteTODO_DiscrepanciesToSubmit(item).Wait();
         ...
         public async Task<int> CountByExpressionLst(List<string> expLst)
        {
            try
            {
                using (var dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
                {
                    ...
                    var set = (IQueryable<TODO_DiscrepanciesToSubmit>)dbContext.TODO_DiscrepanciesToSubmit; 
                    if (expLst.FirstOrDefault() == "All")
                    {
		...
		public async Task<int> Count(string exp)
        {
            try
            {
                using (CoreEntitiesContext dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
                {
                    ...
                    if (exp == "All")
                    {
                        return await dbContext.TODO_DiscrepanciesToSubmit
                                    .AsNoTracking()
									.CountAsync()
									.ConfigureAwait(continueOnCapturedContext: false);
                    }
		...
		public async Task<int> CountNav(string exp, Dictionary<string, string> navExp)
        {
            try
            {
                ...
                using (var dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
                {
                    ...
                    return await dbContext.TODO_DiscrepanciesToSubmit.Where(exp == "All" || exp == null ? "EntryDataDetailsId != null" : exp)
											.AsNoTracking()
                                            .CountAsync()
											.ConfigureAwait(continueOnCapturedContext: false);
                }
		...
		private static async Task<int> CountWhereSelectMany<T>(CoreEntitiesContext dbContext, string exp, string navExp, string navProp) where T : class
        {
            ...
            return await dbContext.Set<T>()
				.AsNoTracking()
                .Where(navExp)
                .SelectMany(navProp).OfType<TODO_DiscrepanciesToSubmit>()
		...
		private static async Task<int> CountWhereSelect<T>(CoreEntitiesContext dbContext, string exp, string navExp, string navProp) where T : class
        {
            ...
            return await dbContext.Set<T>()
				.AsNoTracking()
                .Where(navExp)
                .Select(navProp).OfType<TODO_DiscrepanciesToSubmit>()
                .Where(exp == "All" || exp == null ? "EntryDataDetailsId != null" : exp)
                .Distinct()
                .OrderBy("EntryDataDetailsId")
                .CountAsync()
                                                                                 ...
                                                                                 Dictionary<string, string> navExp, IEnumerable<string> includeLst = null)
        {
            try
            {
                ...
                {
                    dbContext.Database.CommandTimeout = 0;
                    if ((string.IsNullOrEmpty(exp) && navExp.Count == 0) || exp == "None") return new List<TODO_DiscrepanciesToSubmit>();
                    ...
                    return await set//dbContext.TODO_DiscrepanciesToSubmit
								.AsNoTracking()
                                .Where(exp == "All" || exp == null ? "EntryDataDetailsId != null" : exp)
								.OrderBy(y => y.EntryDataDetailsId)
		...
		private static async Task<IEnumerable<TODO_DiscrepanciesToSubmit>> LoadRangeWhere<T>(int startIndex, int count,
		...
		private static async Task<IEnumerable<TODO_DiscrepanciesToSubmit>> LoadRangeSelectMany<T>(int startIndex, int count,
		...
		private static async Task<IEnumerable<TODO_DiscrepanciesToSubmit>> LoadRangeSelect<T>(int startIndex, int count,
            CoreEntitiesContext dbContext, string exp, string navExp, string navProp, IEnumerable<string> includeLst = null) where T : class
        {
			try
			{
        ...
        private static async Task<IEnumerable<TODO_DiscrepanciesToSubmit>> GetWhere<T>(CoreEntitiesContext dbContext,
		...
		private static async Task<IEnumerable<TODO_DiscrepanciesToSubmit>> GetWhereSelectMany<T>(CoreEntitiesContext dbContext,
            string exp, string navExp, string navProp, List<string> includesLst = null) where T : class
        {
			...
			var set = (DbQuery<TODO_DiscrepanciesToSubmit>)dbContext.Set<T>()
				.AsNoTracking()
                .Where(navExp)
                .SelectMany(navProp).OfType<TODO_DiscrepanciesToSubmit>()
                .Where(exp == "All" || exp == null?"EntryDataDetailsId != null":exp)
		...
		private static async Task<IEnumerable<TODO_DiscrepanciesToSubmit>> GetWhereSelect<T>(CoreEntitiesContext dbContext,
            string exp, string navExp, string navProp, List<string> includesLst = null) where T : class
        {
			try
			{
			        ...
			        public async Task<IEnumerable<TODO_DiscrepanciesToSubmit>> GetTODO_DiscrepanciesToSubmitByEmailId(string EmailId, List<string> includesLst = null)
        {
            try
            {
                using ( var dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
              {
                ...
                var set = AddIncludes(includesLst, dbContext);
                IEnumerable<TODO_DiscrepanciesToSubmit> entities = await set//dbContext.TODO_DiscrepanciesToSubmit
                                      .AsNoTracking()
             ...
             try
             {
                 using (var dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
                 {
					...
					decimal res = 0;
                     ...
                     if (whereExp == "All")
                     {
                          res = Convert.ToDecimal(dbContext.TODO_DiscrepanciesToSubmit.AsNoTracking().Sum(field));
                     }
                     else
                     {
                         res = Convert.ToDecimal(dbContext.TODO_DiscrepanciesToSubmit.AsNoTracking().Where(whereExp).Sum(field));
                     }
        ...
        public async Task<decimal> SumNav( string exp, Dictionary<string, string> navExp, string field)
        {
            try
            {
                ...
                {
                    dbContext.Database.CommandTimeout = 0;
                    if (!dbContext.TODO_DiscrepanciesToSubmit.Any()) return 0;
                    if (exp == "All" && navExp.Count == 0)
                    {
                        return Convert.ToDecimal(dbContext.TODO_DiscrepanciesToSubmit
										.AsNoTracking()
                                        .Sum(field)??0);
                    }
                    return Convert.ToDecimal(dbContext.TODO_DiscrepanciesToSubmit.Where(exp == "All" || exp == null ? "EntryDataDetailsId != null" : exp)
											.AsNoTracking()
                                            .Sum(field)??0);
                }
             ...
             try
             {
                 using (var dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
                 {
					...
					string res = "";
                     ...
                     if (whereExp == "All")
                     {
                          res = Convert.ToString(dbContext.TODO_DiscrepanciesToSubmit.AsNoTracking().Min(field));
                     }
                     else
                     {
                         res = Convert.ToString(dbContext.TODO_DiscrepanciesToSubmit.AsNoTracking().Where(whereExp).Min(field));
                     }
		...
		private static IQueryable<TODO_DiscrepanciesToSubmit> AddIncludes(IEnumerable<string> includesLst, CoreEntitiesContext dbContext)
       {
		 try
			{
			   if (includesLst == null) includesLst = new List<string>();
			   var set =(DbQuery<TODO_DiscrepanciesToSubmit>) dbContext.TODO_DiscrepanciesToSubmit; 
	   ...
	   private IQueryable<TODO_DiscrepanciesToSubmit> AddWheres(List<string> expLst, IQueryable<TODO_DiscrepanciesToSubmit> set)
        {
            try
            {
