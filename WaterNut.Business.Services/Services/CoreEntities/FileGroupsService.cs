...
namespace CoreEntities.Business.Services
{
   ...
   [ServiceBehavior(InstanceContextMode = InstanceContextMode.PerCall,
    ...
    public partial class FileGroupsService : IFileGroupsService, IDisposable
    {
        ...
        public Task<IEnumerable<FileGroups>> GetFileGroups(List<string> includesLst = null, bool tracking = true)
        {
            try
            {
            //using (var scope = new TransactionScope(TransactionScopeOption.Required,
               ...
               // {
                  using ( var dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
                  {
                    ...
                    IEnumerable<FileGroups> entities = set.AsNoTracking().ToList();
                           //scope.Complete();
        ...
        public Task<FileGroups> GetFileGroupsByKey(string Id, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
			   if(string.IsNullOrEmpty(Id))return Task.FromResult<FileGroups>(null); 
              using ( var dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
              {
                var i = Convert.ToInt32(Id);
				var set = AddIncludes(includesLst, dbContext);
                FileGroups entity = set.AsNoTracking().SingleOrDefault(x => x.Id == i);
		 ...
		 public Task<IEnumerable<FileGroups>> GetFileGroupsByExpression(string exp, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
                using (var dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
                {
					...
					if (string.IsNullOrEmpty(exp) || exp == "None") return Task.FromResult<IEnumerable<FileGroups>>(new List<FileGroups>());
					var set = AddIncludes(includesLst, dbContext);
                    if (exp == "All")
                    {
                        ...
                        if(tracking) entities.AsParallel(new ParallelLinqOptions() { MaxDegreeOfParallelism = Environment.ProcessorCount }).ForAll(x => x.StartTracking());
                        return Task.FromResult<IEnumerable<FileGroups>>(entities); 
                    }
					else
					{
		 ...
		 public Task<IEnumerable<FileGroups>> GetFileGroupsByExpressionLst(List<string> expLst, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
                using (var dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
                {
                    dbContext.Database.CommandTimeout = 0;
					if (expLst.Count == 0 || expLst.FirstOrDefault() == "None") return Task.FromResult<IEnumerable<FileGroups>>(new List<FileGroups>());
					var set = AddIncludes(includesLst, dbContext);
		...
		public async Task<IEnumerable<FileGroups>> GetFileGroupsByExpressionNav(string exp,
																							  ...
																							  List<string> includesLst = null, bool tracking = true)
        {
            try
            {
                ...
                {
                    dbContext.Database.CommandTimeout = 0;
                    if (string.IsNullOrEmpty(exp) || exp == "None") return new List<FileGroups>();
                    ...
                    foreach (var itm in navExp)
                    {
                        switch (itm.Key)
                        {
                            case "FileTypes":
                                return
                                    await
                                        GetWhere<FileTypes>(dbContext, exp, itm.Value, "FileGroups", "Select", includesLst)
        ...
        public Task<IEnumerable<FileGroups>> GetFileGroupsByBatch(string exp,
                                                                  int totalrow, List<string> includesLst = null, bool tracking = true)
        {
            try
            {

                var res = new ConcurrentQueue<List<FileGroups>>();
        ...
        public Task<IEnumerable<FileGroups>> GetFileGroupsByBatchExpressionLst(List<string> expLst,
                                                                               int totalrow, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
        ...
        public Task<FileGroups> UpdateFileGroups(FileGroups entity)
        { 
            using ( var dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
              {
                try
                {   
                     var res = (FileGroups) entity;
        ...
        public Task<FileGroups> CreateFileGroups(FileGroups entity)
        {
            try
            {
                var res = (FileGroups) entity;
        ...
        public Task<bool> DeleteFileGroups(string Id)
        {
            try
            {
              using ( var dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
              {
                var i = Convert.ToInt32(Id);
                FileGroups entity = dbContext.FileGroups
													.SingleOrDefault(x => x.Id == i);
                if (entity == null)
                    return Task.FromResult(false);

                    dbContext.FileGroups.Attach(entity);
                    dbContext.FileGroups.Remove(entity);
                    dbContext.SaveChanges();
        ...
        public async Task<bool> RemoveSelectedFileGroups(IEnumerable<string> lst)
        {
            try
            {
                StatusModel.StartStatusUpdate("Removing FileGroups", lst.Count());
                var t = Task.Run(() =>
                {
                    using (var ctx = new FileGroupsService())
                    {
                        foreach (var item in lst.ToList())
                        {

                            ctx.DeleteFileGroups(item).Wait();
         ...
         public Task<int> CountByExpressionLst(List<string> expLst)
        {
            try
            {
                using (var dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
                {
                    ...
                    var set = (IQueryable<FileGroups>)dbContext.FileGroups; 
                    if (expLst.FirstOrDefault() == "All")
                    {
		...
		public Task<int> Count(string exp)
        {
            try
            {
                using (CoreEntitiesContext dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
                {
                    ...
                    if (exp == "All")
                    {
                        return Task.FromResult(dbContext.FileGroups
                            .AsNoTracking()
                            .Count());
                    }
                    else
        ...
        public Task<IEnumerable<FileGroups>> LoadRange(int startIndex, int count, string exp)
        {
            try
            {
                using (var dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
                {
                    ...
                    if (exp == "All")
                    {
                        return Task.FromResult<IEnumerable<FileGroups>>(dbContext.FileGroups
                            .AsNoTracking()
                            .OrderBy(y => y.Id)
                            .Skip(startIndex)
                            .Take(count)
            ...
            try
            {
                ...
                using (var dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
                {
                    ...
                    foreach (var itm in navExp)
                    {
                        ...
                        {
                            case "FileTypes":
                                return await CountWhere<FileTypes>(dbContext, exp, itm.Value, "FileGroups", "Select")
											.ConfigureAwait(continueOnCapturedContext: false);
						}
                    }
                    return dbContext.FileGroups.Where(exp == "All" || exp == null ? "Id != null" : exp)
											.AsNoTracking()
                                            .Count();
                }
		...
		private static Task<int> CountWhereSelectMany<T>(CoreEntitiesContext dbContext, string exp, string navExp, string navProp) where T : class
        {
            ...
            return Task.FromResult(dbContext.Set<T>()
                .AsNoTracking()
                .Where(navExp)
                .SelectMany(navProp).OfType<FileGroups>()
		...
		private static Task<int> CountWhereSelect<T>(CoreEntitiesContext dbContext, string exp, string navExp, string navProp) where T : class
        {
            ...
            return Task.FromResult(dbContext.Set<T>()
                .AsNoTracking()
                .Where(navExp)
                .Select(navProp).OfType<FileGroups>()
                .Where(exp == "All" || exp == null ? "Id != null" : exp)
                .Distinct()
                .OrderBy("Id")
                .Count());
		  ...
		  public async Task<IEnumerable<FileGroups>> LoadRangeNav(int startIndex, int count, string exp,
                                                                                 Dictionary<string, string> navExp, IEnumerable<string> includeLst = null)
        {
            try
            {
                ...
                {
                    dbContext.Database.CommandTimeout = 0;
                    if ((string.IsNullOrEmpty(exp) && navExp.Count == 0) || exp == "None") return new List<FileGroups>();
                    ...
                    foreach (var itm in navExp)
                    {
                        switch (itm.Key)
                        {
                            case "FileTypes":
                                return
                                    await
                                        LoadRangeWhere<FileTypes>(startIndex, count, dbContext, exp, itm.Value, "FileGroups", "Select")
													.ConfigureAwait(continueOnCapturedContext: false);
                    ...
                    return set//dbContext.FileGroups
								.AsNoTracking()
                                .Where(exp == "All" || exp == null ? "Id != null" : exp)
								.OrderBy(y => y.Id)
		...
		private static async Task<IEnumerable<FileGroups>> LoadRangeWhere<T>(int startIndex, int count,
		...
		private static Task<IEnumerable<FileGroups>> LoadRangeSelectMany<T>(int startIndex, int count,
                                                                            CoreEntitiesContext dbContext, string exp, string navExp, string navProp, IEnumerable<string> includeLst = null) where T : class
        {
            ...
            return Task.FromResult<IEnumerable<FileGroups>>(set
                .Where(exp == "All" || exp == null ? "Id != null" : exp)
                .Distinct()
                .OrderBy(y => y.Id)
		...
		private static Task<IEnumerable<FileGroups>> LoadRangeSelect<T>(int startIndex, int count,
                                                                        CoreEntitiesContext dbContext, string exp, string navExp, string navProp, IEnumerable<string> includeLst = null) where T : class
        {
			try
			{
        ...
        private static async Task<IEnumerable<FileGroups>> GetWhere<T>(CoreEntitiesContext dbContext,
		...
		private static Task<IEnumerable<FileGroups>> GetWhereSelectMany<T>(CoreEntitiesContext dbContext,
                                                                           string exp, string navExp, string navProp, List<string> includesLst = null) where T : class
        {
			...
			if (includesLst == null)
			{
				return Task.FromResult<IEnumerable<FileGroups>>(dbContext.Set<T>()
                    .AsNoTracking()
                    .Where(navExp)
                    .SelectMany(navProp).OfType<FileGroups>()
                    .Where(exp == "All" || exp == null?"Id != null":exp)
			...
			var set = (DbQuery<FileGroups>)dbContext.Set<T>()
				.AsNoTracking()
                .Where(navExp)
                .SelectMany(navProp).OfType<FileGroups>()
                .Where(exp == "All" || exp == null?"Id != null":exp)
            ...
            return Task.FromResult<IEnumerable<FileGroups>>(set.ToList());
			}
			catch (Exception)
			{
				Debugger.Break();
		...
		private static Task<IEnumerable<FileGroups>> GetWhereSelect<T>(CoreEntitiesContext dbContext,
                                                                       string exp, string navExp, string navProp, List<string> includesLst = null) where T : class
        {
			try
			{
             ...
             try
             {
                 using (var dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
                 {
					...
					decimal res = 0;
                     ...
                     if (whereExp == "All")
                     {
                          res = Convert.ToDecimal(dbContext.FileGroups.AsNoTracking().Sum(field));
                     }
                     else
                     {
                         res = Convert.ToDecimal(dbContext.FileGroups.AsNoTracking().Where(whereExp).Sum(field));
                     }
        ...
        public async Task<decimal> SumNav( string exp, Dictionary<string, string> navExp, string field)
        {
            try
            {
                ...
                {
                    dbContext.Database.CommandTimeout = 0;
                    if (!dbContext.FileGroups.Any()) return 0;
                    if (exp == "All" && navExp.Count == 0)
                    {
                        return Convert.ToDecimal(dbContext.FileGroups
										.AsNoTracking()
                                        .Sum(field)??0);
                    }
                    foreach (var itm in navExp)
                    {
                        ...
                        {
                            case "FileTypes":
                                return await SumWhere<FileTypes>(dbContext, exp, itm.Value, "FileGroups", field, "Select")
											.ConfigureAwait(continueOnCapturedContext: false);
						}
                    }
                    return Convert.ToDecimal(dbContext.FileGroups.Where(exp == "All" || exp == null ? "Id != null" : exp)
											.AsNoTracking()
                                            .Sum(field)??0);
                }
             ...
             try
             {
                 using (var dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
                 {
					...
					string res = "";
                     ...
                     if (whereExp == "All")
                     {
                          res = Convert.ToString(dbContext.FileGroups.AsNoTracking().Min(field));
                     }
                     else
                     {
                         res = Convert.ToString(dbContext.FileGroups.AsNoTracking().Where(whereExp).Min(field));
                     }
		...
		private static IQueryable<FileGroups> AddIncludes(IEnumerable<string> includesLst, CoreEntitiesContext dbContext)
       {
		 try
			{
			   if (includesLst == null) includesLst = new List<string>();
			   var set =(DbQuery<FileGroups>) dbContext.FileGroups; 
	   ...
	   private IQueryable<FileGroups> AddWheres(List<string> expLst, IQueryable<FileGroups> set)
        {
            try
            {
