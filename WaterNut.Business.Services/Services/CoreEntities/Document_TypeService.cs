...
namespace CoreEntities.Business.Services
{
   ...
   [ServiceBehavior(InstanceContextMode = InstanceContextMode.PerCall,
    ...
    public partial class Document_TypeService : IDocument_TypeService, IDisposable
    {
        //private readonly CoreEntitiesContext dbContext;

        public bool StartTracking { get; set; }

        public Document_TypeService()
        {
            try
            {
        ...
        public Task<IEnumerable<Document_Type>> GetDocument_Type(List<string> includesLst = null, bool tracking = true)
        {
            try
            {
            //using (var scope = new TransactionScope(TransactionScopeOption.Required,
               ...
               // {
                  using ( var dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
                  {
                    ...
                    IEnumerable<Document_Type> entities = set.AsNoTracking().ToList();
                           //scope.Complete();
        ...
        public Task<Document_Type> GetDocument_TypeByKey(string Document_TypeId, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
			   if(string.IsNullOrEmpty(Document_TypeId))return Task.FromResult<Document_Type>(null); 
              using ( var dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
              {
                var i = Convert.ToInt32(Document_TypeId);
				var set = AddIncludes(includesLst, dbContext);
                Document_Type entity = set.AsNoTracking().SingleOrDefault(x => x.Document_TypeId == i);
		 ...
		 public Task<IEnumerable<Document_Type>> GetDocument_TypeByExpression(string exp, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
                using (var dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
                {
					...
					if (string.IsNullOrEmpty(exp) || exp == "None") return Task.FromResult<IEnumerable<Document_Type>>(new List<Document_Type>());
					var set = AddIncludes(includesLst, dbContext);
                    if (exp == "All")
                    {
                        ...
                        if(tracking) entities.AsParallel(new ParallelLinqOptions() { MaxDegreeOfParallelism = Environment.ProcessorCount }).ForAll(x => x.StartTracking());
                        return Task.FromResult<IEnumerable<Document_Type>>(entities); 
                    }
					else
					{
		 ...
		 public Task<IEnumerable<Document_Type>> GetDocument_TypeByExpressionLst(List<string> expLst, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
                using (var dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
                {
                    dbContext.Database.CommandTimeout = 0;
					if (expLst.Count == 0 || expLst.FirstOrDefault() == "None") return Task.FromResult<IEnumerable<Document_Type>>(new List<Document_Type>());
					var set = AddIncludes(includesLst, dbContext);
																							  ...
																							  List<string> includesLst = null, bool tracking = true)
        {
            try
            {
                ...
                {
                    dbContext.Database.CommandTimeout = 0;
                    if (string.IsNullOrEmpty(exp) || exp == "None") return new List<Document_Type>();
        ...
        public Task<IEnumerable<Document_Type>> GetDocument_TypeByBatch(string exp,
                                                                        int totalrow, List<string> includesLst = null, bool tracking = true)
        {
            try
            {

                var res = new ConcurrentQueue<List<Document_Type>>();
                    ...
                    //  for (int bat = 0; bat < batches; bat++)
                    {
                        try
                        {
                            using (var dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
                            {
                                ...
                                var set = AddIncludes(includesLst, dbContext);
                                IQueryable<Document_Type> dset;
                                if (exp == "All")
                                {
                                    dset = set.OrderBy(x => x.Document_TypeId);
                                }
                                else
                                {
                                    dset = set.OrderBy(x => x.Document_TypeId).Where(exp);
                                }
        ...
        public Task<IEnumerable<Document_Type>> GetDocument_TypeByBatchExpressionLst(List<string> expLst,
                                                                                     int totalrow, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
        ...
        public Task<Document_Type> UpdateDocument_Type(Document_Type entity)
        { 
            using ( var dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
              {
                try
                {   
                     var res = (Document_Type) entity;
        ...
        public Task<Document_Type> CreateDocument_Type(Document_Type entity)
        {
            try
            {
                var res = (Document_Type) entity;
              using ( var dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
              {
                dbContext.Document_Type.Add(res);
                dbContext.SaveChanges();
                res.AcceptChanges();
                return Task.FromResult(res);
              }
        ...
        public Task<bool> DeleteDocument_Type(string Document_TypeId)
        {
            try
            {
              using ( var dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
              {
                var i = Convert.ToInt32(Document_TypeId);
                Document_Type entity = dbContext.Document_Type
													.SingleOrDefault(x => x.Document_TypeId == i);
                if (entity == null)
                    return Task.FromResult(false);

                    dbContext.Document_Type.Attach(entity);
                    dbContext.Document_Type.Remove(entity);
                    dbContext.SaveChanges();
        ...
        public async Task<bool> RemoveSelectedDocument_Type(IEnumerable<string> lst)
        {
            try
            {
                StatusModel.StartStatusUpdate("Removing Document_Type", lst.Count());
                var t = Task.Run(() =>
                {
                    using (var ctx = new Document_TypeService())
                    {
                        foreach (var item in lst.ToList())
                        {
                            ...
                            ctx.DeleteDocument_Type(item).Wait();
         ...
         public Task<int> CountByExpressionLst(List<string> expLst)
        {
            try
            {
                using (var dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
                {
                    ...
                    var set = (IQueryable<Document_Type>)dbContext.Document_Type; 
                    if (expLst.FirstOrDefault() == "All")
                    {
		...
		public Task<int> Count(string exp)
        {
            try
            {
                using (CoreEntitiesContext dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
                {
                    ...
                    if (exp == "All")
                    {
                        return Task.FromResult(dbContext.Document_Type
                            .AsNoTracking()
                            .Count());
                    }
                    else
        ...
        public Task<IEnumerable<Document_Type>> LoadRange(int startIndex, int count, string exp)
        {
            try
            {
                using (var dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
                {
                    ...
                    if (exp == "All")
                    {
                        return Task.FromResult<IEnumerable<Document_Type>>(dbContext.Document_Type
                            .AsNoTracking()
                            .OrderBy(y => y.Document_TypeId)
                            .Skip(startIndex)
                            .Take(count)
                            .ToList());
                    }
		...
		public async Task<int> CountNav(string exp, Dictionary<string, string> navExp)
        {
            try
            {
                ...
                using (var dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
                {
                    ...
                    if (exp == "All" && navExp.Count == 0)
                    {
                        return dbContext.Document_Type
										.AsNoTracking()
                                        .Count();
                    }
                    foreach (var itm in navExp)
                    ...
                    return dbContext.Document_Type.Where(exp == "All" || exp == null ? "Document_TypeId != null" : exp)
											.AsNoTracking()
                                            .Count();
                }
		...
		private static Task<int> CountWhereSelectMany<T>(CoreEntitiesContext dbContext, string exp, string navExp, string navProp) where T : class
        {
            ...
            return Task.FromResult(dbContext.Set<T>()
                .AsNoTracking()
                .Where(navExp)
                .SelectMany(navProp).OfType<Document_Type>()
                .Where(exp == "All" || exp == null ? "Document_TypeId != null" : exp)
                .Distinct()
                .OrderBy("Document_TypeId")
                .Count());
			}
			catch (Exception)
			{
		...
		private static Task<int> CountWhereSelect<T>(CoreEntitiesContext dbContext, string exp, string navExp, string navProp) where T : class
        {
            ...
            return Task.FromResult(dbContext.Set<T>()
                .AsNoTracking()
                .Where(navExp)
                .Select(navProp).OfType<Document_Type>()
                .Where(exp == "All" || exp == null ? "Document_TypeId != null" : exp)
                .Distinct()
                .OrderBy("Document_TypeId")
                .Count());
                                                                                 ...
                                                                                 Dictionary<string, string> navExp, IEnumerable<string> includeLst = null)
        {
            try
            {
                ...
                {
                    dbContext.Database.CommandTimeout = 0;
                    if ((string.IsNullOrEmpty(exp) && navExp.Count == 0) || exp == "None") return new List<Document_Type>();
                    ...
                    return set//dbContext.Document_Type
								.AsNoTracking()
                                .Where(exp == "All" || exp == null ? "Document_TypeId != null" : exp)
								.OrderBy(y => y.Document_TypeId)
		...
		private static async Task<IEnumerable<Document_Type>> LoadRangeWhere<T>(int startIndex, int count,
		...
		private static Task<IEnumerable<Document_Type>> LoadRangeSelectMany<T>(int startIndex, int count,
                                                                               CoreEntitiesContext dbContext, string exp, string navExp, string navProp, IEnumerable<string> includeLst = null) where T : class
        {
            ...
            return Task.FromResult<IEnumerable<Document_Type>>(set
                .Where(exp == "All" || exp == null ? "Document_TypeId != null" : exp)
                .Distinct()
                .OrderBy(y => y.Document_TypeId)
		...
		private static Task<IEnumerable<Document_Type>> LoadRangeSelect<T>(int startIndex, int count,
                                                                           CoreEntitiesContext dbContext, string exp, string navExp, string navProp, IEnumerable<string> includeLst = null) where T : class
        {
			try
			{
        ...
        private static async Task<IEnumerable<Document_Type>> GetWhere<T>(CoreEntitiesContext dbContext,
		...
		private static Task<IEnumerable<Document_Type>> GetWhereSelectMany<T>(CoreEntitiesContext dbContext,
                                                                              string exp, string navExp, string navProp, List<string> includesLst = null) where T : class
        {
			...
			if (includesLst == null)
			{
				return Task.FromResult<IEnumerable<Document_Type>>(dbContext.Set<T>()
                    .AsNoTracking()
                    .Where(navExp)
                    .SelectMany(navProp).OfType<Document_Type>()
                    .Where(exp == "All" || exp == null?"Document_TypeId != null":exp)
			...
			var set = (DbQuery<Document_Type>)dbContext.Set<T>()
				.AsNoTracking()
                .Where(navExp)
                .SelectMany(navProp).OfType<Document_Type>()
                .Where(exp == "All" || exp == null?"Document_TypeId != null":exp)
            ...
            return Task.FromResult<IEnumerable<Document_Type>>(set.ToList());
			}
			catch (Exception)
			{
				Debugger.Break();
		...
		private static Task<IEnumerable<Document_Type>> GetWhereSelect<T>(CoreEntitiesContext dbContext,
                                                                          string exp, string navExp, string navProp, List<string> includesLst = null) where T : class
        {
			try
			{
             ...
             try
             {
                 using (var dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
                 {
					...
					decimal res = 0;
                     ...
                     if (whereExp == "All")
                     {
                          res = Convert.ToDecimal(dbContext.Document_Type.AsNoTracking().Sum(field));
                     }
                     else
                     {
                         res = Convert.ToDecimal(dbContext.Document_Type.AsNoTracking().Where(whereExp).Sum(field));
                     }
        ...
        public async Task<decimal> SumNav( string exp, Dictionary<string, string> navExp, string field)
        {
            try
            {
                ...
                {
                    dbContext.Database.CommandTimeout = 0;
                    if (!dbContext.Document_Type.Any()) return 0;
                    if (exp == "All" && navExp.Count == 0)
                    {
                        return Convert.ToDecimal(dbContext.Document_Type
										.AsNoTracking()
                                        .Sum(field)??0);
                    }
                    foreach (var itm in navExp)
                    ...
                    return Convert.ToDecimal(dbContext.Document_Type.Where(exp == "All" || exp == null ? "Document_TypeId != null" : exp)
											.AsNoTracking()
                                            .Sum(field)??0);
                }
             ...
             try
             {
                 using (var dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
                 {
					...
					string res = "";
                     ...
                     if (whereExp == "All")
                     {
                          res = Convert.ToString(dbContext.Document_Type.AsNoTracking().Min(field));
                     }
                     else
                     {
                         res = Convert.ToString(dbContext.Document_Type.AsNoTracking().Where(whereExp).Min(field));
                     }
		...
		private static IQueryable<Document_Type> AddIncludes(IEnumerable<string> includesLst, CoreEntitiesContext dbContext)
       {
		 try
			{
			   if (includesLst == null) includesLst = new List<string>();
			   var set =(DbQuery<Document_Type>) dbContext.Document_Type; 
	   ...
	   private IQueryable<Document_Type> AddWheres(List<string> expLst, IQueryable<Document_Type> set)
        {
            try
            {
