...
namespace CoreEntities.Business.Services
{
   ...
   [ServiceBehavior(InstanceContextMode = InstanceContextMode.PerCall,
    ...
    public partial class Document_TypeService : IDocument_TypeService, IDisposable
    {
        ...
        public async Task<IEnumerable<Document_Type>> GetDocument_Type(List<string> includesLst = null, bool tracking = true)
        {
            try
            {
            //using (var scope = new TransactionScope(TransactionScopeOption.Required,
               ...
               // {
                  using ( var dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
                  {
                    ...
                    IEnumerable<Document_Type> entities = await set.AsNoTracking().ToListAsync()
        ...
        public async Task<Document_Type> GetDocument_TypeByKey(string Document_TypeId, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
			   if(string.IsNullOrEmpty(Document_TypeId))return null; 
              using ( var dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
              {
                var i = Convert.ToInt32(Document_TypeId);
				var set = AddIncludes(includesLst, dbContext);
                Document_Type entity = await set.AsNoTracking().SingleOrDefaultAsync(x => x.Document_TypeId == i).ConfigureAwait(continueOnCapturedContext: false);
		 ...
		 public async Task<IEnumerable<Document_Type>> GetDocument_TypeByExpression(string exp, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
                using (var dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
		 ...
		 public async Task<IEnumerable<Document_Type>> GetDocument_TypeByExpressionLst(List<string> expLst, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
                using (var dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
                {
                    dbContext.Database.CommandTimeout = 0;
					if (expLst.Count == 0 || expLst.FirstOrDefault() == "None") return new List<Document_Type>();
					var set = AddIncludes(includesLst, dbContext);
        ...
        public async Task<bool> DeleteDocument_Type(string Document_TypeId)
        {
            try
            {
              using ( var dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
              {
                var i = Convert.ToInt32(Document_TypeId);
                Document_Type entity = await dbContext.Document_Type
													.SingleOrDefaultAsync(x => x.Document_TypeId == i)
													.ConfigureAwait(continueOnCapturedContext: false);
                if (entity == null)
                    return false;
		...
		public async Task<int> Count(string exp)
        {
            try
            {
                using (CoreEntitiesContext dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
                {
                    ...
                    if (exp == "All")
                    {
                        return await dbContext.Document_Type
                                    .AsNoTracking()
									.CountAsync()
									.ConfigureAwait(continueOnCapturedContext: false);
                    }
		...
		public async Task<int> CountNav(string exp, Dictionary<string, string> navExp)
        {
            try
            {
                ...
                using (var dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
                {
                    ...
                    return await dbContext.Document_Type.Where(exp == "All" || exp == null ? "Document_TypeId != null" : exp)
											.AsNoTracking()
                                            .CountAsync()
											.ConfigureAwait(continueOnCapturedContext: false);
                }
                                                                                 ...
                                                                                 Dictionary<string, string> navExp, IEnumerable<string> includeLst = null)
        {
            try
            {
                using (var dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
                {
                    ...
                    return await set//dbContext.Document_Type
								.AsNoTracking()
                                .Where(exp == "All" || exp == null ? "Document_TypeId != null" : exp)
								.OrderBy(y => y.Document_TypeId)
		...
		private static async Task<IEnumerable<Document_Type>> LoadRangeSelectMany<T>(int startIndex, int count,
		...
		private static async Task<IEnumerable<Document_Type>> LoadRangeSelect<T>(int startIndex, int count,
            CoreEntitiesContext dbContext, string exp, string navExp, string navProp, IEnumerable<string> includeLst = null) where T : class
        {
			try
			{
		...
		private static async Task<IEnumerable<Document_Type>> GetWhereSelectMany<T>(CoreEntitiesContext dbContext,
		...
		private static async Task<IEnumerable<Document_Type>> GetWhereSelect<T>(CoreEntitiesContext dbContext,
            string exp, string navExp, string navProp, List<string> includesLst = null) where T : class
        {
			try
			{
