...
namespace CoreEntities.Business.Services
{
   ...
   [ServiceBehavior(InstanceContextMode = InstanceContextMode.PerCall,
    ...
    public partial class TODO_DiscrepanciesAlreadyXMLedService : ITODO_DiscrepanciesAlreadyXMLedService, IDisposable
    {
        ...
        public async Task<IEnumerable<TODO_DiscrepanciesAlreadyXMLed>> GetTODO_DiscrepanciesAlreadyXMLed(List<string> includesLst = null, bool tracking = true)
        {
            try
            {
            //using (var scope = new TransactionScope(TransactionScopeOption.Required,
               ...
               // {
                  using ( var dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
                  {
                    ...
                    IEnumerable<TODO_DiscrepanciesAlreadyXMLed> entities = await set.AsNoTracking().ToListAsync()
        ...
        public async Task<TODO_DiscrepanciesAlreadyXMLed> GetTODO_DiscrepanciesAlreadyXMLedByKey(string EntryDataDetailsId, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
              ...
              using ( var dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
              {
				...
				var set = AddIncludes(includesLst, dbContext);
                TODO_DiscrepanciesAlreadyXMLed entity = await set.AsNoTracking().SingleOrDefaultAsync(x => x.EntryDataDetailsId == i).ConfigureAwait(continueOnCapturedContext: false);
		 ...
		 public async Task<IEnumerable<TODO_DiscrepanciesAlreadyXMLed>> GetTODO_DiscrepanciesAlreadyXMLedByExpression(string exp, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
                using (var dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
                {
					...
					if (string.IsNullOrEmpty(exp) || exp == "None") return new List<TODO_DiscrepanciesAlreadyXMLed>();
					var set = AddIncludes(includesLst, dbContext);
                    if (exp == "All")
                    {
		 ...
		 public async Task<IEnumerable<TODO_DiscrepanciesAlreadyXMLed>> GetTODO_DiscrepanciesAlreadyXMLedByExpressionLst(List<string> expLst, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
                using (var dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
                {
                    dbContext.Database.CommandTimeout = 0;
					if (expLst.Count == 0 || expLst.FirstOrDefault() == "None") return new List<TODO_DiscrepanciesAlreadyXMLed>();
					var set = AddIncludes(includesLst, dbContext);
		...
		public async Task<IEnumerable<TODO_DiscrepanciesAlreadyXMLed>> GetTODO_DiscrepanciesAlreadyXMLedByExpressionNav(string exp,
        ...
        public async Task<IEnumerable<TODO_DiscrepanciesAlreadyXMLed>> GetTODO_DiscrepanciesAlreadyXMLedByBatch(string exp,
        ...
        public async Task<IEnumerable<TODO_DiscrepanciesAlreadyXMLed>> GetTODO_DiscrepanciesAlreadyXMLedByBatchExpressionLst(List<string> expLst,
            int totalrow, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
        ...
        public async Task<bool> DeleteTODO_DiscrepanciesAlreadyXMLed(string EntryDataDetailsId)
        {
            try
            {
              using ( var dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
              {
                var i = Convert.ToInt32(EntryDataDetailsId);
                TODO_DiscrepanciesAlreadyXMLed entity = await dbContext.TODO_DiscrepanciesAlreadyXMLed
		...
		public async Task<int> Count(string exp)
        {
            try
            {
                using (CoreEntitiesContext dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
                {
                    ...
                    if (exp == "All")
                    {
                        return await dbContext.TODO_DiscrepanciesAlreadyXMLed
                                    .AsNoTracking()
									.CountAsync()
									.ConfigureAwait(continueOnCapturedContext: false);
                    }
        ...
        public async Task<IEnumerable<TODO_DiscrepanciesAlreadyXMLed>> LoadRange(int startIndex, int count, string exp)
        {
            try
            {
                using (var dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
		...
		public async Task<int> CountNav(string exp, Dictionary<string, string> navExp)
        {
            try
            {
                ...
                using (var dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
                {
                    ...
                    return await dbContext.TODO_DiscrepanciesAlreadyXMLed.Where(exp == "All" || exp == null ? "EntryDataDetailsId != null" : exp)
											.AsNoTracking()
                                            .CountAsync()
											.ConfigureAwait(continueOnCapturedContext: false);
                }
		...
		private static async Task<int> CountWhereSelect<T>(CoreEntitiesContext dbContext, string exp, string navExp, string navProp) where T : class
        {
		  ...
		  public async Task<IEnumerable<TODO_DiscrepanciesAlreadyXMLed>> LoadRangeNav(int startIndex, int count, string exp,
                                                                                 Dictionary<string, string> navExp, IEnumerable<string> includeLst = null)
        {
            try
            {
                ...
                {
                    dbContext.Database.CommandTimeout = 0;
                    if ((string.IsNullOrEmpty(exp) && navExp.Count == 0) || exp == "None") return new List<TODO_DiscrepanciesAlreadyXMLed>();
                    ...
                    return await set//dbContext.TODO_DiscrepanciesAlreadyXMLed
								.AsNoTracking()
                                .Where(exp == "All" || exp == null ? "EntryDataDetailsId != null" : exp)
								.OrderBy(y => y.EntryDataDetailsId)
		...
		private static async Task<IEnumerable<TODO_DiscrepanciesAlreadyXMLed>> LoadRangeSelectMany<T>(int startIndex, int count,
		...
		private static async Task<IEnumerable<TODO_DiscrepanciesAlreadyXMLed>> LoadRangeSelect<T>(int startIndex, int count,
            CoreEntitiesContext dbContext, string exp, string navExp, string navProp, IEnumerable<string> includeLst = null) where T : class
        {
			try
			{
		...
		private static async Task<IEnumerable<TODO_DiscrepanciesAlreadyXMLed>> GetWhereSelectMany<T>(CoreEntitiesContext dbContext,
		...
		private static async Task<IEnumerable<TODO_DiscrepanciesAlreadyXMLed>> GetWhereSelect<T>(CoreEntitiesContext dbContext,
            string exp, string navExp, string navProp, List<string> includesLst = null) where T : class
        {
			try
			{
			        ...
			        public async Task<IEnumerable<TODO_DiscrepanciesAlreadyXMLed>> GetTODO_DiscrepanciesAlreadyXMLedByEmailId(string EmailId, List<string> includesLst = null)
        {
            try
            {
                using ( var dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
              {
                var i = EmailId;
                var set = AddIncludes(includesLst, dbContext);
                IEnumerable<TODO_DiscrepanciesAlreadyXMLed> entities = await set//dbContext.TODO_DiscrepanciesAlreadyXMLed
                                      .AsNoTracking()
        ...
        public async Task<decimal> SumNav( string exp, Dictionary<string, string> navExp, string field)
        {
            try
            {
                ...
                {
                    dbContext.Database.CommandTimeout = 0;
                    if (!dbContext.TODO_DiscrepanciesAlreadyXMLed.Any()) return 0;
                    if (exp == "All" && navExp.Count == 0)
                    {
                        return Convert.ToDecimal(dbContext.TODO_DiscrepanciesAlreadyXMLed
										.AsNoTracking()
                                        .Sum(field)??0);
                    }
                    return Convert.ToDecimal(dbContext.TODO_DiscrepanciesAlreadyXMLed.Where(exp == "All" || exp == null ? "EntryDataDetailsId != null" : exp)
											.AsNoTracking()
                                            .Sum(field)??0);
                }
