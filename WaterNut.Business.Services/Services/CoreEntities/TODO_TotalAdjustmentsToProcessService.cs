    ...
    public partial class TODO_TotalAdjustmentsToProcessService : ITODO_TotalAdjustmentsToProcessService, IDisposable
    {
            ...
            //using (var scope = new TransactionScope(TransactionScopeOption.Required,
               ...
               // {
                  using ( var dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
                  {
                    ...
                    IEnumerable<TODO_TotalAdjustmentsToProcess> entities = await set.AsNoTracking().ToListAsync()
        ...
        public async Task<TODO_TotalAdjustmentsToProcess> GetTODO_TotalAdjustmentsToProcessByKey(string EntryDataDetailsId, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
              ...
              using ( var dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
              {
				...
				var set = AddIncludes(includesLst, dbContext);
                TODO_TotalAdjustmentsToProcess entity = await set.AsNoTracking().SingleOrDefaultAsync(x => x.EntryDataDetailsId == i).ConfigureAwait(continueOnCapturedContext: false);
        ...
        public async Task<bool> DeleteTODO_TotalAdjustmentsToProcess(string EntryDataDetailsId)
        {
            try
            {
              ...
              {
                var i = Convert.ToInt32(EntryDataDetailsId);
                TODO_TotalAdjustmentsToProcess entity = await dbContext.TODO_TotalAdjustmentsToProcess
		...
		public async Task<int> Count(string exp)
        {
            try
            {
                using (CoreEntitiesContext dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
                {
                    ...
                    if (exp == "All")
                    {
                        return await dbContext.TODO_TotalAdjustmentsToProcess
                                    .AsNoTracking()
									.CountAsync()
									.ConfigureAwait(continueOnCapturedContext: false);
                    }
		...
		public async Task<int> CountNav(string exp, Dictionary<string, string> navExp)
        {
            try
            {
                ...
                using (var dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
                {
                    ...
                    return await dbContext.TODO_TotalAdjustmentsToProcess.Where(exp == "All" || exp == null ? "EntryDataDetailsId != null" : exp)
											.AsNoTracking()
                                            .CountAsync()
											.ConfigureAwait(continueOnCapturedContext: false);
                }
                                                                                 ...
                                                                                 Dictionary<string, string> navExp, IEnumerable<string> includeLst = null)
        {
            try
            {
                using (var dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
                {
                    ...
                    return await set//dbContext.TODO_TotalAdjustmentsToProcess
								.AsNoTracking()
                                .Where(exp == "All" || exp == null ? "EntryDataDetailsId != null" : exp)
								.OrderBy(y => y.EntryDataDetailsId)
