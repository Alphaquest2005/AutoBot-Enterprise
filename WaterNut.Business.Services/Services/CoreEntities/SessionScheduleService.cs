...
{
   [Export (typeof(ISessionScheduleService))]
   [Export(typeof(IBusinessService))]
   [PartCreationPolicy(CreationPolicy.NonShared)]
   [ServiceBehavior(InstanceContextMode = InstanceContextMode.PerCall,
                    ConcurrencyMode = ConcurrencyMode.Multiple)]
   
    public partial class SessionScheduleService : ISessionScheduleService, IDisposable
    {
        //private readonly CoreEntitiesContext dbContext;

        public bool StartTracking { get; set; }

        public SessionScheduleService()
        {
            try
            {
        ...
        public Task<IEnumerable<SessionSchedule>> GetSessionSchedule(List<string> includesLst = null, bool tracking = true)
        {
            try
            {
            //using (var scope = new TransactionScope(TransactionScopeOption.Required,
               ...
               // {
                  using ( var dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
                  {
                    ...
                    IEnumerable<SessionSchedule> entities = set.AsNoTracking().ToList();
                           //scope.Complete();
        ...
        public Task<SessionSchedule> GetSessionScheduleByKey(string Id, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
			   if(string.IsNullOrEmpty(Id))return Task.FromResult<SessionSchedule>(null); 
              using ( var dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
              {
                var i = Convert.ToInt32(Id);
				var set = AddIncludes(includesLst, dbContext);
                SessionSchedule entity = set.AsNoTracking().SingleOrDefault(x => x.Id == i);
		 ...
		 public Task<IEnumerable<SessionSchedule>> GetSessionScheduleByExpression(string exp, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
                using (var dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
                {
					...
					if (string.IsNullOrEmpty(exp) || exp == "None") return Task.FromResult<IEnumerable<SessionSchedule>>(new List<SessionSchedule>());
					var set = AddIncludes(includesLst, dbContext);
                    if (exp == "All")
                    {
                        ...
                        if(tracking) entities.AsParallel(new ParallelLinqOptions() { MaxDegreeOfParallelism = Environment.ProcessorCount }).ForAll(x => x.StartTracking());
                        return Task.FromResult<IEnumerable<SessionSchedule>>(entities); 
                    }
					else
					{
		 ...
		 public Task<IEnumerable<SessionSchedule>> GetSessionScheduleByExpressionLst(List<string> expLst, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
                using (var dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
                {
                    dbContext.Database.CommandTimeout = 0;
					if (expLst.Count == 0 || expLst.FirstOrDefault() == "None") return Task.FromResult<IEnumerable<SessionSchedule>>(new List<SessionSchedule>());
					var set = AddIncludes(includesLst, dbContext);
		...
		public async Task<IEnumerable<SessionSchedule>> GetSessionScheduleByExpressionNav(string exp,
																							  ...
																							  List<string> includesLst = null, bool tracking = true)
        {
            try
            {
                ...
                {
                    dbContext.Database.CommandTimeout = 0;
                    if (string.IsNullOrEmpty(exp) || exp == "None") return new List<SessionSchedule>();
        ...
        public Task<IEnumerable<SessionSchedule>> GetSessionScheduleByBatch(string exp,
                                                                            int totalrow, List<string> includesLst = null, bool tracking = true)
        {
            try
            {

                var res = new ConcurrentQueue<List<SessionSchedule>>();
                    ...
                    //  for (int bat = 0; bat < batches; bat++)
                    {
                        try
                        {
                            using (var dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
                            {
                                ...
                                var set = AddIncludes(includesLst, dbContext);
                                IQueryable<SessionSchedule> dset;
                                if (exp == "All")
                                {
        ...
        public Task<IEnumerable<SessionSchedule>> GetSessionScheduleByBatchExpressionLst(List<string> expLst,
                                                                                         int totalrow, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
        ...
        public Task<SessionSchedule> UpdateSessionSchedule(SessionSchedule entity)
        { 
            using ( var dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
              {
                try
                {   
                     var res = (SessionSchedule) entity;
        ...
        public Task<SessionSchedule> CreateSessionSchedule(SessionSchedule entity)
        {
            try
            {
                var res = (SessionSchedule) entity;
              using ( var dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
              {
                dbContext.SessionSchedule.Add(res);
                dbContext.SaveChanges();
                res.AcceptChanges();
                return Task.FromResult(res);
              }
        ...
        public Task<bool> DeleteSessionSchedule(string Id)
        {
            try
            {
              using ( var dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
              {
                var i = Convert.ToInt32(Id);
                SessionSchedule entity = dbContext.SessionSchedule
													.SingleOrDefault(x => x.Id == i);
                if (entity == null)
                    return Task.FromResult(false);

                    dbContext.SessionSchedule.Attach(entity);
                    dbContext.SessionSchedule.Remove(entity);
                    dbContext.SaveChanges();
        ...
        public async Task<bool> RemoveSelectedSessionSchedule(IEnumerable<string> lst)
        {
            try
            {
                StatusModel.StartStatusUpdate("Removing SessionSchedule", lst.Count());
                var t = Task.Run(() =>
                {
                    using (var ctx = new SessionScheduleService())
                    {
                        foreach (var item in lst.ToList())
                        {

                            ctx.DeleteSessionSchedule(item).Wait();
         ...
         public Task<int> CountByExpressionLst(List<string> expLst)
        {
            try
            {
                using (var dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
                {
                    ...
                    var set = (IQueryable<SessionSchedule>)dbContext.SessionSchedule; 
                    if (expLst.FirstOrDefault() == "All")
                    {
		...
		public Task<int> Count(string exp)
        {
            try
            {
                using (CoreEntitiesContext dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
                {
                    ...
                    if (exp == "All")
                    {
                        return Task.FromResult(dbContext.SessionSchedule
                            .AsNoTracking()
                            .Count());
                    }
                    else
        ...
        public Task<IEnumerable<SessionSchedule>> LoadRange(int startIndex, int count, string exp)
        {
            try
            {
                using (var dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
                {
                    ...
                    if (exp == "All")
                    {
                        return Task.FromResult<IEnumerable<SessionSchedule>>(dbContext.SessionSchedule
                            .AsNoTracking()
                            .OrderBy(y => y.Id)
                            .Skip(startIndex)
                            .Take(count)
		...
		public async Task<int> CountNav(string exp, Dictionary<string, string> navExp)
        {
            try
            {
                ...
                using (var dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
                {
                    ...
                    if (exp == "All" && navExp.Count == 0)
                    {
                        return dbContext.SessionSchedule
										.AsNoTracking()
                                        .Count();
                    }
                    foreach (var itm in navExp)
		...
		private static Task<int> CountWhereSelectMany<T>(CoreEntitiesContext dbContext, string exp, string navExp, string navProp) where T : class
        {
            ...
            return Task.FromResult(dbContext.Set<T>()
                .AsNoTracking()
                .Where(navExp)
                .SelectMany(navProp).OfType<SessionSchedule>()
		...
		private static Task<int> CountWhereSelect<T>(CoreEntitiesContext dbContext, string exp, string navExp, string navProp) where T : class
        {
            ...
            return Task.FromResult(dbContext.Set<T>()
                .AsNoTracking()
                .Where(navExp)
                .Select(navProp).OfType<SessionSchedule>()
                .Where(exp == "All" || exp == null ? "Id != null" : exp)
                .Distinct()
                .OrderBy("Id")
                .Count());
		  ...
		  public async Task<IEnumerable<SessionSchedule>> LoadRangeNav(int startIndex, int count, string exp,
                                                                                 Dictionary<string, string> navExp, IEnumerable<string> includeLst = null)
        {
            try
            {
                ...
                {
                    dbContext.Database.CommandTimeout = 0;
                    if ((string.IsNullOrEmpty(exp) && navExp.Count == 0) || exp == "None") return new List<SessionSchedule>();
                    ...
                    return set//dbContext.SessionSchedule
								.AsNoTracking()
                                .Where(exp == "All" || exp == null ? "Id != null" : exp)
								.OrderBy(y => y.Id)
		...
		private static async Task<IEnumerable<SessionSchedule>> LoadRangeWhere<T>(int startIndex, int count,
		...
		private static Task<IEnumerable<SessionSchedule>> LoadRangeSelectMany<T>(int startIndex, int count,
                                                                                 CoreEntitiesContext dbContext, string exp, string navExp, string navProp, IEnumerable<string> includeLst = null) where T : class
        {
            ...
            return Task.FromResult<IEnumerable<SessionSchedule>>(set
                .Where(exp == "All" || exp == null ? "Id != null" : exp)
                .Distinct()
                .OrderBy(y => y.Id)
		...
		private static Task<IEnumerable<SessionSchedule>> LoadRangeSelect<T>(int startIndex, int count,
                                                                             CoreEntitiesContext dbContext, string exp, string navExp, string navProp, IEnumerable<string> includeLst = null) where T : class
        {
			try
			{
        ...
        private static async Task<IEnumerable<SessionSchedule>> GetWhere<T>(CoreEntitiesContext dbContext,
		...
		private static Task<IEnumerable<SessionSchedule>> GetWhereSelectMany<T>(CoreEntitiesContext dbContext,
                                                                                string exp, string navExp, string navProp, List<string> includesLst = null) where T : class
        {
			...
			if (includesLst == null)
			{
				return Task.FromResult<IEnumerable<SessionSchedule>>(dbContext.Set<T>()
                    .AsNoTracking()
                    .Where(navExp)
                    .SelectMany(navProp).OfType<SessionSchedule>()
                    .Where(exp == "All" || exp == null?"Id != null":exp)
			...
			var set = (DbQuery<SessionSchedule>)dbContext.Set<T>()
				.AsNoTracking()
                .Where(navExp)
                .SelectMany(navProp).OfType<SessionSchedule>()
                .Where(exp == "All" || exp == null?"Id != null":exp)
            ...
            return Task.FromResult<IEnumerable<SessionSchedule>>(set.ToList());
			}
			catch (Exception)
			{
				Debugger.Break();
		...
		private static Task<IEnumerable<SessionSchedule>> GetWhereSelect<T>(CoreEntitiesContext dbContext,
                                                                            string exp, string navExp, string navProp, List<string> includesLst = null) where T : class
        {
			try
			{
			...
			catch (Exception)
			{
				...
				throw;
			        ...
			        public Task<IEnumerable<SessionSchedule>> GetSessionScheduleBySesseionId(string SesseionId, List<string> includesLst = null)
        {
            try
            {
                using ( var dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
              {
                var i = Convert.ToInt32(SesseionId);
                var set = AddIncludes(includesLst, dbContext);
                IEnumerable<SessionSchedule> entities = set//dbContext.SessionSchedule
                                      .AsNoTracking()
                                        .Where(x => x.SesseionId.ToString() == SesseionId.ToString())
										.ToList();
                return Task.FromResult(entities);
              }
             }
            catch (Exception updateEx)
            {
 	        ...
 	        public Task<IEnumerable<SessionSchedule>> GetSessionScheduleByApplicationSettingId(string ApplicationSettingId, List<string> includesLst = null)
        {
            try
            {
                using ( var dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
              {
                var i = Convert.ToInt32(ApplicationSettingId);
                var set = AddIncludes(includesLst, dbContext);
                IEnumerable<SessionSchedule> entities = set//dbContext.SessionSchedule
                                      .AsNoTracking()
                                        .Where(x => x.ApplicationSettingId.ToString() == ApplicationSettingId.ToString())
										.ToList();
                return Task.FromResult(entities);
              }
             }
            catch (Exception updateEx)
            {
 	        ...
 	        public Task<IEnumerable<SessionSchedule>> GetSessionScheduleByActionId(string ActionId, List<string> includesLst = null)
        {
            try
            {
                using ( var dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
            ...
            catch (Exception updateEx)
            {
 	        ...
 	        public Task<IEnumerable<SessionSchedule>> GetSessionScheduleByParameterSetId(string ParameterSetId, List<string> includesLst = null)
        {
            try
            {
                using ( var dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
             ...
             try
             {
                 using (var dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
                 {
					...
					decimal res = 0;
                     ...
                     if (whereExp == "All")
                     {
                          res = Convert.ToDecimal(dbContext.SessionSchedule.AsNoTracking().Sum(field));
                     }
                     else
                     {
                         res = Convert.ToDecimal(dbContext.SessionSchedule.AsNoTracking().Where(whereExp).Sum(field));
                     }
        ...
        public async Task<decimal> SumNav( string exp, Dictionary<string, string> navExp, string field)
        {
            try
            {
                ...
                {
                    dbContext.Database.CommandTimeout = 0;
                    if (!dbContext.SessionSchedule.Any()) return 0;
                    if (exp == "All" && navExp.Count == 0)
                    {
                        return Convert.ToDecimal(dbContext.SessionSchedule
										.AsNoTracking()
                                        .Sum(field)??0);
                    }
                    foreach (var itm in navExp)
                    ...
                    return Convert.ToDecimal(dbContext.SessionSchedule.Where(exp == "All" || exp == null ? "Id != null" : exp)
											.AsNoTracking()
                                            .Sum(field)??0);
                }
             ...
             try
             {
                 using (var dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
                 {
					...
					string res = "";
                     ...
                     if (whereExp == "All")
                     {
                          res = Convert.ToString(dbContext.SessionSchedule.AsNoTracking().Min(field));
                     }
                     else
                     {
                         res = Convert.ToString(dbContext.SessionSchedule.AsNoTracking().Where(whereExp).Min(field));
                     }
		...
		private static IQueryable<SessionSchedule> AddIncludes(IEnumerable<string> includesLst, CoreEntitiesContext dbContext)
       {
		 try
			{
			   if (includesLst == null) includesLst = new List<string>();
			   var set =(DbQuery<SessionSchedule>) dbContext.SessionSchedule; 
	   ...
	   private IQueryable<SessionSchedule> AddWheres(List<string> expLst, IQueryable<SessionSchedule> set)
        {
            try
            {
