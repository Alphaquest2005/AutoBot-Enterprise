...
namespace CoreEntities.Business.Services
{
   ...
   [ServiceBehavior(InstanceContextMode = InstanceContextMode.PerCall,
    ...
    public partial class InventoryItemAliasExService : IInventoryItemAliasExService, IDisposable
    {
        ...
        public async Task<IEnumerable<InventoryItemAliasEx>> GetInventoryItemAliasEx(List<string> includesLst = null, bool tracking = true)
        {
            try
            {
        ...
        public async Task<InventoryItemAliasEx> GetInventoryItemAliasExByKey(string AliasId, List<string> includesLst = null, bool tracking = true)
        {
		 ...
		 public async Task<IEnumerable<InventoryItemAliasEx>> GetInventoryItemAliasExByExpression(string exp, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
                using (var dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
		 ...
		 public async Task<IEnumerable<InventoryItemAliasEx>> GetInventoryItemAliasExByExpressionLst(List<string> expLst, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
                using (var dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
        ...
        public async Task<InventoryItemAliasEx> CreateInventoryItemAliasEx(InventoryItemAliasEx entity)
        {
            try
            {
              ...
              using ( var dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
              {
                dbContext.InventoryItemAliasEx.Add(res);
                await dbContext.SaveChangesAsync().ConfigureAwait(continueOnCapturedContext: false);
                res.AcceptChanges();
                return res;
              }
        ...
        public async Task<bool> DeleteInventoryItemAliasEx(string AliasId)
        {
            try
            {
              ...
              {
                var i = Convert.ToInt32(AliasId);
                InventoryItemAliasEx entity = await dbContext.InventoryItemAliasEx
													.SingleOrDefaultAsync(x => x.AliasId == i)
													.ConfigureAwait(continueOnCapturedContext: false);
                if (entity == null)
                    return false;

                    dbContext.InventoryItemAliasEx.Attach(entity);
                    dbContext.InventoryItemAliasEx.Remove(entity);
                    await dbContext.SaveChangesAsync().ConfigureAwait(continueOnCapturedContext: false);
                    return true;
              }
            }
         ...
         public async Task<int> CountByExpressionLst(List<string> expLst)
        {
            try
            {
                using (var dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
                {
                    ...
                    var set = (IQueryable<InventoryItemAliasEx>)dbContext.InventoryItemAliasEx; 
                    if (expLst.FirstOrDefault() == "All")
                    {
		...
		public async Task<int> Count(string exp)
        {
            try
            {
                using (CoreEntitiesContext dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
                {
                    ...
                    if (exp == "All")
                    {
                        return await dbContext.InventoryItemAliasEx
                                    .AsNoTracking()
									.CountAsync()
									.ConfigureAwait(continueOnCapturedContext: false);
                    }
		...
		public async Task<int> CountNav(string exp, Dictionary<string, string> navExp)
        {
            try
            {
                ...
                using (var dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
                {
                    ...
                    return await dbContext.InventoryItemAliasEx.Where(exp == "All" || exp == null ? "AliasId != null" : exp)
											.AsNoTracking()
                                            .CountAsync()
											.ConfigureAwait(continueOnCapturedContext: false);
                }
                                                                                 ...
                                                                                 Dictionary<string, string> navExp, IEnumerable<string> includeLst = null)
        {
            try
            {
                using (var dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
                {
                    ...
                    return await set//dbContext.InventoryItemAliasEx
								.AsNoTracking()
                                .Where(exp == "All" || exp == null ? "AliasId != null" : exp)
								.OrderBy(y => y.AliasId)
        ...
        private static async Task<IEnumerable<InventoryItemAliasEx>> GetWhere<T>(CoreEntitiesContext dbContext,
		...
		private static async Task<IEnumerable<InventoryItemAliasEx>> GetWhereSelectMany<T>(CoreEntitiesContext dbContext,
		...
		private static async Task<IEnumerable<InventoryItemAliasEx>> GetWhereSelect<T>(CoreEntitiesContext dbContext,
            string exp, string navExp, string navProp, List<string> includesLst = null) where T : class
        {
			try
			{
			        ...
			        public async Task<IEnumerable<InventoryItemAliasEx>> GetInventoryItemAliasExByApplicationSettingsId(string ApplicationSettingsId, List<string> includesLst = null)
        {
            try
            {
                using ( var dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
              {
                ...
                var set = AddIncludes(includesLst, dbContext);
                IEnumerable<InventoryItemAliasEx> entities = await set//dbContext.InventoryItemAliasEx
                                      .AsNoTracking()
             ...
             try
             {
                 using (var dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
                 {
					decimal res = 0;
                     ...
                     if (whereExp == "All")
                     {
                          res = Convert.ToDecimal(dbContext.InventoryItemAliasEx.AsNoTracking().Sum(field));
                     }
                     else
                     {
                         res = Convert.ToDecimal(dbContext.InventoryItemAliasEx.AsNoTracking().Where(whereExp).Sum(field));
                     }
        ...
        public async Task<decimal> SumNav( string exp, Dictionary<string, string> navExp, string field)
        {
            try
            {
                ...
                using (var dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
                {
                    if (!dbContext.InventoryItemAliasEx.Any()) return 0;
                    if (exp == "All" && navExp.Count == 0)
                    {
                        return Convert.ToDecimal(dbContext.InventoryItemAliasEx
										.AsNoTracking()
                                        .Sum(field)??0);
                    }
                    foreach (var itm in navExp)
                    ...
                    return Convert.ToDecimal(dbContext.InventoryItemAliasEx.Where(exp == "All" || exp == null ? "AliasId != null" : exp)
											.AsNoTracking()
                                            .Sum(field)??0);
                }
             ...
             try
             {
                 using (var dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
                 {
					string res = "";
                     ...
                     if (whereExp == "All")
                     {
                          res = Convert.ToString(dbContext.InventoryItemAliasEx.AsNoTracking().Min(field));
                     }
                     else
                     {
                         res = Convert.ToString(dbContext.InventoryItemAliasEx.AsNoTracking().Where(whereExp).Min(field));
                     }
		...
		private static IQueryable<InventoryItemAliasEx> AddIncludes(IEnumerable<string> includesLst, CoreEntitiesContext dbContext)
       {
		 try
			{
			   if (includesLst == null) includesLst = new List<string>();
			   var set =(DbQuery<InventoryItemAliasEx>) dbContext.InventoryItemAliasEx; 
