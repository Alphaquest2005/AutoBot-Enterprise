...
namespace CoreEntities.Business.Services
{
   ...
   [ServiceBehavior(InstanceContextMode = InstanceContextMode.PerCall,
    ...
    public partial class TODO_ImportCompleteEntriesService : ITODO_ImportCompleteEntriesService, IDisposable
    {
        ...
        public async Task<IEnumerable<TODO_ImportCompleteEntries>> GetTODO_ImportCompleteEntries(List<string> includesLst = null, bool tracking = true)
        {
            try
            {
            //using (var scope = new TransactionScope(TransactionScopeOption.Required,
               ...
               // {
                  using ( var dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
                  {
                    ...
                    IEnumerable<TODO_ImportCompleteEntries> entities = await set.AsNoTracking().ToListAsync()
        ...
        public async Task<TODO_ImportCompleteEntries> GetTODO_ImportCompleteEntriesByKey(string NewAsycuda_Id, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
			   if(string.IsNullOrEmpty(NewAsycuda_Id))return null; 
              using ( var dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
              {
                var i = Convert.ToInt32(NewAsycuda_Id);
				var set = AddIncludes(includesLst, dbContext);
                TODO_ImportCompleteEntries entity = await set.AsNoTracking().SingleOrDefaultAsync(x => x.NewAsycuda_Id == i).ConfigureAwait(continueOnCapturedContext: false);
		 ...
		 public async Task<IEnumerable<TODO_ImportCompleteEntries>> GetTODO_ImportCompleteEntriesByExpression(string exp, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
                using (var dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
                {
					...
					if (string.IsNullOrEmpty(exp) || exp == "None") return new List<TODO_ImportCompleteEntries>();
					var set = AddIncludes(includesLst, dbContext);
                    if (exp == "All")
                    {
		 ...
		 public async Task<IEnumerable<TODO_ImportCompleteEntries>> GetTODO_ImportCompleteEntriesByExpressionLst(List<string> expLst, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
                using (var dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
                {
                    dbContext.Database.CommandTimeout = 0;
					if (expLst.Count == 0 || expLst.FirstOrDefault() == "None") return new List<TODO_ImportCompleteEntries>();
					var set = AddIncludes(includesLst, dbContext);
        ...
        public async Task<bool> DeleteTODO_ImportCompleteEntries(string NewAsycuda_Id)
        {
            try
            {
              using ( var dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
              {
                var i = Convert.ToInt32(NewAsycuda_Id);
                TODO_ImportCompleteEntries entity = await dbContext.TODO_ImportCompleteEntries
													.SingleOrDefaultAsync(x => x.NewAsycuda_Id == i)
													.ConfigureAwait(continueOnCapturedContext: false);
                if (entity == null)
                    return false;
		...
		public async Task<int> Count(string exp)
        {
            try
            {
                using (CoreEntitiesContext dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
                {
                    ...
                    if (exp == "All")
                    {
                        return await dbContext.TODO_ImportCompleteEntries
                                    .AsNoTracking()
									.CountAsync()
									.ConfigureAwait(continueOnCapturedContext: false);
                    }
		...
		public async Task<int> CountNav(string exp, Dictionary<string, string> navExp)
        {
            try
            {
                ...
                using (var dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
                {
                    ...
                    return await dbContext.TODO_ImportCompleteEntries.Where(exp == "All" || exp == null ? "NewAsycuda_Id != null" : exp)
											.AsNoTracking()
                                            .CountAsync()
											.ConfigureAwait(continueOnCapturedContext: false);
                }
                                                                                 ...
                                                                                 Dictionary<string, string> navExp, IEnumerable<string> includeLst = null)
        {
            try
            {
                ...
                {
                    dbContext.Database.CommandTimeout = 0;
                    if ((string.IsNullOrEmpty(exp) && navExp.Count == 0) || exp == "None") return new List<TODO_ImportCompleteEntries>();
                    ...
                    return await set//dbContext.TODO_ImportCompleteEntries
								.AsNoTracking()
                                .Where(exp == "All" || exp == null ? "NewAsycuda_Id != null" : exp)
								.OrderBy(y => y.NewAsycuda_Id)
		...
		private static async Task<IEnumerable<TODO_ImportCompleteEntries>> LoadRangeSelectMany<T>(int startIndex, int count,
		...
		private static async Task<IEnumerable<TODO_ImportCompleteEntries>> LoadRangeSelect<T>(int startIndex, int count,
            CoreEntitiesContext dbContext, string exp, string navExp, string navProp, IEnumerable<string> includeLst = null) where T : class
        {
			try
			{
		...
		private static async Task<IEnumerable<TODO_ImportCompleteEntries>> GetWhereSelectMany<T>(CoreEntitiesContext dbContext,
		...
		private static async Task<IEnumerable<TODO_ImportCompleteEntries>> GetWhereSelect<T>(CoreEntitiesContext dbContext,
            string exp, string navExp, string navProp, List<string> includesLst = null) where T : class
        {
			try
			{
			        ...
			        public async Task<IEnumerable<TODO_ImportCompleteEntries>> GetTODO_ImportCompleteEntriesByAsycudaDocumentSetId(string AsycudaDocumentSetId, List<string> includesLst = null)
        {
            try
            {
                using ( var dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
              {
                ...
                var set = AddIncludes(includesLst, dbContext);
                IEnumerable<TODO_ImportCompleteEntries> entities = await set//dbContext.TODO_ImportCompleteEntries
                                      .AsNoTracking()
        ...
        public async Task<decimal> SumNav( string exp, Dictionary<string, string> navExp, string field)
        {
            try
            {
                ...
                {
                    dbContext.Database.CommandTimeout = 0;
                    if (!dbContext.TODO_ImportCompleteEntries.Any()) return 0;
                    if (exp == "All" && navExp.Count == 0)
                    {
                        return Convert.ToDecimal(dbContext.TODO_ImportCompleteEntries
										.AsNoTracking()
                                        .Sum(field)??0);
                    }
                    return Convert.ToDecimal(dbContext.TODO_ImportCompleteEntries.Where(exp == "All" || exp == null ? "NewAsycuda_Id != null" : exp)
											.AsNoTracking()
                                            .Sum(field)??0);
                }
