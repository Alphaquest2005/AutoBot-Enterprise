...
namespace CoreEntities.Business.Services
{
   ...
   [ServiceBehavior(InstanceContextMode = InstanceContextMode.PerCall,
    ...
    public partial class TODO_ERRReport_EntryDataDetailsService : ITODO_ERRReport_EntryDataDetailsService, IDisposable
    {
        ...
        public async Task<IEnumerable<TODO_ERRReport_EntryDataDetails>> GetTODO_ERRReport_EntryDataDetails(List<string> includesLst = null, bool tracking = true)
        {
            try
            {
            //using (var scope = new TransactionScope(TransactionScopeOption.Required,
               ...
               // {
                  using ( var dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
                  {
                    ...
                    IEnumerable<TODO_ERRReport_EntryDataDetails> entities = await set.AsNoTracking().ToListAsync()
        ...
        public async Task<TODO_ERRReport_EntryDataDetails> GetTODO_ERRReport_EntryDataDetailsByKey(string InvoiceNo, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
              ...
              using ( var dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
              {
                var i = InvoiceNo;
				var set = AddIncludes(includesLst, dbContext);
                TODO_ERRReport_EntryDataDetails entity = await set.AsNoTracking().SingleOrDefaultAsync(x => x.InvoiceNo == i).ConfigureAwait(continueOnCapturedContext: false);
		 ...
		 public async Task<IEnumerable<TODO_ERRReport_EntryDataDetails>> GetTODO_ERRReport_EntryDataDetailsByExpression(string exp, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
                using (var dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
                {
					...
					if (string.IsNullOrEmpty(exp) || exp == "None") return new List<TODO_ERRReport_EntryDataDetails>();
					var set = AddIncludes(includesLst, dbContext);
                    if (exp == "All")
                    {
		 ...
		 public async Task<IEnumerable<TODO_ERRReport_EntryDataDetails>> GetTODO_ERRReport_EntryDataDetailsByExpressionLst(List<string> expLst, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
                using (var dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
                {
                    dbContext.Database.CommandTimeout = 0;
					if (expLst.Count == 0 || expLst.FirstOrDefault() == "None") return new List<TODO_ERRReport_EntryDataDetails>();
					var set = AddIncludes(includesLst, dbContext);
        ...
        public async Task<bool> DeleteTODO_ERRReport_EntryDataDetails(string InvoiceNo)
        {
            try
            {
              using ( var dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
              {
                var i = InvoiceNo;
                TODO_ERRReport_EntryDataDetails entity = await dbContext.TODO_ERRReport_EntryDataDetails
		...
		public async Task<int> Count(string exp)
        {
            try
            {
                using (CoreEntitiesContext dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
                {
                    ...
                    if (exp == "All")
                    {
                        return await dbContext.TODO_ERRReport_EntryDataDetails
                                    .AsNoTracking()
									.CountAsync()
									.ConfigureAwait(continueOnCapturedContext: false);
                    }
		...
		public async Task<int> CountNav(string exp, Dictionary<string, string> navExp)
        {
            try
            {
                ...
                using (var dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
                {
                    ...
                    return await dbContext.TODO_ERRReport_EntryDataDetails.Where(exp == "All" || exp == null ? "InvoiceNo != null" : exp)
											.AsNoTracking()
                                            .CountAsync()
											.ConfigureAwait(continueOnCapturedContext: false);
                }
                                                                                 ...
                                                                                 Dictionary<string, string> navExp, IEnumerable<string> includeLst = null)
        {
            try
            {
                ...
                {
                    dbContext.Database.CommandTimeout = 0;
                    if ((string.IsNullOrEmpty(exp) && navExp.Count == 0) || exp == "None") return new List<TODO_ERRReport_EntryDataDetails>();
                    ...
                    return await set//dbContext.TODO_ERRReport_EntryDataDetails
								.AsNoTracking()
                                .Where(exp == "All" || exp == null ? "InvoiceNo != null" : exp)
								.OrderBy(y => y.InvoiceNo)
		...
		private static async Task<IEnumerable<TODO_ERRReport_EntryDataDetails>> LoadRangeSelectMany<T>(int startIndex, int count,
		...
		private static async Task<IEnumerable<TODO_ERRReport_EntryDataDetails>> LoadRangeSelect<T>(int startIndex, int count,
            CoreEntitiesContext dbContext, string exp, string navExp, string navProp, IEnumerable<string> includeLst = null) where T : class
        {
			try
			{
		...
		private static async Task<IEnumerable<TODO_ERRReport_EntryDataDetails>> GetWhereSelectMany<T>(CoreEntitiesContext dbContext,
		...
		private static async Task<IEnumerable<TODO_ERRReport_EntryDataDetails>> GetWhereSelect<T>(CoreEntitiesContext dbContext,
            string exp, string navExp, string navProp, List<string> includesLst = null) where T : class
        {
			try
			{
			        ...
			        public async Task<IEnumerable<TODO_ERRReport_EntryDataDetails>> GetTODO_ERRReport_EntryDataDetailsByApplicationSettingsId(string ApplicationSettingsId, List<string> includesLst = null)
        {
            try
            {
                using ( var dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
              {
                ...
                var set = AddIncludes(includesLst, dbContext);
                IEnumerable<TODO_ERRReport_EntryDataDetails> entities = await set//dbContext.TODO_ERRReport_EntryDataDetails
                                      .AsNoTracking()
        ...
        public async Task<decimal> SumNav( string exp, Dictionary<string, string> navExp, string field)
        {
            try
            {
                ...
                {
                    dbContext.Database.CommandTimeout = 0;
                    if (!dbContext.TODO_ERRReport_EntryDataDetails.Any()) return 0;
                    if (exp == "All" && navExp.Count == 0)
                    {
                        return Convert.ToDecimal(dbContext.TODO_ERRReport_EntryDataDetails
										.AsNoTracking()
                                        .Sum(field)??0);
                    }
                    return Convert.ToDecimal(dbContext.TODO_ERRReport_EntryDataDetails.Where(exp == "All" || exp == null ? "InvoiceNo != null" : exp)
											.AsNoTracking()
                                            .Sum(field)??0);
                }
