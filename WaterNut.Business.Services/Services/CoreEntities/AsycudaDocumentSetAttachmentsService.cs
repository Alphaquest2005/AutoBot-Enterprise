...
namespace CoreEntities.Business.Services
{
   ...
   [ServiceBehavior(InstanceContextMode = InstanceContextMode.PerCall,
    ...
    public partial class AsycudaDocumentSetAttachmentsService : IAsycudaDocumentSetAttachmentsService, IDisposable
    {
        ...
        public async Task<IEnumerable<AsycudaDocumentSetAttachments>> GetAsycudaDocumentSetAttachments(List<string> includesLst = null, bool tracking = true)
        {
            try
            {
        ...
        public async Task<AsycudaDocumentSetAttachments> GetAsycudaDocumentSetAttachmentsByKey(string Id, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
		 ...
		 public async Task<IEnumerable<AsycudaDocumentSetAttachments>> GetAsycudaDocumentSetAttachmentsByExpression(string exp, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
                using (var dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
		 ...
		 public async Task<IEnumerable<AsycudaDocumentSetAttachments>> GetAsycudaDocumentSetAttachmentsByExpressionLst(List<string> expLst, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
                using (var dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
                {
                    dbContext.Database.CommandTimeout = 0;
					if (expLst.Count == 0 || expLst.FirstOrDefault() == "None") return new List<AsycudaDocumentSetAttachments>();
					var set = AddIncludes(includesLst, dbContext);
		...
		private static async Task<IEnumerable<AsycudaDocumentSetAttachments>> LoadRangeSelectMany<T>(int startIndex, int count,
		...
		private static async Task<IEnumerable<AsycudaDocumentSetAttachments>> LoadRangeSelect<T>(int startIndex, int count,
            CoreEntitiesContext dbContext, string exp, string navExp, string navProp, IEnumerable<string> includeLst = null) where T : class
        {
			try
			{
		...
		private static async Task<IEnumerable<AsycudaDocumentSetAttachments>> GetWhereSelectMany<T>(CoreEntitiesContext dbContext,
		...
		private static async Task<IEnumerable<AsycudaDocumentSetAttachments>> GetWhereSelect<T>(CoreEntitiesContext dbContext,
            string exp, string navExp, string navProp, List<string> includesLst = null) where T : class
        {
			try
			{
