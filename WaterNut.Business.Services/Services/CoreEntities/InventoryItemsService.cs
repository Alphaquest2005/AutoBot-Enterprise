...
namespace CoreEntities.Business.Services
{
   ...
   [ServiceBehavior(InstanceContextMode = InstanceContextMode.PerCall,
    ...
    public partial class InventoryItemsService : IInventoryItemsService, IDisposable
    {
                    ...
                    foreach (var itm in navExp)
                    {
                        switch (itm.Key)
                        {
                            ...
                            case "AsycudaDocumentItem":
                                return
                                    await
                                        GetWhere<AsycudaDocumentItem>(dbContext, exp, itm.Value, "InventoryItems", "Select", includesLst)
										.ConfigureAwait(continueOnCapturedContext: false);

                            case "ApplicationSettings":
                                return
                                    await
                                        GetWhere<ApplicationSettings>(dbContext, exp, itm.Value, "InventoryItems", "SelectMany", includesLst)
										.ConfigureAwait(continueOnCapturedContext: false);
                        ...
                        switch (itm.Key)
                        {
                            case "InventoryItemAlias":
                                return await CountWhere<InventoryItemAlias>(dbContext, exp, itm.Value, "InventoryItems", "Select")
											.ConfigureAwait(continueOnCapturedContext: false);
                            case "AsycudaDocumentItem":
                                return await CountWhere<AsycudaDocumentItem>(dbContext, exp, itm.Value, "InventoryItems", "Select")
											.ConfigureAwait(continueOnCapturedContext: false);
                            case "ApplicationSettings":
                                return await CountWhere<ApplicationSettings>(dbContext, exp, itm.Value, "InventoryItems", "SelectMany")
											.ConfigureAwait(continueOnCapturedContext: false);
						}
                    }
                    ...
                    foreach (var itm in navExp)
                    {
                        switch (itm.Key)
                        {
                            ...
                            case "AsycudaDocumentItem":
                                return
                                    await
                                        LoadRangeWhere<AsycudaDocumentItem>(startIndex, count, dbContext, exp, itm.Value, "InventoryItems", "Select")
													.ConfigureAwait(continueOnCapturedContext: false);

                            case "ApplicationSettings":
                                return
                                    await
                                        LoadRangeWhere<ApplicationSettings>(startIndex, count, dbContext, exp, itm.Value, "InventoryItems", "SelectMany")
													.ConfigureAwait(continueOnCapturedContext: false);
        ...
        private static async Task<IEnumerable<InventoryItems>> GetWhere<T>(CoreEntitiesContext dbContext,
		...
		private static async Task<IEnumerable<InventoryItems>> GetWhereSelectMany<T>(CoreEntitiesContext dbContext,
		...
		private static async Task<IEnumerable<InventoryItems>> GetWhereSelect<T>(CoreEntitiesContext dbContext,
            string exp, string navExp, string navProp, List<string> includesLst = null) where T : class
        {
			try
			{
                        ...
                        switch (itm.Key)
                        {
                            case "InventoryItemAlias":
                                return await SumWhere<InventoryItemAlias>(dbContext, exp, itm.Value, "InventoryItems", field, "Select")
											.ConfigureAwait(continueOnCapturedContext: false);
                            case "AsycudaDocumentItem":
                                return await SumWhere<AsycudaDocumentItem>(dbContext, exp, itm.Value, "InventoryItems", field, "Select")
											.ConfigureAwait(continueOnCapturedContext: false);
                            case "ApplicationSettings":
                                return await SumWhere<ApplicationSettings>(dbContext, exp, itm.Value, "InventoryItems", field, "SelectMany")
											.ConfigureAwait(continueOnCapturedContext: false);
						}
                    }
		...
		private static IQueryable<InventoryItems> AddIncludes(IEnumerable<string> includesLst, CoreEntitiesContext dbContext)
       {
		 try
			{
