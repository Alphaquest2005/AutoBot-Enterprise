...
namespace CoreEntities.Business.Services
{
   ...
   [ServiceBehavior(InstanceContextMode = InstanceContextMode.PerCall,
    ...
    public partial class TODO_AdjustmentsToXMLService : ITODO_AdjustmentsToXMLService, IDisposable
    {
        //private readonly CoreEntitiesContext dbContext;

        public bool StartTracking { get; set; }

        public TODO_AdjustmentsToXMLService()
        {
            try
            {
        ...
        public async Task<IEnumerable<TODO_AdjustmentsToXML>> GetTODO_AdjustmentsToXML(List<string> includesLst = null, bool tracking = true)
        {
            try
            {
            //using (var scope = new TransactionScope(TransactionScopeOption.Required,
               ...
               // {
                  using ( var dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
                  {
                    ...
                    IEnumerable<TODO_AdjustmentsToXML> entities = await set.AsNoTracking().ToListAsync()
        ...
        public async Task<TODO_AdjustmentsToXML> GetTODO_AdjustmentsToXMLByKey(string EntryDataDetailsId, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
              ...
              using ( var dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
              {
				...
				var set = AddIncludes(includesLst, dbContext);
                TODO_AdjustmentsToXML entity = await set.AsNoTracking().SingleOrDefaultAsync(x => x.EntryDataDetailsId == i).ConfigureAwait(continueOnCapturedContext: false);
		 ...
		 public async Task<IEnumerable<TODO_AdjustmentsToXML>> GetTODO_AdjustmentsToXMLByExpression(string exp, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
                using (var dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
                {
					if (string.IsNullOrEmpty(exp) || exp == "None") return new List<TODO_AdjustmentsToXML>();
					var set = AddIncludes(includesLst, dbContext);
                    if (exp == "All")
                    {
		 ...
		 public async Task<IEnumerable<TODO_AdjustmentsToXML>> GetTODO_AdjustmentsToXMLByExpressionLst(List<string> expLst, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
                using (var dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
                {
					if (expLst.Count == 0 || expLst.FirstOrDefault() == "None") return new List<TODO_AdjustmentsToXML>();
					var set = AddIncludes(includesLst, dbContext);
            ...
            int totalrow, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
                ...
                var res = new ConcurrentQueue<List<TODO_AdjustmentsToXML>>();
                    ...
                    //  for (int bat = 0; bat < batches; bat++)
                    {
                        try
                        {
                            using (var dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
                            {
                                ...
                                var set = AddIncludes(includesLst, dbContext);
                                IQueryable<TODO_AdjustmentsToXML> dset;
                                if (exp == "All")
                                {
            ...
            using ( var dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
              {
                try
                {   
                     var res = (TODO_AdjustmentsToXML) entity;
        ...
        public async Task<TODO_AdjustmentsToXML> CreateTODO_AdjustmentsToXML(TODO_AdjustmentsToXML entity)
        {
            try
            {
              ...
              using ( var dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
              {
                dbContext.TODO_AdjustmentsToXML.Add(res);
                await dbContext.SaveChangesAsync().ConfigureAwait(continueOnCapturedContext: false);
                res.AcceptChanges();
                return res;
              }
        ...
        public async Task<bool> DeleteTODO_AdjustmentsToXML(string EntryDataDetailsId)
        {
            try
            {
              using ( var dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
              {
                var i = Convert.ToInt32(EntryDataDetailsId);
                TODO_AdjustmentsToXML entity = await dbContext.TODO_AdjustmentsToXML
													.SingleOrDefaultAsync(x => x.EntryDataDetailsId == i)
													.ConfigureAwait(continueOnCapturedContext: false);
                if (entity == null)
                    return false;

                    dbContext.TODO_AdjustmentsToXML.Attach(entity);
                    dbContext.TODO_AdjustmentsToXML.Remove(entity);
                    await dbContext.SaveChangesAsync().ConfigureAwait(continueOnCapturedContext: false);
                    return true;
              }
            }
        ...
        public async Task<bool> RemoveSelectedTODO_AdjustmentsToXML(IEnumerable<string> lst)
        {
            try
            {
                StatusModel.StartStatusUpdate("Removing TODO_AdjustmentsToXML", lst.Count());
                var t = Task.Run(() =>
                {
                    using (var ctx = new TODO_AdjustmentsToXMLService())
                    {
                        foreach (var item in lst.ToList())
                        {

                            ctx.DeleteTODO_AdjustmentsToXML(item).Wait();
         ...
         public async Task<int> CountByExpressionLst(List<string> expLst)
        {
            try
            {
                using (var dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
                {
                    ...
                    var set = (IQueryable<TODO_AdjustmentsToXML>)dbContext.TODO_AdjustmentsToXML; 
                    if (expLst.FirstOrDefault() == "All")
                    {
		...
		public async Task<int> Count(string exp)
        {
            try
            {
                using (CoreEntitiesContext dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
                {
                    ...
                    if (exp == "All")
                    {
                        return await dbContext.TODO_AdjustmentsToXML
                                    .AsNoTracking()
									.CountAsync()
									.ConfigureAwait(continueOnCapturedContext: false);
                    }
		...
		public async Task<int> CountNav(string exp, Dictionary<string, string> navExp)
        {
            try
            {
                ...
                using (var dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
                {
                    ...
                    return await dbContext.TODO_AdjustmentsToXML.Where(exp == "All" || exp == null ? "EntryDataDetailsId != null" : exp)
											.AsNoTracking()
                                            .CountAsync()
											.ConfigureAwait(continueOnCapturedContext: false);
                }
		...
		private static async Task<int> CountWhereSelectMany<T>(CoreEntitiesContext dbContext, string exp, string navExp, string navProp) where T : class
        {
            ...
            return await dbContext.Set<T>()
				.AsNoTracking()
                .Where(navExp)
                .SelectMany(navProp).OfType<TODO_AdjustmentsToXML>()
		...
		private static async Task<int> CountWhereSelect<T>(CoreEntitiesContext dbContext, string exp, string navExp, string navProp) where T : class
        {
            ...
            return await dbContext.Set<T>()
				.AsNoTracking()
                .Where(navExp)
                .Select(navProp).OfType<TODO_AdjustmentsToXML>()
                .Where(exp == "All" || exp == null ? "EntryDataDetailsId != null" : exp)
                .Distinct()
                .OrderBy("EntryDataDetailsId")
                .CountAsync()
                                                                                 ...
                                                                                 Dictionary<string, string> navExp, IEnumerable<string> includeLst = null)
        {
            try
            {
                using (var dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
                {
                    if ((string.IsNullOrEmpty(exp) && navExp.Count == 0) || exp == "None") return new List<TODO_AdjustmentsToXML>();
                    ...
                    return await set//dbContext.TODO_AdjustmentsToXML
								.AsNoTracking()
                                .Where(exp == "All" || exp == null ? "EntryDataDetailsId != null" : exp)
								.OrderBy(y => y.EntryDataDetailsId)
		...
		private static async Task<IEnumerable<TODO_AdjustmentsToXML>> LoadRangeWhere<T>(int startIndex, int count,
		...
		private static async Task<IEnumerable<TODO_AdjustmentsToXML>> LoadRangeSelectMany<T>(int startIndex, int count,
		...
		private static async Task<IEnumerable<TODO_AdjustmentsToXML>> LoadRangeSelect<T>(int startIndex, int count,
            CoreEntitiesContext dbContext, string exp, string navExp, string navProp, IEnumerable<string> includeLst = null) where T : class
        {
			try
			{
        ...
        private static async Task<IEnumerable<TODO_AdjustmentsToXML>> GetWhere<T>(CoreEntitiesContext dbContext,
		...
		private static async Task<IEnumerable<TODO_AdjustmentsToXML>> GetWhereSelectMany<T>(CoreEntitiesContext dbContext,
            string exp, string navExp, string navProp, List<string> includesLst = null) where T : class
        {
			...
			var set = (DbQuery<TODO_AdjustmentsToXML>)dbContext.Set<T>()
				.AsNoTracking()
                .Where(navExp)
                .SelectMany(navProp).OfType<TODO_AdjustmentsToXML>()
                .Where(exp == "All" || exp == null?"EntryDataDetailsId != null":exp)
		...
		private static async Task<IEnumerable<TODO_AdjustmentsToXML>> GetWhereSelect<T>(CoreEntitiesContext dbContext,
            string exp, string navExp, string navProp, List<string> includesLst = null) where T : class
        {
			try
			{
             ...
             try
             {
                 using (var dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
                 {
					decimal res = 0;
                     ...
                     if (whereExp == "All")
                     {
                          res = Convert.ToDecimal(dbContext.TODO_AdjustmentsToXML.AsNoTracking().Sum(field));
                     }
                     else
                     {
                         res = Convert.ToDecimal(dbContext.TODO_AdjustmentsToXML.AsNoTracking().Where(whereExp).Sum(field));
                     }
        ...
        public async Task<decimal> SumNav( string exp, Dictionary<string, string> navExp, string field)
        {
            try
            {
                ...
                using (var dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
                {
                    if (!dbContext.TODO_AdjustmentsToXML.Any()) return 0;
                    if (exp == "All" && navExp.Count == 0)
                    {
                        return Convert.ToDecimal(dbContext.TODO_AdjustmentsToXML
										.AsNoTracking()
                                        .Sum(field)??0);
                    }
                    return Convert.ToDecimal(dbContext.TODO_AdjustmentsToXML.Where(exp == "All" || exp == null ? "EntryDataDetailsId != null" : exp)
											.AsNoTracking()
                                            .Sum(field)??0);
                }
             ...
             try
             {
                 using (var dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
                 {
					string res = "";
                     ...
                     if (whereExp == "All")
                     {
                          res = Convert.ToString(dbContext.TODO_AdjustmentsToXML.AsNoTracking().Min(field));
                     }
                     else
                     {
                         res = Convert.ToString(dbContext.TODO_AdjustmentsToXML.AsNoTracking().Where(whereExp).Min(field));
                     }
		...
		private static IQueryable<TODO_AdjustmentsToXML> AddIncludes(IEnumerable<string> includesLst, CoreEntitiesContext dbContext)
       {
		 try
			{
			   if (includesLst == null) includesLst = new List<string>();
			   var set =(DbQuery<TODO_AdjustmentsToXML>) dbContext.TODO_AdjustmentsToXML; 
	   ...
	   private IQueryable<TODO_AdjustmentsToXML> AddWheres(List<string> expLst, IQueryable<TODO_AdjustmentsToXML> set)
        {
            try
            {
