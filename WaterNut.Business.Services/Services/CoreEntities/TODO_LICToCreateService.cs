...
namespace CoreEntities.Business.Services
{
   ...
   [ServiceBehavior(InstanceContextMode = InstanceContextMode.PerCall,
    ...
    public partial class TODO_LICToCreateService : ITODO_LICToCreateService, IDisposable
    {
        //private readonly CoreEntitiesContext dbContext;

        public bool StartTracking { get; set; }

        public TODO_LICToCreateService()
        {
            try
            {
        ...
        public Task<IEnumerable<TODO_LICToCreate>> GetTODO_LICToCreate(List<string> includesLst = null, bool tracking = true)
        {
            try
            {
            //using (var scope = new TransactionScope(TransactionScopeOption.Required,
               ...
               // {
                  using ( var dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
                  {
                    ...
                    IEnumerable<TODO_LICToCreate> entities = set.AsNoTracking().ToList();
                           //scope.Complete();
        ...
        public Task<TODO_LICToCreate> GetTODO_LICToCreateByKey(string AsycudaDocumentSetId, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
			   if(string.IsNullOrEmpty(AsycudaDocumentSetId))return Task.FromResult<TODO_LICToCreate>(null); 
              using ( var dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
              {
                var i = Convert.ToInt32(AsycudaDocumentSetId);
				var set = AddIncludes(includesLst, dbContext);
                TODO_LICToCreate entity = set.AsNoTracking().SingleOrDefault(x => x.AsycudaDocumentSetId == i);
		 ...
		 public Task<IEnumerable<TODO_LICToCreate>> GetTODO_LICToCreateByExpression(string exp, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
                using (var dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
                {
					...
					if (string.IsNullOrEmpty(exp) || exp == "None") return Task.FromResult<IEnumerable<TODO_LICToCreate>>(new List<TODO_LICToCreate>());
					var set = AddIncludes(includesLst, dbContext);
                    if (exp == "All")
                    {
                        ...
                        if(tracking) entities.AsParallel(new ParallelLinqOptions() { MaxDegreeOfParallelism = Environment.ProcessorCount }).ForAll(x => x.StartTracking());
                        return Task.FromResult<IEnumerable<TODO_LICToCreate>>(entities); 
                    }
					else
					{
		 ...
		 public Task<IEnumerable<TODO_LICToCreate>> GetTODO_LICToCreateByExpressionLst(List<string> expLst, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
                using (var dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
                {
                    dbContext.Database.CommandTimeout = 0;
					if (expLst.Count == 0 || expLst.FirstOrDefault() == "None") return Task.FromResult<IEnumerable<TODO_LICToCreate>>(new List<TODO_LICToCreate>());
					var set = AddIncludes(includesLst, dbContext);
		...
		public Task<IEnumerable<TODO_LICToCreate>> GetTODO_LICToCreateByExpressionNav(string exp,
            ...
            try
            {
                using (var dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
                {
                    ...
                    if (exp == "All" && navExp.Count == 0)
                    {
                        ...
                        return Task.FromResult<IEnumerable<TODO_LICToCreate>>(aentities); 
                    }
					var set = AddIncludes(includesLst, dbContext);
                    var entities = set.AsNoTracking().Where(exp)
									.ToList();
        ...
        public Task<IEnumerable<TODO_LICToCreate>> GetTODO_LICToCreateByBatch(string exp,
                                                                              int totalrow, List<string> includesLst = null, bool tracking = true)
        {
            try
            {

                var res = new ConcurrentQueue<List<TODO_LICToCreate>>();
                    ...
                    //  for (int bat = 0; bat < batches; bat++)
                    {
                        try
                        {
                            using (var dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
                            {
                                ...
                                var set = AddIncludes(includesLst, dbContext);
                                IQueryable<TODO_LICToCreate> dset;
                                if (exp == "All")
                                {
        ...
        public Task<IEnumerable<TODO_LICToCreate>> GetTODO_LICToCreateByBatchExpressionLst(List<string> expLst,
                                                                                           int totalrow, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
        ...
        public Task<TODO_LICToCreate> UpdateTODO_LICToCreate(TODO_LICToCreate entity)
        { 
            using ( var dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
              {
                try
                {   
                     var res = (TODO_LICToCreate) entity;
        ...
        public Task<TODO_LICToCreate> CreateTODO_LICToCreate(TODO_LICToCreate entity)
        {
            try
            {
                var res = (TODO_LICToCreate) entity;
              using ( var dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
              {
                dbContext.TODO_LICToCreate.Add(res);
                dbContext.SaveChanges();
                res.AcceptChanges();
                return Task.FromResult(res);
              }
        ...
        public Task<bool> DeleteTODO_LICToCreate(string AsycudaDocumentSetId)
        {
            try
            {
              using ( var dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
              {
                var i = Convert.ToInt32(AsycudaDocumentSetId);
                TODO_LICToCreate entity = dbContext.TODO_LICToCreate
													.SingleOrDefault(x => x.AsycudaDocumentSetId == i);
                if (entity == null)
                    return Task.FromResult(false);

                    dbContext.TODO_LICToCreate.Attach(entity);
                    dbContext.TODO_LICToCreate.Remove(entity);
                    dbContext.SaveChanges();
        ...
        public async Task<bool> RemoveSelectedTODO_LICToCreate(IEnumerable<string> lst)
        {
            try
            {
                StatusModel.StartStatusUpdate("Removing TODO_LICToCreate", lst.Count());
                var t = Task.Run(() =>
                {
                    using (var ctx = new TODO_LICToCreateService())
                    {
                        foreach (var item in lst.ToList())
                        {

                            ctx.DeleteTODO_LICToCreate(item).Wait();
         ...
         public Task<int> CountByExpressionLst(List<string> expLst)
        {
            try
            {
                using (var dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
                {
                    ...
                    var set = (IQueryable<TODO_LICToCreate>)dbContext.TODO_LICToCreate; 
                    if (expLst.FirstOrDefault() == "All")
                    {
		...
		public Task<int> Count(string exp)
        {
            try
            {
                using (CoreEntitiesContext dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
                {
                    ...
                    if (exp == "All")
                    {
                        return Task.FromResult(dbContext.TODO_LICToCreate
                            .AsNoTracking()
                            .Count());
                    }
                    else
        ...
        public Task<IEnumerable<TODO_LICToCreate>> LoadRange(int startIndex, int count, string exp)
        {
            try
            {
                using (var dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
                {
                    ...
                    if (exp == "All")
                    {
                        return Task.FromResult<IEnumerable<TODO_LICToCreate>>(dbContext.TODO_LICToCreate
                            .AsNoTracking()
		...
		public Task<int> CountNav(string exp, Dictionary<string, string> navExp)
        {
            try
            {
                ...
                using (var dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
                {
                    ...
                    return Task.FromResult(dbContext.TODO_LICToCreate.Where(exp == "All" || exp == null ? "AsycudaDocumentSetId != null" : exp)
                        .AsNoTracking()
                        .Count());
                }
		...
		private static Task<int> CountWhereSelectMany<T>(CoreEntitiesContext dbContext, string exp, string navExp, string navProp) where T : class
        {
            ...
            return Task.FromResult(dbContext.Set<T>()
                .AsNoTracking()
                .Where(navExp)
                .SelectMany(navProp).OfType<TODO_LICToCreate>()
		...
		private static Task<int> CountWhereSelect<T>(CoreEntitiesContext dbContext, string exp, string navExp, string navProp) where T : class
        {
            ...
            return Task.FromResult(dbContext.Set<T>()
                .AsNoTracking()
                .Where(navExp)
                .Select(navProp).OfType<TODO_LICToCreate>()
                .Where(exp == "All" || exp == null ? "AsycudaDocumentSetId != null" : exp)
                .Distinct()
                .OrderBy("AsycudaDocumentSetId")
                .Count());
		  ...
		  public Task<IEnumerable<TODO_LICToCreate>> LoadRangeNav(int startIndex, int count, string exp,
                                                                  Dictionary<string, string> navExp, IEnumerable<string> includeLst = null)
        {
            try
            {
                ...
                {
                    dbContext.Database.CommandTimeout = 0;
                    if ((string.IsNullOrEmpty(exp) && navExp.Count == 0) || exp == "None") return Task.FromResult<IEnumerable<TODO_LICToCreate>>(new List<TODO_LICToCreate>());
                    var set = AddIncludes(includeLst, dbContext);

                    if (exp == "All" && navExp.Count == 0)
                    {
                       
                        return Task.FromResult<IEnumerable<TODO_LICToCreate>>(set
                            .AsNoTracking()
                            .OrderBy(y => y.AsycudaDocumentSetId)
                    ...
                    return Task.FromResult<IEnumerable<TODO_LICToCreate>>(set//dbContext.TODO_LICToCreate
                        .AsNoTracking()
                        .Where(exp == "All" || exp == null ? "AsycudaDocumentSetId != null" : exp)
                        .OrderBy(y => y.AsycudaDocumentSetId)
		...
		private static async Task<IEnumerable<TODO_LICToCreate>> LoadRangeWhere<T>(int startIndex, int count,
		...
		private static Task<IEnumerable<TODO_LICToCreate>> LoadRangeSelectMany<T>(int startIndex, int count,
		...
		private static Task<IEnumerable<TODO_LICToCreate>> LoadRangeSelect<T>(int startIndex, int count,
                                                                              CoreEntitiesContext dbContext, string exp, string navExp, string navProp, IEnumerable<string> includeLst = null) where T : class
        {
			try
			{
        ...
        private static async Task<IEnumerable<TODO_LICToCreate>> GetWhere<T>(CoreEntitiesContext dbContext,
		...
		private static Task<IEnumerable<TODO_LICToCreate>> GetWhereSelectMany<T>(CoreEntitiesContext dbContext,
                                                                                 string exp, string navExp, string navProp, List<string> includesLst = null) where T : class
        {
			...
			if (includesLst == null)
			{
				return Task.FromResult<IEnumerable<TODO_LICToCreate>>(dbContext.Set<T>()
                    .AsNoTracking()
                    .Where(navExp)
                    .SelectMany(navProp).OfType<TODO_LICToCreate>()
                    .Where(exp == "All" || exp == null?"AsycudaDocumentSetId != null":exp)
			...
			var set = (DbQuery<TODO_LICToCreate>)dbContext.Set<T>()
				.AsNoTracking()
                .Where(navExp)
                .SelectMany(navProp).OfType<TODO_LICToCreate>()
                .Where(exp == "All" || exp == null?"AsycudaDocumentSetId != null":exp)
            ...
            return Task.FromResult<IEnumerable<TODO_LICToCreate>>(set.ToList());
			}
			catch (Exception)
			{
				Debugger.Break();
		...
		private static Task<IEnumerable<TODO_LICToCreate>> GetWhereSelect<T>(CoreEntitiesContext dbContext,
                                                                             string exp, string navExp, string navProp, List<string> includesLst = null) where T : class
        {
			try
			{
             ...
             try
             {
                 using (var dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
                 {
					...
					decimal res = 0;
                     ...
                     if (whereExp == "All")
                     {
                          res = Convert.ToDecimal(dbContext.TODO_LICToCreate.AsNoTracking().Sum(field));
                     }
                     else
                     {
                         res = Convert.ToDecimal(dbContext.TODO_LICToCreate.AsNoTracking().Where(whereExp).Sum(field));
                     }
        ...
        public Task<decimal> SumNav( string exp, Dictionary<string, string> navExp, string field)
        {
            try
            {
                ...
                {
                    dbContext.Database.CommandTimeout = 0;
                    if (!dbContext.TODO_LICToCreate.Any()) return Task.FromResult<decimal>(0);
                    if (exp == "All" && navExp.Count == 0)
                    {
                        return Task.FromResult(Convert.ToDecimal(dbContext.TODO_LICToCreate
                                                                     .AsNoTracking()
                                                                     .Sum(field)??0));
                    }
                    return Task.FromResult(Convert.ToDecimal(dbContext.TODO_LICToCreate.Where(exp == "All" || exp == null ? "AsycudaDocumentSetId != null" : exp)
                                                                 .AsNoTracking()
                                                                 .Sum(field)??0));
                }
             ...
             try
             {
                 using (var dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
                 {
					...
					string res = "";
                     ...
                     if (whereExp == "All")
                     {
                          res = Convert.ToString(dbContext.TODO_LICToCreate.AsNoTracking().Min(field));
                     }
                     else
                     {
                         res = Convert.ToString(dbContext.TODO_LICToCreate.AsNoTracking().Where(whereExp).Min(field));
                     }
		...
		private static IQueryable<TODO_LICToCreate> AddIncludes(IEnumerable<string> includesLst, CoreEntitiesContext dbContext)
       {
		 try
			{
			   if (includesLst == null) includesLst = new List<string>();
			   var set =(DbQuery<TODO_LICToCreate>) dbContext.TODO_LICToCreate; 
	   ...
	   private IQueryable<TODO_LICToCreate> AddWheres(List<string> expLst, IQueryable<TODO_LICToCreate> set)
        {
            try
            {
