...
namespace CoreEntities.Business.Services
{
   ...
   [ServiceBehavior(InstanceContextMode = InstanceContextMode.PerCall,
    ...
    public partial class TODO_PODocSetService : ITODO_PODocSetService, IDisposable
    {
        ...
        public Task<IEnumerable<TODO_PODocSet>> GetTODO_PODocSet(List<string> includesLst = null, bool tracking = true)
        {
            try
            {
        ...
        public Task<TODO_PODocSet> GetTODO_PODocSetByKey(string AsycudaDocumentSetId, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
			   if(string.IsNullOrEmpty(AsycudaDocumentSetId))return Task.FromResult<TODO_PODocSet>(null); 
              using ( var dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
              {
		 ...
		 public Task<IEnumerable<TODO_PODocSet>> GetTODO_PODocSetByExpression(string exp, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
                using (var dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
                {
					...
					if (string.IsNullOrEmpty(exp) || exp == "None") return Task.FromResult<IEnumerable<TODO_PODocSet>>(new List<TODO_PODocSet>());
					var set = AddIncludes(includesLst, dbContext);
                    if (exp == "All")
                    {
                        ...
                        if(tracking) entities.AsParallel(new ParallelLinqOptions() { MaxDegreeOfParallelism = Environment.ProcessorCount }).ForAll(x => x.StartTracking());
                        return Task.FromResult<IEnumerable<TODO_PODocSet>>(entities); 
                    }
					else
					{
		 ...
		 public Task<IEnumerable<TODO_PODocSet>> GetTODO_PODocSetByExpressionLst(List<string> expLst, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
                using (var dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
                {
                    dbContext.Database.CommandTimeout = 0;
					if (expLst.Count == 0 || expLst.FirstOrDefault() == "None") return Task.FromResult<IEnumerable<TODO_PODocSet>>(new List<TODO_PODocSet>());
					var set = AddIncludes(includesLst, dbContext);
		...
		public Task<IEnumerable<TODO_PODocSet>> GetTODO_PODocSetByExpressionNav(string exp,
            ...
            try
            {
                using (var dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
                {
                    ...
                    if (exp == "All" && navExp.Count == 0)
                    {
                        ...
                        return Task.FromResult<IEnumerable<TODO_PODocSet>>(aentities); 
                    }
					var set = AddIncludes(includesLst, dbContext);
                    var entities = set.AsNoTracking().Where(exp)
									.ToList();
        ...
        public Task<IEnumerable<TODO_PODocSet>> GetTODO_PODocSetByBatch(string exp,
        ...
        public Task<IEnumerable<TODO_PODocSet>> GetTODO_PODocSetByBatchExpressionLst(List<string> expLst,
                                                                                     int totalrow, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
        ...
        public Task<TODO_PODocSet> UpdateTODO_PODocSet(TODO_PODocSet entity)
        { 
            using ( var dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
              {
                try
        ...
        public Task<TODO_PODocSet> CreateTODO_PODocSet(TODO_PODocSet entity)
        {
            try
            {
                var res = (TODO_PODocSet) entity;
        ...
        public Task<bool> DeleteTODO_PODocSet(string AsycudaDocumentSetId)
        {
            try
            {
              using ( var dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
		...
		public Task<int> Count(string exp)
        {
            try
            {
                using (CoreEntitiesContext dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
                {
                    ...
                    if (exp == "All")
                    {
                        return Task.FromResult(dbContext.TODO_PODocSet
                            .AsNoTracking()
                            .Count());
                    }
                    else
        ...
        public Task<IEnumerable<TODO_PODocSet>> LoadRange(int startIndex, int count, string exp)
        {
            try
            {
                using (var dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
                {
                    ...
                    if (exp == "All")
                    {
                        return Task.FromResult<IEnumerable<TODO_PODocSet>>(dbContext.TODO_PODocSet
                            .AsNoTracking()
		...
		public Task<int> CountNav(string exp, Dictionary<string, string> navExp)
        {
            try
            {
                ...
                using (var dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
                {
                    ...
                    return Task.FromResult(dbContext.TODO_PODocSet.Where(exp == "All" || exp == null ? "AsycudaDocumentSetId != null" : exp)
                        .AsNoTracking()
                        .Count());
                }
		...
		private static Task<int> CountWhereSelect<T>(CoreEntitiesContext dbContext, string exp, string navExp, string navProp) where T : class
        {
		  ...
		  public Task<IEnumerable<TODO_PODocSet>> LoadRangeNav(int startIndex, int count, string exp,
                                                               Dictionary<string, string> navExp, IEnumerable<string> includeLst = null)
        {
            try
            {
                ...
                {
                    dbContext.Database.CommandTimeout = 0;
                    if ((string.IsNullOrEmpty(exp) && navExp.Count == 0) || exp == "None") return Task.FromResult<IEnumerable<TODO_PODocSet>>(new List<TODO_PODocSet>());
                    var set = AddIncludes(includeLst, dbContext);

                    if (exp == "All" && navExp.Count == 0)
                    {
                       
                        return Task.FromResult<IEnumerable<TODO_PODocSet>>(set
                            .AsNoTracking()
                            .OrderBy(y => y.AsycudaDocumentSetId)
                    ...
                    return Task.FromResult<IEnumerable<TODO_PODocSet>>(set//dbContext.TODO_PODocSet
                        .AsNoTracking()
                        .Where(exp == "All" || exp == null ? "AsycudaDocumentSetId != null" : exp)
                        .OrderBy(y => y.AsycudaDocumentSetId)
		...
		private static Task<IEnumerable<TODO_PODocSet>> LoadRangeSelectMany<T>(int startIndex, int count,
		...
		private static Task<IEnumerable<TODO_PODocSet>> LoadRangeSelect<T>(int startIndex, int count,
                                                                           CoreEntitiesContext dbContext, string exp, string navExp, string navProp, IEnumerable<string> includeLst = null) where T : class
        {
			try
			{
		...
		private static Task<IEnumerable<TODO_PODocSet>> GetWhereSelectMany<T>(CoreEntitiesContext dbContext,
                                                                              string exp, string navExp, string navProp, List<string> includesLst = null) where T : class
        {
			...
			if (includesLst == null)
			{
				return Task.FromResult<IEnumerable<TODO_PODocSet>>(dbContext.Set<T>()
                    .AsNoTracking()
                    .Where(navExp)
                    .SelectMany(navProp).OfType<TODO_PODocSet>()
                    .Where(exp == "All" || exp == null?"AsycudaDocumentSetId != null":exp)
            ...
            return Task.FromResult<IEnumerable<TODO_PODocSet>>(set.ToList());
			}
			catch (Exception)
			{
				Debugger.Break();
		...
		private static Task<IEnumerable<TODO_PODocSet>> GetWhereSelect<T>(CoreEntitiesContext dbContext,
                                                                          string exp, string navExp, string navProp, List<string> includesLst = null) where T : class
        {
			try
			{
        ...
        public Task<decimal> SumNav( string exp, Dictionary<string, string> navExp, string field)
        {
            try
            {
                ...
                {
                    dbContext.Database.CommandTimeout = 0;
                    if (!dbContext.TODO_PODocSet.Any()) return Task.FromResult<decimal>(0);
                    if (exp == "All" && navExp.Count == 0)
                    {
                        return Task.FromResult(Convert.ToDecimal(dbContext.TODO_PODocSet
                                                                     .AsNoTracking()
                                                                     .Sum(field)??0));
                    }
                    return Task.FromResult(Convert.ToDecimal(dbContext.TODO_PODocSet.Where(exp == "All" || exp == null ? "AsycudaDocumentSetId != null" : exp)
                                                                 .AsNoTracking()
                                                                 .Sum(field)??0));
                }
