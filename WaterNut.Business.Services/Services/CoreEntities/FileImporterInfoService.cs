...
namespace CoreEntities.Business.Services
{
   ...
   [ServiceBehavior(InstanceContextMode = InstanceContextMode.PerCall,
    ...
    public partial class FileImporterInfoService : IFileImporterInfoService, IDisposable
    {
        //private readonly CoreEntitiesContext dbContext;

        public bool StartTracking { get; set; }

        public FileImporterInfoService()
        {
            try
            {
        ...
        public Task<IEnumerable<FileImporterInfo>> GetFileImporterInfos(List<string> includesLst = null, bool tracking = true)
        {
            try
            {
            //using (var scope = new TransactionScope(TransactionScopeOption.Required,
               ...
               // {
                  using ( var dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
                  {
                    ...
                    IEnumerable<FileImporterInfo> entities = set.AsNoTracking().ToList();
                           //scope.Complete();
        ...
        public Task<FileImporterInfo> GetFileImporterInfoByKey(string Id, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
			   if(string.IsNullOrEmpty(Id))return Task.FromResult<FileImporterInfo>(null); 
              using ( var dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
              {
                var i = Convert.ToInt32(Id);
				var set = AddIncludes(includesLst, dbContext);
                FileImporterInfo entity = set.AsNoTracking().SingleOrDefault(x => x.Id == i);
		 ...
		 public Task<IEnumerable<FileImporterInfo>> GetFileImporterInfosByExpression(string exp, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
                using (var dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
                {
					...
					if (string.IsNullOrEmpty(exp) || exp == "None") return Task.FromResult<IEnumerable<FileImporterInfo>>(new List<FileImporterInfo>());
					var set = AddIncludes(includesLst, dbContext);
                    if (exp == "All")
                    {
                        ...
                        if(tracking) entities.AsParallel(new ParallelLinqOptions() { MaxDegreeOfParallelism = Environment.ProcessorCount }).ForAll(x => x.StartTracking());
                        return Task.FromResult<IEnumerable<FileImporterInfo>>(entities); 
                    }
					else
					{
		 ...
		 public Task<IEnumerable<FileImporterInfo>> GetFileImporterInfosByExpressionLst(List<string> expLst, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
                using (var dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
                {
                    dbContext.Database.CommandTimeout = 0;
					if (expLst.Count == 0 || expLst.FirstOrDefault() == "None") return Task.FromResult<IEnumerable<FileImporterInfo>>(new List<FileImporterInfo>());
					var set = AddIncludes(includesLst, dbContext);
																							  ...
																							  List<string> includesLst = null, bool tracking = true)
        {
            try
            {
                ...
                {
                    dbContext.Database.CommandTimeout = 0;
                    if (string.IsNullOrEmpty(exp) || exp == "None") return new List<FileImporterInfo>();
                    ...
                    foreach (var itm in navExp)
                    {
                        switch (itm.Key)
                        {
                            case "FileTypes":
                                return
                                    await
                                        GetWhere<FileTypes>(dbContext, exp, itm.Value, "FileImporterInfos", "Select", includesLst)
        ...
        public Task<IEnumerable<FileImporterInfo>> GetFileImporterInfosByBatch(string exp,
                                                                               int totalrow, List<string> includesLst = null, bool tracking = true)
        {
            try
            {

                var res = new ConcurrentQueue<List<FileImporterInfo>>();
                    ...
                    //  for (int bat = 0; bat < batches; bat++)
                    {
                        try
                        {
                            using (var dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
                            {
                                ...
                                var set = AddIncludes(includesLst, dbContext);
                                IQueryable<FileImporterInfo> dset;
                                if (exp == "All")
                                {
        ...
        public Task<IEnumerable<FileImporterInfo>> GetFileImporterInfosByBatchExpressionLst(List<string> expLst,
                                                                                            int totalrow, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
        ...
        public Task<FileImporterInfo> UpdateFileImporterInfo(FileImporterInfo entity)
        { 
            using ( var dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
              {
                try
                {   
                     var res = (FileImporterInfo) entity;
        ...
        public Task<FileImporterInfo> CreateFileImporterInfo(FileImporterInfo entity)
        {
            try
            {
                var res = (FileImporterInfo) entity;
              using ( var dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
              {
                dbContext.FileImporterInfos.Add(res);
                dbContext.SaveChanges();
                res.AcceptChanges();
                return Task.FromResult(res);
              }
        ...
        public Task<bool> DeleteFileImporterInfo(string Id)
        {
            try
            {
              using ( var dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
              {
                var i = Convert.ToInt32(Id);
                FileImporterInfo entity = dbContext.FileImporterInfos
													.SingleOrDefault(x => x.Id == i);
                if (entity == null)
                    return Task.FromResult(false);

                    dbContext.FileImporterInfos.Attach(entity);
                    dbContext.FileImporterInfos.Remove(entity);
                    dbContext.SaveChanges();
        ...
        public async Task<bool> RemoveSelectedFileImporterInfo(IEnumerable<string> lst)
        {
            try
            {
                StatusModel.StartStatusUpdate("Removing FileImporterInfo", lst.Count());
                var t = Task.Run(() =>
                {
                    using (var ctx = new FileImporterInfoService())
                    {
                        foreach (var item in lst.ToList())
                        {

                            ctx.DeleteFileImporterInfo(item).Wait();
         ...
         public Task<int> CountByExpressionLst(List<string> expLst)
        {
            try
            {
                using (var dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
                {
                    ...
                    var set = (IQueryable<FileImporterInfo>)dbContext.FileImporterInfos; 
                    if (expLst.FirstOrDefault() == "All")
                    {
		...
		public Task<int> Count(string exp)
        {
            try
            {
                using (CoreEntitiesContext dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
                {
                    ...
                    if (exp == "All")
                    {
                        return Task.FromResult(dbContext.FileImporterInfos
                            .AsNoTracking()
                            .Count());
                    }
                    else
        ...
        public Task<IEnumerable<FileImporterInfo>> LoadRange(int startIndex, int count, string exp)
        {
            try
            {
                using (var dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
                {
                    ...
                    if (exp == "All")
                    {
                        return Task.FromResult<IEnumerable<FileImporterInfo>>(dbContext.FileImporterInfos
                            .AsNoTracking()
                            .OrderBy(y => y.Id)
                            .Skip(startIndex)
                            .Take(count)
		...
		public async Task<int> CountNav(string exp, Dictionary<string, string> navExp)
        {
            try
            {
                ...
                using (var dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
                {
                    ...
                    if (exp == "All" && navExp.Count == 0)
                    {
                        return dbContext.FileImporterInfos
										.AsNoTracking()
                                        .Count();
                    }
                    foreach (var itm in navExp)
                    {
                        ...
                        {
                            case "FileTypes":
                                return await CountWhere<FileTypes>(dbContext, exp, itm.Value, "FileImporterInfos", "Select")
											.ConfigureAwait(continueOnCapturedContext: false);
						}
                    }
                    return dbContext.FileImporterInfos.Where(exp == "All" || exp == null ? "Id != null" : exp)
											.AsNoTracking()
                                            .Count();
                }
		...
		private static Task<int> CountWhereSelectMany<T>(CoreEntitiesContext dbContext, string exp, string navExp, string navProp) where T : class
        {
            ...
            return Task.FromResult(dbContext.Set<T>()
                .AsNoTracking()
                .Where(navExp)
                .SelectMany(navProp).OfType<FileImporterInfo>()
		...
		private static Task<int> CountWhereSelect<T>(CoreEntitiesContext dbContext, string exp, string navExp, string navProp) where T : class
        {
            ...
            return Task.FromResult(dbContext.Set<T>()
                .AsNoTracking()
                .Where(navExp)
                .Select(navProp).OfType<FileImporterInfo>()
                .Where(exp == "All" || exp == null ? "Id != null" : exp)
                .Distinct()
                .OrderBy("Id")
                .Count());
                                                                                 ...
                                                                                 Dictionary<string, string> navExp, IEnumerable<string> includeLst = null)
        {
            try
            {
                ...
                {
                    dbContext.Database.CommandTimeout = 0;
                    if ((string.IsNullOrEmpty(exp) && navExp.Count == 0) || exp == "None") return new List<FileImporterInfo>();
                    ...
                    foreach (var itm in navExp)
                    {
                        switch (itm.Key)
                        {
                            case "FileTypes":
                                return
                                    await
                                        LoadRangeWhere<FileTypes>(startIndex, count, dbContext, exp, itm.Value, "FileImporterInfos", "Select")
													.ConfigureAwait(continueOnCapturedContext: false);
                    ...
                    return set//dbContext.FileImporterInfos
								.AsNoTracking()
                                .Where(exp == "All" || exp == null ? "Id != null" : exp)
								.OrderBy(y => y.Id)
		...
		private static async Task<IEnumerable<FileImporterInfo>> LoadRangeWhere<T>(int startIndex, int count,
		...
		private static Task<IEnumerable<FileImporterInfo>> LoadRangeSelectMany<T>(int startIndex, int count,
                                                                                  CoreEntitiesContext dbContext, string exp, string navExp, string navProp, IEnumerable<string> includeLst = null) where T : class
        {
            ...
            return Task.FromResult<IEnumerable<FileImporterInfo>>(set
                .Where(exp == "All" || exp == null ? "Id != null" : exp)
                .Distinct()
                .OrderBy(y => y.Id)
		...
		private static Task<IEnumerable<FileImporterInfo>> LoadRangeSelect<T>(int startIndex, int count,
                                                                              CoreEntitiesContext dbContext, string exp, string navExp, string navProp, IEnumerable<string> includeLst = null) where T : class
        {
			try
			{
        ...
        private static async Task<IEnumerable<FileImporterInfo>> GetWhere<T>(CoreEntitiesContext dbContext,
		...
		private static Task<IEnumerable<FileImporterInfo>> GetWhereSelectMany<T>(CoreEntitiesContext dbContext,
                                                                                 string exp, string navExp, string navProp, List<string> includesLst = null) where T : class
        {
			...
			if (includesLst == null)
			{
				return Task.FromResult<IEnumerable<FileImporterInfo>>(dbContext.Set<T>()
                    .AsNoTracking()
                    .Where(navExp)
                    .SelectMany(navProp).OfType<FileImporterInfo>()
                    .Where(exp == "All" || exp == null?"Id != null":exp)
			...
			var set = (DbQuery<FileImporterInfo>)dbContext.Set<T>()
				.AsNoTracking()
                .Where(navExp)
                .SelectMany(navProp).OfType<FileImporterInfo>()
                .Where(exp == "All" || exp == null?"Id != null":exp)
            ...
            return Task.FromResult<IEnumerable<FileImporterInfo>>(set.ToList());
			}
			catch (Exception)
			{
				Debugger.Break();
		...
		private static Task<IEnumerable<FileImporterInfo>> GetWhereSelect<T>(CoreEntitiesContext dbContext,
                                                                             string exp, string navExp, string navProp, List<string> includesLst = null) where T : class
        {
			try
			{
             ...
             try
             {
                 using (var dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
                 {
					...
					decimal res = 0;
                     ...
                     if (whereExp == "All")
                     {
                          res = Convert.ToDecimal(dbContext.FileImporterInfos.AsNoTracking().Sum(field));
                     }
                     else
                     {
                         res = Convert.ToDecimal(dbContext.FileImporterInfos.AsNoTracking().Where(whereExp).Sum(field));
                     }
        ...
        public async Task<decimal> SumNav( string exp, Dictionary<string, string> navExp, string field)
        {
            try
            {
                ...
                {
                    dbContext.Database.CommandTimeout = 0;
                    if (!dbContext.FileImporterInfos.Any()) return 0;
                    if (exp == "All" && navExp.Count == 0)
                    {
                        return Convert.ToDecimal(dbContext.FileImporterInfos
										.AsNoTracking()
                                        .Sum(field)??0);
                    }
                    foreach (var itm in navExp)
                    {
                        ...
                        {
                            case "FileTypes":
                                return await SumWhere<FileTypes>(dbContext, exp, itm.Value, "FileImporterInfos", field, "Select")
											.ConfigureAwait(continueOnCapturedContext: false);
						}
                    }
                    return Convert.ToDecimal(dbContext.FileImporterInfos.Where(exp == "All" || exp == null ? "Id != null" : exp)
											.AsNoTracking()
                                            .Sum(field)??0);
                }
             ...
             try
             {
                 using (var dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
                 {
					...
					string res = "";
                     ...
                     if (whereExp == "All")
                     {
                          res = Convert.ToString(dbContext.FileImporterInfos.AsNoTracking().Min(field));
                     }
                     else
                     {
                         res = Convert.ToString(dbContext.FileImporterInfos.AsNoTracking().Where(whereExp).Min(field));
                     }
		...
		private static IQueryable<FileImporterInfo> AddIncludes(IEnumerable<string> includesLst, CoreEntitiesContext dbContext)
       {
		 try
			{
			   if (includesLst == null) includesLst = new List<string>();
			   var set =(DbQuery<FileImporterInfo>) dbContext.FileImporterInfos; 
	   ...
	   private IQueryable<FileImporterInfo> AddWheres(List<string> expLst, IQueryable<FileImporterInfo> set)
        {
            try
            {
