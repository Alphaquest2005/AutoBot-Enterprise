...
namespace CoreEntities.Business.Services
{
   ...
   [ServiceBehavior(InstanceContextMode = InstanceContextMode.PerCall,
    ...
    public partial class TODO_SubmitPOInfoService : ITODO_SubmitPOInfoService, IDisposable
    {
        //private readonly CoreEntitiesContext dbContext;

        public bool StartTracking { get; set; }

        public TODO_SubmitPOInfoService()
        {
            try
            {
        ...
        public Task<IEnumerable<TODO_SubmitPOInfo>> GetTODO_SubmitPOInfo(List<string> includesLst = null, bool tracking = true)
        {
            try
            {
            //using (var scope = new TransactionScope(TransactionScopeOption.Required,
               ...
               // {
                  using ( var dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
                  {
                    ...
                    IEnumerable<TODO_SubmitPOInfo> entities = set.AsNoTracking().ToList();
                           //scope.Complete();
        ...
        public Task<TODO_SubmitPOInfo> GetTODO_SubmitPOInfoByKey(string Id, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
			   if(string.IsNullOrEmpty(Id))return Task.FromResult<TODO_SubmitPOInfo>(null); 
              using ( var dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
              {
                var i = Convert.ToInt32(Id);
				var set = AddIncludes(includesLst, dbContext);
                TODO_SubmitPOInfo entity = set.AsNoTracking().SingleOrDefault(x => x.Id == i);
		 ...
		 public Task<IEnumerable<TODO_SubmitPOInfo>> GetTODO_SubmitPOInfoByExpression(string exp, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
                using (var dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
                {
					...
					if (string.IsNullOrEmpty(exp) || exp == "None") return Task.FromResult<IEnumerable<TODO_SubmitPOInfo>>(new List<TODO_SubmitPOInfo>());
					var set = AddIncludes(includesLst, dbContext);
                    if (exp == "All")
                    {
                        ...
                        if(tracking) entities.AsParallel(new ParallelLinqOptions() { MaxDegreeOfParallelism = Environment.ProcessorCount }).ForAll(x => x.StartTracking());
                        return Task.FromResult<IEnumerable<TODO_SubmitPOInfo>>(entities); 
                    }
					else
					{
		 ...
		 public Task<IEnumerable<TODO_SubmitPOInfo>> GetTODO_SubmitPOInfoByExpressionLst(List<string> expLst, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
                using (var dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
                {
                    dbContext.Database.CommandTimeout = 0;
					if (expLst.Count == 0 || expLst.FirstOrDefault() == "None") return Task.FromResult<IEnumerable<TODO_SubmitPOInfo>>(new List<TODO_SubmitPOInfo>());
					var set = AddIncludes(includesLst, dbContext);
		...
		public Task<IEnumerable<TODO_SubmitPOInfo>> GetTODO_SubmitPOInfoByExpressionNav(string exp,
            ...
            try
            {
                using (var dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
                {
                    ...
                    if (exp == "All" && navExp.Count == 0)
                    {
                        ...
                        return Task.FromResult<IEnumerable<TODO_SubmitPOInfo>>(aentities); 
                    }
					var set = AddIncludes(includesLst, dbContext);
                    var entities = set.AsNoTracking().Where(exp)
									.ToList();
        ...
        public Task<IEnumerable<TODO_SubmitPOInfo>> GetTODO_SubmitPOInfoByBatch(string exp,
                                                                                int totalrow, List<string> includesLst = null, bool tracking = true)
        {
            try
            {

                var res = new ConcurrentQueue<List<TODO_SubmitPOInfo>>();
        ...
        public Task<IEnumerable<TODO_SubmitPOInfo>> GetTODO_SubmitPOInfoByBatchExpressionLst(List<string> expLst,
                                                                                             int totalrow, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
        ...
        public Task<TODO_SubmitPOInfo> UpdateTODO_SubmitPOInfo(TODO_SubmitPOInfo entity)
        { 
            using ( var dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
              {
                try
                {   
                     var res = (TODO_SubmitPOInfo) entity;
        ...
        public Task<TODO_SubmitPOInfo> CreateTODO_SubmitPOInfo(TODO_SubmitPOInfo entity)
        {
            try
            {
                var res = (TODO_SubmitPOInfo) entity;
              using ( var dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
              {
                dbContext.TODO_SubmitPOInfo.Add(res);
                dbContext.SaveChanges();
                res.AcceptChanges();
                return Task.FromResult(res);
              }
        ...
        public Task<bool> DeleteTODO_SubmitPOInfo(string Id)
        {
            try
            {
              using ( var dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
              {
                var i = Convert.ToInt32(Id);
                TODO_SubmitPOInfo entity = dbContext.TODO_SubmitPOInfo
													.SingleOrDefault(x => x.Id == i);
                if (entity == null)
                    return Task.FromResult(false);

                    dbContext.TODO_SubmitPOInfo.Attach(entity);
                    dbContext.TODO_SubmitPOInfo.Remove(entity);
                    dbContext.SaveChanges();
        ...
        public async Task<bool> RemoveSelectedTODO_SubmitPOInfo(IEnumerable<string> lst)
        {
            try
            {
                StatusModel.StartStatusUpdate("Removing TODO_SubmitPOInfo", lst.Count());
                var t = Task.Run(() =>
                {
                    using (var ctx = new TODO_SubmitPOInfoService())
                    {
                        foreach (var item in lst.ToList())
                        {

                            ctx.DeleteTODO_SubmitPOInfo(item).Wait();
		...
		public Task<int> Count(string exp)
        {
            try
            {
                using (CoreEntitiesContext dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
                {
                    ...
                    if (exp == "All")
                    {
                        return Task.FromResult(dbContext.TODO_SubmitPOInfo
                            .AsNoTracking()
                            .Count());
                    }
                    else
        ...
        public Task<IEnumerable<TODO_SubmitPOInfo>> LoadRange(int startIndex, int count, string exp)
        {
            try
            {
                using (var dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
                {
                    ...
                    if (exp == "All")
                    {
                        return Task.FromResult<IEnumerable<TODO_SubmitPOInfo>>(dbContext.TODO_SubmitPOInfo
                            .AsNoTracking()
                            .OrderBy(y => y.Id)
                            .Skip(startIndex)
                            .Take(count)
		...
		public Task<int> CountNav(string exp, Dictionary<string, string> navExp)
        {
            try
            {
                ...
                using (var dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
                {
                    ...
                    return Task.FromResult(dbContext.TODO_SubmitPOInfo.Where(exp == "All" || exp == null ? "Id != null" : exp)
                        .AsNoTracking()
                        .Count());
                }
		...
		private static Task<int> CountWhereSelect<T>(CoreEntitiesContext dbContext, string exp, string navExp, string navProp) where T : class
        {
		  ...
		  public Task<IEnumerable<TODO_SubmitPOInfo>> LoadRangeNav(int startIndex, int count, string exp,
                                                                   Dictionary<string, string> navExp, IEnumerable<string> includeLst = null)
        {
            try
            {
                ...
                {
                    dbContext.Database.CommandTimeout = 0;
                    if ((string.IsNullOrEmpty(exp) && navExp.Count == 0) || exp == "None") return Task.FromResult<IEnumerable<TODO_SubmitPOInfo>>(new List<TODO_SubmitPOInfo>());
                    var set = AddIncludes(includeLst, dbContext);

                    if (exp == "All" && navExp.Count == 0)
                    {
                       
                        return Task.FromResult<IEnumerable<TODO_SubmitPOInfo>>(set
                            .AsNoTracking()
                            .OrderBy(y => y.Id)
                    ...
                    return Task.FromResult<IEnumerable<TODO_SubmitPOInfo>>(set//dbContext.TODO_SubmitPOInfo
                        .AsNoTracking()
                        .Where(exp == "All" || exp == null ? "Id != null" : exp)
                        .OrderBy(y => y.Id)
		...
		private static async Task<IEnumerable<TODO_SubmitPOInfo>> LoadRangeWhere<T>(int startIndex, int count,
		...
		private static Task<IEnumerable<TODO_SubmitPOInfo>> LoadRangeSelectMany<T>(int startIndex, int count,
		...
		private static Task<IEnumerable<TODO_SubmitPOInfo>> LoadRangeSelect<T>(int startIndex, int count,
                                                                               CoreEntitiesContext dbContext, string exp, string navExp, string navProp, IEnumerable<string> includeLst = null) where T : class
        {
			try
			{
        ...
        private static async Task<IEnumerable<TODO_SubmitPOInfo>> GetWhere<T>(CoreEntitiesContext dbContext,
		...
		private static Task<IEnumerable<TODO_SubmitPOInfo>> GetWhereSelectMany<T>(CoreEntitiesContext dbContext,
                                                                                  string exp, string navExp, string navProp, List<string> includesLst = null) where T : class
        {
			...
			if (includesLst == null)
			{
				return Task.FromResult<IEnumerable<TODO_SubmitPOInfo>>(dbContext.Set<T>()
                    .AsNoTracking()
                    .Where(navExp)
                    .SelectMany(navProp).OfType<TODO_SubmitPOInfo>()
                    .Where(exp == "All" || exp == null?"Id != null":exp)
			...
			var set = (DbQuery<TODO_SubmitPOInfo>)dbContext.Set<T>()
				.AsNoTracking()
                .Where(navExp)
                .SelectMany(navProp).OfType<TODO_SubmitPOInfo>()
                .Where(exp == "All" || exp == null?"Id != null":exp)
            ...
            return Task.FromResult<IEnumerable<TODO_SubmitPOInfo>>(set.ToList());
			}
			catch (Exception)
			{
				Debugger.Break();
		...
		private static Task<IEnumerable<TODO_SubmitPOInfo>> GetWhereSelect<T>(CoreEntitiesContext dbContext,
                                                                              string exp, string navExp, string navProp, List<string> includesLst = null) where T : class
        {
			try
			{
			...
			catch (Exception)
			{
				...
				throw;
			        ...
			        public Task<IEnumerable<TODO_SubmitPOInfo>> GetTODO_SubmitPOInfoByApplicationSettingsId(string ApplicationSettingsId, List<string> includesLst = null)
        {
            try
            {
                using ( var dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
              {
                ...
                var set = AddIncludes(includesLst, dbContext);
                IEnumerable<TODO_SubmitPOInfo> entities = set//dbContext.TODO_SubmitPOInfo
                                      .AsNoTracking()
            ...
            catch (Exception updateEx)
            {
 	        ...
 	        public Task<IEnumerable<TODO_SubmitPOInfo>> GetTODO_SubmitPOInfoByEmailId(string EmailId, List<string> includesLst = null)
        {
            try
            {
                using ( var dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
            ...
            catch (Exception updateEx)
            {
 	        ...
 	        public Task<IEnumerable<TODO_SubmitPOInfo>> GetTODO_SubmitPOInfoByFileTypeId(string FileTypeId, List<string> includesLst = null)
        {
            try
            {
                using ( var dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
            ...
            catch (Exception updateEx)
            {
 	        ...
 	        public Task<IEnumerable<TODO_SubmitPOInfo>> GetTODO_SubmitPOInfoByASYCUDA_Id(string ASYCUDA_Id, List<string> includesLst = null)
        {
            try
            {
                using ( var dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
            ...
            catch (Exception updateEx)
            {
 	        ...
 	        public Task<IEnumerable<TODO_SubmitPOInfo>> GetTODO_SubmitPOInfoByAsycudaDocumentSetId(string AsycudaDocumentSetId, List<string> includesLst = null)
        {
            try
            {
                using ( var dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
            ...
            catch (Exception updateEx)
            {
 	        ...
 	        public Task<IEnumerable<TODO_SubmitPOInfo>> GetTODO_SubmitPOInfoByEntryData_Id(string EntryData_Id, List<string> includesLst = null)
        {
            try
            {
                using ( var dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
             ...
             try
             {
                 using (var dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
                 {
					...
					decimal res = 0;
                     ...
                     if (whereExp == "All")
                     {
                          res = Convert.ToDecimal(dbContext.TODO_SubmitPOInfo.AsNoTracking().Sum(field));
                     }
                     else
                     {
                         res = Convert.ToDecimal(dbContext.TODO_SubmitPOInfo.AsNoTracking().Where(whereExp).Sum(field));
                     }
        ...
        public Task<decimal> SumNav( string exp, Dictionary<string, string> navExp, string field)
        {
            try
            {
                ...
                {
                    dbContext.Database.CommandTimeout = 0;
                    if (!dbContext.TODO_SubmitPOInfo.Any()) return Task.FromResult<decimal>(0);
                    if (exp == "All" && navExp.Count == 0)
                    {
                        return Task.FromResult(Convert.ToDecimal(dbContext.TODO_SubmitPOInfo
                                                                     .AsNoTracking()
                                                                     .Sum(field)??0));
                    }
                    return Task.FromResult(Convert.ToDecimal(dbContext.TODO_SubmitPOInfo.Where(exp == "All" || exp == null ? "Id != null" : exp)
                                                                 .AsNoTracking()
                                                                 .Sum(field)??0));
                }
             ...
             try
             {
                 using (var dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
                 {
					...
					string res = "";
                     ...
                     if (whereExp == "All")
                     {
                          res = Convert.ToString(dbContext.TODO_SubmitPOInfo.AsNoTracking().Min(field));
                     }
                     else
                     {
                         res = Convert.ToString(dbContext.TODO_SubmitPOInfo.AsNoTracking().Where(whereExp).Min(field));
                     }
		...
		private static IQueryable<TODO_SubmitPOInfo> AddIncludes(IEnumerable<string> includesLst, CoreEntitiesContext dbContext)
       {
		 try
			{
			   if (includesLst == null) includesLst = new List<string>();
			   var set =(DbQuery<TODO_SubmitPOInfo>) dbContext.TODO_SubmitPOInfo; 
	   ...
	   private IQueryable<TODO_SubmitPOInfo> AddWheres(List<string> expLst, IQueryable<TODO_SubmitPOInfo> set)
        {
            try
            {
