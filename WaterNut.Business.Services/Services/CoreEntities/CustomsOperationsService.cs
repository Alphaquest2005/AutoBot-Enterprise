...
namespace CoreEntities.Business.Services
{
   ...
   [ServiceBehavior(InstanceContextMode = InstanceContextMode.PerCall,
    ...
    public partial class CustomsOperationsService : ICustomsOperationsService, IDisposable
    {
        ...
        public async Task<IEnumerable<CustomsOperations>> GetCustomsOperations(List<string> includesLst = null, bool tracking = true)
        {
            try
            {
            //using (var scope = new TransactionScope(TransactionScopeOption.Required,
               ...
               // {
                  using ( var dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
                  {
                    ...
                    IEnumerable<CustomsOperations> entities = await set.AsNoTracking().ToListAsync()
        ...
        public async Task<CustomsOperations> GetCustomsOperationsByKey(string Id, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
              ...
              using ( var dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
              {
				...
				var set = AddIncludes(includesLst, dbContext);
                CustomsOperations entity = await set.AsNoTracking().SingleOrDefaultAsync(x => x.Id == i).ConfigureAwait(continueOnCapturedContext: false);
		 ...
		 public async Task<IEnumerable<CustomsOperations>> GetCustomsOperationsByExpression(string exp, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
                using (var dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
		 ...
		 public async Task<IEnumerable<CustomsOperations>> GetCustomsOperationsByExpressionLst(List<string> expLst, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
                using (var dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
                {
                    dbContext.Database.CommandTimeout = 0;
					if (expLst.Count == 0 || expLst.FirstOrDefault() == "None") return new List<CustomsOperations>();
					var set = AddIncludes(includesLst, dbContext);
        ...
        public async Task<bool> DeleteCustomsOperations(string Id)
        {
            try
            {
              ...
              {
                var i = Convert.ToInt32(Id);
                CustomsOperations entity = await dbContext.CustomsOperations
		...
		private static async Task<IEnumerable<CustomsOperations>> LoadRangeSelectMany<T>(int startIndex, int count,
		...
		private static async Task<IEnumerable<CustomsOperations>> LoadRangeSelect<T>(int startIndex, int count,
            CoreEntitiesContext dbContext, string exp, string navExp, string navProp, IEnumerable<string> includeLst = null) where T : class
        {
			try
			{
		...
		private static async Task<IEnumerable<CustomsOperations>> GetWhereSelectMany<T>(CoreEntitiesContext dbContext,
		...
		private static async Task<IEnumerable<CustomsOperations>> GetWhereSelect<T>(CoreEntitiesContext dbContext,
            string exp, string navExp, string navProp, List<string> includesLst = null) where T : class
        {
			try
			{
