...
namespace CoreEntities.Business.Services
{
   ...
   [ServiceBehavior(InstanceContextMode = InstanceContextMode.PerCall,
    ...
    public partial class TODO_C71ToXMLService : ITODO_C71ToXMLService, IDisposable
    {
        //private readonly CoreEntitiesContext dbContext;

        public bool StartTracking { get; set; }

        public TODO_C71ToXMLService()
        {
            try
            {
        ...
        public Task<IEnumerable<TODO_C71ToXML>> GetTODO_C71ToXML(List<string> includesLst = null, bool tracking = true)
        {
            try
            {
            //using (var scope = new TransactionScope(TransactionScopeOption.Required,
               ...
               // {
                  using ( var dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
                  {
                    ...
                    IEnumerable<TODO_C71ToXML> entities = set.AsNoTracking().ToList();
                           //scope.Complete();
        ...
        public Task<TODO_C71ToXML> GetTODO_C71ToXMLByKey(string ASYCUDA_Id, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
			   if(string.IsNullOrEmpty(ASYCUDA_Id))return Task.FromResult<TODO_C71ToXML>(null); 
              using ( var dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
              {
                var i = Convert.ToInt32(ASYCUDA_Id);
				var set = AddIncludes(includesLst, dbContext);
                TODO_C71ToXML entity = set.AsNoTracking().SingleOrDefault(x => x.ASYCUDA_Id == i);
		 ...
		 public Task<IEnumerable<TODO_C71ToXML>> GetTODO_C71ToXMLByExpression(string exp, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
                using (var dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
                {
					...
					if (string.IsNullOrEmpty(exp) || exp == "None") return Task.FromResult<IEnumerable<TODO_C71ToXML>>(new List<TODO_C71ToXML>());
					var set = AddIncludes(includesLst, dbContext);
                    if (exp == "All")
                    {
                        ...
                        if(tracking) entities.AsParallel(new ParallelLinqOptions() { MaxDegreeOfParallelism = Environment.ProcessorCount }).ForAll(x => x.StartTracking());
                        return Task.FromResult<IEnumerable<TODO_C71ToXML>>(entities); 
                    }
					else
					{
		 ...
		 public Task<IEnumerable<TODO_C71ToXML>> GetTODO_C71ToXMLByExpressionLst(List<string> expLst, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
                using (var dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
                {
                    dbContext.Database.CommandTimeout = 0;
					if (expLst.Count == 0 || expLst.FirstOrDefault() == "None") return Task.FromResult<IEnumerable<TODO_C71ToXML>>(new List<TODO_C71ToXML>());
					var set = AddIncludes(includesLst, dbContext);
		...
		public Task<IEnumerable<TODO_C71ToXML>> GetTODO_C71ToXMLByExpressionNav(string exp,
            ...
            try
            {
                using (var dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
                {
                    ...
                    if (exp == "All" && navExp.Count == 0)
                    {
                        ...
                        return Task.FromResult<IEnumerable<TODO_C71ToXML>>(aentities); 
                    }
					var set = AddIncludes(includesLst, dbContext);
                    var entities = set.AsNoTracking().Where(exp)
									.ToList();
        ...
        public Task<IEnumerable<TODO_C71ToXML>> GetTODO_C71ToXMLByBatch(string exp,
                                                                        int totalrow, List<string> includesLst = null, bool tracking = true)
        {
            try
            {

                var res = new ConcurrentQueue<List<TODO_C71ToXML>>();
        ...
        public Task<IEnumerable<TODO_C71ToXML>> GetTODO_C71ToXMLByBatchExpressionLst(List<string> expLst,
                                                                                     int totalrow, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
        ...
        public Task<TODO_C71ToXML> UpdateTODO_C71ToXML(TODO_C71ToXML entity)
        { 
            using ( var dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
              {
                try
                {   
                     var res = (TODO_C71ToXML) entity;
        ...
        public Task<TODO_C71ToXML> CreateTODO_C71ToXML(TODO_C71ToXML entity)
        {
            try
            {
                var res = (TODO_C71ToXML) entity;
              using ( var dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
              {
                dbContext.TODO_C71ToXML.Add(res);
                dbContext.SaveChanges();
                res.AcceptChanges();
                return Task.FromResult(res);
              }
        ...
        public Task<bool> DeleteTODO_C71ToXML(string ASYCUDA_Id)
        {
            try
            {
              using ( var dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
              {
                var i = Convert.ToInt32(ASYCUDA_Id);
                TODO_C71ToXML entity = dbContext.TODO_C71ToXML
													.SingleOrDefault(x => x.ASYCUDA_Id == i);
                if (entity == null)
                    return Task.FromResult(false);

                    dbContext.TODO_C71ToXML.Attach(entity);
                    dbContext.TODO_C71ToXML.Remove(entity);
                    dbContext.SaveChanges();
        ...
        public async Task<bool> RemoveSelectedTODO_C71ToXML(IEnumerable<string> lst)
        {
            try
            {
                StatusModel.StartStatusUpdate("Removing TODO_C71ToXML", lst.Count());
                var t = Task.Run(() =>
                {
                    using (var ctx = new TODO_C71ToXMLService())
                    {
                        foreach (var item in lst.ToList())
                        {

                            ctx.DeleteTODO_C71ToXML(item).Wait();
         ...
         public Task<int> CountByExpressionLst(List<string> expLst)
        {
            try
            {
                using (var dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
                {
                    ...
                    var set = (IQueryable<TODO_C71ToXML>)dbContext.TODO_C71ToXML; 
                    if (expLst.FirstOrDefault() == "All")
                    {
		...
		public Task<int> Count(string exp)
        {
            try
            {
                using (CoreEntitiesContext dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
                {
                    ...
                    if (exp == "All")
                    {
                        return Task.FromResult(dbContext.TODO_C71ToXML
                            .AsNoTracking()
                            .Count());
                    }
                    else
        ...
        public Task<IEnumerable<TODO_C71ToXML>> LoadRange(int startIndex, int count, string exp)
        {
            try
            {
                using (var dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
                {
                    ...
                    if (exp == "All")
                    {
                        return Task.FromResult<IEnumerable<TODO_C71ToXML>>(dbContext.TODO_C71ToXML
                            .AsNoTracking()
		...
		public Task<int> CountNav(string exp, Dictionary<string, string> navExp)
        {
            try
            {
                ...
                using (var dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
                {
                    ...
                    return Task.FromResult(dbContext.TODO_C71ToXML.Where(exp == "All" || exp == null ? "ASYCUDA_Id != null" : exp)
                        .AsNoTracking()
                        .Count());
                }
		...
		private static Task<int> CountWhereSelectMany<T>(CoreEntitiesContext dbContext, string exp, string navExp, string navProp) where T : class
        {
            ...
            return Task.FromResult(dbContext.Set<T>()
                .AsNoTracking()
                .Where(navExp)
                .SelectMany(navProp).OfType<TODO_C71ToXML>()
		...
		private static Task<int> CountWhereSelect<T>(CoreEntitiesContext dbContext, string exp, string navExp, string navProp) where T : class
        {
            ...
            return Task.FromResult(dbContext.Set<T>()
                .AsNoTracking()
                .Where(navExp)
                .Select(navProp).OfType<TODO_C71ToXML>()
                .Where(exp == "All" || exp == null ? "ASYCUDA_Id != null" : exp)
                .Distinct()
                .OrderBy("ASYCUDA_Id")
                .Count());
		  ...
		  public Task<IEnumerable<TODO_C71ToXML>> LoadRangeNav(int startIndex, int count, string exp,
                                                               Dictionary<string, string> navExp, IEnumerable<string> includeLst = null)
        {
            try
            {
                ...
                {
                    dbContext.Database.CommandTimeout = 0;
                    if ((string.IsNullOrEmpty(exp) && navExp.Count == 0) || exp == "None") return Task.FromResult<IEnumerable<TODO_C71ToXML>>(new List<TODO_C71ToXML>());
                    var set = AddIncludes(includeLst, dbContext);

                    if (exp == "All" && navExp.Count == 0)
                    {
                       
                        return Task.FromResult<IEnumerable<TODO_C71ToXML>>(set
                            .AsNoTracking()
                            .OrderBy(y => y.ASYCUDA_Id)
                    ...
                    return Task.FromResult<IEnumerable<TODO_C71ToXML>>(set//dbContext.TODO_C71ToXML
                        .AsNoTracking()
                        .Where(exp == "All" || exp == null ? "ASYCUDA_Id != null" : exp)
                        .OrderBy(y => y.ASYCUDA_Id)
		...
		private static async Task<IEnumerable<TODO_C71ToXML>> LoadRangeWhere<T>(int startIndex, int count,
		...
		private static Task<IEnumerable<TODO_C71ToXML>> LoadRangeSelectMany<T>(int startIndex, int count,
		...
		private static Task<IEnumerable<TODO_C71ToXML>> LoadRangeSelect<T>(int startIndex, int count,
                                                                           CoreEntitiesContext dbContext, string exp, string navExp, string navProp, IEnumerable<string> includeLst = null) where T : class
        {
			try
			{
        ...
        private static async Task<IEnumerable<TODO_C71ToXML>> GetWhere<T>(CoreEntitiesContext dbContext,
		...
		private static Task<IEnumerable<TODO_C71ToXML>> GetWhereSelectMany<T>(CoreEntitiesContext dbContext,
                                                                              string exp, string navExp, string navProp, List<string> includesLst = null) where T : class
        {
			...
			if (includesLst == null)
			{
				return Task.FromResult<IEnumerable<TODO_C71ToXML>>(dbContext.Set<T>()
                    .AsNoTracking()
                    .Where(navExp)
                    .SelectMany(navProp).OfType<TODO_C71ToXML>()
                    .Where(exp == "All" || exp == null?"ASYCUDA_Id != null":exp)
			...
			var set = (DbQuery<TODO_C71ToXML>)dbContext.Set<T>()
				.AsNoTracking()
                .Where(navExp)
                .SelectMany(navProp).OfType<TODO_C71ToXML>()
                .Where(exp == "All" || exp == null?"ASYCUDA_Id != null":exp)
            ...
            return Task.FromResult<IEnumerable<TODO_C71ToXML>>(set.ToList());
			}
			catch (Exception)
			{
				Debugger.Break();
		...
		private static Task<IEnumerable<TODO_C71ToXML>> GetWhereSelect<T>(CoreEntitiesContext dbContext,
                                                                          string exp, string navExp, string navProp, List<string> includesLst = null) where T : class
        {
			try
			{
             ...
             try
             {
                 using (var dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
                 {
					...
					decimal res = 0;
                     ...
                     if (whereExp == "All")
                     {
                          res = Convert.ToDecimal(dbContext.TODO_C71ToXML.AsNoTracking().Sum(field));
                     }
                     else
                     {
                         res = Convert.ToDecimal(dbContext.TODO_C71ToXML.AsNoTracking().Where(whereExp).Sum(field));
                     }
        ...
        public Task<decimal> SumNav( string exp, Dictionary<string, string> navExp, string field)
        {
            try
            {
                ...
                {
                    dbContext.Database.CommandTimeout = 0;
                    if (!dbContext.TODO_C71ToXML.Any()) return Task.FromResult<decimal>(0);
                    if (exp == "All" && navExp.Count == 0)
                    {
                        return Task.FromResult(Convert.ToDecimal(dbContext.TODO_C71ToXML
                                                                     .AsNoTracking()
                                                                     .Sum(field)??0));
                    }
                    return Task.FromResult(Convert.ToDecimal(dbContext.TODO_C71ToXML.Where(exp == "All" || exp == null ? "ASYCUDA_Id != null" : exp)
                                                                 .AsNoTracking()
                                                                 .Sum(field)??0));
                }
             ...
             try
             {
                 using (var dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
                 {
					...
					string res = "";
                     ...
                     if (whereExp == "All")
                     {
                          res = Convert.ToString(dbContext.TODO_C71ToXML.AsNoTracking().Min(field));
                     }
                     else
                     {
                         res = Convert.ToString(dbContext.TODO_C71ToXML.AsNoTracking().Where(whereExp).Min(field));
                     }
		...
		private static IQueryable<TODO_C71ToXML> AddIncludes(IEnumerable<string> includesLst, CoreEntitiesContext dbContext)
       {
		 try
			{
			   if (includesLst == null) includesLst = new List<string>();
			   var set =(DbQuery<TODO_C71ToXML>) dbContext.TODO_C71ToXML; 
	   ...
	   private IQueryable<TODO_C71ToXML> AddWheres(List<string> expLst, IQueryable<TODO_C71ToXML> set)
        {
            try
            {
