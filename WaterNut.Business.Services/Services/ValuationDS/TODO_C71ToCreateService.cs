...
namespace ValuationDS.Business.Services
{
   ...
   [ServiceBehavior(InstanceContextMode = InstanceContextMode.PerCall,
    ...
    public partial class TODO_C71ToCreateService : ITODO_C71ToCreateService, IDisposable
    {
        ...
        public Task<IEnumerable<TODO_C71ToCreate>> GetTODO_C71ToCreate(List<string> includesLst = null, bool tracking = true)
        {
            try
            {
            //using (var scope = new TransactionScope(TransactionScopeOption.Required,
               ...
               // {
                  using ( var dbContext = new ValuationDSContext(){StartTracking = StartTracking})
                  {
                    ...
                    IEnumerable<TODO_C71ToCreate> entities = set.AsNoTracking().ToList();
                           //scope.Complete();
        ...
        public Task<TODO_C71ToCreate> GetTODO_C71ToCreateByKey(string AsycudaDocumentSetId, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
			   if(string.IsNullOrEmpty(AsycudaDocumentSetId))return Task.FromResult<TODO_C71ToCreate>(null); 
              using ( var dbContext = new ValuationDSContext(){StartTracking = StartTracking})
              {
                var i = Convert.ToInt32(AsycudaDocumentSetId);
				var set = AddIncludes(includesLst, dbContext);
                TODO_C71ToCreate entity = set.AsNoTracking().SingleOrDefault(x => x.AsycudaDocumentSetId == i);
		 ...
		 public Task<IEnumerable<TODO_C71ToCreate>> GetTODO_C71ToCreateByExpression(string exp, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
                using (var dbContext = new ValuationDSContext(){StartTracking = StartTracking})
                {
					...
					if (string.IsNullOrEmpty(exp) || exp == "None") return Task.FromResult<IEnumerable<TODO_C71ToCreate>>(new List<TODO_C71ToCreate>());
					var set = AddIncludes(includesLst, dbContext);
                    if (exp == "All")
                    {
                        ...
                        if(tracking) entities.AsParallel(new ParallelLinqOptions() { MaxDegreeOfParallelism = Environment.ProcessorCount }).ForAll(x => x.StartTracking());
                        return Task.FromResult<IEnumerable<TODO_C71ToCreate>>(entities); 
                    }
					else
					{
		 ...
		 public Task<IEnumerable<TODO_C71ToCreate>> GetTODO_C71ToCreateByExpressionLst(List<string> expLst, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
                using (var dbContext = new ValuationDSContext(){StartTracking = StartTracking})
                {
                    dbContext.Database.CommandTimeout = 0;
					if (expLst.Count == 0 || expLst.FirstOrDefault() == "None") return Task.FromResult<IEnumerable<TODO_C71ToCreate>>(new List<TODO_C71ToCreate>());
					var set = AddIncludes(includesLst, dbContext);
		...
		public Task<IEnumerable<TODO_C71ToCreate>> GetTODO_C71ToCreateByExpressionNav(string exp,
            ...
            try
            {
                using (var dbContext = new ValuationDSContext(){StartTracking = StartTracking})
                {
                    ...
                    if (exp == "All" && navExp.Count == 0)
                    {
                        ...
                        return Task.FromResult<IEnumerable<TODO_C71ToCreate>>(aentities); 
                    }
					var set = AddIncludes(includesLst, dbContext);
                    var entities = set.AsNoTracking().Where(exp)
									.ToList();
        ...
        public Task<IEnumerable<TODO_C71ToCreate>> GetTODO_C71ToCreateByBatch(string exp,
        ...
        public Task<IEnumerable<TODO_C71ToCreate>> GetTODO_C71ToCreateByBatchExpressionLst(List<string> expLst,
                                                                                           int totalrow, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
        ...
        public Task<TODO_C71ToCreate> UpdateTODO_C71ToCreate(TODO_C71ToCreate entity)
        { 
            using ( var dbContext = new ValuationDSContext(){StartTracking = StartTracking})
              {
                try
        ...
        public Task<TODO_C71ToCreate> CreateTODO_C71ToCreate(TODO_C71ToCreate entity)
        {
            try
            {
                var res = (TODO_C71ToCreate) entity;
        ...
        public Task<bool> DeleteTODO_C71ToCreate(string AsycudaDocumentSetId)
        {
            try
            {
              using ( var dbContext = new ValuationDSContext(){StartTracking = StartTracking})
              {
                var i = Convert.ToInt32(AsycudaDocumentSetId);
                TODO_C71ToCreate entity = dbContext.TODO_C71ToCreate
		...
		public Task<int> Count(string exp)
        {
            try
            {
                using (ValuationDSContext dbContext = new ValuationDSContext(){StartTracking = StartTracking})
                {
                    ...
                    if (exp == "All")
                    {
                        return Task.FromResult(dbContext.TODO_C71ToCreate
                            .AsNoTracking()
                            .Count());
                    }
                    else
        ...
        public Task<IEnumerable<TODO_C71ToCreate>> LoadRange(int startIndex, int count, string exp)
        {
            try
            {
                using (var dbContext = new ValuationDSContext(){StartTracking = StartTracking})
                {
                    ...
                    if (exp == "All")
                    {
                        return Task.FromResult<IEnumerable<TODO_C71ToCreate>>(dbContext.TODO_C71ToCreate
                            .AsNoTracking()
		...
		public Task<int> CountNav(string exp, Dictionary<string, string> navExp)
        {
            try
            {
                ...
                using (var dbContext = new ValuationDSContext(){StartTracking = StartTracking})
                {
                    ...
                    return Task.FromResult(dbContext.TODO_C71ToCreate.Where(exp == "All" || exp == null ? "AsycudaDocumentSetId != null" : exp)
                        .AsNoTracking()
                        .Count());
                }
		...
		private static Task<int> CountWhereSelect<T>(ValuationDSContext dbContext, string exp, string navExp, string navProp) where T : class
        {
		  ...
		  public Task<IEnumerable<TODO_C71ToCreate>> LoadRangeNav(int startIndex, int count, string exp,
                                                                  Dictionary<string, string> navExp, IEnumerable<string> includeLst = null)
        {
            try
            {
                ...
                {
                    dbContext.Database.CommandTimeout = 0;
                    if ((string.IsNullOrEmpty(exp) && navExp.Count == 0) || exp == "None") return Task.FromResult<IEnumerable<TODO_C71ToCreate>>(new List<TODO_C71ToCreate>());
                    var set = AddIncludes(includeLst, dbContext);

                    if (exp == "All" && navExp.Count == 0)
                    {
                       
                        return Task.FromResult<IEnumerable<TODO_C71ToCreate>>(set
                            .AsNoTracking()
                            .OrderBy(y => y.AsycudaDocumentSetId)
                    ...
                    return Task.FromResult<IEnumerable<TODO_C71ToCreate>>(set//dbContext.TODO_C71ToCreate
                        .AsNoTracking()
                        .Where(exp == "All" || exp == null ? "AsycudaDocumentSetId != null" : exp)
                        .OrderBy(y => y.AsycudaDocumentSetId)
		...
		private static Task<IEnumerable<TODO_C71ToCreate>> LoadRangeSelectMany<T>(int startIndex, int count,
		...
		private static Task<IEnumerable<TODO_C71ToCreate>> LoadRangeSelect<T>(int startIndex, int count,
                                                                              ValuationDSContext dbContext, string exp, string navExp, string navProp, IEnumerable<string> includeLst = null) where T : class
        {
			try
			{
        ...
        private static async Task<IEnumerable<TODO_C71ToCreate>> GetWhere<T>(ValuationDSContext dbContext,
		...
		private static Task<IEnumerable<TODO_C71ToCreate>> GetWhereSelectMany<T>(ValuationDSContext dbContext,
                                                                                 string exp, string navExp, string navProp, List<string> includesLst = null) where T : class
        {
			...
			if (includesLst == null)
			{
				return Task.FromResult<IEnumerable<TODO_C71ToCreate>>(dbContext.Set<T>()
                    .AsNoTracking()
                    .Where(navExp)
                    .SelectMany(navProp).OfType<TODO_C71ToCreate>()
                    .Where(exp == "All" || exp == null?"AsycudaDocumentSetId != null":exp)
            ...
            return Task.FromResult<IEnumerable<TODO_C71ToCreate>>(set.ToList());
			}
			catch (Exception)
			{
				Debugger.Break();
		...
		private static Task<IEnumerable<TODO_C71ToCreate>> GetWhereSelect<T>(ValuationDSContext dbContext,
                                                                             string exp, string navExp, string navProp, List<string> includesLst = null) where T : class
        {
			try
			{
			...
			catch (Exception)
			{
				...
				throw;
			        ...
			        public Task<IEnumerable<TODO_C71ToCreate>> GetTODO_C71ToCreateByApplicationSettingsId(string ApplicationSettingsId, List<string> includesLst = null)
        {
            try
            {
                using ( var dbContext = new ValuationDSContext(){StartTracking = StartTracking})
            ...
            catch (Exception updateEx)
            {
 	        ...
 	        public Task<IEnumerable<TODO_C71ToCreate>> GetTODO_C71ToCreateByValue_declaration_form_Id(string Value_declaration_form_Id, List<string> includesLst = null)
        {
            try
            {
                using ( var dbContext = new ValuationDSContext(){StartTracking = StartTracking})
        ...
        public Task<decimal> SumNav( string exp, Dictionary<string, string> navExp, string field)
        {
            try
            {
                ...
                {
                    dbContext.Database.CommandTimeout = 0;
                    if (!dbContext.TODO_C71ToCreate.Any()) return Task.FromResult<decimal>(0);
                    if (exp == "All" && navExp.Count == 0)
                    {
                        return Task.FromResult(Convert.ToDecimal(dbContext.TODO_C71ToCreate
                                                                     .AsNoTracking()
                                                                     .Sum(field)??0));
                    }
                    return Task.FromResult(Convert.ToDecimal(dbContext.TODO_C71ToCreate.Where(exp == "All" || exp == null ? "AsycudaDocumentSetId != null" : exp)
                                                                 .AsNoTracking()
                                                                 .Sum(field)??0));
                }
		...
		private static IQueryable<TODO_C71ToCreate> AddIncludes(IEnumerable<string> includesLst, ValuationDSContext dbContext)
       {
		 try
			{
