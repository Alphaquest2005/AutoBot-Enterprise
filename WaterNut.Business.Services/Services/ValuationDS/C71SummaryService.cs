...
namespace ValuationDS.Business.Services
{
   ...
   [ServiceBehavior(InstanceContextMode = InstanceContextMode.PerCall,
    ...
    public partial class C71SummaryService : IC71SummaryService, IDisposable
    {
        ...
        public Task<IEnumerable<C71Summary>> GetC71Summary(List<string> includesLst = null, bool tracking = true)
        {
            try
            {
        ...
        public Task<C71Summary> GetC71SummaryByKey(string Value_declaration_form_Id, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
			   if(string.IsNullOrEmpty(Value_declaration_form_Id))return Task.FromResult<C71Summary>(null); 
              using ( var dbContext = new ValuationDSContext(){StartTracking = StartTracking})
              {
		 ...
		 public Task<IEnumerable<C71Summary>> GetC71SummaryByExpression(string exp, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
                using (var dbContext = new ValuationDSContext(){StartTracking = StartTracking})
                {
					...
					if (string.IsNullOrEmpty(exp) || exp == "None") return Task.FromResult<IEnumerable<C71Summary>>(new List<C71Summary>());
					var set = AddIncludes(includesLst, dbContext);
                    if (exp == "All")
                    {
                        ...
                        if(tracking) entities.AsParallel(new ParallelLinqOptions() { MaxDegreeOfParallelism = Environment.ProcessorCount }).ForAll(x => x.StartTracking());
                        return Task.FromResult<IEnumerable<C71Summary>>(entities); 
                    }
					else
					{
		 ...
		 public Task<IEnumerable<C71Summary>> GetC71SummaryByExpressionLst(List<string> expLst, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
                using (var dbContext = new ValuationDSContext(){StartTracking = StartTracking})
                {
                    dbContext.Database.CommandTimeout = 0;
					if (expLst.Count == 0 || expLst.FirstOrDefault() == "None") return Task.FromResult<IEnumerable<C71Summary>>(new List<C71Summary>());
					var set = AddIncludes(includesLst, dbContext);
		...
		public Task<IEnumerable<C71Summary>> GetC71SummaryByExpressionNav(string exp,
            ...
            try
            {
                using (var dbContext = new ValuationDSContext(){StartTracking = StartTracking})
                {
                    ...
                    if (exp == "All" && navExp.Count == 0)
                    {
                        ...
                        return Task.FromResult<IEnumerable<C71Summary>>(aentities); 
                    }
					var set = AddIncludes(includesLst, dbContext);
                    var entities = set.AsNoTracking().Where(exp)
									.ToList();
        ...
        public Task<IEnumerable<C71Summary>> GetC71SummaryByBatch(string exp,
        ...
        public Task<IEnumerable<C71Summary>> GetC71SummaryByBatchExpressionLst(List<string> expLst,
                                                                               int totalrow, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
        ...
        public Task<C71Summary> UpdateC71Summary(C71Summary entity)
        { 
            using ( var dbContext = new ValuationDSContext(){StartTracking = StartTracking})
              {
                try
        ...
        public Task<C71Summary> CreateC71Summary(C71Summary entity)
        {
            try
            {
                var res = (C71Summary) entity;
        ...
        public Task<bool> DeleteC71Summary(string Value_declaration_form_Id)
        {
            try
            {
              using ( var dbContext = new ValuationDSContext(){StartTracking = StartTracking})
		...
		public Task<int> Count(string exp)
        {
            try
            {
                using (ValuationDSContext dbContext = new ValuationDSContext(){StartTracking = StartTracking})
                {
                    ...
                    if (exp == "All")
                    {
                        return Task.FromResult(dbContext.C71Summary
                            .AsNoTracking()
                            .Count());
                    }
                    else
        ...
        public Task<IEnumerable<C71Summary>> LoadRange(int startIndex, int count, string exp)
        {
            try
            {
                using (var dbContext = new ValuationDSContext(){StartTracking = StartTracking})
                {
                    ...
                    if (exp == "All")
                    {
                        return Task.FromResult<IEnumerable<C71Summary>>(dbContext.C71Summary
                            .AsNoTracking()
		...
		public Task<int> CountNav(string exp, Dictionary<string, string> navExp)
        {
            try
            {
                ...
                using (var dbContext = new ValuationDSContext(){StartTracking = StartTracking})
                {
                    ...
                    return Task.FromResult(dbContext.C71Summary.Where(exp == "All" || exp == null ? "Value_declaration_form_Id != null" : exp)
                        .AsNoTracking()
                        .Count());
                }
		...
		private static Task<int> CountWhereSelect<T>(ValuationDSContext dbContext, string exp, string navExp, string navProp) where T : class
        {
		  ...
		  public Task<IEnumerable<C71Summary>> LoadRangeNav(int startIndex, int count, string exp,
                                                            Dictionary<string, string> navExp, IEnumerable<string> includeLst = null)
        {
            try
            {
                ...
                {
                    dbContext.Database.CommandTimeout = 0;
                    if ((string.IsNullOrEmpty(exp) && navExp.Count == 0) || exp == "None") return Task.FromResult<IEnumerable<C71Summary>>(new List<C71Summary>());
                    var set = AddIncludes(includeLst, dbContext);

                    if (exp == "All" && navExp.Count == 0)
                    {
                       
                        return Task.FromResult<IEnumerable<C71Summary>>(set
                            .AsNoTracking()
                            .OrderBy(y => y.Value_declaration_form_Id)
                    ...
                    return Task.FromResult<IEnumerable<C71Summary>>(set//dbContext.C71Summary
                        .AsNoTracking()
                        .Where(exp == "All" || exp == null ? "Value_declaration_form_Id != null" : exp)
                        .OrderBy(y => y.Value_declaration_form_Id)
		...
		private static Task<IEnumerable<C71Summary>> LoadRangeSelectMany<T>(int startIndex, int count,
		...
		private static Task<IEnumerable<C71Summary>> LoadRangeSelect<T>(int startIndex, int count,
                                                                        ValuationDSContext dbContext, string exp, string navExp, string navProp, IEnumerable<string> includeLst = null) where T : class
        {
			try
			{
		...
		private static Task<IEnumerable<C71Summary>> GetWhereSelectMany<T>(ValuationDSContext dbContext,
                                                                           string exp, string navExp, string navProp, List<string> includesLst = null) where T : class
        {
			...
			if (includesLst == null)
			{
				return Task.FromResult<IEnumerable<C71Summary>>(dbContext.Set<T>()
                    .AsNoTracking()
                    .Where(navExp)
                    .SelectMany(navProp).OfType<C71Summary>()
                    .Where(exp == "All" || exp == null?"Value_declaration_form_Id != null":exp)
            ...
            return Task.FromResult<IEnumerable<C71Summary>>(set.ToList());
			}
			catch (Exception)
			{
				Debugger.Break();
		...
		private static Task<IEnumerable<C71Summary>> GetWhereSelect<T>(ValuationDSContext dbContext,
                                                                       string exp, string navExp, string navProp, List<string> includesLst = null) where T : class
        {
			try
			{
			...
			catch (Exception)
			{
				...
				throw;
			        ...
			        public Task<IEnumerable<C71Summary>> GetC71SummaryByRegisteredId(string RegisteredId, List<string> includesLst = null)
        {
            try
            {
                using ( var dbContext = new ValuationDSContext(){StartTracking = StartTracking})
            ...
            catch (Exception updateEx)
            {
 	        ...
 	        public Task<IEnumerable<C71Summary>> GetC71SummaryByApplicationSettingsId(string ApplicationSettingsId, List<string> includesLst = null)
        {
            try
            {
                using ( var dbContext = new ValuationDSContext(){StartTracking = StartTracking})
        ...
        public Task<decimal> SumNav( string exp, Dictionary<string, string> navExp, string field)
        {
            try
            {
                ...
                {
                    dbContext.Database.CommandTimeout = 0;
                    if (!dbContext.C71Summary.Any()) return Task.FromResult<decimal>(0);
                    if (exp == "All" && navExp.Count == 0)
                    {
                        return Task.FromResult(Convert.ToDecimal(dbContext.C71Summary
                                                                     .AsNoTracking()
                                                                     .Sum(field)??0));
                    }
                    return Task.FromResult(Convert.ToDecimal(dbContext.C71Summary.Where(exp == "All" || exp == null ? "Value_declaration_form_Id != null" : exp)
                                                                 .AsNoTracking()
                                                                 .Sum(field)??0));
                }
