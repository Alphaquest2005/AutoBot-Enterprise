    ...
    public partial class RegisteredService : IRegisteredService, IDisposable
    {
        ...
        public async Task<Registered> GetRegisteredByKey(string Value_declaration_form_Id, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
              ...
              using ( var dbContext = new ValuationDSContext(){StartTracking = StartTracking})
              {
				...
				var set = AddIncludes(includesLst, dbContext);
                Registered entity = await set.AsNoTracking().SingleOrDefaultAsync(x => x.Value_declaration_form_Id == i).ConfigureAwait(continueOnCapturedContext: false);
        ...
        public async Task<bool> DeleteRegistered(string Value_declaration_form_Id)
        {
            try
            {
              ...
              {
                var i = Convert.ToInt32(Value_declaration_form_Id);
                Registered entity = await dbContext.xC71_Value_declaration_form.OfType<Registered>()
		...
		public async Task<int> CountNav(string exp, Dictionary<string, string> navExp)
        {
            try
            {
                ...
                using (var dbContext = new ValuationDSContext(){StartTracking = StartTracking})
                {
                    ...
                    return await dbContext.Set<Registered>().Where(exp == "All" || exp == null ? "Value_declaration_form_Id != null" : exp)
											.AsNoTracking()
                                            .CountAsync()
											.ConfigureAwait(continueOnCapturedContext: false);
                }
