...
namespace ValuationDS.Business.Services
{
   ...
   [ServiceBehavior(InstanceContextMode = InstanceContextMode.PerCall,
    ...
    public partial class xC71_ItemService : IxC71_ItemService, IDisposable
    {
        ...
        public async Task<IEnumerable<xC71_Item>> GetxC71_Item(List<string> includesLst = null, bool tracking = true)
        {
            try
            {
            //using (var scope = new TransactionScope(TransactionScopeOption.Required,
               ...
               // {
                  using ( var dbContext = new ValuationDSContext(){StartTracking = StartTracking})
                  {
                    ...
                    IEnumerable<xC71_Item> entities = await set.AsNoTracking().ToListAsync()
        ...
        public async Task<xC71_Item> GetxC71_ItemByKey(string Item_Id, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
              ...
              using ( var dbContext = new ValuationDSContext(){StartTracking = StartTracking})
              {
				...
				var set = AddIncludes(includesLst, dbContext);
                xC71_Item entity = await set.AsNoTracking().SingleOrDefaultAsync(x => x.Item_Id == i).ConfigureAwait(continueOnCapturedContext: false);
		 ...
		 public async Task<IEnumerable<xC71_Item>> GetxC71_ItemByExpression(string exp, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
                using (var dbContext = new ValuationDSContext(){StartTracking = StartTracking})
		 ...
		 public async Task<IEnumerable<xC71_Item>> GetxC71_ItemByExpressionLst(List<string> expLst, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
                using (var dbContext = new ValuationDSContext(){StartTracking = StartTracking})
        ...
        public async Task<IEnumerable<xC71_Item>> GetxC71_ItemByBatch(string exp,
        ...
        public async Task<IEnumerable<xC71_Item>> GetxC71_ItemByBatchExpressionLst(List<string> expLst,
            int totalrow, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
        ...
        public async Task<xC71_Item> UpdatexC71_Item(xC71_Item entity)
        { 
            using ( var dbContext = new ValuationDSContext(){StartTracking = StartTracking})
              {
                try
        ...
        public async Task<xC71_Item> CreatexC71_Item(xC71_Item entity)
        {
            try
            {
                var res = (xC71_Item) entity;
        ...
        public async Task<bool> DeletexC71_Item(string Item_Id)
        {
            try
            {
              using ( var dbContext = new ValuationDSContext(){StartTracking = StartTracking})
              {
                var i = Convert.ToInt32(Item_Id);
                xC71_Item entity = await dbContext.xC71_Item
        ...
        public async Task<IEnumerable<xC71_Item>> LoadRange(int startIndex, int count, string exp)
        {
            try
            {
                using (var dbContext = new ValuationDSContext(){StartTracking = StartTracking})
		...
		public async Task<int> CountNav(string exp, Dictionary<string, string> navExp)
        {
            try
            {
                ...
                using (var dbContext = new ValuationDSContext(){StartTracking = StartTracking})
                {
                    ...
                    return await dbContext.xC71_Item.Where(exp == "All" || exp == null ? "Item_Id != null" : exp)
											.AsNoTracking()
                                            .CountAsync()
											.ConfigureAwait(continueOnCapturedContext: false);
                }
                                                                                 ...
                                                                                 Dictionary<string, string> navExp, IEnumerable<string> includeLst = null)
        {
            try
            {
                using (var dbContext = new ValuationDSContext(){StartTracking = StartTracking})
                {
                    ...
                    return await set//dbContext.xC71_Item
								.AsNoTracking()
                                .Where(exp == "All" || exp == null ? "Item_Id != null" : exp)
								.OrderBy(y => y.Item_Id)
		...
		private static async Task<IEnumerable<xC71_Item>> LoadRangeSelectMany<T>(int startIndex, int count,
		...
		private static async Task<IEnumerable<xC71_Item>> LoadRangeSelect<T>(int startIndex, int count,
            ValuationDSContext dbContext, string exp, string navExp, string navProp, IEnumerable<string> includeLst = null) where T : class
        {
			try
			{
		...
		private static async Task<IEnumerable<xC71_Item>> GetWhereSelectMany<T>(ValuationDSContext dbContext,
		...
		private static async Task<IEnumerable<xC71_Item>> GetWhereSelect<T>(ValuationDSContext dbContext,
            string exp, string navExp, string navProp, List<string> includesLst = null) where T : class
        {
			try
			{
			...
			catch (Exception)
			{
				...
				throw;
			        ...
			        public async Task<IEnumerable<xC71_Item>> GetxC71_ItemByValue_declaration_form_Id(string Value_declaration_form_Id, List<string> includesLst = null)
        {
            try
            {
                using ( var dbContext = new ValuationDSContext(){StartTracking = StartTracking})
              {
                ...
                var set = AddIncludes(includesLst, dbContext);
                IEnumerable<xC71_Item> entities = await set//dbContext.xC71_Item
                                      .AsNoTracking()
