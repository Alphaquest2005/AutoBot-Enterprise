...
namespace ValuationDS.Business.Services
{
   ...
   [ServiceBehavior(InstanceContextMode = InstanceContextMode.PerCall,
    ...
    public partial class xC71_ItemService : IxC71_ItemService, IDisposable
    {
        ...
        public Task<IEnumerable<xC71_Item>> GetxC71_Item(List<string> includesLst = null, bool tracking = true)
        {
            try
            {
            //using (var scope = new TransactionScope(TransactionScopeOption.Required,
               ...
               // {
                  using ( var dbContext = new ValuationDSContext(){StartTracking = StartTracking})
                  {
                    ...
                    IEnumerable<xC71_Item> entities = set.AsNoTracking().ToList();
                           //scope.Complete();
        ...
        public Task<xC71_Item> GetxC71_ItemByKey(string Item_Id, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
			   if(string.IsNullOrEmpty(Item_Id))return Task.FromResult<xC71_Item>(null); 
              using ( var dbContext = new ValuationDSContext(){StartTracking = StartTracking})
              {
                var i = Convert.ToInt32(Item_Id);
				var set = AddIncludes(includesLst, dbContext);
                xC71_Item entity = set.AsNoTracking().SingleOrDefault(x => x.Item_Id == i);
		 ...
		 public Task<IEnumerable<xC71_Item>> GetxC71_ItemByExpression(string exp, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
                using (var dbContext = new ValuationDSContext(){StartTracking = StartTracking})
                {
					...
					if (string.IsNullOrEmpty(exp) || exp == "None") return Task.FromResult<IEnumerable<xC71_Item>>(new List<xC71_Item>());
					var set = AddIncludes(includesLst, dbContext);
                    if (exp == "All")
                    {
                        ...
                        if(tracking) entities.AsParallel(new ParallelLinqOptions() { MaxDegreeOfParallelism = Environment.ProcessorCount }).ForAll(x => x.StartTracking());
                        return Task.FromResult<IEnumerable<xC71_Item>>(entities); 
                    }
					else
					{
		 ...
		 public Task<IEnumerable<xC71_Item>> GetxC71_ItemByExpressionLst(List<string> expLst, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
                using (var dbContext = new ValuationDSContext(){StartTracking = StartTracking})
                {
                    dbContext.Database.CommandTimeout = 0;
					if (expLst.Count == 0 || expLst.FirstOrDefault() == "None") return Task.FromResult<IEnumerable<xC71_Item>>(new List<xC71_Item>());
					var set = AddIncludes(includesLst, dbContext);
		...
		public async Task<IEnumerable<xC71_Item>> GetxC71_ItemByExpressionNav(string exp,
                    ...
                    foreach (var itm in navExp)
                    {
                        switch (itm.Key)
                        {
                            case "xC71_Value_declaration_form":
                                return
                                    await
                                        GetWhere<xC71_Value_declaration_form>(dbContext, exp, itm.Value, "xC71_Item", "SelectMany", includesLst)
        ...
        public Task<IEnumerable<xC71_Item>> GetxC71_ItemByBatch(string exp,
                                                                int totalrow, List<string> includesLst = null, bool tracking = true)
        {
            try
            {

                var res = new ConcurrentQueue<List<xC71_Item>>();
        ...
        public Task<IEnumerable<xC71_Item>> GetxC71_ItemByBatchExpressionLst(List<string> expLst,
                                                                             int totalrow, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
        ...
        public Task<xC71_Item> UpdatexC71_Item(xC71_Item entity)
        { 
            using ( var dbContext = new ValuationDSContext(){StartTracking = StartTracking})
              {
                try
                {   
                     var res = (xC71_Item) entity;
        ...
        public Task<xC71_Item> CreatexC71_Item(xC71_Item entity)
        {
            try
            {
                var res = (xC71_Item) entity;
        ...
        public Task<bool> DeletexC71_Item(string Item_Id)
        {
            try
            {
              using ( var dbContext = new ValuationDSContext(){StartTracking = StartTracking})
              {
                var i = Convert.ToInt32(Item_Id);
                xC71_Item entity = dbContext.xC71_Item
													.SingleOrDefault(x => x.Item_Id == i);
                if (entity == null)
                    return Task.FromResult(false);

                    dbContext.xC71_Item.Attach(entity);
                    dbContext.xC71_Item.Remove(entity);
                    dbContext.SaveChanges();
        ...
        public async Task<bool> RemoveSelectedxC71_Item(IEnumerable<string> lst)
        {
            try
            {
                StatusModel.StartStatusUpdate("Removing xC71_Item", lst.Count());
                var t = Task.Run(() =>
                {
                    using (var ctx = new xC71_ItemService())
                    {
                        foreach (var item in lst.ToList())
                        {

                            ctx.DeletexC71_Item(item).Wait();
		...
		public Task<int> Count(string exp)
        {
            try
            {
                using (ValuationDSContext dbContext = new ValuationDSContext(){StartTracking = StartTracking})
                {
                    ...
                    if (exp == "All")
                    {
                        return Task.FromResult(dbContext.xC71_Item
                            .AsNoTracking()
                            .Count());
                    }
                    else
        ...
        public Task<IEnumerable<xC71_Item>> LoadRange(int startIndex, int count, string exp)
        {
            try
            {
                using (var dbContext = new ValuationDSContext(){StartTracking = StartTracking})
                {
                    ...
                    if (exp == "All")
                    {
                        return Task.FromResult<IEnumerable<xC71_Item>>(dbContext.xC71_Item
                            .AsNoTracking()
                            .OrderBy(y => y.Item_Id)
                            .Skip(startIndex)
                            .Take(count)
            ...
            try
            {
                ...
                using (var dbContext = new ValuationDSContext(){StartTracking = StartTracking})
                {
                    ...
                    foreach (var itm in navExp)
                    {
                        ...
                        {
                            case "xC71_Value_declaration_form":
                                return await CountWhere<xC71_Value_declaration_form>(dbContext, exp, itm.Value, "xC71_Item", "SelectMany")
											.ConfigureAwait(continueOnCapturedContext: false);
						}
                    }
                    return dbContext.xC71_Item.Where(exp == "All" || exp == null ? "Item_Id != null" : exp)
											.AsNoTracking()
                                            .Count();
                }
		...
		private static Task<int> CountWhereSelectMany<T>(ValuationDSContext dbContext, string exp, string navExp, string navProp) where T : class
        {
            ...
            return Task.FromResult(dbContext.Set<T>()
                .AsNoTracking()
                .Where(navExp)
                .SelectMany(navProp).OfType<xC71_Item>()
		...
		private static Task<int> CountWhereSelect<T>(ValuationDSContext dbContext, string exp, string navExp, string navProp) where T : class
        {
            ...
            return Task.FromResult(dbContext.Set<T>()
                .AsNoTracking()
                .Where(navExp)
                .Select(navProp).OfType<xC71_Item>()
                .Where(exp == "All" || exp == null ? "Item_Id != null" : exp)
                .Distinct()
                .OrderBy("Item_Id")
                .Count());
		  ...
		  public async Task<IEnumerable<xC71_Item>> LoadRangeNav(int startIndex, int count, string exp,
                                                                                 Dictionary<string, string> navExp, IEnumerable<string> includeLst = null)
        {
            try
            {
                using (var dbContext = new ValuationDSContext(){StartTracking = StartTracking})
                {
                    ...
                    foreach (var itm in navExp)
                    {
                        switch (itm.Key)
                        {
                            case "xC71_Value_declaration_form":
                                return
                                    await
                                        LoadRangeWhere<xC71_Value_declaration_form>(startIndex, count, dbContext, exp, itm.Value, "xC71_Item", "SelectMany")
													.ConfigureAwait(continueOnCapturedContext: false);
                    ...
                    return set//dbContext.xC71_Item
								.AsNoTracking()
                                .Where(exp == "All" || exp == null ? "Item_Id != null" : exp)
								.OrderBy(y => y.Item_Id)
		...
		private static async Task<IEnumerable<xC71_Item>> LoadRangeWhere<T>(int startIndex, int count,
		...
		private static Task<IEnumerable<xC71_Item>> LoadRangeSelectMany<T>(int startIndex, int count,
                                                                           ValuationDSContext dbContext, string exp, string navExp, string navProp, IEnumerable<string> includeLst = null) where T : class
        {
            ...
            return Task.FromResult<IEnumerable<xC71_Item>>(set
                .Where(exp == "All" || exp == null ? "Item_Id != null" : exp)
                .Distinct()
                .OrderBy(y => y.Item_Id)
		...
		private static Task<IEnumerable<xC71_Item>> LoadRangeSelect<T>(int startIndex, int count,
                                                                       ValuationDSContext dbContext, string exp, string navExp, string navProp, IEnumerable<string> includeLst = null) where T : class
        {
			try
			{
        ...
        private static async Task<IEnumerable<xC71_Item>> GetWhere<T>(ValuationDSContext dbContext,
		...
		private static Task<IEnumerable<xC71_Item>> GetWhereSelectMany<T>(ValuationDSContext dbContext,
                                                                          string exp, string navExp, string navProp, List<string> includesLst = null) where T : class
        {
			...
			if (includesLst == null)
			{
				return Task.FromResult<IEnumerable<xC71_Item>>(dbContext.Set<T>()
                    .AsNoTracking()
                    .Where(navExp)
                    .SelectMany(navProp).OfType<xC71_Item>()
                    .Where(exp == "All" || exp == null?"Item_Id != null":exp)
			...
			var set = (DbQuery<xC71_Item>)dbContext.Set<T>()
				.AsNoTracking()
                .Where(navExp)
                .SelectMany(navProp).OfType<xC71_Item>()
                .Where(exp == "All" || exp == null?"Item_Id != null":exp)
            ...
            return Task.FromResult<IEnumerable<xC71_Item>>(set.ToList());
			}
			catch (Exception)
			{
				Debugger.Break();
		...
		private static Task<IEnumerable<xC71_Item>> GetWhereSelect<T>(ValuationDSContext dbContext,
                                                                      string exp, string navExp, string navProp, List<string> includesLst = null) where T : class
        {
			try
			{
			...
			catch (Exception)
			{
				...
				throw;
			        ...
			        public Task<IEnumerable<xC71_Item>> GetxC71_ItemByValue_declaration_form_Id(string Value_declaration_form_Id, List<string> includesLst = null)
        {
            try
            {
                using ( var dbContext = new ValuationDSContext(){StartTracking = StartTracking})
              {
                ...
                var set = AddIncludes(includesLst, dbContext);
                IEnumerable<xC71_Item> entities = set//dbContext.xC71_Item
                                      .AsNoTracking()
             ...
             try
             {
                 using (var dbContext = new ValuationDSContext(){StartTracking = StartTracking})
                 {
					...
					decimal res = 0;
                     ...
                     if (whereExp == "All")
                     {
                          res = Convert.ToDecimal(dbContext.xC71_Item.AsNoTracking().Sum(field));
                     }
                     else
                     {
                         res = Convert.ToDecimal(dbContext.xC71_Item.AsNoTracking().Where(whereExp).Sum(field));
                     }
        ...
        public async Task<decimal> SumNav( string exp, Dictionary<string, string> navExp, string field)
        {
            try
            {
                ...
                using (var dbContext = new ValuationDSContext(){StartTracking = StartTracking})
                {
                    ...
                    if (exp == "All" && navExp.Count == 0)
                    {
                        return Convert.ToDecimal(dbContext.xC71_Item
										.AsNoTracking()
                                        .Sum(field)??0);
                    }
                    foreach (var itm in navExp)
                    {
                        ...
                        {
                            case "xC71_Value_declaration_form":
                                return await SumWhere<xC71_Value_declaration_form>(dbContext, exp, itm.Value, "xC71_Item", field, "SelectMany")
											.ConfigureAwait(continueOnCapturedContext: false);
						}
                    }
                    return Convert.ToDecimal(dbContext.xC71_Item.Where(exp == "All" || exp == null ? "Item_Id != null" : exp)
											.AsNoTracking()
                                            .Sum(field)??0);
                }
             ...
             try
             {
                 using (var dbContext = new ValuationDSContext(){StartTracking = StartTracking})
                 {
					...
					string res = "";
                     ...
                     if (whereExp == "All")
                     {
                          res = Convert.ToString(dbContext.xC71_Item.AsNoTracking().Min(field));
                     }
                     else
                     {
                         res = Convert.ToString(dbContext.xC71_Item.AsNoTracking().Where(whereExp).Min(field));
                     }
		...
		private static IQueryable<xC71_Item> AddIncludes(IEnumerable<string> includesLst, ValuationDSContext dbContext)
       {
		 try
			{
			   if (includesLst == null) includesLst = new List<string>();
			   var set =(DbQuery<xC71_Item>) dbContext.xC71_Item; 
	   ...
	   private IQueryable<xC71_Item> AddWheres(List<string> expLst, IQueryable<xC71_Item> set)
        {
            try
            {
