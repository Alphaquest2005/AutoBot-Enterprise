...
{
   [Export (typeof(IxC71_Identification_segmentService))]
   [Export(typeof(IBusinessService))]
   [PartCreationPolicy(CreationPolicy.NonShared)]
   [ServiceBehavior(InstanceContextMode = InstanceContextMode.PerCall,
                    ConcurrencyMode = ConcurrencyMode.Multiple)]
   
    public partial class xC71_Identification_segmentService : IxC71_Identification_segmentService, IDisposable
    {
        //private readonly ValuationDSContext dbContext;

        public bool StartTracking { get; set; }

        public xC71_Identification_segmentService()
        {
            try
            {
            ...
            //using (var scope = new TransactionScope(TransactionScopeOption.Required,
               ...
               // {
                  using ( var dbContext = new ValuationDSContext(){StartTracking = StartTracking})
                  {
                    ...
                    IEnumerable<xC71_Identification_segment> entities = await set.AsNoTracking().ToListAsync()
        ...
        public async Task<xC71_Identification_segment> GetxC71_Identification_segmentByKey(string Identification_segment_Id, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
              ...
              using ( var dbContext = new ValuationDSContext(){StartTracking = StartTracking})
              {
				...
				var set = AddIncludes(includesLst, dbContext);
                xC71_Identification_segment entity = await set.AsNoTracking().SingleOrDefaultAsync(x => x.Identification_segment_Id == i).ConfigureAwait(continueOnCapturedContext: false);
		...
		public async Task<IEnumerable<xC71_Identification_segment>> GetxC71_Identification_segmentByExpressionNav(string exp,
            ...
            try
            {
                using (var dbContext = new ValuationDSContext(){StartTracking = StartTracking})
                {
                    ...
                    foreach (var itm in navExp)
                    {
                        switch (itm.Key)
                        {
                            case "xC71_Buyer_segment":
                                return
                                    await
                                        GetWhere<xC71_Buyer_segment>(dbContext, exp, itm.Value, "xC71_Identification_segment", "SelectMany", includesLst)
										.ConfigureAwait(continueOnCapturedContext: false);

                            case "xC71_Declarant_segment":
                                return
                                    await
                                        GetWhere<xC71_Declarant_segment>(dbContext, exp, itm.Value, "xC71_Identification_segment", "SelectMany", includesLst)
										.ConfigureAwait(continueOnCapturedContext: false);

                            case "xC71_Seller_segment":
                                return
                                    await
                                        GetWhere<xC71_Seller_segment>(dbContext, exp, itm.Value, "xC71_Identification_segment", "SelectMany", includesLst)
										.ConfigureAwait(continueOnCapturedContext: false);

                            case "xC71_Value_declaration_form":
                                return
                                    await
                                        GetWhere<xC71_Value_declaration_form>(dbContext, exp, itm.Value, "xC71_Identification_segment", "SelectMany", includesLst)
										.ConfigureAwait(continueOnCapturedContext: false);
            ...
            int totalrow, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
                ...
                var res = new ConcurrentQueue<List<xC71_Identification_segment>>();
                    ...
                    //  for (int bat = 0; bat < batches; bat++)
                    {
                        try
                        {
                            using (var dbContext = new ValuationDSContext(){StartTracking = StartTracking})
                            {
                                ...
                                var set = AddIncludes(includesLst, dbContext);
                                IQueryable<xC71_Identification_segment> dset;
                                if (exp == "All")
                                {
            ...
            using ( var dbContext = new ValuationDSContext(){StartTracking = StartTracking})
              {
                try
                {   
                     var res = (xC71_Identification_segment) entity;
        ...
        public async Task<bool> DeletexC71_Identification_segment(string Identification_segment_Id)
        {
            try
            {
              ...
              {
                var i = Convert.ToInt32(Identification_segment_Id);
                xC71_Identification_segment entity = await dbContext.xC71_Identification_segment
        ...
        public async Task<bool> RemoveSelectedxC71_Identification_segment(IEnumerable<string> lst)
        {
            try
            {
                StatusModel.StartStatusUpdate("Removing xC71_Identification_segment", lst.Count());
                var t = Task.Run(() =>
                {
                    using (var ctx = new xC71_Identification_segmentService())
                    {
                        foreach (var item in lst.ToList())
                        {

                            ctx.DeletexC71_Identification_segment(item).Wait();
		...
		public async Task<int> Count(string exp)
        {
            try
            {
                using (ValuationDSContext dbContext = new ValuationDSContext(){StartTracking = StartTracking})
                {
                    ...
                    if (exp == "All")
                    {
                        return await dbContext.xC71_Identification_segment
                                    .AsNoTracking()
									.CountAsync()
									.ConfigureAwait(continueOnCapturedContext: false);
                    }
            ...
            try
            {
                ...
                using (var dbContext = new ValuationDSContext(){StartTracking = StartTracking})
                {
                    ...
                    foreach (var itm in navExp)
                    {
                        ...
                        {
                            case "xC71_Buyer_segment":
                                return await CountWhere<xC71_Buyer_segment>(dbContext, exp, itm.Value, "xC71_Identification_segment", "SelectMany")
											.ConfigureAwait(continueOnCapturedContext: false);
                            case "xC71_Declarant_segment":
                                return await CountWhere<xC71_Declarant_segment>(dbContext, exp, itm.Value, "xC71_Identification_segment", "SelectMany")
											.ConfigureAwait(continueOnCapturedContext: false);
                            case "xC71_Seller_segment":
                                return await CountWhere<xC71_Seller_segment>(dbContext, exp, itm.Value, "xC71_Identification_segment", "SelectMany")
											.ConfigureAwait(continueOnCapturedContext: false);
                            case "xC71_Value_declaration_form":
                                return await CountWhere<xC71_Value_declaration_form>(dbContext, exp, itm.Value, "xC71_Identification_segment", "SelectMany")
											.ConfigureAwait(continueOnCapturedContext: false);
						}
                    }
                    return await dbContext.xC71_Identification_segment.Where(exp == "All" || exp == null ? "Identification_segment_Id != null" : exp)
											.AsNoTracking()
                                            .CountAsync()
											.ConfigureAwait(continueOnCapturedContext: false);
                }
		...
		private static async Task<int> CountWhereSelect<T>(ValuationDSContext dbContext, string exp, string navExp, string navProp) where T : class
        {
		  ...
		  public async Task<IEnumerable<xC71_Identification_segment>> LoadRangeNav(int startIndex, int count, string exp,
                                                                                 Dictionary<string, string> navExp, IEnumerable<string> includeLst = null)
        {
            try
            {
                ...
                {
                    dbContext.Database.CommandTimeout = 0;
                    if ((string.IsNullOrEmpty(exp) && navExp.Count == 0) || exp == "None") return new List<xC71_Identification_segment>();
                    ...
                    foreach (var itm in navExp)
                    {
                        switch (itm.Key)
                        {
                            case "xC71_Buyer_segment":
                                return
                                    await
                                        LoadRangeWhere<xC71_Buyer_segment>(startIndex, count, dbContext, exp, itm.Value, "xC71_Identification_segment", "SelectMany")
													.ConfigureAwait(continueOnCapturedContext: false);

                            case "xC71_Declarant_segment":
                                return
                                    await
                                        LoadRangeWhere<xC71_Declarant_segment>(startIndex, count, dbContext, exp, itm.Value, "xC71_Identification_segment", "SelectMany")
													.ConfigureAwait(continueOnCapturedContext: false);

                            case "xC71_Seller_segment":
                                return
                                    await
                                        LoadRangeWhere<xC71_Seller_segment>(startIndex, count, dbContext, exp, itm.Value, "xC71_Identification_segment", "SelectMany")
													.ConfigureAwait(continueOnCapturedContext: false);

                            case "xC71_Value_declaration_form":
                                return
                                    await
                                        LoadRangeWhere<xC71_Value_declaration_form>(startIndex, count, dbContext, exp, itm.Value, "xC71_Identification_segment", "SelectMany")
													.ConfigureAwait(continueOnCapturedContext: false);
                    ...
                    return await set//dbContext.xC71_Identification_segment
								.AsNoTracking()
                                .Where(exp == "All" || exp == null ? "Identification_segment_Id != null" : exp)
								.OrderBy(y => y.Identification_segment_Id)
		...
		private static async Task<IEnumerable<xC71_Identification_segment>> LoadRangeWhere<T>(int startIndex, int count,
        ...
        private static async Task<IEnumerable<xC71_Identification_segment>> GetWhere<T>(ValuationDSContext dbContext,
             ...
             try
             {
                 using (var dbContext = new ValuationDSContext(){StartTracking = StartTracking})
                 {
					...
					decimal res = 0;
                     ...
                     if (whereExp == "All")
                     {
                          res = Convert.ToDecimal(dbContext.xC71_Identification_segment.AsNoTracking().Sum(field));
                     }
                     else
                     {
                         res = Convert.ToDecimal(dbContext.xC71_Identification_segment.AsNoTracking().Where(whereExp).Sum(field));
                     }
        ...
        public async Task<decimal> SumNav( string exp, Dictionary<string, string> navExp, string field)
        {
            try
            {
                ...
                {
                    dbContext.Database.CommandTimeout = 0;
                    if (!dbContext.xC71_Identification_segment.Any()) return 0;
                    if (exp == "All" && navExp.Count == 0)
                    {
                        return Convert.ToDecimal(dbContext.xC71_Identification_segment
										.AsNoTracking()
                                        .Sum(field)??0);
                    }
                    foreach (var itm in navExp)
                    {
                        ...
                        {
                            case "xC71_Buyer_segment":
                                return await SumWhere<xC71_Buyer_segment>(dbContext, exp, itm.Value, "xC71_Identification_segment", field, "SelectMany")
											.ConfigureAwait(continueOnCapturedContext: false);
                            case "xC71_Declarant_segment":
                                return await SumWhere<xC71_Declarant_segment>(dbContext, exp, itm.Value, "xC71_Identification_segment", field, "SelectMany")
											.ConfigureAwait(continueOnCapturedContext: false);
                            case "xC71_Seller_segment":
                                return await SumWhere<xC71_Seller_segment>(dbContext, exp, itm.Value, "xC71_Identification_segment", field, "SelectMany")
											.ConfigureAwait(continueOnCapturedContext: false);
                            case "xC71_Value_declaration_form":
                                return await SumWhere<xC71_Value_declaration_form>(dbContext, exp, itm.Value, "xC71_Identification_segment", field, "SelectMany")
											.ConfigureAwait(continueOnCapturedContext: false);
						}
                    }
                    return Convert.ToDecimal(dbContext.xC71_Identification_segment.Where(exp == "All" || exp == null ? "Identification_segment_Id != null" : exp)
											.AsNoTracking()
                                            .Sum(field)??0);
                }
             ...
             try
             {
                 using (var dbContext = new ValuationDSContext(){StartTracking = StartTracking})
                 {
					...
					string res = "";
                     ...
                     if (whereExp == "All")
                     {
                          res = Convert.ToString(dbContext.xC71_Identification_segment.AsNoTracking().Min(field));
                     }
                     else
                     {
                         res = Convert.ToString(dbContext.xC71_Identification_segment.AsNoTracking().Where(whereExp).Min(field));
                     }
		...
		private static IQueryable<xC71_Identification_segment> AddIncludes(IEnumerable<string> includesLst, ValuationDSContext dbContext)
       {
		 try
			{
			   if (includesLst == null) includesLst = new List<string>();
			   var set =(DbQuery<xC71_Identification_segment>) dbContext.xC71_Identification_segment; 
	   ...
	   private IQueryable<xC71_Identification_segment> AddWheres(List<string> expLst, IQueryable<xC71_Identification_segment> set)
        {
            try
            {
