...
namespace EntryDataDS.Business.Services
{
   ...
   [ServiceBehavior(InstanceContextMode = InstanceContextMode.PerCall,
    ...
    public partial class AttachmentsService : IAttachmentsService, IDisposable
    {
                    ...
                    foreach (var itm in navExp)
                    {
                        switch (itm.Key)
                        {
                            case "ShipmentAttachments":
                                return
                                    await
                                        GetWhere<ShipmentAttachments>(dbContext, exp, itm.Value, "Attachments", "Select", includesLst)
            ...
            try
            {
                ...
                using (var dbContext = new EntryDataDSContext(){StartTracking = StartTracking})
                {
                    ...
                    foreach (var itm in navExp)
                    {
                        ...
                        {
                            case "ShipmentAttachments":
                                return await CountWhere<ShipmentAttachments>(dbContext, exp, itm.Value, "Attachments", "Select")
											.ConfigureAwait(continueOnCapturedContext: false);
						}
                    }
                    ...
                    foreach (var itm in navExp)
                    {
                        switch (itm.Key)
                        {
                            case "ShipmentAttachments":
                                return
                                    await
                                        LoadRangeWhere<ShipmentAttachments>(startIndex, count, dbContext, exp, itm.Value, "Attachments", "Select")
													.ConfigureAwait(continueOnCapturedContext: false);
        ...
        private static async Task<IEnumerable<Attachments>> GetWhere<T>(EntryDataDSContext dbContext,
		...
		private static Task<IEnumerable<Attachments>> GetWhereSelectMany<T>(EntryDataDSContext dbContext,
		...
		private static Task<IEnumerable<Attachments>> GetWhereSelect<T>(EntryDataDSContext dbContext,
                                                                        string exp, string navExp, string navProp, List<string> includesLst = null) where T : class
        {
			try
			{
            ...
            try
            {
                ...
                using (var dbContext = new EntryDataDSContext(){StartTracking = StartTracking})
                {
                    ...
                    foreach (var itm in navExp)
                    {
                        ...
                        {
                            case "ShipmentAttachments":
                                return await SumWhere<ShipmentAttachments>(dbContext, exp, itm.Value, "Attachments", field, "Select")
											.ConfigureAwait(continueOnCapturedContext: false);
						}
                    }
		...
		private static IQueryable<Attachments> AddIncludes(IEnumerable<string> includesLst, EntryDataDSContext dbContext)
       {
		 try
			{
