...
namespace EntryDataDS.Business.Services
{
   ...
   [ServiceBehavior(InstanceContextMode = InstanceContextMode.PerCall,
    ...
    public partial class SuppliersService : ISuppliersService, IDisposable
    {
        ...
        public async Task<IEnumerable<Suppliers>> GetSuppliers(List<string> includesLst = null, bool tracking = true)
        {
            try
            {
            //using (var scope = new TransactionScope(TransactionScopeOption.Required,
               ...
               // {
                  using ( var dbContext = new EntryDataDSContext(){StartTracking = StartTracking})
                  {
                    ...
                    IEnumerable<Suppliers> entities = await set.AsNoTracking().ToListAsync()
        ...
        public async Task<Suppliers> GetSuppliersByKey(string SupplierCode, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
			   if(string.IsNullOrEmpty(SupplierCode))return null; 
              using ( var dbContext = new EntryDataDSContext(){StartTracking = StartTracking})
              {
                var i = SupplierCode;
				var set = AddIncludes(includesLst, dbContext);
                Suppliers entity = await set.AsNoTracking().SingleOrDefaultAsync(x => x.SupplierCode == i).ConfigureAwait(continueOnCapturedContext: false);
		 ...
		 public async Task<IEnumerable<Suppliers>> GetSuppliersByExpression(string exp, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
                using (var dbContext = new EntryDataDSContext(){StartTracking = StartTracking})
		 ...
		 public async Task<IEnumerable<Suppliers>> GetSuppliersByExpressionLst(List<string> expLst, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
                using (var dbContext = new EntryDataDSContext(){StartTracking = StartTracking})
                {
					if (expLst.Count == 0 || expLst.FirstOrDefault() == "None") return new List<Suppliers>();
					var set = AddIncludes(includesLst, dbContext);
        ...
        public async Task<IEnumerable<Suppliers>> GetSuppliersByBatch(string exp,
        ...
        public async Task<IEnumerable<Suppliers>> GetSuppliersByBatchExpressionLst(List<string> expLst,
            int totalrow, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
        ...
        public async Task<Suppliers> UpdateSuppliers(Suppliers entity)
        { 
            using ( var dbContext = new EntryDataDSContext(){StartTracking = StartTracking})
              {
                try
        ...
        public async Task<Suppliers> CreateSuppliers(Suppliers entity)
        {
            try
            {
                var res = (Suppliers) entity;
        ...
        public async Task<bool> DeleteSuppliers(string SupplierCode)
        {
            try
            {
              using ( var dbContext = new EntryDataDSContext(){StartTracking = StartTracking})
              {
                var i = SupplierCode;
                Suppliers entity = await dbContext.Suppliers
        ...
        public async Task<IEnumerable<Suppliers>> LoadRange(int startIndex, int count, string exp)
        {
            try
            {
                using (var dbContext = new EntryDataDSContext(){StartTracking = StartTracking})
		...
		public async Task<int> CountNav(string exp, Dictionary<string, string> navExp)
        {
            try
            {
                ...
                using (var dbContext = new EntryDataDSContext(){StartTracking = StartTracking})
                {
                    ...
                    return await dbContext.Suppliers.Where(exp == "All" || exp == null ? "SupplierCode != null" : exp)
											.AsNoTracking()
                                            .CountAsync()
											.ConfigureAwait(continueOnCapturedContext: false);
                }
                                                                                 ...
                                                                                 Dictionary<string, string> navExp, IEnumerable<string> includeLst = null)
        {
            try
            {
                using (var dbContext = new EntryDataDSContext(){StartTracking = StartTracking})
                {
                    ...
                    return await set//dbContext.Suppliers
								.AsNoTracking()
                                .Where(exp == "All" || exp == null ? "SupplierCode != null" : exp)
								.OrderBy(y => y.SupplierCode)
		...
		private static async Task<IEnumerable<Suppliers>> LoadRangeSelectMany<T>(int startIndex, int count,
		...
		private static async Task<IEnumerable<Suppliers>> LoadRangeSelect<T>(int startIndex, int count,
            EntryDataDSContext dbContext, string exp, string navExp, string navProp, IEnumerable<string> includeLst = null) where T : class
        {
			try
			{
		...
		private static async Task<IEnumerable<Suppliers>> GetWhereSelectMany<T>(EntryDataDSContext dbContext,
		...
		private static async Task<IEnumerable<Suppliers>> GetWhereSelect<T>(EntryDataDSContext dbContext,
            string exp, string navExp, string navProp, List<string> includesLst = null) where T : class
        {
			try
			{
			...
			catch (Exception)
			{
				...
				throw;
			        ...
			        public async Task<IEnumerable<Suppliers>> GetSuppliersByApplicationSettingsId(string ApplicationSettingsId, List<string> includesLst = null)
        {
            try
            {
                using ( var dbContext = new EntryDataDSContext(){StartTracking = StartTracking})
              {
                ...
                var set = AddIncludes(includesLst, dbContext);
                IEnumerable<Suppliers> entities = await set//dbContext.Suppliers
