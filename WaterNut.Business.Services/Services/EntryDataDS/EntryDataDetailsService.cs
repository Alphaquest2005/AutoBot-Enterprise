...
namespace EntryDataDS.Business.Services
{
   ...
   [ServiceBehavior(InstanceContextMode = InstanceContextMode.PerCall,
    ...
    public partial class EntryDataDetailsService : IEntryDataDetailsService, IDisposable
    {
        ...
        public Task<IEnumerable<EntryDataDetails>> GetEntryDataDetails(List<string> includesLst = null, bool tracking = true)
        {
            try
            {
        ...
        public Task<EntryDataDetails> GetEntryDataDetailsByKey(string EntryDataDetailsId, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
			   if(string.IsNullOrEmpty(EntryDataDetailsId))return Task.FromResult<EntryDataDetails>(null); 
              using ( var dbContext = new EntryDataDSContext(){StartTracking = StartTracking})
              {
		 ...
		 public Task<IEnumerable<EntryDataDetails>> GetEntryDataDetailsByExpression(string exp, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
                using (var dbContext = new EntryDataDSContext(){StartTracking = StartTracking})
                {
					...
					if (string.IsNullOrEmpty(exp) || exp == "None") return Task.FromResult<IEnumerable<EntryDataDetails>>(new List<EntryDataDetails>());
					var set = AddIncludes(includesLst, dbContext);
                    if (exp == "All")
                    {
                        ...
                        if(tracking) entities.AsParallel(new ParallelLinqOptions() { MaxDegreeOfParallelism = Environment.ProcessorCount }).ForAll(x => x.StartTracking());
                        return Task.FromResult<IEnumerable<EntryDataDetails>>(entities); 
                    }
					else
					{
		 ...
		 public Task<IEnumerable<EntryDataDetails>> GetEntryDataDetailsByExpressionLst(List<string> expLst, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
                using (var dbContext = new EntryDataDSContext(){StartTracking = StartTracking})
                {
                    dbContext.Database.CommandTimeout = 0;
					if (expLst.Count == 0 || expLst.FirstOrDefault() == "None") return Task.FromResult<IEnumerable<EntryDataDetails>>(new List<EntryDataDetails>());
					var set = AddIncludes(includesLst, dbContext);
        ...
        public Task<IEnumerable<EntryDataDetails>> GetEntryDataDetailsByBatch(string exp,
        ...
        public Task<IEnumerable<EntryDataDetails>> GetEntryDataDetailsByBatchExpressionLst(List<string> expLst,
                                                                                           int totalrow, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
        ...
        public Task<EntryDataDetails> UpdateEntryDataDetails(EntryDataDetails entity)
        { 
            using ( var dbContext = new EntryDataDSContext(){StartTracking = StartTracking})
              {
                try
        ...
        public Task<EntryDataDetails> CreateEntryDataDetails(EntryDataDetails entity)
        {
            try
            {
                var res = (EntryDataDetails) entity;
        ...
        public Task<bool> DeleteEntryDataDetails(string EntryDataDetailsId)
        {
            try
            {
              using ( var dbContext = new EntryDataDSContext(){StartTracking = StartTracking})
		...
		public Task<int> Count(string exp)
        {
            try
            {
                using (EntryDataDSContext dbContext = new EntryDataDSContext(){StartTracking = StartTracking})
                {
                    ...
                    if (exp == "All")
                    {
                        return Task.FromResult(dbContext.EntryDataDetails
                            .AsNoTracking()
                            .Count());
                    }
                    else
        ...
        public Task<IEnumerable<EntryDataDetails>> LoadRange(int startIndex, int count, string exp)
        {
            try
            {
                using (var dbContext = new EntryDataDSContext(){StartTracking = StartTracking})
                {
                    ...
                    if (exp == "All")
                    {
                        return Task.FromResult<IEnumerable<EntryDataDetails>>(dbContext.EntryDataDetails
                            .AsNoTracking()
		...
		private static Task<IEnumerable<EntryDataDetails>> LoadRangeSelectMany<T>(int startIndex, int count,
                                                                                  EntryDataDSContext dbContext, string exp, string navExp, string navProp, IEnumerable<string> includeLst = null) where T : class
        {
            ...
            return Task.FromResult<IEnumerable<EntryDataDetails>>(set
                .Where(exp == "All" || exp == null ? "EntryDataDetailsId != null" : exp)
                .Distinct()
                .OrderBy(y => y.EntryDataDetailsId)
		...
		private static Task<IEnumerable<EntryDataDetails>> LoadRangeSelect<T>(int startIndex, int count,
                                                                              EntryDataDSContext dbContext, string exp, string navExp, string navProp, IEnumerable<string> includeLst = null) where T : class
        {
			try
			{
		...
		private static Task<IEnumerable<EntryDataDetails>> GetWhereSelectMany<T>(EntryDataDSContext dbContext,
                                                                                 string exp, string navExp, string navProp, List<string> includesLst = null) where T : class
        {
			...
			if (includesLst == null)
			{
				return Task.FromResult<IEnumerable<EntryDataDetails>>(dbContext.Set<T>()
                    .AsNoTracking()
                    .Where(navExp)
                    .SelectMany(navProp).OfType<EntryDataDetails>()
                    .Where(exp == "All" || exp == null?"EntryDataDetailsId != null":exp)
            ...
            return Task.FromResult<IEnumerable<EntryDataDetails>>(set.ToList());
			}
			catch (Exception)
			{
				Debugger.Break();
		...
		private static Task<IEnumerable<EntryDataDetails>> GetWhereSelect<T>(EntryDataDSContext dbContext,
                                                                             string exp, string navExp, string navProp, List<string> includesLst = null) where T : class
        {
			try
			{
			...
			catch (Exception)
			{
				...
				throw;
			        ...
			        public Task<IEnumerable<EntryDataDetails>> GetEntryDataDetailsByEntryDataId(string EntryDataId, List<string> includesLst = null)
        {
            try
            {
                using ( var dbContext = new EntryDataDSContext(){StartTracking = StartTracking})
            ...
            catch (Exception updateEx)
            {
 	        ...
 	        public Task<IEnumerable<EntryDataDetails>> GetEntryDataDetailsByInventoryItemId(string InventoryItemId, List<string> includesLst = null)
        {
            try
            {
                using ( var dbContext = new EntryDataDSContext(){StartTracking = StartTracking})
            ...
            catch (Exception updateEx)
            {
 	        ...
 	        public Task<IEnumerable<EntryDataDetails>> GetEntryDataDetailsByEntryData_Id(string EntryData_Id, List<string> includesLst = null)
        {
            try
            {
                using ( var dbContext = new EntryDataDSContext(){StartTracking = StartTracking})
