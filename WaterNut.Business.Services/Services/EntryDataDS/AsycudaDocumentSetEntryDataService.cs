...
namespace EntryDataDS.Business.Services
{
   ...
   [ServiceBehavior(InstanceContextMode = InstanceContextMode.PerCall,
    ...
    public partial class AsycudaDocumentSetEntryDataService : IAsycudaDocumentSetEntryDataService, IDisposable
    {
		...
		private static Task<IEnumerable<AsycudaDocumentSetEntryData>> GetWhereSelectMany<T>(EntryDataDSContext dbContext,
		...
		private static Task<IEnumerable<AsycudaDocumentSetEntryData>> GetWhereSelect<T>(EntryDataDSContext dbContext,
                                                                                        string exp, string navExp, string navProp, List<string> includesLst = null) where T : class
        {
			try
			{
