...
namespace EntryDataDS.Business.Services
{
   ...
   [ServiceBehavior(InstanceContextMode = InstanceContextMode.PerCall,
    ...
    public partial class InvoicesService : IInvoicesService, IDisposable
    {
        ...
        public async Task<Invoices> GetInvoicesByKey(string EntryDataId, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
              ...
              using ( var dbContext = new EntryDataDSContext(){StartTracking = StartTracking})
              {
                var i = EntryDataId;
				var set = AddIncludes(includesLst, dbContext);
                Invoices entity = await set.AsNoTracking().SingleOrDefaultAsync(x => x.EntryDataId == i).ConfigureAwait(continueOnCapturedContext: false);
        ...
        public async Task<bool> DeleteInvoices(string EntryDataId)
        {
            try
            {
              using ( var dbContext = new EntryDataDSContext(){StartTracking = StartTracking})
		...
		public async Task<int> CountNav(string exp, Dictionary<string, string> navExp)
        {
            try
            {
                ...
                using (var dbContext = new EntryDataDSContext(){StartTracking = StartTracking})
                {
                    ...
                    return await dbContext.Set<Invoices>().Where(exp == "All" || exp == null ? "EntryDataId != null" : exp)
											.AsNoTracking()
                                            .CountAsync()
											.ConfigureAwait(continueOnCapturedContext: false);
                }
        ...
        public async Task<decimal> SumNav( string exp, Dictionary<string, string> navExp, string field)
        {
            try
            {
                ...
                using (var dbContext = new EntryDataDSContext(){StartTracking = StartTracking})
                {
                    ...
                    return Convert.ToDecimal(dbContext.Set<Invoices>().Where(exp == "All" || exp == null ? "EntryDataId != null" : exp)
											.AsNoTracking()
                                            .Sum(field)??0);
                }
