...
namespace EntryDataDS.Business.Services
{
   ...
   [ServiceBehavior(InstanceContextMode = InstanceContextMode.PerCall,
    ...
    public partial class InvoicesService : IInvoicesService, IDisposable
    {
        ...
        public Task<IEnumerable<Invoices>> GetEntryData(List<string> includesLst = null, bool tracking = true)
        {
            try
            {
        ...
        public Task<Invoices> GetInvoicesByKey(string EntryData_Id, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
			   if(string.IsNullOrEmpty(EntryData_Id))return Task.FromResult<Invoices>(null); 
              using ( var dbContext = new EntryDataDSContext(){StartTracking = StartTracking})
              {
		 ...
		 public Task<IEnumerable<Invoices>> GetEntryDataByExpression(string exp, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
                using (var dbContext = new EntryDataDSContext(){StartTracking = StartTracking})
                {
					...
					if (string.IsNullOrEmpty(exp) || exp == "None") return Task.FromResult<IEnumerable<Invoices>>(new List<Invoices>());
					var set = AddIncludes(includesLst, dbContext);
                    if (exp == "All")
                    {
                        ...
                        if(tracking) entities.AsParallel(new ParallelLinqOptions() { MaxDegreeOfParallelism = Environment.ProcessorCount }).ForAll(x => x.StartTracking());
                        return Task.FromResult<IEnumerable<Invoices>>(entities); 
                    }
					else
					{
		 ...
		 public Task<IEnumerable<Invoices>> GetEntryDataByExpressionLst(List<string> expLst, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
                using (var dbContext = new EntryDataDSContext(){StartTracking = StartTracking})
                {
                    dbContext.Database.CommandTimeout = 0;
					if (expLst.Count == 0 || expLst.FirstOrDefault() == "None") return Task.FromResult<IEnumerable<Invoices>>(new List<Invoices>());
					var set = AddIncludes(includesLst, dbContext);
        ...
        public Task<IEnumerable<Invoices>> GetEntryDataByBatch(string exp,
        ...
        public Task<IEnumerable<Invoices>> GetEntryDataByBatchExpressionLst(List<string> expLst,
                                                                            int totalrow, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
        ...
        public Task<Invoices> UpdateInvoices(Invoices entity)
        { 
            using ( var dbContext = new EntryDataDSContext(){StartTracking = StartTracking})
              {
                try
        ...
        public Task<Invoices> CreateInvoices(Invoices entity)
        {
            try
            {
                var res = (Invoices) entity;
        ...
        public Task<bool> DeleteInvoices(string EntryData_Id)
        {
            try
            {
              using ( var dbContext = new EntryDataDSContext(){StartTracking = StartTracking})
		...
		public Task<int> Count(string exp)
        {
            try
            {
                using (EntryDataDSContext dbContext = new EntryDataDSContext(){StartTracking = StartTracking})
                {
                    ...
                    if (exp == "All")
                    {
                        return Task.FromResult(dbContext.Set<Invoices>()
                            .AsNoTracking()
                            .Count());
                    }
                    else
        ...
        public Task<IEnumerable<Invoices>> LoadRange(int startIndex, int count, string exp)
        {
            try
            {
                using (var dbContext = new EntryDataDSContext(){StartTracking = StartTracking})
                {
                    ...
                    if (exp == "All")
                    {
                        return Task.FromResult<IEnumerable<Invoices>>(dbContext.Set<Invoices>()
                            .AsNoTracking()
		...
		private static Task<IEnumerable<Invoices>> LoadRangeSelectMany<T>(int startIndex, int count,
                                                                          EntryDataDSContext dbContext, string exp, string navExp, string navProp, IEnumerable<string> includeLst = null) where T : class
        {
            ...
            return Task.FromResult<IEnumerable<Invoices>>(set
                .Where(exp == "All" || exp == null ? "EntryData_Id != null" : exp)
                .Distinct()
                .OrderBy(y => y.EntryData_Id)
		...
		private static Task<IEnumerable<Invoices>> LoadRangeSelect<T>(int startIndex, int count,
                                                                      EntryDataDSContext dbContext, string exp, string navExp, string navProp, IEnumerable<string> includeLst = null) where T : class
        {
			try
			{
		...
		private static Task<IEnumerable<Invoices>> GetWhereSelectMany<T>(EntryDataDSContext dbContext,
                                                                         string exp, string navExp, string navProp, List<string> includesLst = null) where T : class
        {
			...
			if (includesLst == null)
			{
				return Task.FromResult<IEnumerable<Invoices>>(dbContext.Set<T>()
                    .AsNoTracking()
                    .Where(navExp)
                    .SelectMany(navProp).OfType<Invoices>()
                    .Where(exp == "All" || exp == null?"EntryData_Id != null":exp)
            ...
            return Task.FromResult<IEnumerable<Invoices>>(set.ToList());
			}
			catch (Exception)
			{
				Debugger.Break();
		...
		private static Task<IEnumerable<Invoices>> GetWhereSelect<T>(EntryDataDSContext dbContext,
                                                                     string exp, string navExp, string navProp, List<string> includesLst = null) where T : class
        {
			try
			{
			...
			catch (Exception)
			{
				...
				throw;
			        ...
			        public Task<IEnumerable<Invoices>> GetInvoicesByEntryDataId(string EntryDataId, List<string> includesLst = null)
        {
            try
            {
                using ( var dbContext = new EntryDataDSContext(){StartTracking = StartTracking})
            ...
            catch (Exception updateEx)
            {
 	        ...
 	        public Task<IEnumerable<Invoices>> GetInvoicesByApplicationSettingsId(string ApplicationSettingsId, List<string> includesLst = null)
        {
            try
            {
                using ( var dbContext = new EntryDataDSContext(){StartTracking = StartTracking})
            ...
            catch (Exception updateEx)
            {
 	        ...
 	        public Task<IEnumerable<Invoices>> GetInvoicesByEmailId(string EmailId, List<string> includesLst = null)
        {
            try
            {
                using ( var dbContext = new EntryDataDSContext(){StartTracking = StartTracking})
            ...
            catch (Exception updateEx)
            {
 	        ...
 	        public Task<IEnumerable<Invoices>> GetInvoicesByFileTypeId(string FileTypeId, List<string> includesLst = null)
        {
            try
            {
                using ( var dbContext = new EntryDataDSContext(){StartTracking = StartTracking})
