...
{
   [Export (typeof(IInvoiceVolumeService))]
   [Export(typeof(IBusinessService))]
   [PartCreationPolicy(CreationPolicy.NonShared)]
   [ServiceBehavior(InstanceContextMode = InstanceContextMode.PerCall,
                    ConcurrencyMode = ConcurrencyMode.Multiple)]
   
    public partial class InvoiceVolumeService : IInvoiceVolumeService, IDisposable
    {
        //private readonly EntryDataDSContext dbContext;

        public bool StartTracking { get; set; }

        public InvoiceVolumeService()
        {
            try
            {
        ...
        public async Task<IEnumerable<InvoiceVolume>> GetInvoiceVolume(List<string> includesLst = null, bool tracking = true)
        {
            try
            {
            //using (var scope = new TransactionScope(TransactionScopeOption.Required,
               ...
               // {
                  using ( var dbContext = new EntryDataDSContext(){StartTracking = StartTracking})
                  {
                    ...
                    IEnumerable<InvoiceVolume> entities = await set.AsNoTracking().ToListAsync()
        ...
        public async Task<InvoiceVolume> GetInvoiceVolumeByKey(string Id, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
              ...
              using ( var dbContext = new EntryDataDSContext(){StartTracking = StartTracking})
              {
				...
				var set = AddIncludes(includesLst, dbContext);
                InvoiceVolume entity = await set.AsNoTracking().SingleOrDefaultAsync(x => x.Id == i).ConfigureAwait(continueOnCapturedContext: false);
		 ...
		 public async Task<IEnumerable<InvoiceVolume>> GetInvoiceVolumeByExpression(string exp, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
                using (var dbContext = new EntryDataDSContext(){StartTracking = StartTracking})
                {
					...
					if (string.IsNullOrEmpty(exp) || exp == "None") return new List<InvoiceVolume>();
					var set = AddIncludes(includesLst, dbContext);
                    if (exp == "All")
                    {
		 ...
		 public async Task<IEnumerable<InvoiceVolume>> GetInvoiceVolumeByExpressionLst(List<string> expLst, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
                using (var dbContext = new EntryDataDSContext(){StartTracking = StartTracking})
                {
                    dbContext.Database.CommandTimeout = 0;
					if (expLst.Count == 0 || expLst.FirstOrDefault() == "None") return new List<InvoiceVolume>();
					var set = AddIncludes(includesLst, dbContext);
		...
		public async Task<IEnumerable<InvoiceVolume>> GetInvoiceVolumeByExpressionNav(string exp,
                    ...
                    foreach (var itm in navExp)
                    {
                        switch (itm.Key)
                        {
                            case "ShipmentInvoice":
                                return
                                    await
                                        GetWhere<ShipmentInvoice>(dbContext, exp, itm.Value, "TotalVolume", "SelectMany", includesLst)
										.ConfigureAwait(continueOnCapturedContext: false);
        ...
        public async Task<IEnumerable<InvoiceVolume>> GetInvoiceVolumeByBatch(string exp,
            int totalrow, List<string> includesLst = null, bool tracking = true)
        {
            try
            {

                var res = new ConcurrentQueue<List<InvoiceVolume>>();
        ...
        public async Task<IEnumerable<InvoiceVolume>> GetInvoiceVolumeByBatchExpressionLst(List<string> expLst,
            int totalrow, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
        ...
        public async Task<InvoiceVolume> UpdateInvoiceVolume(InvoiceVolume entity)
        { 
            using ( var dbContext = new EntryDataDSContext(){StartTracking = StartTracking})
              {
                try
                {   
                     var res = (InvoiceVolume) entity;
        ...
        public async Task<InvoiceVolume> CreateInvoiceVolume(InvoiceVolume entity)
        {
            try
            {
                var res = (InvoiceVolume) entity;
              using ( var dbContext = new EntryDataDSContext(){StartTracking = StartTracking})
              {
                dbContext.InvoiceVolume.Add(res);
                await dbContext.SaveChangesAsync().ConfigureAwait(continueOnCapturedContext: false);
                res.AcceptChanges();
                return res;
              }
        ...
        public async Task<bool> DeleteInvoiceVolume(string Id)
        {
            try
            {
              using ( var dbContext = new EntryDataDSContext(){StartTracking = StartTracking})
              {
                var i = Convert.ToInt32(Id);
                InvoiceVolume entity = await dbContext.InvoiceVolume
													.SingleOrDefaultAsync(x => x.Id == i)
													.ConfigureAwait(continueOnCapturedContext: false);
                if (entity == null)
                    return false;

                    dbContext.InvoiceVolume.Attach(entity);
                    dbContext.InvoiceVolume.Remove(entity);
                    await dbContext.SaveChangesAsync().ConfigureAwait(continueOnCapturedContext: false);
                    return true;
              }
            }
        ...
        public async Task<bool> RemoveSelectedInvoiceVolume(IEnumerable<string> lst)
        {
            try
            {
                StatusModel.StartStatusUpdate("Removing InvoiceVolume", lst.Count());
                var t = Task.Run(() =>
                {
                    using (var ctx = new InvoiceVolumeService())
                    {
                        foreach (var item in lst.ToList())
                        {

                            ctx.DeleteInvoiceVolume(item).Wait();
         ...
         public async Task<int> CountByExpressionLst(List<string> expLst)
        {
            try
            {
                using (var dbContext = new EntryDataDSContext(){StartTracking = StartTracking})
                {
                    ...
                    var set = (IQueryable<InvoiceVolume>)dbContext.InvoiceVolume; 
                    if (expLst.FirstOrDefault() == "All")
                    {
		...
		public async Task<int> Count(string exp)
        {
            try
            {
                using (EntryDataDSContext dbContext = new EntryDataDSContext(){StartTracking = StartTracking})
                {
                    ...
                    if (exp == "All")
                    {
                        return await dbContext.InvoiceVolume
                                    .AsNoTracking()
									.CountAsync()
									.ConfigureAwait(continueOnCapturedContext: false);
                    }
        ...
        public async Task<IEnumerable<InvoiceVolume>> LoadRange(int startIndex, int count, string exp)
        {
            try
            {
                using (var dbContext = new EntryDataDSContext(){StartTracking = StartTracking})
            ...
            try
            {
                ...
                using (var dbContext = new EntryDataDSContext(){StartTracking = StartTracking})
                {
                    ...
                    foreach (var itm in navExp)
                    {
                        ...
                        {
                            case "ShipmentInvoice":
                                return await CountWhere<ShipmentInvoice>(dbContext, exp, itm.Value, "TotalVolume", "SelectMany")
											.ConfigureAwait(continueOnCapturedContext: false);
						}
                    }
                    return await dbContext.InvoiceVolume.Where(exp == "All" || exp == null ? "Id != null" : exp)
											.AsNoTracking()
                                            .CountAsync()
											.ConfigureAwait(continueOnCapturedContext: false);
                }
		...
		private static async Task<int> CountWhereSelectMany<T>(EntryDataDSContext dbContext, string exp, string navExp, string navProp) where T : class
        {
            ...
            return await dbContext.Set<T>()
				.AsNoTracking()
                .Where(navExp)
                .SelectMany(navProp).OfType<InvoiceVolume>()
		...
		private static async Task<int> CountWhereSelect<T>(EntryDataDSContext dbContext, string exp, string navExp, string navProp) where T : class
        {
            ...
            return await dbContext.Set<T>()
				.AsNoTracking()
                .Where(navExp)
                .Select(navProp).OfType<InvoiceVolume>()
                .Where(exp == "All" || exp == null ? "Id != null" : exp)
                .Distinct()
                .OrderBy("Id")
                .CountAsync()
		  ...
		  public async Task<IEnumerable<InvoiceVolume>> LoadRangeNav(int startIndex, int count, string exp,
                                                                                 Dictionary<string, string> navExp, IEnumerable<string> includeLst = null)
        {
            try
            {
                ...
                {
                    dbContext.Database.CommandTimeout = 0;
                    if ((string.IsNullOrEmpty(exp) && navExp.Count == 0) || exp == "None") return new List<InvoiceVolume>();
                    ...
                    foreach (var itm in navExp)
                    {
                        switch (itm.Key)
                        {
                            case "ShipmentInvoice":
                                return
                                    await
                                        LoadRangeWhere<ShipmentInvoice>(startIndex, count, dbContext, exp, itm.Value, "TotalVolume", "SelectMany")
													.ConfigureAwait(continueOnCapturedContext: false);
                    ...
                    return await set//dbContext.InvoiceVolume
								.AsNoTracking()
                                .Where(exp == "All" || exp == null ? "Id != null" : exp)
								.OrderBy(y => y.Id)
		...
		private static async Task<IEnumerable<InvoiceVolume>> LoadRangeWhere<T>(int startIndex, int count,
		...
		private static async Task<IEnumerable<InvoiceVolume>> LoadRangeSelectMany<T>(int startIndex, int count,
		...
		private static async Task<IEnumerable<InvoiceVolume>> LoadRangeSelect<T>(int startIndex, int count,
            EntryDataDSContext dbContext, string exp, string navExp, string navProp, IEnumerable<string> includeLst = null) where T : class
        {
			try
			{
        ...
        private static async Task<IEnumerable<InvoiceVolume>> GetWhere<T>(EntryDataDSContext dbContext,
		...
		private static async Task<IEnumerable<InvoiceVolume>> GetWhereSelectMany<T>(EntryDataDSContext dbContext,
            string exp, string navExp, string navProp, List<string> includesLst = null) where T : class
        {
			...
			var set = (DbQuery<InvoiceVolume>)dbContext.Set<T>()
				.AsNoTracking()
                .Where(navExp)
                .SelectMany(navProp).OfType<InvoiceVolume>()
                .Where(exp == "All" || exp == null?"Id != null":exp)
		...
		private static async Task<IEnumerable<InvoiceVolume>> GetWhereSelect<T>(EntryDataDSContext dbContext,
            string exp, string navExp, string navProp, List<string> includesLst = null) where T : class
        {
			try
			{
             ...
             try
             {
                 using (var dbContext = new EntryDataDSContext(){StartTracking = StartTracking})
                 {
					...
					decimal res = 0;
                     ...
                     if (whereExp == "All")
                     {
                          res = Convert.ToDecimal(dbContext.InvoiceVolume.AsNoTracking().Sum(field));
                     }
                     else
                     {
                         res = Convert.ToDecimal(dbContext.InvoiceVolume.AsNoTracking().Where(whereExp).Sum(field));
                     }
        ...
        public async Task<decimal> SumNav( string exp, Dictionary<string, string> navExp, string field)
        {
            try
            {
                ...
                {
                    dbContext.Database.CommandTimeout = 0;
                    if (!dbContext.InvoiceVolume.Any()) return 0;
                    if (exp == "All" && navExp.Count == 0)
                    {
                        return Convert.ToDecimal(dbContext.InvoiceVolume
										.AsNoTracking()
                                        .Sum(field)??0);
                    }
                    foreach (var itm in navExp)
                    {
                        ...
                        {
                            case "ShipmentInvoice":
                                return await SumWhere<ShipmentInvoice>(dbContext, exp, itm.Value, "TotalVolume", field, "SelectMany")
											.ConfigureAwait(continueOnCapturedContext: false);
						}
                    }
                    return Convert.ToDecimal(dbContext.InvoiceVolume.Where(exp == "All" || exp == null ? "Id != null" : exp)
											.AsNoTracking()
                                            .Sum(field)??0);
                }
             ...
             try
             {
                 using (var dbContext = new EntryDataDSContext(){StartTracking = StartTracking})
                 {
					...
					string res = "";
                     ...
                     if (whereExp == "All")
                     {
                          res = Convert.ToString(dbContext.InvoiceVolume.AsNoTracking().Min(field));
                     }
                     else
                     {
                         res = Convert.ToString(dbContext.InvoiceVolume.AsNoTracking().Where(whereExp).Min(field));
                     }
		...
		private static IQueryable<InvoiceVolume> AddIncludes(IEnumerable<string> includesLst, EntryDataDSContext dbContext)
       {
		 try
			{
			   if (includesLst == null) includesLst = new List<string>();
			   var set =(DbQuery<InvoiceVolume>) dbContext.InvoiceVolume; 
	   ...
	   private IQueryable<InvoiceVolume> AddWheres(List<string> expLst, IQueryable<InvoiceVolume> set)
        {
            try
            {
