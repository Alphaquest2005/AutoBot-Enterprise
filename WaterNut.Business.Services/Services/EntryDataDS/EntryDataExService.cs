...
namespace EntryDataDS.Business.Services
{
   ...
   [ServiceBehavior(InstanceContextMode = InstanceContextMode.PerCall,
    ...
    public partial class EntryDataExService : IEntryDataExService, IDisposable
    {
                    ...
                    foreach (var itm in navExp)
                    {
                        switch (itm.Key)
                        {
                            case "EntryData":
                                return
                                    await
                                        GetWhere<EntryData>(dbContext, exp, itm.Value, "EntryDataEx", "SelectMany", includesLst)
            ...
            try
            {
                ...
                using (var dbContext = new EntryDataDSContext(){StartTracking = StartTracking})
                {
                    ...
                    foreach (var itm in navExp)
                    {
                        ...
                        {
                            case "EntryData":
                                return await CountWhere<EntryData>(dbContext, exp, itm.Value, "EntryDataEx", "SelectMany")
											.ConfigureAwait(continueOnCapturedContext: false);
						}
                    }
                    return dbContext.EntryDataEx.Where(exp == "All" || exp == null ? "EntryData_Id != null" : exp)
											.AsNoTracking()
                                            .Count();
                }
                                                                                 ...
                                                                                 Dictionary<string, string> navExp, IEnumerable<string> includeLst = null)
        {
            try
            {
                using (var dbContext = new EntryDataDSContext(){StartTracking = StartTracking})
                {
                    ...
                    foreach (var itm in navExp)
                    {
                        switch (itm.Key)
                        {
                            case "EntryData":
                                return
                                    await
                                        LoadRangeWhere<EntryData>(startIndex, count, dbContext, exp, itm.Value, "EntryDataEx", "SelectMany")
													.ConfigureAwait(continueOnCapturedContext: false);
                    ...
                    return set//dbContext.EntryDataEx
								.AsNoTracking()
                                .Where(exp == "All" || exp == null ? "EntryData_Id != null" : exp)
								.OrderBy(y => y.EntryData_Id)
        ...
        private static async Task<IEnumerable<EntryDataEx>> GetWhere<T>(EntryDataDSContext dbContext,
		...
		private static Task<IEnumerable<EntryDataEx>> GetWhereSelectMany<T>(EntryDataDSContext dbContext,
		...
		private static Task<IEnumerable<EntryDataEx>> GetWhereSelect<T>(EntryDataDSContext dbContext,
                                                                        string exp, string navExp, string navProp, List<string> includesLst = null) where T : class
        {
			try
			{
			        ...
			        public Task<IEnumerable<EntryDataEx>> GetEntryDataExByApplicationSettingsId(string ApplicationSettingsId, List<string> includesLst = null)
        {
            try
            {
                using ( var dbContext = new EntryDataDSContext(){StartTracking = StartTracking})
              {
                ...
                var set = AddIncludes(includesLst, dbContext);
                IEnumerable<EntryDataEx> entities = set//dbContext.EntryDataEx
                                      .AsNoTracking()
            ...
            try
            {
                ...
                using (var dbContext = new EntryDataDSContext(){StartTracking = StartTracking})
                {
                    ...
                    foreach (var itm in navExp)
                    {
                        ...
                        {
                            case "EntryData":
                                return await SumWhere<EntryData>(dbContext, exp, itm.Value, "EntryDataEx", field, "SelectMany")
											.ConfigureAwait(continueOnCapturedContext: false);
						}
                    }
                    return Convert.ToDecimal(dbContext.EntryDataEx.Where(exp == "All" || exp == null ? "EntryData_Id != null" : exp)
											.AsNoTracking()
                                            .Sum(field)??0);
                }
		...
		private static IQueryable<EntryDataEx> AddIncludes(IEnumerable<string> includesLst, EntryDataDSContext dbContext)
       {
		 try
			{
