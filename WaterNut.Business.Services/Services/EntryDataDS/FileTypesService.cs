...
namespace EntryDataDS.Business.Services
{
   ...
   [ServiceBehavior(InstanceContextMode = InstanceContextMode.PerCall,
    ...
    public partial class FileTypesService : IFileTypesService, IDisposable
    {
        ...
        private static async Task<IEnumerable<FileTypes>> GetWhere<T>(EntryDataDSContext dbContext,
		...
		private static Task<IEnumerable<FileTypes>> GetWhereSelectMany<T>(EntryDataDSContext dbContext,
		...
		private static Task<IEnumerable<FileTypes>> GetWhereSelect<T>(EntryDataDSContext dbContext,
                                                                      string exp, string navExp, string navProp, List<string> includesLst = null) where T : class
        {
			try
			{
		...
		private static IQueryable<FileTypes> AddIncludes(IEnumerable<string> includesLst, EntryDataDSContext dbContext)
       {
		 try
			{
