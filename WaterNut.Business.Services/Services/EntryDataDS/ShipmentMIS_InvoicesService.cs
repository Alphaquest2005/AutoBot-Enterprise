...
namespace EntryDataDS.Business.Services
{
   ...
   [ServiceBehavior(InstanceContextMode = InstanceContextMode.PerCall,
    ...
    public partial class ShipmentMIS_InvoicesService : IShipmentMIS_InvoicesService, IDisposable
    {
        ...
        public async Task<IEnumerable<ShipmentMIS_Invoices>> GetShipmentMIS_Invoices(List<string> includesLst = null, bool tracking = true)
        {
            try
            {
            //using (var scope = new TransactionScope(TransactionScopeOption.Required,
               ...
               // {
                  using ( var dbContext = new EntryDataDSContext(){StartTracking = StartTracking})
                  {
                    ...
                    IEnumerable<ShipmentMIS_Invoices> entities = await set.AsNoTracking().ToListAsync()
        ...
        public async Task<ShipmentMIS_Invoices> GetShipmentMIS_InvoicesByKey(string Id, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
              ...
              using ( var dbContext = new EntryDataDSContext(){StartTracking = StartTracking})
              {
				...
				var set = AddIncludes(includesLst, dbContext);
                ShipmentMIS_Invoices entity = await set.AsNoTracking().SingleOrDefaultAsync(x => x.Id == i).ConfigureAwait(continueOnCapturedContext: false);
		 ...
		 public async Task<IEnumerable<ShipmentMIS_Invoices>> GetShipmentMIS_InvoicesByExpression(string exp, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
                using (var dbContext = new EntryDataDSContext(){StartTracking = StartTracking})
                {
					...
					if (string.IsNullOrEmpty(exp) || exp == "None") return new List<ShipmentMIS_Invoices>();
					var set = AddIncludes(includesLst, dbContext);
                    if (exp == "All")
                    {
		 ...
		 public async Task<IEnumerable<ShipmentMIS_Invoices>> GetShipmentMIS_InvoicesByExpressionLst(List<string> expLst, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
                using (var dbContext = new EntryDataDSContext(){StartTracking = StartTracking})
                {
                    dbContext.Database.CommandTimeout = 0;
					if (expLst.Count == 0 || expLst.FirstOrDefault() == "None") return new List<ShipmentMIS_Invoices>();
					var set = AddIncludes(includesLst, dbContext);
		...
		public async Task<IEnumerable<ShipmentMIS_Invoices>> GetShipmentMIS_InvoicesByExpressionNav(string exp,
        ...
        public async Task<IEnumerable<ShipmentMIS_Invoices>> GetShipmentMIS_InvoicesByBatch(string exp,
        ...
        public async Task<IEnumerable<ShipmentMIS_Invoices>> GetShipmentMIS_InvoicesByBatchExpressionLst(List<string> expLst,
            int totalrow, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
        ...
        public async Task<ShipmentMIS_Invoices> UpdateShipmentMIS_Invoices(ShipmentMIS_Invoices entity)
        { 
            using ( var dbContext = new EntryDataDSContext(){StartTracking = StartTracking})
              {
                try
        ...
        public async Task<ShipmentMIS_Invoices> CreateShipmentMIS_Invoices(ShipmentMIS_Invoices entity)
        {
            try
            {
                var res = (ShipmentMIS_Invoices) entity;
        ...
        public async Task<bool> DeleteShipmentMIS_Invoices(string Id)
        {
            try
            {
              using ( var dbContext = new EntryDataDSContext(){StartTracking = StartTracking})
              {
                var i = Convert.ToInt32(Id);
                ShipmentMIS_Invoices entity = await dbContext.ShipmentMIS_Invoices
		...
		public async Task<int> Count(string exp)
        {
            try
            {
                using (EntryDataDSContext dbContext = new EntryDataDSContext(){StartTracking = StartTracking})
                {
                    ...
                    if (exp == "All")
                    {
                        return await dbContext.ShipmentMIS_Invoices
                                    .AsNoTracking()
									.CountAsync()
									.ConfigureAwait(continueOnCapturedContext: false);
                    }
        ...
        public async Task<IEnumerable<ShipmentMIS_Invoices>> LoadRange(int startIndex, int count, string exp)
        {
            try
            {
                using (var dbContext = new EntryDataDSContext(){StartTracking = StartTracking})
		...
		public async Task<int> CountNav(string exp, Dictionary<string, string> navExp)
        {
            try
            {
                ...
                using (var dbContext = new EntryDataDSContext(){StartTracking = StartTracking})
                {
                    ...
                    return await dbContext.ShipmentMIS_Invoices.Where(exp == "All" || exp == null ? "Id != null" : exp)
											.AsNoTracking()
                                            .CountAsync()
											.ConfigureAwait(continueOnCapturedContext: false);
                }
		...
		private static async Task<int> CountWhereSelect<T>(EntryDataDSContext dbContext, string exp, string navExp, string navProp) where T : class
        {
		  ...
		  public async Task<IEnumerable<ShipmentMIS_Invoices>> LoadRangeNav(int startIndex, int count, string exp,
                                                                                 Dictionary<string, string> navExp, IEnumerable<string> includeLst = null)
        {
            try
            {
                ...
                {
                    dbContext.Database.CommandTimeout = 0;
                    if ((string.IsNullOrEmpty(exp) && navExp.Count == 0) || exp == "None") return new List<ShipmentMIS_Invoices>();
                    ...
                    return await set//dbContext.ShipmentMIS_Invoices
								.AsNoTracking()
                                .Where(exp == "All" || exp == null ? "Id != null" : exp)
								.OrderBy(y => y.Id)
		...
		private static async Task<IEnumerable<ShipmentMIS_Invoices>> LoadRangeSelectMany<T>(int startIndex, int count,
		...
		private static async Task<IEnumerable<ShipmentMIS_Invoices>> LoadRangeSelect<T>(int startIndex, int count,
            EntryDataDSContext dbContext, string exp, string navExp, string navProp, IEnumerable<string> includeLst = null) where T : class
        {
			try
			{
		...
		private static async Task<IEnumerable<ShipmentMIS_Invoices>> GetWhereSelectMany<T>(EntryDataDSContext dbContext,
		...
		private static async Task<IEnumerable<ShipmentMIS_Invoices>> GetWhereSelect<T>(EntryDataDSContext dbContext,
            string exp, string navExp, string navProp, List<string> includesLst = null) where T : class
        {
			try
			{
        ...
        public async Task<decimal> SumNav( string exp, Dictionary<string, string> navExp, string field)
        {
            try
            {
                ...
                {
                    dbContext.Database.CommandTimeout = 0;
                    if (!dbContext.ShipmentMIS_Invoices.Any()) return 0;
                    if (exp == "All" && navExp.Count == 0)
                    {
                        return Convert.ToDecimal(dbContext.ShipmentMIS_Invoices
										.AsNoTracking()
                                        .Sum(field)??0);
                    }
                    return Convert.ToDecimal(dbContext.ShipmentMIS_Invoices.Where(exp == "All" || exp == null ? "Id != null" : exp)
											.AsNoTracking()
                                            .Sum(field)??0);
                }
