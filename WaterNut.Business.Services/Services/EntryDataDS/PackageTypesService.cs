...
namespace EntryDataDS.Business.Services
{
   ...
   [ServiceBehavior(InstanceContextMode = InstanceContextMode.PerCall,
    ...
    public partial class PackageTypesService : IPackageTypesService, IDisposable
    {
        ...
        public async Task<IEnumerable<PackageTypes>> GetPackageTypes(List<string> includesLst = null, bool tracking = true)
        {
            try
            {
            //using (var scope = new TransactionScope(TransactionScopeOption.Required,
               ...
               // {
                  using ( var dbContext = new EntryDataDSContext(){StartTracking = StartTracking})
                  {
                    ...
                    IEnumerable<PackageTypes> entities = await set.AsNoTracking().ToListAsync()
        ...
        public async Task<PackageTypes> GetPackageTypesByKey(string PackageType, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
			   if(string.IsNullOrEmpty(PackageType))return null; 
              using ( var dbContext = new EntryDataDSContext(){StartTracking = StartTracking})
              {
                var i = PackageType;
				var set = AddIncludes(includesLst, dbContext);
                PackageTypes entity = await set.AsNoTracking().SingleOrDefaultAsync(x => x.PackageType == i).ConfigureAwait(continueOnCapturedContext: false);
		 ...
		 public async Task<IEnumerable<PackageTypes>> GetPackageTypesByExpression(string exp, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
                using (var dbContext = new EntryDataDSContext(){StartTracking = StartTracking})
		 ...
		 public async Task<IEnumerable<PackageTypes>> GetPackageTypesByExpressionLst(List<string> expLst, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
                using (var dbContext = new EntryDataDSContext(){StartTracking = StartTracking})
		...
		public async Task<IEnumerable<PackageTypes>> GetPackageTypesByExpressionNav(string exp,
        ...
        public async Task<IEnumerable<PackageTypes>> GetPackageTypesByBatch(string exp,
                    ...
                    //  for (int bat = 0; bat < batches; bat++)
                    {
                        try
                        {
                            using (var dbContext = new EntryDataDSContext(){StartTracking = StartTracking})
                            {
                                ...
                                if (exp == "All")
                                {
                                    dset = set.OrderBy(x => x.PackageType);
                                }
                                else
                                {
                                    dset = set.OrderBy(x => x.PackageType).Where(exp);
                                }
        ...
        public async Task<IEnumerable<PackageTypes>> GetPackageTypesByBatchExpressionLst(List<string> expLst,
            int totalrow, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
        ...
        public async Task<bool> DeletePackageTypes(string PackageType)
        {
            try
            {
              using ( var dbContext = new EntryDataDSContext(){StartTracking = StartTracking})
              {
                var i = PackageType;
                PackageTypes entity = await dbContext.PackageTypes
													.SingleOrDefaultAsync(x => x.PackageType == i)
													.ConfigureAwait(continueOnCapturedContext: false);
                if (entity == null)
                    return false;
		...
		private static async Task<int> CountWhereSelectMany<T>(EntryDataDSContext dbContext, string exp, string navExp, string navProp) where T : class
        {
            ...
            return await dbContext.Set<T>()
                ...
                .Where(exp == "All" || exp == null ? "PackageType != null" : exp)
                .Distinct()
                .OrderBy("PackageType")
                .CountAsync()
				.ConfigureAwait(continueOnCapturedContext: false);
		...
		private static async Task<IEnumerable<PackageTypes>> GetWhereSelectMany<T>(EntryDataDSContext dbContext,
		...
		private static async Task<IEnumerable<PackageTypes>> GetWhereSelect<T>(EntryDataDSContext dbContext,
            string exp, string navExp, string navProp, List<string> includesLst = null) where T : class
        {
			try
			{
