...
namespace EntryDataDS.Business.Services
{
   ...
   [ServiceBehavior(InstanceContextMode = InstanceContextMode.PerCall,
    ...
    public partial class PackageTypesService : IPackageTypesService, IDisposable
    {
        ...
        public Task<IEnumerable<PackageTypes>> GetPackageTypes(List<string> includesLst = null, bool tracking = true)
        {
            try
            {
        ...
        public Task<PackageTypes> GetPackageTypesByKey(string PackageDescription, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
			   if(string.IsNullOrEmpty(PackageDescription))return Task.FromResult<PackageTypes>(null); 
              using ( var dbContext = new EntryDataDSContext(){StartTracking = StartTracking})
              {
		 ...
		 public Task<IEnumerable<PackageTypes>> GetPackageTypesByExpression(string exp, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
                using (var dbContext = new EntryDataDSContext(){StartTracking = StartTracking})
                {
					...
					if (string.IsNullOrEmpty(exp) || exp == "None") return Task.FromResult<IEnumerable<PackageTypes>>(new List<PackageTypes>());
					var set = AddIncludes(includesLst, dbContext);
                    if (exp == "All")
                    {
                        ...
                        if(tracking) entities.AsParallel(new ParallelLinqOptions() { MaxDegreeOfParallelism = Environment.ProcessorCount }).ForAll(x => x.StartTracking());
                        return Task.FromResult<IEnumerable<PackageTypes>>(entities); 
                    }
					else
					{
		 ...
		 public Task<IEnumerable<PackageTypes>> GetPackageTypesByExpressionLst(List<string> expLst, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
                using (var dbContext = new EntryDataDSContext(){StartTracking = StartTracking})
                {
                    dbContext.Database.CommandTimeout = 0;
					if (expLst.Count == 0 || expLst.FirstOrDefault() == "None") return Task.FromResult<IEnumerable<PackageTypes>>(new List<PackageTypes>());
					var set = AddIncludes(includesLst, dbContext);
		...
		public Task<IEnumerable<PackageTypes>> GetPackageTypesByExpressionNav(string exp,
            ...
            try
            {
                using (var dbContext = new EntryDataDSContext(){StartTracking = StartTracking})
                {
                    ...
                    if (exp == "All" && navExp.Count == 0)
                    {
                        ...
                        return Task.FromResult<IEnumerable<PackageTypes>>(aentities); 
                    }
					var set = AddIncludes(includesLst, dbContext);
                    var entities = set.AsNoTracking().Where(exp)
									.ToList();
        ...
        public Task<IEnumerable<PackageTypes>> GetPackageTypesByBatch(string exp,
        ...
        public Task<IEnumerable<PackageTypes>> GetPackageTypesByBatchExpressionLst(List<string> expLst,
                                                                                   int totalrow, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
        ...
        public Task<PackageTypes> UpdatePackageTypes(PackageTypes entity)
        { 
            using ( var dbContext = new EntryDataDSContext(){StartTracking = StartTracking})
              {
                try
        ...
        public Task<PackageTypes> CreatePackageTypes(PackageTypes entity)
        {
            try
            {
                var res = (PackageTypes) entity;
        ...
        public Task<bool> DeletePackageTypes(string PackageDescription)
        {
            try
            {
              using ( var dbContext = new EntryDataDSContext(){StartTracking = StartTracking})
              {
                var i = PackageDescription;
                PackageTypes entity = dbContext.PackageTypes
         ...
         public Task<int> CountByExpressionLst(List<string> expLst)
        {
            try
            {
                using (var dbContext = new EntryDataDSContext(){StartTracking = StartTracking})
                {
                    ...
                    var set = (IQueryable<PackageTypes>)dbContext.PackageTypes; 
                    if (expLst.FirstOrDefault() == "All")
                    {
		...
		public Task<int> Count(string exp)
        {
            try
            {
                using (EntryDataDSContext dbContext = new EntryDataDSContext(){StartTracking = StartTracking})
                {
                    ...
                    if (exp == "All")
                    {
                        return Task.FromResult(dbContext.PackageTypes
                            .AsNoTracking()
                            .Count());
                    }
                    else
        ...
        public Task<IEnumerable<PackageTypes>> LoadRange(int startIndex, int count, string exp)
        {
            try
            {
                using (var dbContext = new EntryDataDSContext(){StartTracking = StartTracking})
                {
                    ...
                    if (exp == "All")
                    {
                        return Task.FromResult<IEnumerable<PackageTypes>>(dbContext.PackageTypes
                            .AsNoTracking()
		...
		public Task<int> CountNav(string exp, Dictionary<string, string> navExp)
        {
            try
            {
                ...
                using (var dbContext = new EntryDataDSContext(){StartTracking = StartTracking})
                {
                    ...
                    return Task.FromResult(dbContext.PackageTypes.Where(exp == "All" || exp == null ? "PackageDescription != null" : exp)
                        .AsNoTracking()
                        .Count());
                }
		...
		private static Task<int> CountWhereSelect<T>(EntryDataDSContext dbContext, string exp, string navExp, string navProp) where T : class
        {
		  ...
		  public Task<IEnumerable<PackageTypes>> LoadRangeNav(int startIndex, int count, string exp,
                                                              Dictionary<string, string> navExp, IEnumerable<string> includeLst = null)
        {
            try
            {
                ...
                {
                    dbContext.Database.CommandTimeout = 0;
                    if ((string.IsNullOrEmpty(exp) && navExp.Count == 0) || exp == "None") return Task.FromResult<IEnumerable<PackageTypes>>(new List<PackageTypes>());
                    var set = AddIncludes(includeLst, dbContext);

                    if (exp == "All" && navExp.Count == 0)
                    {
                       
                        return Task.FromResult<IEnumerable<PackageTypes>>(set
                            .AsNoTracking()
                            .OrderBy(y => y.PackageDescription)
                    ...
                    return Task.FromResult<IEnumerable<PackageTypes>>(set//dbContext.PackageTypes
                        .AsNoTracking()
                        .Where(exp == "All" || exp == null ? "PackageDescription != null" : exp)
                        .OrderBy(y => y.PackageDescription)
		...
		private static Task<IEnumerable<PackageTypes>> LoadRangeSelectMany<T>(int startIndex, int count,
		...
		private static Task<IEnumerable<PackageTypes>> LoadRangeSelect<T>(int startIndex, int count,
                                                                          EntryDataDSContext dbContext, string exp, string navExp, string navProp, IEnumerable<string> includeLst = null) where T : class
        {
			try
			{
        ...
        private static async Task<IEnumerable<PackageTypes>> GetWhere<T>(EntryDataDSContext dbContext,
		...
		private static Task<IEnumerable<PackageTypes>> GetWhereSelectMany<T>(EntryDataDSContext dbContext,
                                                                             string exp, string navExp, string navProp, List<string> includesLst = null) where T : class
        {
			...
			if (includesLst == null)
			{
				return Task.FromResult<IEnumerable<PackageTypes>>(dbContext.Set<T>()
                    .AsNoTracking()
                    .Where(navExp)
                    .SelectMany(navProp).OfType<PackageTypes>()
                    .Where(exp == "All" || exp == null?"PackageDescription != null":exp)
            ...
            return Task.FromResult<IEnumerable<PackageTypes>>(set.ToList());
			}
			catch (Exception)
			{
				Debugger.Break();
		...
		private static Task<IEnumerable<PackageTypes>> GetWhereSelect<T>(EntryDataDSContext dbContext,
                                                                         string exp, string navExp, string navProp, List<string> includesLst = null) where T : class
        {
			try
			{
        ...
        public Task<decimal> SumNav( string exp, Dictionary<string, string> navExp, string field)
        {
            try
            {
                ...
                {
                    dbContext.Database.CommandTimeout = 0;
                    if (!dbContext.PackageTypes.Any()) return Task.FromResult<decimal>(0);
                    if (exp == "All" && navExp.Count == 0)
                    {
                        return Task.FromResult(Convert.ToDecimal(dbContext.PackageTypes
                                                                     .AsNoTracking()
                                                                     .Sum(field)??0));
                    }
                    return Task.FromResult(Convert.ToDecimal(dbContext.PackageTypes.Where(exp == "All" || exp == null ? "PackageDescription != null" : exp)
                                                                 .AsNoTracking()
                                                                 .Sum(field)??0));
                }
		...
		private static IQueryable<PackageTypes> AddIncludes(IEnumerable<string> includesLst, EntryDataDSContext dbContext)
       {
		 try
			{
			   if (includesLst == null) includesLst = new List<string>();
			   var set =(DbQuery<PackageTypes>) dbContext.PackageTypes; 
