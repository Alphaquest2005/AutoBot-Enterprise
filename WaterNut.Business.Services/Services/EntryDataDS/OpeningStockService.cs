...
{
   [Export (typeof(IOpeningStockService))]
   [Export(typeof(IBusinessService))]
   [PartCreationPolicy(CreationPolicy.NonShared)]
   [ServiceBehavior(InstanceContextMode = InstanceContextMode.PerCall,
                    ConcurrencyMode = ConcurrencyMode.Multiple)]
   
    public partial class OpeningStockService : IOpeningStockService, IDisposable
    {
        ...
        public Task<IEnumerable<OpeningStock>> GetEntryData(List<string> includesLst = null, bool tracking = true)
        {
            try
            {
            //using (var scope = new TransactionScope(TransactionScopeOption.Required,
               ...
               // {
                  using ( var dbContext = new EntryDataDSContext(){StartTracking = StartTracking})
                  {
                    ...
                    IEnumerable<OpeningStock> entities = set.AsNoTracking().ToList();
                           //scope.Complete();
        ...
        public Task<OpeningStock> GetOpeningStockByKey(string EntryData_Id, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
			   if(string.IsNullOrEmpty(EntryData_Id))return Task.FromResult<OpeningStock>(null); 
              using ( var dbContext = new EntryDataDSContext(){StartTracking = StartTracking})
              {
                var i = Convert.ToInt32(EntryData_Id);
				var set = AddIncludes(includesLst, dbContext);
                OpeningStock entity = set.AsNoTracking().SingleOrDefault(x => x.EntryData_Id == i);
		 ...
		 public Task<IEnumerable<OpeningStock>> GetEntryDataByExpression(string exp, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
                using (var dbContext = new EntryDataDSContext(){StartTracking = StartTracking})
                {
					...
					if (string.IsNullOrEmpty(exp) || exp == "None") return Task.FromResult<IEnumerable<OpeningStock>>(new List<OpeningStock>());
					var set = AddIncludes(includesLst, dbContext);
                    if (exp == "All")
                    {
                        ...
                        if(tracking) entities.AsParallel(new ParallelLinqOptions() { MaxDegreeOfParallelism = Environment.ProcessorCount }).ForAll(x => x.StartTracking());
                        return Task.FromResult<IEnumerable<OpeningStock>>(entities); 
                    }
					else
					{
		 ...
		 public Task<IEnumerable<OpeningStock>> GetEntryDataByExpressionLst(List<string> expLst, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
                using (var dbContext = new EntryDataDSContext(){StartTracking = StartTracking})
                {
                    dbContext.Database.CommandTimeout = 0;
					if (expLst.Count == 0 || expLst.FirstOrDefault() == "None") return Task.FromResult<IEnumerable<OpeningStock>>(new List<OpeningStock>());
					var set = AddIncludes(includesLst, dbContext);
		...
		public async Task<IEnumerable<OpeningStock>> GetEntryDataByExpressionNav(string exp,
																							  ...
																							  List<string> includesLst = null, bool tracking = true)
        {
            try
            {
                ...
                {
                    dbContext.Database.CommandTimeout = 0;
                    if (string.IsNullOrEmpty(exp) || exp == "None") return new List<OpeningStock>();
        ...
        public Task<IEnumerable<OpeningStock>> GetEntryDataByBatch(string exp,
                                                                   int totalrow, List<string> includesLst = null, bool tracking = true)
        {
            try
            {

                var res = new ConcurrentQueue<List<OpeningStock>>();
        ...
        public Task<IEnumerable<OpeningStock>> GetEntryDataByBatchExpressionLst(List<string> expLst,
                                                                                int totalrow, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
        ...
        public Task<OpeningStock> UpdateOpeningStock(OpeningStock entity)
        { 
            using ( var dbContext = new EntryDataDSContext(){StartTracking = StartTracking})
              {
                try
                {   
                     var res = (OpeningStock) entity;
        ...
        public Task<OpeningStock> CreateOpeningStock(OpeningStock entity)
        {
            try
            {
                var res = (OpeningStock) entity;
              using ( var dbContext = new EntryDataDSContext(){StartTracking = StartTracking})
              {
                dbContext.Set<OpeningStock>().Add(res);
                dbContext.SaveChanges();
                res.AcceptChanges();
                return Task.FromResult(res);
              }
        ...
        public Task<bool> DeleteOpeningStock(string EntryData_Id)
        {
            try
            {
              using ( var dbContext = new EntryDataDSContext(){StartTracking = StartTracking})
              {
                var i = Convert.ToInt32(EntryData_Id);
                OpeningStock entity = dbContext.EntryData.OfType<OpeningStock>()
													.SingleOrDefault(x => x.EntryData_Id == i);
                if (entity == null)
                    return Task.FromResult(false);

                    dbContext.Set<OpeningStock>().Attach(entity);
                    dbContext.Set<OpeningStock>().Remove(entity);
                    dbContext.SaveChanges();
        ...
        public async Task<bool> RemoveSelectedOpeningStock(IEnumerable<string> lst)
        {
            try
            {
                StatusModel.StartStatusUpdate("Removing OpeningStock", lst.Count());
                var t = Task.Run(() =>
                {
                    using (var ctx = new OpeningStockService())
                    {
                        foreach (var item in lst.ToList())
                        {
                            ...
                            ctx.DeleteOpeningStock(item).Wait();
         ...
         public Task<int> CountByExpressionLst(List<string> expLst)
        {
            try
            {
                using (var dbContext = new EntryDataDSContext(){StartTracking = StartTracking})
                {
                    ...
                    var set = (IQueryable<OpeningStock>)dbContext.Set<OpeningStock>(); 
                    if (expLst.FirstOrDefault() == "All")
                    {
		...
		public Task<int> Count(string exp)
        {
            try
            {
                using (EntryDataDSContext dbContext = new EntryDataDSContext(){StartTracking = StartTracking})
                {
                    ...
                    if (exp == "All")
                    {
                        return Task.FromResult(dbContext.Set<OpeningStock>()
                            .AsNoTracking()
                            .Count());
                    }
                    else
        ...
        public Task<IEnumerable<OpeningStock>> LoadRange(int startIndex, int count, string exp)
        {
            try
            {
                using (var dbContext = new EntryDataDSContext(){StartTracking = StartTracking})
                {
                    ...
                    if (exp == "All")
                    {
                        return Task.FromResult<IEnumerable<OpeningStock>>(dbContext.Set<OpeningStock>()
                            .AsNoTracking()
		...
		public async Task<int> CountNav(string exp, Dictionary<string, string> navExp)
        {
            try
            {
                ...
                using (var dbContext = new EntryDataDSContext(){StartTracking = StartTracking})
                {
                    ...
                    if (exp == "All" && navExp.Count == 0)
                    {
                        return dbContext.Set<OpeningStock>()
										.AsNoTracking()
                                        .Count();
                    }
                    foreach (var itm in navExp)
                    ...
                    return dbContext.Set<OpeningStock>().Where(exp == "All" || exp == null ? "EntryData_Id != null" : exp)
											.AsNoTracking()
                                            .Count();
                }
		...
		private static Task<int> CountWhereSelectMany<T>(EntryDataDSContext dbContext, string exp, string navExp, string navProp) where T : class
        {
            ...
            return Task.FromResult(dbContext.Set<T>()
                .AsNoTracking()
                .Where(navExp)
                .SelectMany(navProp).OfType<OpeningStock>()
		...
		private static Task<int> CountWhereSelect<T>(EntryDataDSContext dbContext, string exp, string navExp, string navProp) where T : class
        {
            ...
            return Task.FromResult(dbContext.Set<T>()
                .AsNoTracking()
                .Where(navExp)
                .Select(navProp).OfType<OpeningStock>()
                .Where(exp == "All" || exp == null ? "EntryData_Id != null" : exp)
                .Distinct()
                .OrderBy("EntryData_Id")
                .Count());
		  ...
		  public async Task<IEnumerable<OpeningStock>> LoadRangeNav(int startIndex, int count, string exp,
                                                                                 Dictionary<string, string> navExp, IEnumerable<string> includeLst = null)
        {
            try
            {
                ...
                {
                    dbContext.Database.CommandTimeout = 0;
                    if ((string.IsNullOrEmpty(exp) && navExp.Count == 0) || exp == "None") return new List<OpeningStock>();
                    ...
                    return set//dbContext.Set<OpeningStock>()
								.AsNoTracking()
                                .Where(exp == "All" || exp == null ? "EntryData_Id != null" : exp)
								.OrderBy(y => y.EntryData_Id)
		...
		private static async Task<IEnumerable<OpeningStock>> LoadRangeWhere<T>(int startIndex, int count,
		...
		private static Task<IEnumerable<OpeningStock>> LoadRangeSelectMany<T>(int startIndex, int count,
                                                                              EntryDataDSContext dbContext, string exp, string navExp, string navProp, IEnumerable<string> includeLst = null) where T : class
        {
            ...
            return Task.FromResult<IEnumerable<OpeningStock>>(set
                .Where(exp == "All" || exp == null ? "EntryData_Id != null" : exp)
                .Distinct()
                .OrderBy(y => y.EntryData_Id)
		...
		private static Task<IEnumerable<OpeningStock>> LoadRangeSelect<T>(int startIndex, int count,
                                                                          EntryDataDSContext dbContext, string exp, string navExp, string navProp, IEnumerable<string> includeLst = null) where T : class
        {
			try
			{
        ...
        private static async Task<IEnumerable<OpeningStock>> GetWhere<T>(EntryDataDSContext dbContext,
		...
		private static Task<IEnumerable<OpeningStock>> GetWhereSelectMany<T>(EntryDataDSContext dbContext,
                                                                             string exp, string navExp, string navProp, List<string> includesLst = null) where T : class
        {
			...
			if (includesLst == null)
			{
				return Task.FromResult<IEnumerable<OpeningStock>>(dbContext.Set<T>()
                    .AsNoTracking()
                    .Where(navExp)
                    .SelectMany(navProp).OfType<OpeningStock>()
                    .Where(exp == "All" || exp == null?"EntryData_Id != null":exp)
			...
			var set = (DbQuery<OpeningStock>)dbContext.Set<T>()
				.AsNoTracking()
                .Where(navExp)
                .SelectMany(navProp).OfType<OpeningStock>()
                .Where(exp == "All" || exp == null?"EntryData_Id != null":exp)
            ...
            return Task.FromResult<IEnumerable<OpeningStock>>(set.ToList());
			}
			catch (Exception)
			{
				Debugger.Break();
		...
		private static Task<IEnumerable<OpeningStock>> GetWhereSelect<T>(EntryDataDSContext dbContext,
                                                                         string exp, string navExp, string navProp, List<string> includesLst = null) where T : class
        {
			try
			{
			...
			catch (Exception)
			{
				...
				throw;
			        ...
			        public Task<IEnumerable<OpeningStock>> GetOpeningStockByEntryDataId(string EntryDataId, List<string> includesLst = null)
        {
            try
            {
                using ( var dbContext = new EntryDataDSContext(){StartTracking = StartTracking})
              {
                var i = EntryDataId;
                var set = AddIncludes(includesLst, dbContext);
                IEnumerable<OpeningStock> entities = set//dbContext.EntryData.OfType<OpeningStock>()
                                      .AsNoTracking()
            ...
            catch (Exception updateEx)
            {
 	        ...
 	        public Task<IEnumerable<OpeningStock>> GetOpeningStockByApplicationSettingsId(string ApplicationSettingsId, List<string> includesLst = null)
        {
            try
            {
                using ( var dbContext = new EntryDataDSContext(){StartTracking = StartTracking})
            ...
            catch (Exception updateEx)
            {
 	        ...
 	        public Task<IEnumerable<OpeningStock>> GetOpeningStockByEmailId(string EmailId, List<string> includesLst = null)
        {
            try
            {
                using ( var dbContext = new EntryDataDSContext(){StartTracking = StartTracking})
            ...
            catch (Exception updateEx)
            {
 	        ...
 	        public Task<IEnumerable<OpeningStock>> GetOpeningStockByFileTypeId(string FileTypeId, List<string> includesLst = null)
        {
            try
            {
                using ( var dbContext = new EntryDataDSContext(){StartTracking = StartTracking})
             ...
             try
             {
                 using (var dbContext = new EntryDataDSContext(){StartTracking = StartTracking})
                 {
					...
					decimal res = 0;
                     ...
                     if (whereExp == "All")
                     {
                          res = Convert.ToDecimal(dbContext.EntryData.OfType<OpeningStock>().AsNoTracking().Sum(field));
                     }
                     else
                     {
                         res = Convert.ToDecimal(dbContext.EntryData.OfType<OpeningStock>().AsNoTracking().Where(whereExp).Sum(field));
                     }
        ...
        public async Task<decimal> SumNav( string exp, Dictionary<string, string> navExp, string field)
        {
            try
            {
                ...
                {
                    dbContext.Database.CommandTimeout = 0;
                    if (!dbContext.Set<OpeningStock>().Any()) return 0;
                    if (exp == "All" && navExp.Count == 0)
                    {
                        return Convert.ToDecimal(dbContext.Set<OpeningStock>()
										.AsNoTracking()
                                        .Sum(field)??0);
                    }
                    foreach (var itm in navExp)
                    ...
                    return Convert.ToDecimal(dbContext.Set<OpeningStock>().Where(exp == "All" || exp == null ? "EntryData_Id != null" : exp)
											.AsNoTracking()
                                            .Sum(field)??0);
                }
             ...
             try
             {
                 using (var dbContext = new EntryDataDSContext(){StartTracking = StartTracking})
                 {
					...
					string res = "";
                     ...
                     if (whereExp == "All")
                     {
                          res = Convert.ToString(dbContext.EntryData.OfType<OpeningStock>().AsNoTracking().Min(field));
                     }
                     else
                     {
                         res = Convert.ToString(dbContext.EntryData.OfType<OpeningStock>().AsNoTracking().Where(whereExp).Min(field));
                     }
		...
		private static IQueryable<OpeningStock> AddIncludes(IEnumerable<string> includesLst, EntryDataDSContext dbContext)
       {
		 try
			{
			   if (includesLst == null) includesLst = new List<string>();
			   var set =(DbQuery<OpeningStock>) dbContext.EntryData.OfType<OpeningStock>(); 
	   ...
	   private IQueryable<OpeningStock> AddWheres(List<string> expLst, IQueryable<OpeningStock> set)
        {
            try
            {
