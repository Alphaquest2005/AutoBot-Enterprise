...
namespace EntryDataDS.Business.Services
{
   ...
   [ServiceBehavior(InstanceContextMode = InstanceContextMode.PerCall,
    ...
    public partial class OpeningStockService : IOpeningStockService, IDisposable
    {
        ...
        public async Task<IEnumerable<OpeningStock>> GetEntryData(List<string> includesLst = null, bool tracking = true)
        {
            try
            {
            //using (var scope = new TransactionScope(TransactionScopeOption.Required,
               ...
               // {
                  using ( var dbContext = new EntryDataDSContext(){StartTracking = StartTracking})
                  {
                    ...
                    IEnumerable<OpeningStock> entities = await set.AsNoTracking().ToListAsync()
        ...
        public async Task<OpeningStock> GetOpeningStockByKey(string EntryData_Id, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
              ...
              using ( var dbContext = new EntryDataDSContext(){StartTracking = StartTracking})
              {
				...
				var set = AddIncludes(includesLst, dbContext);
                OpeningStock entity = await set.AsNoTracking().SingleOrDefaultAsync(x => x.EntryData_Id == i).ConfigureAwait(continueOnCapturedContext: false);
		 ...
		 public async Task<IEnumerable<OpeningStock>> GetEntryDataByExpression(string exp, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
                using (var dbContext = new EntryDataDSContext(){StartTracking = StartTracking})
		 ...
		 public async Task<IEnumerable<OpeningStock>> GetEntryDataByExpressionLst(List<string> expLst, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
                using (var dbContext = new EntryDataDSContext(){StartTracking = StartTracking})
                {
                    dbContext.Database.CommandTimeout = 0;
					if (expLst.Count == 0 || expLst.FirstOrDefault() == "None") return new List<OpeningStock>();
					var set = AddIncludes(includesLst, dbContext);
        ...
        public async Task<IEnumerable<OpeningStock>> GetEntryDataByBatch(string exp,
        ...
        public async Task<IEnumerable<OpeningStock>> GetEntryDataByBatchExpressionLst(List<string> expLst,
            int totalrow, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
        ...
        public async Task<OpeningStock> UpdateOpeningStock(OpeningStock entity)
        { 
            using ( var dbContext = new EntryDataDSContext(){StartTracking = StartTracking})
              {
                try
        ...
        public async Task<OpeningStock> CreateOpeningStock(OpeningStock entity)
        {
            try
            {
                var res = (OpeningStock) entity;
        ...
        public async Task<bool> DeleteOpeningStock(string EntryData_Id)
        {
            try
            {
              using ( var dbContext = new EntryDataDSContext(){StartTracking = StartTracking})
              {
                var i = Convert.ToInt32(EntryData_Id);
                OpeningStock entity = await dbContext.EntryData.OfType<OpeningStock>()
		...
		public async Task<int> Count(string exp)
        {
            try
            {
                using (EntryDataDSContext dbContext = new EntryDataDSContext(){StartTracking = StartTracking})
                {
                    ...
                    if (exp == "All")
                    {
                        return await dbContext.Set<OpeningStock>()
                                    .AsNoTracking()
									.CountAsync()
									.ConfigureAwait(continueOnCapturedContext: false);
                    }
        ...
        public async Task<IEnumerable<OpeningStock>> LoadRange(int startIndex, int count, string exp)
        {
            try
            {
                using (var dbContext = new EntryDataDSContext(){StartTracking = StartTracking})
		...
		public async Task<int> CountNav(string exp, Dictionary<string, string> navExp)
        {
            try
            {
                ...
                using (var dbContext = new EntryDataDSContext(){StartTracking = StartTracking})
                {
                    ...
                    return await dbContext.Set<OpeningStock>().Where(exp == "All" || exp == null ? "EntryData_Id != null" : exp)
											.AsNoTracking()
                                            .CountAsync()
											.ConfigureAwait(continueOnCapturedContext: false);
                }
                                                                                 ...
                                                                                 Dictionary<string, string> navExp, IEnumerable<string> includeLst = null)
        {
            try
            {
                using (var dbContext = new EntryDataDSContext(){StartTracking = StartTracking})
                {
                    ...
                    return await set//dbContext.Set<OpeningStock>()
								.AsNoTracking()
                                .Where(exp == "All" || exp == null ? "EntryData_Id != null" : exp)
								.OrderBy(y => y.EntryData_Id)
		...
		private static async Task<IEnumerable<OpeningStock>> LoadRangeSelectMany<T>(int startIndex, int count,
		...
		private static async Task<IEnumerable<OpeningStock>> LoadRangeSelect<T>(int startIndex, int count,
            EntryDataDSContext dbContext, string exp, string navExp, string navProp, IEnumerable<string> includeLst = null) where T : class
        {
			try
			{
		...
		private static async Task<IEnumerable<OpeningStock>> GetWhereSelectMany<T>(EntryDataDSContext dbContext,
		...
		private static async Task<IEnumerable<OpeningStock>> GetWhereSelect<T>(EntryDataDSContext dbContext,
            string exp, string navExp, string navProp, List<string> includesLst = null) where T : class
        {
			try
			{
			...
			catch (Exception)
			{
				...
				throw;
			        ...
			        public async Task<IEnumerable<OpeningStock>> GetOpeningStockByEntryDataId(string EntryDataId, List<string> includesLst = null)
        {
            try
            {
                using ( var dbContext = new EntryDataDSContext(){StartTracking = StartTracking})
 	        ...
 	        public async Task<IEnumerable<OpeningStock>> GetOpeningStockByApplicationSettingsId(string ApplicationSettingsId, List<string> includesLst = null)
        {
            ...
            catch (Exception updateEx)
            {
 	        ...
 	        public async Task<IEnumerable<OpeningStock>> GetOpeningStockByEmailId(string EmailId, List<string> includesLst = null)
        {
            try
            {
                using ( var dbContext = new EntryDataDSContext(){StartTracking = StartTracking})
            ...
            catch (Exception updateEx)
            {
 	        ...
 	        public async Task<IEnumerable<OpeningStock>> GetOpeningStockByFileTypeId(string FileTypeId, List<string> includesLst = null)
        {
            try
            {
                using ( var dbContext = new EntryDataDSContext(){StartTracking = StartTracking})
