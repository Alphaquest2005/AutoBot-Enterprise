...
namespace EntryDataDS.Business.Services
{
   ...
   [ServiceBehavior(InstanceContextMode = InstanceContextMode.PerCall,
    ...
    public partial class EntryDataExTotalsService : IEntryDataExTotalsService, IDisposable
    {
        ...
        public async Task<EntryDataExTotals> GetEntryDataExTotalsByKey(string EntryDataId, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
              ...
              using ( var dbContext = new EntryDataDSContext(){StartTracking = StartTracking})
              {
                var i = EntryDataId;
				var set = AddIncludes(includesLst, dbContext);
                EntryDataExTotals entity = await set.AsNoTracking().SingleOrDefaultAsync(x => x.EntryDataId == i).ConfigureAwait(continueOnCapturedContext: false);
        ...
        public async Task<bool> DeleteEntryDataExTotals(string EntryDataId)
        {
            try
            {
              using ( var dbContext = new EntryDataDSContext(){StartTracking = StartTracking})
		...
		public async Task<int> CountNav(string exp, Dictionary<string, string> navExp)
        {
            try
            {
                ...
                using (var dbContext = new EntryDataDSContext(){StartTracking = StartTracking})
                {
                    ...
                    return await dbContext.EntryDataExTotals.Where(exp == "All" || exp == null ? "EntryDataId != null" : exp)
											.AsNoTracking()
                                            .CountAsync()
											.ConfigureAwait(continueOnCapturedContext: false);
                }
        ...
        public async Task<decimal> SumNav( string exp, Dictionary<string, string> navExp, string field)
        {
            try
            {
                ...
                using (var dbContext = new EntryDataDSContext(){StartTracking = StartTracking})
                {
                    ...
                    return Convert.ToDecimal(dbContext.EntryDataExTotals.Where(exp == "All" || exp == null ? "EntryDataId != null" : exp)
											.AsNoTracking()
                                            .Sum(field)??0);
                }
