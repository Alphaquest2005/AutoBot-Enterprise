...
namespace EntryDataDS.Business.Services
{
   ...
   [ServiceBehavior(InstanceContextMode = InstanceContextMode.PerCall,
    ...
    public partial class EntryDataExTotalsService : IEntryDataExTotalsService, IDisposable
    {
        ...
        public async Task<IEnumerable<EntryDataExTotals>> GetEntryDataExTotals(List<string> includesLst = null, bool tracking = true)
        {
            try
            {
            //using (var scope = new TransactionScope(TransactionScopeOption.Required,
               ...
               // {
                  using ( var dbContext = new EntryDataDSContext(){StartTracking = StartTracking})
                  {
                    ...
                    IEnumerable<EntryDataExTotals> entities = await set.AsNoTracking().ToListAsync()
        ...
        public async Task<EntryDataExTotals> GetEntryDataExTotalsByKey(string EntryData_Id, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
              ...
              using ( var dbContext = new EntryDataDSContext(){StartTracking = StartTracking})
              {
				...
				var set = AddIncludes(includesLst, dbContext);
                EntryDataExTotals entity = await set.AsNoTracking().SingleOrDefaultAsync(x => x.EntryData_Id == i).ConfigureAwait(continueOnCapturedContext: false);
		 ...
		 public async Task<IEnumerable<EntryDataExTotals>> GetEntryDataExTotalsByExpression(string exp, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
                using (var dbContext = new EntryDataDSContext(){StartTracking = StartTracking})
		 ...
		 public async Task<IEnumerable<EntryDataExTotals>> GetEntryDataExTotalsByExpressionLst(List<string> expLst, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
                using (var dbContext = new EntryDataDSContext(){StartTracking = StartTracking})
                {
                    dbContext.Database.CommandTimeout = 0;
					if (expLst.Count == 0 || expLst.FirstOrDefault() == "None") return new List<EntryDataExTotals>();
					var set = AddIncludes(includesLst, dbContext);
        ...
        public async Task<IEnumerable<EntryDataExTotals>> GetEntryDataExTotalsByBatch(string exp,
        ...
        public async Task<IEnumerable<EntryDataExTotals>> GetEntryDataExTotalsByBatchExpressionLst(List<string> expLst,
            int totalrow, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
        ...
        public async Task<EntryDataExTotals> UpdateEntryDataExTotals(EntryDataExTotals entity)
        { 
            using ( var dbContext = new EntryDataDSContext(){StartTracking = StartTracking})
              {
                try
        ...
        public async Task<EntryDataExTotals> CreateEntryDataExTotals(EntryDataExTotals entity)
        {
            try
            {
                var res = (EntryDataExTotals) entity;
        ...
        public async Task<bool> DeleteEntryDataExTotals(string EntryData_Id)
        {
            try
            {
              using ( var dbContext = new EntryDataDSContext(){StartTracking = StartTracking})
              {
                var i = Convert.ToInt32(EntryData_Id);
                EntryDataExTotals entity = await dbContext.EntryDataExTotals
		...
		public async Task<int> Count(string exp)
        {
            try
            {
                using (EntryDataDSContext dbContext = new EntryDataDSContext(){StartTracking = StartTracking})
                {
                    ...
                    if (exp == "All")
                    {
                        return await dbContext.EntryDataExTotals
                                    .AsNoTracking()
									.CountAsync()
									.ConfigureAwait(continueOnCapturedContext: false);
                    }
        ...
        public async Task<IEnumerable<EntryDataExTotals>> LoadRange(int startIndex, int count, string exp)
        {
            try
            {
                using (var dbContext = new EntryDataDSContext(){StartTracking = StartTracking})
		...
		public async Task<int> CountNav(string exp, Dictionary<string, string> navExp)
        {
            try
            {
                ...
                using (var dbContext = new EntryDataDSContext(){StartTracking = StartTracking})
                {
                    ...
                    return await dbContext.EntryDataExTotals.Where(exp == "All" || exp == null ? "EntryData_Id != null" : exp)
											.AsNoTracking()
                                            .CountAsync()
											.ConfigureAwait(continueOnCapturedContext: false);
                }
                                                                                 ...
                                                                                 Dictionary<string, string> navExp, IEnumerable<string> includeLst = null)
        {
            try
            {
                using (var dbContext = new EntryDataDSContext(){StartTracking = StartTracking})
                {
                    ...
                    return await set//dbContext.EntryDataExTotals
								.AsNoTracking()
                                .Where(exp == "All" || exp == null ? "EntryData_Id != null" : exp)
								.OrderBy(y => y.EntryData_Id)
		...
		private static async Task<IEnumerable<EntryDataExTotals>> LoadRangeSelectMany<T>(int startIndex, int count,
		...
		private static async Task<IEnumerable<EntryDataExTotals>> LoadRangeSelect<T>(int startIndex, int count,
            EntryDataDSContext dbContext, string exp, string navExp, string navProp, IEnumerable<string> includeLst = null) where T : class
        {
			try
			{
		...
		private static async Task<IEnumerable<EntryDataExTotals>> GetWhereSelectMany<T>(EntryDataDSContext dbContext,
		...
		private static async Task<IEnumerable<EntryDataExTotals>> GetWhereSelect<T>(EntryDataDSContext dbContext,
            string exp, string navExp, string navProp, List<string> includesLst = null) where T : class
        {
			try
			{
			...
			catch (Exception)
			{
				...
				throw;
			        ...
			        public async Task<IEnumerable<EntryDataExTotals>> GetEntryDataExTotalsByEntryDataId(string EntryDataId, List<string> includesLst = null)
        {
            try
            {
                using ( var dbContext = new EntryDataDSContext(){StartTracking = StartTracking})
              {
                var i = EntryDataId;
                var set = AddIncludes(includesLst, dbContext);
                IEnumerable<EntryDataExTotals> entities = await set//dbContext.EntryDataExTotals
                                      .AsNoTracking()
            ...
            catch (Exception updateEx)
            {
 	        ...
 	        public async Task<IEnumerable<EntryDataExTotals>> GetEntryDataExTotalsByAsycudaDocumentSetId(string AsycudaDocumentSetId, List<string> includesLst = null)
        {
            try
            {
                using ( var dbContext = new EntryDataDSContext(){StartTracking = StartTracking})
