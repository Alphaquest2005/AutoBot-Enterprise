    ...
    public partial class ShipmentInvoiceService : IShipmentInvoiceService, IDisposable
    {
            ...
            //using (var scope = new TransactionScope(TransactionScopeOption.Required,
               ...
               // {
                  using ( var dbContext = new EntryDataDSContext(){StartTracking = StartTracking})
                  {
                    ...
                    IEnumerable<ShipmentInvoice> entities = await set.AsNoTracking().ToListAsync()
        ...
        public async Task<ShipmentInvoice> GetShipmentInvoiceByKey(string Id, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
              ...
              using ( var dbContext = new EntryDataDSContext(){StartTracking = StartTracking})
              {
				...
				var set = AddIncludes(includesLst, dbContext);
                ShipmentInvoice entity = await set.AsNoTracking().SingleOrDefaultAsync(x => x.Id == i).ConfigureAwait(continueOnCapturedContext: false);
                    ...
                    foreach (var itm in navExp)
                    {
                        switch (itm.Key)
                        {
                            ...
                            case "TotalVolume":
                                return
                                    await
                                        GetWhere<InvoiceVolume>(dbContext, exp, itm.Value, "ShipmentInvoice", "SelectMany", includesLst)
										.ConfigureAwait(continueOnCapturedContext: false);
        ...
        public async Task<bool> DeleteShipmentInvoice(string Id)
        {
            try
            {
              ...
              {
                var i = Convert.ToInt32(Id);
                ShipmentInvoice entity = await dbContext.ShipmentInvoice
		...
		public async Task<int> Count(string exp)
        {
            try
            {
                using (EntryDataDSContext dbContext = new EntryDataDSContext(){StartTracking = StartTracking})
                {
                    ...
                    if (exp == "All")
                    {
                        return await dbContext.ShipmentInvoice
                                    .AsNoTracking()
									.CountAsync()
									.ConfigureAwait(continueOnCapturedContext: false);
                    }
                        ...
                        switch (itm.Key)
                        {
                            ...
                            case "ShipmentInvoiceRiderDetails":
                                return await CountWhere<ShipmentInvoiceRiderDetails>(dbContext, exp, itm.Value, "ShipmentInvoice", "Select")
											.ConfigureAwait(continueOnCapturedContext: false);
                            case "TotalVolume":
                                return await CountWhere<InvoiceVolume>(dbContext, exp, itm.Value, "ShipmentInvoice", "SelectMany")
											.ConfigureAwait(continueOnCapturedContext: false);
						}
                    }
                                                                                 ...
                                                                                 Dictionary<string, string> navExp, IEnumerable<string> includeLst = null)
        {
            try
            {
                using (var dbContext = new EntryDataDSContext(){StartTracking = StartTracking})
                {
                    ...
                    foreach (var itm in navExp)
                    {
                        switch (itm.Key)
                        {
                            ...
                            case "TotalVolume":
                                return
                                    await
                                        LoadRangeWhere<InvoiceVolume>(startIndex, count, dbContext, exp, itm.Value, "ShipmentInvoice", "SelectMany")
													.ConfigureAwait(continueOnCapturedContext: false);
                    ...
                    return await set//dbContext.ShipmentInvoice
								.AsNoTracking()
                                .Where(exp == "All" || exp == null ? "Id != null" : exp)
								.OrderBy(y => y.Id)
			        ...
			        public async Task<IEnumerable<ShipmentInvoice>> GetShipmentInvoiceByEmailId(string EmailId, List<string> includesLst = null)
        {
            try
            {
                using ( var dbContext = new EntryDataDSContext(){StartTracking = StartTracking})
              {
                ...
                var set = AddIncludes(includesLst, dbContext);
                IEnumerable<ShipmentInvoice> entities = await set//dbContext.ShipmentInvoice
                        ...
                        switch (itm.Key)
                        {
                            ...
                            case "ShipmentInvoiceRiderDetails":
                                return await SumWhere<ShipmentInvoiceRiderDetails>(dbContext, exp, itm.Value, "ShipmentInvoice", field, "Select")
											.ConfigureAwait(continueOnCapturedContext: false);
                            case "TotalVolume":
                                return await SumWhere<InvoiceVolume>(dbContext, exp, itm.Value, "ShipmentInvoice", field, "SelectMany")
											.ConfigureAwait(continueOnCapturedContext: false);
						}
                    }
