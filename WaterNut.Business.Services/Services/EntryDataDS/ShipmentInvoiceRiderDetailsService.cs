...
namespace EntryDataDS.Business.Services
{
   ...
   [ServiceBehavior(InstanceContextMode = InstanceContextMode.PerCall,
    ...
    public partial class ShipmentInvoiceRiderDetailsService : IShipmentInvoiceRiderDetailsService, IDisposable
    {
        ...
        public Task<IEnumerable<ShipmentInvoiceRiderDetails>> GetShipmentInvoiceRiderDetails(List<string> includesLst = null, bool tracking = true)
        {
            try
            {
            //using (var scope = new TransactionScope(TransactionScopeOption.Required,
               ...
               // {
                  using ( var dbContext = new EntryDataDSContext(){StartTracking = StartTracking})
                  {
                    ...
                    IEnumerable<ShipmentInvoiceRiderDetails> entities = set.AsNoTracking().ToList();
                           //scope.Complete();
        ...
        public Task<ShipmentInvoiceRiderDetails> GetShipmentInvoiceRiderDetailsByKey(string Id, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
			   if(string.IsNullOrEmpty(Id))return Task.FromResult<ShipmentInvoiceRiderDetails>(null); 
              using ( var dbContext = new EntryDataDSContext(){StartTracking = StartTracking})
              {
                var i = Convert.ToInt32(Id);
				var set = AddIncludes(includesLst, dbContext);
                ShipmentInvoiceRiderDetails entity = set.AsNoTracking().SingleOrDefault(x => x.Id == i);
		 ...
		 public Task<IEnumerable<ShipmentInvoiceRiderDetails>> GetShipmentInvoiceRiderDetailsByExpression(string exp, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
                using (var dbContext = new EntryDataDSContext(){StartTracking = StartTracking})
                {
					...
					if (string.IsNullOrEmpty(exp) || exp == "None") return Task.FromResult<IEnumerable<ShipmentInvoiceRiderDetails>>(new List<ShipmentInvoiceRiderDetails>());
					var set = AddIncludes(includesLst, dbContext);
                    if (exp == "All")
                    {
                        ...
                        if(tracking) entities.AsParallel(new ParallelLinqOptions() { MaxDegreeOfParallelism = Environment.ProcessorCount }).ForAll(x => x.StartTracking());
                        return Task.FromResult<IEnumerable<ShipmentInvoiceRiderDetails>>(entities); 
                    }
					else
					{
		 ...
		 public Task<IEnumerable<ShipmentInvoiceRiderDetails>> GetShipmentInvoiceRiderDetailsByExpressionLst(List<string> expLst, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
                using (var dbContext = new EntryDataDSContext(){StartTracking = StartTracking})
                {
                    dbContext.Database.CommandTimeout = 0;
					if (expLst.Count == 0 || expLst.FirstOrDefault() == "None") return Task.FromResult<IEnumerable<ShipmentInvoiceRiderDetails>>(new List<ShipmentInvoiceRiderDetails>());
					var set = AddIncludes(includesLst, dbContext);
        ...
        public Task<IEnumerable<ShipmentInvoiceRiderDetails>> GetShipmentInvoiceRiderDetailsByBatch(string exp,
        ...
        public Task<IEnumerable<ShipmentInvoiceRiderDetails>> GetShipmentInvoiceRiderDetailsByBatchExpressionLst(List<string> expLst,
                                                                                                                 int totalrow, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
        ...
        public Task<ShipmentInvoiceRiderDetails> UpdateShipmentInvoiceRiderDetails(ShipmentInvoiceRiderDetails entity)
        { 
            using ( var dbContext = new EntryDataDSContext(){StartTracking = StartTracking})
              {
                try
        ...
        public Task<ShipmentInvoiceRiderDetails> CreateShipmentInvoiceRiderDetails(ShipmentInvoiceRiderDetails entity)
        {
            try
            {
                var res = (ShipmentInvoiceRiderDetails) entity;
        ...
        public Task<bool> DeleteShipmentInvoiceRiderDetails(string Id)
        {
            try
            {
              using ( var dbContext = new EntryDataDSContext(){StartTracking = StartTracking})
              {
                var i = Convert.ToInt32(Id);
                ShipmentInvoiceRiderDetails entity = dbContext.ShipmentInvoiceRiderDetails
		...
		public Task<int> Count(string exp)
        {
            try
            {
                using (EntryDataDSContext dbContext = new EntryDataDSContext(){StartTracking = StartTracking})
                {
                    ...
                    if (exp == "All")
                    {
                        return Task.FromResult(dbContext.ShipmentInvoiceRiderDetails
                            .AsNoTracking()
                            .Count());
                    }
                    else
        ...
        public Task<IEnumerable<ShipmentInvoiceRiderDetails>> LoadRange(int startIndex, int count, string exp)
        {
            try
            {
                using (var dbContext = new EntryDataDSContext(){StartTracking = StartTracking})
                {
                    ...
                    if (exp == "All")
                    {
                        return Task.FromResult<IEnumerable<ShipmentInvoiceRiderDetails>>(dbContext.ShipmentInvoiceRiderDetails
                            .AsNoTracking()
                            .OrderBy(y => y.Id)
                            .Skip(startIndex)
                            .Take(count)
		...
		public async Task<int> CountNav(string exp, Dictionary<string, string> navExp)
        {
            try
            {
                ...
                using (var dbContext = new EntryDataDSContext(){StartTracking = StartTracking})
                {
                    ...
                    if (exp == "All" && navExp.Count == 0)
                    {
                        return dbContext.ShipmentInvoiceRiderDetails
										.AsNoTracking()
                                        .Count();
                    }
                    foreach (var itm in navExp)
                    ...
                    return dbContext.ShipmentInvoiceRiderDetails.Where(exp == "All" || exp == null ? "Id != null" : exp)
											.AsNoTracking()
                                            .Count();
                }
                                                                                 ...
                                                                                 Dictionary<string, string> navExp, IEnumerable<string> includeLst = null)
        {
            try
            {
                using (var dbContext = new EntryDataDSContext(){StartTracking = StartTracking})
                {
                    ...
                    return set//dbContext.ShipmentInvoiceRiderDetails
								.AsNoTracking()
                                .Where(exp == "All" || exp == null ? "Id != null" : exp)
								.OrderBy(y => y.Id)
		...
		private static Task<IEnumerable<ShipmentInvoiceRiderDetails>> LoadRangeSelectMany<T>(int startIndex, int count,
                                                                                             EntryDataDSContext dbContext, string exp, string navExp, string navProp, IEnumerable<string> includeLst = null) where T : class
        {
            ...
            return Task.FromResult<IEnumerable<ShipmentInvoiceRiderDetails>>(set
                .Where(exp == "All" || exp == null ? "Id != null" : exp)
                .Distinct()
                .OrderBy(y => y.Id)
		...
		private static Task<IEnumerable<ShipmentInvoiceRiderDetails>> LoadRangeSelect<T>(int startIndex, int count,
                                                                                         EntryDataDSContext dbContext, string exp, string navExp, string navProp, IEnumerable<string> includeLst = null) where T : class
        {
			try
			{
		...
		private static Task<IEnumerable<ShipmentInvoiceRiderDetails>> GetWhereSelectMany<T>(EntryDataDSContext dbContext,
                                                                                            string exp, string navExp, string navProp, List<string> includesLst = null) where T : class
        {
			...
			if (includesLst == null)
			{
				return Task.FromResult<IEnumerable<ShipmentInvoiceRiderDetails>>(dbContext.Set<T>()
                    .AsNoTracking()
                    .Where(navExp)
                    .SelectMany(navProp).OfType<ShipmentInvoiceRiderDetails>()
                    .Where(exp == "All" || exp == null?"Id != null":exp)
            ...
            return Task.FromResult<IEnumerable<ShipmentInvoiceRiderDetails>>(set.ToList());
			}
			catch (Exception)
			{
				Debugger.Break();
		...
		private static Task<IEnumerable<ShipmentInvoiceRiderDetails>> GetWhereSelect<T>(EntryDataDSContext dbContext,
                                                                                        string exp, string navExp, string navProp, List<string> includesLst = null) where T : class
        {
			try
			{
			...
			catch (Exception)
			{
				...
				throw;
			        ...
			        public Task<IEnumerable<ShipmentInvoiceRiderDetails>> GetShipmentInvoiceRiderDetailsByInvoiceId(string InvoiceId, List<string> includesLst = null)
        {
            try
            {
                using ( var dbContext = new EntryDataDSContext(){StartTracking = StartTracking})
              {
                ...
                var set = AddIncludes(includesLst, dbContext);
                IEnumerable<ShipmentInvoiceRiderDetails> entities = set//dbContext.ShipmentInvoiceRiderDetails
                                      .AsNoTracking()
            ...
            catch (Exception updateEx)
            {
 	        ...
 	        public Task<IEnumerable<ShipmentInvoiceRiderDetails>> GetShipmentInvoiceRiderDetailsByRiderDetailId(string RiderDetailId, List<string> includesLst = null)
        {
            try
            {
                using ( var dbContext = new EntryDataDSContext(){StartTracking = StartTracking})
