    ...
    public partial class AdjustmentShortAllocationService : IAdjustmentShortAllocationService, IDisposable
    {
            ...
            //using (var scope = new TransactionScope(TransactionScopeOption.Required,
               ...
               // {
                  using ( var dbContext = new AllocationQSContext(){StartTracking = StartTracking})
                  {
                    ...
                    IEnumerable<AdjustmentShortAllocation> entities = await set.AsNoTracking().ToListAsync()
        ...
        public async Task<AdjustmentShortAllocation> GetAdjustmentShortAllocationByKey(string AllocationId, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
              ...
              using ( var dbContext = new AllocationQSContext(){StartTracking = StartTracking})
              {
				...
				var set = AddIncludes(includesLst, dbContext);
                AdjustmentShortAllocation entity = await set.AsNoTracking().SingleOrDefaultAsync(x => x.AllocationId == i).ConfigureAwait(continueOnCapturedContext: false);
        ...
        public async Task<bool> DeleteAdjustmentShortAllocation(string AllocationId)
        {
            try
            {
              ...
              {
                var i = Convert.ToInt32(AllocationId);
                AdjustmentShortAllocation entity = await dbContext.AdjustmentShortAllocations
