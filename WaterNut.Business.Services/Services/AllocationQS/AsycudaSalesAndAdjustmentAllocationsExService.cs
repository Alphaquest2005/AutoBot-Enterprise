...
namespace AllocationQS.Business.Services
{
   ...
   [ServiceBehavior(InstanceContextMode = InstanceContextMode.PerCall,
    ...
    public partial class AsycudaSalesAndAdjustmentAllocationsExService : IAsycudaSalesAndAdjustmentAllocationsExService, IDisposable
    {
        //private readonly AllocationQSContext dbContext;

        public bool StartTracking { get; set; }

        public AsycudaSalesAndAdjustmentAllocationsExService()
        {
            try
            {
        ...
        var set = AddIncludes(includesLst, dbContext);
                    IEnumerable<AsycudaSalesAndAdjustmentAllocationsEx> entities = await set.AsNoTracking().ToListAsync().ConfigureAwait(false);
                           //scope.Complete();
        ...
        public async Task<AsycudaSalesAndAdjustmentAllocationsEx> GetAsycudaSalesAndAdjustmentAllocationsExByKey(string TotalValue, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
              ...
              using ( var dbContext = new AllocationQSContext(){StartTracking = StartTracking})
              {
				...
				var set = AddIncludes(includesLst, dbContext);
                AsycudaSalesAndAdjustmentAllocationsEx entity = await set.AsNoTracking().SingleOrDefaultAsync(x => x.TotalValue == i).ConfigureAwait(false);
            ...
            int totalrow, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
                ...
                var res = new ConcurrentQueue<List<AsycudaSalesAndAdjustmentAllocationsEx>>();
            ...
            using ( var dbContext = new AllocationQSContext(){StartTracking = StartTracking})
              {
                try
                {   
                     var res = (AsycudaSalesAndAdjustmentAllocationsEx) entity;
        ...
        public async Task<bool> RemoveSelectedAsycudaSalesAndAdjustmentAllocationsEx(IEnumerable<string> lst)
        {
            try
            {
                StatusModel.StartStatusUpdate("Removing AsycudaSalesAndAdjustmentAllocationsEx", lst.Count());
                var t = Task.Run(() =>
                {
                    using (var ctx = new AsycudaSalesAndAdjustmentAllocationsExService())
                    {
                        foreach (var item in lst.ToList())
                        {

                            ctx.DeleteAsycudaSalesAndAdjustmentAllocationsEx(item).Wait();
		...
		private static async Task<IEnumerable<AsycudaSalesAndAdjustmentAllocationsEx>> LoadRangeWhere<T>(int startIndex, int count,
        ...
        private static async Task<IEnumerable<AsycudaSalesAndAdjustmentAllocationsEx>> GetWhere<T>(AllocationQSContext dbContext,
			        ...
			        public async Task<IEnumerable<AsycudaSalesAndAdjustmentAllocationsEx>> GetAsycudaSalesAndAdjustmentAllocationsExByPreviousItem_Id(string PreviousItem_Id, List<string> includesLst = null)
        {
            try
            {
                using ( var dbContext = new AllocationQSContext(){StartTracking = StartTracking})
              {
                ...
                var set = AddIncludes(includesLst, dbContext);
                IEnumerable<AsycudaSalesAndAdjustmentAllocationsEx> entities = set//dbContext.AsycudaSalesAndAdjustmentAllocationsExes
                                      .AsNoTracking()
             ...
             try
             {
                 using (var dbContext = new AllocationQSContext(){StartTracking = StartTracking})
                 {
					...
					decimal res = 0;
                     ...
                     if (whereExp == "All")
                     {
                          res = Convert.ToDecimal(dbContext.AsycudaSalesAndAdjustmentAllocationsExes.AsNoTracking().Sum(field));
                     }
                     else
                     {
                         res = Convert.ToDecimal(dbContext.AsycudaSalesAndAdjustmentAllocationsExes.AsNoTracking().Where(whereExp).Sum(field));
                     }
             ...
             try
             {
                 using (var dbContext = new AllocationQSContext(){StartTracking = StartTracking})
                 {
					...
					string res = "";
                     ...
                     if (whereExp == "All")
                     {
                          res = Convert.ToString(dbContext.AsycudaSalesAndAdjustmentAllocationsExes.AsNoTracking().Min(field));
                     }
                     else
                     {
                         res = Convert.ToString(dbContext.AsycudaSalesAndAdjustmentAllocationsExes.AsNoTracking().Where(whereExp).Min(field));
                     }
		...
		private static IQueryable<AsycudaSalesAndAdjustmentAllocationsEx> AddIncludes(IEnumerable<string> includesLst, AllocationQSContext dbContext)
       {
		 try
			{
			   if (includesLst == null) includesLst = new List<string>();
			   var set =(DbQuery<AsycudaSalesAndAdjustmentAllocationsEx>) dbContext.AsycudaSalesAndAdjustmentAllocationsExes; 
	   ...
	   private IQueryable<AsycudaSalesAndAdjustmentAllocationsEx> AddWheres(List<string> expLst, IQueryable<AsycudaSalesAndAdjustmentAllocationsEx> set)
        {
            try
            {
