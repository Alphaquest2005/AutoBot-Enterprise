...
namespace AllocationQS.Business.Services
{
   ...
   [ServiceBehavior(InstanceContextMode = InstanceContextMode.PerCall,
    ...
    public partial class AllocationsTestCasService : IAllocationsTestCasService, IDisposable
    {
        ...
        public async Task<IEnumerable<AllocationsTestCas>> GetAllocationsTestCases(List<string> includesLst = null, bool tracking = true)
        {
            try
            {
            //using (var scope = new TransactionScope(TransactionScopeOption.Required,
               ...
               // {
                  using ( var dbContext = new AllocationQSContext(){StartTracking = StartTracking})
                  {
                    ...
                    IEnumerable<AllocationsTestCas> entities = await set.AsNoTracking().ToListAsync()
        ...
        public async Task<AllocationsTestCas> GetAllocationsTestCasByKey(string Id, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
              ...
              using ( var dbContext = new AllocationQSContext(){StartTracking = StartTracking})
              {
				...
				var set = AddIncludes(includesLst, dbContext);
                AllocationsTestCas entity = await set.AsNoTracking().SingleOrDefaultAsync(x => x.Id == i).ConfigureAwait(continueOnCapturedContext: false);
		 ...
		 public async Task<IEnumerable<AllocationsTestCas>> GetAllocationsTestCasesByExpression(string exp, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
                using (var dbContext = new AllocationQSContext(){StartTracking = StartTracking})
                {
					...
					if (string.IsNullOrEmpty(exp) || exp == "None") return new List<AllocationsTestCas>();
					var set = AddIncludes(includesLst, dbContext);
                    if (exp == "All")
                    {
		 ...
		 public async Task<IEnumerable<AllocationsTestCas>> GetAllocationsTestCasesByExpressionLst(List<string> expLst, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
                using (var dbContext = new AllocationQSContext(){StartTracking = StartTracking})
                {
                    dbContext.Database.CommandTimeout = 0;
					if (expLst.Count == 0 || expLst.FirstOrDefault() == "None") return new List<AllocationsTestCas>();
					var set = AddIncludes(includesLst, dbContext);
        ...
        public async Task<bool> DeleteAllocationsTestCas(string Id)
        {
            try
            {
              ...
              {
                var i = Convert.ToInt32(Id);
                AllocationsTestCas entity = await dbContext.AllocationsTestCases
                                                                                 ...
                                                                                 Dictionary<string, string> navExp, IEnumerable<string> includeLst = null)
        {
            try
            {
                ...
                {
                    dbContext.Database.CommandTimeout = 0;
                    if ((string.IsNullOrEmpty(exp) && navExp.Count == 0) || exp == "None") return new List<AllocationsTestCas>();
		...
		private static async Task<IEnumerable<AllocationsTestCas>> LoadRangeSelectMany<T>(int startIndex, int count,
		...
		private static async Task<IEnumerable<AllocationsTestCas>> LoadRangeSelect<T>(int startIndex, int count,
            AllocationQSContext dbContext, string exp, string navExp, string navProp, IEnumerable<string> includeLst = null) where T : class
        {
			try
			{
		...
		private static async Task<IEnumerable<AllocationsTestCas>> GetWhereSelectMany<T>(AllocationQSContext dbContext,
		...
		private static async Task<IEnumerable<AllocationsTestCas>> GetWhereSelect<T>(AllocationQSContext dbContext,
            string exp, string navExp, string navProp, List<string> includesLst = null) where T : class
        {
			try
			{
			        ...
			        public async Task<IEnumerable<AllocationsTestCas>> GetAllocationsTestCasByEntryDataDetailsId(string EntryDataDetailsId, List<string> includesLst = null)
        {
            try
            {
                using ( var dbContext = new AllocationQSContext(){StartTracking = StartTracking})
              {
                ...
                var set = AddIncludes(includesLst, dbContext);
                IEnumerable<AllocationsTestCas> entities = await set//dbContext.AllocationsTestCases
                                      .AsNoTracking()
