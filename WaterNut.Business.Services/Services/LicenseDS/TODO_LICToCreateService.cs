...
namespace LicenseDS.Business.Services
{
   ...
   [ServiceBehavior(InstanceContextMode = InstanceContextMode.PerCall,
    ...
    public partial class TODO_LICToCreateService : ITODO_LICToCreateService, IDisposable
    {
		...
		private static async Task<IEnumerable<TODO_LICToCreate>> GetWhereSelectMany<T>(LicenseDSContext dbContext,
		...
		private static async Task<IEnumerable<TODO_LICToCreate>> GetWhereSelect<T>(LicenseDSContext dbContext,
            string exp, string navExp, string navProp, List<string> includesLst = null) where T : class
        {
			try
			{
