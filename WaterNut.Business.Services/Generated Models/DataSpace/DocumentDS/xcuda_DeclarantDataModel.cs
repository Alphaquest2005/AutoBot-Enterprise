...
{
	public partial class xcuda_DeclarantDataModel_AutoGen 
	{
        private static readonly xcuda_DeclarantDataModel_AutoGen instance;
        static xcuda_DeclarantDataModel_AutoGen()
        {
            instance = new xcuda_DeclarantDataModel_AutoGen();
        }

        public static  xcuda_DeclarantDataModel_AutoGen Instance
        {
            get { return instance; }
        }
