...
namespace CoreEntities.Business.Services
{
    ...
    public partial interface ITODO_SubmitAllXMLToCustomsService : IBusinessService
    {
        [OperationContract]
        [FaultContract(typeof(ValidationFault))]
        Task<IEnumerable<TODO_SubmitAllXMLToCustoms>> GetTODO_SubmitAllXMLToCustoms(List<string> includesLst = null, bool tracking = true);

        [OperationContract]
        [FaultContract(typeof(ValidationFault))]
        Task<TODO_SubmitAllXMLToCustoms> GetTODO_SubmitAllXMLToCustomsByKey(string id, List<string> includesLst = null, bool tracking = true);

		[OperationContract]
        [FaultContract(typeof(ValidationFault))]
        Task<IEnumerable<TODO_SubmitAllXMLToCustoms>> GetTODO_SubmitAllXMLToCustomsByExpression(string exp, List<string> includesLst = null, bool tracking = true);

		[OperationContract]
        [FaultContract(typeof(ValidationFault))]
        Task<IEnumerable<TODO_SubmitAllXMLToCustoms>> GetTODO_SubmitAllXMLToCustomsByExpressionLst(List<string> expLst, List<string> includesLst = null, bool tracking = true);
        ...
        [OperationContract]
        [FaultContract(typeof(ValidationFault))]
        Task<IEnumerable<TODO_SubmitAllXMLToCustoms>> GetTODO_SubmitAllXMLToCustomsByBatchExpressionLst(List<string> exp,
            int totalrow, List<string> includesLst = null, bool tracking = true);
