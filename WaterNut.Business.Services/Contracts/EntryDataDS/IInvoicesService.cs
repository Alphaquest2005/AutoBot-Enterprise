...
namespace EntryDataDS.Business.Services
{
    ...
    public partial interface IInvoicesService : IBusinessService
    {
        ...
        Task<IEnumerable<Invoices>> GetEntryData(List<string> includesLst = null, bool tracking = true);
		...
		[OperationContract]
        [FaultContract(typeof(ValidationFault))]
        Task<IEnumerable<Invoices>> GetEntryDataByExpression(string exp, List<string> includesLst = null, bool tracking = true);

		[OperationContract]
        [FaultContract(typeof(ValidationFault))]
        Task<IEnumerable<Invoices>> GetEntryDataByExpressionLst(List<string> expLst, List<string> includesLst = null, bool tracking = true);

		[OperationContract]
        [FaultContract(typeof(ValidationFault))]
		Task<IEnumerable<Invoices>> GetEntryDataByExpressionNav(string exp,
            Dictionary<string, string> navExp, List<string> includesLst = null, bool tracking = true);

        [OperationContract]
        [FaultContract(typeof(ValidationFault))]
        Task<IEnumerable<Invoices>> GetEntryDataByBatch(string exp,
            int totalrow, List<string> includesLst = null, bool tracking = true);

        [OperationContract]
        [FaultContract(typeof(ValidationFault))]
        Task<IEnumerable<Invoices>> GetEntryDataByBatchExpressionLst(List<string> exp,
            int totalrow, List<string> includesLst = null, bool tracking = true);
		...
		string MinField(string whereExp, string field);
				...
				[OperationContract]
        [FaultContract(typeof(ValidationFault))]
        Task<IEnumerable<Invoices>> GetInvoicesByEntryDataId(string EntryDataId, List<string> includesLst = null);
  		[OperationContract]
        [FaultContract(typeof(ValidationFault))]
        Task<IEnumerable<Invoices>> GetInvoicesByApplicationSettingsId(string ApplicationSettingsId, List<string> includesLst = null);
  		[OperationContract]
        [FaultContract(typeof(ValidationFault))]
        Task<IEnumerable<Invoices>> GetInvoicesByEmailId(string EmailId, List<string> includesLst = null);
  		[OperationContract]
        [FaultContract(typeof(ValidationFault))]
