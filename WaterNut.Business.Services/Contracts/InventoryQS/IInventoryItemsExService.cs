...
namespace InventoryQS.Business.Services
{
    ...
    public partial interface IInventoryItemsExService : IBusinessService
    {
        ...
        Task<IEnumerable<InventoryItemsEx>> GetInventoryItemsEx(List<string> includesLst = null, bool tracking = true);
		...
		[OperationContract]
        [FaultContract(typeof(ValidationFault))]
        Task<IEnumerable<InventoryItemsEx>> GetInventoryItemsExByExpression(string exp, List<string> includesLst = null, bool tracking = true);

		[OperationContract]
        [FaultContract(typeof(ValidationFault))]
        Task<IEnumerable<InventoryItemsEx>> GetInventoryItemsExByExpressionLst(List<string> expLst, List<string> includesLst = null, bool tracking = true);
        ...
        [OperationContract]
        [FaultContract(typeof(ValidationFault))]
        Task<IEnumerable<InventoryItemsEx>> GetInventoryItemsExByBatchExpressionLst(List<string> exp,
            int totalrow, List<string> includesLst = null, bool tracking = true);
