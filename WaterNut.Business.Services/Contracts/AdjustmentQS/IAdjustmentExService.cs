...
namespace AdjustmentQS.Business.Services
{
    ...
    public partial interface IAdjustmentExService : IBusinessService
    {
        [OperationContract]
        [FaultContract(typeof(ValidationFault))]
        Task<IEnumerable<AdjustmentEx>> GetAdjustmentExes(List<string> includesLst = null, bool tracking = true);

        [OperationContract]
        [FaultContract(typeof(ValidationFault))]
        Task<AdjustmentEx> GetAdjustmentExByKey(string id, List<string> includesLst = null, bool tracking = true);

		[OperationContract]
        [FaultContract(typeof(ValidationFault))]
        Task<IEnumerable<AdjustmentEx>> GetAdjustmentExesByExpression(string exp, List<string> includesLst = null, bool tracking = true);

		[OperationContract]
        [FaultContract(typeof(ValidationFault))]
        Task<IEnumerable<AdjustmentEx>> GetAdjustmentExesByExpressionLst(List<string> expLst, List<string> includesLst = null, bool tracking = true);
        ...
        [OperationContract]
        [FaultContract(typeof(ValidationFault))]
        Task<IEnumerable<AdjustmentEx>> GetAdjustmentExesByBatchExpressionLst(List<string> exp,
            int totalrow, List<string> includesLst = null, bool tracking = true);
