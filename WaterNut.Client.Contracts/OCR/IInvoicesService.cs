...
namespace OCR.Client.Contracts
{
    ...
    public partial interface IInvoicesService : IClientService
    {
        [OperationContract]
        Task<IEnumerable<Invoices>> GetInvoices(List<string> includesLst = null);

        [OperationContract]
        Task<Invoices> GetInvoicesByKey(string id, List<string> includesLst = null);

		[OperationContract]
        Task<IEnumerable<Invoices>> GetInvoicesByExpression(string exp, List<string> includesLst = null);

		[OperationContract]
        Task<IEnumerable<Invoices>> GetInvoicesByExpressionLst(List<string> expLst, List<string> includesLst = null);
        ...
        [OperationContract]
        Task<IEnumerable<Invoices>> GetInvoicesByBatchExpressionLst(List<string> expLst,
                                                                        int totalrow, List<string> includesLst = null);
