...
namespace OCR.Client.Contracts
{
    ...
    public partial interface IFieldsService : IClientService
    {
        [OperationContract]
        Task<IEnumerable<Fields>> GetFields(List<string> includesLst = null);

        [OperationContract]
        Task<Fields> GetFieldsByKey(string id, List<string> includesLst = null);

		[OperationContract]
        Task<IEnumerable<Fields>> GetFieldsByExpression(string exp, List<string> includesLst = null);

		[OperationContract]
        Task<IEnumerable<Fields>> GetFieldsByExpressionLst(List<string> expLst, List<string> includesLst = null);
        ...
        [OperationContract]
        Task<IEnumerable<Fields>> GetFieldsByBatchExpressionLst(List<string> expLst,
                                                                        int totalrow, List<string> includesLst = null);
