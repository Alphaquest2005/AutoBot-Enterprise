...
*   **Purpose:** Index of immutable entries providing seeds for deterministic LTM filename construction.
*   **Format:**
...
*   `LTM_File_Path`: The deterministically constructed path to the immutable LTM file (e.g., `LTM/SerilogConfig-FileSink-Info_Iter7.md`).
