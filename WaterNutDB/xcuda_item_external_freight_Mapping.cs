...
namespace WaterNutDB
{
    ...
    internal partial class xcuda_item_external_freight_Mapping : EntityTypeConfiguration<xcuda_item_external_freight>
    {
        public xcuda_item_external_freight_Mapping()
        {                        
              this.HasKey(t => t.Valuation_item_Id);        
              this.ToTable("xcuda_item_external_freight");
              ...
              this.HasRequired(t => t.xcuda_Valuation_item).WithOptional(t => t.xcuda_item_external_freight);
         }
    }
}
