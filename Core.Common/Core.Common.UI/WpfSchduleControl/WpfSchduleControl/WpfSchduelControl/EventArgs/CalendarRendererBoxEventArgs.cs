...
namespace WpfSchduleControl
{
        ...
        : CalendarRendererEventArgs
    {
        ...
        public CalendarRendererBoxEventArgs(CalendarRendererEventArgs original, Rect bounds, string text)
            : this(original)
        {
            Bounds = bounds;
            Text = text;
        ...
        public CalendarRendererBoxEventArgs(CalendarRendererEventArgs original, Rect bounds, string text, Color textColor, TextFormatFlags flags)
            : this(original)
        {
            Bounds = bounds;
            Text = text;
        ...
        public CalendarRendererBoxEventArgs(CalendarRendererEventArgs original, Rect bounds, string text, Color textColor, Color backgroundColor)
            : this(original)
        {
            Bounds = bounds;
            Text = text;
