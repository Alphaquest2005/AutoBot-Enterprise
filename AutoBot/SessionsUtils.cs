    ...
    public class SessionsUtils
    {
        public static Dictionary<string, Action> SessionActions =>
            new Dictionary<string, Action>(WaterNut.DataSpace.Utils.ignoreCase)
            {
                ...
                {"ImportAllSalesEntries", DocumentUtils.ImportAllSalesEntries },
                ...
                {"ImportAllFilesInDataFolder", ImportAllAsycudaDocumentsInDataFolderUtils.ImportAllAsycudaDocumentsInDataFolder},
