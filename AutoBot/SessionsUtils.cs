    ...
    public class SessionsUtils
    {
        public static Dictionary<string, Action> SessionActions =>
            new Dictionary<string, Action>(WaterNut.DataSpace.Utils.ignoreCase)
            {
                ...
                {"CreateEx9",() => EX9Utils.CreateEx9(false) },
                {"ExportEx9Entries", EX9Utils.ExportEx9Entries },
                {"AssessEx9Entries", EX9Utils.AssessEx9Entries },
                ...
                {"ImportWarehouseErrors", ImportWarehouseErrorsUtils.ImportWarehouseErrors},
