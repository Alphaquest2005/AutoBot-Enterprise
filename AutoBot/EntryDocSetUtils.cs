...
namespace AutoBot
{
    public class EntryDocSetUtils
    {
        ...
        {
            await EX9Utils.EmailEntriesExpiringNextMonth().ConfigureAwait(false);
        }

        public static async Task ImportCancelledEntries(FileTypes arg1, FileInfo[] arg2)
        {
            await ImportCancelledEntries().ConfigureAwait(false);
        }

        public static async Task ImportExpiredEntires(FileTypes arg1, FileInfo[] arg2)
        {
            await ImportExpiredEntires().ConfigureAwait(false);
        }

        public static async Task EmailWarehouseErrors(FileTypes arg1, FileInfo[] arg2)
        {
            await EX9Utils.EmailWarehouseErrors().ConfigureAwait(false);
        }

        public static async Task FixIncompleteEntries(FileTypes arg1, FileInfo[] arg2)
        {
            await FixIncompleteEntries().ConfigureAwait(false);
        }

        public static async Task RemoveDuplicateEntries(FileTypes ft, FileInfo[] fs)
        {
        ...
        public static async Task ImportExpiredEntires()
        {
            try
            {
                var docSet = await BaseDataModel.CurrentSalesInfo(-1).ConfigureAwait(false);
                ...
                await ImportExpiredEntires(expFile).ConfigureAwait(false);
            }
            catch (Exception e)
            {
                Console.WriteLine(e);
        ...
        public static async Task ImportExpiredEntires(string expFile)
        {
        ...
        public static async Task ImportCancelledEntries()
        {
            try
            {
                var docSet = await BaseDataModel.CurrentSalesInfo(-1).ConfigureAwait(false);
                ...
                await ImportCancelledEntries(expFile).ConfigureAwait(false);
            }
            catch (Exception e)
            {
                Console.WriteLine(e);
        ...
        public static async Task ImportCancelledEntries(string expFile)
        {
        ...
        public static async Task RenameDuplicateDocuments()
        {
            try
            {
                Console.WriteLine("Rename Duplicate Documents");
        ...
        public static Task AttachToDocSetByRef(FileTypes ft)
        {
            return BaseDataModel.Instance.AttachToExistingDocuments(ft.AsycudaDocumentSetId);
        }

        public static async Task AttachToDocSetByRef()
        {
            ...
            using (var ctx = new CoreEntitiesContext())
            {
                ...
                {
                    await BaseDataModel.Instance.AttachToExistingDocuments(doc).ConfigureAwait(false);
                }
            }
        }
        ...
        public static async Task SubmitEntryCIF(FileTypes ft, FileInfo[] fs)
        {
            try
            {
        ...
        public static async Task AssessEntries(string docReference, int asycudaDocumentSetId)
        {
            ...
            await Utils.RetryAssess(instrFile, resultsFile, directoryName, 3).ConfigureAwait(false);
        }

        public static async Task ClearDocSetEntries(FileTypes fileType)
        {
            try
            {
                Console.WriteLine($"Clear {fileType.FileImporterInfos.EntryType} Entries");
                var docSet = await BaseDataModel.Instance.GetAsycudaDocumentSet(fileType.AsycudaDocumentSetId).ConfigureAwait(false);
                ...
                {
                    await BaseDataModel.Instance.ClearAsycudaDocumentSet(fileType.AsycudaDocumentSetId).ConfigureAwait(false);
        ...
        public static async Task FixIncompleteEntries()
        {
            try
            {
                ...
                using (var ctx = new CoreEntitiesContext())
                {
                    ...
                    foreach (var doc in lst)
                    {
                        await BaseDataModel.Instance.DeleteAsycudaDocument(doc.Key.ASYCUDA_Id).ConfigureAwait(false);
                        await BaseDataModel.Instance.ImportDocuments(doc.Key.AsycudaDocumentSetId.GetValueOrDefault(), new List<string>() { doc.Key.SourceFileName }, true, true, false, true, true).ConfigureAwait(false);
                    }
                }
            }
            catch (Exception e)
        ...
        public static async Task RemoveDuplicateEntries()
        {
            try
            {
