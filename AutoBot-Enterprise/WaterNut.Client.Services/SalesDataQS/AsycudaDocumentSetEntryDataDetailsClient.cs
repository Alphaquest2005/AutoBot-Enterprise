...
{
    [Export (typeof(AsycudaDocumentSetEntryDataDetailsClient))]
    [Export (typeof(IAsycudaDocumentSetEntryDataDetailsService))]
    ...
    public partial class AsycudaDocumentSetEntryDataDetailsClient :  ClientService<IAsycudaDocumentSetEntryDataDetailsService>, IAsycudaDocumentSetEntryDataDetailsService, IDisposable
    {
        ...
        public async Task<IEnumerable<AsycudaDocumentSetEntryDataDetails>> GetAsycudaDocumentSetEntryDataDetailsByBatch(string exp,
                                                                        int totalrow, List<string> includesLst = null)
        {
            return await Channel.GetAsycudaDocumentSetEntryDataDetailsByBatch(exp, totalrow, includesLst).ConfigureAwait(false);
        }

        public async Task<IEnumerable<AsycudaDocumentSetEntryDataDetails>> GetAsycudaDocumentSetEntryDataDetailsByBatchExpressionLst(List<string> expLst,
                                                                        int totalrow, List<string> includesLst = null)
        {
        ...
        {
            return await Channel.DeleteAsycudaDocumentSetEntryDataDetails(id).ConfigureAwait(false);
        }
        ...
        {
           return await Channel.RemoveSelectedAsycudaDocumentSetEntryDataDetails(selectedAsycudaDocumentSetEntryDataDetails).ConfigureAwait(false);
        }
