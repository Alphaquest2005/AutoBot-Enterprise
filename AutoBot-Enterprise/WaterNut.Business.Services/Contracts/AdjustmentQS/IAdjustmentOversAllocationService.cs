...
namespace AdjustmentQS.Business.Services
{
    ...
    public partial interface IAdjustmentOversAllocationService : IBusinessService
    {
        [OperationContract]
        [FaultContract(typeof(ValidationFault))]
        Task<IEnumerable<AdjustmentOversAllocation>> GetAdjustmentOversAllocations(List<string> includesLst = null, bool tracking = true);

        [OperationContract]
        [FaultContract(typeof(ValidationFault))]
        Task<AdjustmentOversAllocation> GetAdjustmentOversAllocationByKey(string id, List<string> includesLst = null, bool tracking = true);

		[OperationContract]
        [FaultContract(typeof(ValidationFault))]
        Task<IEnumerable<AdjustmentOversAllocation>> GetAdjustmentOversAllocationsByExpression(string exp, List<string> includesLst = null, bool tracking = true);

		[OperationContract]
        [FaultContract(typeof(ValidationFault))]
        Task<IEnumerable<AdjustmentOversAllocation>> GetAdjustmentOversAllocationsByExpressionLst(List<string> expLst, List<string> includesLst = null, bool tracking = true);
        ...
        [OperationContract]
        [FaultContract(typeof(ValidationFault))]
        Task<IEnumerable<AdjustmentOversAllocation>> GetAdjustmentOversAllocationsByBatchExpressionLst(List<string> exp,
            int totalrow, List<string> includesLst = null, bool tracking = true);
