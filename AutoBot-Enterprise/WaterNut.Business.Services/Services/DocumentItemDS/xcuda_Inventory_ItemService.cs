...
namespace DocumentItemDS.Business.Services
{
   ...
   [ServiceBehavior(InstanceContextMode = InstanceContextMode.PerCall,
    ...
    public partial class xcuda_Inventory_ItemService : Ixcuda_Inventory_ItemService, IDisposable
    {
        ...
        private static async Task<IEnumerable<xcuda_Inventory_Item>> GetWhere<T>(DocumentItemDSContext dbContext,
		...
		private static async Task<IEnumerable<xcuda_Inventory_Item>> GetWhereSelectMany<T>(DocumentItemDSContext dbContext,
		...
		private static async Task<IEnumerable<xcuda_Inventory_Item>> GetWhereSelect<T>(DocumentItemDSContext dbContext,
            string exp, string navExp, string navProp, List<string> includesLst = null) where T : class
        {
			try
			{
		...
		private static IQueryable<xcuda_Inventory_Item> AddIncludes(IEnumerable<string> includesLst, DocumentItemDSContext dbContext)
       {
		 try
			{
