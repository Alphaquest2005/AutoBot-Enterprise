...
namespace EntryDataDS.Business.Services
{
   ...
   [ServiceBehavior(InstanceContextMode = InstanceContextMode.PerCall,
    ...
    public partial class AsycudaDocumentSetEntryDataService : IAsycudaDocumentSetEntryDataService, IDisposable
    {
        ...
        public async Task<IEnumerable<AsycudaDocumentSetEntryData>> GetAsycudaDocumentSetEntryData(List<string> includesLst = null, bool tracking = true)
        {
            try
            {
        ...
        public async Task<AsycudaDocumentSetEntryData> GetAsycudaDocumentSetEntryDataByKey(string Id, List<string> includesLst = null, bool tracking = true)
        {
		 ...
		 public async Task<IEnumerable<AsycudaDocumentSetEntryData>> GetAsycudaDocumentSetEntryDataByExpression(string exp, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
                using (var dbContext = new EntryDataDSContext(){StartTracking = StartTracking})
		 ...
		 public async Task<IEnumerable<AsycudaDocumentSetEntryData>> GetAsycudaDocumentSetEntryDataByExpressionLst(List<string> expLst, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
                using (var dbContext = new EntryDataDSContext(){StartTracking = StartTracking})
		...
		public async Task<IEnumerable<AsycudaDocumentSetEntryData>> GetAsycudaDocumentSetEntryDataByExpressionNav(string exp,
                    ...
                    foreach (var itm in navExp)
                    {
                        switch (itm.Key)
                        {
                            case "EntryData":
                                return
                                    await
                                        GetWhere<EntryData>(dbContext, exp, itm.Value, "AsycudaDocumentSets", "SelectMany", includesLst)
        ...
        public async Task<AsycudaDocumentSetEntryData> CreateAsycudaDocumentSetEntryData(AsycudaDocumentSetEntryData entity)
        {
            try
            {
              ...
              using ( var dbContext = new EntryDataDSContext(){StartTracking = StartTracking})
              {
                dbContext.AsycudaDocumentSetEntryData.Add(res);
                dbContext.SaveChanges();
                res.AcceptChanges();
                return res;
              }
        ...
        public async Task<bool> DeleteAsycudaDocumentSetEntryData(string Id)
        {
            try
            {
              ...
              {
                var i = Convert.ToInt32(Id);
                AsycudaDocumentSetEntryData entity = dbContext.AsycudaDocumentSetEntryData
													.SingleOrDefault(x => x.Id == i);
                if (entity == null)
                    return false;

                    dbContext.AsycudaDocumentSetEntryData.Attach(entity);
                    dbContext.AsycudaDocumentSetEntryData.Remove(entity);
                    dbContext.SaveChanges();
                    return true;
              }
            }
         ...
         public async Task<int> CountByExpressionLst(List<string> expLst)
        {
            try
            {
                using (var dbContext = new EntryDataDSContext(){StartTracking = StartTracking})
                {
                    ...
                    var set = (IQueryable<AsycudaDocumentSetEntryData>)dbContext.AsycudaDocumentSetEntryData; 
                    if (expLst.FirstOrDefault() == "All")
                    {
		...
		public async Task<int> Count(string exp)
        {
            try
            {
                using (EntryDataDSContext dbContext = new EntryDataDSContext(){StartTracking = StartTracking})
                {
                    ...
                    if (exp == "All")
                    {
                        return dbContext.AsycudaDocumentSetEntryData
                                    .AsNoTracking()
									.Count();
                    }
                    else
            ...
            try
            {
                ...
                using (var dbContext = new EntryDataDSContext(){StartTracking = StartTracking})
                {
                    ...
                    foreach (var itm in navExp)
                    {
                        ...
                        {
                            case "EntryData":
                                return await CountWhere<EntryData>(dbContext, exp, itm.Value, "AsycudaDocumentSets", "SelectMany")
											.ConfigureAwait(continueOnCapturedContext: false);
						}
                    }
                    return dbContext.AsycudaDocumentSetEntryData.Where(exp == "All" || exp == null ? "Id != null" : exp)
											.AsNoTracking()
                                            .Count();
                }
                                                                                 ...
                                                                                 Dictionary<string, string> navExp, IEnumerable<string> includeLst = null)
        {
            try
            {
                using (var dbContext = new EntryDataDSContext(){StartTracking = StartTracking})
                {
                    ...
                    foreach (var itm in navExp)
                    {
                        switch (itm.Key)
                        {
                            case "EntryData":
                                return
                                    await
                                        LoadRangeWhere<EntryData>(startIndex, count, dbContext, exp, itm.Value, "AsycudaDocumentSets", "SelectMany")
													.ConfigureAwait(continueOnCapturedContext: false);
                    ...
                    return set//dbContext.AsycudaDocumentSetEntryData
								.AsNoTracking()
                                .Where(exp == "All" || exp == null ? "Id != null" : exp)
								.OrderBy(y => y.Id)
        ...
        private static async Task<IEnumerable<AsycudaDocumentSetEntryData>> GetWhere<T>(EntryDataDSContext dbContext,
		...
		private static async Task<IEnumerable<AsycudaDocumentSetEntryData>> GetWhereSelectMany<T>(EntryDataDSContext dbContext,
		...
		private static async Task<IEnumerable<AsycudaDocumentSetEntryData>> GetWhereSelect<T>(EntryDataDSContext dbContext,
            string exp, string navExp, string navProp, List<string> includesLst = null) where T : class
        {
			try
			{
			        ...
			        public async Task<IEnumerable<AsycudaDocumentSetEntryData>> GetAsycudaDocumentSetEntryDataByAsycudaDocumentSetId(string AsycudaDocumentSetId, List<string> includesLst = null)
        {
            try
            {
                using ( var dbContext = new EntryDataDSContext(){StartTracking = StartTracking})
              {
                ...
                var set = AddIncludes(includesLst, dbContext);
                IEnumerable<AsycudaDocumentSetEntryData> entities = set//dbContext.AsycudaDocumentSetEntryData
                                      .AsNoTracking()
             ...
             try
             {
                 using (var dbContext = new EntryDataDSContext(){StartTracking = StartTracking})
                 {
					...
					decimal res = 0;
                     ...
                     if (whereExp == "All")
                     {
                          res = Convert.ToDecimal(dbContext.AsycudaDocumentSetEntryData.AsNoTracking().Sum(field));
                     }
                     else
                     {
                         res = Convert.ToDecimal(dbContext.AsycudaDocumentSetEntryData.AsNoTracking().Where(whereExp).Sum(field));
                     }
        ...
        public async Task<decimal> SumNav( string exp, Dictionary<string, string> navExp, string field)
        {
            try
            {
                ...
                {
                    dbContext.Database.CommandTimeout = 0;
                    if (!dbContext.AsycudaDocumentSetEntryData.Any()) return 0;
                    if (exp == "All" && navExp.Count == 0)
                    {
                        return Convert.ToDecimal(dbContext.AsycudaDocumentSetEntryData
										.AsNoTracking()
                                        .Sum(field)??0);
                    }
                    foreach (var itm in navExp)
                    {
                        ...
                        {
                            case "EntryData":
                                return await SumWhere<EntryData>(dbContext, exp, itm.Value, "AsycudaDocumentSets", field, "SelectMany")
											.ConfigureAwait(continueOnCapturedContext: false);
						}
                    }
                    return Convert.ToDecimal(dbContext.AsycudaDocumentSetEntryData.Where(exp == "All" || exp == null ? "Id != null" : exp)
											.AsNoTracking()
                                            .Sum(field)??0);
                }
             ...
             try
             {
                 using (var dbContext = new EntryDataDSContext(){StartTracking = StartTracking})
                 {
					...
					string res = "";
                     ...
                     if (whereExp == "All")
                     {
                          res = Convert.ToString(dbContext.AsycudaDocumentSetEntryData.AsNoTracking().Min(field));
                     }
                     else
                     {
                         res = Convert.ToString(dbContext.AsycudaDocumentSetEntryData.AsNoTracking().Where(whereExp).Min(field));
                     }
		...
		private static IQueryable<AsycudaDocumentSetEntryData> AddIncludes(IEnumerable<string> includesLst, EntryDataDSContext dbContext)
       {
		 try
			{
			   if (includesLst == null) includesLst = new List<string>();
			   var set =(DbQuery<AsycudaDocumentSetEntryData>) dbContext.AsycudaDocumentSetEntryData; 
