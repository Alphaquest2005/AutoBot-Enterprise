...
namespace EntryDataDS.Business.Services
{
   ...
   [ServiceBehavior(InstanceContextMode = InstanceContextMode.PerCall,
    ...
    public partial class ShipmentBLDetailsService : IShipmentBLDetailsService, IDisposable
    {
        ...
        public async Task<IEnumerable<ShipmentBLDetails>> GetShipmentBLDetails(List<string> includesLst = null, bool tracking = true)
        {
            try
            {
        ...
        public async Task<ShipmentBLDetails> GetShipmentBLDetailsByKey(string Id, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
		 ...
		 public async Task<IEnumerable<ShipmentBLDetails>> GetShipmentBLDetailsByExpression(string exp, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
                using (var dbContext = new EntryDataDSContext(){StartTracking = StartTracking})
		 ...
		 public async Task<IEnumerable<ShipmentBLDetails>> GetShipmentBLDetailsByExpressionLst(List<string> expLst, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
                using (var dbContext = new EntryDataDSContext(){StartTracking = StartTracking})
                {
                    dbContext.Database.CommandTimeout = 0;
					if (expLst.Count == 0 || expLst.FirstOrDefault() == "None") return new List<ShipmentBLDetails>();
					var set = AddIncludes(includesLst, dbContext);
        ...
        public async Task<IEnumerable<ShipmentBLDetails>> GetShipmentBLDetailsByBatch(string exp,
        ...
        public async Task<IEnumerable<ShipmentBLDetails>> GetShipmentBLDetailsByBatchExpressionLst(List<string> expLst,
            int totalrow, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
        ...
        public async Task<ShipmentBLDetails> UpdateShipmentBLDetails(ShipmentBLDetails entity)
        { 
            using ( var dbContext = new EntryDataDSContext(){StartTracking = StartTracking})
              {
                try
        ...
        public async Task<ShipmentBLDetails> CreateShipmentBLDetails(ShipmentBLDetails entity)
        {
            try
            {
                var res = (ShipmentBLDetails) entity;
        ...
        public async Task<bool> DeleteShipmentBLDetails(string Id)
        {
            try
            {
              using ( var dbContext = new EntryDataDSContext(){StartTracking = StartTracking})
        ...
        public async Task<IEnumerable<ShipmentBLDetails>> LoadRange(int startIndex, int count, string exp)
        {
            try
            {
                using (var dbContext = new EntryDataDSContext(){StartTracking = StartTracking})
		...
		private static async Task<IEnumerable<ShipmentBLDetails>> LoadRangeSelectMany<T>(int startIndex, int count,
		...
		private static async Task<IEnumerable<ShipmentBLDetails>> LoadRangeSelect<T>(int startIndex, int count,
            EntryDataDSContext dbContext, string exp, string navExp, string navProp, IEnumerable<string> includeLst = null) where T : class
        {
			try
			{
		...
		private static async Task<IEnumerable<ShipmentBLDetails>> GetWhereSelectMany<T>(EntryDataDSContext dbContext,
		...
		private static async Task<IEnumerable<ShipmentBLDetails>> GetWhereSelect<T>(EntryDataDSContext dbContext,
            string exp, string navExp, string navProp, List<string> includesLst = null) where T : class
        {
			try
			{
