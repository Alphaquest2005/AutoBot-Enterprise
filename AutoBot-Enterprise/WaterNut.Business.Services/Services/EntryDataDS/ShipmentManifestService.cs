...
{
   [Export (typeof(IShipmentManifestService))]
   [Export(typeof(IBusinessService))]
   [PartCreationPolicy(CreationPolicy.NonShared)]
   [ServiceBehavior(InstanceContextMode = InstanceContextMode.PerCall,
                    ConcurrencyMode = ConcurrencyMode.Multiple)]
   
    public partial class ShipmentManifestService : IShipmentManifestService, IDisposable
    {
        ...
        public async Task<IEnumerable<ShipmentManifest>> GetShipmentManifest(List<string> includesLst = null, bool tracking = true)
        {
            try
            {
            //using (var scope = new TransactionScope(TransactionScopeOption.Required,
               ...
               // {
                  using ( var dbContext = new EntryDataDSContext(){StartTracking = StartTracking})
                  {
                    ...
                    IEnumerable<ShipmentManifest> entities = set.AsNoTracking().ToList();
                           //scope.Complete();
        ...
        public async Task<ShipmentManifest> GetShipmentManifestByKey(string Id, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
              ...
              using ( var dbContext = new EntryDataDSContext(){StartTracking = StartTracking})
              {
				...
				var set = AddIncludes(includesLst, dbContext);
                ShipmentManifest entity = set.AsNoTracking().SingleOrDefault(x => x.Id == i);
		 ...
		 public async Task<IEnumerable<ShipmentManifest>> GetShipmentManifestByExpression(string exp, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
                using (var dbContext = new EntryDataDSContext(){StartTracking = StartTracking})
                {
					...
					if (string.IsNullOrEmpty(exp) || exp == "None") return new List<ShipmentManifest>();
					var set = AddIncludes(includesLst, dbContext);
                    if (exp == "All")
                    {
		 ...
		 public async Task<IEnumerable<ShipmentManifest>> GetShipmentManifestByExpressionLst(List<string> expLst, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
                using (var dbContext = new EntryDataDSContext(){StartTracking = StartTracking})
                {
                    dbContext.Database.CommandTimeout = 0;
					if (expLst.Count == 0 || expLst.FirstOrDefault() == "None") return new List<ShipmentManifest>();
					var set = AddIncludes(includesLst, dbContext);
		...
		public async Task<IEnumerable<ShipmentManifest>> GetShipmentManifestByExpressionNav(string exp,
                ...
                using (var dbContext = new EntryDataDSContext(){StartTracking = StartTracking})
                {
                    ...
                    foreach (var itm in navExp)
                    {
                        switch (itm.Key)
                        {
                            ...
                            case "ShipmentRiderManifests":
                                return
                                    await
                                        GetWhere<ShipmentRiderManifests>(dbContext, exp, itm.Value, "ShipmentManifest", "Select", includesLst)
										.ConfigureAwait(continueOnCapturedContext: false);

                            case "ShipmentFreightManifests":
                                return
                                    await
                                        GetWhere<ShipmentFreightManifests>(dbContext, exp, itm.Value, "ShipmentManifest", "Select", includesLst)
										.ConfigureAwait(continueOnCapturedContext: false);

                            case "Consignees":
                                return
                                    await
                                        GetWhere<Consignees>(dbContext, exp, itm.Value, "ShipmentManifest", "SelectMany", includesLst)
										.ConfigureAwait(continueOnCapturedContext: false);
        ...
        public async Task<IEnumerable<ShipmentManifest>> GetShipmentManifestByBatch(string exp,
            int totalrow, List<string> includesLst = null, bool tracking = true)
        {
            try
            {

                var res = new ConcurrentQueue<List<ShipmentManifest>>();
                    ...
                    //  for (int bat = 0; bat < batches; bat++)
                    {
                        try
                        {
                            using (var dbContext = new EntryDataDSContext(){StartTracking = StartTracking})
                            {
                                ...
                                var set = AddIncludes(includesLst, dbContext);
                                IQueryable<ShipmentManifest> dset;
                                if (exp == "All")
                                {
        ...
        public async Task<IEnumerable<ShipmentManifest>> GetShipmentManifestByBatchExpressionLst(List<string> expLst,
            int totalrow, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
        ...
        public async Task<ShipmentManifest> UpdateShipmentManifest(ShipmentManifest entity)
        { 
            using ( var dbContext = new EntryDataDSContext(){StartTracking = StartTracking})
              {
                try
                {   
                     var res = (ShipmentManifest) entity;
        ...
        public async Task<ShipmentManifest> CreateShipmentManifest(ShipmentManifest entity)
        {
            try
            {
                var res = (ShipmentManifest) entity;
              using ( var dbContext = new EntryDataDSContext(){StartTracking = StartTracking})
              {
                dbContext.ShipmentManifest.Add(res);
                dbContext.SaveChanges();
                res.AcceptChanges();
                return res;
              }
        ...
        public async Task<bool> DeleteShipmentManifest(string Id)
        {
            try
            {
              using ( var dbContext = new EntryDataDSContext(){StartTracking = StartTracking})
              {
                var i = Convert.ToInt32(Id);
                ShipmentManifest entity = dbContext.ShipmentManifest
													.SingleOrDefault(x => x.Id == i);
                if (entity == null)
                    return false;

                    dbContext.ShipmentManifest.Attach(entity);
                    dbContext.ShipmentManifest.Remove(entity);
                    dbContext.SaveChanges();
                    return true;
              }
            }
        ...
        public async Task<bool> RemoveSelectedShipmentManifest(IEnumerable<string> lst)
        {
            try
            {
                StatusModel.StartStatusUpdate("Removing ShipmentManifest", lst.Count());
                var t = Task.Run(() =>
                {
                    using (var ctx = new ShipmentManifestService())
                    {
                        foreach (var item in lst.ToList())
                        {

                            ctx.DeleteShipmentManifest(item).Wait();
         ...
         public async Task<int> CountByExpressionLst(List<string> expLst)
        {
            try
            {
                using (var dbContext = new EntryDataDSContext(){StartTracking = StartTracking})
                {
                    ...
                    var set = (IQueryable<ShipmentManifest>)dbContext.ShipmentManifest; 
                    if (expLst.FirstOrDefault() == "All")
                    {
		...
		public async Task<int> Count(string exp)
        {
            try
            {
                using (EntryDataDSContext dbContext = new EntryDataDSContext(){StartTracking = StartTracking})
                {
                    ...
                    if (exp == "All")
                    {
                        return dbContext.ShipmentManifest
                                    .AsNoTracking()
									.Count();
                    }
                    else
        ...
        public async Task<IEnumerable<ShipmentManifest>> LoadRange(int startIndex, int count, string exp)
        {
            try
            {
                using (var dbContext = new EntryDataDSContext(){StartTracking = StartTracking})
                        ...
                        switch (itm.Key)
                        {
                            ...
                            case "ShipmentManifestBLs":
                                return await CountWhere<ShipmentManifestBLs>(dbContext, exp, itm.Value, "ShipmentManifest", "Select")
											.ConfigureAwait(continueOnCapturedContext: false);
                            case "ShipmentRiderManifests":
                                return await CountWhere<ShipmentRiderManifests>(dbContext, exp, itm.Value, "ShipmentManifest", "Select")
											.ConfigureAwait(continueOnCapturedContext: false);
                            case "ShipmentFreightManifests":
                                return await CountWhere<ShipmentFreightManifests>(dbContext, exp, itm.Value, "ShipmentManifest", "Select")
											.ConfigureAwait(continueOnCapturedContext: false);
                            case "Consignees":
                                return await CountWhere<Consignees>(dbContext, exp, itm.Value, "ShipmentManifest", "SelectMany")
											.ConfigureAwait(continueOnCapturedContext: false);
						}
                    }
                    return dbContext.ShipmentManifest.Where(exp == "All" || exp == null ? "Id != null" : exp)
											.AsNoTracking()
                                            .Count();
                }
		...
		private static async Task<int> CountWhereSelectMany<T>(EntryDataDSContext dbContext, string exp, string navExp, string navProp) where T : class
        {
            ...
            return dbContext.Set<T>()
				.AsNoTracking()
                .Where(navExp)
                .SelectMany(navProp).OfType<ShipmentManifest>()
		...
		private static async Task<int> CountWhereSelect<T>(EntryDataDSContext dbContext, string exp, string navExp, string navProp) where T : class
        {
            ...
            return dbContext.Set<T>()
				.AsNoTracking()
                .Where(navExp)
                .Select(navProp).OfType<ShipmentManifest>()
                .Where(exp == "All" || exp == null ? "Id != null" : exp)
                .Distinct()
                .OrderBy("Id")
                .Count();
		  ...
		  public async Task<IEnumerable<ShipmentManifest>> LoadRangeNav(int startIndex, int count, string exp,
                                                                                 Dictionary<string, string> navExp, IEnumerable<string> includeLst = null)
        {
            try
            {
                ...
                {
                    dbContext.Database.CommandTimeout = 0;
                    if ((string.IsNullOrEmpty(exp) && navExp.Count == 0) || exp == "None") return new List<ShipmentManifest>();
                    ...
                    foreach (var itm in navExp)
                    {
                        switch (itm.Key)
                        {
                            ...
                            case "ShipmentRiderManifests":
                                return
                                    await
                                        LoadRangeWhere<ShipmentRiderManifests>(startIndex, count, dbContext, exp, itm.Value, "ShipmentManifest", "Select")
													.ConfigureAwait(continueOnCapturedContext: false);

                            case "ShipmentFreightManifests":
                                return
                                    await
                                        LoadRangeWhere<ShipmentFreightManifests>(startIndex, count, dbContext, exp, itm.Value, "ShipmentManifest", "Select")
													.ConfigureAwait(continueOnCapturedContext: false);

                            case "Consignees":
                                return
                                    await
                                        LoadRangeWhere<Consignees>(startIndex, count, dbContext, exp, itm.Value, "ShipmentManifest", "SelectMany")
													.ConfigureAwait(continueOnCapturedContext: false);
                    ...
                    return set//dbContext.ShipmentManifest
								.AsNoTracking()
                                .Where(exp == "All" || exp == null ? "Id != null" : exp)
								.OrderBy(y => y.Id)
		...
		private static async Task<IEnumerable<ShipmentManifest>> LoadRangeWhere<T>(int startIndex, int count,
		...
		private static async Task<IEnumerable<ShipmentManifest>> LoadRangeSelectMany<T>(int startIndex, int count,
		...
		private static async Task<IEnumerable<ShipmentManifest>> LoadRangeSelect<T>(int startIndex, int count,
            EntryDataDSContext dbContext, string exp, string navExp, string navProp, IEnumerable<string> includeLst = null) where T : class
        {
			try
			{
        ...
        private static async Task<IEnumerable<ShipmentManifest>> GetWhere<T>(EntryDataDSContext dbContext,
		...
		private static async Task<IEnumerable<ShipmentManifest>> GetWhereSelectMany<T>(EntryDataDSContext dbContext,
            string exp, string navExp, string navProp, List<string> includesLst = null) where T : class
        {
			...
			var set = (DbQuery<ShipmentManifest>)dbContext.Set<T>()
				.AsNoTracking()
                .Where(navExp)
                .SelectMany(navProp).OfType<ShipmentManifest>()
                .Where(exp == "All" || exp == null?"Id != null":exp)
		...
		private static async Task<IEnumerable<ShipmentManifest>> GetWhereSelect<T>(EntryDataDSContext dbContext,
            string exp, string navExp, string navProp, List<string> includesLst = null) where T : class
        {
			try
			{
			...
			catch (Exception)
			{
				...
				throw;
			        ...
			        public async Task<IEnumerable<ShipmentManifest>> GetShipmentManifestByEmailId(string EmailId, List<string> includesLst = null)
        {
            try
            {
                using ( var dbContext = new EntryDataDSContext(){StartTracking = StartTracking})
              {
                var i = EmailId;
                var set = AddIncludes(includesLst, dbContext);
                IEnumerable<ShipmentManifest> entities = set//dbContext.ShipmentManifest
                                                    // .Include(x => x.ShipmentAttachedManifest)									  
                                                    // .Include(x => x.ShipmentManifestDetails)									  
                                                    // .Include(x => x.ShipmentManifestBLs)									  
                                                    // .Include(x => x.ShipmentRiderManifests)									  
 	        ...
 	        public async Task<IEnumerable<ShipmentManifest>> GetShipmentManifestByApplicationSettingsId(string ApplicationSettingsId, List<string> includesLst = null)
        {
            ...
            catch (Exception updateEx)
            {
 	        ...
 	        public async Task<IEnumerable<ShipmentManifest>> GetShipmentManifestByFileTypeId(string FileTypeId, List<string> includesLst = null)
        {
            try
            {
                using ( var dbContext = new EntryDataDSContext(){StartTracking = StartTracking})
             ...
             try
             {
                 using (var dbContext = new EntryDataDSContext(){StartTracking = StartTracking})
                 {
					...
					decimal res = 0;
                     ...
                     if (whereExp == "All")
                     {
                          res = Convert.ToDecimal(dbContext.ShipmentManifest.AsNoTracking().Sum(field));
                     }
                     else
                     {
                         res = Convert.ToDecimal(dbContext.ShipmentManifest.AsNoTracking().Where(whereExp).Sum(field));
                     }
        ...
        public async Task<decimal> SumNav( string exp, Dictionary<string, string> navExp, string field)
        {
            try
            {
                ...
                {
                    dbContext.Database.CommandTimeout = 0;
                    if (!dbContext.ShipmentManifest.Any()) return 0;
                    if (exp == "All" && navExp.Count == 0)
                    {
                        return Convert.ToDecimal(dbContext.ShipmentManifest
										.AsNoTracking()
                                        .Sum(field)??0);
                    }
                    foreach (var itm in navExp)
                        ...
                        switch (itm.Key)
                        {
                            ...
                            case "ShipmentManifestBLs":
                                return await SumWhere<ShipmentManifestBLs>(dbContext, exp, itm.Value, "ShipmentManifest", field, "Select")
											.ConfigureAwait(continueOnCapturedContext: false);
                            case "ShipmentRiderManifests":
                                return await SumWhere<ShipmentRiderManifests>(dbContext, exp, itm.Value, "ShipmentManifest", field, "Select")
											.ConfigureAwait(continueOnCapturedContext: false);
                            case "ShipmentFreightManifests":
                                return await SumWhere<ShipmentFreightManifests>(dbContext, exp, itm.Value, "ShipmentManifest", field, "Select")
											.ConfigureAwait(continueOnCapturedContext: false);
                            case "Consignees":
                                return await SumWhere<Consignees>(dbContext, exp, itm.Value, "ShipmentManifest", field, "SelectMany")
											.ConfigureAwait(continueOnCapturedContext: false);
						}
                    }
                    return Convert.ToDecimal(dbContext.ShipmentManifest.Where(exp == "All" || exp == null ? "Id != null" : exp)
											.AsNoTracking()
                                            .Sum(field)??0);
                }
             ...
             try
             {
                 using (var dbContext = new EntryDataDSContext(){StartTracking = StartTracking})
                 {
					...
					string res = "";
                     ...
                     if (whereExp == "All")
                     {
                          res = Convert.ToString(dbContext.ShipmentManifest.AsNoTracking().Min(field));
                     }
                     else
                     {
                         res = Convert.ToString(dbContext.ShipmentManifest.AsNoTracking().Where(whereExp).Min(field));
                     }
		...
		private static IQueryable<ShipmentManifest> AddIncludes(IEnumerable<string> includesLst, EntryDataDSContext dbContext)
       {
		 try
			{
			   if (includesLst == null) includesLst = new List<string>();
			   var set =(DbQuery<ShipmentManifest>) dbContext.ShipmentManifest; 
	   ...
	   private IQueryable<ShipmentManifest> AddWheres(List<string> expLst, IQueryable<ShipmentManifest> set)
        {
            try
            {
