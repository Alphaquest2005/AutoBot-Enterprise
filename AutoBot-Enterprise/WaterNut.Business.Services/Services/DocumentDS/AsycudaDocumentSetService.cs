...
namespace DocumentDS.Business.Services
{
   ...
   [ServiceBehavior(InstanceContextMode = InstanceContextMode.PerCall,
    ...
    public partial class AsycudaDocumentSetService : IAsycudaDocumentSetService, IDisposable
    {
        ...
        public async Task<IEnumerable<AsycudaDocumentSet>> GetAsycudaDocumentSets(List<string> includesLst = null, bool tracking = true)
        {
            try
            {
        ...
        public async Task<AsycudaDocumentSet> GetAsycudaDocumentSetByKey(string AsycudaDocumentSetId, List<string> includesLst = null, bool tracking = true)
        {
		 ...
		 public async Task<IEnumerable<AsycudaDocumentSet>> GetAsycudaDocumentSetsByExpression(string exp, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
                using (var dbContext = new DocumentDSContext(){StartTracking = StartTracking})
		 ...
		 public async Task<IEnumerable<AsycudaDocumentSet>> GetAsycudaDocumentSetsByExpressionLst(List<string> expLst, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
                using (var dbContext = new DocumentDSContext(){StartTracking = StartTracking})
		...
		public async Task<IEnumerable<AsycudaDocumentSet>> GetAsycudaDocumentSetsByExpressionNav(string exp,
                    ...
                    foreach (var itm in navExp)
                    {
                        switch (itm.Key)
                        {
                            ...
                            case "Consignee":
                                return
                                    await
                                        GetWhere<Consignee>(dbContext, exp, itm.Value, "AsycudaDocumentSets", "SelectMany", includesLst)
										.ConfigureAwait(continueOnCapturedContext: false);
        ...
        public async Task<IEnumerable<AsycudaDocumentSet>> GetAsycudaDocumentSetsByBatch(string exp,
        ...
        public async Task<IEnumerable<AsycudaDocumentSet>> GetAsycudaDocumentSetsByBatchExpressionLst(List<string> expLst,
            int totalrow, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
        ...
        public async Task<bool> DeleteAsycudaDocumentSet(string AsycudaDocumentSetId)
        {
            try
            {
              ...
              {
                var i = Convert.ToInt32(AsycudaDocumentSetId);
                AsycudaDocumentSet entity = dbContext.AsycudaDocumentSets
													.SingleOrDefault(x => x.AsycudaDocumentSetId == i);
                if (entity == null)
                    return false;

                    dbContext.AsycudaDocumentSets.Attach(entity);
                    dbContext.AsycudaDocumentSets.Remove(entity);
                    dbContext.SaveChanges();
                    return true;
              }
            }
         ...
         public async Task<int> CountByExpressionLst(List<string> expLst)
        {
            try
            {
                using (var dbContext = new DocumentDSContext(){StartTracking = StartTracking})
                {
                    ...
                    var set = (IQueryable<AsycudaDocumentSet>)dbContext.AsycudaDocumentSets; 
                    if (expLst.FirstOrDefault() == "All")
                    {
		...
		public async Task<int> Count(string exp)
        {
            try
            {
                using (DocumentDSContext dbContext = new DocumentDSContext(){StartTracking = StartTracking})
                {
                    ...
                    if (exp == "All")
                    {
                        return dbContext.AsycudaDocumentSets
                                    .AsNoTracking()
									.Count();
                    }
                    else
                        ...
                        switch (itm.Key)
                        {
                            ...
                            case "Customs_Procedure":
                                return await CountWhere<Customs_Procedure>(dbContext, exp, itm.Value, "AsycudaDocumentSets", "SelectMany")
											.ConfigureAwait(continueOnCapturedContext: false);
                            case "Consignee":
                                return await CountWhere<Consignee>(dbContext, exp, itm.Value, "AsycudaDocumentSets", "SelectMany")
											.ConfigureAwait(continueOnCapturedContext: false);
						}
                    }
                    return dbContext.AsycudaDocumentSets.Where(exp == "All" || exp == null ? "AsycudaDocumentSetId != null" : exp)
											.AsNoTracking()
                                            .Count();
                }
                                                                                 ...
                                                                                 Dictionary<string, string> navExp, IEnumerable<string> includeLst = null)
        {
            try
            {
                using (var dbContext = new DocumentDSContext(){StartTracking = StartTracking})
                {
                    ...
                    foreach (var itm in navExp)
                    {
                        switch (itm.Key)
                        {
                            ...
                            case "Consignee":
                                return
                                    await
                                        LoadRangeWhere<Consignee>(startIndex, count, dbContext, exp, itm.Value, "AsycudaDocumentSets", "SelectMany")
													.ConfigureAwait(continueOnCapturedContext: false);
                    ...
                    return set//dbContext.AsycudaDocumentSets
								.AsNoTracking()
                                .Where(exp == "All" || exp == null ? "AsycudaDocumentSetId != null" : exp)
								.OrderBy(y => y.AsycudaDocumentSetId)
        ...
        private static async Task<IEnumerable<AsycudaDocumentSet>> GetWhere<T>(DocumentDSContext dbContext,
		...
		private static async Task<IEnumerable<AsycudaDocumentSet>> GetWhereSelectMany<T>(DocumentDSContext dbContext,
		...
		private static async Task<IEnumerable<AsycudaDocumentSet>> GetWhereSelect<T>(DocumentDSContext dbContext,
            string exp, string navExp, string navProp, List<string> includesLst = null) where T : class
        {
			try
			{
             ...
             try
             {
                 using (var dbContext = new DocumentDSContext(){StartTracking = StartTracking})
                 {
					...
					decimal res = 0;
                     ...
                     if (whereExp == "All")
                     {
                          res = Convert.ToDecimal(dbContext.AsycudaDocumentSets.AsNoTracking().Sum(field));
                     }
                     else
                     {
                         res = Convert.ToDecimal(dbContext.AsycudaDocumentSets.AsNoTracking().Where(whereExp).Sum(field));
                     }
        ...
        public async Task<decimal> SumNav( string exp, Dictionary<string, string> navExp, string field)
        {
            try
            {
                ...
                {
                    dbContext.Database.CommandTimeout = 0;
                    if (!dbContext.AsycudaDocumentSets.Any()) return 0;
                    if (exp == "All" && navExp.Count == 0)
                    {
                        return Convert.ToDecimal(dbContext.AsycudaDocumentSets
										.AsNoTracking()
                                        .Sum(field)??0);
                    }
                    foreach (var itm in navExp)
                        ...
                        switch (itm.Key)
                        {
                            ...
                            case "Customs_Procedure":
                                return await SumWhere<Customs_Procedure>(dbContext, exp, itm.Value, "AsycudaDocumentSets", field, "SelectMany")
											.ConfigureAwait(continueOnCapturedContext: false);
                            case "Consignee":
                                return await SumWhere<Consignee>(dbContext, exp, itm.Value, "AsycudaDocumentSets", field, "SelectMany")
											.ConfigureAwait(continueOnCapturedContext: false);
						}
                    }
                    return Convert.ToDecimal(dbContext.AsycudaDocumentSets.Where(exp == "All" || exp == null ? "AsycudaDocumentSetId != null" : exp)
											.AsNoTracking()
                                            .Sum(field)??0);
                }
             ...
             try
             {
                 using (var dbContext = new DocumentDSContext(){StartTracking = StartTracking})
                 {
					...
					string res = "";
                     ...
                     if (whereExp == "All")
                     {
                          res = Convert.ToString(dbContext.AsycudaDocumentSets.AsNoTracking().Min(field));
                     }
                     else
                     {
                         res = Convert.ToString(dbContext.AsycudaDocumentSets.AsNoTracking().Where(whereExp).Min(field));
                     }
		...
		private static IQueryable<AsycudaDocumentSet> AddIncludes(IEnumerable<string> includesLst, DocumentDSContext dbContext)
       {
		 try
			{
			   if (includesLst == null) includesLst = new List<string>();
			   var set =(DbQuery<AsycudaDocumentSet>) dbContext.AsycudaDocumentSets; 
