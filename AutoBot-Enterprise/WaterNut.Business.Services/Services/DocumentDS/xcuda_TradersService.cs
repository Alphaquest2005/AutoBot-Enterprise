...
{
   [Export (typeof(Ixcuda_TradersService))]
   [Export(typeof(IBusinessService))]
   [PartCreationPolicy(CreationPolicy.NonShared)]
   [ServiceBehavior(InstanceContextMode = InstanceContextMode.PerCall,
                    ConcurrencyMode = ConcurrencyMode.Multiple)]
   
    public partial class xcuda_TradersService : Ixcuda_TradersService, IDisposable
    {
        //private readonly DocumentDSContext dbContext;

        public bool StartTracking { get; set; }

        public xcuda_TradersService()
        {
            try
            {
		...
		public async Task<IEnumerable<xcuda_Traders>> Getxcuda_TradersByExpressionNav(string exp,
                    ...
                    foreach (var itm in navExp)
                    {
                        switch (itm.Key)
                        {
                            case "xcuda_ASYCUDA":
                                return
                                    await
                                        GetWhere<xcuda_ASYCUDA>(dbContext, exp, itm.Value, "xcuda_Traders", "SelectMany", includesLst)
										.ConfigureAwait(continueOnCapturedContext: false);

                            case "xcuda_Consignee":
                                return
                                    await
                                        GetWhere<xcuda_Consignee>(dbContext, exp, itm.Value, "xcuda_Traders", "SelectMany", includesLst)
										.ConfigureAwait(continueOnCapturedContext: false);

                            case "xcuda_Exporter":
                                return
                                    await
                                        GetWhere<xcuda_Exporter>(dbContext, exp, itm.Value, "xcuda_Traders", "SelectMany", includesLst)
										.ConfigureAwait(continueOnCapturedContext: false);

                            case "xcuda_Traders_Financial":
                                return
                                    await
                                        GetWhere<xcuda_Traders_Financial>(dbContext, exp, itm.Value, "xcuda_Traders", "SelectMany", includesLst)
										.ConfigureAwait(continueOnCapturedContext: false);
            ...
            int totalrow, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
                ...
                var res = new ConcurrentQueue<List<xcuda_Traders>>();
        ...
        public async Task<bool> RemoveSelectedxcuda_Traders(IEnumerable<string> lst)
        {
            try
            {
                StatusModel.StartStatusUpdate("Removing xcuda_Traders", lst.Count());
                var t = Task.Run(() =>
                {
                    using (var ctx = new xcuda_TradersService())
                    {
                        foreach (var item in lst.ToList())
                        {
                            ...
                            ctx.Deletexcuda_Traders(item).Wait();
            ...
            try
            {
                ...
                using (var dbContext = new DocumentDSContext(){StartTracking = StartTracking})
                {
                    ...
                    foreach (var itm in navExp)
                    {
                        ...
                        {
                            case "xcuda_ASYCUDA":
                                return await CountWhere<xcuda_ASYCUDA>(dbContext, exp, itm.Value, "xcuda_Traders", "SelectMany")
											.ConfigureAwait(continueOnCapturedContext: false);
                            case "xcuda_Consignee":
                                return await CountWhere<xcuda_Consignee>(dbContext, exp, itm.Value, "xcuda_Traders", "SelectMany")
											.ConfigureAwait(continueOnCapturedContext: false);
                            case "xcuda_Exporter":
                                return await CountWhere<xcuda_Exporter>(dbContext, exp, itm.Value, "xcuda_Traders", "SelectMany")
											.ConfigureAwait(continueOnCapturedContext: false);
                            case "xcuda_Traders_Financial":
                                return await CountWhere<xcuda_Traders_Financial>(dbContext, exp, itm.Value, "xcuda_Traders", "SelectMany")
											.ConfigureAwait(continueOnCapturedContext: false);
						}
                    }
                    return dbContext.xcuda_Traders.Where(exp == "All" || exp == null ? "Traders_Id != null" : exp)
											.AsNoTracking()
                                            .Count();
                }
		...
		private static async Task<int> CountWhereSelect<T>(DocumentDSContext dbContext, string exp, string navExp, string navProp) where T : class
        {
		  ...
		  public async Task<IEnumerable<xcuda_Traders>> LoadRangeNav(int startIndex, int count, string exp,
                                                                                 Dictionary<string, string> navExp, IEnumerable<string> includeLst = null)
        {
            try
            {
                ...
                {
                    dbContext.Database.CommandTimeout = 0;
                    if ((string.IsNullOrEmpty(exp) && navExp.Count == 0) || exp == "None") return new List<xcuda_Traders>();
                    ...
                    foreach (var itm in navExp)
                    {
                        switch (itm.Key)
                        {
                            case "xcuda_ASYCUDA":
                                return
                                    await
                                        LoadRangeWhere<xcuda_ASYCUDA>(startIndex, count, dbContext, exp, itm.Value, "xcuda_Traders", "SelectMany")
													.ConfigureAwait(continueOnCapturedContext: false);

                            case "xcuda_Consignee":
                                return
                                    await
                                        LoadRangeWhere<xcuda_Consignee>(startIndex, count, dbContext, exp, itm.Value, "xcuda_Traders", "SelectMany")
													.ConfigureAwait(continueOnCapturedContext: false);

                            case "xcuda_Exporter":
                                return
                                    await
                                        LoadRangeWhere<xcuda_Exporter>(startIndex, count, dbContext, exp, itm.Value, "xcuda_Traders", "SelectMany")
													.ConfigureAwait(continueOnCapturedContext: false);

                            case "xcuda_Traders_Financial":
                                return
                                    await
                                        LoadRangeWhere<xcuda_Traders_Financial>(startIndex, count, dbContext, exp, itm.Value, "xcuda_Traders", "SelectMany")
													.ConfigureAwait(continueOnCapturedContext: false);
                    ...
                    return set//dbContext.xcuda_Traders
								.AsNoTracking()
                                .Where(exp == "All" || exp == null ? "Traders_Id != null" : exp)
								.OrderBy(y => y.Traders_Id)
		...
		private static async Task<IEnumerable<xcuda_Traders>> LoadRangeWhere<T>(int startIndex, int count,
        ...
        private static async Task<IEnumerable<xcuda_Traders>> GetWhere<T>(DocumentDSContext dbContext,
             ...
             try
             {
                 using (var dbContext = new DocumentDSContext(){StartTracking = StartTracking})
                 {
					...
					decimal res = 0;
                     ...
                     if (whereExp == "All")
                     {
                          res = Convert.ToDecimal(dbContext.xcuda_Traders.AsNoTracking().Sum(field));
                     }
                     else
                     {
                         res = Convert.ToDecimal(dbContext.xcuda_Traders.AsNoTracking().Where(whereExp).Sum(field));
                     }
        ...
        public async Task<decimal> SumNav( string exp, Dictionary<string, string> navExp, string field)
        {
            try
            {
                ...
                {
                    dbContext.Database.CommandTimeout = 0;
                    if (!dbContext.xcuda_Traders.Any()) return 0;
                    if (exp == "All" && navExp.Count == 0)
                    {
                        return Convert.ToDecimal(dbContext.xcuda_Traders
										.AsNoTracking()
                                        .Sum(field)??0);
                    }
                    foreach (var itm in navExp)
                    {
                        ...
                        {
                            case "xcuda_ASYCUDA":
                                return await SumWhere<xcuda_ASYCUDA>(dbContext, exp, itm.Value, "xcuda_Traders", field, "SelectMany")
											.ConfigureAwait(continueOnCapturedContext: false);
                            case "xcuda_Consignee":
                                return await SumWhere<xcuda_Consignee>(dbContext, exp, itm.Value, "xcuda_Traders", field, "SelectMany")
											.ConfigureAwait(continueOnCapturedContext: false);
                            case "xcuda_Exporter":
                                return await SumWhere<xcuda_Exporter>(dbContext, exp, itm.Value, "xcuda_Traders", field, "SelectMany")
											.ConfigureAwait(continueOnCapturedContext: false);
                            case "xcuda_Traders_Financial":
                                return await SumWhere<xcuda_Traders_Financial>(dbContext, exp, itm.Value, "xcuda_Traders", field, "SelectMany")
											.ConfigureAwait(continueOnCapturedContext: false);
						}
                    }
                    return Convert.ToDecimal(dbContext.xcuda_Traders.Where(exp == "All" || exp == null ? "Traders_Id != null" : exp)
											.AsNoTracking()
                                            .Sum(field)??0);
                }
             ...
             try
             {
                 using (var dbContext = new DocumentDSContext(){StartTracking = StartTracking})
                 {
					...
					string res = "";
                     ...
                     if (whereExp == "All")
                     {
                          res = Convert.ToString(dbContext.xcuda_Traders.AsNoTracking().Min(field));
                     }
                     else
                     {
                         res = Convert.ToString(dbContext.xcuda_Traders.AsNoTracking().Where(whereExp).Min(field));
                     }
		...
		private static IQueryable<xcuda_Traders> AddIncludes(IEnumerable<string> includesLst, DocumentDSContext dbContext)
       {
		 try
			{
			   if (includesLst == null) includesLst = new List<string>();
			   var set =(DbQuery<xcuda_Traders>) dbContext.xcuda_Traders; 
	   ...
	   private IQueryable<xcuda_Traders> AddWheres(List<string> expLst, IQueryable<xcuda_Traders> set)
        {
            try
            {
