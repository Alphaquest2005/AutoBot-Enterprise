...
namespace OCR.Business.Services
{
   ...
   [ServiceBehavior(InstanceContextMode = InstanceContextMode.PerCall,
    ...
    public partial class EndService : IEndService, IDisposable
    {
        ...
        public async Task<IEnumerable<End>> GetEnd(List<string> includesLst = null, bool tracking = true)
        {
            try
            {
            //using (var scope = new TransactionScope(TransactionScopeOption.Required,
               ...
               // {
                  using ( var dbContext = new OCRContext(){StartTracking = StartTracking})
                  {
                    ...
                    IEnumerable<End> entities = set.AsNoTracking().ToList();
                           //scope.Complete();
        ...
        public async Task<End> GetEndByKey(string Id, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
              ...
              using ( var dbContext = new OCRContext(){StartTracking = StartTracking})
              {
				...
				var set = AddIncludes(includesLst, dbContext);
                End entity = set.AsNoTracking().SingleOrDefault(x => x.Id == i);
		 ...
		 public async Task<IEnumerable<End>> GetEndByExpression(string exp, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
                using (var dbContext = new OCRContext(){StartTracking = StartTracking})
                {
					...
					if (string.IsNullOrEmpty(exp) || exp == "None") return new List<End>();
					var set = AddIncludes(includesLst, dbContext);
                    if (exp == "All")
                    {
		 ...
		 public async Task<IEnumerable<End>> GetEndByExpressionLst(List<string> expLst, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
                using (var dbContext = new OCRContext(){StartTracking = StartTracking})
                {
                    dbContext.Database.CommandTimeout = 0;
					if (expLst.Count == 0 || expLst.FirstOrDefault() == "None") return new List<End>();
					var set = AddIncludes(includesLst, dbContext);
            ...
            int totalrow, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
                ...
                var res = new ConcurrentQueue<List<End>>();
        ...
        public async Task<bool> DeleteEnd(string Id)
        {
            try
            {
              ...
              {
                var i = Convert.ToInt32(Id);
                End entity = dbContext.End
													.SingleOrDefault(x => x.Id == i);
                if (entity == null)
                    return false;

                    dbContext.End.Attach(entity);
                    dbContext.End.Remove(entity);
                    dbContext.SaveChanges();
                    return true;
              }
            }
        ...
        public async Task<bool> RemoveSelectedEnd(IEnumerable<string> lst)
        {
            try
            {
                StatusModel.StartStatusUpdate("Removing End", lst.Count());
                var t = Task.Run(() =>
                {
                    using (var ctx = new EndService())
                    {
                        foreach (var item in lst.ToList())
                        {

                            ctx.DeleteEnd(item).Wait();
         ...
         public async Task<int> CountByExpressionLst(List<string> expLst)
        {
            try
            {
                using (var dbContext = new OCRContext(){StartTracking = StartTracking})
                {
                    ...
                    var set = (IQueryable<End>)dbContext.End; 
                    if (expLst.FirstOrDefault() == "All")
                    {
		...
		public async Task<int> CountNav(string exp, Dictionary<string, string> navExp)
        {
            try
            {
                ...
                using (var dbContext = new OCRContext(){StartTracking = StartTracking})
                {
                    ...
                    return dbContext.End.Where(exp == "All" || exp == null ? "Id != null" : exp)
											.AsNoTracking()
                                            .Count();
                }
                                                                                 ...
                                                                                 Dictionary<string, string> navExp, IEnumerable<string> includeLst = null)
        {
            try
            {
                ...
                {
                    dbContext.Database.CommandTimeout = 0;
                    if ((string.IsNullOrEmpty(exp) && navExp.Count == 0) || exp == "None") return new List<End>();
		...
		private static async Task<IEnumerable<End>> LoadRangeWhere<T>(int startIndex, int count,
		...
		private static async Task<IEnumerable<End>> LoadRangeSelectMany<T>(int startIndex, int count,
		...
		private static async Task<IEnumerable<End>> LoadRangeSelect<T>(int startIndex, int count,
            OCRContext dbContext, string exp, string navExp, string navProp, IEnumerable<string> includeLst = null) where T : class
        {
			try
			{
        ...
        private static async Task<IEnumerable<End>> GetWhere<T>(OCRContext dbContext,
		...
		private static async Task<IEnumerable<End>> GetWhereSelectMany<T>(OCRContext dbContext,
            string exp, string navExp, string navProp, List<string> includesLst = null) where T : class
        {
			...
			var set = (DbQuery<End>)dbContext.Set<T>()
				.AsNoTracking()
                .Where(navExp)
                .SelectMany(navProp).OfType<End>()
                .Where(exp == "All" || exp == null?"Id != null":exp)
		...
		private static async Task<IEnumerable<End>> GetWhereSelect<T>(OCRContext dbContext,
            string exp, string navExp, string navProp, List<string> includesLst = null) where T : class
        {
			try
			{
			        ...
			        public async Task<IEnumerable<End>> GetEndByPartId(string PartId, List<string> includesLst = null)
        {
            try
            {
                using ( var dbContext = new OCRContext(){StartTracking = StartTracking})
              {
                ...
                var set = AddIncludes(includesLst, dbContext);
                IEnumerable<End> entities = set//dbContext.End
                                      .AsNoTracking()
             ...
             try
             {
                 using (var dbContext = new OCRContext(){StartTracking = StartTracking})
                 {
					...
					decimal res = 0;
                     ...
                     if (whereExp == "All")
                     {
                          res = Convert.ToDecimal(dbContext.End.AsNoTracking().Sum(field));
                     }
                     else
                     {
                         res = Convert.ToDecimal(dbContext.End.AsNoTracking().Where(whereExp).Sum(field));
                     }
        ...
        public async Task<decimal> SumNav( string exp, Dictionary<string, string> navExp, string field)
        {
            try
            {
                ...
                {
                    dbContext.Database.CommandTimeout = 0;
                    if (!dbContext.End.Any()) return 0;
                    if (exp == "All" && navExp.Count == 0)
                    {
                        return Convert.ToDecimal(dbContext.End
										.AsNoTracking()
                                        .Sum(field)??0);
                    }
                    foreach (var itm in navExp)
                    ...
                    return Convert.ToDecimal(dbContext.End.Where(exp == "All" || exp == null ? "Id != null" : exp)
											.AsNoTracking()
                                            .Sum(field)??0);
                }
             ...
             try
             {
                 using (var dbContext = new OCRContext(){StartTracking = StartTracking})
                 {
					...
					string res = "";
                     ...
                     if (whereExp == "All")
                     {
                          res = Convert.ToString(dbContext.End.AsNoTracking().Min(field));
                     }
                     else
                     {
                         res = Convert.ToString(dbContext.End.AsNoTracking().Where(whereExp).Min(field));
                     }
		...
		private static IQueryable<End> AddIncludes(IEnumerable<string> includesLst, OCRContext dbContext)
       {
		 try
			{
			   if (includesLst == null) includesLst = new List<string>();
			   var set =(DbQuery<End>) dbContext.End; 
	   ...
	   private IQueryable<End> AddWheres(List<string> expLst, IQueryable<End> set)
        {
            try
            {
