...
{
   [Export (typeof(ITODO_DeleteDocumentSetService))]
   [Export(typeof(IBusinessService))]
   [PartCreationPolicy(CreationPolicy.NonShared)]
   [ServiceBehavior(InstanceContextMode = InstanceContextMode.PerCall,
                    ConcurrencyMode = ConcurrencyMode.Multiple)]
   
    public partial class TODO_DeleteDocumentSetService : ITODO_DeleteDocumentSetService, IDisposable
    {
        //private readonly CoreEntitiesContext dbContext;

        public bool StartTracking { get; set; }

        public TODO_DeleteDocumentSetService()
        {
            try
            {
        ...
        public async Task<IEnumerable<TODO_DeleteDocumentSet>> GetTODO_DeleteDocumentSet(List<string> includesLst = null, bool tracking = true)
        {
            try
            {
            //using (var scope = new TransactionScope(TransactionScopeOption.Required,
               ...
               // {
                  using ( var dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
                  {
                    ...
                    IEnumerable<TODO_DeleteDocumentSet> entities = set.AsNoTracking().ToList();
                           //scope.Complete();
        ...
        public async Task<TODO_DeleteDocumentSet> GetTODO_DeleteDocumentSetByKey(string AsycudaDocumentSetId, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
              ...
              using ( var dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
              {
				...
				var set = AddIncludes(includesLst, dbContext);
                TODO_DeleteDocumentSet entity = set.AsNoTracking().SingleOrDefault(x => x.AsycudaDocumentSetId == i);
		 ...
		 public async Task<IEnumerable<TODO_DeleteDocumentSet>> GetTODO_DeleteDocumentSetByExpression(string exp, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
                using (var dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
                {
					...
					if (string.IsNullOrEmpty(exp) || exp == "None") return new List<TODO_DeleteDocumentSet>();
					var set = AddIncludes(includesLst, dbContext);
                    if (exp == "All")
                    {
		 ...
		 public async Task<IEnumerable<TODO_DeleteDocumentSet>> GetTODO_DeleteDocumentSetByExpressionLst(List<string> expLst, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
                using (var dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
                {
                    dbContext.Database.CommandTimeout = 0;
					if (expLst.Count == 0 || expLst.FirstOrDefault() == "None") return new List<TODO_DeleteDocumentSet>();
					var set = AddIncludes(includesLst, dbContext);
		...
		public async Task<IEnumerable<TODO_DeleteDocumentSet>> GetTODO_DeleteDocumentSetByExpressionNav(string exp,
        ...
        public async Task<IEnumerable<TODO_DeleteDocumentSet>> GetTODO_DeleteDocumentSetByBatch(string exp,
            int totalrow, List<string> includesLst = null, bool tracking = true)
        {
            try
            {

                var res = new ConcurrentQueue<List<TODO_DeleteDocumentSet>>();
                    ...
                    //  for (int bat = 0; bat < batches; bat++)
                    {
                        try
                        {
                            using (var dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
                            {
                                ...
                                var set = AddIncludes(includesLst, dbContext);
                                IQueryable<TODO_DeleteDocumentSet> dset;
                                if (exp == "All")
                                {
        ...
        public async Task<IEnumerable<TODO_DeleteDocumentSet>> GetTODO_DeleteDocumentSetByBatchExpressionLst(List<string> expLst,
            int totalrow, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
            ...
            using ( var dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
              {
                try
                {   
                     var res = (TODO_DeleteDocumentSet) entity;
        ...
        public async Task<TODO_DeleteDocumentSet> CreateTODO_DeleteDocumentSet(TODO_DeleteDocumentSet entity)
        {
            try
            {
              ...
              using ( var dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
              {
                dbContext.TODO_DeleteDocumentSet.Add(res);
                dbContext.SaveChanges();
                res.AcceptChanges();
                return res;
              }
        ...
        public async Task<bool> DeleteTODO_DeleteDocumentSet(string AsycudaDocumentSetId)
        {
            try
            {
              using ( var dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
              {
                var i = Convert.ToInt32(AsycudaDocumentSetId);
                TODO_DeleteDocumentSet entity = dbContext.TODO_DeleteDocumentSet
													.SingleOrDefault(x => x.AsycudaDocumentSetId == i);
                if (entity == null)
                    return false;

                    dbContext.TODO_DeleteDocumentSet.Attach(entity);
                    dbContext.TODO_DeleteDocumentSet.Remove(entity);
                    dbContext.SaveChanges();
                    return true;
              }
            }
        ...
        public async Task<bool> RemoveSelectedTODO_DeleteDocumentSet(IEnumerable<string> lst)
        {
            try
            {
                StatusModel.StartStatusUpdate("Removing TODO_DeleteDocumentSet", lst.Count());
                var t = Task.Run(() =>
                {
                    using (var ctx = new TODO_DeleteDocumentSetService())
                    {
                        foreach (var item in lst.ToList())
                        {

                            ctx.DeleteTODO_DeleteDocumentSet(item).Wait();
         ...
         public async Task<int> CountByExpressionLst(List<string> expLst)
        {
            try
            {
                using (var dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
                {
                    ...
                    var set = (IQueryable<TODO_DeleteDocumentSet>)dbContext.TODO_DeleteDocumentSet; 
                    if (expLst.FirstOrDefault() == "All")
                    {
		...
		public async Task<int> Count(string exp)
        {
            try
            {
                using (CoreEntitiesContext dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
                {
                    ...
                    if (exp == "All")
                    {
                        return dbContext.TODO_DeleteDocumentSet
                                    .AsNoTracking()
									.Count();
                    }
                    else
        ...
        public async Task<IEnumerable<TODO_DeleteDocumentSet>> LoadRange(int startIndex, int count, string exp)
        {
            try
            {
                using (var dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
		...
		public async Task<int> CountNav(string exp, Dictionary<string, string> navExp)
        {
            try
            {
                ...
                using (var dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
                {
                    ...
                    return dbContext.TODO_DeleteDocumentSet.Where(exp == "All" || exp == null ? "AsycudaDocumentSetId != null" : exp)
											.AsNoTracking()
                                            .Count();
                }
		...
		private static async Task<int> CountWhereSelectMany<T>(CoreEntitiesContext dbContext, string exp, string navExp, string navProp) where T : class
        {
            ...
            return dbContext.Set<T>()
				.AsNoTracking()
                .Where(navExp)
                .SelectMany(navProp).OfType<TODO_DeleteDocumentSet>()
		...
		private static async Task<int> CountWhereSelect<T>(CoreEntitiesContext dbContext, string exp, string navExp, string navProp) where T : class
        {
            ...
            return dbContext.Set<T>()
				.AsNoTracking()
                .Where(navExp)
                .Select(navProp).OfType<TODO_DeleteDocumentSet>()
                .Where(exp == "All" || exp == null ? "AsycudaDocumentSetId != null" : exp)
                .Distinct()
                .OrderBy("AsycudaDocumentSetId")
                .Count();
		  ...
		  public async Task<IEnumerable<TODO_DeleteDocumentSet>> LoadRangeNav(int startIndex, int count, string exp,
                                                                                 Dictionary<string, string> navExp, IEnumerable<string> includeLst = null)
        {
            try
            {
                ...
                {
                    dbContext.Database.CommandTimeout = 0;
                    if ((string.IsNullOrEmpty(exp) && navExp.Count == 0) || exp == "None") return new List<TODO_DeleteDocumentSet>();
                    ...
                    return set//dbContext.TODO_DeleteDocumentSet
								.AsNoTracking()
                                .Where(exp == "All" || exp == null ? "AsycudaDocumentSetId != null" : exp)
								.OrderBy(y => y.AsycudaDocumentSetId)
		...
		private static async Task<IEnumerable<TODO_DeleteDocumentSet>> LoadRangeWhere<T>(int startIndex, int count,
		...
		private static async Task<IEnumerable<TODO_DeleteDocumentSet>> LoadRangeSelectMany<T>(int startIndex, int count,
		...
		private static async Task<IEnumerable<TODO_DeleteDocumentSet>> LoadRangeSelect<T>(int startIndex, int count,
            CoreEntitiesContext dbContext, string exp, string navExp, string navProp, IEnumerable<string> includeLst = null) where T : class
        {
			try
			{
        ...
        private static async Task<IEnumerable<TODO_DeleteDocumentSet>> GetWhere<T>(CoreEntitiesContext dbContext,
		...
		private static async Task<IEnumerable<TODO_DeleteDocumentSet>> GetWhereSelectMany<T>(CoreEntitiesContext dbContext,
            string exp, string navExp, string navProp, List<string> includesLst = null) where T : class
        {
			...
			var set = (DbQuery<TODO_DeleteDocumentSet>)dbContext.Set<T>()
				.AsNoTracking()
                .Where(navExp)
                .SelectMany(navProp).OfType<TODO_DeleteDocumentSet>()
                .Where(exp == "All" || exp == null?"AsycudaDocumentSetId != null":exp)
		...
		private static async Task<IEnumerable<TODO_DeleteDocumentSet>> GetWhereSelect<T>(CoreEntitiesContext dbContext,
            string exp, string navExp, string navProp, List<string> includesLst = null) where T : class
        {
			try
			{
             ...
             try
             {
                 using (var dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
                 {
					...
					decimal res = 0;
                     ...
                     if (whereExp == "All")
                     {
                          res = Convert.ToDecimal(dbContext.TODO_DeleteDocumentSet.AsNoTracking().Sum(field));
                     }
                     else
                     {
                         res = Convert.ToDecimal(dbContext.TODO_DeleteDocumentSet.AsNoTracking().Where(whereExp).Sum(field));
                     }
        ...
        public async Task<decimal> SumNav( string exp, Dictionary<string, string> navExp, string field)
        {
            try
            {
                ...
                {
                    dbContext.Database.CommandTimeout = 0;
                    if (!dbContext.TODO_DeleteDocumentSet.Any()) return 0;
                    if (exp == "All" && navExp.Count == 0)
                    {
                        return Convert.ToDecimal(dbContext.TODO_DeleteDocumentSet
										.AsNoTracking()
                                        .Sum(field)??0);
                    }
                    return Convert.ToDecimal(dbContext.TODO_DeleteDocumentSet.Where(exp == "All" || exp == null ? "AsycudaDocumentSetId != null" : exp)
											.AsNoTracking()
                                            .Sum(field)??0);
                }
             ...
             try
             {
                 using (var dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
                 {
					...
					string res = "";
                     ...
                     if (whereExp == "All")
                     {
                          res = Convert.ToString(dbContext.TODO_DeleteDocumentSet.AsNoTracking().Min(field));
                     }
                     else
                     {
                         res = Convert.ToString(dbContext.TODO_DeleteDocumentSet.AsNoTracking().Where(whereExp).Min(field));
                     }
		...
		private static IQueryable<TODO_DeleteDocumentSet> AddIncludes(IEnumerable<string> includesLst, CoreEntitiesContext dbContext)
       {
		 try
			{
			   if (includesLst == null) includesLst = new List<string>();
			   var set =(DbQuery<TODO_DeleteDocumentSet>) dbContext.TODO_DeleteDocumentSet; 
	   ...
	   private IQueryable<TODO_DeleteDocumentSet> AddWheres(List<string> expLst, IQueryable<TODO_DeleteDocumentSet> set)
        {
            try
            {
