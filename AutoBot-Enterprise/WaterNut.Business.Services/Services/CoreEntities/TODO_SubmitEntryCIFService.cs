...
{
   [Export (typeof(ITODO_SubmitEntryCIFService))]
   [Export(typeof(IBusinessService))]
   [PartCreationPolicy(CreationPolicy.NonShared)]
   [ServiceBehavior(InstanceContextMode = InstanceContextMode.PerCall,
                    ConcurrencyMode = ConcurrencyMode.Multiple)]
   
    public partial class TODO_SubmitEntryCIFService : ITODO_SubmitEntryCIFService, IDisposable
    {
        //private readonly CoreEntitiesContext dbContext;

        public bool StartTracking { get; set; }

        public TODO_SubmitEntryCIFService()
        {
            try
            {
        ...
        public async Task<IEnumerable<TODO_SubmitEntryCIF>> GetTODO_SubmitEntryCIF(List<string> includesLst = null, bool tracking = true)
        {
            try
            {
            //using (var scope = new TransactionScope(TransactionScopeOption.Required,
               ...
               // {
                  using ( var dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
                  {
                    ...
                    IEnumerable<TODO_SubmitEntryCIF> entities = set.AsNoTracking().ToList();
                           //scope.Complete();
        ...
        public async Task<TODO_SubmitEntryCIF> GetTODO_SubmitEntryCIFByKey(string InvoiceNo, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
              ...
              using ( var dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
              {
                var i = InvoiceNo;
				var set = AddIncludes(includesLst, dbContext);
                TODO_SubmitEntryCIF entity = set.AsNoTracking().SingleOrDefault(x => x.InvoiceNo == i);
		 ...
		 public async Task<IEnumerable<TODO_SubmitEntryCIF>> GetTODO_SubmitEntryCIFByExpression(string exp, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
                using (var dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
                {
					...
					if (string.IsNullOrEmpty(exp) || exp == "None") return new List<TODO_SubmitEntryCIF>();
					var set = AddIncludes(includesLst, dbContext);
                    if (exp == "All")
                    {
		 ...
		 public async Task<IEnumerable<TODO_SubmitEntryCIF>> GetTODO_SubmitEntryCIFByExpressionLst(List<string> expLst, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
                using (var dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
                {
                    dbContext.Database.CommandTimeout = 0;
					if (expLst.Count == 0 || expLst.FirstOrDefault() == "None") return new List<TODO_SubmitEntryCIF>();
					var set = AddIncludes(includesLst, dbContext);
		...
		public async Task<IEnumerable<TODO_SubmitEntryCIF>> GetTODO_SubmitEntryCIFByExpressionNav(string exp,
        ...
        public async Task<IEnumerable<TODO_SubmitEntryCIF>> GetTODO_SubmitEntryCIFByBatch(string exp,
            int totalrow, List<string> includesLst = null, bool tracking = true)
        {
            try
            {

                var res = new ConcurrentQueue<List<TODO_SubmitEntryCIF>>();
                    ...
                    //  for (int bat = 0; bat < batches; bat++)
                    {
                        try
                        {
                            using (var dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
                            {
                                ...
                                var set = AddIncludes(includesLst, dbContext);
                                IQueryable<TODO_SubmitEntryCIF> dset;
                                if (exp == "All")
                                {
        ...
        public async Task<IEnumerable<TODO_SubmitEntryCIF>> GetTODO_SubmitEntryCIFByBatchExpressionLst(List<string> expLst,
            int totalrow, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
            ...
            using ( var dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
              {
                try
                {   
                     var res = (TODO_SubmitEntryCIF) entity;
        ...
        public async Task<TODO_SubmitEntryCIF> CreateTODO_SubmitEntryCIF(TODO_SubmitEntryCIF entity)
        {
            try
            {
              ...
              using ( var dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
              {
                dbContext.TODO_SubmitEntryCIF.Add(res);
                dbContext.SaveChanges();
                res.AcceptChanges();
                return res;
              }
        ...
        public async Task<bool> DeleteTODO_SubmitEntryCIF(string InvoiceNo)
        {
            try
            {
              using ( var dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
              {
                var i = InvoiceNo;
                TODO_SubmitEntryCIF entity = dbContext.TODO_SubmitEntryCIF
													.SingleOrDefault(x => x.InvoiceNo == i);
                if (entity == null)
                    return false;

                    dbContext.TODO_SubmitEntryCIF.Attach(entity);
                    dbContext.TODO_SubmitEntryCIF.Remove(entity);
                    dbContext.SaveChanges();
                    return true;
              }
            }
        ...
        public async Task<bool> RemoveSelectedTODO_SubmitEntryCIF(IEnumerable<string> lst)
        {
            try
            {
                StatusModel.StartStatusUpdate("Removing TODO_SubmitEntryCIF", lst.Count());
                var t = Task.Run(() =>
                {
                    using (var ctx = new TODO_SubmitEntryCIFService())
                    {
                        foreach (var item in lst.ToList())
                        {

                            ctx.DeleteTODO_SubmitEntryCIF(item).Wait();
         ...
         public async Task<int> CountByExpressionLst(List<string> expLst)
        {
            try
            {
                using (var dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
                {
                    ...
                    var set = (IQueryable<TODO_SubmitEntryCIF>)dbContext.TODO_SubmitEntryCIF; 
                    if (expLst.FirstOrDefault() == "All")
                    {
		...
		public async Task<int> Count(string exp)
        {
            try
            {
                using (CoreEntitiesContext dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
                {
                    ...
                    if (exp == "All")
                    {
                        return dbContext.TODO_SubmitEntryCIF
                                    .AsNoTracking()
									.Count();
                    }
                    else
        ...
        public async Task<IEnumerable<TODO_SubmitEntryCIF>> LoadRange(int startIndex, int count, string exp)
        {
            try
            {
                using (var dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
		...
		public async Task<int> CountNav(string exp, Dictionary<string, string> navExp)
        {
            try
            {
                ...
                using (var dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
                {
                    ...
                    return dbContext.TODO_SubmitEntryCIF.Where(exp == "All" || exp == null ? "InvoiceNo != null" : exp)
											.AsNoTracking()
                                            .Count();
                }
		...
		private static async Task<int> CountWhereSelectMany<T>(CoreEntitiesContext dbContext, string exp, string navExp, string navProp) where T : class
        {
            ...
            return dbContext.Set<T>()
				.AsNoTracking()
                .Where(navExp)
                .SelectMany(navProp).OfType<TODO_SubmitEntryCIF>()
		...
		private static async Task<int> CountWhereSelect<T>(CoreEntitiesContext dbContext, string exp, string navExp, string navProp) where T : class
        {
            ...
            return dbContext.Set<T>()
				.AsNoTracking()
                .Where(navExp)
                .Select(navProp).OfType<TODO_SubmitEntryCIF>()
                .Where(exp == "All" || exp == null ? "InvoiceNo != null" : exp)
                .Distinct()
                .OrderBy("InvoiceNo")
                .Count();
		  ...
		  public async Task<IEnumerable<TODO_SubmitEntryCIF>> LoadRangeNav(int startIndex, int count, string exp,
                                                                                 Dictionary<string, string> navExp, IEnumerable<string> includeLst = null)
        {
            try
            {
                ...
                {
                    dbContext.Database.CommandTimeout = 0;
                    if ((string.IsNullOrEmpty(exp) && navExp.Count == 0) || exp == "None") return new List<TODO_SubmitEntryCIF>();
                    ...
                    return set//dbContext.TODO_SubmitEntryCIF
								.AsNoTracking()
                                .Where(exp == "All" || exp == null ? "InvoiceNo != null" : exp)
								.OrderBy(y => y.InvoiceNo)
		...
		private static async Task<IEnumerable<TODO_SubmitEntryCIF>> LoadRangeWhere<T>(int startIndex, int count,
		...
		private static async Task<IEnumerable<TODO_SubmitEntryCIF>> LoadRangeSelectMany<T>(int startIndex, int count,
		...
		private static async Task<IEnumerable<TODO_SubmitEntryCIF>> LoadRangeSelect<T>(int startIndex, int count,
            CoreEntitiesContext dbContext, string exp, string navExp, string navProp, IEnumerable<string> includeLst = null) where T : class
        {
			try
			{
        ...
        private static async Task<IEnumerable<TODO_SubmitEntryCIF>> GetWhere<T>(CoreEntitiesContext dbContext,
		...
		private static async Task<IEnumerable<TODO_SubmitEntryCIF>> GetWhereSelectMany<T>(CoreEntitiesContext dbContext,
            string exp, string navExp, string navProp, List<string> includesLst = null) where T : class
        {
			...
			var set = (DbQuery<TODO_SubmitEntryCIF>)dbContext.Set<T>()
				.AsNoTracking()
                .Where(navExp)
                .SelectMany(navProp).OfType<TODO_SubmitEntryCIF>()
                .Where(exp == "All" || exp == null?"InvoiceNo != null":exp)
		...
		private static async Task<IEnumerable<TODO_SubmitEntryCIF>> GetWhereSelect<T>(CoreEntitiesContext dbContext,
            string exp, string navExp, string navProp, List<string> includesLst = null) where T : class
        {
			try
			{
             ...
             try
             {
                 using (var dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
                 {
					...
					decimal res = 0;
                     ...
                     if (whereExp == "All")
                     {
                          res = Convert.ToDecimal(dbContext.TODO_SubmitEntryCIF.AsNoTracking().Sum(field));
                     }
                     else
                     {
                         res = Convert.ToDecimal(dbContext.TODO_SubmitEntryCIF.AsNoTracking().Where(whereExp).Sum(field));
                     }
        ...
        public async Task<decimal> SumNav( string exp, Dictionary<string, string> navExp, string field)
        {
            try
            {
                ...
                {
                    dbContext.Database.CommandTimeout = 0;
                    if (!dbContext.TODO_SubmitEntryCIF.Any()) return 0;
                    if (exp == "All" && navExp.Count == 0)
                    {
                        return Convert.ToDecimal(dbContext.TODO_SubmitEntryCIF
										.AsNoTracking()
                                        .Sum(field)??0);
                    }
                    return Convert.ToDecimal(dbContext.TODO_SubmitEntryCIF.Where(exp == "All" || exp == null ? "InvoiceNo != null" : exp)
											.AsNoTracking()
                                            .Sum(field)??0);
                }
             ...
             try
             {
                 using (var dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
                 {
					...
					string res = "";
                     ...
                     if (whereExp == "All")
                     {
                          res = Convert.ToString(dbContext.TODO_SubmitEntryCIF.AsNoTracking().Min(field));
                     }
                     else
                     {
                         res = Convert.ToString(dbContext.TODO_SubmitEntryCIF.AsNoTracking().Where(whereExp).Min(field));
                     }
		...
		private static IQueryable<TODO_SubmitEntryCIF> AddIncludes(IEnumerable<string> includesLst, CoreEntitiesContext dbContext)
       {
		 try
			{
			   if (includesLst == null) includesLst = new List<string>();
			   var set =(DbQuery<TODO_SubmitEntryCIF>) dbContext.TODO_SubmitEntryCIF; 
	   ...
	   private IQueryable<TODO_SubmitEntryCIF> AddWheres(List<string> expLst, IQueryable<TODO_SubmitEntryCIF> set)
        {
            try
            {
