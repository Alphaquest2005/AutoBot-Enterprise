...
namespace CoreEntities.Client.DTO
{
   ...
   // [JsonObject(IsReference = true)]
    ...
    public partial class TODO_TotalAdjustmentsToProcess : BaseEntity<TODO_TotalAdjustmentsToProcess>, ITrackable, IEquatable<TODO_TotalAdjustmentsToProcess>
    {
        [DataMember]
   ...
   //     public ICollection<string> ModifiedProperties { get; set; }
    ...
    //	private Guid _entityIdentity = default(Guid);
    	...
    	bool IEquatable<TODO_TotalAdjustmentsToProcess>.Equals(TODO_TotalAdjustmentsToProcess other)
    	{
