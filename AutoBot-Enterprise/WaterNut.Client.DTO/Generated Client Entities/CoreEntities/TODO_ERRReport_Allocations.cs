...
namespace CoreEntities.Client.DTO
{
   ...
   // [JsonObject(IsReference = true)]
    ...
    public partial class TODO_ERRReport_Allocations : BaseEntity<TODO_ERRReport_Allocations>, ITrackable, IEquatable<TODO_ERRReport_Allocations>
    {
        [DataMember]
   ...
   //     public ICollection<string> ModifiedProperties { get; set; }
    ...
    //	private Guid _entityIdentity = default(Guid);
    	...
    	bool IEquatable<TODO_ERRReport_Allocations>.Equals(TODO_ERRReport_Allocations other)
    	{
