...
namespace CoreEntities.Client.DTO
{
   ...
   // [JsonObject(IsReference = true)]
    ...
    public partial class TODO_SubmitDiscrepanciesToCustoms : BaseEntity<TODO_SubmitDiscrepanciesToCustoms>, ITrackable, IEquatable<TODO_SubmitDiscrepanciesToCustoms>
    {
        [DataMember]
        public int Id
		{ 
   ...
   //     public ICollection<string> ModifiedProperties { get; set; }
    ...
    //	private Guid _entityIdentity = default(Guid);
    	...
    	bool IEquatable<TODO_SubmitDiscrepanciesToCustoms>.Equals(TODO_SubmitDiscrepanciesToCustoms other)
    	{
