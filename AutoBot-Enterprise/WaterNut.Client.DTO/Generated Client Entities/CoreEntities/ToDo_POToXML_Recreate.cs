...
namespace CoreEntities.Client.DTO
{
   ...
   // [JsonObject(IsReference = true)]
    ...
    public partial class ToDo_POToXML_Recreate : BaseEntity<ToDo_POToXML_Recreate>, ITrackable, IEquatable<ToDo_POToXML_Recreate>
    {
        [DataMember]
   ...
   //     public ICollection<string> ModifiedProperties { get; set; }
    ...
    //	private Guid _entityIdentity = default(Guid);
    	...
    	bool IEquatable<ToDo_POToXML_Recreate>.Equals(ToDo_POToXML_Recreate other)
    	{
