...
namespace AllocationQS.Client.DTO
{
   ...
   // [JsonObject(IsReference = true)]
    ...
    public partial class AdjustmentShortAllocation : BaseEntity<AdjustmentShortAllocation>, ITrackable, IEquatable<AdjustmentShortAllocation>
    {
        [DataMember]
   ...
   //     public ICollection<string> ModifiedProperties { get; set; }
    ...
    //	private Guid _entityIdentity = default(Guid);
    	...
    	bool IEquatable<AdjustmentShortAllocation>.Equals(AdjustmentShortAllocation other)
    	{
