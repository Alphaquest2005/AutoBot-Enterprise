...
namespace WpfSchduleControl
{
        ...
        : CalendarSelectableElement
    {
        ...
        private Thickness overflowPadding = new Thickness(5);
        ...
        public Rect BodyBounds
        {
            get 
            {
                return new Rect(Bounds.Left, DayTop.Bounds.Bottom, Bounds.Right, Bounds.Bottom);
            }
        }
        ...
        public Rect HeaderBounds
        {
            get 
            {
                return new Rect(Bounds.Left, Bounds.Top, Bounds.Width, Calendar.Renderer.DayHeaderHeight);
            }
        }
        ...
        /// </summary>
        public virtual Rect OverflowStartBounds
        {
            get { return new Rect(new Point(Bounds.Right - overflowPadding.Right - overflowSize.Width, Bounds.Top + overflowPadding.Top), overflowSize); }
        }
        ...
        /// </summary>
        public virtual Rect OverflowEndBounds
        {
            get { return new Rect(new Point(Bounds.Right - overflowPadding.Right - overflowSize.Width, Bounds.Bottom - overflowPadding.Bottom - overflowSize.Height), overflowSize); }
        }
