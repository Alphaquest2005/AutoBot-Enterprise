...
{
	public partial class xcuda_Gs_external_freightDataModel_AutoGen 
	{
        private static readonly xcuda_Gs_external_freightDataModel_AutoGen instance;
        static xcuda_Gs_external_freightDataModel_AutoGen()
        {
            instance = new xcuda_Gs_external_freightDataModel_AutoGen();
        }

        public static  xcuda_Gs_external_freightDataModel_AutoGen Instance
        {
            get { return instance; }
        }
