...
{
	public partial class xcuda_Assessment_noticeDataModel_AutoGen 
	{
        private static readonly xcuda_Assessment_noticeDataModel_AutoGen instance;
        static xcuda_Assessment_noticeDataModel_AutoGen()
        {
            instance = new xcuda_Assessment_noticeDataModel_AutoGen();
        }

        public static  xcuda_Assessment_noticeDataModel_AutoGen Instance
        {
            get { return instance; }
        }
