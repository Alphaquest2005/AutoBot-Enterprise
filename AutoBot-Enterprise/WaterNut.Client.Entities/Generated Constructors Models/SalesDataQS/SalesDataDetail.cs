...
namespace SalesDataQS.Client.Entities
{
    ...
    public partial class SalesDataDetail 
    {
       public SalesDataDetail()
        {
            this.DTO = new DTO.SalesDataDetail();//{TrackingState = TrackableEntities.TrackingState.Added}
            _changeTracker = new ChangeTrackingCollection<DTO.SalesDataDetail>(this.DTO);
