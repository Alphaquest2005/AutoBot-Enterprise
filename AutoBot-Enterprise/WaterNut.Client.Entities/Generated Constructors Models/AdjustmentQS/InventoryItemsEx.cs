...
namespace AdjustmentQS.Client.Entities
{
    ...
    public partial class InventoryItemsEx 
    {
       public InventoryItemsEx()
        {
            this.DTO = new DTO.InventoryItemsEx();//{TrackingState = TrackableEntities.TrackingState.Added}
            _changeTracker = new ChangeTrackingCollection<DTO.InventoryItemsEx>(this.DTO);
