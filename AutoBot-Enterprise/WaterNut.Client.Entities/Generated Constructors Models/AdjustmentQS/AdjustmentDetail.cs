...
namespace AdjustmentQS.Client.Entities
{
    ...
    public partial class AdjustmentDetail 
    {
       public AdjustmentDetail()
        {
            this.DTO = new DTO.AdjustmentDetail();//{TrackingState = TrackableEntities.TrackingState.Added}
            _changeTracker = new ChangeTrackingCollection<DTO.AdjustmentDetail>(this.DTO);
