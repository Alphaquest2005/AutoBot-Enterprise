...
namespace CoreEntities.Client.Entities
{
    ...
    {
       public ActionDocSetLogs()
        {
            this.DTO = new DTO.ActionDocSetLogs();//{TrackingState = TrackableEntities.TrackingState.Added}
            _changeTracker = new ChangeTrackingCollection<DTO.ActionDocSetLogs>(this.DTO);
