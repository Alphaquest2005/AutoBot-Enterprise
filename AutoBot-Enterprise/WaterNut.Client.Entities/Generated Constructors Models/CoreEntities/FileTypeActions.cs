...
namespace CoreEntities.Client.Entities
{
    ...
    public partial class FileTypeActions 
    {
       public FileTypeActions()
        {
            this.DTO = new DTO.FileTypeActions();//{TrackingState = TrackableEntities.TrackingState.Added}
            _changeTracker = new ChangeTrackingCollection<DTO.FileTypeActions>(this.DTO);
