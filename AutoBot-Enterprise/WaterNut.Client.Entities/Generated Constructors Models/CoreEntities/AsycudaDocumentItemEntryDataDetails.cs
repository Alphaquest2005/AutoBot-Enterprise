...
namespace CoreEntities.Client.Entities
{
    ...
    {
       public AsycudaDocumentItemEntryDataDetails()
        {
            this.DTO = new DTO.AsycudaDocumentItemEntryDataDetails();//{TrackingState = TrackableEntities.TrackingState.Added}
            _changeTracker = new ChangeTrackingCollection<DTO.AsycudaDocumentItemEntryDataDetails>(this.DTO);
