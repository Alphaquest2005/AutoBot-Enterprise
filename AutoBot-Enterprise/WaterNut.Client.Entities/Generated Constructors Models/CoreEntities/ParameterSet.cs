...
namespace CoreEntities.Client.Entities
{
    ...
    public partial class ParameterSet 
    {
       public ParameterSet()
        {
            this.DTO = new DTO.ParameterSet();//{TrackingState = TrackableEntities.TrackingState.Added}
            _changeTracker = new ChangeTrackingCollection<DTO.ParameterSet>(this.DTO);
