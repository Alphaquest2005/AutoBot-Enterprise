...
namespace CoreEntities.Client.Entities
{
    ...
    public partial class FileTypeMappings 
    {
       public FileTypeMappings()
        {
            this.DTO = new DTO.FileTypeMappings();//{TrackingState = TrackableEntities.TrackingState.Added}
            _changeTracker = new ChangeTrackingCollection<DTO.FileTypeMappings>(this.DTO);
