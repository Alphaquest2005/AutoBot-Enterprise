...
namespace CoreEntities.Client.Entities
{
    ...
    public partial class TODO_ImportCompleteEntries 
    {
       public TODO_ImportCompleteEntries()
        {
            this.DTO = new DTO.TODO_ImportCompleteEntries();//{TrackingState = TrackableEntities.TrackingState.Added}
            _changeTracker = new ChangeTrackingCollection<DTO.TODO_ImportCompleteEntries>(this.DTO);
