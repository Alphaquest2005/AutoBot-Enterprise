...
namespace CoreEntities.Client.Entities
{
    ...
    {
       public ParameterSetParameters()
        {
            this.DTO = new DTO.ParameterSetParameters();//{TrackingState = TrackableEntities.TrackingState.Added}
            _changeTracker = new ChangeTrackingCollection<DTO.ParameterSetParameters>(this.DTO);
