...
namespace CoreEntities.Client.Entities
{
    ...
    public partial class InventoryItemX 
    {
       public InventoryItemX()
        {
            this.DTO = new DTO.InventoryItemX();//{TrackingState = TrackableEntities.TrackingState.Added}
            _changeTracker = new ChangeTrackingCollection<DTO.InventoryItemX>(this.DTO);
