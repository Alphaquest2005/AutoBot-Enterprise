...
namespace CoreEntities.Client.Entities
{
    ...
    public partial class TODO_SubmitIncompleteSupplierInfo 
    {
       public TODO_SubmitIncompleteSupplierInfo()
        {
            this.DTO = new DTO.TODO_SubmitIncompleteSupplierInfo();//{TrackingState = TrackableEntities.TrackingState.Added}
            _changeTracker = new ChangeTrackingCollection<DTO.TODO_SubmitIncompleteSupplierInfo>(this.DTO);
