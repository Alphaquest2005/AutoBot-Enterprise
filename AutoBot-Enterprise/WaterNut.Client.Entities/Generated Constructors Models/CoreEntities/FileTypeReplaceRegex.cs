...
namespace CoreEntities.Client.Entities
{
    ...
    public partial class FileTypeReplaceRegex 
    {
       public FileTypeReplaceRegex()
        {
            this.DTO = new DTO.FileTypeReplaceRegex();//{TrackingState = TrackableEntities.TrackingState.Added}
            _changeTracker = new ChangeTrackingCollection<DTO.FileTypeReplaceRegex>(this.DTO);
