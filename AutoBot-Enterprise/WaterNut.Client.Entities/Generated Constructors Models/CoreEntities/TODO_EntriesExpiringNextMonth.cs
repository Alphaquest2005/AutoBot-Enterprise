...
namespace CoreEntities.Client.Entities
{
    ...
    {
       public TODO_EntriesExpiringNextMonth()
        {
            this.DTO = new DTO.TODO_EntriesExpiringNextMonth();//{TrackingState = TrackableEntities.TrackingState.Added}
            _changeTracker = new ChangeTrackingCollection<DTO.TODO_EntriesExpiringNextMonth>(this.DTO);
