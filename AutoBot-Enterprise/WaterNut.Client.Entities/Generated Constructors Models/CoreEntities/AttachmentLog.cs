...
namespace CoreEntities.Client.Entities
{
    ...
    public partial class AttachmentLog 
    {
       public AttachmentLog()
        {
            this.DTO = new DTO.AttachmentLog();//{TrackingState = TrackableEntities.TrackingState.Added}
            _changeTracker = new ChangeTrackingCollection<DTO.AttachmentLog>(this.DTO);
