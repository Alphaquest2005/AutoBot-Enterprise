...
namespace CoreEntities.Client.Entities
{
    ...
    {
       public InfoMappingRegEx()
        {
            this.DTO = new DTO.InfoMappingRegEx();//{TrackingState = TrackableEntities.TrackingState.Added}
            _changeTracker = new ChangeTrackingCollection<DTO.InfoMappingRegEx>(this.DTO);
