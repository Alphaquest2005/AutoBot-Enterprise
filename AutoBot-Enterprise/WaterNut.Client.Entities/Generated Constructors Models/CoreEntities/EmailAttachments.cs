...
namespace CoreEntities.Client.Entities
{
    ...
    public partial class EmailAttachments 
    {
       public EmailAttachments()
        {
            this.DTO = new DTO.EmailAttachments();//{TrackingState = TrackableEntities.TrackingState.Added}
            _changeTracker = new ChangeTrackingCollection<DTO.EmailAttachments>(this.DTO);
