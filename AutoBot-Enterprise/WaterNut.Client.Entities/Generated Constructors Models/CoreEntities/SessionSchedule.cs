...
namespace CoreEntities.Client.Entities
{
    ...
    public partial class SessionSchedule 
    {
       public SessionSchedule()
        {
            this.DTO = new DTO.SessionSchedule();//{TrackingState = TrackableEntities.TrackingState.Added}
            _changeTracker = new ChangeTrackingCollection<DTO.SessionSchedule>(this.DTO);
