...
namespace CoreEntities.Client.Entities
{
    ...
    public partial class AsycudaDocumentSet 
    {
       public AsycudaDocumentSet()
        {
            this.DTO = new DTO.AsycudaDocumentSet();//{TrackingState = TrackableEntities.TrackingState.Added}
            _changeTracker = new ChangeTrackingCollection<DTO.AsycudaDocumentSet>(this.DTO);
