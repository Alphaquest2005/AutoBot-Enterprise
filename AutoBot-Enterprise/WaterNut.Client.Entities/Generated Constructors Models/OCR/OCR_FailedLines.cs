...
namespace OCR.Client.Entities
{
    ...
    public partial class OCR_FailedLines 
    {
       public OCR_FailedLines()
        {
            this.DTO = new DTO.OCR_FailedLines();//{TrackingState = TrackableEntities.TrackingState.Added}
            _changeTracker = new ChangeTrackingCollection<DTO.OCR_FailedLines>(this.DTO);
