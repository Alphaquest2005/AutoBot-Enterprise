...
namespace OCR.Client.Entities
{
    ...
    public partial class RegularExpressions 
    {
       public RegularExpressions()
        {
            this.DTO = new DTO.RegularExpressions();//{TrackingState = TrackableEntities.TrackingState.Added}
            _changeTracker = new ChangeTrackingCollection<DTO.RegularExpressions>(this.DTO);
