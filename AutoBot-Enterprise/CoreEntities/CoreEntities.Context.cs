...
namespace CoreEntities
{
    ...
    public partial class CoreEntities : DbContext
    {
        ...
        public DbSet<TODO_DiscrepanciesExecutionReport> TODO_DiscrepanciesExecutionReport { get; set; }
        ...
        public virtual int Stp_TODO_ImportCompleteEntries(Nullable<int> applicationSettingsId)
        {
            var applicationSettingsIdParameter = applicationSettingsId.HasValue ?
                new ObjectParameter("ApplicationSettingsId", applicationSettingsId) :
                new ObjectParameter("ApplicationSettingsId", typeof(int));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("Stp_TODO_ImportCompleteEntries", applicationSettingsIdParameter);
        }
    }
}
