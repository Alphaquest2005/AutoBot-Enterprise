...
{
    public partial class InvoiceRegExVirturalListLoader : IVirtualListLoader<InvoiceRegEx>
	{
        ...
        public IList<InvoiceRegEx> LoadRange(int startIndex, int count, SortDescriptionCollection sortDescriptions, out int overallCount)
        {
            try
            {
