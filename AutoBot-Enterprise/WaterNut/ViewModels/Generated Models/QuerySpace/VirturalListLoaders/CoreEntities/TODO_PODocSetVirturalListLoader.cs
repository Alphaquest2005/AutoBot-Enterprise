...
{
    public partial class TODO_PODocSetVirturalListLoader : IVirtualListLoader<TODO_PODocSet>
	{
        ...
        public string FilterExpression
        {
            ...
            set
            {
                ...
                MessageBus.Default.BeginNotify(MessageToken.TODO_PODocSetFilterExpressionChanged, null,
                                            new NotificationEventArgs<string>(MessageToken.TODO_PODocSetFilterExpressionChanged, _filterExpression));
            }
        }
        ...
        public IList<TODO_PODocSet> LoadRange(int startIndex, int count, SortDescriptionCollection sortDescriptions, out int overallCount)
        {
            try
            {
