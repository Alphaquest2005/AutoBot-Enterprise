...
{
    public partial class TODO_UnallocatedShortsVirturalListLoader : IVirtualListLoader<TODO_UnallocatedShorts>
	{
        ...
        public string FilterExpression
        {
            ...
            set
            {
                ...
                MessageBus.Default.BeginNotify(MessageToken.TODO_UnallocatedShortsFilterExpressionChanged, null,
                                            new NotificationEventArgs<string>(MessageToken.TODO_UnallocatedShortsFilterExpressionChanged, _filterExpression));
            }
        }
        ...
        public IList<TODO_UnallocatedShorts> LoadRange(int startIndex, int count, SortDescriptionCollection sortDescriptions, out int overallCount)
        {
            try
            {
            ...
            catch (Exception ex)
            {
                ...
                overallCount = 0;
                return new List<TODO_UnallocatedShorts>() ;
            }
