...
{
    public partial class TODO_Error_IncompleteImportVirturalListLoader : IVirtualListLoader<TODO_Error_IncompleteImport>
	{
        ...
        public string FilterExpression
        {
            ...
            set
            {
                ...
                MessageBus.Default.BeginNotify(MessageToken.TODO_Error_IncompleteImportFilterExpressionChanged, null,
                                            new NotificationEventArgs<string>(MessageToken.TODO_Error_IncompleteImportFilterExpressionChanged, _filterExpression));
            }
        }
        ...
        public IList<TODO_Error_IncompleteImport> LoadRange(int startIndex, int count, SortDescriptionCollection sortDescriptions, out int overallCount)
        {
            try
            {
            ...
            catch (Exception ex)
            {
                ...
                overallCount = 0;
                return new List<TODO_Error_IncompleteImport>() ;
            }
