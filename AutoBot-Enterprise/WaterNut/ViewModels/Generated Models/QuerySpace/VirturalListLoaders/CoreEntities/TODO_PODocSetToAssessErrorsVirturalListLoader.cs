...
{
    public partial class TODO_PODocSetToAssessErrorsVirturalListLoader : IVirtualListLoader<TODO_PODocSetToAssessErrors>
	{
        ...
        public string FilterExpression
        {
            ...
            set
            {
                ...
                MessageBus.Default.BeginNotify(MessageToken.TODO_PODocSetToAssessErrorsFilterExpressionChanged, null,
                                            new NotificationEventArgs<string>(MessageToken.TODO_PODocSetToAssessErrorsFilterExpressionChanged, _filterExpression));
            }
        }
        ...
        public IList<TODO_PODocSetToAssessErrors> LoadRange(int startIndex, int count, SortDescriptionCollection sortDescriptions, out int overallCount)
        {
            try
            {
            ...
            catch (Exception ex)
            {
                ...
                overallCount = 0;
                return new List<TODO_PODocSetToAssessErrors>() ;
            }
