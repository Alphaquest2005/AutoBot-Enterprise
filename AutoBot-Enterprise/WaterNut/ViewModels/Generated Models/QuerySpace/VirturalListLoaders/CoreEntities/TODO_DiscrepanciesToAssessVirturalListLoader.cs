...
{
    public partial class TODO_DiscrepanciesToAssessVirturalListLoader : IVirtualListLoader<TODO_DiscrepanciesToAssess>
	{
        ...
        public string FilterExpression
        {
            ...
            set
            {
                ...
                MessageBus.Default.BeginNotify(MessageToken.TODO_DiscrepanciesToAssessFilterExpressionChanged, null,
                                            new NotificationEventArgs<string>(MessageToken.TODO_DiscrepanciesToAssessFilterExpressionChanged, _filterExpression));
            }
        }
        ...
        public IList<TODO_DiscrepanciesToAssess> LoadRange(int startIndex, int count, SortDescriptionCollection sortDescriptions, out int overallCount)
        {
            try
            {
            ...
            catch (Exception ex)
            {
                ...
                overallCount = 0;
                return new List<TODO_DiscrepanciesToAssess>() ;
            }
