...
{
    public partial class TODO_SubmitIncompleteEntryDataVirturalListLoader : IVirtualListLoader<TODO_SubmitIncompleteEntryData>
	{
        ...
        public string FilterExpression
        {
            ...
            set
            {
                ...
                MessageBus.Default.BeginNotify(MessageToken.TODO_SubmitIncompleteEntryDataFilterExpressionChanged, null,
                                            new NotificationEventArgs<string>(MessageToken.TODO_SubmitIncompleteEntryDataFilterExpressionChanged, _filterExpression));
            }
        }
        ...
        public IList<TODO_SubmitIncompleteEntryData> LoadRange(int startIndex, int count, SortDescriptionCollection sortDescriptions, out int overallCount)
        {
            try
            {
            ...
            catch (Exception ex)
            {
                ...
                overallCount = 0;
                return new List<TODO_SubmitIncompleteEntryData>() ;
            }
