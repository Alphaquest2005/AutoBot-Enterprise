...
{
    public partial class ActionDocSetLogsVirturalListLoader : IVirtualListLoader<ActionDocSetLogs>
	{
        ...
        public string FilterExpression
        {
            ...
            set
            {
                ...
                MessageBus.Default.BeginNotify(MessageToken.ActionDocSetLogsFilterExpressionChanged, null,
                                            new NotificationEventArgs<string>(MessageToken.ActionDocSetLogsFilterExpressionChanged, _filterExpression));
            }
        }
        ...
        public IList<ActionDocSetLogs> LoadRange(int startIndex, int count, SortDescriptionCollection sortDescriptions, out int overallCount)
        {
            try
            {
            ...
            catch (Exception ex)
            {
                ...
                overallCount = 0;
                return new List<ActionDocSetLogs>() ;
            }
