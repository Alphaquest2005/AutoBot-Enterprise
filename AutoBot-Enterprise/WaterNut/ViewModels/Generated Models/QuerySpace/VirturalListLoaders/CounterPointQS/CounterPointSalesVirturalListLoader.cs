...
{
    public partial class CounterPointSalesVirturalListLoader : IVirtualListLoader<CounterPointSales>
	{
        ...
        public string FilterExpression
        {
            ...
            set
            {
                ...
                MessageBus.Default.BeginNotify(MessageToken.CounterPointSalesFilterExpressionChanged, null,
                                            new NotificationEventArgs<string>(MessageToken.CounterPointSalesFilterExpressionChanged, _filterExpression));
            }
        }
        ...
        public IList<CounterPointSales> LoadRange(int startIndex, int count, SortDescriptionCollection sortDescriptions, out int overallCount)
        {
            try
            {
