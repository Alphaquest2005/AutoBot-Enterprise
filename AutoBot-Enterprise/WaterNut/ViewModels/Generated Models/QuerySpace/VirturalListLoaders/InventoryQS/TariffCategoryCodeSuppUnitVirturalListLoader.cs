...
{
    public partial class TariffCategoryCodeSuppUnitVirturalListLoader : IVirtualListLoader<TariffCategoryCodeSuppUnit>
	{
        ...
        public string FilterExpression
        {
            ...
            set
            {
                ...
                MessageBus.Default.BeginNotify(MessageToken.TariffCategoryCodeSuppUnitFilterExpressionChanged, null,
                                            new NotificationEventArgs<string>(MessageToken.TariffCategoryCodeSuppUnitFilterExpressionChanged, _filterExpression));
            }
        }
        ...
        public IList<TariffCategoryCodeSuppUnit> LoadRange(int startIndex, int count, SortDescriptionCollection sortDescriptions, out int overallCount)
        {
            try
            {
            ...
            catch (Exception ex)
            {
                ...
                overallCount = 0;
                return new List<TariffCategoryCodeSuppUnit>() ;
            }
