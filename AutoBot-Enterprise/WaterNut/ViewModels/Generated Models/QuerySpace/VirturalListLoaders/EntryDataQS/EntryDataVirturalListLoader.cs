...
{
    public partial class EntryDataVirturalListLoader : IVirtualListLoader<EntryData>
	{
        ...
        public string FilterExpression
        {
            ...
            set
            {
                ...
                MessageBus.Default.BeginNotify(MessageToken.EntryDatasFilterExpressionChanged, null,
                                            new NotificationEventArgs<string>(MessageToken.EntryDatasFilterExpressionChanged, _filterExpression));
            }
        }
        ...
        public IList<EntryData> LoadRange(int startIndex, int count, SortDescriptionCollection sortDescriptions, out int overallCount)
        {
            try
            {
