...
{
    public partial class ShortAllocationVirturalListLoader : IVirtualListLoader<ShortAllocation>
	{
        ...
        public string FilterExpression
        {
            ...
            set
            {
                ...
                MessageBus.Default.BeginNotify(MessageToken.ShortAllocationsFilterExpressionChanged, null,
                                            new NotificationEventArgs<string>(MessageToken.ShortAllocationsFilterExpressionChanged, _filterExpression));
            }
        }
        ...
        public IList<ShortAllocation> LoadRange(int startIndex, int count, SortDescriptionCollection sortDescriptions, out int overallCount)
        {
            try
            {
            ...
            catch (Exception ex)
            {
                ...
                overallCount = 0;
                return new List<ShortAllocation>() ;
            }
