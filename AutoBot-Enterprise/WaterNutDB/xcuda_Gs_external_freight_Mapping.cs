...
namespace WaterNutDB
{
    ...
    internal partial class xcuda_Gs_external_freight_Mapping : EntityTypeConfiguration<xcuda_Gs_external_freight>
    {
        public xcuda_Gs_external_freight_Mapping()
        {                        
              ...
              this.HasRequired(t => t.xcuda_Valuation).WithOptional(t => t.xcuda_Gs_external_freight);
         }
    }
}
