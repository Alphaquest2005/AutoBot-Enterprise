...
namespace WaterNutDB
{
    ...
    internal partial class AsycudaDocumentSetPreviousEntries_Mapping : EntityTypeConfiguration<AsycudaDocumentSetPreviousEntries>
    {
        public AsycudaDocumentSetPreviousEntries_Mapping()
        {                        
              this.HasKey(t => new {t.AsycudaDocumentSetId, t.ASYCUDA_Id, t.Item_Id});        
              this.ToTable("AsycudaDocumentSetPreviousEntries", "WaterNutDBDataLayerStoreContainer");
              ...
              this.HasRequired(t => t.xcuda_Item).WithMany(t => t.AsycudaDocumentSetPreviousEntries).HasForeignKey(d => d.Item_Id);
         }
    }
}
