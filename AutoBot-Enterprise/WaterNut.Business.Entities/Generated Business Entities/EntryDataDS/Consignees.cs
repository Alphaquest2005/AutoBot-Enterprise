...
namespace EntryDataDS.Business.Entities
{
    ...
    public partial class Consignees : BaseEntity<Consignees>, ITrackable 
    {
        ...
        {
            this.Shipment = new List<Shipment>();
            this.ShipmentBL = new List<ShipmentBL>();
            this.ShipmentManifest = new List<ShipmentManifest>();
        }
        ...
        [DataMember]
        public List<ShipmentBL> ShipmentBL { get; set; }
        [DataMember]
        public List<ShipmentManifest> ShipmentManifest { get; set; }
