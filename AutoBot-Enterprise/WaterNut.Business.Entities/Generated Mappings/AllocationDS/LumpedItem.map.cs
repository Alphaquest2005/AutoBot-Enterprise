namespace AllocationDS.Business.Entities.Mapping
{
    ...
    public partial class LumpedItemMap : EntityTypeConfiguration<LumpedItem>
    {
        public LumpedItemMap()
        {                        
              this.HasKey(t => t.InventoryItemId);        
              this.ToTable("InventoryItems-Lumped");
              ...
              this.HasRequired(t => t.InventoryItem).WithOptional(t => (LumpedItem)t.LumpedItem);
             // Tracking Properties
