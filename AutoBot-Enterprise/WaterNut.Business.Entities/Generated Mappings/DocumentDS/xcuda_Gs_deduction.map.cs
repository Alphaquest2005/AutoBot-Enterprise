namespace DocumentDS.Business.Entities.Mapping
{
    ...
    public partial class xcuda_Gs_deductionMap : EntityTypeConfiguration<xcuda_Gs_deduction>
    {
        public xcuda_Gs_deductionMap()
        {                        
              this.HasKey(t => t.Valuation_Id);        
              this.ToTable("xcuda_Gs_deduction");
              ...
              this.HasRequired(t => t.xcuda_Valuation).WithOptional(t => (xcuda_Gs_deduction)t.xcuda_Gs_deduction);
             // Tracking Properties
