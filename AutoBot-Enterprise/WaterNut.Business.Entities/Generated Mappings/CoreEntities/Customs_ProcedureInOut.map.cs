namespace CoreEntities.Business.Entities.Mapping
{
    ...
    public partial class Customs_ProcedureInOutMap : EntityTypeConfiguration<Customs_ProcedureInOut>
    {
        ...
        {                        
              ...
              this.HasRequired(t => t.InCustomsProcedure).WithMany(t =>(ICollection<Customs_ProcedureInOut>) t.Customs_ProcedureInOut).HasForeignKey(d => d.WarehouseCustomsProcedureId);
