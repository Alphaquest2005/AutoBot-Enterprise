namespace InventoryDS.Business.Entities.Mapping
{
    ...
    public partial class InventoryItemSourceMap : EntityTypeConfiguration<InventoryItemSource>
    {
        ...
        {                        
              ...
              this.HasRequired(t => t.InventorySource).WithMany(t =>(ICollection<InventoryItemSource>) t.InventoryItemSource).HasForeignKey(d => d.InventorySourceId);
              this.HasRequired(t => t.InventoryItem).WithMany(t =>(ICollection<InventoryItemSource>) t.InventoryItemSources).HasForeignKey(d => d.InventoryId);
             // Tracking Properties
