namespace InventoryQS.Business.Entities.Mapping
{
    ...
    public partial class TariffCategoryCodeSuppUnitMap : EntityTypeConfiguration<TariffCategoryCodeSuppUnit>
    {
        ...
        {                        
              ...
              this.HasRequired(t => t.TariffCategory).WithMany(t =>(ICollection<TariffCategoryCodeSuppUnit>) t.TariffCategoryCodeSuppUnit).HasForeignKey(d => d.TariffCategoryCode);
              this.HasRequired(t => t.TariffSupUnitLkps).WithMany(t =>(ICollection<TariffCategoryCodeSuppUnit>) t.TariffCategoryCodeSuppUnit).HasForeignKey(d => d.TariffSupUnitId);
             // Tracking Properties
